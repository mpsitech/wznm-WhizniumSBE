/**
	...
	* API code for job PnlWznmErrList (declarations)
...
namespace PnlWznmErrList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmErrList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmErrList::StatApp statappqry;
