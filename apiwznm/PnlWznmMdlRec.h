/**
	...
	* API code for job PnlWznmMdlRec (declarations)
...
namespace PnlWznmMdlRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEMDL1NCARD = 2;
		static const Sbecore::uint INITDONEREF1NPANEL = 3;

	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneMdl1NCard = false, const bool initdoneRef1NPanel = false);

	public:
		bool initdoneDetail;
		bool initdoneMdl1NCard;
	...
	public:
		...
		static const Sbecore::uint SCRJREFMDL1NCARD = 3;
		static const Sbecore::uint SCRJREFREF1NPANEL = 4;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 5;

	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefMdl1NCard = "", const std::string& scrJrefRef1NPanel = "", const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWznmVExpstate;
		std::string scrJrefDetail;
		std::string scrJrefMdl1NCard;
