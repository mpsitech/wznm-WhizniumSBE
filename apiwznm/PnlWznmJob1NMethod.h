/**
	...
	* API code for job PnlWznmJob1NMethod (declarations)
...
namespace PnlWznmJob1NMethod {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmJob1NMethod::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmJob1NMethod::StatApp statappqry;
