/**
	* \file PnlWznmCapHeadbar.cpp
	* API code for job PnlWznmCapHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmCapHeadbar::StgInf
 ******************************************************************************/

PnlWznmCapHeadbar::StgInf::StgInf(
...
bool PnlWznmCapHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmCapHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmCapHeadbar";
...
set<uint> PnlWznmCapHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCapHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCapHeadbar::Tag
 ******************************************************************************/

PnlWznmCapHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmCapHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCapHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCapHeadbar";
...
/******************************************************************************
 class PnlWznmCapHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmCapHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCAPHEADBARDATA)
		{
};

string PnlWznmCapHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCapHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCapHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
