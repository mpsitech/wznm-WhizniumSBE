/**
	* \file PnlWznmCtpKKey.cpp
	* API code for job PnlWznmCtpKKey (implementation)
...
bool PnlWznmCtpKKey::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmCtpKKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmCtpKKey";
...
PnlWznmCtpKKey::StatApp::StatApp(
...
bool PnlWznmCtpKKey::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmCtpKKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmCtpKKey";
...
set<uint> PnlWznmCtpKKey::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpKKey::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmCtpKKey::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmCtpKKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmCtpKKey";
...
bool PnlWznmCtpKKey::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCtpKKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCtpKKey";
...
PnlWznmCtpKKey::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKKEYDATA, scrJref)
		{
...
void PnlWznmCtpKKey::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCtpKKeyData");
...
PnlWznmCtpKKey::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKKEYDO, scrJref)
		{
...
void PnlWznmCtpKKey::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCtpKKeyDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmCtpKKey::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCTPKKEYDATA)
		{
...
void PnlWznmCtpKKey::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCtpKKeyData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmCtpKKey::StatApp();
		statshrqry = QryWznmCtpKKey::StatShr();
