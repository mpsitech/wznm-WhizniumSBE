/**
	...
	* API code for job PnlWznmStbList (declarations)
...
namespace PnlWznmStbList {
	...
	public:
		...
		static const Sbecore::uint TCOTBL = 10;
		static const Sbecore::uint TCOSBS = 11;
		static const Sbecore::uint TCOEXA = 12;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoTyp = "", const std::string& TcoTbl = "", const std::string& TcoSbs = "", const std::string& TcoExa = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmStbList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmStbList::StatApp statappqry;
