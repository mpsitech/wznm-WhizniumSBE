/**
	...
	* API code for job QryWznmBlkRef1NRtblock (implementation)
...
QryWznmBlkRef1NRtblock::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmBlkRef1NRtblock::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmBlkRef1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmBlkRef1NRtblock";
...
set<uint> QryWznmBlkRef1NRtblock::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmBlkRef1NRtblock::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmBlkRef1NRtblock::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmBlkRef1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmBlkRef1NRtblock";
