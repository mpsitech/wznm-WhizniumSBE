/**
	...
	* API code for job QryWznmMdlMdl1NCard (implementation)
...
QryWznmMdlMdl1NCard::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmMdlMdl1NCard::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmMdlMdl1NCard");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmMdlMdl1NCard";
...
set<uint> QryWznmMdlMdl1NCard::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMdlMdl1NCard::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmMdlMdl1NCard::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmMdlMdl1NCard");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmMdlMdl1NCard";
