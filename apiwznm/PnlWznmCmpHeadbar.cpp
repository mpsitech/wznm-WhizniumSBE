/**
	* \file PnlWznmCmpHeadbar.cpp
	* API code for job PnlWznmCmpHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmCmpHeadbar::StgInf
 ******************************************************************************/

PnlWznmCmpHeadbar::StgInf::StgInf(
...
bool PnlWznmCmpHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmCmpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmCmpHeadbar";
...
set<uint> PnlWznmCmpHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCmpHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCmpHeadbar::Tag
 ******************************************************************************/

PnlWznmCmpHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmCmpHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCmpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCmpHeadbar";
...
/******************************************************************************
 class PnlWznmCmpHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmCmpHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCMPHEADBARDATA)
		{
};

string PnlWznmCmpHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCmpHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCmpHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
