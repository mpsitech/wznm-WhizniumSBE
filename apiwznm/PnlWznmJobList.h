/**
	...
	* API code for job PnlWznmJobList (declarations)
...
namespace PnlWznmJobList {
	...
	public:
		...
		static const Sbecore::uint TCOGBL = 13;
		static const Sbecore::uint TCOCLS = 14;
		static const Sbecore::uint TCOSHD = 15;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoTyp = "", const std::string& TcoVer = "", const std::string& TcoRet = "", const std::string& TcoReu = "", const std::string& TcoGbl = "", const std::string& TcoCls = "", const std::string& TcoShd = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmJobList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmJobList::StatApp statappqry;
