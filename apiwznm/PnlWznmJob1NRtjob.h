/**
	...
	* API code for job PnlWznmJob1NRtjob (declarations)
...
namespace PnlWznmJob1NRtjob {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmJob1NRtjob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmJob1NRtjob::StatApp statappqry;
