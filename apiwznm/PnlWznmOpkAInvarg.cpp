/**
	* \file PnlWznmOpkAInvarg.cpp
	* API code for job PnlWznmOpkAInvarg (implementation)
...
bool PnlWznmOpkAInvarg::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmOpkAInvarg");
	else
...
PnlWznmOpkAInvarg::StatApp::StatApp(
...
bool PnlWznmOpkAInvarg::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmOpkAInvarg");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmOpkAInvarg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpkAInvarg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmOpkAInvarg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmOpkAInvarg");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmOpkAInvarg::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmOpkAInvarg");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmOpkAInvarg::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDATA, scrJref)
		{
...
void PnlWznmOpkAInvarg::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmOpkAInvargData");
...
PnlWznmOpkAInvarg::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmOpkAInvarg::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmOpkAInvargDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmOpkAInvarg::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMOPKAINVARGDATA)
		{
...
void PnlWznmOpkAInvarg::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmOpkAInvargData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmOpkAInvarg::StatApp();
		statshrqry = QryWznmOpkAInvarg::StatShr();
