/**
	...
	* API code for job PnlWznmCtpAPar (declarations)
...
namespace PnlWznmCtpAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmCtpAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCtpAPar::StatApp statappqry;
