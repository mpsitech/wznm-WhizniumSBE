/**
	* \file PnlWznmCarHeadbar.cpp
	* API code for job PnlWznmCarHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmCarHeadbar::StgInf
 ******************************************************************************/

PnlWznmCarHeadbar::StgInf::StgInf(
...
bool PnlWznmCarHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmCarHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmCarHeadbar";
...
set<uint> PnlWznmCarHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCarHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCarHeadbar::Tag
 ******************************************************************************/

PnlWznmCarHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmCarHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCarHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCarHeadbar";
...
/******************************************************************************
 class PnlWznmCarHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmCarHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCARHEADBARDATA)
		{
};

string PnlWznmCarHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCarHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCarHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
