/**
	...
	* API code for job QryWznmCmpMNLibrary (implementation)
...
QryWznmCmpMNLibrary::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmCmpMNLibrary::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmCmpMNLibrary");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmCmpMNLibrary";
...
set<uint> QryWznmCmpMNLibrary::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmCmpMNLibrary::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmCmpMNLibrary::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmCmpMNLibrary");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmCmpMNLibrary";
