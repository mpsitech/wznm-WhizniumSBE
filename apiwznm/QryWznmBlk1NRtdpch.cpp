/**
	...
	* API code for job QryWznmBlk1NRtdpch (implementation)
...
QryWznmBlk1NRtdpch::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmBlk1NRtdpch::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmBlk1NRtdpch");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmBlk1NRtdpch";
...
set<uint> QryWznmBlk1NRtdpch::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmBlk1NRtdpch::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmBlk1NRtdpch::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmBlk1NRtdpch");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmBlk1NRtdpch";
