/**
	...
	* API code for job PnlWznmVitHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmVitHeadbar::StgInf
 ******************************************************************************/

PnlWznmVitHeadbar::StgInf::StgInf(
...
bool PnlWznmVitHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmVitHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmVitHeadbar";
...
set<uint> PnlWznmVitHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVitHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVitHeadbar::Tag
 ******************************************************************************/

PnlWznmVitHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmVitHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmVitHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmVitHeadbar";
...
/******************************************************************************
 class PnlWznmVitHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmVitHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMVITHEADBARDATA)
		{
};

string PnlWznmVitHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVitHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmVitHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
