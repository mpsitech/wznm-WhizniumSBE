/**
	...
	* API code for job PnlWznmVerBvr1NVersion (implementation)
...
bool PnlWznmVerBvr1NVersion::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmVerBvr1NVersion");
	else
...
PnlWznmVerBvr1NVersion::StatApp::StatApp(
...
bool PnlWznmVerBvr1NVersion::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmVerBvr1NVersion");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmVerBvr1NVersion::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVerBvr1NVersion::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmVerBvr1NVersion::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmVerBvr1NVersion");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmVerBvr1NVersion::Tag::Tag(
			const string& Cpt
...
bool PnlWznmVerBvr1NVersion::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmVerBvr1NVersion");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmVerBvr1NVersion::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVERBVR1NVERSIONDATA, scrJref)
		{
...
void PnlWznmVerBvr1NVersion::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmVerBvr1NVersionData");
...
PnlWznmVerBvr1NVersion::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVERBVR1NVERSIONDO, scrJref)
		{
...
void PnlWznmVerBvr1NVersion::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmVerBvr1NVersionDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmVerBvr1NVersion::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMVERBVR1NVERSIONDATA)
		{
...
void PnlWznmVerBvr1NVersion::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmVerBvr1NVersionData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmVerBvr1NVersion::StatApp();
		statshrqry = QryWznmVerBvr1NVersion::StatShr();
