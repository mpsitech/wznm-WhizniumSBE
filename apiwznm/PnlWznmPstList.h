/**
	...
	* API code for job PnlWznmPstList (declarations)
...
namespace PnlWznmPstList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmPstList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmPstList::StatApp statappqry;
