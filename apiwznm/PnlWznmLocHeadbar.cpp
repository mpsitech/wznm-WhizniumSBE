/**
	* \file PnlWznmLocHeadbar.cpp
	* API code for job PnlWznmLocHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmLocHeadbar::StgInf
 ******************************************************************************/

PnlWznmLocHeadbar::StgInf::StgInf(
...
bool PnlWznmLocHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmLocHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmLocHeadbar";
...
set<uint> PnlWznmLocHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLocHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLocHeadbar::Tag
 ******************************************************************************/

PnlWznmLocHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmLocHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmLocHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmLocHeadbar";
...
/******************************************************************************
 class PnlWznmLocHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmLocHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLOCHEADBARDATA)
		{
};

string PnlWznmLocHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLocHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmLocHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
