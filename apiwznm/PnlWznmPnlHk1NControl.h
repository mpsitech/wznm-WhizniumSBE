/**
	...
	* API code for job PnlWznmPnlHk1NControl (declarations)
...
/**
	...
	*/
namespace PnlWznmPnlHk1NControl {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmPnlHk1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmPnlHk1NControl::StatApp statappqry;
