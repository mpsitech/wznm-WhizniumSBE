/**
	...
	* API code for job PnlWznmUtlHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmUtlHeadbar::StgInf
 ******************************************************************************/

PnlWznmUtlHeadbar::StgInf::StgInf(
...
bool PnlWznmUtlHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmUtlHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmUtlHeadbar";
...
set<uint> PnlWznmUtlHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmUtlHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmUtlHeadbar::Tag
 ******************************************************************************/

PnlWznmUtlHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmUtlHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmUtlHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmUtlHeadbar";
...
/******************************************************************************
 class PnlWznmUtlHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmUtlHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMUTLHEADBARDATA)
		{
};

string PnlWznmUtlHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmUtlHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmUtlHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
