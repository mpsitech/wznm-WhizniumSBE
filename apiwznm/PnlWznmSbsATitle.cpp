/**
	* \file PnlWznmSbsATitle.cpp
	* API code for job PnlWznmSbsATitle (implementation)
...
bool PnlWznmSbsATitle::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmSbsATitle");
	else
...
PnlWznmSbsATitle::StatApp::StatApp(
...
bool PnlWznmSbsATitle::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmSbsATitle");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmSbsATitle::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmSbsATitle::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmSbsATitle::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmSbsATitle");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmSbsATitle::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmSbsATitle");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmSbsATitle::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSBSATITLEDATA, scrJref)
		{
...
void PnlWznmSbsATitle::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmSbsATitleData");
...
PnlWznmSbsATitle::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSBSATITLEDO, scrJref)
		{
...
void PnlWznmSbsATitle::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmSbsATitleDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmSbsATitle::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSBSATITLEDATA)
		{
...
void PnlWznmSbsATitle::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmSbsATitleData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmSbsATitle::StatApp();
		statshrqry = QryWznmSbsATitle::StatShr();
