...
PnlWznmSbsRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEATITLE, INITDONETOS1NRELATION, INITDONE1NSTUB, INITDONE1NTABLECOL, INITDONEFRS1NRELATION, INITDONEPST1NQUERYMOD, INITDONEASBMNSUBSET, INITDONEBSBMNSUBSET};
};
...
set<uint> PnlWznmSbsRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEATITLE, INITDONETOS1NRELATION, INITDONE1NSTUB, INITDONE1NTABLECOL, INITDONEFRS1NRELATION, INITDONEPST1NQUERYMOD, INITDONEASBMNSUBSET, INITDONEBSBMNSUBSET};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmSbsRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFTOS1NRELATION, SCRJREF1NSTUB, SCRJREF1NTABLECOL, SCRJREFFRS1NRELATION, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFASBMNSUBSET, SCRJREFBSBMNSUBSET, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmSbsRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFTOS1NRELATION, SCRJREF1NSTUB, SCRJREF1NTABLECOL, SCRJREFFRS1NRELATION, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFASBMNSUBSET, SCRJREFBSBMNSUBSET, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
