...
PnlWznmVecRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEATITLE, INITDONEVEC1NVECTORITEM, INITDONEREF1NPANEL, INITDONEFCT1NTABLECOL, INITDONESRC1NFEED, INITDONEPST1NQUERYMOD, INITDONEMNTABLE};
};
...
set<uint> PnlWznmVecRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEATITLE, INITDONEVEC1NVECTORITEM, INITDONEREF1NPANEL, INITDONEFCT1NTABLECOL, INITDONESRC1NFEED, INITDONEPST1NQUERYMOD, INITDONEMNTABLE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmVecRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFVEC1NVECTORITEM, SCRJREFREF1NPANEL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFSRC1NFEED, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNTABLE, PNLMNTABLEAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmVecRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFVEC1NVECTORITEM, SCRJREFREF1NPANEL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFSRC1NFEED, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNTABLE, PNLMNTABLEAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
