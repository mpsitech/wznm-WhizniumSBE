...
PnlWznmJobRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEAVAR, INITDONEACMD, INITDONE1NMETHOD, INITDONE1NSENSITIVITY, INITDONEJOB1NSTAGE, INITDONE1NRTJOB, INITDONEHK1NVECTOR, INITDONEREF1NBLOCK, INITDONEMNOPPACK, INITDONEMNOP, INITDONESUPMNJOB, INITDONESUBMNJOB};
};
...
set<uint> PnlWznmJobRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEAVAR, INITDONEACMD, INITDONE1NMETHOD, INITDONE1NSENSITIVITY, INITDONEJOB1NSTAGE, INITDONE1NRTJOB, INITDONEHK1NVECTOR, INITDONEREF1NBLOCK, INITDONEMNOPPACK, INITDONEMNOP, INITDONESUPMNJOB, INITDONESUBMNJOB};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmJobRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAVAR, SCRJREFACMD, SCRJREF1NMETHOD, SCRJREF1NSENSITIVITY, SCRJREFJOB1NSTAGE, SCRJREF1NRTJOB, SCRJREFHK1NVECTOR, SCRJREFREF1NBLOCK, SCRJREFMNOPPACK, SCRJREFMNOP, SCRJREFSUPMNJOB, SCRJREFSUBMNJOB, PNLSUBMNJOBAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmJobRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAVAR, SCRJREFACMD, SCRJREF1NMETHOD, SCRJREF1NSENSITIVITY, SCRJREFJOB1NSTAGE, SCRJREF1NRTJOB, SCRJREFHK1NVECTOR, SCRJREFREF1NBLOCK, SCRJREFMNOPPACK, SCRJREFMNOP, SCRJREFSUPMNJOB, SCRJREFSUBMNJOB, PNLSUBMNJOBAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
