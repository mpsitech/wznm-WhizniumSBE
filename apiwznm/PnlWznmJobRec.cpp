...
PnlWznmJobRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEAVAR, INITDONEACMD, INITDONE1NRTJOB, INITDONE1NMETHOD, INITDONEJOB1NSTAGE, INITDONE1NSENSITIVITY, INITDONEHK1NVECTOR, INITDONEREF1NBLOCK, INITDONEMNOP, INITDONEMNOPPACK, INITDONESUPMNJOB, INITDONESUBMNJOB};
};
...
set<uint> PnlWznmJobRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEAVAR, INITDONEACMD, INITDONE1NRTJOB, INITDONE1NMETHOD, INITDONEJOB1NSTAGE, INITDONE1NSENSITIVITY, INITDONEHK1NVECTOR, INITDONEREF1NBLOCK, INITDONEMNOP, INITDONEMNOPPACK, INITDONESUPMNJOB, INITDONESUBMNJOB};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmJobRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAVAR, SCRJREFACMD, SCRJREF1NRTJOB, SCRJREF1NMETHOD, SCRJREFJOB1NSTAGE, SCRJREF1NSENSITIVITY, SCRJREFHK1NVECTOR, SCRJREFREF1NBLOCK, SCRJREFMNOP, SCRJREFMNOPPACK, SCRJREFSUPMNJOB, SCRJREFSUBMNJOB, PNLSUBMNJOBAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmJobRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAVAR, SCRJREFACMD, SCRJREF1NRTJOB, SCRJREF1NMETHOD, SCRJREFJOB1NSTAGE, SCRJREF1NSENSITIVITY, SCRJREFHK1NVECTOR, SCRJREFREF1NBLOCK, SCRJREFMNOP, SCRJREFMNOPPACK, SCRJREFSUPMNJOB, SCRJREFSUBMNJOB, PNLSUBMNJOBAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
