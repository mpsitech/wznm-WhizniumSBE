...
bool PnlWznmLibAMakefile::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmLibAMakefile";
...
PnlWznmLibAMakefile::StatApp::StatApp(
...
bool PnlWznmLibAMakefile::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmLibAMakefile";
...
set<uint> PnlWznmLibAMakefile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAMakefile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmLibAMakefile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmLibAMakefile";
...
bool PnlWznmLibAMakefile::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmLibAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmLibAMakefile";
...
PnlWznmLibAMakefile::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAMAKEFILEDATA, scrJref)
		{
...
void PnlWznmLibAMakefile::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibAMakefileData");
...
PnlWznmLibAMakefile::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAMAKEFILEDO, scrJref)
		{
...
void PnlWznmLibAMakefile::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibAMakefileDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmLibAMakefile::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBAMAKEFILEDATA)
		{
...
void PnlWznmLibAMakefile::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmLibAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmLibAMakefile::StatApp();
		statshrqry = QryWznmLibAMakefile::StatShr();
