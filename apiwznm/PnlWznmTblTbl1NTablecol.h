/**
	...
	* API code for job PnlWznmTblTbl1NTablecol (declarations)
...
/**
	...
	*/
namespace PnlWznmTblTbl1NTablecol {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmTblTbl1NTablecol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTblTbl1NTablecol::StatApp statappqry;
