/**
	...
	* API code for job QryWznmImeSup1NImpexp (implementation)
...
QryWznmImeSup1NImpexp::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmImeSup1NImpexp::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmImeSup1NImpexp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmImeSup1NImpexp";
...
set<uint> QryWznmImeSup1NImpexp::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmImeSup1NImpexp::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmImeSup1NImpexp::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmImeSup1NImpexp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmImeSup1NImpexp";
