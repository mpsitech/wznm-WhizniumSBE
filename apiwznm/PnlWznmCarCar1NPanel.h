/**
	...
	* API code for job PnlWznmCarCar1NPanel (declarations)
...
/**
	...
	*/
namespace PnlWznmCarCar1NPanel {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmCarCar1NPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCarCar1NPanel::StatApp statappqry;
