/**
	* \file PnlWznmPrjMNPerson.cpp
	* API code for job PnlWznmPrjMNPerson (implementation)
...
bool PnlWznmPrjMNPerson::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmPrjMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmPrjMNPerson";
...
PnlWznmPrjMNPerson::StatApp::StatApp(
...
bool PnlWznmPrjMNPerson::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmPrjMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmPrjMNPerson";
...
set<uint> PnlWznmPrjMNPerson::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPrjMNPerson::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmPrjMNPerson::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmPrjMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmPrjMNPerson";
...
bool PnlWznmPrjMNPerson::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmPrjMNPerson");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmPrjMNPerson";
...
PnlWznmPrjMNPerson::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRJMNPERSONDATA, scrJref)
		{
...
void PnlWznmPrjMNPerson::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmPrjMNPersonData");
...
PnlWznmPrjMNPerson::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRJMNPERSONDO, scrJref)
		{
...
void PnlWznmPrjMNPerson::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmPrjMNPersonDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmPrjMNPerson::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMPRJMNPERSONDATA)
		{
...
void PnlWznmPrjMNPerson::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmPrjMNPersonData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmPrjMNPerson::StatApp();
		statshrqry = QryWznmPrjMNPerson::StatShr();
