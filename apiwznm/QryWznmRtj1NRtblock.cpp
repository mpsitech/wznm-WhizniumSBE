/**
	...
	* API code for job QryWznmRtj1NRtblock (implementation)
...
QryWznmRtj1NRtblock::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmRtj1NRtblock::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmRtj1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmRtj1NRtblock";
...
set<uint> QryWznmRtj1NRtblock::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRtj1NRtblock::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmRtj1NRtblock::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmRtj1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmRtj1NRtblock";
