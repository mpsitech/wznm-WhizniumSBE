/**
	...
	* API code for job PnlWznmPrjRec (declarations)
...
namespace PnlWznmPrjRec {
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefPrj1NVersion = "", const std::string& scrJrefMNPerson = "", const bool ButRegularizeActive = true);
