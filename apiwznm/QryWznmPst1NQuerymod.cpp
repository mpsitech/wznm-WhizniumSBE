/**
	...
	* API code for job QryWznmPst1NQuerymod (implementation)
...
QryWznmPst1NQuerymod::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmPst1NQuerymod::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmPst1NQuerymod");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmPst1NQuerymod";
...
set<uint> QryWznmPst1NQuerymod::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmPst1NQuerymod::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmPst1NQuerymod::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmPst1NQuerymod");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmPst1NQuerymod";
