/**
	...
	* API code for job PnlWznmRtjSup1NRtjob (declarations)
...
/**
	...
	*/
namespace PnlWznmRtjSup1NRtjob {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmRtjSup1NRtjob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmRtjSup1NRtjob::StatApp statappqry;
