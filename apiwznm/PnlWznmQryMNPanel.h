/**
	...
	* API code for job PnlWznmQryMNPanel (declarations)
...
namespace PnlWznmQryMNPanel {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmQryMNPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmQryMNPanel::StatApp statappqry;
