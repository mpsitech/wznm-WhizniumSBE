/**
	...
	* API code for job PnlWznmAppList (declarations)
...
namespace PnlWznmAppList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmAppList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmAppList::StatApp statappqry;
