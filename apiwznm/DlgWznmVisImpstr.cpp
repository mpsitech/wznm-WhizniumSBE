/**
	...
	* API code for job DlgWznmVisImpstr (implementation)
...
bool DlgWznmVisImpstr::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVisImpstr");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::ContInfImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVisImpstrImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::ContInfLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVisImpstrLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVisImpstr::StatApp::StatApp(
			const bool initdone
...
bool DlgWznmVisImpstr::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppDlgWznmVisImpstr");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> DlgWznmVisImpstr::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> DlgWznmVisImpstr::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool DlgWznmVisImpstr::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVisImpstr");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::StatShrIfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVisImpstrIfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::StatShrImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVisImpstrImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::StatShrLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVisImpstrLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVisImpstr::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVisImpstr");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVisImpstr::TagIfi::TagIfi(
			const string& Uld
			, const string& Cpt
		) :
			Block()
...
bool DlgWznmVisImpstr::TagIfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVisImpstrIfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVisImpstr::TagImp::TagImp(
			const string& CptPrg
			, const string& ButRun
			, const string& ButSto
		) :
...
bool DlgWznmVisImpstr::TagImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVisImpstrImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVisImpstr::TagLfi::TagLfi(
			const string& Dld
		) :
			Block()
			, Dld(Dld)
...
bool DlgWznmVisImpstr::TagLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVisImpstrLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVisImpstr::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPDLGWZNMVISIMPSTRDATA, scrJref)
		{
...
void DlgWznmVisImpstr::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWznmVisImpstrData");
...
DlgWznmVisImpstr::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPDLGWZNMVISIMPSTRDO, scrJref)
			, ixVDo(ixVDo)
			, ixVDoImp(ixVDoImp)
		{
...
void DlgWznmVisImpstr::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWznmVisImpstrDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
DlgWznmVisImpstr::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGDLGWZNMVISIMPSTRDATA)
		{
...
void DlgWznmVisImpstr::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngDlgWznmVisImpstrData");
	else
		basefound = checkXPath(docctx, basexpath);
