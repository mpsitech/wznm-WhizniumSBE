...
namespace PnlWznmConDetail {
	...
	public:
		...
		static const Sbecore::uint TXTHKUACTIVE = 12;
		static const Sbecore::uint BUTHKUVIEWAVAIL = 13;
		static const Sbecore::uint BUTHKUVIEWACTIVE = 14;
		static const Sbecore::uint TXTREUACTIVE = 15;
		static const Sbecore::uint BUTREUVIEWAVAIL = 16;
		static const Sbecore::uint BUTREUVIEWACTIVE = 17;
		static const Sbecore::uint TXTSUPACTIVE = 18;
		static const Sbecore::uint BUTSUPVIEWAVAIL = 19;
		static const Sbecore::uint BUTSUPVIEWACTIVE = 20;
		static const Sbecore::uint PUPSCOACTIVE = 21;
		static const Sbecore::uint PUPSTYACTIVE = 22;
		static const Sbecore::uint LSTTAGACTIVE = 23;
		static const Sbecore::uint TXFTAGVALID = 24;
		static const Sbecore::uint BUTTAGVIEWAVAIL = 25;
		static const Sbecore::uint BUTTAGVIEWACTIVE = 26;
		static const Sbecore::uint TXTSTSACTIVE = 27;
		static const Sbecore::uint BUTSTSVIEWAVAIL = 28;
		static const Sbecore::uint BUTSTSVIEWACTIVE = 29;
		static const Sbecore::uint TXTSHSACTIVE = 30;
		static const Sbecore::uint BUTSHSVIEWAVAIL = 31;
		static const Sbecore::uint BUTSHSVIEWACTIVE = 32;
		static const Sbecore::uint TXFAVLACTIVE = 33;
		static const Sbecore::uint TXFACTACTIVE = 34;
		static const Sbecore::uint LSTOPTACTIVE = 35;
		static const Sbecore::uint TXFOPTVALID = 36;
		static const Sbecore::uint BUTOPTEDITAVAIL = 37;
		static const Sbecore::uint SEPFEDAVAIL = 38;
		static const Sbecore::uint HDGFEDAVAIL = 39;
		static const Sbecore::uint BUTFEDNEWAVAIL = 40;
		static const Sbecore::uint BUTFEDDELETEAVAIL = 41;
		static const Sbecore::uint TXTFEDSRFAVAIL = 42;
		static const Sbecore::uint TXTFEDSRFACTIVE = 43;
		static const Sbecore::uint TXTFEDSRUAVAIL = 44;
		static const Sbecore::uint TXTFEDSRUACTIVE = 45;
		static const Sbecore::uint BUTFEDSRUVIEWAVAIL = 46;
		static const Sbecore::uint BUTFEDSRUVIEWACTIVE = 47;
		static const Sbecore::uint LSTFEDVITAVAIL = 48;
		static const Sbecore::uint LSTFEDVITACTIVE = 49;
		static const Sbecore::uint TXFFEDVITVALID = 50;
		static const Sbecore::uint BUTFEDVITVIEWAVAIL = 51;
		static const Sbecore::uint BUTFEDVITVIEWACTIVE = 52;
		static const Sbecore::uint LSTFEDTAGAVAIL = 53;
		static const Sbecore::uint LSTFEDTAGACTIVE = 54;
		static const Sbecore::uint TXFFEDTAGVALID = 55;
	...
	public:
		StatShr(const bool ButSaveAvail = true, const bool ButSaveActive = true, const bool TxtSrfActive = true, const bool PupJtiActive = true, const bool ButJtiEditAvail = true, const bool TxtTitActive = true, const bool PupTypActive = true, const bool LstCluActive = true, const bool ButCluViewActive = true, const bool ButCluClusterAvail = true, const bool ButCluUnclusterAvail = true, const bool TxtHkuActive = true, const bool ButHkuViewAvail = true, const bool ButHkuViewActive = true, const bool TxtReuActive = true, const bool ButReuViewAvail = true, const bool ButReuViewActive = true, const bool TxtSupActive = true, const bool ButSupViewAvail = true, const bool ButSupViewActive = true, const bool PupScoActive = true, const bool PupStyActive = true, const bool LstTagActive = true, const bool TxfTagValid = false, const bool ButTagViewAvail = true, const bool ButTagViewActive = true, const bool TxtStsActive = true, const bool ButStsViewAvail = true, const bool ButStsViewActive = true, const bool TxtShsActive = true, const bool ButShsViewAvail = true, const bool ButShsViewActive = true, const bool TxfAvlActive = true, const bool TxfActActive = true, const bool LstOptActive = true, const bool TxfOptValid = false, const bool ButOptEditAvail = true, const bool SepFedAvail = true, const bool HdgFedAvail = true, const bool ButFedNewAvail = true, const bool ButFedDeleteAvail = true, const bool TxtFedSrfAvail = true, const bool TxtFedSrfActive = true, const bool TxtFedSruAvail = true, const bool TxtFedSruActive = true, const bool ButFedSruViewAvail = true, const bool ButFedSruViewActive = true, const bool LstFedVitAvail = true, const bool LstFedVitActive = true, const bool TxfFedVitValid = false, const bool ButFedVitViewAvail = true, const bool ButFedVitViewActive = true, const bool LstFedTagAvail = true, const bool LstFedTagActive = true, const bool TxfFedTagValid = false, const bool ButFedTagViewAvail = true, const bool ButFedTagViewActive = true, const bool TxfFedCmtAvail = true, const bool TxfFedCmtActive = true);
