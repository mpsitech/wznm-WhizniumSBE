...
#define VecVWznmMtdListDo PnlWznmMtdList::VecVDo

#define ContIacWznmMtdList PnlWznmMtdList::ContIac
#define ContInfWznmMtdList PnlWznmMtdList::ContInf
#define StatShrWznmMtdList PnlWznmMtdList::StatShr
#define StgIacWznmMtdList PnlWznmMtdList::StgIac
#define TagWznmMtdList PnlWznmMtdList::Tag

#define DpchAppWznmMtdListData PnlWznmMtdList::DpchAppData
#define DpchAppWznmMtdListDo PnlWznmMtdList::DpchAppDo
#define DpchEngWznmMtdListData PnlWznmMtdList::DpchEngData

/**
	* PnlWznmMtdList
	*/
namespace PnlWznmMtdList {
	/**
	...
	public:
		...
		static const Sbecore::uint TCOEXSWIDTH = 3;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoJobWidth = 100, const Sbecore::uint TcoExsWidth = 100);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoJobWidth;
		Sbecore::uint TcoExsWidth;
	...
	public:
		...
		static const Sbecore::uint TCOJOB = 9;
		static const Sbecore::uint TCOEXS = 10;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoJob = "", const std::string& TcoExs = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmMtdList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmMtdList::StatApp statappqry;
