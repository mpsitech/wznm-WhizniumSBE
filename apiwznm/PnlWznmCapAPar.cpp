/**
	* \file PnlWznmCapAPar.cpp
	* API code for job PnlWznmCapAPar (implementation)
...
bool PnlWznmCapAPar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmCapAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmCapAPar";
...
PnlWznmCapAPar::StatApp::StatApp(
...
bool PnlWznmCapAPar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmCapAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmCapAPar";
...
set<uint> PnlWznmCapAPar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCapAPar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmCapAPar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmCapAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmCapAPar";
...
bool PnlWznmCapAPar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCapAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCapAPar";
...
PnlWznmCapAPar::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAPAPARDATA, scrJref)
		{
...
void PnlWznmCapAPar::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCapAParData");
...
PnlWznmCapAPar::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAPAPARDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmCapAPar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCapAParDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmCapAPar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCAPAPARDATA)
		{
...
void PnlWznmCapAPar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCapAParData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmCapAPar::StatApp();
		statshrqry = QryWznmCapAPar::StatShr();
