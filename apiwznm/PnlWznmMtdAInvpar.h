/**
	...
	* API code for job PnlWznmMtdAInvpar (declarations)
...
namespace PnlWznmMtdAInvpar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmMtdAInvpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmMtdAInvpar::StatApp statappqry;
