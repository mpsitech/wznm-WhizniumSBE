/**
	...
	* API code for job PnlWznmTblTo1NRelation (declarations)
...
/**
	...
	*/
namespace PnlWznmTblTo1NRelation {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmTblTo1NRelation::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTblTo1NRelation::StatApp statappqry;
