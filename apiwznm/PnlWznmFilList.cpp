/**
	* \file PnlWznmFilList.cpp
	* API code for job PnlWznmFilList (implementation)
...
bool PnlWznmFilList::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmFilList";
...
bool PnlWznmFilList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmFilList";
...
bool PnlWznmFilList::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmFilList";
...
PnlWznmFilList::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMFILLISTDATA, scrJref)
		{
...
void PnlWznmFilList::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmFilListData");
...
PnlWznmFilList::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMFILLISTDO, scrJref)
		{
...
void PnlWznmFilList::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmFilListDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmFilList::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMFILLISTDATA)
		{
...
void PnlWznmFilList::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmFilListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmFilList::StatApp();
		statshrqry = QryWznmFilList::StatShr();
