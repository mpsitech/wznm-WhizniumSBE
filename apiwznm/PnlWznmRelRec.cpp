...
set<uint> PnlWznmRelRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEATITLE, INITDONE1NTABLECOL, INITDONESUP1NRELATION, INITDONEREF1NPANEL, INITDONEREF1NDIALOG, INITDONEREF1NCONTROL};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmRelRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREF1NTABLECOL, SCRJREFSUP1NRELATION, SCRJREFREF1NPANEL, SCRJREFREF1NDIALOG, SCRJREFREF1NCONTROL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
