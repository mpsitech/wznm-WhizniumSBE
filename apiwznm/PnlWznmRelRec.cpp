...
PnlWznmRelRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEATITLE, INITDONESUP1NRELATION, INITDONE1NTABLECOL, INITDONEREF1NCONTROL, INITDONEREF1NPANEL, INITDONEREF1NDIALOG};
};
...
set<uint> PnlWznmRelRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEATITLE, INITDONESUP1NRELATION, INITDONE1NTABLECOL, INITDONEREF1NCONTROL, INITDONEREF1NPANEL, INITDONEREF1NDIALOG};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmRelRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFSUP1NRELATION, SCRJREF1NTABLECOL, SCRJREFREF1NCONTROL, SCRJREFREF1NPANEL, SCRJREFREF1NDIALOG, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmRelRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFSUP1NRELATION, SCRJREF1NTABLECOL, SCRJREFREF1NCONTROL, SCRJREFREF1NPANEL, SCRJREFREF1NDIALOG, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
