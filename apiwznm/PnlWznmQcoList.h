/**
	...
	* API code for job PnlWznmQcoList (declarations)
...
namespace PnlWznmQcoList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmQcoList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmQcoList::StatApp statappqry;
