/**
	...
	* API code for job PnlWznmSeqSeq1NState (declarations)
...
/**
	...
	*/
namespace PnlWznmSeqSeq1NState {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmSeqSeq1NState::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmSeqSeq1NState::StatApp statappqry;
