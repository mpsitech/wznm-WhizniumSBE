...
bool PnlWznmLibAPkglist::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmLibAPkglist");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmLibAPkglist";
...
PnlWznmLibAPkglist::StatApp::StatApp(
...
bool PnlWznmLibAPkglist::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmLibAPkglist");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmLibAPkglist";
...
set<uint> PnlWznmLibAPkglist::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAPkglist::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmLibAPkglist::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmLibAPkglist");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmLibAPkglist";
...
bool PnlWznmLibAPkglist::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmLibAPkglist");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmLibAPkglist";
...
PnlWznmLibAPkglist::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAPKGLISTDATA, scrJref)
		{
...
void PnlWznmLibAPkglist::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibAPkglistData");
...
PnlWznmLibAPkglist::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAPKGLISTDO, scrJref)
		{
...
void PnlWznmLibAPkglist::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibAPkglistDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmLibAPkglist::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBAPKGLISTDATA)
		{
...
void PnlWznmLibAPkglist::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmLibAPkglistData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmLibAPkglist::StatApp();
		statshrqry = QryWznmLibAPkglist::StatShr();
