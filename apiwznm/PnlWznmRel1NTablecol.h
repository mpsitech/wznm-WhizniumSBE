/**
	...
	* API code for job PnlWznmRel1NTablecol (declarations)
...
/**
	...
	*/
namespace PnlWznmRel1NTablecol {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmRel1NTablecol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmRel1NTablecol::StatApp statappqry;
