/**
	...
	* API code for job PnlWznmUsgAAccess (declarations)
...
namespace PnlWznmUsgAAccess {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmUsgAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmUsgAAccess::StatApp statappqry;
