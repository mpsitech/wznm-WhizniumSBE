/**
	...
	* API code for job PnlWznmBlkList (declarations)
...
namespace PnlWznmBlkList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmBlkList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmBlkList::StatApp statappqry;
