/**
	...
	* API code for job PnlWznmCal1NSensitivity (implementation)
...
bool PnlWznmCal1NSensitivity::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmCal1NSensitivity");
	else
...
PnlWznmCal1NSensitivity::StatApp::StatApp(
...
bool PnlWznmCal1NSensitivity::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmCal1NSensitivity");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmCal1NSensitivity::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCal1NSensitivity::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
PnlWznmCal1NSensitivity::Tag::Tag(
			const string& Cpt
...
bool PnlWznmCal1NSensitivity::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCal1NSensitivity");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmCal1NSensitivity::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAL1NSENSITIVITYDATA, scrJref)
		{
...
void PnlWznmCal1NSensitivity::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCal1NSensitivityData");
...
PnlWznmCal1NSensitivity::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAL1NSENSITIVITYDO, scrJref)
		{
...
void PnlWznmCal1NSensitivity::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCal1NSensitivityDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmCal1NSensitivity::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCAL1NSENSITIVITYDATA)
		{
...
void PnlWznmCal1NSensitivity::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCal1NSensitivityData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmCal1NSensitivity::StatApp();
		statshrqry = QryWznmCal1NSensitivity::StatShr();
