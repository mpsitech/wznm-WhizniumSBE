...
PnlWznmVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONE1NVECTOR, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONEVER1NERROR, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE};
};
...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONE1NVECTOR, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONEVER1NERROR, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmVerRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NVECTOR, SCRJREF1NCAPABILITY, SCRJREFVER1NAPP, SCRJREFVER1NERROR, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NQUERY, SCRJREF1NPRESET, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
