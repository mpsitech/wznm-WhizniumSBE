...
PnlWznmVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NQUERY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONE1NPRESET, INITDONEREF1NFILE, INITDONEMNLOCALE};
};
...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NQUERY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONE1NPRESET, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
