...
PnlWznmVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONEVER1NERROR, INITDONE1NVECTOR, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NCALL, INITDONE1NCOMPONENT, INITDONE1NBLOCK, INITDONEBVR1NVERSION, INITDONEREF1NFILE, INITDONEMNLOCALE};
};
...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONEVER1NERROR, INITDONE1NVECTOR, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NCALL, INITDONE1NCOMPONENT, INITDONE1NBLOCK, INITDONEBVR1NVERSION, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmVerRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NCAPABILITY, SCRJREFVER1NAPP, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREFVER1NERROR, SCRJREF1NVECTOR, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NCALL, SCRJREF1NCOMPONENT, SCRJREF1NBLOCK, SCRJREFBVR1NVERSION, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
