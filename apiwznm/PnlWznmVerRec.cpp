...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEVER1NERROR, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NBLOCK, INITDONEBVR1NVERSION, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NVECTOR, INITDONE1NQUERY, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmVerRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFVER1NERROR, SCRJREF1NTABLE, SCRJREF1NRELATION, SCRJREF1NBLOCK, SCRJREFBVR1NVERSION, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NVECTOR, SCRJREF1NQUERY, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
