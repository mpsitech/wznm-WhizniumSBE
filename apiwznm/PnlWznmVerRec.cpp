...
PnlWznmVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEVER1NERROR, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NVECTOR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE};
};
...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEVER1NERROR, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NVECTOR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmVerRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NERROR, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NVECTOR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
