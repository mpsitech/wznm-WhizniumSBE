...
PnlWznmVerRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONE1NPRESET, INITDONE1NQUERY, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NRELATION, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NCAPABILITY, INITDONE1NBLOCK, INITDONE1NVECTOR, INITDONE1NTABLE, INITDONE1NCALL, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONEREF1NFILE, INITDONEMNLOCALE};
};
...
set<uint> PnlWznmVerRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONE1NPRESET, INITDONE1NQUERY, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NRELATION, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NCAPABILITY, INITDONE1NBLOCK, INITDONE1NVECTOR, INITDONE1NTABLE, INITDONE1NCALL, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONEREF1NFILE, INITDONEMNLOCALE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
set<uint> PnlWznmVerRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NRELATION, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NCAPABILITY, SCRJREF1NBLOCK, SCRJREF1NVECTOR, SCRJREF1NTABLE, SCRJREF1NCALL, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
