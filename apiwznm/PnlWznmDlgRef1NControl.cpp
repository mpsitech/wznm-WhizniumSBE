/**
	...
	* API code for job PnlWznmDlgRef1NControl (implementation)
...
bool PnlWznmDlgRef1NControl::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmDlgRef1NControl");
	else
...
PnlWznmDlgRef1NControl::StatApp::StatApp(
...
bool PnlWznmDlgRef1NControl::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmDlgRef1NControl");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmDlgRef1NControl::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmDlgRef1NControl::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmDlgRef1NControl::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmDlgRef1NControl");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgRef1NControl::Tag::Tag(
			const string& Cpt
...
bool PnlWznmDlgRef1NControl::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmDlgRef1NControl");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgRef1NControl::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGREF1NCONTROLDATA, scrJref)
		{
...
void PnlWznmDlgRef1NControl::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmDlgRef1NControlData");
...
PnlWznmDlgRef1NControl::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGREF1NCONTROLDO, scrJref)
		{
...
void PnlWznmDlgRef1NControl::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmDlgRef1NControlDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmDlgRef1NControl::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMDLGREF1NCONTROLDATA)
		{
...
void PnlWznmDlgRef1NControl::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmDlgRef1NControlData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmDlgRef1NControl::StatApp();
		statshrqry = QryWznmDlgRef1NControl::StatShr();
