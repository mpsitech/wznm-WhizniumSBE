/**
	...
	* API code for job PnlWznmSge1NSensitivity (declarations)
...
/**
	...
	*/
namespace PnlWznmSge1NSensitivity {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmSge1NSensitivity::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmSge1NSensitivity::StatApp statappqry;
