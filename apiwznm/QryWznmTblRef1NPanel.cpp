/**
	...
	* API code for job QryWznmTblRef1NPanel (implementation)
...
QryWznmTblRef1NPanel::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmTblRef1NPanel::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmTblRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmTblRef1NPanel";
...
set<uint> QryWznmTblRef1NPanel::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblRef1NPanel::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmTblRef1NPanel::StatShr
 ******************************************************************************/

QryWznmTblRef1NPanel::StatShr::StatShr(
			const uint ntot
...
bool QryWznmTblRef1NPanel::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmTblRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmTblRef1NPanel";
...
set<uint> QryWznmTblRef1NPanel::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblRef1NPanel::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmTblRef1NPanel::StgIac
 ******************************************************************************/

QryWznmTblRef1NPanel::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmTblRef1NPanel::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmTblRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmTblRef1NPanel";
...
void QryWznmTblRef1NPanel::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryWznmTblRef1NPanel";
...
set<uint> QryWznmTblRef1NPanel::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblRef1NPanel::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
