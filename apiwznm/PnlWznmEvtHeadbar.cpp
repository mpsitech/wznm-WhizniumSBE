/**
	* \file PnlWznmEvtHeadbar.cpp
	* API code for job PnlWznmEvtHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmEvtHeadbar::StgInf
 ******************************************************************************/

PnlWznmEvtHeadbar::StgInf::StgInf(
...
bool PnlWznmEvtHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmEvtHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmEvtHeadbar";
...
set<uint> PnlWznmEvtHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmEvtHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmEvtHeadbar::Tag
 ******************************************************************************/

PnlWznmEvtHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmEvtHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmEvtHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmEvtHeadbar";
...
/******************************************************************************
 class PnlWznmEvtHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmEvtHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMEVTHEADBARDATA)
		{
};

string PnlWznmEvtHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmEvtHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmEvtHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
