/**
	* \file CrdWznmLib.cpp
	* API code for job CrdWznmLib (implementation)
...
bool CrdWznmLib::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmLib");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmLib";
...
bool CrdWznmLib::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmLib");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmLib";
...
set<uint> CrdWznmLib::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWznmLib::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWznmLib::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmLib");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmLib";
...
bool CrdWznmLib::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmLib");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmLib";
...
CrdWznmLib::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void CrdWznmLib::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibDo");
...
CrdWznmLib::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBDATA)
		{
...
void CrdWznmLib::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmLibData");
	else
		basefound = checkXPath(docctx, basexpath);
