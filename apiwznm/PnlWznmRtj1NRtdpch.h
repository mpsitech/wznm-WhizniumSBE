/**
	...
	* API code for job PnlWznmRtj1NRtdpch (declarations)
...
namespace PnlWznmRtj1NRtdpch {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmRtj1NRtdpch::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmRtj1NRtdpch::StatApp statappqry;
