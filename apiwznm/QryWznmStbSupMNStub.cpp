/**
	...
	* API code for job QryWznmStbSupMNStub (implementation)
...
QryWznmStbSupMNStub::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmStbSupMNStub::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmStbSupMNStub");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmStbSupMNStub";
...
set<uint> QryWznmStbSupMNStub::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmStbSupMNStub::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmStbSupMNStub::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmStbSupMNStub");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmStbSupMNStub";
