/**
	...
	* API code for job PnlWznmCtpKParKey (implementation)
...
bool PnlWznmCtpKParKey::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmCtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmCtpKParKey";
...
PnlWznmCtpKParKey::StatApp::StatApp(
...
bool PnlWznmCtpKParKey::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmCtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmCtpKParKey";
...
set<uint> PnlWznmCtpKParKey::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpKParKey::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmCtpKParKey::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmCtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmCtpKParKey";
...
bool PnlWznmCtpKParKey::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCtpKParKey";
...
PnlWznmCtpKParKey::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKPARKEYDATA, scrJref)
		{
...
void PnlWznmCtpKParKey::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCtpKParKeyData");
...
PnlWznmCtpKParKey::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKPARKEYDO, scrJref)
		{
...
void PnlWznmCtpKParKey::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmCtpKParKeyDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmCtpKParKey::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCTPKPARKEYDATA)
		{
...
void PnlWznmCtpKParKey::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCtpKParKeyData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmCtpKParKey::StatApp();
		statshrqry = QryWznmCtpKParKey::StatShr();
