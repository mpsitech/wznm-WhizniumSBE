/**
	...
	* API code for job PnlWznmTbl1NCheck (declarations)
...
namespace PnlWznmTbl1NCheck {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmTbl1NCheck::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTbl1NCheck::StatApp statappqry;
