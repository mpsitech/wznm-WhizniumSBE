/**
	...
	* API code for job PnlWznmVecList (declarations)
...
namespace PnlWznmVecList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmVecList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmVecList::StatApp statappqry;
