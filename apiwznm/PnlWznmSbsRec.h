...
namespace PnlWznmSbsRec {
	...
	public:
		...
		static const Sbecore::uint INITDONETOS1NRELATION = 3;
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneATitle = false, const bool initdoneTos1NRelation = false, const bool initdone1NStub = false, const bool initdone1NTablecol = false, const bool initdoneFrs1NRelation = false, const bool initdonePst1NQuerymod = false, const bool initdoneAsbMNSubset = false, const bool initdoneBsbMNSubset = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREFTOS1NRELATION = 4;
		static const Sbecore::uint SCRJREF1NSTUB = 5;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefATitle = "", const std::string& scrJrefTos1NRelation = "", const std::string& scrJref1NStub = "", const std::string& scrJref1NTablecol = "", const std::string& scrJrefFrs1NRelation = "", const std::string& scrJrefPst1NQuerymod = "", const bool pnlpst1nquerymodAvail = false, const std::string& scrJrefAsbMNSubset = "", const std::string& scrJrefBsbMNSubset = "", const bool ButRegularizeActive = true);
