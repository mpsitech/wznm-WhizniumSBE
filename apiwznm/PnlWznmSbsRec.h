...
namespace PnlWznmSbsRec {
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefATitle = "", const std::string& scrJref1NStub = "", const std::string& scrJrefTos1NRelation = "", const std::string& scrJrefFrs1NRelation = "", const std::string& scrJref1NTablecol = "", const std::string& scrJrefPst1NQuerymod = "", const bool pnlpst1nquerymodAvail = false, const std::string& scrJrefAsbMNSubset = "", const std::string& scrJrefBsbMNSubset = "", const bool ButRegularizeActive = true);
