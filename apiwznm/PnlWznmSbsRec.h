...
namespace PnlWznmSbsRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEFRS1NRELATION = 5;
		static const Sbecore::uint INITDONETOS1NRELATION = 6;
	...
	public:
		...
		static const Sbecore::uint SCRJREFFRS1NRELATION = 6;
		static const Sbecore::uint SCRJREFTOS1NRELATION = 7;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefATitle = "", const std::string& scrJref1NStub = "", const std::string& scrJref1NTablecol = "", const std::string& scrJrefFrs1NRelation = "", const std::string& scrJrefTos1NRelation = "", const std::string& scrJrefPst1NQuerymod = "", const bool pnlpst1nquerymodAvail = false, const std::string& scrJrefAsbMNSubset = "", const std::string& scrJrefBsbMNSubset = "", const bool ButRegularizeActive = true);
