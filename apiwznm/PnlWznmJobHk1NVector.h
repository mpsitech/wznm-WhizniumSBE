/**
	...
	* API code for job PnlWznmJobHk1NVector (declarations)
...
/**
	...
	*/
namespace PnlWznmJobHk1NVector {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmJobHk1NVector::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmJobHk1NVector::StatApp statappqry;
