/**
	...
	* API code for job PnlWznmOpkList (declarations)
...
namespace PnlWznmOpkList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmOpkList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmOpkList::StatApp statappqry;
