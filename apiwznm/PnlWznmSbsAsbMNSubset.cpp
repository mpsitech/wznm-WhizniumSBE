/**
	...
	* API code for job PnlWznmSbsAsbMNSubset (implementation)
...
bool PnlWznmSbsAsbMNSubset::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmSbsAsbMNSubset");
	else
...
PnlWznmSbsAsbMNSubset::StatApp::StatApp(
...
bool PnlWznmSbsAsbMNSubset::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmSbsAsbMNSubset");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmSbsAsbMNSubset::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmSbsAsbMNSubset::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmSbsAsbMNSubset::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmSbsAsbMNSubset");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmSbsAsbMNSubset::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmSbsAsbMNSubset");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmSbsAsbMNSubset::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSBSASBMNSUBSETDATA, scrJref)
		{
...
void PnlWznmSbsAsbMNSubset::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmSbsAsbMNSubsetData");
...
PnlWznmSbsAsbMNSubset::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSBSASBMNSUBSETDO, scrJref)
		{
...
void PnlWznmSbsAsbMNSubset::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmSbsAsbMNSubsetDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmSbsAsbMNSubset::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSBSASBMNSUBSETDATA)
		{
...
void PnlWznmSbsAsbMNSubset::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmSbsAsbMNSubsetData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmSbsAsbMNSubset::StatApp();
		statshrqry = QryWznmSbsAsbMNSubset::StatShr();
