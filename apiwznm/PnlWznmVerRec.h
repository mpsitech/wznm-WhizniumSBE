...
namespace PnlWznmVerRec {
	...
	public:
		...
		static const Sbecore::uint INITDONE1NIMPEXPCPLX = 5;
		static const Sbecore::uint INITDONE1NJOB = 6;
		static const Sbecore::uint INITDONE1NOPPACK = 7;
		static const Sbecore::uint INITDONEVER1NMODULE = 8;
		static const Sbecore::uint INITDONE1NPRESET = 9;
		static const Sbecore::uint INITDONE1NQUERY = 10;
		static const Sbecore::uint INITDONE1NRELATION = 11;
		static const Sbecore::uint INITDONE1NTABLE = 12;
		static const Sbecore::uint INITDONE1NVECTOR = 13;
		static const Sbecore::uint INITDONEVER1NAPP = 14;
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneVer1NError = false, const bool initdone1NComponent = false, const bool initdone1NCall = false, const bool initdone1NImpexpcplx = false, const bool initdone1NJob = false, const bool initdone1NOppack = false, const bool initdoneVer1NModule = false, const bool initdone1NPreset = false, const bool initdone1NQuery = false, const bool initdone1NRelation = false, const bool initdone1NTable = false, const bool initdone1NVector = false, const bool initdoneVer1NApp = false, const bool initdone1NCapability = false, const bool initdoneBvr1NVersion = false, const bool initdone1NBlock = false, const bool initdoneRef1NFile = false, const bool initdoneMNLocale = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREF1NIMPEXPCPLX = 6;
		static const Sbecore::uint SCRJREF1NJOB = 7;
		static const Sbecore::uint SCRJREF1NOPPACK = 8;
		static const Sbecore::uint SCRJREFVER1NMODULE = 9;
		static const Sbecore::uint SCRJREF1NPRESET = 10;
		static const Sbecore::uint SCRJREF1NQUERY = 11;
		static const Sbecore::uint SCRJREF1NRELATION = 12;
		static const Sbecore::uint SCRJREF1NTABLE = 13;
		static const Sbecore::uint SCRJREF1NVECTOR = 14;
		static const Sbecore::uint SCRJREFVER1NAPP = 15;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefVer1NError = "", const std::string& scrJref1NComponent = "", const std::string& scrJref1NCall = "", const std::string& scrJref1NImpexpcplx = "", const std::string& scrJref1NJob = "", const std::string& scrJref1NOppack = "", const std::string& scrJrefVer1NModule = "", const std::string& scrJref1NPreset = "", const std::string& scrJref1NQuery = "", const std::string& scrJref1NRelation = "", const std::string& scrJref1NTable = "", const std::string& scrJref1NVector = "", const std::string& scrJrefVer1NApp = "", const std::string& scrJref1NCapability = "", const std::string& scrJrefBvr1NVersion = "", const std::string& scrJref1NBlock = "", const std::string& scrJrefRef1NFile = "", const std::string& scrJrefMNLocale = "", const bool ButRegularizeActive = true);
