...
namespace PnlWznmVerRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEBVR1NVERSION = 5;
		static const Sbecore::uint INITDONE1NQUERY = 6;
		static const Sbecore::uint INITDONE1NRELATION = 7;
		static const Sbecore::uint INITDONE1NTABLE = 8;
		static const Sbecore::uint INITDONE1NVECTOR = 9;
		static const Sbecore::uint INITDONE1NPRESET = 10;
		static const Sbecore::uint INITDONEVER1NMODULE = 11;
		static const Sbecore::uint INITDONE1NOPPACK = 12;
		static const Sbecore::uint INITDONE1NIMPEXPCPLX = 13;
		static const Sbecore::uint INITDONE1NCOMPONENT = 14;
		static const Sbecore::uint INITDONE1NCALL = 15;
		static const Sbecore::uint INITDONE1NBLOCK = 16;
		static const Sbecore::uint INITDONE1NJOB = 17;
		static const Sbecore::uint INITDONEREF1NFILE = 18;
		static const Sbecore::uint INITDONEMNLOCALE = 19;

	public:
		StatApp(const bool initdoneDetail = false, const bool initdone1NCapability = false, const bool initdoneVer1NApp = false, const bool initdoneVer1NError = false, const bool initdoneBvr1NVersion = false, const bool initdone1NQuery = false, const bool initdone1NRelation = false, const bool initdone1NTable = false, const bool initdone1NVector = false, const bool initdone1NPreset = false, const bool initdoneVer1NModule = false, const bool initdone1NOppack = false, const bool initdone1NImpexpcplx = false, const bool initdone1NComponent = false, const bool initdone1NCall = false, const bool initdone1NBlock = false, const bool initdone1NJob = false, const bool initdoneRef1NFile = false, const bool initdoneMNLocale = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREFBVR1NVERSION = 6;
		static const Sbecore::uint SCRJREF1NQUERY = 7;
		static const Sbecore::uint SCRJREF1NRELATION = 8;
		static const Sbecore::uint SCRJREF1NTABLE = 9;
		static const Sbecore::uint SCRJREF1NVECTOR = 10;
		static const Sbecore::uint SCRJREF1NPRESET = 11;
		static const Sbecore::uint SCRJREFVER1NMODULE = 12;
		static const Sbecore::uint SCRJREF1NOPPACK = 13;
		static const Sbecore::uint SCRJREF1NIMPEXPCPLX = 14;
		static const Sbecore::uint SCRJREF1NCOMPONENT = 15;
		static const Sbecore::uint SCRJREF1NCALL = 16;
		static const Sbecore::uint SCRJREF1NBLOCK = 17;
		static const Sbecore::uint SCRJREF1NJOB = 18;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJref1NCapability = "", const std::string& scrJrefVer1NApp = "", const std::string& scrJrefVer1NError = "", const std::string& scrJrefBvr1NVersion = "", const std::string& scrJref1NQuery = "", const std::string& scrJref1NRelation = "", const std::string& scrJref1NTable = "", const std::string& scrJref1NVector = "", const std::string& scrJref1NPreset = "", const std::string& scrJrefVer1NModule = "", const std::string& scrJref1NOppack = "", const std::string& scrJref1NImpexpcplx = "", const std::string& scrJref1NComponent = "", const std::string& scrJref1NCall = "", const std::string& scrJref1NBlock = "", const std::string& scrJref1NJob = "", const std::string& scrJrefRef1NFile = "", const std::string& scrJrefMNLocale = "", const bool ButRegularizeActive = true);
