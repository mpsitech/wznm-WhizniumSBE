/**
	* \file PnlWznmMtdAInvpar.cpp
	* API code for job PnlWznmMtdAInvpar (implementation)
...
bool PnlWznmMtdAInvpar::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmMtdAInvpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmMtdAInvpar";
...
PnlWznmMtdAInvpar::StatApp::StatApp(
...
bool PnlWznmMtdAInvpar::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmMtdAInvpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmMtdAInvpar";
...
set<uint> PnlWznmMtdAInvpar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdAInvpar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmMtdAInvpar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmMtdAInvpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmMtdAInvpar";
...
bool PnlWznmMtdAInvpar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmMtdAInvpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmMtdAInvpar";
...
PnlWznmMtdAInvpar::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDAINVPARDATA, scrJref)
		{
...
void PnlWznmMtdAInvpar::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmMtdAInvparData");
...
PnlWznmMtdAInvpar::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDAINVPARDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmMtdAInvpar::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmMtdAInvparDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmMtdAInvpar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTDAINVPARDATA)
		{
...
void PnlWznmMtdAInvpar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmMtdAInvparData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmMtdAInvpar::StatApp();
		statshrqry = QryWznmMtdAInvpar::StatShr();
