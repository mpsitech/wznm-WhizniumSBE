/**
	* \file PnlWznmPrjList.h
	* API code for job PnlWznmPrjList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMPRJLIST_H
#define PNLWZNMPRJLIST_H
...
#define VecVWznmPrjListDo PnlWznmPrjList::VecVDo

#define ContIacWznmPrjList PnlWznmPrjList::ContIac
#define ContInfWznmPrjList PnlWznmPrjList::ContInf
#define StatShrWznmPrjList PnlWznmPrjList::StatShr
#define StgIacWznmPrjList PnlWznmPrjList::StgIac
#define TagWznmPrjList PnlWznmPrjList::Tag

#define DpchAppWznmPrjListData PnlWznmPrjList::DpchAppData
#define DpchAppWznmPrjListDo PnlWznmPrjList::DpchAppDo
#define DpchEngWznmPrjListData PnlWznmPrjList::DpchEngData

/**
	* PnlWznmPrjList
	*/
namespace PnlWznmPrjList {
	/**
	...
	public:
		...
		static const Sbecore::uint TCOGRLWIDTH = 6;

	public:
		StgIac(const Sbecore::uint TcoGrpWidth = 100, const Sbecore::uint TcoOwnWidth = 100, const Sbecore::uint TcoShoWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoGrlWidth = 100);
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmPrjList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmPrjList::StatApp statappqry;
