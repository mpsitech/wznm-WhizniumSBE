/**
	...
	* API code for job PnlWznmCalList (declarations)
...
namespace PnlWznmCalList {
	...
	public:
		...
		static const Sbecore::uint TCOIAT = 13;
		static const Sbecore::uint TCORAT = 14;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoTyp = "", const std::string& TcoVer = "", const std::string& TcoRet = "", const std::string& TcoReu = "", const std::string& TcoIat = "", const std::string& TcoRat = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmCalList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCalList::StatApp statappqry;
