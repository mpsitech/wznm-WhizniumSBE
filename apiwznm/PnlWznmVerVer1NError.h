/**
	...
	* API code for job PnlWznmVerVer1NError (declarations)
...
/**
	...
	*/
namespace PnlWznmVerVer1NError {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmVerVer1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmVerVer1NError::StatApp statappqry;
