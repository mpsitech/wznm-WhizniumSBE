/**
	...
	* API code for job QryWznmOpkRef1NBlock (implementation)
...
QryWznmOpkRef1NBlock::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmOpkRef1NBlock::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmOpkRef1NBlock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmOpkRef1NBlock";
...
set<uint> QryWznmOpkRef1NBlock::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmOpkRef1NBlock::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmOpkRef1NBlock::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmOpkRef1NBlock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmOpkRef1NBlock";
