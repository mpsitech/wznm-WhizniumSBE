/**
	* \file PnlWznmMdlList.h
	* API code for job PnlWznmMdlList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMMDLLIST_H
#define PNLWZNMMDLLIST_H
...
#define VecVWznmMdlListDo PnlWznmMdlList::VecVDo

#define ContIacWznmMdlList PnlWznmMdlList::ContIac
#define ContInfWznmMdlList PnlWznmMdlList::ContInf
#define StatShrWznmMdlList PnlWznmMdlList::StatShr
#define StgIacWznmMdlList PnlWznmMdlList::StgIac
#define TagWznmMdlList PnlWznmMdlList::Tag

#define DpchAppWznmMdlListData PnlWznmMdlList::DpchAppData
#define DpchAppWznmMdlListDo PnlWznmMdlList::DpchAppDo
#define DpchEngWznmMdlListData PnlWznmMdlList::DpchEngData

/**
	* PnlWznmMdlList
	*/
namespace PnlWznmMdlList {
	/**
	...
	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoTit = "", const std::string& TcoVer = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmMdlList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmMdlList::StatApp statappqry;
