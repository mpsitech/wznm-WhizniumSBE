/**
	...
	* API code for job PnlWznmCarList (declarations)
...
namespace PnlWznmCarList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmCarList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCarList::StatApp statappqry;
