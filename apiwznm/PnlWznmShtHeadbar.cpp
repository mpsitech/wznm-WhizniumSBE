/**
	* \file PnlWznmShtHeadbar.cpp
	* API code for job PnlWznmShtHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmShtHeadbar::StgInf
 ******************************************************************************/

PnlWznmShtHeadbar::StgInf::StgInf(
...
bool PnlWznmShtHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmShtHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmShtHeadbar";
...
set<uint> PnlWznmShtHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmShtHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmShtHeadbar::Tag
 ******************************************************************************/

PnlWznmShtHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmShtHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmShtHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmShtHeadbar";
...
/******************************************************************************
 class PnlWznmShtHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmShtHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSHTHEADBARDATA)
		{
};

string PnlWznmShtHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmShtHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmShtHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
