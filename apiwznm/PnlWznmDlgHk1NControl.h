/**
	...
	* API code for job PnlWznmDlgHk1NControl (declarations)
...
/**
	...
	*/
namespace PnlWznmDlgHk1NControl {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmDlgHk1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmDlgHk1NControl::StatApp statappqry;
