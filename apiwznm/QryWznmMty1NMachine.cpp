/**
	...
	* API code for job QryWznmMty1NMachine (implementation)
...
/******************************************************************************
 class QryWznmMty1NMachine::StatApp
 ******************************************************************************/

QryWznmMty1NMachine::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmMty1NMachine::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmMty1NMachine");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmMty1NMachine";
...
set<uint> QryWznmMty1NMachine::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMty1NMachine::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmMty1NMachine::StatShr
 ******************************************************************************/

QryWznmMty1NMachine::StatShr::StatShr(
			const uint ntot
...
bool QryWznmMty1NMachine::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmMty1NMachine");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmMty1NMachine";
...
set<uint> QryWznmMty1NMachine::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMty1NMachine::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmMty1NMachine::StgIac
 ******************************************************************************/

QryWznmMty1NMachine::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmMty1NMachine::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmMty1NMachine");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmMty1NMachine";
...
void QryWznmMty1NMachine::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmMty1NMachine";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmMty1NMachine";
...
set<uint> QryWznmMty1NMachine::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMty1NMachine::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
