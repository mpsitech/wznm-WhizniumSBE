/**
	...
	* API code for job QryWznmTbl1NImpexp (implementation)
...
/******************************************************************************
 class QryWznmTbl1NImpexp::StatApp
 ******************************************************************************/

QryWznmTbl1NImpexp::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmTbl1NImpexp::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmTbl1NImpexp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmTbl1NImpexp";
...
set<uint> QryWznmTbl1NImpexp::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTbl1NImpexp::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmTbl1NImpexp::StatShr
 ******************************************************************************/

QryWznmTbl1NImpexp::StatShr::StatShr(
			const uint ntot
...
bool QryWznmTbl1NImpexp::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmTbl1NImpexp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmTbl1NImpexp";
...
set<uint> QryWznmTbl1NImpexp::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTbl1NImpexp::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmTbl1NImpexp::StgIac
 ******************************************************************************/

QryWznmTbl1NImpexp::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmTbl1NImpexp::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmTbl1NImpexp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmTbl1NImpexp";
...
void QryWznmTbl1NImpexp::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmTbl1NImpexp";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmTbl1NImpexp";
...
set<uint> QryWznmTbl1NImpexp::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTbl1NImpexp::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
