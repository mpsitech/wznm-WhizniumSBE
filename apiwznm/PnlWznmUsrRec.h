/**
	...
	* API code for job PnlWznmUsrRec (declarations)
...
namespace PnlWznmUsrRec {
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefAAccess = "", const std::string& scrJref1NSession = "", const std::string& scrJrefMNUsergroup = "", const bool ButRegularizeActive = true);
