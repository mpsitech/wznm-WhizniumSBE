/**
	...
	* API code for job PnlWznmPrsMNProject (implementation)
...
bool PnlWznmPrsMNProject::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmPrsMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmPrsMNProject";
...
PnlWznmPrsMNProject::StatApp::StatApp(
...
bool PnlWznmPrsMNProject::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmPrsMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmPrsMNProject";
...
set<uint> PnlWznmPrsMNProject::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPrsMNProject::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmPrsMNProject::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmPrsMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmPrsMNProject";
...
bool PnlWznmPrsMNProject::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmPrsMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmPrsMNProject";
...
PnlWznmPrsMNProject::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRSMNPROJECTDATA, scrJref)
		{
...
void PnlWznmPrsMNProject::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmPrsMNProjectData");
...
PnlWznmPrsMNProject::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRSMNPROJECTDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmPrsMNProject::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmPrsMNProjectDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmPrsMNProject::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMPRSMNPROJECTDATA)
		{
...
void PnlWznmPrsMNProject::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmPrsMNProjectData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmPrsMNProject::StatApp();
		statshrqry = QryWznmPrsMNProject::StatShr();
