/**
	* \file CrdWznmErr.cpp
	* API code for job CrdWznmErr (implementation)
...
bool CrdWznmErr::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmErr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmErr";
...
bool CrdWznmErr::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmErr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmErr";
...
set<uint> CrdWznmErr::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWznmErr::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWznmErr::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmErr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmErr";
...
bool CrdWznmErr::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmErr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmErr";
...
CrdWznmErr::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMERRDO, scrJref)
		{
...
void CrdWznmErr::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmErrDo");
...
CrdWznmErr::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMERRDATA)
		{
...
void CrdWznmErr::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmErrData");
	else
		basefound = checkXPath(docctx, basexpath);
