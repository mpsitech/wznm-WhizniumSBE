/**
	...
	* API code for job PnlWznmIexList (declarations)
...
namespace PnlWznmIexList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmIexList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmIexList::StatApp statappqry;
