...
PnlWznmMchRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEAPAR, INITDONE1NRELEASE};
};
...
set<uint> PnlWznmMchRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEAPAR, INITDONE1NRELEASE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmMchRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAPAR, SCRJREF1NRELEASE, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmMchRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFAPAR, SCRJREF1NRELEASE, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
