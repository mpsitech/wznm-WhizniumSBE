/**
	...
	* API code for job PnlWznmMtyAMakefile (implementation)
...
bool PnlWznmMtyAMakefile::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmMtyAMakefile");
	else
...
PnlWznmMtyAMakefile::StatApp::StatApp(
...
bool PnlWznmMtyAMakefile::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmMtyAMakefile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtyAMakefile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmMtyAMakefile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmMtyAMakefile::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmMtyAMakefile::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTYAMAKEFILEDATA, scrJref)
		{
...
void PnlWznmMtyAMakefile::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmMtyAMakefileData");
...
PnlWznmMtyAMakefile::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTYAMAKEFILEDO, scrJref)
		{
...
void PnlWznmMtyAMakefile::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmMtyAMakefileDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmMtyAMakefile::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTYAMAKEFILEDATA)
		{
...
void PnlWznmMtyAMakefile::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmMtyAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmMtyAMakefile::StatApp();
		statshrqry = QryWznmMtyAMakefile::StatShr();
