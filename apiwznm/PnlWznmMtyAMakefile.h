/**
	...
	* API code for job PnlWznmMtyAMakefile (declarations)
...
namespace PnlWznmMtyAMakefile {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmMtyAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmMtyAMakefile::StatApp statappqry;
