/**
	...
	* API code for job QryWznmCarCar1NPanel (implementation)
...
QryWznmCarCar1NPanel::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmCarCar1NPanel::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmCarCar1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmCarCar1NPanel";
...
set<uint> QryWznmCarCar1NPanel::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmCarCar1NPanel::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmCarCar1NPanel::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmCarCar1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmCarCar1NPanel";
