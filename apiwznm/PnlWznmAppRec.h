...
namespace PnlWznmAppRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEAPP1NSEQUENCE = 2;
		static const Sbecore::uint INITDONE1NRTJOB = 3;
		static const Sbecore::uint INITDONEREF1NFILE = 4;

	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneApp1NSequence = false, const bool initdone1NRtjob = false, const bool initdoneRef1NFile = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREFAPP1NSEQUENCE = 3;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefApp1NSequence = "", const std::string& scrJref1NRtjob = "", const std::string& scrJrefRef1NFile = "", const bool ButRegularizeActive = true);
