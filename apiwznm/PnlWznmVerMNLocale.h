/**
	...
	* API code for job PnlWznmVerMNLocale (declarations)
...
namespace PnlWznmVerMNLocale {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmVerMNLocale::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmVerMNLocale::StatApp statappqry;
