/**
	...
	* API code for job PnlWznmTblMNQuery (declarations)
...
namespace PnlWznmTblMNQuery {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmTblMNQuery::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTblMNQuery::StatApp statappqry;
