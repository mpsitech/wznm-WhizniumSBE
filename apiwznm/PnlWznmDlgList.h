/**
	...
	* API code for job PnlWznmDlgList (declarations)
...
namespace PnlWznmDlgList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmDlgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmDlgList::StatApp statappqry;
