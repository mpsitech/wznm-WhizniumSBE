...
bool PnlWznmTco1NImpexpcol::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmTco1NImpexpcol");
	else
...
PnlWznmTco1NImpexpcol::StatApp::StatApp(
...
bool PnlWznmTco1NImpexpcol::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmTco1NImpexpcol");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmTco1NImpexpcol::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTco1NImpexpcol::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmTco1NImpexpcol::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmTco1NImpexpcol");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTco1NImpexpcol::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCO1NIMPEXPCOLDATA, scrJref)
		{
...
void PnlWznmTco1NImpexpcol::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmTco1NImpexpcolData");
...
PnlWznmTco1NImpexpcol::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCO1NIMPEXPCOLDO, scrJref)
		{
...
void PnlWznmTco1NImpexpcol::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmTco1NImpexpcolDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmTco1NImpexpcol::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTCO1NIMPEXPCOLDATA)
		{
...
void PnlWznmTco1NImpexpcol::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmTco1NImpexpcolData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmTco1NImpexpcol::StatApp();
		statshrqry = QryWznmTco1NImpexpcol::StatShr();
