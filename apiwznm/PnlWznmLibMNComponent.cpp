/**
	...
	* API code for job PnlWznmLibMNComponent (implementation)
...
bool PnlWznmLibMNComponent::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmLibMNComponent");
	else
...
PnlWznmLibMNComponent::StatApp::StatApp(
...
bool PnlWznmLibMNComponent::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmLibMNComponent");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmLibMNComponent::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibMNComponent::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmLibMNComponent::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmLibMNComponent");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmLibMNComponent::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmLibMNComponent");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmLibMNComponent::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBMNCOMPONENTDATA, scrJref)
		{
...
void PnlWznmLibMNComponent::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibMNComponentData");
...
PnlWznmLibMNComponent::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBMNCOMPONENTDO, scrJref)
		{
...
void PnlWznmLibMNComponent::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmLibMNComponentDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmLibMNComponent::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBMNCOMPONENTDATA)
		{
...
void PnlWznmLibMNComponent::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmLibMNComponentData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmLibMNComponent::StatApp();
		statshrqry = QryWznmLibMNComponent::StatShr();
