/**
	...
	* API code for job PnlWznmIexRef1NDialog (implementation)
...
bool PnlWznmIexRef1NDialog::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmIexRef1NDialog");
	else
...
PnlWznmIexRef1NDialog::StatApp::StatApp(
...
bool PnlWznmIexRef1NDialog::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmIexRef1NDialog");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmIexRef1NDialog::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmIexRef1NDialog::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmIexRef1NDialog::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmIexRef1NDialog");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmIexRef1NDialog::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmIexRef1NDialog");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmIexRef1NDialog::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMIEXREF1NDIALOGDATA, scrJref)
		{
...
void PnlWznmIexRef1NDialog::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmIexRef1NDialogData");
...
PnlWznmIexRef1NDialog::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMIEXREF1NDIALOGDO, scrJref)
		{
...
void PnlWznmIexRef1NDialog::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmIexRef1NDialogDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmIexRef1NDialog::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMIEXREF1NDIALOGDATA)
		{
...
void PnlWznmIexRef1NDialog::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmIexRef1NDialogData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmIexRef1NDialog::StatApp();
		statshrqry = QryWznmIexRef1NDialog::StatShr();
