/**
	...
	* API code for job PnlWznmCtpKParKey (declarations)
...
namespace PnlWznmCtpKParKey {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmCtpKParKey::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCtpKParKey::StatApp statappqry;
