/**
	...
	* API code for job QryWznmTblRef1NRtblock (implementation)
...
QryWznmTblRef1NRtblock::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmTblRef1NRtblock::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmTblRef1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmTblRef1NRtblock";
...
set<uint> QryWznmTblRef1NRtblock::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblRef1NRtblock::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmTblRef1NRtblock::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmTblRef1NRtblock");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmTblRef1NRtblock";
