/**
	...
	* API code for job QryWznmStbMNSquawk (implementation)
...
QryWznmStbMNSquawk::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmStbMNSquawk::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmStbMNSquawk");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmStbMNSquawk";
...
set<uint> QryWznmStbMNSquawk::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmStbMNSquawk::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmStbMNSquawk::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmStbMNSquawk");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmStbMNSquawk";
