...
namespace PnlWznmQryRec {
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneAClause = false, const bool initdoneAOrder = false, const bool initdone1NQuerymod = false, const bool initdoneQry1NQuerycol = false, const bool initdoneSup1NQuery = false, const bool initdoneMNTable = false, const bool initdoneMNPanel = false, const bool initdoneMNDialog = false);
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefAClause = "", const std::string& scrJrefAOrder = "", const std::string& scrJref1NQuerymod = "", const std::string& scrJrefQry1NQuerycol = "", const std::string& scrJrefSup1NQuery = "", const std::string& scrJrefMNTable = "", const std::string& scrJrefMNPanel = "", const std::string& scrJrefMNDialog = "", const bool ButRegularizeActive = true);
