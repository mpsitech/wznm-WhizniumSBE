/**
	* \file CrdWznmPrj.cpp
	* API code for job CrdWznmPrj (implementation)
...
bool CrdWznmPrj::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmPrj");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWznmPrj";
...
bool CrdWznmPrj::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmPrj");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWznmPrj";
...
set<uint> CrdWznmPrj::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWznmPrj::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWznmPrj::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmPrj");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWznmPrj";
...
bool CrdWznmPrj::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmPrj");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmPrj";
...
CrdWznmPrj::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRJDO, scrJref)
		{
...
void CrdWznmPrj::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmPrjDo");
...
CrdWznmPrj::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMPRJDATA)
		{
...
void CrdWznmPrj::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmPrjData");
	else
		basefound = checkXPath(docctx, basexpath);
