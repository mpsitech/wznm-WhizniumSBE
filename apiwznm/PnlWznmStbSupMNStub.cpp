/**
	...
	* API code for job PnlWznmStbSupMNStub (implementation)
...
bool PnlWznmStbSupMNStub::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmStbSupMNStub");
	else
...
PnlWznmStbSupMNStub::StatApp::StatApp(
...
bool PnlWznmStbSupMNStub::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmStbSupMNStub");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmStbSupMNStub::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmStbSupMNStub::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmStbSupMNStub::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmStbSupMNStub");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmStbSupMNStub::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmStbSupMNStub");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmStbSupMNStub::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBSUPMNSTUBDATA, scrJref)
		{
...
void PnlWznmStbSupMNStub::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmStbSupMNStubData");
...
PnlWznmStbSupMNStub::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBSUPMNSTUBDO, scrJref)
		{
...
void PnlWznmStbSupMNStub::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmStbSupMNStubDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmStbSupMNStub::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSTBSUPMNSTUBDATA)
		{
...
void PnlWznmStbSupMNStub::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmStbSupMNStubData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmStbSupMNStub::StatApp();
		statshrqry = QryWznmStbSupMNStub::StatShr();
