...
uint ApiWznm::readDpchEng(
	...
	try {
		...
		} else if (ixWznmVDpch == VecWznmVDpch::DPCHENGWZNMPRJ1NVERSIONDATA) {
			*dpcheng = new PnlWznmPrj1NVersion::DpchEngData();
			((PnlWznmPrj1NVersion::DpchEngData*) *dpcheng)->readXML(docctx, "/", true);
