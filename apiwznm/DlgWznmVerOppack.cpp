/**
	...
	* API code for job DlgWznmVerOppack (implementation)
...
bool DlgWznmVerOppack::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVerOppack");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::ContInfImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVerOppackImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::ContInfLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWznmVerOppackLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVerOppack::StatApp::StatApp(
			const bool initdone
...
bool DlgWznmVerOppack::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppDlgWznmVerOppack");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> DlgWznmVerOppack::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> DlgWznmVerOppack::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool DlgWznmVerOppack::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVerOppack");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::StatShrIfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVerOppackIfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::StatShrImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVerOppackImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::StatShrLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWznmVerOppackLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool DlgWznmVerOppack::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVerOppack");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVerOppack::TagIfi::TagIfi(
			const string& Uld
			, const string& Cpt
		) :
			Block()
...
bool DlgWznmVerOppack::TagIfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVerOppackIfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVerOppack::TagImp::TagImp(
			const string& CptPrg
			, const string& ButRun
			, const string& ButSto
		) :
...
bool DlgWznmVerOppack::TagImp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVerOppackImp");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVerOppack::TagLfi::TagLfi(
			const string& Dld
		) :
			Block()
		{
...
bool DlgWznmVerOppack::TagLfi::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWznmVerOppackLfi");
	else
		basefound = checkXPath(docctx, basexpath);
...
DlgWznmVerOppack::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPDLGWZNMVEROPPACKDATA, scrJref)
		{
...
void DlgWznmVerOppack::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWznmVerOppackData");
...
DlgWznmVerOppack::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPDLGWZNMVEROPPACKDO, scrJref)
		{
...
void DlgWznmVerOppack::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWznmVerOppackDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
DlgWznmVerOppack::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGDLGWZNMVEROPPACKDATA)
		{
...
void DlgWznmVerOppack::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngDlgWznmVerOppackData");
	else
		basefound = checkXPath(docctx, basexpath);
