...
PnlWznmTcoRec::StatApp::StatApp(
	...
	mask = {INITDONEDETAIL, INITDONEATITLE, INITDONE1NQUERYCOL, INITDONE1NIMPEXPCOL, INITDONEREF1NCONTROL, INITDONEREF1NQUERYMOD, INITDONE1NCHECK};
};
...
set<uint> PnlWznmTcoRec::StatApp::diff(
	...
	diffitems = {INITDONEDETAIL, INITDONEATITLE, INITDONE1NQUERYCOL, INITDONE1NIMPEXPCOL, INITDONEREF1NCONTROL, INITDONEREF1NQUERYMOD, INITDONE1NCHECK};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
PnlWznmTcoRec::StatShr::StatShr(
	...
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREF1NQUERYCOL, PNL1NQUERYCOLAVAIL, SCRJREF1NIMPEXPCOL, PNL1NIMPEXPCOLAVAIL, SCRJREFREF1NCONTROL, PNLREF1NCONTROLAVAIL, SCRJREFREF1NQUERYMOD, PNLREF1NQUERYMODAVAIL, SCRJREF1NCHECK, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmTcoRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREF1NQUERYCOL, PNL1NQUERYCOLAVAIL, SCRJREF1NIMPEXPCOL, PNL1NIMPEXPCOLAVAIL, SCRJREFREF1NCONTROL, PNLREF1NCONTROLAVAIL, SCRJREFREF1NQUERYMOD, PNLREF1NQUERYMODAVAIL, SCRJREF1NCHECK, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
