/**
	...
	* API code for job PnlWznmVitList (declarations)
...
namespace PnlWznmVitList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmVitList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmVitList::StatApp statappqry;
