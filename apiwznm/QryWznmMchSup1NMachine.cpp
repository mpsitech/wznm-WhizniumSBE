/**
	...
	* API code for job QryWznmMchSup1NMachine (implementation)
...
QryWznmMchSup1NMachine::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmMchSup1NMachine::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmMchSup1NMachine");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmMchSup1NMachine";
...
set<uint> QryWznmMchSup1NMachine::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMchSup1NMachine::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmMchSup1NMachine::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmMchSup1NMachine");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmMchSup1NMachine";
