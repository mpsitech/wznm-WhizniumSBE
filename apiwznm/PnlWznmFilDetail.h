/**
	...
	* API code for job PnlWznmFilDetail (declarations)
...
namespace PnlWznmFilDetail {
	...
	public:
		StatApp(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::MIND, const bool LstCluAlt = true, const bool PupCntAlt = false, const bool PupMimAlt = false, const Sbecore::uint LstCluNumFirstdisp = 1);
