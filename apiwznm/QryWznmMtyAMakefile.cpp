/**
	...
	* API code for job QryWznmMtyAMakefile (implementation)
...
/******************************************************************************
 class QryWznmMtyAMakefile::StatApp
 ******************************************************************************/

QryWznmMtyAMakefile::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmMtyAMakefile::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmMtyAMakefile";
...
set<uint> QryWznmMtyAMakefile::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMtyAMakefile::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmMtyAMakefile::StatShr
 ******************************************************************************/

QryWznmMtyAMakefile::StatShr::StatShr(
			const uint ntot
...
bool QryWznmMtyAMakefile::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmMtyAMakefile";
...
set<uint> QryWznmMtyAMakefile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMtyAMakefile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmMtyAMakefile::StgIac
 ******************************************************************************/

QryWznmMtyAMakefile::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmMtyAMakefile::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmMtyAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmMtyAMakefile";
...
void QryWznmMtyAMakefile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmMtyAMakefile";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmMtyAMakefile";
...
set<uint> QryWznmMtyAMakefile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMtyAMakefile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
