/**
	...
	* API code for job PnlWznmBoxDstMNBox (implementation)
...
bool PnlWznmBoxDstMNBox::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmBoxDstMNBox");
	else
...
PnlWznmBoxDstMNBox::StatApp::StatApp(
...
bool PnlWznmBoxDstMNBox::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmBoxDstMNBox");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmBoxDstMNBox::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmBoxDstMNBox::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmBoxDstMNBox::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmBoxDstMNBox");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmBoxDstMNBox::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmBoxDstMNBox");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmBoxDstMNBox::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMBOXDSTMNBOXDATA, scrJref)
		{
...
void PnlWznmBoxDstMNBox::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmBoxDstMNBoxData");
...
PnlWznmBoxDstMNBox::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMBOXDSTMNBOXDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmBoxDstMNBox::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmBoxDstMNBoxDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmBoxDstMNBox::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMBOXDSTMNBOXDATA)
		{
...
void PnlWznmBoxDstMNBox::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmBoxDstMNBoxData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmBoxDstMNBox::StatApp();
		statshrqry = QryWznmBoxDstMNBox::StatShr();
