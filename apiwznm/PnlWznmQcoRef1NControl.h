...
/**
	...
	*/
namespace PnlWznmQcoRef1NControl {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmQcoRef1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmQcoRef1NControl::StatApp statappqry;
