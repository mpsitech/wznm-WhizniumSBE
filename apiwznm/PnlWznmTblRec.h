...
namespace PnlWznmTblRec {
	...
	public:
		...
		static const Sbecore::uint INITDONE1NSUBSET = 5;
		static const Sbecore::uint INITDONEFR1NRELATION = 6;
		static const Sbecore::uint INITDONE1NIMPEXP = 7;
		static const Sbecore::uint INITDONE1NCHECK = 8;
		static const Sbecore::uint INITDONE1NSTUB = 9;
		static const Sbecore::uint INITDONETO1NRELATION = 10;
		static const Sbecore::uint INITDONEREF1NQUERYMOD = 11;
		static const Sbecore::uint INITDONEREF1NRTBLOCK = 12;
		static const Sbecore::uint INITDONEFCT1NTABLECOL = 13;
		static const Sbecore::uint INITDONEREF1NDIALOG = 14;
		static const Sbecore::uint INITDONEREF1NCALL = 15;
		static const Sbecore::uint INITDONESRC1NFEED = 16;
		static const Sbecore::uint INITDONEREF1NPANEL = 17;
		static const Sbecore::uint INITDONEHK1NVECTOR = 18;
	...
	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneATitle = false, const bool initdoneALoadfct = false, const bool initdoneTbl1NTablecol = false, const bool initdone1NSubset = false, const bool initdoneFr1NRelation = false, const bool initdone1NImpexp = false, const bool initdone1NCheck = false, const bool initdone1NStub = false, const bool initdoneTo1NRelation = false, const bool initdoneRef1NQuerymod = false, const bool initdoneRef1NRtblock = false, const bool initdoneFct1NTablecol = false, const bool initdoneRef1NDialog = false, const bool initdoneRef1NCall = false, const bool initdoneSrc1NFeed = false, const bool initdoneRef1NPanel = false, const bool initdoneHk1NVector = false, const bool initdonePst1NQuerymod = false, const bool initdoneMNVector = false, const bool initdoneMNQuery = false);
	...
	public:
		...
		static const Sbecore::uint SCRJREF1NSUBSET = 8;
		static const Sbecore::uint PNL1NSUBSETAVAIL = 9;
		static const Sbecore::uint SCRJREFFR1NRELATION = 10;
		static const Sbecore::uint PNLFR1NRELATIONAVAIL = 11;
		static const Sbecore::uint SCRJREF1NIMPEXP = 12;
		static const Sbecore::uint PNL1NIMPEXPAVAIL = 13;
		static const Sbecore::uint SCRJREF1NCHECK = 14;
		static const Sbecore::uint PNL1NCHECKAVAIL = 15;
		static const Sbecore::uint SCRJREF1NSTUB = 16;
		static const Sbecore::uint PNL1NSTUBAVAIL = 17;
		static const Sbecore::uint SCRJREFTO1NRELATION = 18;
		static const Sbecore::uint PNLTO1NRELATIONAVAIL = 19;
		static const Sbecore::uint SCRJREFREF1NQUERYMOD = 20;
		static const Sbecore::uint SCRJREFREF1NRTBLOCK = 21;
		static const Sbecore::uint SCRJREFFCT1NTABLECOL = 22;
		static const Sbecore::uint PNLFCT1NTABLECOLAVAIL = 23;
		static const Sbecore::uint SCRJREFREF1NDIALOG = 24;
		static const Sbecore::uint PNLREF1NDIALOGAVAIL = 25;
		static const Sbecore::uint SCRJREFREF1NCALL = 26;
		static const Sbecore::uint PNLREF1NCALLAVAIL = 27;
		static const Sbecore::uint SCRJREFSRC1NFEED = 28;
		static const Sbecore::uint SCRJREFREF1NPANEL = 29;
		static const Sbecore::uint SCRJREFHK1NVECTOR = 30;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefATitle = "", const bool pnlatitleAvail = false, const std::string& scrJrefALoadfct = "", const bool pnlaloadfctAvail = false, const std::string& scrJrefTbl1NTablecol = "", const std::string& scrJref1NSubset = "", const bool pnl1nsubsetAvail = false, const std::string& scrJrefFr1NRelation = "", const bool pnlfr1nrelationAvail = false, const std::string& scrJref1NImpexp = "", const bool pnl1nimpexpAvail = false, const std::string& scrJref1NCheck = "", const bool pnl1ncheckAvail = false, const std::string& scrJref1NStub = "", const bool pnl1nstubAvail = false, const std::string& scrJrefTo1NRelation = "", const bool pnlto1nrelationAvail = false, const std::string& scrJrefRef1NQuerymod = "", const std::string& scrJrefRef1NRtblock = "", const std::string& scrJrefFct1NTablecol = "", const bool pnlfct1ntablecolAvail = false, const std::string& scrJrefRef1NDialog = "", const bool pnlref1ndialogAvail = false, const std::string& scrJrefRef1NCall = "", const bool pnlref1ncallAvail = false, const std::string& scrJrefSrc1NFeed = "", const std::string& scrJrefRef1NPanel = "", const std::string& scrJrefHk1NVector = "", const std::string& scrJrefPst1NQuerymod = "", const bool pnlpst1nquerymodAvail = false, const std::string& scrJrefMNVector = "", const bool pnlmnvectorAvail = false, const std::string& scrJrefMNQuery = "", const bool pnlmnqueryAvail = false, const bool ButRegularizeActive = true);
