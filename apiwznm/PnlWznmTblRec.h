...
namespace PnlWznmTblRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEREF1NPANEL = 12;
		static const Sbecore::uint INITDONEREF1NQUERYMOD = 13;
	...
	public:
		...
		static const Sbecore::uint SCRJREFREF1NPANEL = 21;
		static const Sbecore::uint SCRJREFREF1NQUERYMOD = 22;
		static const Sbecore::uint SCRJREFHK1NVECTOR = 23;
		static const Sbecore::uint SCRJREFFCT1NTABLECOL = 24;
		static const Sbecore::uint PNLFCT1NTABLECOLAVAIL = 25;
		static const Sbecore::uint SCRJREFSRC1NFEED = 26;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefALoadfct = "", const bool pnlaloadfctAvail = false, const std::string& scrJrefATitle = "", const bool pnlatitleAvail = false, const std::string& scrJrefFr1NRelation = "", const bool pnlfr1nrelationAvail = false, const std::string& scrJrefTo1NRelation = "", const bool pnlto1nrelationAvail = false, const std::string& scrJref1NStub = "", const bool pnl1nstubAvail = false, const std::string& scrJref1NSubset = "", const bool pnl1nsubsetAvail = false, const std::string& scrJrefTbl1NTablecol = "", const std::string& scrJref1NImpexp = "", const bool pnl1nimpexpAvail = false, const std::string& scrJref1NCheck = "", const bool pnl1ncheckAvail = false, const std::string& scrJrefRef1NRtblock = "", const std::string& scrJrefRef1NPanel = "", const std::string& scrJrefRef1NQuerymod = "", const std::string& scrJrefHk1NVector = "", const std::string& scrJrefFct1NTablecol = "", const bool pnlfct1ntablecolAvail = false, const std::string& scrJrefSrc1NFeed = "", const std::string& scrJrefRef1NCall = "", const bool pnlref1ncallAvail = false, const std::string& scrJrefRef1NDialog = "", const bool pnlref1ndialogAvail = false, const std::string& scrJrefPst1NQuerymod = "", const bool pnlpst1nquerymodAvail = false, const std::string& scrJrefMNVector = "", const bool pnlmnvectorAvail = false, const std::string& scrJrefMNQuery = "", const bool pnlmnqueryAvail = false, const bool ButRegularizeActive = true);
