/**
	* \file PnlWznmJobSubMNJob.cpp
	* API code for job PnlWznmJobSubMNJob (implementation)
...
bool PnlWznmJobSubMNJob::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWznmJobSubMNJob");
	else
...
PnlWznmJobSubMNJob::StatApp::StatApp(
...
bool PnlWznmJobSubMNJob::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWznmJobSubMNJob");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWznmJobSubMNJob::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmJobSubMNJob::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWznmJobSubMNJob::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWznmJobSubMNJob");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWznmJobSubMNJob::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmJobSubMNJob");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmJobSubMNJob::DpchAppData::DpchAppData(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUBMNJOBDATA, scrJref)
		{
...
void PnlWznmJobSubMNJob::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmJobSubMNJobData");
...
PnlWznmJobSubMNJob::DpchAppDo::DpchAppDo(
			...
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUBMNJOBDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWznmJobSubMNJob::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWznmJobSubMNJobDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWznmJobSubMNJob::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMJOBSUBMNJOBDATA)
		{
...
void PnlWznmJobSubMNJob::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmJobSubMNJobData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWznmJobSubMNJob::StatApp();
		statshrqry = QryWznmJobSubMNJob::StatShr();
