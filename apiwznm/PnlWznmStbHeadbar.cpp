/**
	* \file PnlWznmStbHeadbar.cpp
	* API code for job PnlWznmStbHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmStbHeadbar::StgInf
 ******************************************************************************/

PnlWznmStbHeadbar::StgInf::StgInf(
...
bool PnlWznmStbHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmStbHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmStbHeadbar";
...
set<uint> PnlWznmStbHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmStbHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmStbHeadbar::Tag
 ******************************************************************************/

PnlWznmStbHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmStbHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmStbHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmStbHeadbar";
...
/******************************************************************************
 class PnlWznmStbHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmStbHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSTBHEADBARDATA)
		{
};

string PnlWznmStbHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmStbHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmStbHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
