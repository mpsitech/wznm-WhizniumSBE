/**
	* \file QryWznmRel1NTablecol.cpp
	* API code for job QryWznmRel1NTablecol (implementation)
...
QryWznmRel1NTablecol::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmRel1NTablecol::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmRel1NTablecol");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmRel1NTablecol";
...
set<uint> QryWznmRel1NTablecol::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRel1NTablecol::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmRel1NTablecol::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmRel1NTablecol");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmRel1NTablecol";
