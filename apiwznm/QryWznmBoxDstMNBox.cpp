/**
	...
	* API code for job QryWznmBoxDstMNBox (implementation)
...
QryWznmBoxDstMNBox::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmBoxDstMNBox::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmBoxDstMNBox");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmBoxDstMNBox";
...
set<uint> QryWznmBoxDstMNBox::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmBoxDstMNBox::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmBoxDstMNBox::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmBoxDstMNBox");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmBoxDstMNBox";
