/**
	* \file PnlWznmRelHeadbar.cpp
	* API code for job PnlWznmRelHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmRelHeadbar::StgInf
 ******************************************************************************/

PnlWznmRelHeadbar::StgInf::StgInf(
...
bool PnlWznmRelHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmRelHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmRelHeadbar";
...
set<uint> PnlWznmRelHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmRelHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmRelHeadbar::Tag
 ******************************************************************************/

PnlWznmRelHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmRelHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmRelHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmRelHeadbar";
...
/******************************************************************************
 class PnlWznmRelHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmRelHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMRELHEADBARDATA)
		{
};

string PnlWznmRelHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmRelHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmRelHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
