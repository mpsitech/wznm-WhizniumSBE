/**
	...
	* API code for job PnlWznmMchAPar (declarations)
...
namespace PnlWznmMchAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmMchAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmMchAPar::StatApp statappqry;
