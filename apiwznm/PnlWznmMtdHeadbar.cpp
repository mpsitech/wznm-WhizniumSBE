/**
	* \file PnlWznmMtdHeadbar.cpp
	* API code for job PnlWznmMtdHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmMtdHeadbar::StgInf
 ******************************************************************************/

PnlWznmMtdHeadbar::StgInf::StgInf(
...
bool PnlWznmMtdHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmMtdHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmMtdHeadbar";
...
set<uint> PnlWznmMtdHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdHeadbar::Tag
 ******************************************************************************/

PnlWznmMtdHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmMtdHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmMtdHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmMtdHeadbar";
...
/******************************************************************************
 class PnlWznmMtdHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmMtdHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTDHEADBARDATA)
		{
};

string PnlWznmMtdHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmMtdHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
