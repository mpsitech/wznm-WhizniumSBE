/**
	* \file PnlWznmCtpHeadbar.cpp
	* API code for job PnlWznmCtpHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmCtpHeadbar::StgInf
 ******************************************************************************/

PnlWznmCtpHeadbar::StgInf::StgInf(
...
bool PnlWznmCtpHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmCtpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmCtpHeadbar";
...
set<uint> PnlWznmCtpHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCtpHeadbar::Tag
 ******************************************************************************/

PnlWznmCtpHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmCtpHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmCtpHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmCtpHeadbar";
...
/******************************************************************************
 class PnlWznmCtpHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmCtpHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCTPHEADBARDATA)
		{
};

string PnlWznmCtpHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCtpHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmCtpHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
