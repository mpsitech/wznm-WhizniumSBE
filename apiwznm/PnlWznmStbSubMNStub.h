/**
	...
	* API code for job PnlWznmStbSubMNStub (declarations)
...
namespace PnlWznmStbSubMNStub {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmStbSubMNStub::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmStbSubMNStub::StatApp statappqry;
