/**
	...
	* API code for job PnlWznmUsrAAccess (declarations)
...
namespace PnlWznmUsrAAccess {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmUsrAAccess::StatApp statappqry;
