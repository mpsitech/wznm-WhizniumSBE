/**
	* \file PnlWznmBoxHeadbar.cpp
	* API code for job PnlWznmBoxHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmBoxHeadbar::StgInf
 ******************************************************************************/

PnlWznmBoxHeadbar::StgInf::StgInf(
...
bool PnlWznmBoxHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmBoxHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmBoxHeadbar";
...
set<uint> PnlWznmBoxHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmBoxHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmBoxHeadbar::Tag
 ******************************************************************************/

PnlWznmBoxHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmBoxHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmBoxHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmBoxHeadbar";
...
/******************************************************************************
 class PnlWznmBoxHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmBoxHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMBOXHEADBARDATA)
		{
};

string PnlWznmBoxHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmBoxHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmBoxHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
