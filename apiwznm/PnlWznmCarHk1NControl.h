/**
	...
	* API code for job PnlWznmCarHk1NControl (declarations)
...
/**
	...
	*/
namespace PnlWznmCarHk1NControl {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmCarHk1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmCarHk1NControl::StatApp statappqry;
