...
PnlWznmTblRec::StatApp::StatApp(
			...
			, initdoneALoadfct(initdoneALoadfct)
			, initdoneTbl1NTablecol(initdoneTbl1NTablecol)
			, initdone1NSubset(initdone1NSubset)
			, initdone1NStub(initdone1NStub)
			, initdoneTo1NRelation(initdoneTo1NRelation)
			, initdoneFr1NRelation(initdoneFr1NRelation)
			, initdone1NCheck(initdone1NCheck)
			, initdone1NImpexp(initdone1NImpexp)
			, initdoneRef1NRtblock(initdoneRef1NRtblock)
			, initdoneRef1NQuerymod(initdoneRef1NQuerymod)
			...
			, initdoneRef1NCall(initdoneRef1NCall)
			, initdoneRef1NDialog(initdoneRef1NDialog)
			, initdonePst1NQuerymod(initdonePst1NQuerymod)
			, initdoneMNVector(initdoneMNVector)
			, initdoneMNQuery(initdoneMNQuery)
		{
	mask = {INITDONEDETAIL, INITDONEATITLE, INITDONEALOADFCT, INITDONETBL1NTABLECOL, INITDONE1NSUBSET, INITDONE1NSTUB, INITDONETO1NRELATION, INITDONEFR1NRELATION, INITDONE1NCHECK, INITDONE1NIMPEXP, INITDONEREF1NRTBLOCK, INITDONEREF1NQUERYMOD, INITDONEHK1NVECTOR, INITDONEFCT1NTABLECOL, INITDONEREF1NPANEL, INITDONESRC1NFEED, INITDONEREF1NCALL, INITDONEREF1NDIALOG, INITDONEPST1NQUERYMOD, INITDONEMNVECTOR, INITDONEMNQUERY};
};
...
PnlWznmTblRec::StatShr::StatShr(
			...
			, scrJrefALoadfct(scrJrefALoadfct)
			, pnlaloadfctAvail(pnlaloadfctAvail)
			, scrJrefTbl1NTablecol(scrJrefTbl1NTablecol)
			, scrJref1NSubset(scrJref1NSubset)
			, pnl1nsubsetAvail(pnl1nsubsetAvail)
			, scrJref1NStub(scrJref1NStub)
			, pnl1nstubAvail(pnl1nstubAvail)
			, scrJrefTo1NRelation(scrJrefTo1NRelation)
			, pnlto1nrelationAvail(pnlto1nrelationAvail)
			, scrJrefFr1NRelation(scrJrefFr1NRelation)
			, pnlfr1nrelationAvail(pnlfr1nrelationAvail)
			, scrJref1NCheck(scrJref1NCheck)
			, pnl1ncheckAvail(pnl1ncheckAvail)
			, scrJref1NImpexp(scrJref1NImpexp)
			, pnl1nimpexpAvail(pnl1nimpexpAvail)
			, scrJrefRef1NRtblock(scrJrefRef1NRtblock)
			, scrJrefRef1NQuerymod(scrJrefRef1NQuerymod)
			...
			, scrJrefRef1NCall(scrJrefRef1NCall)
			, pnlref1ncallAvail(pnlref1ncallAvail)
			, scrJrefRef1NDialog(scrJrefRef1NDialog)
			, pnlref1ndialogAvail(pnlref1ndialogAvail)
			, scrJrefPst1NQuerymod(scrJrefPst1NQuerymod)
			, pnlpst1nquerymodAvail(pnlpst1nquerymodAvail)
			, scrJrefMNVector(scrJrefMNVector)
			, pnlmnvectorAvail(pnlmnvectorAvail)
			, scrJrefMNQuery(scrJrefMNQuery)
			, pnlmnqueryAvail(pnlmnqueryAvail)
			, ButRegularizeActive(ButRegularizeActive)
		{
	mask = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NPANEL, SCRJREFSRC1NFEED, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE};
};
...
set<uint> PnlWznmTblRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NPANEL, SCRJREFSRC1NFEED, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
