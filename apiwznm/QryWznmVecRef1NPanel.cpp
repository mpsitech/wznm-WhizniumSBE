/**
	...
	* API code for job QryWznmVecRef1NPanel (implementation)
...
QryWznmVecRef1NPanel::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmVecRef1NPanel::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmVecRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmVecRef1NPanel";
...
set<uint> QryWznmVecRef1NPanel::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmVecRef1NPanel::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool QryWznmVecRef1NPanel::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmVecRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmVecRef1NPanel";
