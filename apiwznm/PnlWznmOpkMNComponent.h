/**
	...
	* API code for job PnlWznmOpkMNComponent (declarations)
...
/**
	...
	*/
namespace PnlWznmOpkMNComponent {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmOpkMNComponent::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmOpkMNComponent::StatApp statappqry;
