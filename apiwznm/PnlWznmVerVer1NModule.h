/**
	...
	* API code for job PnlWznmVerVer1NModule (declarations)
...
/**
	...
	*/
namespace PnlWznmVerVer1NModule {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmVerVer1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmVerVer1NModule::StatApp statappqry;
