/**
	...
	* API code for job PnlWznmTcoList (declarations)
...
namespace PnlWznmTcoList {
	...
	public:
		...
		static const Sbecore::uint TCOFCT = 12;
		static const Sbecore::uint TCOSTY = 13;
		static const Sbecore::uint TCOAXF = 14;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtFor = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoSrf = "", const std::string& TcoSho = "", const std::string& TcoTyp = "", const std::string& TcoTbl = "", const std::string& TcoFct = "", const std::string& TcoSty = "", const std::string& TcoAxf = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmTcoList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTcoList::StatApp statappqry;
