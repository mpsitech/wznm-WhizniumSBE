...
/******************************************************************************
 class QryWznmRtjList::VecVOrd
 ******************************************************************************/

uint QryWznmRtjList::VecVOrd::getIx(
			const string& sref
		) {
...
QryWznmRtjList::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmRtjList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmRtjList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmRtjList";
...
set<uint> QryWznmRtjList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRtjList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmRtjList::StatShr
 ******************************************************************************/

QryWznmRtjList::StatShr::StatShr(
			const uint ntot
...
bool QryWznmRtjList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmRtjList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmRtjList";
...
set<uint> QryWznmRtjList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRtjList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmRtjList::StgIac
 ******************************************************************************/

QryWznmRtjList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmRtjList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmRtjList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmRtjList";
...
void QryWznmRtjList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryWznmRtjList";
...
set<uint> QryWznmRtjList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRtjList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
