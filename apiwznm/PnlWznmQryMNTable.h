/**
	...
	* API code for job PnlWznmQryMNTable (declarations)
...
namespace PnlWznmQryMNTable {
	...
	public:
		...
		static const Sbecore::uint TCOTQMD = 8;
		static const Sbecore::uint TCOSRC = 9;
		static const Sbecore::uint TCOPFX = 10;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoMref = "", const std::string& TcoTqmd = "", const std::string& TcoSrc = "", const std::string& TcoPfx = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmQryMNTable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmQryMNTable::StatApp statappqry;
