/**
	...
	* API code for job PnlWznmPrjMNPerson (declarations)
...
namespace PnlWznmPrjMNPerson {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmPrjMNPerson::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmPrjMNPerson::StatApp statappqry;
