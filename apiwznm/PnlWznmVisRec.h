/**
	...
	* API code for job PnlWznmVisRec (declarations)
...
namespace PnlWznmVisRec {
	...
	public:
		...
		static const Sbecore::uint INITDONEVIS1NSHEET = 2;
		static const Sbecore::uint INITDONEREF1NFILE = 3;

	public:
		StatApp(const bool initdoneDetail = false, const bool initdoneVis1NSheet = false, const bool initdoneRef1NFile = false);

	public:
		bool initdoneDetail;
		bool initdoneVis1NSheet;
	...
	public:
		...
		static const Sbecore::uint SCRJREFVIS1NSHEET = 3;
		static const Sbecore::uint SCRJREFREF1NFILE = 4;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 5;

	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const std::string& scrJrefDetail = "", const std::string& scrJrefVis1NSheet = "", const std::string& scrJrefRef1NFile = "", const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWznmVExpstate;
		std::string scrJrefDetail;
		std::string scrJrefVis1NSheet;
