/**
	...
	* API code for job QryWznmPstList (implementation)
...
/******************************************************************************
 class QryWznmPstList::VecVOrd
 ******************************************************************************/

uint QryWznmPstList::VecVOrd::getIx(
			const string& sref
		) {
...
QryWznmPstList::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmPstList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmPstList";
...
set<uint> QryWznmPstList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmPstList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmPstList::StatShr
 ******************************************************************************/

QryWznmPstList::StatShr::StatShr(
			const uint ntot
...
bool QryWznmPstList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmPstList";
...
set<uint> QryWznmPstList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmPstList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmPstList::StgIac
 ******************************************************************************/

QryWznmPstList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmPstList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmPstList";
...
void QryWznmPstList::StgIac::writeXML(
	...
	else itemtag = "StgitemIacQryWznmPstList";
...
set<uint> QryWznmPstList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmPstList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
