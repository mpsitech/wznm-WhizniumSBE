/**
	...
	* API code for job QryWznmRelRef1NPanel (implementation)
...
/******************************************************************************
 class QryWznmRelRef1NPanel::StatApp
 ******************************************************************************/

QryWznmRelRef1NPanel::StatApp::StatApp(
			const uint firstcol
...
bool QryWznmRelRef1NPanel::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWznmRelRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWznmRelRef1NPanel";
...
set<uint> QryWznmRelRef1NPanel::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRelRef1NPanel::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmRelRef1NPanel::StatShr
 ******************************************************************************/

QryWznmRelRef1NPanel::StatShr::StatShr(
			const uint ntot
...
bool QryWznmRelRef1NPanel::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWznmRelRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWznmRelRef1NPanel";
...
set<uint> QryWznmRelRef1NPanel::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRelRef1NPanel::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmRelRef1NPanel::StgIac
 ******************************************************************************/

QryWznmRelRef1NPanel::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmRelRef1NPanel::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmRelRef1NPanel");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmRelRef1NPanel";
...
void QryWznmRelRef1NPanel::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmRelRef1NPanel";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmRelRef1NPanel";
...
set<uint> QryWznmRelRef1NPanel::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmRelRef1NPanel::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
