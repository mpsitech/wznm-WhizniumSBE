/**
	...
	* API code for job PnlWznmQryQry1NQuerycol (declarations)
...
/**
	...
	*/
namespace PnlWznmQryQry1NQuerycol {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmQryQry1NQuerycol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmQryQry1NQuerycol::StatApp statappqry;
