/**
	* \file PnlWznmErrHeadbar.cpp
	* API code for job PnlWznmErrHeadbar (implementation)
...
/******************************************************************************
 class PnlWznmErrHeadbar::StgInf
 ******************************************************************************/

PnlWznmErrHeadbar::StgInf::StgInf(
...
bool PnlWznmErrHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWznmErrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWznmErrHeadbar";
...
set<uint> PnlWznmErrHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmErrHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmErrHeadbar::Tag
 ******************************************************************************/

PnlWznmErrHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWznmErrHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWznmErrHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWznmErrHeadbar";
...
/******************************************************************************
 class PnlWznmErrHeadbar::DpchEngData
 ******************************************************************************/

PnlWznmErrHeadbar::DpchEngData::DpchEngData() :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMERRHEADBARDATA)
		{
};

string PnlWznmErrHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmErrHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWznmErrHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
