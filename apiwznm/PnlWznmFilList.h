/**
	...
	* API code for job PnlWznmFilList (declarations)
...
namespace PnlWznmFilList {
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWznmFilList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmFilList::StatApp statappqry;
