/**
	...
	* API code for job PnlWznmTbl1NStub (declarations)
...
namespace PnlWznmTbl1NStub {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWznmTbl1NStub::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmTbl1NStub::StatApp statappqry;
