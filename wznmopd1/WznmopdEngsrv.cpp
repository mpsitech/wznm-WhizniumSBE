...
uint WznmopdEngsrv::readDpchInv(
	...
	} else if (ixWznmVDpch == VecWznmVDpch::DPCHINVWZNMPRCFILEIEXCONV) {
		req->dpchinv = new DpchInvWznmPrcfileIexconv();
		((DpchInvWznmPrcfileIexconv*) (req->dpchinv))->readXML(docctx, "/", true);
