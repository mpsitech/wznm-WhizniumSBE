/**
  * \file PnlWznmImeSup1NImpexp.js
  * web client functionality for panel PnlWznmImeSup1NImpexp
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate", "mind");

	getRecwnd().changeHeight("Sup1NImpexp", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Sup1NImpexp_side").setAttribute("height", "30");
	doc.getElementById("Sup1NImpexp_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Sup1NImpexp_side").src = "./PnlWznmImeSup1NImpexp_aside.html";
	doc.getElementById("Sup1NImpexp_cont").src = "./PnlWznmImeSup1NImpexp_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate", "regd");

	getRecwnd().changeHeight("Sup1NImpexp", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Sup1NImpexp_side").setAttribute("height", "255");
	doc.getElementById("Sup1NImpexp_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Sup1NImpexp_side").src = "./PnlWznmImeSup1NImpexp_bside.html";
	doc.getElementById("Sup1NImpexp_cont").src = "./PnlWznmImeSup1NImpexp_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Sup1NImpexp_side").contentDocument;
	contdoc = doc.getElementById("Sup1NImpexp_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Sup1NImpexp_side").contentDocument;
	contdoc = doc.getElementById("Sup1NImpexp_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Sup1NImpexp_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Sup1NImpexp_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Sup1NImpexp_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWznmVExpstate = retrieveSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWznmImeSup1NImpexp", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWznmImeSup1NImpexp", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmImeSup1NImpexp", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmImeSup1NImpexp", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWznmImeSup1NImpexp", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWznmImeSup1NImpexp", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWznmQImeSup1NImpexp
		rownode = getRownode(srcdoc, "ListWznmQImeSup1NImpexp", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWznmImeSup1NImpexp", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Sup1NImpexp", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NImpexp_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Sup1NImpexp_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Sup1NImpexp_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Sup1NImpexp_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WznmImeSup1NImpexp", "ListWznmQImeSup1NImpexp", retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "TxtRecord1"), retrieveTi(srcdoc, "TagWznmImeSup1NImpexp", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmImeSup1NImpexp", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmImeSup1NImpexp", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWznmImeSup1NImpexp", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWznmImeSup1NImpexp", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWznmImeSup1NImpexpData", scrJref, "StgIacQryWznmImeSup1NImpexp");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "firstcol"));

	setSi(srcdoc, "StatAppQryWznmImeSup1NImpexp", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWznmImeSup1NImpexp", "srefIxWznmVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmImeSup1NImpexp", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWznmImeSup1NImpexpDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "ContInfWznmImeSup1NImpexp", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StatAppWznmImeSup1NImpexp", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StatShrWznmImeSup1NImpexp", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StgIacWznmImeSup1NImpexp", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "TagWznmImeSup1NImpexp", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "ListWznmQImeSup1NImpexp", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StatAppQryWznmImeSup1NImpexp", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StatShrQryWznmImeSup1NImpexp", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWznmImeSup1NImpexpData", "StgIacQryWznmImeSup1NImpexp", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWznmImeSup1NImpexpData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWznmImeSup1NImpexpData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Sup1NImpexp");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWznmImeSup1NImpexpData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
