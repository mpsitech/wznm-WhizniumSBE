/**
  * \file PnlWznmRel1NTablecol.js
  * web client functionality for panel PnlWznmRel1NTablecol
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate", "mind");
	...
	// change content
	doc.getElementById("1NTablecol_side").src = "./PnlWznmRel1NTablecol_aside.html";
	doc.getElementById("1NTablecol_cont").src = "./PnlWznmRel1NTablecol_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate", "regd");
	...
	// change content
	doc.getElementById("1NTablecol_side").src = "./PnlWznmRel1NTablecol_bside.html";
	doc.getElementById("1NTablecol_cont").src = "./PnlWznmRel1NTablecol_b.html";
};
...
function initBD(bNotD) {
	...
	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmRel1NTablecol", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWznmRel1NTablecol", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWznmVExpstate = retrieveSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmRel1NTablecol", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWznmRel1NTablecol", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWznmRel1NTablecol", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmRel1NTablecol", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmRel1NTablecol", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWznmRel1NTablecol", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWznmRel1NTablecol", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWznmRel1NTablecol", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWznmRel1NTablecol", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWznmQRel1NTablecol
		rownode = getRownode(srcdoc, "ListWznmQRel1NTablecol", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWznmRel1NTablecol", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWznmRel1NTablecol", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWznmRel1NTablecol", "numFCsiQst"));
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WznmRel1NTablecol", "ListWznmQRel1NTablecol", retrieveTi(srcdoc, "TagWznmRel1NTablecol", "TxtRecord1"), retrieveTi(srcdoc, "TagWznmRel1NTablecol", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmRel1NTablecol", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmRel1NTablecol", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWznmRel1NTablecol", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWznmRel1NTablecol", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWznmRel1NTablecolData", scrJref, "StgIacQryWznmRel1NTablecol");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmRel1NTablecol", "firstcol"));

	setSi(srcdoc, "StatAppQryWznmRel1NTablecol", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWznmRel1NTablecol", "srefIxWznmVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmRel1NTablecol", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWznmRel1NTablecolDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "ContInfWznmRel1NTablecol", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "StatAppWznmRel1NTablecol", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "StgIacWznmRel1NTablecol", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "TagWznmRel1NTablecol", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "ListWznmQRel1NTablecol", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "StatAppQryWznmRel1NTablecol", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "StatShrQryWznmRel1NTablecol", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWznmRel1NTablecolData", "StgIacQryWznmRel1NTablecol", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWznmRel1NTablecolData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWznmRel1NTablecolData") {
				mergeDpchEngData(dom);
				init();
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWznmRel1NTablecolData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
