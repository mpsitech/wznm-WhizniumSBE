/**
  * \file PnlWznmUsrList.js
  * web client functionality for panel PnlWznmUsrList
	...
	if (chgcol) {
		...
		for (i = firstcol, ix = 0; i <= ncol; i++) {
			...
			if (i == 1) {
				...
				doc.cols.push("TcoPrs"); doc.widths.push(TcoPrsWidth); doc.fs.push("prs"); doc.tos.push(2); wtot += TcoPrsWidth;
			} else if (i == 4) {
