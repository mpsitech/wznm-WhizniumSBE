...
function setPnlAvail(short, avail) {
	...
	if ((short == "Detail") || (short == "ATitle") || (short == "ALoadfct")) lhsrhsdoc = lhsdoc;
...
function changeHeight(pnlshort, height, update) {
	...
	if ((pnlshort == "Detail") || (pnlshort == "ATitle") || (pnlshort == "ALoadfct")) lhsrhsdoc = lhsdoc;
	else lhsrhsdoc = rhsdoc;
...
function updateHeight() {
	...
	heightLhs = heightDetail+13 + heightATitle+13 + heightALoadfct+13 + 5;
	heightRhs = heightTbl1NTablecol+13 + height1NSubset+13 + heightFr1NRelation+13 + height1NImpexp+13 + height1NCheck+13 + height1NStub+13 + heightTo1NRelation+13 + heightRef1NQuerymod+13 + heightRef1NRtblock+13 + heightFct1NTablecol+13 + heightRef1NDialog+13 + heightRef1NCall+13 + heightSrc1NFeed+13 + heightRef1NPanel+13 + heightHk1NVector+13 + heightPst1NQuerymod+13 + heightMNVector+13 + heightMNQuery+13 + 5;
