...
function minimize(updh) {
	...
	setSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate", "mind");

	getRecwnd().changeHeight("Tbl1NTablecol", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Tbl1NTablecol_side").setAttribute("height", "30");
	doc.getElementById("Tbl1NTablecol_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Tbl1NTablecol_side").src = "./PnlWznmTblTbl1NTablecol_aside.html";
	doc.getElementById("Tbl1NTablecol_cont").src = "./PnlWznmTblTbl1NTablecol_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate", "regd");

	getRecwnd().changeHeight("Tbl1NTablecol", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Tbl1NTablecol_side").setAttribute("height", "255");
	doc.getElementById("Tbl1NTablecol_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Tbl1NTablecol_side").src = "./PnlWznmTblTbl1NTablecol_bside.html";
	doc.getElementById("Tbl1NTablecol_cont").src = "./PnlWznmTblTbl1NTablecol_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Tbl1NTablecol_side").contentDocument;
	contdoc = doc.getElementById("Tbl1NTablecol_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Tbl1NTablecol_side").contentDocument;
	contdoc = doc.getElementById("Tbl1NTablecol_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Tbl1NTablecol_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Tbl1NTablecol_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Tbl1NTablecol_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWznmVExpstate = retrieveSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWznmTblTbl1NTablecol", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWznmTblTbl1NTablecol", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmTblTbl1NTablecol", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmTblTbl1NTablecol", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWznmTblTbl1NTablecol", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWznmTblTbl1NTablecol", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWznmQTblTbl1NTablecol
		rownode = getRownode(srcdoc, "ListWznmQTblTbl1NTablecol", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWznmTblTbl1NTablecol", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Tbl1NTablecol", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Tbl1NTablecol_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Tbl1NTablecol_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Tbl1NTablecol_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Tbl1NTablecol_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WznmTblTbl1NTablecol", "ListWznmQTblTbl1NTablecol", retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "TxtRecord1"), retrieveTi(srcdoc, "TagWznmTblTbl1NTablecol", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmTblTbl1NTablecol", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmTblTbl1NTablecol", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWznmTblTbl1NTablecol", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWznmTblTbl1NTablecol", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWznmTblTbl1NTablecolData", scrJref, "StgIacQryWznmTblTbl1NTablecol");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "firstcol"));

	setSi(srcdoc, "StatAppQryWznmTblTbl1NTablecol", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWznmTblTbl1NTablecol", "srefIxWznmVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmTblTbl1NTablecol", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWznmTblTbl1NTablecolDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "ContInfWznmTblTbl1NTablecol", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StatAppWznmTblTbl1NTablecol", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StatShrWznmTblTbl1NTablecol", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StgIacWznmTblTbl1NTablecol", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "TagWznmTblTbl1NTablecol", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "ListWznmQTblTbl1NTablecol", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StatAppQryWznmTblTbl1NTablecol", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StatShrQryWznmTblTbl1NTablecol", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWznmTblTbl1NTablecolData", "StgIacQryWznmTblTbl1NTablecol", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWznmTblTbl1NTablecolData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWznmTblTbl1NTablecolData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Tbl1NTablecol");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWznmTblTbl1NTablecolData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
