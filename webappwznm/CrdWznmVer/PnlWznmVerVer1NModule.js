/**
  * \file PnlWznmVerVer1NModule.js
  * web client functionality for panel PnlWznmVerVer1NModule
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate", "mind");

	getRecwnd().changeHeight("Ver1NModule", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("Ver1NModule_side").setAttribute("height", "30");
	doc.getElementById("Ver1NModule_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("Ver1NModule_side").src = "./PnlWznmVerVer1NModule_aside.html";
	doc.getElementById("Ver1NModule_cont").src = "./PnlWznmVerVer1NModule_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate", "regd");

	getRecwnd().changeHeight("Ver1NModule", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("Ver1NModule_side").setAttribute("height", "255");
	doc.getElementById("Ver1NModule_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("Ver1NModule_side").src = "./PnlWznmVerVer1NModule_bside.html";
	doc.getElementById("Ver1NModule_cont").src = "./PnlWznmVerVer1NModule_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("Ver1NModule_side").contentDocument;
	contdoc = doc.getElementById("Ver1NModule_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("Ver1NModule_side").contentDocument;
	contdoc = doc.getElementById("Ver1NModule_cont").contentDocument;
	hdrdoc = contdoc.getElementById("Ver1NModule_hdr").contentDocument;
	tbldoc = contdoc.getElementById("Ver1NModule_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("Ver1NModule_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmVerVer1NModule", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWznmVerVer1NModule", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWznmVExpstate = retrieveSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmVerVer1NModule", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWznmVerVer1NModule", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWznmVerVer1NModule", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmVerVer1NModule", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmVerVer1NModule", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWznmVerVer1NModule", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWznmVerVer1NModule", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWznmVerVer1NModule", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWznmVerVer1NModule", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWznmQVerVer1NModule
		rownode = getRownode(srcdoc, "ListWznmQVerVer1NModule", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWznmVerVer1NModule", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWznmVerVer1NModule", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWznmVerVer1NModule", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("Ver1NModule", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("Ver1NModule_side").setAttribute("height", "" + (height+55));
	doc.getElementById("Ver1NModule_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("Ver1NModule_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("Ver1NModule_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WznmVerVer1NModule", "ListWznmQVerVer1NModule", retrieveTi(srcdoc, "TagWznmVerVer1NModule", "TxtRecord1"), retrieveTi(srcdoc, "TagWznmVerVer1NModule", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmVerVer1NModule", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmVerVer1NModule", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWznmVerVer1NModule", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWznmVerVer1NModule", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWznmVerVer1NModuleData", scrJref, "StgIacQryWznmVerVer1NModule");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmVerVer1NModule", "firstcol"));

	setSi(srcdoc, "StatAppQryWznmVerVer1NModule", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWznmVerVer1NModule", "srefIxWznmVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmVerVer1NModule", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWznmVerVer1NModuleDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "ContInfWznmVerVer1NModule", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StatAppWznmVerVer1NModule", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StatShrWznmVerVer1NModule", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StgIacWznmVerVer1NModule", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "TagWznmVerVer1NModule", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "ListWznmQVerVer1NModule", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StatAppQryWznmVerVer1NModule", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StatShrQryWznmVerVer1NModule", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWznmVerVer1NModuleData", "StgIacQryWznmVerVer1NModule", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWznmVerVer1NModuleData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWznmVerVer1NModuleData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("Ver1NModule");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWznmVerVer1NModuleData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
