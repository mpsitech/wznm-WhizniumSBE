/**
  * \file PnlWznmIelList.js
  * web client functionality for panel PnlWznmIelList
	...
	if (chgcol) {
		...
		for (i = firstcol, ix = 0; i <= ncol; i++) {
			...
			if (i == 1) {
				...
				doc.cols.push("TcoIme"); doc.widths.push(TcoImeWidth); doc.fs.push("ime"); doc.tos.push(2); wtot += TcoImeWidth;
			} else if (i == 5) {
