/**
  * \file PnlWznmPst1NQuerymod.js
  * web client functionality for panel PnlWznmPst1NQuerymod
...
function minimize(updh) {
	if (retrieveSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate") == "mind") return;

	setSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate", "mind");

	getRecwnd().changeHeight("1NQuerymod", 30, updh);
	doc.getElementById("tdSide").setAttribute("height", "30");
	doc.getElementById("1NQuerymod_side").setAttribute("height", "30");
	doc.getElementById("1NQuerymod_cont").setAttribute("height", "30");

	// change content
	doc.getElementById("1NQuerymod_side").src = "./PnlWznmPst1NQuerymod_aside.html";
	doc.getElementById("1NQuerymod_cont").src = "./PnlWznmPst1NQuerymod_a.html";
};

function regularize() {
	if (retrieveSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate") == "regd") return;

	setSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate", "regd");

	getRecwnd().changeHeight("1NQuerymod", 255, true);
	doc.getElementById("tdSide").setAttribute("height", "255");
	doc.getElementById("1NQuerymod_side").setAttribute("height", "255");
	doc.getElementById("1NQuerymod_cont").setAttribute("height", "255");

	// change content
	doc.getElementById("1NQuerymod_side").src = "./PnlWznmPst1NQuerymod_bside.html";
	doc.getElementById("1NQuerymod_cont").src = "./PnlWznmPst1NQuerymod_b.html";
};
...
function initA() {
	...
	sidedoc = doc.getElementById("1NQuerymod_side").contentDocument;
	contdoc = doc.getElementById("1NQuerymod_cont").contentDocument;
	hdrdoc = null;
	tbldoc = null;
	ftrdoc = null;
...
function initBD(bNotD) {
	...
	sidedoc = doc.getElementById("1NQuerymod_side").contentDocument;
	contdoc = doc.getElementById("1NQuerymod_cont").contentDocument;
	hdrdoc = contdoc.getElementById("1NQuerymod_hdr").contentDocument;
	tbldoc = contdoc.getElementById("1NQuerymod_tbl").contentDocument;
	ftrdoc = contdoc.getElementById("1NQuerymod_ftr").contentDocument;

	setTextContent(hdrdoc, hdrdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "Cpt"));

	// column headers in refreshBD() only

	setTextContent(ftrdoc, ftrdoc.getElementById("TrsGoto"), retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "Trs"));

	refreshBD(bNotD, true);
};

function init() {
	var srefIxWznmVExpstate = retrieveSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate");
...
function refreshA() {
	setTextContent(contdoc, contdoc.getElementById("Cpt"), retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "Cpt") + " (" + retrieveSi(srcdoc, "StatShrQryWznmPst1NQuerymod", "ntot") + ")");
};

function refreshBD(bNotD, chgcol) {
	// obtain record set characteristics
	var jnumSel = parseInt(retrieveSi(srcdoc, "StgIacQryWznmPst1NQuerymod", "jnum"));
	var jnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "jnumFirstdisp"));
	var ndisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "ndisp"));
	var jnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmPst1NQuerymod", "jnumFirstload"));
	var nload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmPst1NQuerymod", "nload"));
	var ntot = parseInt(retrieveSi(srcdoc, "StatShrQryWznmPst1NQuerymod", "ntot"));
	...
	if (chgcol) {
		...
		var firstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "firstcol"));
		var ncol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "ncol"));

		var TcoRefWidth = parseInt(retrieveSi(srcdoc, "StgIacWznmPst1NQuerymod", "TcoRefWidth"));
		...
		for (var j = 0; j < doc.cols.length; j++) {
			...
			mytd.setAttribute("class", "col");
			setTextContent(tbldoc, mytd, retrieveTi(srcdoc, "TagWznmPst1NQuerymod", doc.cols[j]));
	...
	if ((jnumFirstdisp < jnumFirstload) || (jnumFirstdisp > (jnumFirstload+nload-1))) {
		...
		setSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "jnumFirstdisp", jnumFirstdisp);
	};
	...
	for (var i = 1; i <= ndisp; i++) {
		...
		// find element in ListWznmQPst1NQuerymod
		rownode = getRownode(srcdoc, "ListWznmQPst1NQuerymod", jnum);
	...
	setTextContent(ftrdoc, ftrdoc.getElementById("TxtShowing"), strShowing(retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "TxtShowing1"), jnumFirstdisp, jnumLastdisp, ntot, retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "TxtShowing2")));
	...
	refreshCsi(ftrdoc, "CsiQst", srcdoc, "FeedFCsiQst", retrieveCi(srcdoc, "ContInfWznmPst1NQuerymod", "numFCsiQst"));

	height = 20 + 18*ndisp;

	getRecwnd().changeHeight("1NQuerymod", height+55, true);
	doc.getElementById("tdSide").setAttribute("height", "" + (height+55));
	doc.getElementById("1NQuerymod_side").setAttribute("height", "" + (height+55));
	doc.getElementById("1NQuerymod_cont").setAttribute("height", "" + (height+55));
	sidedoc.getElementById("tdFlex").setAttribute("height", "" + (height+55-30));
	contdoc.getElementById("tdTbl").setAttribute("height", "" + height);
	contdoc.getElementById("1NQuerymod_tbl").setAttribute("height", "" + height);
};
...
function handleLoad() {
	...
	doc = document;
	srcdoc = doc.getElementById("1NQuerymod_src").contentDocument;
...
function handleButClipboardClick() {
	copyToClipboard(document, srcdoc, "WznmPst1NQuerymod", "ListWznmQPst1NQuerymod", retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "TxtRecord1"), retrieveTi(srcdoc, "TagWznmPst1NQuerymod", "TxtRecord2"),
				["Ref"],
				["ref"]);
};
...
function handleTblSelect(jnum) {
	...
	var oldJnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmPst1NQuerymod", "jnum"));
	var oldJnumFirstdisp = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "jnumFirstdisp"));
	var oldJnumFirstload = parseInt(retrieveSi(srcdoc, "StatShrQryWznmPst1NQuerymod", "jnumFirstload"));
	...
	if (oldJnum != jnum) {
		setSi(srcdoc, "StgIacQryWznmPst1NQuerymod", "jnum", jnum);
		...
		if (jnum != 0) {
			if (!((jnum >= oldJnumFirstdisp) && (jnum <= (oldJnumFirstdisp+ndisp-1)))) {
				...
				if (!((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1)))) {
					...
					setSi(srcdoc, "StgIacQryWznmPst1NQuerymod", "jnumFirstload", jnumFirstload);
				};
			};
		};

		var str = serializeDpchAppData(srcdoc, "DpchAppWznmPst1NQuerymodData", scrJref, "StgIacQryWznmPst1NQuerymod");
...
function changeTblJnumFirstdisp(jnumFirstdisp, dJnumFirstdisp, dpgJnumFirstdisp) {
	...
	if (oldJnumFirstdisp != jnumFirstdisp) {
		...
		if ((jnumFirstdisp >= oldJnumFirstload) && (jnumLastdisp <= (oldJnumFirstload+nload-1))) {
			refreshBD((retrieveSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate") == "regd"), false);
...
function handleTblCpreviousClick() {
	var oldFirstcol = parseInt(retrieveSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "firstcol"));

	setSi(srcdoc, "StatAppQryWznmPst1NQuerymod", "firstcol", "" + (oldFirstcol-1));

	refreshBD((retrieveSi(srcdoc, "StatAppWznmPst1NQuerymod", "srefIxWznmVExpstate") == "regd"), true);
};
...
function handleTrsPreviousClick() {
	var jnum = parseInt(retrieveSi(srcdoc, "StgIacQryWznmPst1NQuerymod", "jnum"));
...
function handleButClick(ctlsref) {
	var str = serializeDpchAppDo(srcdoc, "DpchAppWznmPst1NQuerymodDo", scrJref, ctlsref + "Click");
	sendReq(str, doc, handleDpchAppDataDoReply);
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "ContInfWznmPst1NQuerymod", srcdoc)) mask.push("continf");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "FeedFCsiQst", srcdoc)) mask.push("feedFCsiQst");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StatAppWznmPst1NQuerymod", srcdoc)) mask.push("statapp");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StatShrWznmPst1NQuerymod", srcdoc)) mask.push("statshr");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StgIacWznmPst1NQuerymod", srcdoc)) mask.push("stgiac");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "TagWznmPst1NQuerymod", srcdoc)) mask.push("tag");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "ListWznmQPst1NQuerymod", srcdoc)) mask.push("rst");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StatAppQryWznmPst1NQuerymod", srcdoc)) mask.push("statappqry");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StatShrQryWznmPst1NQuerymod", srcdoc)) mask.push("statshrqry");
	if (updateSrcblock(dom, "DpchEngWznmPst1NQuerymodData", "StgIacQryWznmPst1NQuerymod", srcdoc)) mask.push("stgiacqry");

	return mask;
};

function handleDpchEng(dom, dpch) {
	if (dpch == "DpchEngWznmPst1NQuerymodData") {
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWznmPst1NQuerymodData") {
				mergeDpchEngData(dom);
				init();

				getRecwnd().setInitdone("1NQuerymod");
			};
		};
	};
};
...
function handleDpchAppDataDoReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			...
			} else if (blk.nodeName == "DpchEngWznmPst1NQuerymodData") {
				mergeDpchEngData(dom);
				refresh();
			};
		};
