/**
  * \file PnlWznmMtyList.java
  * Java API code for job PnlWznmMtyList
...
public class PnlWznmMtyList {
	/**
		* VecVDo (full: VecVWznmMtyListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmMtyList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmMtyList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmMtyList";
	...
	/**
	  * ContInf (full: ContInfWznmMtyList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMtyList");
	...
	/**
	  * StatShr (full: StatShrWznmMtyList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMtyList");
	...
	/**
	  * StgIac (full: StgIacWznmMtyList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOACHWIDTH = 2;
		public static final int TCOOSWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOACHWIDTH, TCOOSWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoAchWidth;
		public int TcoOsWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMtyList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAchWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoAchWidth", mask, TCOACHWIDTH);
				TcoOsWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoOsWidth", mask, TCOOSWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMtyList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoAchWidth", TcoAchWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoOsWidth", TcoOsWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoAchWidth == comp.TcoAchWidth) items.add(TCOACHWIDTH);
			if (TcoOsWidth == comp.TcoOsWidth) items.add(TCOOSWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOACHWIDTH, TCOOSWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOACH = 8;
		public static final int TCOOS = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOACH, TCOOS));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMtyList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAch = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoAch", mask, TCOACH);
				TcoOs = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoOs", mask, TCOOS);
		...
		public HashSet<Integer> comm(
			...
			if (TcoAch.equals(comp.TcoAch)) items.add(TCOACH);
			if (TcoOs.equals(comp.TcoOs)) items.add(TCOOS);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOACH, TCOOS));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmMtyListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTYLISTDATA, scrJref);
		...
		public QryWznmMtyList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtyListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMtyListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTYLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtyListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMtyListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTYLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQMtyList();
			statappqry = (new QryWznmMtyList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMtyList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMtyList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMtyList rst;
		public QryWznmMtyList.StatApp statappqry;
		public QryWznmMtyList.StatShr statshrqry;
		public QryWznmMtyList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtyListData");
