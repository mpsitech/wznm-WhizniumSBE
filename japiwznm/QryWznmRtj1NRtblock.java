/**
  * \file QryWznmRtj1NRtblock.java
  * Java API code for job QryWznmRtj1NRtblock
...
public class QryWznmRtj1NRtblock {
	/**
	  * StatApp (full: StatAppQryWznmRtj1NRtblock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRtj1NRtblock");
	...
	/**
	  * StatShr (full: StatShrQryWznmRtj1NRtblock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRtj1NRtblock");
	...
	/**
	  * StgIac (full: StgIacQryWznmRtj1NRtblock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRtj1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRtj1NRtblock";
