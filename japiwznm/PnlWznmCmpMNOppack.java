/**
  * \file PnlWznmCmpMNOppack.java
  * Java API code for job PnlWznmCmpMNOppack
...
public class PnlWznmCmpMNOppack {
	/**
		* VecVDo (full: VecVWznmCmpMNOppackDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCmpMNOppack)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCmpMNOppack");
	...
	/**
	  * StatApp (full: StatAppWznmCmpMNOppack)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCmpMNOppack");
	...
	/**
	  * StatShr (full: StatShrWznmCmpMNOppack)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCmpMNOppack");
	...
	/**
	  * StgIac (full: StgIacWznmCmpMNOppack)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCmpMNOppack");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCmpMNOppack";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCmpMNOppack");
	...
	/**
		* DpchAppData (full: DpchAppWznmCmpMNOppackData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPMNOPPACKDATA, scrJref);
		...
		public QryWznmCmpMNOppack.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpMNOppackData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCmpMNOppackDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPMNOPPACKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpMNOppackDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCmpMNOppackData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCMPMNOPPACKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCmpMNOppack();
			statappqry = (new QryWznmCmpMNOppack()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCmpMNOppack()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCmpMNOppack()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCmpMNOppack rst;
		public QryWznmCmpMNOppack.StatApp statappqry;
		public QryWznmCmpMNOppack.StatShr statshrqry;
		public QryWznmCmpMNOppack.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCmpMNOppackData");
