/**
  * \file QryWznmVecPst1NQuerymod.java
  * Java API code for job QryWznmVecPst1NQuerymod
...
public class QryWznmVecPst1NQuerymod {
	/**
	  * StatApp (full: StatAppQryWznmVecPst1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVecPst1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrQryWznmVecPst1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVecPst1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacQryWznmVecPst1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVecPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVecPst1NQuerymod";
