/**
  * \file PnlWznmOpkList.java
  * Java API code for job PnlWznmOpkList
...
public class PnlWznmOpkList {
	/**
		* VecVDo (full: VecVWznmOpkListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmOpkList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmOpkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmOpkList";
	...
	/**
	  * ContInf (full: ContInfWznmOpkList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkList");
	...
	/**
	  * StatShr (full: StatShrWznmOpkList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOSHDWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSHDWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSHDWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSHD = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOTYP, TCOVER, TCOSHD));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOTYP, TCOVER, TCOSHD));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKLISTDATA, scrJref);
		...
		public QryWznmOpkList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQOpkList();
			statappqry = (new QryWznmOpkList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkList rst;
		public QryWznmOpkList.StatApp statappqry;
		public QryWznmOpkList.StatShr statshrqry;
		public QryWznmOpkList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkListData");
