/**
  * \file CrdWznmSeq.java
  * Java API code for job CrdWznmSeq
...
public class CrdWznmSeq {
	/**
		* VecVDo (full: VecVWznmSeqDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSeq)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDSEQ = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSEQ));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdSeq;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSeq");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdSeq = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdSeq", mask, MTXCRDSEQ);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdSeq.equals(comp.MtxCrdSeq)) items.add(MTXCRDSEQ);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSEQ));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSeq");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSeq");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSeq");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSeqDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSEQDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSeqDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSeqData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSEQDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSeqData");
