/**
  * \file PnlWznmCtpKKey.java
  * Java API code for job PnlWznmCtpKKey
...
public class PnlWznmCtpKKey {
	/**
		* VecVDo (full: VecVWznmCtpKKeyDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCtpKKey)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtpKKey");
	...
	/**
	  * StatApp (full: StatAppWznmCtpKKey)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtpKKey");
	...
	/**
	  * StatShr (full: StatShrWznmCtpKKey)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtpKKey");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCtpKKey");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCtpKKey";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtpKKey");
	...
	/**
		* DpchAppData (full: DpchAppWznmCtpKKeyData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPKKEYDATA, scrJref);
		...
		public QryWznmCtpKKey.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpKKeyData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCtpKKeyDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPKKEYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpKKeyDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCtpKKeyData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTPKKEYDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQCtpKKey();
			statappqry = (new QryWznmCtpKKey()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCtpKKey()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCtpKKey()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCtpKKey rst;
		public QryWznmCtpKKey.StatApp statappqry;
		public QryWznmCtpKKey.StatShr statshrqry;
		public QryWznmCtpKKey.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtpKKeyData");
