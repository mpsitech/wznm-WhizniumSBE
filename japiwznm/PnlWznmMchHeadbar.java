/**
  * \file PnlWznmMchHeadbar.java
  * Java API code for job PnlWznmMchHeadbar
...
public class PnlWznmMchHeadbar {
	/**
	  * StgInf (full: StgInfWznmMchHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmMchHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMchHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmMchHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMCHHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMchHeadbarData");
