/**
  * \file PnlWznmVerVer1NModule.java
  * Java API code for job PnlWznmVerVer1NModule
...
public class PnlWznmVerVer1NModule {
	/**
		* VecVDo (full: VecVWznmVerVer1NModuleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerVer1NModule)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerVer1NModule");
	...
	/**
	  * StatApp (full: StatAppWznmVerVer1NModule)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerVer1NModule");
	...
	/**
	  * StatShr (full: StatShrWznmVerVer1NModule)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerVer1NModule");
	...
	/**
	  * StgIac (full: StgIacWznmVerVer1NModule)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerVer1NModule");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerVer1NModule";
	...
	/**
	  * Tag (full: TagWznmVerVer1NModule)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerVer1NModule");
	...
	/**
		* DpchAppData (full: DpchAppWznmVerVer1NModuleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NMODULEDATA, scrJref);
		...
		public QryWznmVerVer1NModule.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NModuleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerVer1NModuleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NMODULEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NModuleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerVer1NModuleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERVER1NMODULEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerVer1NModule();
			statappqry = (new QryWznmVerVer1NModule()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerVer1NModule()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerVer1NModule()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerVer1NModule rst;
		public QryWznmVerVer1NModule.StatApp statappqry;
		public QryWznmVerVer1NModule.StatShr statshrqry;
		public QryWznmVerVer1NModule.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerVer1NModuleData");
