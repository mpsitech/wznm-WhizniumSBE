/**
  * \file QryWznmPrsADetail.java
  * Java API code for job QryWznmPrsADetail
...
public class QryWznmPrsADetail {
	/**
	  * StatApp (full: StatAppQryWznmPrsADetail)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmPrsADetail");
	...
	/**
	  * StatShr (full: StatShrQryWznmPrsADetail)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmPrsADetail");
	...
	/**
	  * StgIac (full: StgIacQryWznmPrsADetail)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmPrsADetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmPrsADetail";
