/**
  * \file PnlWznmUsrHeadbar.java
  * Java API code for job PnlWznmUsrHeadbar
...
public class PnlWznmUsrHeadbar {
	/**
	  * StgInf (full: StgInfWznmUsrHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmUsrHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsrHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsrHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSRHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsrHeadbarData");
