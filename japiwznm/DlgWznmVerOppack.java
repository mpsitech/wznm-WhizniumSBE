/**
  * \file DlgWznmVerOppack.java
  * Java API code for job DlgWznmVerOppack
...
public class DlgWznmVerOppack {
	/**
		* VecVDit (full: VecVDlgWznmVerOppackDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVerOppackDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVerOppackDoImp)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmVerOppackSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVerOppack)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVerOppack");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVerOppack";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVerOppack)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerOppack");

			String itemtag = "ContitemInfDlgWznmVerOppack";
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVerOppackImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerOppackImp");

			String itemtag = "ContitemInfDlgWznmVerOppackImp";
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVerOppackLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerOppackLfi");

			String itemtag = "ContitemInfDlgWznmVerOppackLfi";
	...
	/**
	  * StatApp (full: StatAppDlgWznmVerOppack)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVerOppack");

			String itemtag = "StatitemAppDlgWznmVerOppack";
	...
	/**
	  * StatShr (full: StatShrDlgWznmVerOppack)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerOppack");

			String itemtag = "StatitemShrDlgWznmVerOppack";
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVerOppackIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerOppackIfi");

			String itemtag = "StatitemShrDlgWznmVerOppackIfi";
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVerOppackImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerOppackImp");

			String itemtag = "StatitemShrDlgWznmVerOppackImp";
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVerOppackLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerOppackLfi");

			String itemtag = "StatitemShrDlgWznmVerOppackLfi";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerOppack");

			String itemtag = "TagitemDlgWznmVerOppack";
	...
	/**
	  * TagIfi (full: TagDlgWznmVerOppackIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerOppackIfi");

			String itemtag = "TagitemDlgWznmVerOppackIfi";
	...
	/**
	  * TagImp (full: TagDlgWznmVerOppackImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerOppackImp");

			String itemtag = "TagitemDlgWznmVerOppackImp";
	...
	/**
	  * TagLfi (full: TagDlgWznmVerOppackLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerOppackLfi");

			String itemtag = "TagitemDlgWznmVerOppackLfi";
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmVerOppackData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVEROPPACKDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerOppackData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVerOppackDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVEROPPACKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerOppackDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVerOppackData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMVEROPPACKDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVerOppackData");
