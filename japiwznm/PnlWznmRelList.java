/**
  * \file PnlWznmRelList.java
  * Java API code for job PnlWznmRelList
...
public class PnlWznmRelList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmRelList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmRelList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelList");

			String itemtag = "ContitemInfWznmRelList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelList");

			String itemtag = "StatitemShrWznmRelList";
	...
	public class StgIac extends Block {
		...
		public static final int TCOFRTWIDTH = 1;
		public static final int TCOFRSWIDTH = 2;
		public static final int TCOTOTWIDTH = 3;
		public static final int TCOTOSWIDTH = 4;
		public static final int TCOTYPWIDTH = 5;
		public static final int TCOVERWIDTH = 6;
		public static final int TCOSUPWIDTH = 7;
		public static final int TCOSRLWIDTH = 8;
		public static final int TCOTBLWIDTH = 9;
		public static final int TCOPFXWIDTH = 10;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOFRTWIDTH, TCOFRSWIDTH, TCOTOTWIDTH, TCOTOSWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOPFXWIDTH));
		};

		public int TcoFrtWidth;
		public int TcoFrsWidth;
		public int TcoTotWidth;
		public int TcoTosWidth;
		public int TcoTypWidth;
		public int TcoVerWidth;
		public int TcoSupWidth;
		public int TcoSrlWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelList");

			String itemtag = "StgitemIacWznmRelList";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoFrtWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoFrtWidth", mask, TCOFRTWIDTH);
				TcoFrsWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoFrsWidth", mask, TCOFRSWIDTH);
				TcoTotWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTotWidth", mask, TCOTOTWIDTH);
				TcoTosWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTosWidth", mask, TCOTOSWIDTH);
				...
				TcoSrlWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSrlWidth", mask, TCOSRLWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoFrtWidth", TcoFrtWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoFrsWidth", TcoFrsWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTotWidth", TcoTotWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTosWidth", TcoTosWidth);
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSrlWidth", TcoSrlWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoFrtWidth == comp.TcoFrtWidth) items.add(TCOFRTWIDTH);
			if (TcoFrsWidth == comp.TcoFrsWidth) items.add(TCOFRSWIDTH);
			if (TcoTotWidth == comp.TcoTotWidth) items.add(TCOTOTWIDTH);
			if (TcoTosWidth == comp.TcoTosWidth) items.add(TCOTOSWIDTH);
			...
			if (TcoSrlWidth == comp.TcoSrlWidth) items.add(TCOSRLWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOFRTWIDTH, TCOFRSWIDTH, TCOTOTWIDTH, TCOTOSWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOPFXWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOFRT = 8;
		public static final int TCOFRS = 9;
		public static final int TCOTOT = 10;
		public static final int TCOTOS = 11;
		public static final int TCOTYP = 12;
		public static final int TCOVER = 13;
		public static final int TCOSUP = 14;
		public static final int TCOSRL = 15;
		public static final int TCOTBL = 16;
		public static final int TCOPFX = 17;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOFRT, TCOFRS, TCOTOT, TCOTOS, TCOTYP, TCOVER, TCOSUP, TCOSRL, TCOTBL, TCOPFX));
		};
		...
		public String TcoFrt;
		public String TcoFrs;
		public String TcoTot;
		public String TcoTos;
		public String TcoTyp;
		public String TcoVer;
		public String TcoSup;
		public String TcoSrl;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelList");

			String itemtag = "TagitemWznmRelList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoFrt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoFrt", mask, TCOFRT);
				TcoFrs = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoFrs", mask, TCOFRS);
				TcoTot = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTot", mask, TCOTOT);
				TcoTos = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTos", mask, TCOTOS);
				...
				TcoSrl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSrl", mask, TCOSRL);
		...
		public HashSet<Integer> comm(
			...
			if (TcoFrt.equals(comp.TcoFrt)) items.add(TCOFRT);
			if (TcoFrs.equals(comp.TcoFrs)) items.add(TCOFRS);
			if (TcoTot.equals(comp.TcoTot)) items.add(TCOTOT);
			if (TcoTos.equals(comp.TcoTos)) items.add(TCOTOS);
			...
			if (TcoSrl.equals(comp.TcoSrl)) items.add(TCOSRL);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOFRT, TCOFRS, TCOTOT, TCOTOS, TCOTYP, TCOVER, TCOSUP, TCOSRL, TCOTBL, TCOPFX));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELLISTDATA, scrJref);
		...
		public QryWznmRelList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelListData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelListDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQRelList();
			statappqry = (new QryWznmRelList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelList rst;
		public QryWznmRelList.StatApp statappqry;
		public QryWznmRelList.StatShr statshrqry;
		public QryWznmRelList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelListData");
