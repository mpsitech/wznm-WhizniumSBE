/**
  * \file PnlWznmJobRef1NBlock.java
  * Java API code for job PnlWznmJobRef1NBlock
...
public class PnlWznmJobRef1NBlock {
	/**
		* VecVDo (full: VecVWznmJobRef1NBlockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobRef1NBlock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobRef1NBlock");
	...
	/**
	  * StatApp (full: StatAppWznmJobRef1NBlock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobRef1NBlock");
	...
	/**
	  * StatShr (full: StatShrWznmJobRef1NBlock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobRef1NBlock");
	...
	/**
	  * StgIac (full: StgIacWznmJobRef1NBlock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobRef1NBlock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobRef1NBlock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobRef1NBlock");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobRef1NBlockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBREF1NBLOCKDATA, scrJref);
		...
		public QryWznmJobRef1NBlock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobRef1NBlockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobRef1NBlockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBREF1NBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobRef1NBlockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobRef1NBlockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBREF1NBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJobRef1NBlock();
			statappqry = (new QryWznmJobRef1NBlock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobRef1NBlock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobRef1NBlock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobRef1NBlock rst;
		public QryWznmJobRef1NBlock.StatApp statappqry;
		public QryWznmJobRef1NBlock.StatShr statshrqry;
		public QryWznmJobRef1NBlock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobRef1NBlockData");
