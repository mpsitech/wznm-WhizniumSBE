/**
  * \file PnlWznmCtpKParKey.java
  * Java API code for job PnlWznmCtpKParKey
...
public class PnlWznmCtpKParKey {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtpKParKey");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtpKParKey");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtpKParKey");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCtpKParKey");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCtpKParKey";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtpKParKey");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPKPARKEYDATA, scrJref);
		...
		public QryWznmCtpKParKey.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpKParKeyData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPKPARKEYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpKParKeyDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTPKPARKEYDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQCtpKParKey();
			statappqry = (new QryWznmCtpKParKey()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCtpKParKey()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCtpKParKey()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCtpKParKey rst;
		public QryWznmCtpKParKey.StatApp statappqry;
		public QryWznmCtpKParKey.StatShr statshrqry;
		public QryWznmCtpKParKey.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtpKParKeyData");
