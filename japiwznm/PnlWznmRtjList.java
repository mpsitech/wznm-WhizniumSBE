/**
  * \file PnlWznmRtjList.java
  * Java API code for job PnlWznmRtjList
...
public class PnlWznmRtjList {
	/**
		* VecVDo (full: VecVWznmRtjListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmRtjList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmRtjList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmRtjList";
	...
	/**
	  * ContInf (full: ContInfWznmRtjList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRtjList");
	...
	/**
	  * StatShr (full: StatShrWznmRtjList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRtjList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOAPPWIDTH, TCOSUPWIDTH, TCOJOBWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoAppWidth;
		public int TcoSupWidth;
		public int TcoJobWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRtjList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAppWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoAppWidth", mask, TCOAPPWIDTH);
				TcoSupWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSupWidth", mask, TCOSUPWIDTH);
				TcoJobWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoJobWidth", mask, TCOJOBWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRtjList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoAppWidth", TcoAppWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSupWidth", TcoSupWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoJobWidth", TcoJobWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoAppWidth == comp.TcoAppWidth) items.add(TCOAPPWIDTH);
			if (TcoSupWidth == comp.TcoSupWidth) items.add(TCOSUPWIDTH);
			if (TcoJobWidth == comp.TcoJobWidth) items.add(TCOJOBWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOAPPWIDTH, TCOSUPWIDTH, TCOJOBWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOAPP = 9;
		public static final int TCOSUP = 10;
		public static final int TCOJOB = 11;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOAPP, TCOSUP, TCOJOB));
		};
		...
		public String TcoApp;
		public String TcoSup;
		public String TcoJob;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRtjList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoApp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoApp", mask, TCOAPP);
				TcoSup = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSup", mask, TCOSUP);
				TcoJob = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoJob", mask, TCOJOB);
		...
		public HashSet<Integer> comm(
			...
			if (TcoApp.equals(comp.TcoApp)) items.add(TCOAPP);
			if (TcoSup.equals(comp.TcoSup)) items.add(TCOSUP);
			if (TcoJob.equals(comp.TcoJob)) items.add(TCOJOB);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOAPP, TCOSUP, TCOJOB));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmRtjListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJLISTDATA, scrJref);
		...
		public QryWznmRtjList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtjListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRtjListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtjListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRtjListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRTJLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQRtjList();
			statappqry = (new QryWznmRtjList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRtjList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRtjList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRtjList rst;
		public QryWznmRtjList.StatApp statappqry;
		public QryWznmRtjList.StatShr statshrqry;
		public QryWznmRtjList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRtjListData");
