/**
  * \file PnlWznmPstHeadbar.java
  * Java API code for job PnlWznmPstHeadbar
...
public class PnlWznmPstHeadbar {
	/**
	  * StgInf (full: StgInfWznmPstHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmPstHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPstHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmPstHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPSTHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPstHeadbarData");
