/**
  * \file PnlWznmSbsATitle.java
  * Java API code for job PnlWznmSbsATitle
...
public class PnlWznmSbsATitle {
	/**
		* VecVDo (full: VecVWznmSbsATitleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbsATitle)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsATitle");

			String itemtag = "ContitemInfWznmSbsATitle";
	...
	/**
	  * StatApp (full: StatAppWznmSbsATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsATitle");

			String itemtag = "StatitemAppWznmSbsATitle";
	...
	/**
	  * StatShr (full: StatShrWznmSbsATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsATitle");

			String itemtag = "StatitemShrWznmSbsATitle";
	...
	/**
	  * StgIac (full: StgIacWznmSbsATitle)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsATitle");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsATitle";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsATitle");

			String itemtag = "TagitemWznmSbsATitle";
	...
	/**
		* DpchAppData (full: DpchAppWznmSbsATitleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSATITLEDATA, scrJref);
		...
		public QryWznmSbsATitle.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsATitleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbsATitleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSATITLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsATitleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbsATitleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSATITLEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQSbsATitle();
			statappqry = (new QryWznmSbsATitle()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsATitle()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsATitle()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsATitle rst;
		public QryWznmSbsATitle.StatApp statappqry;
		public QryWznmSbsATitle.StatShr statshrqry;
		public QryWznmSbsATitle.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsATitleData");
