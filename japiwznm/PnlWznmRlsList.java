/**
  * \file PnlWznmRlsList.java
  * Java API code for job PnlWznmRlsList
...
public class PnlWznmRlsList {
	/**
		* VecVDo (full: VecVWznmRlsListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmRlsList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmRlsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmRlsList";
	...
	/**
	  * ContInf (full: ContInfWznmRlsList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRlsList");
	...
	/**
	  * StatShr (full: StatShrWznmRlsList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRlsList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRlsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRlsList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRlsList");
	...
	/**
		* DpchAppData (full: DpchAppWznmRlsListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRLSLISTDATA, scrJref);
		...
		public QryWznmRlsList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRlsListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRlsListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRLSLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRlsListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRlsListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRLSLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQRlsList();
			statappqry = (new QryWznmRlsList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRlsList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRlsList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRlsList rst;
		public QryWznmRlsList.StatApp statappqry;
		public QryWznmRlsList.StatShr statshrqry;
		public QryWznmRlsList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRlsListData");
