/**
  * \file QryWznmSge1NSensitivity.java
  * Java API code for job QryWznmSge1NSensitivity
...
public class QryWznmSge1NSensitivity {
	/**
	  * StatApp (full: StatAppQryWznmSge1NSensitivity)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSge1NSensitivity");
	...
	/**
	  * StatShr (full: StatShrQryWznmSge1NSensitivity)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSge1NSensitivity");
	...
	/**
	  * StgIac (full: StgIacQryWznmSge1NSensitivity)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSge1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSge1NSensitivity";
