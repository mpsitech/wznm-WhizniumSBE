/**
  * \file PnlWznmTbl1NStub.java
  * Java API code for job PnlWznmTbl1NStub
...
public class PnlWznmTbl1NStub {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTbl1NStub");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTbl1NStub");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTbl1NStub");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTbl1NStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTbl1NStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTbl1NStub");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NSTUBDATA, scrJref);
		...
		public QryWznmTbl1NStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NStubData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NStubDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBL1NSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTbl1NStub();
			statappqry = (new QryWznmTbl1NStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTbl1NStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTbl1NStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTbl1NStub rst;
		public QryWznmTbl1NStub.StatApp statappqry;
		public QryWznmTbl1NStub.StatShr statshrqry;
		public QryWznmTbl1NStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTbl1NStubData");
