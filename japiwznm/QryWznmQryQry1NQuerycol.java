/**
  * \file QryWznmQryQry1NQuerycol.java
  * Java API code for job QryWznmQryQry1NQuerycol
...
public class QryWznmQryQry1NQuerycol {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmQryQry1NQuerycol");

			String itemtag = "StatitemAppQryWznmQryQry1NQuerycol";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmQryQry1NQuerycol");

			String itemtag = "StatitemShrQryWznmQryQry1NQuerycol";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmQryQry1NQuerycol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmQryQry1NQuerycol";
