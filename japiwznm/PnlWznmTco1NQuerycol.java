/**
  * \file PnlWznmTco1NQuerycol.java
  * Java API code for job PnlWznmTco1NQuerycol
...
public class PnlWznmTco1NQuerycol {
	/**
		* VecVDo (full: VecVWznmTco1NQuerycolDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTco1NQuerycol)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTco1NQuerycol");
	...
	/**
	  * StatApp (full: StatAppWznmTco1NQuerycol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTco1NQuerycol");
	...
	/**
	  * StatShr (full: StatShrWznmTco1NQuerycol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTco1NQuerycol");
	...
	/**
	  * StgIac (full: StgIacWznmTco1NQuerycol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTco1NQuerycol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTco1NQuerycol";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTco1NQuerycol");
	...
	/**
		* DpchAppData (full: DpchAppWznmTco1NQuerycolData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NQUERYCOLDATA, scrJref);
		...
		public QryWznmTco1NQuerycol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NQuerycolData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTco1NQuerycolDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NQUERYCOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NQuerycolDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTco1NQuerycolData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCO1NQUERYCOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTco1NQuerycol();
			statappqry = (new QryWznmTco1NQuerycol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTco1NQuerycol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTco1NQuerycol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTco1NQuerycol rst;
		public QryWznmTco1NQuerycol.StatApp statappqry;
		public QryWznmTco1NQuerycol.StatShr statshrqry;
		public QryWznmTco1NQuerycol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTco1NQuerycolData");
