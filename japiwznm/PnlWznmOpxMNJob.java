/**
  * \file PnlWznmOpxMNJob.java
  * Java API code for job PnlWznmOpxMNJob
...
public class PnlWznmOpxMNJob {
	/**
		* VecVDo (full: VecVWznmOpxMNJobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpxMNJob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxMNJob");
	...
	/**
	  * StatApp (full: StatAppWznmOpxMNJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpxMNJob");
	...
	/**
	  * StatShr (full: StatShrWznmOpxMNJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxMNJob");
	...
	/**
	  * StgIac (full: StgIacWznmOpxMNJob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxMNJob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxMNJob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxMNJob");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxMNJobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXMNJOBDATA, scrJref);
		...
		public QryWznmOpxMNJob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxMNJobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxMNJobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXMNJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxMNJobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxMNJobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXMNJOBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpxMNJob();
			statappqry = (new QryWznmOpxMNJob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxMNJob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxMNJob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxMNJob rst;
		public QryWznmOpxMNJob.StatApp statappqry;
		public QryWznmOpxMNJob.StatShr statshrqry;
		public QryWznmOpxMNJob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxMNJobData");
