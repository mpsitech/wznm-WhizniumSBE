/**
  * \file CrdWznmChk.java
  * Java API code for job CrdWznmChk
...
public class CrdWznmChk {
	/**
		* VecVDo (full: VecVWznmChkDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmChk)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDCHK = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDCHK));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdChk;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmChk");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdChk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdChk", mask, MTXCRDCHK);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdChk.equals(comp.MtxCrdChk)) items.add(MTXCRDCHK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDCHK));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmChk");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmChk");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmChk");
	...
	/**
		* DpchAppDo (full: DpchAppWznmChkDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCHKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmChkDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmChkData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCHKDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmChkData");
