/**
  * \file PnlWznmOpxARetval.java
  * Java API code for job PnlWznmOpxARetval
...
public class PnlWznmOpxARetval {
	/**
		* VecVDo (full: VecVWznmOpxARetvalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpxARetval)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxARetval");
	...
	/**
	  * StatApp (full: StatAppWznmOpxARetval)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpxARetval");
	...
	/**
	  * StatShr (full: StatShrWznmOpxARetval)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxARetval");
	...
	/**
	  * StgIac (full: StgIacWznmOpxARetval)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxARetval");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxARetval";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxARetval");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxARetvalData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXARETVALDATA, scrJref);
		...
		public QryWznmOpxARetval.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxARetvalData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxARetvalDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXARETVALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxARetvalDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxARetvalData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXARETVALDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQOpxARetval();
			statappqry = (new QryWznmOpxARetval()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxARetval()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxARetval()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxARetval rst;
		public QryWznmOpxARetval.StatApp statappqry;
		public QryWznmOpxARetval.StatShr statshrqry;
		public QryWznmOpxARetval.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxARetvalData");
