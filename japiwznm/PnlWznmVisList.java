/**
  * \file PnlWznmVisList.java
  * Java API code for job PnlWznmVisList
...
public class PnlWznmVisList {
	/**
		* VecVDo (full: VecVWznmVisListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmVisList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmVisList");

			String itemtag = "ContitemIacWznmVisList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmVisList";

			String itemtag;

			if (shorttags) itemtag = "Ci";
			else itemtag = "ContitemIacWznmVisList";
	...
	/**
	  * ContInf (full: ContInfWznmVisList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVisList");

			String itemtag = "ContitemInfWznmVisList";
	...
	/**
	  * StatShr (full: StatShrWznmVisList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVisList");

			String itemtag = "StatitemShrWznmVisList";
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOTYPWIDTH, TCOVERWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVisList");

			String itemtag = "StgitemIacWznmVisList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVisList";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmVisList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOTYPWIDTH, TCOVERWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOTYP, TCOVER));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVisList");

			String itemtag = "TagitemWznmVisList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOTYP, TCOVER));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmVisListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					...
					, ContIac contiac
					, StgIac stgiac
					, QryWznmVisList.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMVISLISTDATA, scrJref);
		...
		public QryWznmVisList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVisListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVISLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVisListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVISLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQVisList();
			statappqry = (new QryWznmVisList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVisList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVisList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVisList rst;
		public QryWznmVisList.StatApp statappqry;
		public QryWznmVisList.StatShr statshrqry;
		public QryWznmVisList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVisListData");
