/**
  * \file PnlWznmMdlDetail.java
  * Java API code for job PnlWznmMdlDetail
...
public class PnlWznmMdlDetail {
	...
	public class ContIac extends Block {
		...
		public ContIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFPUPJ));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmMdlDetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmMdlDetail";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFPUPJ));
	...
	public class ContInf extends Block {
		...
		public static final int TXTCMT = 3;
		public static final int TXTVER = 4;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(TXTSRF, TXTTIT, TXTCMT, TXTVER));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMdlDetail");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TxtCmt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "TxtCmt", mask, TXTCMT);
		...
		public HashSet<Integer> comm(
			...
			if (TxtCmt.equals(comp.TxtCmt)) items.add(TXTCMT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TXTSRF, TXTTIT, TXTCMT, TXTVER));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMdlDetail");
	...
	public class StatShr extends Block {
		...
		public static final int TXTCMTACTIVE = 7;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, PUPJACTIVE, BUTJEDITAVAIL, TXTTITACTIVE, TXTCMTACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMdlDetail");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TxtCmtActive = Xmlio.extractBooleanAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TxtCmtActive", mask, TXTCMTACTIVE);
		...
		public HashSet<Integer> comm(
			...
			if (TxtCmtActive == comp.TxtCmtActive) items.add(TXTCMTACTIVE);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, PUPJACTIVE, BUTJEDITAVAIL, TXTTITACTIVE, TXTCMTACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTTIT, CPTCMT, CPTVER));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMdlDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTTIT, CPTCMT, CPTVER));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLDETAILDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlDetailData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLDETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlDetailDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMDLDETAILDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMdlDetailData");
