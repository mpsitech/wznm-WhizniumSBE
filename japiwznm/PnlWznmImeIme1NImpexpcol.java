/**
  * \file PnlWznmImeIme1NImpexpcol.java
  * Java API code for job PnlWznmImeIme1NImpexpcol
...
public class PnlWznmImeIme1NImpexpcol {
	/**
		* VecVDo (full: VecVWznmImeIme1NImpexpcolDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmImeIme1NImpexpcol)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmImeIme1NImpexpcol");
	...
	/**
	  * StatApp (full: StatAppWznmImeIme1NImpexpcol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmImeIme1NImpexpcol");
	...
	/**
	  * StatShr (full: StatShrWznmImeIme1NImpexpcol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmImeIme1NImpexpcol");
	...
	/**
	  * StgIac (full: StgIacWznmImeIme1NImpexpcol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmImeIme1NImpexpcol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmImeIme1NImpexpcol";
	...
	/**
	  * Tag (full: TagWznmImeIme1NImpexpcol)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmImeIme1NImpexpcol");
	...
	/**
		* DpchAppData (full: DpchAppWznmImeIme1NImpexpcolData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMEIME1NIMPEXPCOLDATA, scrJref);
		...
		public QryWznmImeIme1NImpexpcol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeIme1NImpexpcolData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmImeIme1NImpexpcolDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMEIME1NIMPEXPCOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeIme1NImpexpcolDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmImeIme1NImpexpcolData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIMEIME1NIMPEXPCOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQImeIme1NImpexpcol();
			statappqry = (new QryWznmImeIme1NImpexpcol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmImeIme1NImpexpcol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmImeIme1NImpexpcol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQImeIme1NImpexpcol rst;
		public QryWznmImeIme1NImpexpcol.StatApp statappqry;
		public QryWznmImeIme1NImpexpcol.StatShr statshrqry;
		public QryWznmImeIme1NImpexpcol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmImeIme1NImpexpcolData");
