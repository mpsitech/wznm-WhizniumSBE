/**
  * \file CrdWznmSht.java
  * Java API code for job CrdWznmSht
...
public class CrdWznmSht {
	/**
		* VecVDo (full: VecVWznmShtDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSht)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDSHT = 3;
		...
		public ContInf(
			...
			this.MtxCrdSht = MtxCrdSht;

			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSHT));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdSht;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSht");

			String itemtag = "ContitemInfWznmSht";

			if (Xmlio.checkXPath(doc, basexpath)) {
				numFSge = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "numFSge", mask, NUMFSGE);
				MrlAppHlp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", mask, MRLAPPHLP);
				MtxCrdSht = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdSht", mask, MTXCRDSHT);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdSht.equals(comp.MtxCrdSht)) items.add(MTXCRDSHT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSHT));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSht");

			String itemtag = "StatitemAppWznmSht";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSht");

			String itemtag = "StatitemShrWznmSht";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSht");

			String itemtag = "TagitemWznmSht";
	...
	/**
		* DpchAppDo (full: DpchAppWznmShtDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSHTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmShtDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmShtData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSHTDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmShtData");
