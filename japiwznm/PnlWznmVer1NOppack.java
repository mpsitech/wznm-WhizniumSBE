/**
  * \file PnlWznmVer1NOppack.java
  * Java API code for job PnlWznmVer1NOppack
...
public class PnlWznmVer1NOppack {
	/**
		* VecVDo (full: VecVWznmVer1NOppackDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NOppack)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NOppack");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NOppack)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NOppack");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NOppack)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NOppack");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NOppack)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NOppack");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NOppack";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NOppack");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NOppackData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NOPPACKDATA, scrJref);
		...
		public QryWznmVer1NOppack.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NOppackData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NOppackDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NOPPACKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NOppackDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NOppackData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NOPPACKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NOppack();
			statappqry = (new QryWznmVer1NOppack()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NOppack()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NOppack()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NOppack rst;
		public QryWznmVer1NOppack.StatApp statappqry;
		public QryWznmVer1NOppack.StatShr statshrqry;
		public QryWznmVer1NOppack.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NOppackData");
