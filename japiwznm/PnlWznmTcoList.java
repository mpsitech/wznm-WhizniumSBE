/**
  * \file PnlWznmTcoList.java
  * Java API code for job PnlWznmTcoList
...
public class PnlWznmTcoList {
	/**
		* VecVDo (full: VecVWznmTcoListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmTcoList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmTcoList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmTcoList";
	...
	/**
	  * ContInf (full: ContInfWznmTcoList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTcoList");
	...
	/**
	  * StatShr (full: StatShrWznmTcoList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTcoList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOTBLWIDTH = 4;
		public static final int TCOFCTWIDTH = 5;
		public static final int TCOSTYWIDTH = 6;
		public static final int TCOAXFWIDTH = 7;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOTBLWIDTH, TCOFCTWIDTH, TCOSTYWIDTH, TCOAXFWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTcoList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAxfWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoAxfWidth", mask, TCOAXFWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTcoList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoAxfWidth", TcoAxfWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoAxfWidth == comp.TcoAxfWidth) items.add(TCOAXFWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOTBLWIDTH, TCOFCTWIDTH, TCOSTYWIDTH, TCOAXFWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTBL = 11;
		public static final int TCOFCT = 12;
		public static final int TCOSTY = 13;
		public static final int TCOAXF = 14;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOTBL, TCOFCT, TCOSTY, TCOAXF));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTcoList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAxf = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoAxf", mask, TCOAXF);
		...
		public HashSet<Integer> comm(
			...
			if (TcoAxf.equals(comp.TcoAxf)) items.add(TCOAXF);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOTBL, TCOFCT, TCOSTY, TCOAXF));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmTcoListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOLISTDATA, scrJref);
		...
		public QryWznmTcoList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTcoListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTcoListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCOLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQTcoList();
			statappqry = (new QryWznmTcoList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTcoList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTcoList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTcoList rst;
		public QryWznmTcoList.StatApp statappqry;
		public QryWznmTcoList.StatShr statshrqry;
		public QryWznmTcoList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoListData");
