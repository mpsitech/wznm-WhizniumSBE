/**
  * \file QryWznmPst1NQuerymod.java
  * Java API code for job QryWznmPst1NQuerymod
...
public class QryWznmPst1NQuerymod {
	/**
	  * StatApp (full: StatAppQryWznmPst1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmPst1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrQryWznmPst1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmPst1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacQryWznmPst1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmPst1NQuerymod";
