/**
  * \file PnlWznmTblFct1NTablecol.java
  * Java API code for job PnlWznmTblFct1NTablecol
...
public class PnlWznmTblFct1NTablecol {
	/**
		* VecVDo (full: VecVWznmTblFct1NTablecolDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblFct1NTablecol)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblFct1NTablecol");
	...
	/**
	  * StatApp (full: StatAppWznmTblFct1NTablecol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblFct1NTablecol");
	...
	/**
	  * StatShr (full: StatShrWznmTblFct1NTablecol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblFct1NTablecol");
	...
	/**
	  * StgIac (full: StgIacWznmTblFct1NTablecol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblFct1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblFct1NTablecol";
	...
	/**
	  * Tag (full: TagWznmTblFct1NTablecol)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblFct1NTablecol");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblFct1NTablecolData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLFCT1NTABLECOLDATA, scrJref);
		...
		public QryWznmTblFct1NTablecol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblFct1NTablecolData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblFct1NTablecolDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLFCT1NTABLECOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblFct1NTablecolDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblFct1NTablecolData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLFCT1NTABLECOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblFct1NTablecol();
			statappqry = (new QryWznmTblFct1NTablecol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblFct1NTablecol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblFct1NTablecol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblFct1NTablecol rst;
		public QryWznmTblFct1NTablecol.StatApp statappqry;
		public QryWznmTblFct1NTablecol.StatShr statshrqry;
		public QryWznmTblFct1NTablecol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblFct1NTablecolData");
