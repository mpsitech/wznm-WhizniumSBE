/**
  * \file PnlWznmJobList.java
  * Java API code for job PnlWznmJobList
...
public class PnlWznmJobList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmJobList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmJobList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOGBLWIDTH = 6;
		public static final int TCOCLSWIDTH = 7;
		public static final int TCOSHDWIDTH = 8;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOGBLWIDTH, TCOCLSWIDTH, TCOSHDWIDTH));
		};
		...
		public int TcoGblWidth;
		public int TcoClsWidth;
		public int TcoShdWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoGblWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoGblWidth", mask, TCOGBLWIDTH);
				TcoClsWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoClsWidth", mask, TCOCLSWIDTH);
				TcoShdWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoShdWidth", mask, TCOSHDWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoGblWidth", TcoGblWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoClsWidth", TcoClsWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoShdWidth", TcoShdWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoGblWidth == comp.TcoGblWidth) items.add(TCOGBLWIDTH);
			if (TcoClsWidth == comp.TcoClsWidth) items.add(TCOCLSWIDTH);
			if (TcoShdWidth == comp.TcoShdWidth) items.add(TCOSHDWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOGBLWIDTH, TCOCLSWIDTH, TCOSHDWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOGBL = 13;
		public static final int TCOCLS = 14;
		public static final int TCOSHD = 15;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCORET, TCOREU, TCOGBL, TCOCLS, TCOSHD));
		};
		...
		public String TcoGbl;
		public String TcoCls;
		public String TcoShd;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoGbl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoGbl", mask, TCOGBL);
				TcoCls = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCls", mask, TCOCLS);
				TcoShd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoShd", mask, TCOSHD);
		...
		public HashSet<Integer> comm(
			...
			if (TcoGbl.equals(comp.TcoGbl)) items.add(TCOGBL);
			if (TcoCls.equals(comp.TcoCls)) items.add(TCOCLS);
			if (TcoShd.equals(comp.TcoShd)) items.add(TCOSHD);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCORET, TCOREU, TCOGBL, TCOCLS, TCOSHD));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBLISTDATA, scrJref);
		...
		public QryWznmJobList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobListData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobListDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQJobList();
			statappqry = (new QryWznmJobList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobList rst;
		public QryWznmJobList.StatApp statappqry;
		public QryWznmJobList.StatShr statshrqry;
		public QryWznmJobList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobListData");
