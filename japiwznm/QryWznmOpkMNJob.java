/**
  * \file QryWznmOpkMNJob.java
  * Java API code for job QryWznmOpkMNJob
...
public class QryWznmOpkMNJob {
	/**
	  * StatApp (full: StatAppQryWznmOpkMNJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmOpkMNJob");
	...
	/**
	  * StatShr (full: StatShrQryWznmOpkMNJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmOpkMNJob");
	...
	/**
	  * StgIac (full: StgIacQryWznmOpkMNJob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmOpkMNJob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmOpkMNJob";
