/**
  * \file PnlWznmCmp1NRelease.java
  * Java API code for job PnlWznmCmp1NRelease
...
public class PnlWznmCmp1NRelease {
	/**
		* VecVDo (full: VecVWznmCmp1NReleaseDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCmp1NRelease)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCmp1NRelease");
	...
	/**
	  * StatApp (full: StatAppWznmCmp1NRelease)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCmp1NRelease");
	...
	/**
	  * StatShr (full: StatShrWznmCmp1NRelease)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCmp1NRelease");
	...
	/**
	  * StgIac (full: StgIacWznmCmp1NRelease)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCmp1NRelease");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCmp1NRelease";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCmp1NRelease");
	...
	/**
		* DpchAppData (full: DpchAppWznmCmp1NReleaseData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMP1NRELEASEDATA, scrJref);
		...
		public QryWznmCmp1NRelease.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmp1NReleaseData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCmp1NReleaseDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMP1NRELEASEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmp1NReleaseDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCmp1NReleaseData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCMP1NRELEASEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCmp1NRelease();
			statappqry = (new QryWznmCmp1NRelease()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCmp1NRelease()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCmp1NRelease()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCmp1NRelease rst;
		public QryWznmCmp1NRelease.StatApp statappqry;
		public QryWznmCmp1NRelease.StatShr statshrqry;
		public QryWznmCmp1NRelease.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCmp1NReleaseData");
