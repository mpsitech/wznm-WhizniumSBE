/**
  * \file CrdWznmOpx.java
  * Java API code for job CrdWznmOpx
...
public class CrdWznmOpx {
	/**
		* VecVDo (full: VecVWznmOpxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpx)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDOPX = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDOPX));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdOpx;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpx");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdOpx = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdOpx", mask, MTXCRDOPX);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdOpx.equals(comp.MtxCrdOpx)) items.add(MTXCRDOPX);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDOPX));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpx");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpx");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpx");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxData");
