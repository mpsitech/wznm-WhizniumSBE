/**
  ...
  * Java API code for record of table TblWznmQJobSubMNJob
...
public class WznmQJobSubMNJob {
	
	public WznmQJobSubMNJob(
				int jnum
				, String stubMref
				, String Short
				, String yesnoMulti
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQJobSubMNJob");
