/**
  * \file PnlWznmSbsTos1NRelation.java
  * Java API code for job PnlWznmSbsTos1NRelation
...
public class PnlWznmSbsTos1NRelation {
	/**
		* VecVDo (full: VecVWznmSbsTos1NRelationDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbsTos1NRelation)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsTos1NRelation");
	...
	/**
	  * StatApp (full: StatAppWznmSbsTos1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsTos1NRelation");
	...
	/**
	  * StatShr (full: StatShrWznmSbsTos1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsTos1NRelation");
	...
	/**
	  * StgIac (full: StgIacWznmSbsTos1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsTos1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsTos1NRelation";
	...
	/**
	  * Tag (full: TagWznmSbsTos1NRelation)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsTos1NRelation");
	...
	/**
		* DpchAppData (full: DpchAppWznmSbsTos1NRelationData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSTOS1NRELATIONDATA, scrJref);
		...
		public QryWznmSbsTos1NRelation.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsTos1NRelationData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbsTos1NRelationDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSTOS1NRELATIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsTos1NRelationDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbsTos1NRelationData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSTOS1NRELATIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSbsTos1NRelation();
			statappqry = (new QryWznmSbsTos1NRelation()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsTos1NRelation()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsTos1NRelation()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsTos1NRelation rst;
		public QryWznmSbsTos1NRelation.StatApp statappqry;
		public QryWznmSbsTos1NRelation.StatShr statshrqry;
		public QryWznmSbsTos1NRelation.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsTos1NRelationData");
