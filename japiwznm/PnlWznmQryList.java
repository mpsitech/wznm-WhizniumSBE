/**
  * \file PnlWznmQryList.java
  * Java API code for job PnlWznmQryList
...
public class PnlWznmQryList {
	/**
		* VecVDo (full: VecVWznmQryListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmQryList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmQryList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmQryList";
	...
	/**
	  * ContInf (full: ContInfWznmQryList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQryList");

			String itemtag = "ContitemInfWznmQryList";
	...
	/**
	  * StatShr (full: StatShrWznmQryList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQryList");

			String itemtag = "StatitemShrWznmQryList";
	...
	public class StgIac extends Block {
		...
		public static final int TCOSUPWIDTH = 4;
		public static final int TCOSRLWIDTH = 5;
		public static final int TCOTBLWIDTH = 6;
		public static final int TCOQTBWIDTH = 7;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOQTBWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQryList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoQtbWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoQtbWidth", mask, TCOQTBWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQryList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoQtbWidth", TcoQtbWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoQtbWidth == comp.TcoQtbWidth) items.add(TCOQTBWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOQTBWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSUP = 11;
		public static final int TCOSRL = 12;
		public static final int TCOTBL = 13;
		public static final int TCOQTB = 14;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCOSUP, TCOSRL, TCOTBL, TCOQTB));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryList");

			String itemtag = "TagitemWznmQryList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoQtb = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoQtb", mask, TCOQTB);
		...
		public HashSet<Integer> comm(
			...
			if (TcoQtb.equals(comp.TcoQtb)) items.add(TCOQTB);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCOSUP, TCOSRL, TCOTBL, TCOQTB));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmQryListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYLISTDATA, scrJref);
		...
		public QryWznmQryList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQryListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQryListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQQryList();
			statappqry = (new QryWznmQryList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQryList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQryList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQryList rst;
		public QryWznmQryList.StatApp statappqry;
		public QryWznmQryList.StatShr statshrqry;
		public QryWznmQryList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryListData");
