/**
  * \file QryWznmRelSup1NRelation.java
  * Java API code for job QryWznmRelSup1NRelation
...
public class QryWznmRelSup1NRelation {
	/**
	  * StatApp (full: StatAppQryWznmRelSup1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRelSup1NRelation");
	...
	/**
	  * StatShr (full: StatShrQryWznmRelSup1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRelSup1NRelation");
	...
	/**
	  * StgIac (full: StgIacQryWznmRelSup1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRelSup1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRelSup1NRelation";
