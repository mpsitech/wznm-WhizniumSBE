/**
  * \file QryWznmTblSrc1NFeed.java
  * Java API code for job QryWznmTblSrc1NFeed
...
public class QryWznmTblSrc1NFeed {
	/**
	  * StatApp (full: StatAppQryWznmTblSrc1NFeed)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblSrc1NFeed");
	...
	/**
	  * StatShr (full: StatShrQryWznmTblSrc1NFeed)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblSrc1NFeed");
	...
	/**
	  * StgIac (full: StgIacQryWznmTblSrc1NFeed)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblSrc1NFeed");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblSrc1NFeed";
