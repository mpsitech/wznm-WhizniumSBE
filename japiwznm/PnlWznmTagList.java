/**
  * \file PnlWznmTagList.java
  * Java API code for job PnlWznmTagList
...
public class PnlWznmTagList {
	/**
		* VecVDo (full: VecVWznmTagListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmTagList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmTagList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmTagList";
	...
	/**
	  * ContInf (full: ContInfWznmTagList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTagList");
	...
	/**
	  * StatShr (full: StatShrWznmTagList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTagList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOCPBWIDTH, TCOGRPWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoTitWidth;
		public int TcoCpbWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTagList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoCpbWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCpbWidth", mask, TCOCPBWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTagList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCpbWidth", TcoCpbWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoCpbWidth == comp.TcoCpbWidth) items.add(TCOCPBWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOCPBWIDTH, TCOGRPWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTagList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoCpb = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCpb", mask, TCOCPB);
		...
		public HashSet<Integer> comm(
			...
			if (TcoCpb.equals(comp.TcoCpb)) items.add(TCOCPB);
	...
	/**
		* DpchAppData (full: DpchAppWznmTagListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTAGLISTDATA, scrJref);
		...
		public QryWznmTagList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTagListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTagListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTAGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTagListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTagListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTagList rst;
		public QryWznmTagList.StatApp statappqry;
		public QryWznmTagList.StatShr statshrqry;
		public QryWznmTagList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTagListData");
