/**
  * \file PnlWznmBoxHeadbar.java
  * Java API code for job PnlWznmBoxHeadbar
...
public class PnlWznmBoxHeadbar {
	/**
	  * StgInf (full: StgInfWznmBoxHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmBoxHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBoxHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmBoxHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBOXHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBoxHeadbarData");
