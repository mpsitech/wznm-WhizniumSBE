/**
  * \file QryWznmLibRef1NFile.java
  * Java API code for job QryWznmLibRef1NFile
...
public class QryWznmLibRef1NFile {
	/**
	  * StatApp (full: StatAppQryWznmLibRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmLibRef1NFile");
	...
	/**
	  * StatShr (full: StatShrQryWznmLibRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmLibRef1NFile");
	...
	/**
	  * StgIac (full: StgIacQryWznmLibRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmLibRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmLibRef1NFile";
