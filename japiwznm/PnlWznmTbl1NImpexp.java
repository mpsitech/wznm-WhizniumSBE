/**
  * \file PnlWznmTbl1NImpexp.java
  * Java API code for job PnlWznmTbl1NImpexp
...
public class PnlWznmTbl1NImpexp {
	/**
		* VecVDo (full: VecVWznmTbl1NImpexpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTbl1NImpexp)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTbl1NImpexp");
	...
	/**
	  * StatApp (full: StatAppWznmTbl1NImpexp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTbl1NImpexp");
	...
	/**
	  * StatShr (full: StatShrWznmTbl1NImpexp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTbl1NImpexp");
	...
	/**
	  * StgIac (full: StgIacWznmTbl1NImpexp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTbl1NImpexp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTbl1NImpexp";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTbl1NImpexp");
	...
	/**
		* DpchAppData (full: DpchAppWznmTbl1NImpexpData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NIMPEXPDATA, scrJref);
		...
		public QryWznmTbl1NImpexp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NImpexpData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTbl1NImpexpDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NIMPEXPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NImpexpDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTbl1NImpexpData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBL1NIMPEXPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTbl1NImpexp();
			statappqry = (new QryWznmTbl1NImpexp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTbl1NImpexp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTbl1NImpexp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTbl1NImpexp rst;
		public QryWznmTbl1NImpexp.StatApp statappqry;
		public QryWznmTbl1NImpexp.StatShr statshrqry;
		public QryWznmTbl1NImpexp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTbl1NImpexpData");
