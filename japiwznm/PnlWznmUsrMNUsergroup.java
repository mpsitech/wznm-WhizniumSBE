/**
  * \file PnlWznmUsrMNUsergroup.java
  * Java API code for job PnlWznmUsrMNUsergroup
...
public class PnlWznmUsrMNUsergroup {
	/**
		* VecVDo (full: VecVWznmUsrMNUsergroupDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmUsrMNUsergroup)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsrMNUsergroup");
	...
	/**
	  * StatApp (full: StatAppWznmUsrMNUsergroup)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmUsrMNUsergroup");
	...
	/**
	  * StatShr (full: StatShrWznmUsrMNUsergroup)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsrMNUsergroup");
	...
	/**
	  * StgIac (full: StgIacWznmUsrMNUsergroup)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsrMNUsergroup");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsrMNUsergroup";
	...
	/**
	  * Tag (full: TagWznmUsrMNUsergroup)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsrMNUsergroup");
	...
	/**
		* DpchAppData (full: DpchAppWznmUsrMNUsergroupData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRMNUSERGROUPDATA, scrJref);
		...
		public QryWznmUsrMNUsergroup.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrMNUsergroupData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsrMNUsergroupDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRMNUSERGROUPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrMNUsergroupDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsrMNUsergroupData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSRMNUSERGROUPDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQUsrMNUsergroup();
			statappqry = (new QryWznmUsrMNUsergroup()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsrMNUsergroup()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsrMNUsergroup()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsrMNUsergroup rst;
		public QryWznmUsrMNUsergroup.StatApp statappqry;
		public QryWznmUsrMNUsergroup.StatShr statshrqry;
		public QryWznmUsrMNUsergroup.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsrMNUsergroupData");
