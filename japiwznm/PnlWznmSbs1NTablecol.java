/**
  * \file PnlWznmSbs1NTablecol.java
  * Java API code for job PnlWznmSbs1NTablecol
...
public class PnlWznmSbs1NTablecol {
	/**
		* VecVDo (full: VecVWznmSbs1NTablecolDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbs1NTablecol)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbs1NTablecol");
	...
	/**
	  * StatApp (full: StatAppWznmSbs1NTablecol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbs1NTablecol");
	...
	/**
	  * StatShr (full: StatShrWznmSbs1NTablecol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbs1NTablecol");
	...
	/**
	  * StgIac (full: StgIacWznmSbs1NTablecol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbs1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbs1NTablecol";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbs1NTablecol");
	...
	/**
		* DpchAppData (full: DpchAppWznmSbs1NTablecolData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBS1NTABLECOLDATA, scrJref);
		...
		public QryWznmSbs1NTablecol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbs1NTablecolData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbs1NTablecolDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBS1NTABLECOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbs1NTablecolDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbs1NTablecolData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBS1NTABLECOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSbs1NTablecol();
			statappqry = (new QryWznmSbs1NTablecol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbs1NTablecol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbs1NTablecol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbs1NTablecol rst;
		public QryWznmSbs1NTablecol.StatApp statappqry;
		public QryWznmSbs1NTablecol.StatShr statshrqry;
		public QryWznmSbs1NTablecol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbs1NTablecolData");
