/**
  * \file PnlWznmCtpTpl1NCapability.java
  * Java API code for job PnlWznmCtpTpl1NCapability
...
public class PnlWznmCtpTpl1NCapability {
	/**
		* VecVDo (full: VecVWznmCtpTpl1NCapabilityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCtpTpl1NCapability)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtpTpl1NCapability");
	...
	/**
	  * StatApp (full: StatAppWznmCtpTpl1NCapability)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtpTpl1NCapability");
	...
	/**
	  * StatShr (full: StatShrWznmCtpTpl1NCapability)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtpTpl1NCapability");
	...
	/**
	  * StgIac (full: StgIacWznmCtpTpl1NCapability)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCtpTpl1NCapability");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCtpTpl1NCapability";
	...
	/**
	  * Tag (full: TagWznmCtpTpl1NCapability)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtpTpl1NCapability");
	...
	/**
		* DpchAppData (full: DpchAppWznmCtpTpl1NCapabilityData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPTPL1NCAPABILITYDATA, scrJref);
		...
		public QryWznmCtpTpl1NCapability.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpTpl1NCapabilityData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCtpTpl1NCapabilityDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPTPL1NCAPABILITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpTpl1NCapabilityDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCtpTpl1NCapabilityData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTPTPL1NCAPABILITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCtpTpl1NCapability();
			statappqry = (new QryWznmCtpTpl1NCapability()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCtpTpl1NCapability()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCtpTpl1NCapability()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCtpTpl1NCapability rst;
		public QryWznmCtpTpl1NCapability.StatApp statappqry;
		public QryWznmCtpTpl1NCapability.StatShr statshrqry;
		public QryWznmCtpTpl1NCapability.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtpTpl1NCapabilityData");
