/**
  * \file PnlWznmStbMNSquawk.java
  * Java API code for job PnlWznmStbMNSquawk
...
public class PnlWznmStbMNSquawk {
	/**
		* VecVDo (full: VecVWznmStbMNSquawkDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmStbMNSquawk)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmStbMNSquawk");
	...
	/**
	  * StatApp (full: StatAppWznmStbMNSquawk)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmStbMNSquawk");
	...
	/**
	  * StatShr (full: StatShrWznmStbMNSquawk)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmStbMNSquawk");
	...
	/**
	  * StgIac (full: StgIacWznmStbMNSquawk)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmStbMNSquawk");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmStbMNSquawk";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmStbMNSquawk");
	...
	/**
		* DpchAppData (full: DpchAppWznmStbMNSquawkData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBMNSQUAWKDATA, scrJref);
		...
		public QryWznmStbMNSquawk.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbMNSquawkData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmStbMNSquawkDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBMNSQUAWKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbMNSquawkDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmStbMNSquawkData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSTBMNSQUAWKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQStbMNSquawk();
			statappqry = (new QryWznmStbMNSquawk()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmStbMNSquawk()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmStbMNSquawk()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQStbMNSquawk rst;
		public QryWznmStbMNSquawk.StatApp statappqry;
		public QryWznmStbMNSquawk.StatShr statshrqry;
		public QryWznmStbMNSquawk.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmStbMNSquawkData");
