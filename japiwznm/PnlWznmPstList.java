/**
  * \file PnlWznmPstList.java
  * Java API code for job PnlWznmPstList
...
public class PnlWznmPstList {
	/**
		* VecVDo (full: VecVWznmPstListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmPstList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmPstList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmPstList";
	...
	/**
	  * ContInf (full: ContInfWznmPstList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPstList");
	...
	/**
	  * StatShr (full: StatShrWznmPstList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPstList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOATYWIDTH = 6;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOATYWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPstList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAtyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoAtyWidth", mask, TCOATYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPstList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoAtyWidth", TcoAtyWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoAtyWidth == comp.TcoAtyWidth) items.add(TCOATYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOATYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOATY = 13;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCORET, TCOREU, TCOATY));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPstList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoAty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoAty", mask, TCOATY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoAty.equals(comp.TcoAty)) items.add(TCOATY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCORET, TCOREU, TCOATY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmPstListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPSTLISTDATA, scrJref);
		...
		public QryWznmPstList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPstListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmPstListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPSTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPstListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmPstListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPSTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQPstList();
			statappqry = (new QryWznmPstList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPstList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPstList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPstList rst;
		public QryWznmPstList.StatApp statappqry;
		public QryWznmPstList.StatShr statshrqry;
		public QryWznmPstList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPstListData");
