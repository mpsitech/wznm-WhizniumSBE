...
public class PnlWznmLibAPkglist {
	/**
		* VecVDo (full: VecVWznmLibAPkglistDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmLibAPkglist)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLibAPkglist");
	...
	/**
	  * StatApp (full: StatAppWznmLibAPkglist)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmLibAPkglist");
	...
	/**
	  * StatShr (full: StatShrWznmLibAPkglist)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLibAPkglist");
	...
	/**
	  * StgIac (full: StgIacWznmLibAPkglist)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLibAPkglist");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLibAPkglist";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLibAPkglist");
	...
	/**
		* DpchAppData (full: DpchAppWznmLibAPkglistData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBAPKGLISTDATA, scrJref);
		...
		public QryWznmLibAPkglist.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibAPkglistData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmLibAPkglistDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBAPKGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibAPkglistDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmLibAPkglistData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLIBAPKGLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQLibAPkglist();
			statappqry = (new QryWznmLibAPkglist()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLibAPkglist()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLibAPkglist()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLibAPkglist rst;
		public QryWznmLibAPkglist.StatApp statappqry;
		public QryWznmLibAPkglist.StatShr statshrqry;
		public QryWznmLibAPkglist.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLibAPkglistData");
