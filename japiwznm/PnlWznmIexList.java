/**
  * \file PnlWznmIexList.java
  * Java API code for job PnlWznmIexList
...
public class PnlWznmIexList {
	/**
		* VecVDo (full: VecVWznmIexListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmIexList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmIexList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmIexList";
	...
	/**
	  * ContInf (full: ContInfWznmIexList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIexList");
	...
	/**
	  * StatShr (full: StatShrWznmIexList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIexList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOVERWIDTH = 4;
		public static final int TCOMIVWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOMIVWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmIexList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMivWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoMivWidth", mask, TCOMIVWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmIexList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoMivWidth", TcoMivWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoMivWidth == comp.TcoMivWidth) items.add(TCOMIVWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOMIVWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOMIV = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTIT, TCOVER, TCOMIV));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIexList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMiv = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoMiv", mask, TCOMIV);
		...
		public HashSet<Integer> comm(
			...
			if (TcoMiv.equals(comp.TcoMiv)) items.add(TCOMIV);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTIT, TCOVER, TCOMIV));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmIexListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXLISTDATA, scrJref);
		...
		public QryWznmIexList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIexListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIexListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIEXLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQIexList();
			statappqry = (new QryWznmIexList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmIexList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmIexList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQIexList rst;
		public QryWznmIexList.StatApp statappqry;
		public QryWznmIexList.StatShr statshrqry;
		public QryWznmIexList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIexListData");
