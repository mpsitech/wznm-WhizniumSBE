/**
  * \file CrdWznmDlg.java
  * Java API code for job CrdWznmDlg
...
public class CrdWznmDlg {
	/**
		* VecVDo (full: VecVWznmDlgDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmDlg)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDDLG = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDDLG));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdDlg;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmDlg");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdDlg = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdDlg", mask, MTXCRDDLG);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdDlg.equals(comp.MtxCrdDlg)) items.add(MTXCRDDLG);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDDLG));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmDlg");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmDlg");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmDlg");
	...
	/**
		* DpchAppDo (full: DpchAppWznmDlgDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmDlgData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMDLGDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmDlgData");
