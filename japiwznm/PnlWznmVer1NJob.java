/**
  * \file PnlWznmVer1NJob.java
  * Java API code for job PnlWznmVer1NJob
...
public class PnlWznmVer1NJob {
	/**
		* VecVDo (full: VecVWznmVer1NJobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NJob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NJob");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NJob");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NJob");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NJob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NJob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NJob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NJob");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NJobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NJOBDATA, scrJref);
		...
		public QryWznmVer1NJob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NJobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NJobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NJobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NJobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NJOBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NJob();
			statappqry = (new QryWznmVer1NJob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NJob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NJob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NJob rst;
		public QryWznmVer1NJob.StatApp statappqry;
		public QryWznmVer1NJob.StatShr statshrqry;
		public QryWznmVer1NJob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NJobData");
