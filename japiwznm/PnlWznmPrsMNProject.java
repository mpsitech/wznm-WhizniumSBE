/**
  * \file PnlWznmPrsMNProject.java
  * Java API code for job PnlWznmPrsMNProject
...
public class PnlWznmPrsMNProject {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPrsMNProject");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPrsMNProject");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPrsMNProject");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPrsMNProject");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPrsMNProject";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPrsMNProject");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRSMNPROJECTDATA, scrJref);
		...
		public QryWznmPrsMNProject.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrsMNProjectData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRSMNPROJECTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrsMNProjectDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPRSMNPROJECTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQPrsMNProject();
			statappqry = (new QryWznmPrsMNProject()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPrsMNProject()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPrsMNProject()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPrsMNProject rst;
		public QryWznmPrsMNProject.StatApp statappqry;
		public QryWznmPrsMNProject.StatShr statshrqry;
		public QryWznmPrsMNProject.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPrsMNProjectData");
