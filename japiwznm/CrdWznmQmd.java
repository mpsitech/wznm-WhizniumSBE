/**
  * \file CrdWznmQmd.java
  * Java API code for job CrdWznmQmd
...
public class CrdWznmQmd {
	/**
		* VecVDo (full: VecVWznmQmdDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmQmd)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDQMD = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQMD));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdQmd;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQmd");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdQmd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdQmd", mask, MTXCRDQMD);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdQmd.equals(comp.MtxCrdQmd)) items.add(MTXCRDQMD);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQMD));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQmd");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQmd");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQmd");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQmdDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQMDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQmdDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQmdData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQMDDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQmdData");
