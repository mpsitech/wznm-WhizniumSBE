/**
  * \file PnlWznmSbsPst1NQuerymod.java
  * Java API code for job PnlWznmSbsPst1NQuerymod
...
public class PnlWznmSbsPst1NQuerymod {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsPst1NQuerymod");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsPst1NQuerymod");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsPst1NQuerymod");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsPst1NQuerymod";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsPst1NQuerymod");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSPST1NQUERYMODDATA, scrJref);
		...
		public QryWznmSbsPst1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsPst1NQuerymodData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSPST1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsPst1NQuerymodDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSPST1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSbsPst1NQuerymod();
			statappqry = (new QryWznmSbsPst1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsPst1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsPst1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsPst1NQuerymod rst;
		public QryWznmSbsPst1NQuerymod.StatApp statappqry;
		public QryWznmSbsPst1NQuerymod.StatShr statshrqry;
		public QryWznmSbsPst1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsPst1NQuerymodData");
