/**
  * \file PnlWznmChkHeadbar.java
  * Java API code for job PnlWznmChkHeadbar
...
public class PnlWznmChkHeadbar {
	/**
	  * StgInf (full: StgInfWznmChkHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmChkHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmChkHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmChkHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCHKHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmChkHeadbarData");
