/**
  * \file PnlWznmStbList.java
  * Java API code for job PnlWznmStbList
...
public class PnlWznmStbList {
	/**
		* VecVDo (full: VecVWznmStbListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmStbList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmStbList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmStbList";
	...
	/**
	  * ContInf (full: ContInfWznmStbList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmStbList");
	...
	/**
	  * StatShr (full: StatShrWznmStbList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmStbList");
	...
	/**
	  * StgIac (full: StgIacWznmStbList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOTYPWIDTH = 2;
		public static final int TCOTBLWIDTH = 3;
		public static final int TCOSBSWIDTH = 4;
		public static final int TCOEXAWIDTH = 5;
		...
		public StgIac(
			...
			this.TcoExaWidth = TcoExaWidth;

			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOTBLWIDTH, TCOSBSWIDTH, TCOEXAWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmStbList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoExaWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoExaWidth", mask, TCOEXAWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmStbList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoExaWidth", TcoExaWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoExaWidth == comp.TcoExaWidth) items.add(TCOEXAWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOTBLWIDTH, TCOSBSWIDTH, TCOEXAWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTBL = 10;
		public static final int TCOSBS = 11;
		public static final int TCOEXA = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOTBL, TCOSBS, TCOEXA));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmStbList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoExa = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoExa", mask, TCOEXA);
		...
		public HashSet<Integer> comm(
			...
			if (TcoExa.equals(comp.TcoExa)) items.add(TCOEXA);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOTBL, TCOSBS, TCOEXA));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmStbListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBLISTDATA, scrJref);
		...
		public QryWznmStbList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmStbListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmStbListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSTBLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQStbList();
			statappqry = (new QryWznmStbList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmStbList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmStbList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQStbList rst;
		public QryWznmStbList.StatApp statappqry;
		public QryWznmStbList.StatShr statshrqry;
		public QryWznmStbList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmStbListData");
