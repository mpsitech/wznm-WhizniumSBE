/**
	...
	* Java API code for record of table TblWznmQPrsMNProject
...
public class WznmQPrsMNProject {
	
	public WznmQPrsMNProject(
				int jnum
				, String stubMref
				, String ftmX1Startd
				, String ftmX1Stopd
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQPrsMNProject");
