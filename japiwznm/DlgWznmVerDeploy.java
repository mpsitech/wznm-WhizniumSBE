...
public class DlgWznmVerDeploy {
	/**
		* VecVDit (full: VecVDlgWznmVerDeployDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVerDeployDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVerDeployDoImp)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVerDeploy)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVerDeploy");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVerDeploy";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVerDeploy)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDeploy");
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVerDeployImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDeployImp");
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVerDeployLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDeployLfi");
	...
	/**
	  * StatApp (full: StatAppDlgWznmVerDeploy)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVerDeploy");
	...
	/**
	  * StatShr (full: StatShrDlgWznmVerDeploy)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDeploy");
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVerDeployIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDeployIfi");
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVerDeployImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDeployImp");
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVerDeployLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDeployLfi");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDeploy");
	...
	/**
	  * TagIfi (full: TagDlgWznmVerDeployIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDeployIfi");
	...
	/**
	  * TagImp (full: TagDlgWznmVerDeployImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDeployImp");
	...
	/**
	  * TagLfi (full: TagDlgWznmVerDeployLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDeployLfi");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERDEPLOYDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerDeployData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVerDeployDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerDeployDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVerDeployData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVerDeployData");
