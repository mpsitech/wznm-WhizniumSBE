/**
  * \file PnlWznmIexRef1NDialog.java
  * Java API code for job PnlWznmIexRef1NDialog
...
public class PnlWznmIexRef1NDialog {
	/**
		* VecVDo (full: VecVWznmIexRef1NDialogDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmIexRef1NDialog)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIexRef1NDialog");

			String itemtag = "ContitemInfWznmIexRef1NDialog";
	...
	/**
	  * StatApp (full: StatAppWznmIexRef1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmIexRef1NDialog");

			String itemtag = "StatitemAppWznmIexRef1NDialog";
	...
	/**
	  * StatShr (full: StatShrWznmIexRef1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIexRef1NDialog");

			String itemtag = "StatitemShrWznmIexRef1NDialog";
	...
	/**
	  * StgIac (full: StgIacWznmIexRef1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmIexRef1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmIexRef1NDialog";
	...
	/**
	  * Tag (full: TagWznmIexRef1NDialog)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIexRef1NDialog");

			String itemtag = "TagitemWznmIexRef1NDialog";
	...
	/**
		* DpchAppData (full: DpchAppWznmIexRef1NDialogData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXREF1NDIALOGDATA, scrJref);
		...
		public QryWznmIexRef1NDialog.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexRef1NDialogData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIexRef1NDialogDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXREF1NDIALOGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexRef1NDialogDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIexRef1NDialogData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIEXREF1NDIALOGDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQIexRef1NDialog();
			statappqry = (new QryWznmIexRef1NDialog()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmIexRef1NDialog()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmIexRef1NDialog()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQIexRef1NDialog rst;
		public QryWznmIexRef1NDialog.StatApp statappqry;
		public QryWznmIexRef1NDialog.StatShr statshrqry;
		public QryWznmIexRef1NDialog.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIexRef1NDialogData");
