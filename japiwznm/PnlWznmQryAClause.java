/**
  * \file PnlWznmQryAClause.java
  * Java API code for job PnlWznmQryAClause
...
public class PnlWznmQryAClause {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQryAClause");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQryAClause");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQryAClause");
	...
	public class StgIac extends Block {
		...
		public static final int TCOQMDWIDTH = 1;
		public static final int TCOTYPWIDTH = 2;
		public static final int TCOCSEWIDTH = 3;
		public static final int TCOPSTWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOQMDWIDTH, TCOTYPWIDTH, TCOCSEWIDTH, TCOPSTWIDTH, TCOVECWIDTH, TCOVITWIDTH));
		};

		public int TcoQmdWidth;
		public int TcoTypWidth;
		public int TcoCseWidth;
		public int TcoPstWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQryAClause");

			String itemtag = "StgitemIacWznmQryAClause";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoQmdWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoQmdWidth", mask, TCOQMDWIDTH);
				TcoTypWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTypWidth", mask, TCOTYPWIDTH);
				TcoCseWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCseWidth", mask, TCOCSEWIDTH);
				TcoPstWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoPstWidth", mask, TCOPSTWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQryAClause";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoQmdWidth", TcoQmdWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTypWidth", TcoTypWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCseWidth", TcoCseWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoPstWidth", TcoPstWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoQmdWidth == comp.TcoQmdWidth) items.add(TCOQMDWIDTH);
			if (TcoTypWidth == comp.TcoTypWidth) items.add(TCOTYPWIDTH);
			if (TcoCseWidth == comp.TcoCseWidth) items.add(TCOCSEWIDTH);
			if (TcoPstWidth == comp.TcoPstWidth) items.add(TCOPSTWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOQMDWIDTH, TCOTYPWIDTH, TCOCSEWIDTH, TCOPSTWIDTH, TCOVECWIDTH, TCOVITWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOQMD = 7;
		public static final int TCOTYP = 8;
		public static final int TCOCSE = 9;
		public static final int TCOPST = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOQMD, TCOTYP, TCOCSE, TCOPST, TCOVEC, TCOVIT));
		};
		...
		public String TcoQmd;
		public String TcoTyp;
		public String TcoCse;
		public String TcoPst;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryAClause");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoQmd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoQmd", mask, TCOQMD);
				TcoTyp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTyp", mask, TCOTYP);
				TcoCse = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCse", mask, TCOCSE);
				TcoPst = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoPst", mask, TCOPST);
		...
		public HashSet<Integer> comm(
			...
			if (TcoQmd.equals(comp.TcoQmd)) items.add(TCOQMD);
			if (TcoTyp.equals(comp.TcoTyp)) items.add(TCOTYP);
			if (TcoCse.equals(comp.TcoCse)) items.add(TCOCSE);
			if (TcoPst.equals(comp.TcoPst)) items.add(TCOPST);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOQMD, TCOTYP, TCOCSE, TCOPST, TCOVEC, TCOVIT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYACLAUSEDATA, scrJref);
		...
		public QryWznmQryAClause.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryAClauseData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYACLAUSEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryAClauseDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYACLAUSEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQQryAClause();
			statappqry = (new QryWznmQryAClause()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQryAClause()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQryAClause()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQryAClause rst;
		public QryWznmQryAClause.StatApp statappqry;
		public QryWznmQryAClause.StatShr statshrqry;
		public QryWznmQryAClause.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryAClauseData");
