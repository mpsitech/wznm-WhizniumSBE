/**
  * \file PnlWznmJob1NMethod.java
  * Java API code for job PnlWznmJob1NMethod
...
public class PnlWznmJob1NMethod {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJob1NMethod");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJob1NMethod");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJob1NMethod");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJob1NMethod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJob1NMethod";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJob1NMethod");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOB1NMETHODDATA, scrJref);
		...
		public QryWznmJob1NMethod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJob1NMethodData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOB1NMETHODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJob1NMethodDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOB1NMETHODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJob1NMethod();
			statappqry = (new QryWznmJob1NMethod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJob1NMethod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJob1NMethod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJob1NMethod rst;
		public QryWznmJob1NMethod.StatApp statappqry;
		public QryWznmJob1NMethod.StatShr statshrqry;
		public QryWznmJob1NMethod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJob1NMethodData");
