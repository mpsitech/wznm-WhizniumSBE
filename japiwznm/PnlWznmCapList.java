/**
  * \file PnlWznmCapList.java
  * Java API code for job PnlWznmCapList
...
public class PnlWznmCapList {
	/**
		* VecVDo (full: VecVWznmCapListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmCapList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmCapList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmCapList";
	...
	/**
	  * ContInf (full: ContInfWznmCapList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCapList");
	...
	/**
	  * StatShr (full: StatShrWznmCapList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCapList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOTPLWIDTH = 4;
		public static final int TCOATFWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOTPLWIDTH, TCOATFWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCapList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCapList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOTPLWIDTH, TCOATFWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTPL = 11;
		public static final int TCOATF = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCOTPL, TCOATF));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCapList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCOTPL, TCOATF));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmCapListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAPLISTDATA, scrJref);
		...
		public QryWznmCapList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCapListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCapListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAPLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCapListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCapListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCAPLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQCapList();
			statappqry = (new QryWznmCapList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCapList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCapList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCapList rst;
		public QryWznmCapList.StatApp statappqry;
		public QryWznmCapList.StatShr statshrqry;
		public QryWznmCapList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCapListData");
