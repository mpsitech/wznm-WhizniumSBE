/**
  * \file PnlWznmVerVer1NVisual.java
  * Java API code for job PnlWznmVerVer1NVisual
...
public class PnlWznmVerVer1NVisual {
	/**
		* VecVDo (full: VecVWznmVerVer1NVisualDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerVer1NVisual)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerVer1NVisual");
	...
	/**
	  * StatApp (full: StatAppWznmVerVer1NVisual)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerVer1NVisual");
	...
	/**
	  * StatShr (full: StatShrWznmVerVer1NVisual)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerVer1NVisual");
	...
	/**
	  * StgIac (full: StgIacWznmVerVer1NVisual)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerVer1NVisual");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerVer1NVisual";
	...
	/**
	  * Tag (full: TagWznmVerVer1NVisual)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerVer1NVisual");
	...
	/**
		* DpchAppData (full: DpchAppWznmVerVer1NVisualData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NVISUALDATA, scrJref);
		...
		public QryWznmVerVer1NVisual.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NVisualData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerVer1NVisualDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NVISUALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NVisualDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerVer1NVisualData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERVER1NVISUALDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerVer1NVisual();
			statappqry = (new QryWznmVerVer1NVisual()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerVer1NVisual()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerVer1NVisual()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerVer1NVisual rst;
		public QryWznmVerVer1NVisual.StatApp statappqry;
		public QryWznmVerVer1NVisual.StatShr statshrqry;
		public QryWznmVerVer1NVisual.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerVer1NVisualData");
