/**
  * \file PnlWznmTblMNVector.java
  * Java API code for job PnlWznmTblMNVector
...
public class PnlWznmTblMNVector {
	/**
		* VecVDo (full: VecVWznmTblMNVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblMNVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblMNVector");
	...
	/**
	  * StatApp (full: StatAppWznmTblMNVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblMNVector");
	...
	/**
	  * StatShr (full: StatShrWznmTblMNVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblMNVector");
	...
	/**
	  * StgIac (full: StgIacWznmTblMNVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblMNVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblMNVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblMNVector");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblMNVectorData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLMNVECTORDATA, scrJref);
		...
		public QryWznmTblMNVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblMNVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblMNVectorDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLMNVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblMNVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblMNVectorData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLMNVECTORDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQTblMNVector();
			statappqry = (new QryWznmTblMNVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblMNVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblMNVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblMNVector rst;
		public QryWznmTblMNVector.StatApp statappqry;
		public QryWznmTblMNVector.StatShr statshrqry;
		public QryWznmTblMNVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblMNVectorData");
