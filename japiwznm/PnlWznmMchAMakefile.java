/**
  * \file PnlWznmMchAMakefile.java
  * Java API code for job PnlWznmMchAMakefile
...
public class PnlWznmMchAMakefile {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMchAMakefile");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMchAMakefile");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMchAMakefile");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMchAMakefile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMchAMakefile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMchAMakefile");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHAMAKEFILEDATA, scrJref);
		...
		public QryWznmMchAMakefile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchAMakefileData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHAMAKEFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchAMakefileDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMCHAMAKEFILEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQMchAMakefile();
			statappqry = (new QryWznmMchAMakefile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMchAMakefile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMchAMakefile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMchAMakefile rst;
		public QryWznmMchAMakefile.StatApp statappqry;
		public QryWznmMchAMakefile.StatShr statshrqry;
		public QryWznmMchAMakefile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMchAMakefileData");
