/**
  * \file PnlWznmRlsHeadbar.java
  * Java API code for job PnlWznmRlsHeadbar
...
public class PnlWznmRlsHeadbar {
	/**
	  * StgInf (full: StgInfWznmRlsHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmRlsHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRlsHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmRlsHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRLSHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRlsHeadbarData");
