/**
  * \file PnlWznmPrjMNPerson.java
  * Java API code for job PnlWznmPrjMNPerson
...
public class PnlWznmPrjMNPerson {
	/**
		* VecVDo (full: VecVWznmPrjMNPersonDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmPrjMNPerson)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPrjMNPerson");
	...
	/**
	  * StatApp (full: StatAppWznmPrjMNPerson)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPrjMNPerson");
	...
	/**
	  * StatShr (full: StatShrWznmPrjMNPerson)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPrjMNPerson");
	...
	/**
	  * StgIac (full: StgIacWznmPrjMNPerson)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPrjMNPerson");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPrjMNPerson";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPrjMNPerson");
	...
	/**
		* DpchAppData (full: DpchAppWznmPrjMNPersonData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRJMNPERSONDATA, scrJref);
		...
		public QryWznmPrjMNPerson.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrjMNPersonData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmPrjMNPersonDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRJMNPERSONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrjMNPersonDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmPrjMNPersonData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPRJMNPERSONDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQPrjMNPerson();
			statappqry = (new QryWznmPrjMNPerson()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPrjMNPerson()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPrjMNPerson()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPrjMNPerson rst;
		public QryWznmPrjMNPerson.StatApp statappqry;
		public QryWznmPrjMNPerson.StatShr statshrqry;
		public QryWznmPrjMNPerson.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPrjMNPersonData");
