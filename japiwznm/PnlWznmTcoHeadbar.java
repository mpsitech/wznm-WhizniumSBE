/**
  * \file PnlWznmTcoHeadbar.java
  * Java API code for job PnlWznmTcoHeadbar
...
public class PnlWznmTcoHeadbar {
	/**
	  * StgInf (full: StgInfWznmTcoHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmTcoHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTcoHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmTcoHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCOHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoHeadbarData");
