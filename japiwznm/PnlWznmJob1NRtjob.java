/**
  * \file PnlWznmJob1NRtjob.java
  * Java API code for job PnlWznmJob1NRtjob
...
public class PnlWznmJob1NRtjob {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJob1NRtjob");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJob1NRtjob");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJob1NRtjob");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJob1NRtjob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJob1NRtjob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJob1NRtjob");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOB1NRTJOBDATA, scrJref);
		...
		public QryWznmJob1NRtjob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJob1NRtjobData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOB1NRTJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJob1NRtjobDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOB1NRTJOBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJob1NRtjob();
			statappqry = (new QryWznmJob1NRtjob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJob1NRtjob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJob1NRtjob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJob1NRtjob rst;
		public QryWznmJob1NRtjob.StatApp statappqry;
		public QryWznmJob1NRtjob.StatShr statshrqry;
		public QryWznmJob1NRtjob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJob1NRtjobData");
