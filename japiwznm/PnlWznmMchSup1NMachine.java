/**
  * \file PnlWznmMchSup1NMachine.java
  * Java API code for job PnlWznmMchSup1NMachine
...
public class PnlWznmMchSup1NMachine {
	/**
		* VecVDo (full: VecVWznmMchSup1NMachineDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMchSup1NMachine)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMchSup1NMachine");
	...
	/**
	  * StatApp (full: StatAppWznmMchSup1NMachine)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMchSup1NMachine");
	...
	/**
	  * StatShr (full: StatShrWznmMchSup1NMachine)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMchSup1NMachine");
	...
	/**
	  * StgIac (full: StgIacWznmMchSup1NMachine)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMchSup1NMachine");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMchSup1NMachine";
	...
	/**
	  * Tag (full: TagWznmMchSup1NMachine)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMchSup1NMachine");
	...
	/**
		* DpchAppData (full: DpchAppWznmMchSup1NMachineData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHSUP1NMACHINEDATA, scrJref);
		...
		public QryWznmMchSup1NMachine.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchSup1NMachineData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMchSup1NMachineDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHSUP1NMACHINEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchSup1NMachineDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMchSup1NMachineData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMCHSUP1NMACHINEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQMchSup1NMachine();
			statappqry = (new QryWznmMchSup1NMachine()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMchSup1NMachine()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMchSup1NMachine()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMchSup1NMachine rst;
		public QryWznmMchSup1NMachine.StatApp statappqry;
		public QryWznmMchSup1NMachine.StatShr statshrqry;
		public QryWznmMchSup1NMachine.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMchSup1NMachineData");
