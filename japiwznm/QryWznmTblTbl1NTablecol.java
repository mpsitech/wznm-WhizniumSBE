/**
  * \file QryWznmTblTbl1NTablecol.java
  * Java API code for job QryWznmTblTbl1NTablecol
...
public class QryWznmTblTbl1NTablecol {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblTbl1NTablecol");

			String itemtag = "StatitemAppQryWznmTblTbl1NTablecol";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblTbl1NTablecol");

			String itemtag = "StatitemShrQryWznmTblTbl1NTablecol";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblTbl1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblTbl1NTablecol";
