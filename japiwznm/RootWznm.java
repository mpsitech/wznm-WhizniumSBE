/**
  * \file RootWznm.java
  * Java API code for job RootWznm
...
public class RootWznm {
	...
	/**
		...
		*/
	public class DpchAppLogin extends DpchAppWznm {
		...
		public DpchAppLogin(
			...
			super(VecWznmVDpch.DPCHAPPROOTWZNMLOGIN, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppRootWznmLogin");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGROOTWZNMDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngRootWznmData");
