/**
  * \file PnlWznmFilHeadbar.java
  * Java API code for job PnlWznmFilHeadbar
...
public class PnlWznmFilHeadbar {
	/**
	  * StgInf (full: StgInfWznmFilHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmFilHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmFilHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmFilHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMFILHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmFilHeadbarData");
