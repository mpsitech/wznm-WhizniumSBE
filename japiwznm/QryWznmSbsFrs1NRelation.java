/**
  * \file QryWznmSbsFrs1NRelation.java
  * Java API code for job QryWznmSbsFrs1NRelation
...
public class QryWznmSbsFrs1NRelation {
	/**
	  * StatApp (full: StatAppQryWznmSbsFrs1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSbsFrs1NRelation");
	...
	/**
	  * StatShr (full: StatShrQryWznmSbsFrs1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSbsFrs1NRelation");
	...
	/**
	  * StgIac (full: StgIacQryWznmSbsFrs1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSbsFrs1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSbsFrs1NRelation";
