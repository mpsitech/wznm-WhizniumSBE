/**
  * \file CrdWznmApp.java
  * Java API code for job CrdWznmApp
...
public class CrdWznmApp {
	...
	public static class VecVDo {
		...
		public static final int MITCRDWRCCLICK = 5;
	...
	public class ContInf extends Block {
		...
		public static final int MTXCRDAPP = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDAPP));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdApp;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmApp");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdApp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdApp", mask, MTXCRDAPP);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdApp.equals(comp.MtxCrdApp)) items.add(MTXCRDAPP);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDAPP));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmApp");
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFDLGIMPSTR = 1;
		...
		public static final int MITCRDISTAVAIL = 9;
		public static final int MITCRDISTACTIVE = 10;
		public static final int MITCRDWRCAVAIL = 11;
		public static final int MITCRDWRCACTIVE = 12;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(SCRJREFDLGIMPSTR, SCRJREFDLGNEW, SCRJREFDLGWRITE, SCRJREFHEADBAR, SCRJREFLIST, SCRJREFREC, MSPCRD1AVAIL, MITCRDNEWAVAIL, MITCRDISTAVAIL, MITCRDISTACTIVE, MITCRDWRCAVAIL, MITCRDWRCACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmApp");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(SCRJREFDLGIMPSTR, SCRJREFDLGNEW, SCRJREFDLGWRITE, SCRJREFHEADBAR, SCRJREFLIST, SCRJREFREC, MSPCRD1AVAIL, MITCRDNEWAVAIL, MITCRDISTAVAIL, MITCRDISTACTIVE, MITCRDWRCAVAIL, MITCRDWRCACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int MITCRDWRC = 5;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(MITAPPABT, MRLAPPHLP, MITCRDNEW, MITCRDIST, MITCRDWRC));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmApp");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(MITAPPABT, MRLAPPHLP, MITCRDNEW, MITCRDIST, MITCRDWRC));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmAppDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMAPPDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmAppData");
