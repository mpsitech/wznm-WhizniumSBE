/**
  * \file PnlWznmTagHeadbar.java
  * Java API code for job PnlWznmTagHeadbar
...
public class PnlWznmTagHeadbar {
	/**
	  * StgInf (full: StgInfWznmTagHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmTagHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTagHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmTagHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTAGHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTagHeadbarData");
