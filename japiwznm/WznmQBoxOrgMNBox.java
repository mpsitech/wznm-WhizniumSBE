/**
	* \file WznmQBoxOrgMNBox.java
	* Java API code for record of table TblWznmQBoxOrgMNBox
...
public class WznmQBoxOrgMNBox {
	
	public WznmQBoxOrgMNBox(
				int jnum
				, String stubMref
				, int orgClk
				, int dstClk
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQBoxOrgMNBox");
