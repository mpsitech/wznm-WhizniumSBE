/**
  * \file PnlWznmCalMNStub.java
  * Java API code for job PnlWznmCalMNStub
...
public class PnlWznmCalMNStub {
	/**
		* VecVDo (full: VecVWznmCalMNStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCalMNStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCalMNStub");
	...
	/**
	  * StatApp (full: StatAppWznmCalMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCalMNStub");
	...
	/**
	  * StatShr (full: StatShrWznmCalMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCalMNStub");
	...
	/**
	  * StgIac (full: StgIacWznmCalMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCalMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCalMNStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCalMNStub");
	...
	/**
		* DpchAppData (full: DpchAppWznmCalMNStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCALMNSTUBDATA, scrJref);
		...
		public QryWznmCalMNStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCalMNStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCalMNStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCALMNSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCalMNStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCalMNStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCALMNSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCalMNStub();
			statappqry = (new QryWznmCalMNStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCalMNStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCalMNStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCalMNStub rst;
		public QryWznmCalMNStub.StatApp statappqry;
		public QryWznmCalMNStub.StatShr statshrqry;
		public QryWznmCalMNStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCalMNStubData");
