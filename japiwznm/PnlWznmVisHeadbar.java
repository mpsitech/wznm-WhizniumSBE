/**
  * \file PnlWznmVisHeadbar.java
  * Java API code for job PnlWznmVisHeadbar
...
public class PnlWznmVisHeadbar {
	/**
	  * StgInf (full: StgInfWznmVisHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmVisHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVisHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmVisHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVISHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVisHeadbarData");
