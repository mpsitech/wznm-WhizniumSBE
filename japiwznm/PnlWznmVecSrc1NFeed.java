/**
  * \file PnlWznmVecSrc1NFeed.java
  * Java API code for job PnlWznmVecSrc1NFeed
...
public class PnlWznmVecSrc1NFeed {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecSrc1NFeed");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecSrc1NFeed");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecSrc1NFeed");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecSrc1NFeed");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecSrc1NFeed";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecSrc1NFeed");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECSRC1NFEEDDATA, scrJref);
		...
		public QryWznmVecSrc1NFeed.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecSrc1NFeedData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECSRC1NFEEDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecSrc1NFeedDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECSRC1NFEEDDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVecSrc1NFeed();
			statappqry = (new QryWznmVecSrc1NFeed()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecSrc1NFeed()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecSrc1NFeed()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecSrc1NFeed rst;
		public QryWznmVecSrc1NFeed.StatApp statappqry;
		public QryWznmVecSrc1NFeed.StatShr statshrqry;
		public QryWznmVecSrc1NFeed.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecSrc1NFeedData");
