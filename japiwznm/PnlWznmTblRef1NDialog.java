/**
  * \file PnlWznmTblRef1NDialog.java
  * Java API code for job PnlWznmTblRef1NDialog
...
public class PnlWznmTblRef1NDialog {
	/**
		* VecVDo (full: VecVWznmTblRef1NDialogDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblRef1NDialog)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblRef1NDialog");
	...
	/**
	  * StatApp (full: StatAppWznmTblRef1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblRef1NDialog");
	...
	/**
	  * StatShr (full: StatShrWznmTblRef1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblRef1NDialog");
	...
	/**
	  * StgIac (full: StgIacWznmTblRef1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblRef1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblRef1NDialog";
	...
	/**
	  * Tag (full: TagWznmTblRef1NDialog)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblRef1NDialog");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblRef1NDialogData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NDIALOGDATA, scrJref);
		...
		public QryWznmTblRef1NDialog.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NDialogData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblRef1NDialogDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NDIALOGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NDialogDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblRef1NDialogData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLREF1NDIALOGDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblRef1NDialog();
			statappqry = (new QryWznmTblRef1NDialog()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblRef1NDialog()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblRef1NDialog()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblRef1NDialog rst;
		public QryWznmTblRef1NDialog.StatApp statappqry;
		public QryWznmTblRef1NDialog.StatShr statshrqry;
		public QryWznmTblRef1NDialog.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblRef1NDialogData");
