/**
  * \file PnlWznmVer1NTable.java
  * Java API code for job PnlWznmVer1NTable
...
public class PnlWznmVer1NTable {
	/**
		* VecVDo (full: VecVWznmVer1NTableDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NTable)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NTable");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NTable)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NTable");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NTable)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NTable");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NTable)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NTable");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NTable";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NTable");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NTableData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NTABLEDATA, scrJref);
		...
		public QryWznmVer1NTable.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NTableData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NTableDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NTABLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NTableDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NTableData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NTABLEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NTable();
			statappqry = (new QryWznmVer1NTable()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NTable()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NTable()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NTable rst;
		public QryWznmVer1NTable.StatApp statappqry;
		public QryWznmVer1NTable.StatShr statshrqry;
		public QryWznmVer1NTable.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NTableData");
