/**
  * \file PnlWznmTblFr1NRelation.java
  * Java API code for job PnlWznmTblFr1NRelation
...
public class PnlWznmTblFr1NRelation {
	/**
		* VecVDo (full: VecVWznmTblFr1NRelationDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblFr1NRelation)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblFr1NRelation");
	...
	/**
	  * StatApp (full: StatAppWznmTblFr1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblFr1NRelation");
	...
	/**
	  * StatShr (full: StatShrWznmTblFr1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblFr1NRelation");
	...
	/**
	  * StgIac (full: StgIacWznmTblFr1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblFr1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblFr1NRelation";
	...
	/**
	  * Tag (full: TagWznmTblFr1NRelation)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblFr1NRelation");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblFr1NRelationData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLFR1NRELATIONDATA, scrJref);
		...
		public QryWznmTblFr1NRelation.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblFr1NRelationData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblFr1NRelationDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLFR1NRELATIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblFr1NRelationDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblFr1NRelationData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLFR1NRELATIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblFr1NRelation();
			statappqry = (new QryWznmTblFr1NRelation()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblFr1NRelation()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblFr1NRelation()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblFr1NRelation rst;
		public QryWznmTblFr1NRelation.StatApp statappqry;
		public QryWznmTblFr1NRelation.StatShr statshrqry;
		public QryWznmTblFr1NRelation.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblFr1NRelationData");
