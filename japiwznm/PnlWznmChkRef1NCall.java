/**
  * \file PnlWznmChkRef1NCall.java
  * Java API code for job PnlWznmChkRef1NCall
...
public class PnlWznmChkRef1NCall {
	/**
		* VecVDo (full: VecVWznmChkRef1NCallDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmChkRef1NCall)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmChkRef1NCall");
	...
	/**
	  * StatApp (full: StatAppWznmChkRef1NCall)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmChkRef1NCall");
	...
	/**
	  * StatShr (full: StatShrWznmChkRef1NCall)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmChkRef1NCall");
	...
	/**
	  * StgIac (full: StgIacWznmChkRef1NCall)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmChkRef1NCall");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmChkRef1NCall";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmChkRef1NCall");
	...
	/**
		* DpchAppData (full: DpchAppWznmChkRef1NCallData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCHKREF1NCALLDATA, scrJref);
		...
		public QryWznmChkRef1NCall.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmChkRef1NCallData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmChkRef1NCallDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCHKREF1NCALLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmChkRef1NCallDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmChkRef1NCallData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCHKREF1NCALLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQChkRef1NCall();
			statappqry = (new QryWznmChkRef1NCall()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmChkRef1NCall()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmChkRef1NCall()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQChkRef1NCall rst;
		public QryWznmChkRef1NCall.StatApp statappqry;
		public QryWznmChkRef1NCall.StatShr statshrqry;
		public QryWznmChkRef1NCall.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmChkRef1NCallData");
