/**
  * \file PnlWznmJobSubMNJob.java
  * Java API code for job PnlWznmJobSubMNJob
...
public class PnlWznmJobSubMNJob {
	/**
		* VecVDo (full: VecVWznmJobSubMNJobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobSubMNJob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobSubMNJob");

			String itemtag = "ContitemInfWznmJobSubMNJob";
	...
	/**
	  * StatApp (full: StatAppWznmJobSubMNJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobSubMNJob");

			String itemtag = "StatitemAppWznmJobSubMNJob";
	...
	/**
	  * StatShr (full: StatShrWznmJobSubMNJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobSubMNJob");

			String itemtag = "StatitemShrWznmJobSubMNJob";
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOSHOWIDTH, TCOMLTWIDTH, TCOCSAWIDTH));
		};

		public int TcoMrefWidth;
		public int TcoShoWidth;
		public int TcoMltWidth;
		public int TcoCsaWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobSubMNJob");

			String itemtag = "StgitemIacWznmJobSubMNJob";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMltWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoMltWidth", mask, TCOMLTWIDTH);
				TcoCsaWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCsaWidth", mask, TCOCSAWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobSubMNJob";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmJobSubMNJob";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoMltWidth", TcoMltWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCsaWidth", TcoCsaWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoMltWidth == comp.TcoMltWidth) items.add(TCOMLTWIDTH);
			if (TcoCsaWidth == comp.TcoCsaWidth) items.add(TCOCSAWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOSHOWIDTH, TCOMLTWIDTH, TCOCSAWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSHO = 8;
		public static final int TCOMLT = 9;
		public static final int TCOCSA = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOSHO, TCOMLT, TCOCSA));
		};
		...
		public String TcoMlt;
		public String TcoCsa;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobSubMNJob");

			String itemtag = "TagitemWznmJobSubMNJob";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoMlt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoMlt", mask, TCOMLT);
				TcoCsa = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCsa", mask, TCOCSA);
		...
		public HashSet<Integer> comm(
			...
			if (TcoMlt.equals(comp.TcoMlt)) items.add(TCOMLT);
			if (TcoCsa.equals(comp.TcoCsa)) items.add(TCOCSA);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOSHO, TCOMLT, TCOCSA));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmJobSubMNJobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					String scrJref
					, StgIac stgiac
					, QryWznmJobSubMNJob.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMJOBSUBMNJOBDATA, scrJref);
		...
		public QryWznmJobSubMNJob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobSubMNJobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobSubMNJobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBSUBMNJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobSubMNJobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobSubMNJobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBSUBMNJOBDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQJobSubMNJob();
			statappqry = (new QryWznmJobSubMNJob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobSubMNJob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobSubMNJob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobSubMNJob rst;
		public QryWznmJobSubMNJob.StatApp statappqry;
		public QryWznmJobSubMNJob.StatShr statshrqry;
		public QryWznmJobSubMNJob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobSubMNJobData");
