/**
  * \file QryWznmSbsTos1NRelation.java
  * Java API code for job QryWznmSbsTos1NRelation
...
public class QryWznmSbsTos1NRelation {
	/**
	  * StatApp (full: StatAppQryWznmSbsTos1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSbsTos1NRelation");
	...
	/**
	  * StatShr (full: StatShrQryWznmSbsTos1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSbsTos1NRelation");
	...
	/**
	  * StgIac (full: StgIacQryWznmSbsTos1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSbsTos1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSbsTos1NRelation";
