/**
  * \file CrdWznmTco.java
  * Java API code for job CrdWznmTco
...
public class CrdWznmTco {
	/**
		* VecVDo (full: VecVWznmTcoDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTco)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDTCO = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTCO));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdTco;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTco");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdTco = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdTco", mask, MTXCRDTCO);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdTco.equals(comp.MtxCrdTco)) items.add(MTXCRDTCO);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTCO));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTco");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTco");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTco");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTcoDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCODO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTcoData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCODATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoData");
