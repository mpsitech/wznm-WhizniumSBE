/**
  * \file DlgWznmAppImpstr.java
  * Java API code for job DlgWznmAppImpstr
...
public class DlgWznmAppImpstr {
	/**
		* VecVDit (full: VecVDlgWznmAppImpstrDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmAppImpstrDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmAppImpstrDoImp)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmAppImpstrSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmAppImpstr)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmAppImpstr");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmAppImpstr";
	...
	/**
	  * ContInf (full: ContInfDlgWznmAppImpstr)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmAppImpstr");

			String itemtag = "ContitemInfDlgWznmAppImpstr";
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmAppImpstrImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmAppImpstrImp");

			String itemtag = "ContitemInfDlgWznmAppImpstrImp";
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmAppImpstrLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmAppImpstrLfi");

			String itemtag = "ContitemInfDlgWznmAppImpstrLfi";
	...
	/**
	  * StatApp (full: StatAppDlgWznmAppImpstr)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmAppImpstr");

			String itemtag = "StatitemAppDlgWznmAppImpstr";
	...
	/**
	  * StatShr (full: StatShrDlgWznmAppImpstr)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmAppImpstr");

			String itemtag = "StatitemShrDlgWznmAppImpstr";
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmAppImpstrIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmAppImpstrIfi");

			String itemtag = "StatitemShrDlgWznmAppImpstrIfi";
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmAppImpstrImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmAppImpstrImp");

			String itemtag = "StatitemShrDlgWznmAppImpstrImp";
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmAppImpstrLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmAppImpstrLfi");

			String itemtag = "StatitemShrDlgWznmAppImpstrLfi";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmAppImpstr");

			String itemtag = "TagitemDlgWznmAppImpstr";
	...
	/**
	  * TagIfi (full: TagDlgWznmAppImpstrIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmAppImpstrIfi");

			String itemtag = "TagitemDlgWznmAppImpstrIfi";
	...
	/**
	  * TagImp (full: TagDlgWznmAppImpstrImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmAppImpstrImp");

			String itemtag = "TagitemDlgWznmAppImpstrImp";
	...
	/**
	  * TagLfi (full: TagDlgWznmAppImpstrLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmAppImpstrLfi");

			String itemtag = "TagitemDlgWznmAppImpstrLfi";
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmAppImpstrData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMAPPIMPSTRDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmAppImpstrData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmAppImpstrDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMAPPIMPSTRDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmAppImpstrDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmAppImpstrData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMAPPIMPSTRDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmAppImpstrData");
