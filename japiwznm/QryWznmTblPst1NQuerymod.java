/**
  * \file QryWznmTblPst1NQuerymod.java
  * Java API code for job QryWznmTblPst1NQuerymod
...
public class QryWznmTblPst1NQuerymod {
	/**
	  * StatApp (full: StatAppQryWznmTblPst1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblPst1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrQryWznmTblPst1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblPst1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacQryWznmTblPst1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblPst1NQuerymod";
