/**
  * \file QryWznmQryMNDialog.java
  * Java API code for job QryWznmQryMNDialog
...
public class QryWznmQryMNDialog {
	/**
	  * StatApp (full: StatAppQryWznmQryMNDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmQryMNDialog");
	...
	/**
	  * StatShr (full: StatShrQryWznmQryMNDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmQryMNDialog");
	...
	/**
	  * StgIac (full: StgIacQryWznmQryMNDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmQryMNDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmQryMNDialog";
