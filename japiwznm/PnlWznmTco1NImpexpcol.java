/**
  * \file PnlWznmTco1NImpexpcol.java
  * Java API code for job PnlWznmTco1NImpexpcol
...
public class PnlWznmTco1NImpexpcol {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTco1NImpexpcol");

			String itemtag = "ContitemInfWznmTco1NImpexpcol";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTco1NImpexpcol");

			String itemtag = "StatitemAppWznmTco1NImpexpcol";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTco1NImpexpcol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTco1NImpexpcol";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTco1NImpexpcol");

			String itemtag = "TagitemWznmTco1NImpexpcol";
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NIMPEXPCOLDATA, scrJref);
		...
		public QryWznmTco1NImpexpcol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NImpexpcolData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NIMPEXPCOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NImpexpcolDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCO1NIMPEXPCOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTco1NImpexpcol();
			statappqry = (new QryWznmTco1NImpexpcol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTco1NImpexpcol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTco1NImpexpcol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTco1NImpexpcol rst;
		public QryWznmTco1NImpexpcol.StatApp statappqry;
		public QryWznmTco1NImpexpcol.StatShr statshrqry;
		public QryWznmTco1NImpexpcol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTco1NImpexpcolData");
