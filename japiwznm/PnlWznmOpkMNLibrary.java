/**
  * \file PnlWznmOpkMNLibrary.java
  * Java API code for job PnlWznmOpkMNLibrary
...
public class PnlWznmOpkMNLibrary {
	/**
		* VecVDo (full: VecVWznmOpkMNLibraryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpkMNLibrary)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkMNLibrary");
	...
	/**
	  * StatApp (full: StatAppWznmOpkMNLibrary)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkMNLibrary");
	...
	/**
	  * StatShr (full: StatShrWznmOpkMNLibrary)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkMNLibrary");
	...
	/**
	  * StgIac (full: StgIacWznmOpkMNLibrary)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkMNLibrary");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkMNLibrary";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkMNLibrary");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkMNLibraryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNLIBRARYDATA, scrJref);
		...
		public QryWznmOpkMNLibrary.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNLibraryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkMNLibraryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNLIBRARYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNLibraryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkMNLibraryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKMNLIBRARYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpkMNLibrary();
			statappqry = (new QryWznmOpkMNLibrary()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkMNLibrary()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkMNLibrary()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkMNLibrary rst;
		public QryWznmOpkMNLibrary.StatApp statappqry;
		public QryWznmOpkMNLibrary.StatShr statshrqry;
		public QryWznmOpkMNLibrary.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkMNLibraryData");
