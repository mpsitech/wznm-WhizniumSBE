/**
  ...
  * Java API code for record of table TblWznmQCtpKParKey
...
public class WznmQCtpKParKey {
	
	public WznmQCtpKParKey(
				int jnum
				, String yesnoFixed
				, String sref
				, String Avail
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQCtpKParKey");
