/**
  * \file PnlWznmUtlHeadbar.java
  * Java API code for job PnlWznmUtlHeadbar
...
public class PnlWznmUtlHeadbar {
	/**
	  * StgInf (full: StgInfWznmUtlHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmUtlHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUtlHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmUtlHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUTLHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUtlHeadbarData");
