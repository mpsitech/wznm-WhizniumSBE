/**
  * \file PnlWznmRelRef1NPanel.java
  * Java API code for job PnlWznmRelRef1NPanel
...
public class PnlWznmRelRef1NPanel {
	/**
		* VecVDo (full: VecVWznmRelRef1NPanelDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRelRef1NPanel)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelRef1NPanel");
	...
	/**
	  * StatApp (full: StatAppWznmRelRef1NPanel)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRelRef1NPanel");
	...
	/**
	  * StatShr (full: StatShrWznmRelRef1NPanel)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelRef1NPanel");
	...
	/**
	  * StgIac (full: StgIacWznmRelRef1NPanel)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelRef1NPanel");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelRef1NPanel";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelRef1NPanel");
	...
	/**
		* DpchAppData (full: DpchAppWznmRelRef1NPanelData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NPANELDATA, scrJref);
		...
		public QryWznmRelRef1NPanel.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NPanelData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRelRef1NPanelDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NPANELDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NPanelDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRelRef1NPanelData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELREF1NPANELDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRelRef1NPanel();
			statappqry = (new QryWznmRelRef1NPanel()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelRef1NPanel()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelRef1NPanel()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelRef1NPanel rst;
		public QryWznmRelRef1NPanel.StatApp statappqry;
		public QryWznmRelRef1NPanel.StatShr statshrqry;
		public QryWznmRelRef1NPanel.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelRef1NPanelData");
