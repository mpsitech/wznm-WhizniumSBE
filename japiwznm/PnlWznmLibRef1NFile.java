/**
  * \file PnlWznmLibRef1NFile.java
  * Java API code for job PnlWznmLibRef1NFile
...
public class PnlWznmLibRef1NFile {
	/**
		* VecVDo (full: VecVWznmLibRef1NFileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmLibRef1NFile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLibRef1NFile");
	...
	/**
	  * StatApp (full: StatAppWznmLibRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmLibRef1NFile");
	...
	/**
	  * StatShr (full: StatShrWznmLibRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLibRef1NFile");
	...
	/**
	  * StgIac (full: StgIacWznmLibRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLibRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLibRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLibRef1NFile");
	...
	/**
		* DpchAppData (full: DpchAppWznmLibRef1NFileData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBREF1NFILEDATA, scrJref);
		...
		public QryWznmLibRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibRef1NFileData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmLibRef1NFileDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibRef1NFileDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmLibRef1NFileData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLIBREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQLibRef1NFile();
			statappqry = (new QryWznmLibRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLibRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLibRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLibRef1NFile rst;
		public QryWznmLibRef1NFile.StatApp statappqry;
		public QryWznmLibRef1NFile.StatShr statshrqry;
		public QryWznmLibRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLibRef1NFileData");
