/**
  * \file CrdWznmIex.java
  * Java API code for job CrdWznmIex
...
public class CrdWznmIex {
	/**
		* VecVDo (full: VecVWznmIexDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmIex)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDIEX = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDIEX));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdIex;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIex");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdIex = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdIex", mask, MTXCRDIEX);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdIex.equals(comp.MtxCrdIex)) items.add(MTXCRDIEX);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDIEX));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmIex");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIex");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIex");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIexDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIexData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIEXDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIexData");
