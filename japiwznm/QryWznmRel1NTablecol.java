/**
  * \file QryWznmRel1NTablecol.java
  * Java API code for job QryWznmRel1NTablecol
...
public class QryWznmRel1NTablecol {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRel1NTablecol");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRel1NTablecol");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRel1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRel1NTablecol";
