...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NCALL = 3;
		public static final int INITDONEVER1NERROR = 4;
		public static final int INITDONEVER1NAPP = 5;
		public static final int INITDONE1NCAPABILITY = 6;
		public static final int INITDONE1NVECTOR = 7;
		...
		public static final int INITDONEBVR1NVERSION = 14;
		public static final int INITDONE1NRELATION = 15;
		public static final int INITDONE1NBLOCK = 16;
		public static final int INITDONE1NOPPACK = 17;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NTABLE, INITDONEBVR1NVERSION, INITDONE1NRELATION, INITDONE1NBLOCK, INITDONE1NOPPACK, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NTABLE, INITDONEBVR1NVERSION, INITDONE1NRELATION, INITDONE1NBLOCK, INITDONE1NOPPACK, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NCALL = 4;
		public static final int SCRJREFVER1NERROR = 5;
		public static final int SCRJREFVER1NAPP = 6;
		public static final int SCRJREF1NCAPABILITY = 7;
		public static final int SCRJREF1NVECTOR = 8;
		...
		public static final int SCRJREFBVR1NVERSION = 15;
		public static final int SCRJREF1NRELATION = 16;
		public static final int SCRJREF1NBLOCK = 17;
		public static final int SCRJREF1NOPPACK = 18;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREF1NVECTOR, SCRJREF1NQUERY, SCRJREF1NPRESET, SCRJREFVER1NMODULE, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NTABLE, SCRJREFBVR1NVERSION, SCRJREF1NRELATION, SCRJREF1NBLOCK, SCRJREF1NOPPACK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREF1NVECTOR, SCRJREF1NQUERY, SCRJREF1NPRESET, SCRJREFVER1NMODULE, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NTABLE, SCRJREFBVR1NVERSION, SCRJREF1NRELATION, SCRJREF1NBLOCK, SCRJREF1NOPPACK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
