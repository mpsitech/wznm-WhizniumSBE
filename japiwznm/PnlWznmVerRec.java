...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NPRESET = 2;
		public static final int INITDONE1NQUERY = 3;
		public static final int INITDONEVER1NERROR = 4;
		public static final int INITDONEVER1NAPP = 5;
		public static final int INITDONE1NRELATION = 6;
		public static final int INITDONE1NIMPEXPCPLX = 7;
		public static final int INITDONE1NJOB = 8;
		public static final int INITDONE1NOPPACK = 9;
		public static final int INITDONEBVR1NVERSION = 10;
		public static final int INITDONE1NCAPABILITY = 11;
		public static final int INITDONE1NBLOCK = 12;
		public static final int INITDONE1NVECTOR = 13;
		public static final int INITDONE1NTABLE = 14;
		public static final int INITDONE1NCALL = 15;
		public static final int INITDONEVER1NMODULE = 16;
		public static final int INITDONE1NCOMPONENT = 17;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NPRESET, INITDONE1NQUERY, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NRELATION, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NCAPABILITY, INITDONE1NBLOCK, INITDONE1NVECTOR, INITDONE1NTABLE, INITDONE1NCALL, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NPRESET, INITDONE1NQUERY, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NRELATION, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NCAPABILITY, INITDONE1NBLOCK, INITDONE1NVECTOR, INITDONE1NTABLE, INITDONE1NCALL, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NPRESET = 3;
		public static final int SCRJREF1NQUERY = 4;
		public static final int SCRJREFVER1NERROR = 5;
		public static final int SCRJREFVER1NAPP = 6;
		public static final int SCRJREF1NRELATION = 7;
		public static final int SCRJREF1NIMPEXPCPLX = 8;
		public static final int SCRJREF1NJOB = 9;
		public static final int SCRJREF1NOPPACK = 10;
		public static final int SCRJREFBVR1NVERSION = 11;
		public static final int SCRJREF1NCAPABILITY = 12;
		public static final int SCRJREF1NBLOCK = 13;
		public static final int SCRJREF1NVECTOR = 14;
		public static final int SCRJREF1NTABLE = 15;
		public static final int SCRJREF1NCALL = 16;
		public static final int SCRJREFVER1NMODULE = 17;
		public static final int SCRJREF1NCOMPONENT = 18;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NRELATION, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NCAPABILITY, SCRJREF1NBLOCK, SCRJREF1NVECTOR, SCRJREF1NTABLE, SCRJREF1NCALL, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NRELATION, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NCAPABILITY, SCRJREF1NBLOCK, SCRJREF1NVECTOR, SCRJREF1NTABLE, SCRJREF1NCALL, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
