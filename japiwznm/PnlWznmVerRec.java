...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NCOMPONENT = 11;
		public static final int INITDONE1NCALL = 12;
		public static final int INITDONE1NIMPEXPCPLX = 13;
		public static final int INITDONE1NJOB = 14;
		public static final int INITDONE1NOPPACK = 15;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NVECTOR, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONEVER1NERROR, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NVECTOR, INITDONE1NCAPABILITY, INITDONEVER1NAPP, INITDONEVER1NERROR, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NQUERY, INITDONE1NPRESET, INITDONEVER1NMODULE, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NCOMPONENT = 12;
		public static final int SCRJREF1NCALL = 13;
		public static final int SCRJREF1NIMPEXPCPLX = 14;
		public static final int SCRJREF1NJOB = 15;
		public static final int SCRJREF1NOPPACK = 16;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NVECTOR, SCRJREF1NCAPABILITY, SCRJREFVER1NAPP, SCRJREFVER1NERROR, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NQUERY, SCRJREF1NPRESET, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NVECTOR, SCRJREF1NCAPABILITY, SCRJREFVER1NAPP, SCRJREFVER1NERROR, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NQUERY, SCRJREF1NPRESET, SCRJREFVER1NMODULE, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
