...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONEVER1NMODULE = 6;
		...
		public static final int INITDONE1NCOMPONENT = 10;
		public static final int INITDONE1NCALL = 11;
		public static final int INITDONE1NTABLE = 12;
		public static final int INITDONE1NRELATION = 13;
		public static final int INITDONE1NQUERY = 14;
		public static final int INITDONEBVR1NVERSION = 15;
		public static final int INITDONE1NBLOCK = 16;
		public static final int INITDONE1NPRESET = 17;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NQUERY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONE1NPRESET, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NERROR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONE1NVECTOR, INITDONEVER1NMODULE, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NQUERY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONE1NPRESET, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFVER1NMODULE = 7;
		...
		public static final int SCRJREF1NCOMPONENT = 11;
		public static final int SCRJREF1NCALL = 12;
		public static final int SCRJREF1NTABLE = 13;
		public static final int SCRJREF1NRELATION = 14;
		public static final int SCRJREF1NQUERY = 15;
		public static final int SCRJREFBVR1NVERSION = 16;
		public static final int SCRJREF1NBLOCK = 17;
		public static final int SCRJREF1NPRESET = 18;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NERROR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREF1NVECTOR, SCRJREFVER1NMODULE, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NTABLE, SCRJREF1NRELATION, SCRJREF1NQUERY, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREF1NPRESET, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
