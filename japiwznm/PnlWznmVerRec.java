...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONEVER1NAPP = 2;
		public static final int INITDONE1NCAPABILITY = 3;
		public static final int INITDONEVER1NERROR = 4;
		public static final int INITDONE1NTABLE = 5;
		public static final int INITDONE1NRELATION = 6;
		public static final int INITDONE1NBLOCK = 7;
		public static final int INITDONEBVR1NVERSION = 8;
		public static final int INITDONE1NCOMPONENT = 9;
		public static final int INITDONE1NCALL = 10;
		public static final int INITDONE1NIMPEXPCPLX = 11;
		public static final int INITDONE1NJOB = 12;
		public static final int INITDONE1NOPPACK = 13;
		public static final int INITDONEVER1NMODULE = 14;
		public static final int INITDONE1NPRESET = 15;
		public static final int INITDONE1NVECTOR = 16;
		public static final int INITDONE1NQUERY = 17;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEVER1NERROR, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NBLOCK, INITDONEBVR1NVERSION, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NVECTOR, INITDONE1NQUERY, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEVER1NERROR, INITDONE1NTABLE, INITDONE1NRELATION, INITDONE1NBLOCK, INITDONEBVR1NVERSION, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NVECTOR, INITDONE1NQUERY, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFVER1NAPP = 3;
		public static final int SCRJREF1NCAPABILITY = 4;
		public static final int SCRJREFVER1NERROR = 5;
		public static final int SCRJREF1NTABLE = 6;
		public static final int SCRJREF1NRELATION = 7;
		public static final int SCRJREF1NBLOCK = 8;
		public static final int SCRJREFBVR1NVERSION = 9;
		public static final int SCRJREF1NCOMPONENT = 10;
		public static final int SCRJREF1NCALL = 11;
		public static final int SCRJREF1NIMPEXPCPLX = 12;
		public static final int SCRJREF1NJOB = 13;
		public static final int SCRJREF1NOPPACK = 14;
		public static final int SCRJREFVER1NMODULE = 15;
		public static final int SCRJREF1NPRESET = 16;
		public static final int SCRJREF1NVECTOR = 17;
		public static final int SCRJREF1NQUERY = 18;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFVER1NERROR, SCRJREF1NTABLE, SCRJREF1NRELATION, SCRJREF1NBLOCK, SCRJREFBVR1NVERSION, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NVECTOR, SCRJREF1NQUERY, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFVER1NERROR, SCRJREF1NTABLE, SCRJREF1NRELATION, SCRJREF1NBLOCK, SCRJREFBVR1NVERSION, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NVECTOR, SCRJREF1NQUERY, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
