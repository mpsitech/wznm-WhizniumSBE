...
public class PnlWznmVerRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NCALL = 4;
		public static final int INITDONE1NIMPEXPCPLX = 5;
		public static final int INITDONE1NJOB = 6;
		public static final int INITDONE1NOPPACK = 7;
		public static final int INITDONEVER1NMODULE = 8;
		public static final int INITDONE1NPRESET = 9;
		public static final int INITDONE1NQUERY = 10;
		public static final int INITDONE1NRELATION = 11;
		public static final int INITDONE1NTABLE = 12;
		public static final int INITDONE1NVECTOR = 13;
		public static final int INITDONEVER1NAPP = 14;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NERROR, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NVECTOR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEVER1NERROR, INITDONE1NCOMPONENT, INITDONE1NCALL, INITDONE1NIMPEXPCPLX, INITDONE1NJOB, INITDONE1NOPPACK, INITDONEVER1NMODULE, INITDONE1NPRESET, INITDONE1NQUERY, INITDONE1NRELATION, INITDONE1NTABLE, INITDONE1NVECTOR, INITDONEVER1NAPP, INITDONE1NCAPABILITY, INITDONEBVR1NVERSION, INITDONE1NBLOCK, INITDONEREF1NFILE, INITDONEMNLOCALE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NCALL = 5;
		public static final int SCRJREF1NIMPEXPCPLX = 6;
		public static final int SCRJREF1NJOB = 7;
		public static final int SCRJREF1NOPPACK = 8;
		public static final int SCRJREFVER1NMODULE = 9;
		public static final int SCRJREF1NPRESET = 10;
		public static final int SCRJREF1NQUERY = 11;
		public static final int SCRJREF1NRELATION = 12;
		public static final int SCRJREF1NTABLE = 13;
		public static final int SCRJREF1NVECTOR = 14;
		public static final int SCRJREFVER1NAPP = 15;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NERROR, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NVECTOR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFVER1NERROR, SCRJREF1NCOMPONENT, SCRJREF1NCALL, SCRJREF1NIMPEXPCPLX, SCRJREF1NJOB, SCRJREF1NOPPACK, SCRJREFVER1NMODULE, SCRJREF1NPRESET, SCRJREF1NQUERY, SCRJREF1NRELATION, SCRJREF1NTABLE, SCRJREF1NVECTOR, SCRJREFVER1NAPP, SCRJREF1NCAPABILITY, SCRJREFBVR1NVERSION, SCRJREF1NBLOCK, SCRJREFREF1NFILE, SCRJREFMNLOCALE, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
