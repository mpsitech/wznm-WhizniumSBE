...
public class PnlWznmRelRec {
	...
	public class StatApp extends Block {
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONE1NTABLECOL, INITDONESUP1NRELATION, INITDONEREF1NCONTROL, INITDONEREF1NDIALOG, INITDONEREF1NPANEL));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONE1NTABLECOL, INITDONESUP1NRELATION, INITDONEREF1NCONTROL, INITDONEREF1NDIALOG, INITDONEREF1NPANEL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREF1NTABLECOL, SCRJREFSUP1NRELATION, SCRJREFREF1NCONTROL, SCRJREFREF1NDIALOG, SCRJREFREF1NPANEL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREF1NTABLECOL, SCRJREFSUP1NRELATION, SCRJREFREF1NCONTROL, SCRJREFREF1NDIALOG, SCRJREFREF1NPANEL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
