...
public class PnlWznmRelRec {
	...
	public class StatApp extends Block {
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONESUP1NRELATION, INITDONE1NTABLECOL, INITDONEREF1NPANEL, INITDONEREF1NDIALOG, INITDONEREF1NCONTROL));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONESUP1NRELATION, INITDONE1NTABLECOL, INITDONEREF1NPANEL, INITDONEREF1NDIALOG, INITDONEREF1NCONTROL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFSUP1NRELATION, SCRJREF1NTABLECOL, SCRJREFREF1NPANEL, SCRJREFREF1NDIALOG, SCRJREFREF1NCONTROL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFSUP1NRELATION, SCRJREF1NTABLECOL, SCRJREFREF1NPANEL, SCRJREFREF1NDIALOG, SCRJREFREF1NCONTROL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
