/**
  * \file QryWznmPrsList.java
  * Java API code for job QryWznmPrsList
...
public class QryWznmPrsList {
	/**
		* VecVOrd (full: VecVQryWznmPrsListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWznmPrsList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmPrsList");
	...
	/**
	  * StatShr (full: StatShrQryWznmPrsList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmPrsList");
	...
	/**
	  * StgIac (full: StgIacQryWznmPrsList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmPrsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmPrsList";
