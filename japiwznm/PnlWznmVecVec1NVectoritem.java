/**
  * \file PnlWznmVecVec1NVectoritem.java
  * Java API code for job PnlWznmVecVec1NVectoritem
...
public class PnlWznmVecVec1NVectoritem {
	/**
		* VecVDo (full: VecVWznmVecVec1NVectoritemDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVecVec1NVectoritem)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecVec1NVectoritem");
	...
	/**
	  * StatApp (full: StatAppWznmVecVec1NVectoritem)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecVec1NVectoritem");
	...
	/**
	  * StatShr (full: StatShrWznmVecVec1NVectoritem)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecVec1NVectoritem");
	...
	/**
	  * StgIac (full: StgIacWznmVecVec1NVectoritem)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecVec1NVectoritem");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecVec1NVectoritem";
	...
	/**
	  * Tag (full: TagWznmVecVec1NVectoritem)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecVec1NVectoritem");
	...
	/**
		* DpchAppData (full: DpchAppWznmVecVec1NVectoritemData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECVEC1NVECTORITEMDATA, scrJref);
		...
		public QryWznmVecVec1NVectoritem.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecVec1NVectoritemData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecVec1NVectoritemDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECVEC1NVECTORITEMDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecVec1NVectoritemDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecVec1NVectoritemData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECVEC1NVECTORITEMDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVecVec1NVectoritem();
			statappqry = (new QryWznmVecVec1NVectoritem()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecVec1NVectoritem()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecVec1NVectoritem()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecVec1NVectoritem rst;
		public QryWznmVecVec1NVectoritem.StatApp statappqry;
		public QryWznmVecVec1NVectoritem.StatShr statshrqry;
		public QryWznmVecVec1NVectoritem.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecVec1NVectoritemData");
