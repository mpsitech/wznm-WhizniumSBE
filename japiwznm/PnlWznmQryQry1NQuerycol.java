/**
  * \file PnlWznmQryQry1NQuerycol.java
  * Java API code for job PnlWznmQryQry1NQuerycol
...
public class PnlWznmQryQry1NQuerycol {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQryQry1NQuerycol");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQryQry1NQuerycol");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQryQry1NQuerycol");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQryQry1NQuerycol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQryQry1NQuerycol";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryQry1NQuerycol");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYQRY1NQUERYCOLDATA, scrJref);
		...
		public QryWznmQryQry1NQuerycol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryQry1NQuerycolData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYQRY1NQUERYCOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryQry1NQuerycolDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYQRY1NQUERYCOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQQryQry1NQuerycol();
			statappqry = (new QryWznmQryQry1NQuerycol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQryQry1NQuerycol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQryQry1NQuerycol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQryQry1NQuerycol rst;
		public QryWznmQryQry1NQuerycol.StatApp statappqry;
		public QryWznmQryQry1NQuerycol.StatShr statshrqry;
		public QryWznmQryQry1NQuerycol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryQry1NQuerycolData");
