/**
  * \file PnlWznmCtp1NTag.java
  * Java API code for job PnlWznmCtp1NTag
...
public class PnlWznmCtp1NTag {
	/**
		* VecVDo (full: VecVWznmCtp1NTagDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCtp1NTag)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtp1NTag");
	...
	/**
	  * StatApp (full: StatAppWznmCtp1NTag)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtp1NTag");
	...
	/**
	  * StatShr (full: StatShrWznmCtp1NTag)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtp1NTag");
	...
	/**
	  * StgIac (full: StgIacWznmCtp1NTag)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCtp1NTag");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCtp1NTag";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtp1NTag");
	...
	/**
		* DpchAppData (full: DpchAppWznmCtp1NTagData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTP1NTAGDATA, scrJref);
		...
		public QryWznmCtp1NTag.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtp1NTagData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCtp1NTagDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTP1NTAGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtp1NTagDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCtp1NTagData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTP1NTAGDATA);
			...
			statshrqry = (new QryWznmCtp1NTag()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCtp1NTag()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCtp1NTag rst;
		public QryWznmCtp1NTag.StatApp statappqry;
		public QryWznmCtp1NTag.StatShr statshrqry;
		public QryWznmCtp1NTag.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtp1NTagData");
