/**
  * \file DlgWznmVerDbstr.java
  * Java API code for job DlgWznmVerDbstr
...
public class DlgWznmVerDbstr {
	/**
		* VecVDit (full: VecVDlgWznmVerDbstrDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVerDbstrDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVerDbstrDoImp)
		*/
	...
	/**
		* VecVDoPpr (full: VecVDlgWznmVerDbstrDoPpr)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmVerDbstrSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVerDbstr)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVerDbstr");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVerDbstr";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVerDbstr)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDbstr");
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVerDbstrImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDbstrImp");
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVerDbstrLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDbstrLfi");
	...
	/**
	  * ContInfPpr (full: ContInfDlgWznmVerDbstrPpr)
	  */
	public class ContInfPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerDbstrPpr");
	...
	/**
	  * StatApp (full: StatAppDlgWznmVerDbstr)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVerDbstr");
	...
	/**
	  * StatShr (full: StatShrDlgWznmVerDbstr)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDbstr");
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVerDbstrIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDbstrIfi");
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVerDbstrImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDbstrImp");
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVerDbstrLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDbstrLfi");
	...
	/**
	  * StatShrPpr (full: StatShrDlgWznmVerDbstrPpr)
	  */
	public class StatShrPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerDbstrPpr");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDbstr");
	...
	/**
	  * TagIfi (full: TagDlgWznmVerDbstrIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDbstrIfi");
	...
	/**
	  * TagImp (full: TagDlgWznmVerDbstrImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDbstrImp");
	...
	/**
	  * TagLfi (full: TagDlgWznmVerDbstrLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDbstrLfi");
	...
	/**
	  * TagPpr (full: TagDlgWznmVerDbstrPpr)
	  */
	public class TagPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerDbstrPpr");
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmVerDbstrData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERDBSTRDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerDbstrData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVerDbstrDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERDBSTRDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerDbstrDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVerDbstrData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMVERDBSTRDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVerDbstrData");
