/**
  * \file CrdWznmTbl.java
  * Java API code for job CrdWznmTbl
...
public class CrdWznmTbl {
	/**
		* VecVDo (full: VecVWznmTblDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTbl)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDTBL = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTBL));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdTbl;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTbl");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdTbl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdTbl", mask, MTXCRDTBL);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdTbl.equals(comp.MtxCrdTbl)) items.add(MTXCRDTBL);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTBL));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTbl");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTbl");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTbl");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblData");
