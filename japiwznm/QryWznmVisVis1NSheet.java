/**
  * \file QryWznmVisVis1NSheet.java
  * Java API code for job QryWznmVisVis1NSheet
...
public class QryWznmVisVis1NSheet {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVisVis1NSheet");

			String itemtag = "StatitemAppQryWznmVisVis1NSheet";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVisVis1NSheet");

			String itemtag = "StatitemShrQryWznmVisVis1NSheet";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVisVis1NSheet");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVisVis1NSheet";
