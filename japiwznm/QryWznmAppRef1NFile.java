/**
  * \file QryWznmAppRef1NFile.java
  * Java API code for job QryWznmAppRef1NFile
...
public class QryWznmAppRef1NFile {
	/**
	  * StatApp (full: StatAppQryWznmAppRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmAppRef1NFile");
	...
	/**
	  * StatShr (full: StatShrQryWznmAppRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmAppRef1NFile");
	...
	/**
	  * StgIac (full: StgIacQryWznmAppRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmAppRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmAppRef1NFile";
