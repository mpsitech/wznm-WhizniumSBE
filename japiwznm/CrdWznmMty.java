/**
  * \file CrdWznmMty.java
  * Java API code for job CrdWznmMty
...
public class CrdWznmMty {
	/**
		* VecVDo (full: VecVWznmMtyDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMty)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDMTY = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDMTY));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdMty;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMty");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdMty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdMty", mask, MTXCRDMTY);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdMty.equals(comp.MtxCrdMty)) items.add(MTXCRDMTY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDMTY));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMty");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMty");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMty");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMtyDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtyDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMtyData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTYDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtyData");
