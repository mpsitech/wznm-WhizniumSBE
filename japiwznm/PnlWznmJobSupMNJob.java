/**
  * \file PnlWznmJobSupMNJob.java
  * Java API code for job PnlWznmJobSupMNJob
...
public class PnlWznmJobSupMNJob {
	/**
		* VecVDo (full: VecVWznmJobSupMNJobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobSupMNJob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobSupMNJob");
	...
	/**
	  * StatApp (full: StatAppWznmJobSupMNJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobSupMNJob");
	...
	/**
	  * StatShr (full: StatShrWznmJobSupMNJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobSupMNJob");
	...
	/**
	  * StgIac (full: StgIacWznmJobSupMNJob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobSupMNJob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobSupMNJob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobSupMNJob");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobSupMNJobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBSUPMNJOBDATA, scrJref);
		...
		public QryWznmJobSupMNJob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobSupMNJobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobSupMNJobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBSUPMNJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobSupMNJobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobSupMNJobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBSUPMNJOBDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQJobSupMNJob();
			statappqry = (new QryWznmJobSupMNJob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobSupMNJob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobSupMNJob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobSupMNJob rst;
		public QryWznmJobSupMNJob.StatApp statappqry;
		public QryWznmJobSupMNJob.StatShr statshrqry;
		public QryWznmJobSupMNJob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobSupMNJobData");
