/**
  * \file PnlWznmFilList.java
  * Java API code for job PnlWznmFilList
...
public class PnlWznmFilList {
	/**
		* VecVDo (full: VecVWznmFilListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmFilList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmFilList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmFilList";
	...
	/**
	  * ContInf (full: ContInfWznmFilList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmFilList");
	...
	/**
	  * StatShr (full: StatShrWznmFilList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmFilList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmFilList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmFilList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmFilList");
	...
	/**
		* DpchAppData (full: DpchAppWznmFilListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMFILLISTDATA, scrJref);
		...
		public QryWznmFilList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmFilListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmFilListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMFILLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmFilListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmFilListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMFILLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQFilList();
			statappqry = (new QryWznmFilList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmFilList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmFilList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQFilList rst;
		public QryWznmFilList.StatApp statappqry;
		public QryWznmFilList.StatShr statshrqry;
		public QryWznmFilList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmFilListData");
