/**
  * \file PnlWznmTcoATitle.java
  * Java API code for job PnlWznmTcoATitle
...
public class PnlWznmTcoATitle {
	/**
		* VecVDo (full: VecVWznmTcoATitleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTcoATitle)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTcoATitle");
	...
	/**
	  * StatApp (full: StatAppWznmTcoATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTcoATitle");
	...
	/**
	  * StatShr (full: StatShrWznmTcoATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTcoATitle");
	...
	/**
	  * StgIac (full: StgIacWznmTcoATitle)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTcoATitle");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTcoATitle";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTcoATitle");
	...
	/**
		* DpchAppData (full: DpchAppWznmTcoATitleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOATITLEDATA, scrJref);
		...
		public QryWznmTcoATitle.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoATitleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTcoATitleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOATITLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoATitleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTcoATitleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCOATITLEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQTcoATitle();
			statappqry = (new QryWznmTcoATitle()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTcoATitle()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTcoATitle()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTcoATitle rst;
		public QryWznmTcoATitle.StatApp statappqry;
		public QryWznmTcoATitle.StatShr statshrqry;
		public QryWznmTcoATitle.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoATitleData");
