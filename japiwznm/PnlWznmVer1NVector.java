/**
  * \file PnlWznmVer1NVector.java
  * Java API code for job PnlWznmVer1NVector
...
public class PnlWznmVer1NVector {
	/**
		* VecVDo (full: VecVWznmVer1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NVector");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NVector");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NVector");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NVectorData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NVECTORDATA, scrJref);
		...
		public QryWznmVer1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NVectorData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NVector();
			statappqry = (new QryWznmVer1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NVector rst;
		public QryWznmVer1NVector.StatApp statappqry;
		public QryWznmVer1NVector.StatShr statshrqry;
		public QryWznmVer1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NVectorData");
