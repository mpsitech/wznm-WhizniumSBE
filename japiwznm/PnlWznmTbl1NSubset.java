/**
  * \file PnlWznmTbl1NSubset.java
  * Java API code for job PnlWznmTbl1NSubset
...
public class PnlWznmTbl1NSubset {
	/**
		* VecVDo (full: VecVWznmTbl1NSubsetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTbl1NSubset)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTbl1NSubset");
	...
	/**
	  * StatApp (full: StatAppWznmTbl1NSubset)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTbl1NSubset");
	...
	/**
	  * StatShr (full: StatShrWznmTbl1NSubset)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTbl1NSubset");
	...
	/**
	  * StgIac (full: StgIacWznmTbl1NSubset)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTbl1NSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTbl1NSubset";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTbl1NSubset");
	...
	/**
		* DpchAppData (full: DpchAppWznmTbl1NSubsetData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NSUBSETDATA, scrJref);
		...
		public QryWznmTbl1NSubset.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NSubsetData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTbl1NSubsetDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NSUBSETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NSubsetDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTbl1NSubsetData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBL1NSUBSETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTbl1NSubset();
			statappqry = (new QryWznmTbl1NSubset()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTbl1NSubset()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTbl1NSubset()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTbl1NSubset rst;
		public QryWznmTbl1NSubset.StatApp statappqry;
		public QryWznmTbl1NSubset.StatShr statshrqry;
		public QryWznmTbl1NSubset.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTbl1NSubsetData");
