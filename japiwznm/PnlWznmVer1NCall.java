/**
  * \file PnlWznmVer1NCall.java
  * Java API code for job PnlWznmVer1NCall
...
public class PnlWznmVer1NCall {
	/**
		* VecVDo (full: VecVWznmVer1NCallDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NCall)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NCall");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NCall)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NCall");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NCall)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NCall");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NCall)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NCall");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NCall";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NCall");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NCallData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCALLDATA, scrJref);
		...
		public QryWznmVer1NCall.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NCallData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NCallDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCALLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NCallDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NCallData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NCALLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NCall();
			statappqry = (new QryWznmVer1NCall()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NCall()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NCall()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NCall rst;
		public QryWznmVer1NCall.StatApp statappqry;
		public QryWznmVer1NCall.StatShr statshrqry;
		public QryWznmVer1NCall.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NCallData");
