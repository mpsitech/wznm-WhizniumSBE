/**
  * \file PnlWznmPst1NQuerymod.java
  * Java API code for job PnlWznmPst1NQuerymod
...
public class PnlWznmPst1NQuerymod {
	/**
		* VecVDo (full: VecVWznmPst1NQuerymodDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmPst1NQuerymod)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPst1NQuerymod");
	...
	/**
	  * StatApp (full: StatAppWznmPst1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPst1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrWznmPst1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPst1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacWznmPst1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPst1NQuerymod";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPst1NQuerymod");
	...
	/**
		* DpchAppData (full: DpchAppWznmPst1NQuerymodData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPST1NQUERYMODDATA, scrJref);
		...
		public QryWznmPst1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPst1NQuerymodData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmPst1NQuerymodDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPST1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPst1NQuerymodDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmPst1NQuerymodData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPST1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQPst1NQuerymod();
			statappqry = (new QryWznmPst1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPst1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPst1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPst1NQuerymod rst;
		public QryWznmPst1NQuerymod.StatApp statappqry;
		public QryWznmPst1NQuerymod.StatShr statshrqry;
		public QryWznmPst1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPst1NQuerymodData");
