/**
  * \file PnlWznmVer1NBlock.java
  * Java API code for job PnlWznmVer1NBlock
...
public class PnlWznmVer1NBlock {
	/**
		* VecVDo (full: VecVWznmVer1NBlockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NBlock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NBlock");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NBlock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NBlock");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NBlock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NBlock");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NBlock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NBlock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NBlock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NBlock");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NBlockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NBLOCKDATA, scrJref);
		...
		public QryWznmVer1NBlock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NBlockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NBlockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NBlockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NBlockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NBlock();
			statappqry = (new QryWznmVer1NBlock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NBlock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NBlock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NBlock rst;
		public QryWznmVer1NBlock.StatApp statappqry;
		public QryWznmVer1NBlock.StatShr statshrqry;
		public QryWznmVer1NBlock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NBlockData");
