/**
  * \file PnlWznmCapHeadbar.java
  * Java API code for job PnlWznmCapHeadbar
...
public class PnlWznmCapHeadbar {
	/**
	  * StgInf (full: StgInfWznmCapHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmCapHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCapHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmCapHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCAPHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCapHeadbarData");
