/**
  * \file CrdWznmBox.java
  * Java API code for job CrdWznmBox
...
public class CrdWznmBox {
	/**
		* VecVDo (full: VecVWznmBoxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmBox)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDBOX = 3;
		...
		public ContInf(
			...
			this.MtxCrdBox = MtxCrdBox;

			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBOX));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdBox;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBox");

			String itemtag = "ContitemInfWznmBox";

			if (Xmlio.checkXPath(doc, basexpath)) {
				numFSge = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "numFSge", mask, NUMFSGE);
				MrlAppHlp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", mask, MRLAPPHLP);
				MtxCrdBox = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdBox", mask, MTXCRDBOX);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdBox.equals(comp.MtxCrdBox)) items.add(MTXCRDBOX);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBOX));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmBox");

			String itemtag = "StatitemAppWznmBox";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBox");

			String itemtag = "StatitemShrWznmBox";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBox");

			String itemtag = "TagitemWznmBox";
	...
	/**
		* DpchAppDo (full: DpchAppWznmBoxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBoxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBOXDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBoxData");
