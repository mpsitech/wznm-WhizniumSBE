/**
  * \file PnlWznmRtj1NRtdpch.java
  * Java API code for job PnlWznmRtj1NRtdpch
...
public class PnlWznmRtj1NRtdpch {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRtj1NRtdpch");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRtj1NRtdpch");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRtj1NRtdpch");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRtj1NRtdpch");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRtj1NRtdpch";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRtj1NRtdpch");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJ1NRTDPCHDATA, scrJref);
		...
		public QryWznmRtj1NRtdpch.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtj1NRtdpchData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJ1NRTDPCHDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtj1NRtdpchDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRTJ1NRTDPCHDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRtj1NRtdpch();
			statappqry = (new QryWznmRtj1NRtdpch()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRtj1NRtdpch()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRtj1NRtdpch()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRtj1NRtdpch rst;
		public QryWznmRtj1NRtdpch.StatApp statappqry;
		public QryWznmRtj1NRtdpch.StatShr statshrqry;
		public QryWznmRtj1NRtdpch.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRtj1NRtdpchData");
