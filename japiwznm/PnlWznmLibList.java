/**
  * \file PnlWznmLibList.java
  * Java API code for job PnlWznmLibList
...
public class PnlWznmLibList {
	/**
		* VecVDo (full: VecVWznmLibListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmLibList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmLibList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmLibList";
	...
	/**
	  * ContInf (full: ContInfWznmLibList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLibList");
	...
	/**
	  * StatShr (full: StatShrWznmLibList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLibList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOLTYWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOLTYWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoTitWidth;
		public int TcoVerWidth;
		public int TcoLtyWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLibList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoLtyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoLtyWidth", mask, TCOLTYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLibList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoLtyWidth", TcoLtyWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoLtyWidth == comp.TcoLtyWidth) items.add(TCOLTYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCOLTYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOLTY = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCOLTY));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLibList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoLty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoLty", mask, TCOLTY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoLty.equals(comp.TcoLty)) items.add(TCOLTY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER, TCOLTY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmLibListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBLISTDATA, scrJref);
		...
		public QryWznmLibList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmLibListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmLibListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLIBLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQLibList();
			statappqry = (new QryWznmLibList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLibList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLibList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLibList rst;
		public QryWznmLibList.StatApp statappqry;
		public QryWznmLibList.StatShr statshrqry;
		public QryWznmLibList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLibListData");
