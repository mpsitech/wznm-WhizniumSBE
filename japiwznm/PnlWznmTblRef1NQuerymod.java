/**
  * \file PnlWznmTblRef1NQuerymod.java
  * Java API code for job PnlWznmTblRef1NQuerymod
...
public class PnlWznmTblRef1NQuerymod {
	/**
		* VecVDo (full: VecVWznmTblRef1NQuerymodDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblRef1NQuerymod)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblRef1NQuerymod");
	...
	/**
	  * StatApp (full: StatAppWznmTblRef1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblRef1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrWznmTblRef1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblRef1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacWznmTblRef1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblRef1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblRef1NQuerymod";
	...
	/**
	  * Tag (full: TagWznmTblRef1NQuerymod)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblRef1NQuerymod");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblRef1NQuerymodData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NQUERYMODDATA, scrJref);
		...
		public QryWznmTblRef1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NQuerymodData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblRef1NQuerymodDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NQuerymodDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblRef1NQuerymodData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLREF1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblRef1NQuerymod();
			statappqry = (new QryWznmTblRef1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblRef1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblRef1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblRef1NQuerymod rst;
		public QryWznmTblRef1NQuerymod.StatApp statappqry;
		public QryWznmTblRef1NQuerymod.StatShr statshrqry;
		public QryWznmTblRef1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblRef1NQuerymodData");
