/**
  * \file PnlWznmVer1NComponent.java
  * Java API code for job PnlWznmVer1NComponent
...
public class PnlWznmVer1NComponent {
	/**
		* VecVDo (full: VecVWznmVer1NComponentDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NComponent)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NComponent");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NComponent)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NComponent");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NComponent)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NComponent");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NComponent)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NComponent");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NComponent";
	...
	/**
	  * Tag (full: TagWznmVer1NComponent)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NComponent");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NComponentData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCOMPONENTDATA, scrJref);
		...
		public QryWznmVer1NComponent.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NComponentData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NComponentDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCOMPONENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NComponentDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NComponentData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NCOMPONENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NComponent();
			statappqry = (new QryWznmVer1NComponent()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NComponent()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NComponent()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NComponent rst;
		public QryWznmVer1NComponent.StatApp statappqry;
		public QryWznmVer1NComponent.StatShr statshrqry;
		public QryWznmVer1NComponent.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NComponentData");
