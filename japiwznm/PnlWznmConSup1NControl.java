/**
  * \file PnlWznmConSup1NControl.java
  * Java API code for job PnlWznmConSup1NControl
...
public class PnlWznmConSup1NControl {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmConSup1NControl");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmConSup1NControl");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmConSup1NControl");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmConSup1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmConSup1NControl";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmConSup1NControl");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONSUP1NCONTROLDATA, scrJref);
		...
		public QryWznmConSup1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConSup1NControlData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONSUP1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConSup1NControlDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCONSUP1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQConSup1NControl();
			statappqry = (new QryWznmConSup1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmConSup1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmConSup1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQConSup1NControl rst;
		public QryWznmConSup1NControl.StatApp statappqry;
		public QryWznmConSup1NControl.StatShr statshrqry;
		public QryWznmConSup1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmConSup1NControlData");
