/**
  * \file QryWznmRtj1NRtdpch.java
  * Java API code for job QryWznmRtj1NRtdpch
...
public class QryWznmRtj1NRtdpch {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRtj1NRtdpch");

			String itemtag = "StatitemAppQryWznmRtj1NRtdpch";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRtj1NRtdpch");

			String itemtag = "StatitemShrQryWznmRtj1NRtdpch";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRtj1NRtdpch");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRtj1NRtdpch";
