/**
  * \file PnlWznmSteAStep.java
  * Java API code for job PnlWznmSteAStep
...
public class PnlWznmSteAStep {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSteAStep");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSteAStep");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSteAStep");
	...
	public class StgIac extends Block {
		...
		public static final int TCOSNXWIDTH = 1;
		public static final int TCOTRGWIDTH = 2;
		public static final int TCORTJWIDTH = 3;
		public static final int TCOVITWIDTH = 4;
		public static final int TCOXSRWIDTH = 5;
		public static final int TCORTDWIDTH = 6;
		public static final int TCOMSKWIDTH = 7;
		public static final int TCOCNDWIDTH = 8;
		public static final int TCOCCDWIDTH = 9;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSNXWIDTH, TCOTRGWIDTH, TCORTJWIDTH, TCOVITWIDTH, TCOXSRWIDTH, TCORTDWIDTH, TCOMSKWIDTH, TCOCNDWIDTH, TCOCCDWIDTH));
		};

		public int TcoSnxWidth;
		public int TcoTrgWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSteAStep");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTrgWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTrgWidth", mask, TCOTRGWIDTH);
				...
				TcoCcdWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCcdWidth", mask, TCOCCDWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSteAStep";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTrgWidth", TcoTrgWidth);
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCcdWidth", TcoCcdWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoTrgWidth == comp.TcoTrgWidth) items.add(TCOTRGWIDTH);
			...
			if (TcoCcdWidth == comp.TcoCcdWidth) items.add(TCOCCDWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSNXWIDTH, TCOTRGWIDTH, TCORTJWIDTH, TCOVITWIDTH, TCOXSRWIDTH, TCORTDWIDTH, TCOMSKWIDTH, TCOCNDWIDTH, TCOCCDWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSNX = 7;
		public static final int TCOTRG = 8;
		public static final int TCORTJ = 9;
		public static final int TCOVIT = 10;
		public static final int TCOXSR = 11;
		public static final int TCORTD = 12;
		public static final int TCOMSK = 13;
		public static final int TCOCND = 14;
		public static final int TCOCCD = 15;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSNX, TCOTRG, TCORTJ, TCOVIT, TCOXSR, TCORTD, TCOMSK, TCOCND, TCOCCD));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSteAStep");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTrg = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTrg", mask, TCOTRG);
				...
				TcoCcd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCcd", mask, TCOCCD);
		...
		public HashSet<Integer> comm(
			...
			if (TcoTrg.equals(comp.TcoTrg)) items.add(TCOTRG);
			...
			if (TcoCcd.equals(comp.TcoCcd)) items.add(TCOCCD);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSNX, TCOTRG, TCORTJ, TCOVIT, TCOXSR, TCORTD, TCOMSK, TCOCND, TCOCCD));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTEASTEPDATA, scrJref);
		...
		public QryWznmSteAStep.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSteAStepData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTEASTEPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSteAStepDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSTEASTEPDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQSteAStep();
			statappqry = (new QryWznmSteAStep()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSteAStep()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSteAStep()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSteAStep rst;
		public QryWznmSteAStep.StatApp statappqry;
		public QryWznmSteAStep.StatShr statshrqry;
		public QryWznmSteAStep.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSteAStepData");
