/**
  * \file PnlWznmQryHeadbar.java
  * Java API code for job PnlWznmQryHeadbar
...
public class PnlWznmQryHeadbar {
	/**
	  * StgInf (full: StgInfWznmQryHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmQryHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmQryHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryHeadbarData");
