/**
  * \file PnlWznmVecATitle.java
  * Java API code for job PnlWznmVecATitle
...
public class PnlWznmVecATitle {
	/**
		* VecVDo (full: VecVWznmVecATitleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVecATitle)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecATitle");
	...
	/**
	  * StatApp (full: StatAppWznmVecATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecATitle");
	...
	/**
	  * StatShr (full: StatShrWznmVecATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecATitle");
	...
	/**
	  * StgIac (full: StgIacWznmVecATitle)
	  */
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOLOCWIDTH, TCOTITWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecATitle");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecATitle";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOLOCWIDTH, TCOTITWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOLOC, TCOTIT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecATitle");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOLOC, TCOTIT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmVecATitleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECATITLEDATA, scrJref);
		...
		public QryWznmVecATitle.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecATitleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecATitleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECATITLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecATitleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecATitleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECATITLEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQVecATitle();
			statappqry = (new QryWznmVecATitle()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecATitle()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecATitle()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecATitle rst;
		public QryWznmVecATitle.StatApp statappqry;
		public QryWznmVecATitle.StatShr statshrqry;
		public QryWznmVecATitle.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecATitleData");
