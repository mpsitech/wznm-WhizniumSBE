/**
  * \file PnlWznmImeList.java
  * Java API code for job PnlWznmImeList
...
public class PnlWznmImeList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmImeList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmImeList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmImeList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmImeList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOIEXWIDTH = 2;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOIEXWIDTH, TCOSUPWIDTH, TCOTBLWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoIexWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmImeList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoIexWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoIexWidth", mask, TCOIEXWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmImeList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoIexWidth", TcoIexWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoIexWidth == comp.TcoIexWidth) items.add(TCOIEXWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOIEXWIDTH, TCOSUPWIDTH, TCOTBLWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOIEX = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOIEX, TCOSUP, TCOTBL));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmImeList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoIex = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoIex", mask, TCOIEX);
		...
		public HashSet<Integer> comm(
			...
			if (TcoIex.equals(comp.TcoIex)) items.add(TCOIEX);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOIEX, TCOSUP, TCOTBL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMELISTDATA, scrJref);
		...
		public QryWznmImeList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeListData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMELISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeListDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIMELISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQImeList();
			statappqry = (new QryWznmImeList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmImeList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmImeList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQImeList rst;
		public QryWznmImeList.StatApp statappqry;
		public QryWznmImeList.StatShr statshrqry;
		public QryWznmImeList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmImeListData");
