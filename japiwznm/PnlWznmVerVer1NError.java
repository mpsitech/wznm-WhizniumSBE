/**
  * \file PnlWznmVerVer1NError.java
  * Java API code for job PnlWznmVerVer1NError
...
public class PnlWznmVerVer1NError {
	/**
		* VecVDo (full: VecVWznmVerVer1NErrorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerVer1NError)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerVer1NError");
	...
	/**
	  * StatApp (full: StatAppWznmVerVer1NError)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerVer1NError");
	...
	/**
	  * StatShr (full: StatShrWznmVerVer1NError)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerVer1NError");
	...
	/**
	  * StgIac (full: StgIacWznmVerVer1NError)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerVer1NError");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerVer1NError";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerVer1NError");
	...
	/**
		* DpchAppData (full: DpchAppWznmVerVer1NErrorData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NERRORDATA, scrJref);
		...
		public QryWznmVerVer1NError.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NErrorData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerVer1NErrorDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NERRORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NErrorDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerVer1NErrorData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERVER1NERRORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerVer1NError();
			statappqry = (new QryWznmVerVer1NError()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerVer1NError()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerVer1NError()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerVer1NError rst;
		public QryWznmVerVer1NError.StatApp statappqry;
		public QryWznmVerVer1NError.StatShr statshrqry;
		public QryWznmVerVer1NError.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerVer1NErrorData");
