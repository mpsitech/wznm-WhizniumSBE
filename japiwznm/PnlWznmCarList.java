/**
  * \file PnlWznmCarList.java
  * Java API code for job PnlWznmCarList
...
public class PnlWznmCarList {
	/**
		* VecVDo (full: VecVWznmCarListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmCarList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmCarList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmCarList";
	...
	/**
	  * ContInf (full: ContInfWznmCarList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCarList");
	...
	/**
	  * StatShr (full: StatShrWznmCarList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCarList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOMDLWIDTH, TCORETWIDTH, TCOREUWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCarList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCarList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH, TCOMDLWIDTH, TCORETWIDTH, TCOREUWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOMDL, TCORET, TCOREU));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCarList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOMDL, TCORET, TCOREU));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmCarListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARLISTDATA, scrJref);
		...
		public QryWznmCarList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCarListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCarListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCARLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQCarList();
			statappqry = (new QryWznmCarList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCarList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCarList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCarList rst;
		public QryWznmCarList.StatApp statappqry;
		public QryWznmCarList.StatShr statshrqry;
		public QryWznmCarList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCarListData");
