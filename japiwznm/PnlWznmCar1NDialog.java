/**
  * \file PnlWznmCar1NDialog.java
  * Java API code for job PnlWznmCar1NDialog
...
public class PnlWznmCar1NDialog {
	/**
		* VecVDo (full: VecVWznmCar1NDialogDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCar1NDialog)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCar1NDialog");
	...
	/**
	  * StatApp (full: StatAppWznmCar1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCar1NDialog");
	...
	/**
	  * StatShr (full: StatShrWznmCar1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCar1NDialog");
	...
	/**
	  * StgIac (full: StgIacWznmCar1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCar1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCar1NDialog";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCar1NDialog");
	...
	/**
		* DpchAppData (full: DpchAppWznmCar1NDialogData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAR1NDIALOGDATA, scrJref);
		...
		public QryWznmCar1NDialog.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCar1NDialogData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCar1NDialogDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAR1NDIALOGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCar1NDialogDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCar1NDialogData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCAR1NDIALOGDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCar1NDialog();
			statappqry = (new QryWznmCar1NDialog()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCar1NDialog()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCar1NDialog()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCar1NDialog rst;
		public QryWznmCar1NDialog.StatApp statappqry;
		public QryWznmCar1NDialog.StatShr statshrqry;
		public QryWznmCar1NDialog.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCar1NDialogData");
