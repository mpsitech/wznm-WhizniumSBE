/**
  * \file QryWznmJob1NMethod.java
  * Java API code for job QryWznmJob1NMethod
...
public class QryWznmJob1NMethod {
	/**
	  * StatApp (full: StatAppQryWznmJob1NMethod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmJob1NMethod");
	...
	/**
	  * StatShr (full: StatShrQryWznmJob1NMethod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmJob1NMethod");
	...
	/**
	  * StgIac (full: StgIacQryWznmJob1NMethod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmJob1NMethod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmJob1NMethod";
