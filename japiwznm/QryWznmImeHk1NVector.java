/**
  * \file QryWznmImeHk1NVector.java
  * Java API code for job QryWznmImeHk1NVector
...
public class QryWznmImeHk1NVector {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmImeHk1NVector");

			String itemtag = "StatitemAppQryWznmImeHk1NVector";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmImeHk1NVector");

			String itemtag = "StatitemShrQryWznmImeHk1NVector";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmImeHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmImeHk1NVector";
