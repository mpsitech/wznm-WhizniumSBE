/**
  * \file PnlWznmCmpDetail.java
  * Java API code for job PnlWznmCmpDetail
...
public class PnlWznmCmpDetail {
	/**
		* VecVDo (full: VecVWznmCmpDetailDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmCmpDetail)
	  */
	public class ContIac extends Block {
		...
		public ContIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TXFTIT, NUMFPUPTYP, TXFCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmCmpDetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmCmpDetail";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TXFTIT, NUMFPUPTYP, TXFCMT));
	...
	/**
	  * ContInf (full: ContInfWznmCmpDetail)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCmpDetail");
	...
	/**
	  * StatApp (full: StatAppWznmCmpDetail)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCmpDetail");
	...
	/**
	  * StatShr (full: StatShrWznmCmpDetail)
	  */
	public class StatShr extends Block {
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXFTITACTIVE, PUPTYPACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE, TXFCMTACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCmpDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(BUTSAVEAVAIL, BUTSAVEACTIVE, TXTSRFACTIVE, TXFTITACTIVE, PUPTYPACTIVE, TXTVERACTIVE, BUTVERVIEWAVAIL, BUTVERVIEWACTIVE, TXFCMTACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTTIT, CPTTYP, CPTVER, CPTCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCmpDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, CPTSRF, CPTTIT, CPTTYP, CPTVER, CPTCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmCmpDetailData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPDETAILDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpDetailData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCmpDetailDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPDETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpDetailDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCmpDetailData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCMPDETAILDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCmpDetailData");
