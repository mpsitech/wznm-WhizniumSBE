/**
  * \file PnlWznmJobACmd.java
  * Java API code for job PnlWznmJobACmd
...
public class PnlWznmJobACmd {
	/**
		* VecVDo (full: VecVWznmJobACmdDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobACmd)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobACmd");
	...
	/**
	  * StatApp (full: StatAppWznmJobACmd)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobACmd");
	...
	/**
	  * StatShr (full: StatShrWznmJobACmd)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobACmd");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobACmd");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobACmd";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobACmd");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobACmdData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBACMDDATA, scrJref);
		...
		public QryWznmJobACmd.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobACmdData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobACmdDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBACMDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobACmdDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobACmdData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBACMDDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQJobACmd();
			statappqry = (new QryWznmJobACmd()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobACmd()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobACmd()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobACmd rst;
		public QryWznmJobACmd.StatApp statappqry;
		public QryWznmJobACmd.StatShr statshrqry;
		public QryWznmJobACmd.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobACmdData");
