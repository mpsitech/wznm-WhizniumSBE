/**
  * \file QryWznmJobJob1NStage.java
  * Java API code for job QryWznmJobJob1NStage
...
public class QryWznmJobJob1NStage {
	/**
	  * StatApp (full: StatAppQryWznmJobJob1NStage)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmJobJob1NStage");
	...
	/**
	  * StatShr (full: StatShrQryWznmJobJob1NStage)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmJobJob1NStage");
	...
	/**
	  * StgIac (full: StgIacQryWznmJobJob1NStage)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmJobJob1NStage");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmJobJob1NStage";
