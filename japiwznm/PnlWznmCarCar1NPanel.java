/**
  * \file PnlWznmCarCar1NPanel.java
  * Java API code for job PnlWznmCarCar1NPanel
...
public class PnlWznmCarCar1NPanel {
	/**
		* VecVDo (full: VecVWznmCarCar1NPanelDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCarCar1NPanel)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCarCar1NPanel");
	...
	/**
	  * StatApp (full: StatAppWznmCarCar1NPanel)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCarCar1NPanel");
	...
	/**
	  * StatShr (full: StatShrWznmCarCar1NPanel)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCarCar1NPanel");
	...
	/**
	  * StgIac (full: StgIacWznmCarCar1NPanel)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCarCar1NPanel");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCarCar1NPanel";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCarCar1NPanel");
	...
	/**
		* DpchAppData (full: DpchAppWznmCarCar1NPanelData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARCAR1NPANELDATA, scrJref);
		...
		public QryWznmCarCar1NPanel.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarCar1NPanelData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCarCar1NPanelDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARCAR1NPANELDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarCar1NPanelDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCarCar1NPanelData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCARCAR1NPANELDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCarCar1NPanel();
			statappqry = (new QryWznmCarCar1NPanel()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCarCar1NPanel()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCarCar1NPanel()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCarCar1NPanel rst;
		public QryWznmCarCar1NPanel.StatApp statappqry;
		public QryWznmCarCar1NPanel.StatShr statshrqry;
		public QryWznmCarCar1NPanel.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCarCar1NPanelData");
