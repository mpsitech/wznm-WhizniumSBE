/**
  * \file PnlWznmBlkList.java
  * Java API code for job PnlWznmBlkList
...
public class PnlWznmBlkList {
	/**
		* VecVDo (full: VecVWznmBlkListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmBlkList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmBlkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmBlkList";
	...
	/**
	  * ContInf (full: ContInfWznmBlkList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBlkList");
	...
	/**
	  * StatShr (full: StatShrWznmBlkList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBlkList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmBlkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmBlkList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCORET, TCOREU));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBlkList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCORET, TCOREU));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmBlkListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBLKLISTDATA, scrJref);
		...
		public QryWznmBlkList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBlkListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmBlkListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBLKLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBlkListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBlkListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBLKLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQBlkList();
			statappqry = (new QryWznmBlkList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmBlkList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmBlkList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQBlkList rst;
		public QryWznmBlkList.StatApp statappqry;
		public QryWznmBlkList.StatShr statshrqry;
		public QryWznmBlkList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBlkListData");
