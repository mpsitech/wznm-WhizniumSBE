/**
  * \file QryWznmJobHk1NVector.java
  * Java API code for job QryWznmJobHk1NVector
...
public class QryWznmJobHk1NVector {
	/**
	  * StatApp (full: StatAppQryWznmJobHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmJobHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWznmJobHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmJobHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWznmJobHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmJobHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmJobHk1NVector";
