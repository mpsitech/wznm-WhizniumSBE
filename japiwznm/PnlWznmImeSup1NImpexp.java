/**
  * \file PnlWznmImeSup1NImpexp.java
  * Java API code for job PnlWznmImeSup1NImpexp
...
public class PnlWznmImeSup1NImpexp {
	/**
		* VecVDo (full: VecVWznmImeSup1NImpexpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmImeSup1NImpexp)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmImeSup1NImpexp");
	...
	/**
	  * StatApp (full: StatAppWznmImeSup1NImpexp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmImeSup1NImpexp");
	...
	/**
	  * StatShr (full: StatShrWznmImeSup1NImpexp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmImeSup1NImpexp");
	...
	/**
	  * StgIac (full: StgIacWznmImeSup1NImpexp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmImeSup1NImpexp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmImeSup1NImpexp";
	...
	/**
	  * Tag (full: TagWznmImeSup1NImpexp)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmImeSup1NImpexp");
	...
	/**
		* DpchAppData (full: DpchAppWznmImeSup1NImpexpData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMESUP1NIMPEXPDATA, scrJref);
		...
		public QryWznmImeSup1NImpexp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeSup1NImpexpData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmImeSup1NImpexpDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMESUP1NIMPEXPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeSup1NImpexpDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmImeSup1NImpexpData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIMESUP1NIMPEXPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQImeSup1NImpexp();
			statappqry = (new QryWznmImeSup1NImpexp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmImeSup1NImpexp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmImeSup1NImpexp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQImeSup1NImpexp rst;
		public QryWznmImeSup1NImpexp.StatApp statappqry;
		public QryWznmImeSup1NImpexp.StatShr statshrqry;
		public QryWznmImeSup1NImpexp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmImeSup1NImpexpData");
