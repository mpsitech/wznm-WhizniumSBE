/**
  * \file PnlWznmVerBvr1NVersion.java
  * Java API code for job PnlWznmVerBvr1NVersion
...
public class PnlWznmVerBvr1NVersion {
	/**
		* VecVDo (full: VecVWznmVerBvr1NVersionDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerBvr1NVersion)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerBvr1NVersion");

			String itemtag = "ContitemInfWznmVerBvr1NVersion";
	...
	/**
	  * StatApp (full: StatAppWznmVerBvr1NVersion)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerBvr1NVersion");

			String itemtag = "StatitemAppWznmVerBvr1NVersion";
	...
	/**
	  * StatShr (full: StatShrWznmVerBvr1NVersion)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerBvr1NVersion");

			String itemtag = "StatitemShrWznmVerBvr1NVersion";
	...
	/**
	  * StgIac (full: StgIacWznmVerBvr1NVersion)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerBvr1NVersion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerBvr1NVersion";
	...
	/**
	  * Tag (full: TagWznmVerBvr1NVersion)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerBvr1NVersion");

			String itemtag = "TagitemWznmVerBvr1NVersion";
	...
	/**
		* DpchAppData (full: DpchAppWznmVerBvr1NVersionData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERBVR1NVERSIONDATA, scrJref);
		...
		public QryWznmVerBvr1NVersion.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerBvr1NVersionData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerBvr1NVersionDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERBVR1NVERSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerBvr1NVersionDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerBvr1NVersionData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERBVR1NVERSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerBvr1NVersion();
			statappqry = (new QryWznmVerBvr1NVersion()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerBvr1NVersion()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerBvr1NVersion()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerBvr1NVersion rst;
		public QryWznmVerBvr1NVersion.StatApp statappqry;
		public QryWznmVerBvr1NVersion.StatShr statshrqry;
		public QryWznmVerBvr1NVersion.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerBvr1NVersionData");
