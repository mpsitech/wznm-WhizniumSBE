/**
  * \file PnlWznmVerVer1NApp.java
  * Java API code for job PnlWznmVerVer1NApp
...
public class PnlWznmVerVer1NApp {
	/**
		* VecVDo (full: VecVWznmVerVer1NAppDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerVer1NApp)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerVer1NApp");
	...
	/**
	  * StatApp (full: StatAppWznmVerVer1NApp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerVer1NApp");
	...
	/**
	  * StatShr (full: StatShrWznmVerVer1NApp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerVer1NApp");
	...
	/**
	  * StgIac (full: StgIacWznmVerVer1NApp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerVer1NApp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerVer1NApp";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerVer1NApp");
	...
	/**
		* DpchAppData (full: DpchAppWznmVerVer1NAppData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NAPPDATA, scrJref);
		...
		public QryWznmVerVer1NApp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NAppData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerVer1NAppDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERVER1NAPPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerVer1NAppDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerVer1NAppData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERVER1NAPPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerVer1NApp();
			statappqry = (new QryWznmVerVer1NApp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerVer1NApp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerVer1NApp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerVer1NApp rst;
		public QryWznmVerVer1NApp.StatApp statappqry;
		public QryWznmVerVer1NApp.StatShr statshrqry;
		public QryWznmVerVer1NApp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerVer1NAppData");
