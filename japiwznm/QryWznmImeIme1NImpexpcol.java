/**
  * \file QryWznmImeIme1NImpexpcol.java
  * Java API code for job QryWznmImeIme1NImpexpcol
...
public class QryWznmImeIme1NImpexpcol {
	/**
	  * StatApp (full: StatAppQryWznmImeIme1NImpexpcol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmImeIme1NImpexpcol");
	...
	/**
	  * StatShr (full: StatShrQryWznmImeIme1NImpexpcol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmImeIme1NImpexpcol");
	...
	/**
	  * StgIac (full: StgIacQryWznmImeIme1NImpexpcol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmImeIme1NImpexpcol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmImeIme1NImpexpcol";
