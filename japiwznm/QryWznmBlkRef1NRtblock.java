/**
  * \file QryWznmBlkRef1NRtblock.java
  * Java API code for job QryWznmBlkRef1NRtblock
...
public class QryWznmBlkRef1NRtblock {
	/**
	  * StatApp (full: StatAppQryWznmBlkRef1NRtblock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmBlkRef1NRtblock");
	...
	/**
	  * StatShr (full: StatShrQryWznmBlkRef1NRtblock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmBlkRef1NRtblock");
	...
	/**
	  * StgIac (full: StgIacQryWznmBlkRef1NRtblock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmBlkRef1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmBlkRef1NRtblock";
