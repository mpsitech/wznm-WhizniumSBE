/**
  * \file QryWznmCtpKKey.java
  * Java API code for job QryWznmCtpKKey
...
public class QryWznmCtpKKey {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmCtpKKey");

			String itemtag = "StatitemAppQryWznmCtpKKey";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmCtpKKey");

			String itemtag = "StatitemShrQryWznmCtpKKey";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmCtpKKey");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmCtpKKey";
