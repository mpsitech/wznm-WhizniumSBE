/**
  * \file PnlWznmOpxAInvarg.java
  * Java API code for job PnlWznmOpxAInvarg
...
public class PnlWznmOpxAInvarg {
	/**
		* VecVDo (full: VecVWznmOpxAInvargDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpxAInvarg)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxAInvarg");
	...
	/**
	  * StatApp (full: StatAppWznmOpxAInvarg)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpxAInvarg");
	...
	/**
	  * StatShr (full: StatShrWznmOpxAInvarg)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxAInvarg");
	...
	/**
	  * StgIac (full: StgIacWznmOpxAInvarg)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxAInvarg");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxAInvarg";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxAInvarg");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxAInvargData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXAINVARGDATA, scrJref);
		...
		public QryWznmOpxAInvarg.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxAInvargData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxAInvargDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXAINVARGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxAInvargDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxAInvargData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXAINVARGDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQOpxAInvarg();
			statappqry = (new QryWznmOpxAInvarg()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxAInvarg()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxAInvarg()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxAInvarg rst;
		public QryWznmOpxAInvarg.StatApp statappqry;
		public QryWznmOpxAInvarg.StatShr statshrqry;
		public QryWznmOpxAInvarg.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxAInvargData");
