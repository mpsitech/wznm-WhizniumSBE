/**
  * \file QryWznmSbsAsbMNSubset.java
  * Java API code for job QryWznmSbsAsbMNSubset
...
public class QryWznmSbsAsbMNSubset {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSbsAsbMNSubset");

			String itemtag = "StatitemAppQryWznmSbsAsbMNSubset";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSbsAsbMNSubset");

			String itemtag = "StatitemShrQryWznmSbsAsbMNSubset";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSbsAsbMNSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSbsAsbMNSubset";
