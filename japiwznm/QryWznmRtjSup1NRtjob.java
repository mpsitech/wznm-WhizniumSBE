/**
  * \file QryWznmRtjSup1NRtjob.java
  * Java API code for job QryWznmRtjSup1NRtjob
...
public class QryWznmRtjSup1NRtjob {
	/**
	  * StatApp (full: StatAppQryWznmRtjSup1NRtjob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRtjSup1NRtjob");
	...
	/**
	  * StatShr (full: StatShrQryWznmRtjSup1NRtjob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRtjSup1NRtjob");
	...
	/**
	  * StgIac (full: StgIacQryWznmRtjSup1NRtjob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRtjSup1NRtjob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRtjSup1NRtjob";
