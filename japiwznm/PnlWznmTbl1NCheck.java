/**
  * \file PnlWznmTbl1NCheck.java
  * Java API code for job PnlWznmTbl1NCheck
...
public class PnlWznmTbl1NCheck {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTbl1NCheck");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTbl1NCheck");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTbl1NCheck");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTbl1NCheck");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTbl1NCheck";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTbl1NCheck");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NCHECKDATA, scrJref);
		...
		public QryWznmTbl1NCheck.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NCheckData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBL1NCHECKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTbl1NCheckDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBL1NCHECKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTbl1NCheck();
			statappqry = (new QryWznmTbl1NCheck()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTbl1NCheck()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTbl1NCheck()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTbl1NCheck rst;
		public QryWznmTbl1NCheck.StatApp statappqry;
		public QryWznmTbl1NCheck.StatShr statshrqry;
		public QryWznmTbl1NCheck.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTbl1NCheckData");
