/**
  * \file PnlWznmUsgAAccess.java
  * Java API code for job PnlWznmUsgAAccess
...
public class PnlWznmUsgAAccess {
	/**
		* VecVDo (full: VecVWznmUsgAAccessDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmUsgAAccess)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsgAAccess");

			String itemtag = "ContitemInfWznmUsgAAccess";
	...
	/**
	  * StatApp (full: StatAppWznmUsgAAccess)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmUsgAAccess");

			String itemtag = "StatitemAppWznmUsgAAccess";
	...
	/**
	  * StatShr (full: StatShrWznmUsgAAccess)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsgAAccess");

			String itemtag = "StatitemShrWznmUsgAAccess";
	...
	/**
	  * StgIac (full: StgIacWznmUsgAAccess)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsgAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsgAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsgAAccess");

			String itemtag = "TagitemWznmUsgAAccess";
	...
	/**
		* DpchAppData (full: DpchAppWznmUsgAAccessData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGAACCESSDATA, scrJref);
		...
		public QryWznmUsgAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgAAccessData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsgAAccessDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgAAccessDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsgAAccessData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSGAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQUsgAAccess();
			statappqry = (new QryWznmUsgAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsgAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsgAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsgAAccess rst;
		public QryWznmUsgAAccess.StatApp statappqry;
		public QryWznmUsgAAccess.StatShr statshrqry;
		public QryWznmUsgAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsgAAccessData");
