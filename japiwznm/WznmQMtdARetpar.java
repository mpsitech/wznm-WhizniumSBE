/**
  ...
  * Java API code for record of table TblWznmQMtdARetpar
...
public class WznmQMtdARetpar {
	
	public WznmQMtdARetpar(
				int jnum
				, String sref
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQMtdARetpar");
