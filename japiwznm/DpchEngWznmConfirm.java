/**
  * \file DpchEngWznmConfirm.java
  * Wznm Java API package confirm engine dispatch block
...
public class DpchEngWznmConfirm extends DpchEngWznm {

	public static final int ACCEPTED = 1;
	public static final int SCRJREF = 2;
	public static final int SREF = 3;

	public DpchEngWznmConfirm() {
		super(VecWznmVDpch.DPCHENGWZNMCONFIRM);
	...
	public void readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmConfirm");
