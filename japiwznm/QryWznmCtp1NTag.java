/**
  * \file QryWznmCtp1NTag.java
  * Java API code for job QryWznmCtp1NTag
...
public class QryWznmCtp1NTag {
	/**
	  * StatApp (full: StatAppQryWznmCtp1NTag)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmCtp1NTag");
	...
	/**
	  * StatShr (full: StatShrQryWznmCtp1NTag)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmCtp1NTag");
	...
	/**
	  * StgIac (full: StgIacQryWznmCtp1NTag)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmCtp1NTag");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmCtp1NTag";
