/**
  * \file PnlWznmTblPst1NQuerymod.java
  * Java API code for job PnlWznmTblPst1NQuerymod
...
public class PnlWznmTblPst1NQuerymod {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblPst1NQuerymod");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblPst1NQuerymod");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblPst1NQuerymod");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblPst1NQuerymod";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblPst1NQuerymod");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLPST1NQUERYMODDATA, scrJref);
		...
		public QryWznmTblPst1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblPst1NQuerymodData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLPST1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblPst1NQuerymodDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLPST1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblPst1NQuerymod();
			statappqry = (new QryWznmTblPst1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblPst1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblPst1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblPst1NQuerymod rst;
		public QryWznmTblPst1NQuerymod.StatApp statappqry;
		public QryWznmTblPst1NQuerymod.StatShr statshrqry;
		public QryWznmTblPst1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblPst1NQuerymodData");
