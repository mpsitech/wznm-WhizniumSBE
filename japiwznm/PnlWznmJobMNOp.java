/**
  * \file PnlWznmJobMNOp.java
  * Java API code for job PnlWznmJobMNOp
...
public class PnlWznmJobMNOp {
	/**
		* VecVDo (full: VecVWznmJobMNOpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobMNOp)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobMNOp");
	...
	/**
	  * StatApp (full: StatAppWznmJobMNOp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobMNOp");
	...
	/**
	  * StatShr (full: StatShrWznmJobMNOp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobMNOp");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobMNOp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobMNOp";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobMNOp");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobMNOpData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBMNOPDATA, scrJref);
		...
		public QryWznmJobMNOp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobMNOpData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobMNOpDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBMNOPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobMNOpDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobMNOpData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBMNOPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJobMNOp();
			statappqry = (new QryWznmJobMNOp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobMNOp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobMNOp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobMNOp rst;
		public QryWznmJobMNOp.StatApp statappqry;
		public QryWznmJobMNOp.StatShr statshrqry;
		public QryWznmJobMNOp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobMNOpData");
