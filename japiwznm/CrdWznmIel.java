/**
  * \file CrdWznmIel.java
  * Java API code for job CrdWznmIel
...
public class CrdWznmIel {
	/**
		* VecVDo (full: VecVWznmIelDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmIel)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDIEL = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDIEL));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdIel;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIel");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdIel = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdIel", mask, MTXCRDIEL);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdIel.equals(comp.MtxCrdIel)) items.add(MTXCRDIEL);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDIEL));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmIel");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIel");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIel");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIelDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIELDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIelDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIelData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIELDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIelData");
