/**
  * \file QryWznmTco1NImpexpcol.java
  * Java API code for job QryWznmTco1NImpexpcol
...
public class QryWznmTco1NImpexpcol {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTco1NImpexpcol");

			String itemtag = "StatitemAppQryWznmTco1NImpexpcol";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTco1NImpexpcol");

			String itemtag = "StatitemShrQryWznmTco1NImpexpcol";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTco1NImpexpcol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTco1NImpexpcol";
