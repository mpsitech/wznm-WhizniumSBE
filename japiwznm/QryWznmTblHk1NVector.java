/**
  * \file QryWznmTblHk1NVector.java
  * Java API code for job QryWznmTblHk1NVector
...
public class QryWznmTblHk1NVector {
	/**
	  * StatApp (full: StatAppQryWznmTblHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblHk1NVector");
	...
	/**
	  * StatShr (full: StatShrQryWznmTblHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblHk1NVector");
	...
	/**
	  * StgIac (full: StgIacQryWznmTblHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblHk1NVector";
