...
public class PnlWznmVecRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONESRC1NFEED = 4;
		public static final int INITDONEREF1NPANEL = 5;
		public static final int INITDONEFCT1NTABLECOL = 6;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONEVEC1NVECTORITEM, INITDONESRC1NFEED, INITDONEREF1NPANEL, INITDONEFCT1NTABLECOL, INITDONEPST1NQUERYMOD, INITDONEMNTABLE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONEVEC1NVECTORITEM, INITDONESRC1NFEED, INITDONEREF1NPANEL, INITDONEFCT1NTABLECOL, INITDONEPST1NQUERYMOD, INITDONEMNTABLE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFSRC1NFEED = 5;
		public static final int SCRJREFREF1NPANEL = 6;
		public static final int SCRJREFFCT1NTABLECOL = 7;
		public static final int PNLFCT1NTABLECOLAVAIL = 8;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFVEC1NVECTORITEM, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNTABLE, PNLMNTABLEAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREFVEC1NVECTORITEM, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNTABLE, PNLMNTABLEAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
