/**
  * \file PnlWznmMdlList.java
  * Java API code for job PnlWznmMdlList
...
public class PnlWznmMdlList {
	/**
		* VecVDo (full: VecVWznmMdlListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmMdlList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmMdlList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmMdlList";
	...
	/**
	  * ContInf (full: ContInfWznmMdlList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMdlList");
	...
	/**
	  * StatShr (full: StatShrWznmMdlList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMdlList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMdlList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMdlList";
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMdlList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT, TCOVER));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmMdlListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLLISTDATA, scrJref);
		...
		public QryWznmMdlList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMdlListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMdlListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMDLLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQMdlList();
			statappqry = (new QryWznmMdlList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMdlList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMdlList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMdlList rst;
		public QryWznmMdlList.StatApp statappqry;
		public QryWznmMdlList.StatShr statshrqry;
		public QryWznmMdlList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMdlListData");
