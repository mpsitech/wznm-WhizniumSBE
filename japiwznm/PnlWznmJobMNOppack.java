/**
  * \file PnlWznmJobMNOppack.java
  * Java API code for job PnlWznmJobMNOppack
...
public class PnlWznmJobMNOppack {
	/**
		* VecVDo (full: VecVWznmJobMNOppackDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobMNOppack)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobMNOppack");
	...
	/**
	  * StatApp (full: StatAppWznmJobMNOppack)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobMNOppack");
	...
	/**
	  * StatShr (full: StatShrWznmJobMNOppack)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobMNOppack");
	...
	/**
	  * StgIac (full: StgIacWznmJobMNOppack)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobMNOppack");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobMNOppack";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobMNOppack");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobMNOppackData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBMNOPPACKDATA, scrJref);
		...
		public QryWznmJobMNOppack.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobMNOppackData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobMNOppackDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBMNOPPACKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobMNOppackDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobMNOppackData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBMNOPPACKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJobMNOppack();
			statappqry = (new QryWznmJobMNOppack()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobMNOppack()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobMNOppack()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobMNOppack rst;
		public QryWznmJobMNOppack.StatApp statappqry;
		public QryWznmJobMNOppack.StatShr statshrqry;
		public QryWznmJobMNOppack.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobMNOppackData");
