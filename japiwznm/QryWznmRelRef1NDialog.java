/**
  * \file QryWznmRelRef1NDialog.java
  * Java API code for job QryWznmRelRef1NDialog
...
public class QryWznmRelRef1NDialog {
	/**
	  * StatApp (full: StatAppQryWznmRelRef1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmRelRef1NDialog");
	...
	/**
	  * StatShr (full: StatShrQryWznmRelRef1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmRelRef1NDialog");
	...
	/**
	  * StgIac (full: StgIacQryWznmRelRef1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmRelRef1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmRelRef1NDialog";
