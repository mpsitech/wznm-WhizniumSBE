/**
  * \file QryWznmVerVer1NVisual.java
  * Java API code for job QryWznmVerVer1NVisual
...
public class QryWznmVerVer1NVisual {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVerVer1NVisual");

			String itemtag = "StatitemAppQryWznmVerVer1NVisual";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVerVer1NVisual");

			String itemtag = "StatitemShrQryWznmVerVer1NVisual";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVerVer1NVisual");

			String itemtag = "StgitemIacQryWznmVerVer1NVisual";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVerVer1NVisual";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacQryWznmVerVer1NVisual";
