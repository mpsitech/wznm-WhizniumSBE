/**
  * \file PnlWznmApp1NRtjob.java
  * Java API code for job PnlWznmApp1NRtjob
...
public class PnlWznmApp1NRtjob {
	/**
		* VecVDo (full: VecVWznmApp1NRtjobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmApp1NRtjob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmApp1NRtjob");
	...
	/**
	  * StatApp (full: StatAppWznmApp1NRtjob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmApp1NRtjob");
	...
	/**
	  * StatShr (full: StatShrWznmApp1NRtjob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmApp1NRtjob");
	...
	/**
	  * StgIac (full: StgIacWznmApp1NRtjob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmApp1NRtjob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmApp1NRtjob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmApp1NRtjob");
	...
	/**
		* DpchAppData (full: DpchAppWznmApp1NRtjobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPP1NRTJOBDATA, scrJref);
		...
		public QryWznmApp1NRtjob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmApp1NRtjobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmApp1NRtjobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPP1NRTJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmApp1NRtjobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmApp1NRtjobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMAPP1NRTJOBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQApp1NRtjob();
			statappqry = (new QryWznmApp1NRtjob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmApp1NRtjob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmApp1NRtjob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQApp1NRtjob rst;
		public QryWznmApp1NRtjob.StatApp statappqry;
		public QryWznmApp1NRtjob.StatShr statshrqry;
		public QryWznmApp1NRtjob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmApp1NRtjobData");
