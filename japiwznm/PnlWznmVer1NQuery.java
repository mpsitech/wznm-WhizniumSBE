/**
  * \file PnlWznmVer1NQuery.java
  * Java API code for job PnlWznmVer1NQuery
...
public class PnlWznmVer1NQuery {
	/**
		* VecVDo (full: VecVWznmVer1NQueryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NQuery)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NQuery");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NQuery)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NQuery");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NQuery)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NQuery");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NQuery)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NQuery");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NQuery";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NQuery");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NQueryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NQUERYDATA, scrJref);
		...
		public QryWznmVer1NQuery.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NQueryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NQueryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NQUERYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NQueryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NQueryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NQUERYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NQuery();
			statappqry = (new QryWznmVer1NQuery()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NQuery()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NQuery()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NQuery rst;
		public QryWznmVer1NQuery.StatApp statappqry;
		public QryWznmVer1NQuery.StatShr statshrqry;
		public QryWznmVer1NQuery.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NQueryData");
