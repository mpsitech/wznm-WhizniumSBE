/**
  * \file PnlWznmDlgMNQuery.java
  * Java API code for job PnlWznmDlgMNQuery
...
public class PnlWznmDlgMNQuery {
	/**
		* VecVDo (full: VecVWznmDlgMNQueryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmDlgMNQuery)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmDlgMNQuery");
	...
	/**
	  * StatApp (full: StatAppWznmDlgMNQuery)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmDlgMNQuery");
	...
	/**
	  * StatShr (full: StatShrWznmDlgMNQuery)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmDlgMNQuery");
	...
	/**
	  * StgIac (full: StgIacWznmDlgMNQuery)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmDlgMNQuery");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmDlgMNQuery";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmDlgMNQuery");
	...
	/**
		* DpchAppData (full: DpchAppWznmDlgMNQueryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGMNQUERYDATA, scrJref);
		...
		public QryWznmDlgMNQuery.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgMNQueryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmDlgMNQueryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGMNQUERYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgMNQueryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmDlgMNQueryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMDLGMNQUERYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQDlgMNQuery();
			statappqry = (new QryWznmDlgMNQuery()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmDlgMNQuery()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmDlgMNQuery()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQDlgMNQuery rst;
		public QryWznmDlgMNQuery.StatApp statappqry;
		public QryWznmDlgMNQuery.StatShr statshrqry;
		public QryWznmDlgMNQuery.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmDlgMNQueryData");
