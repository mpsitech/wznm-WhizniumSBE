/**
  * \file CrdWznmOpk.java
  * Java API code for job CrdWznmOpk
...
public class CrdWznmOpk {
	/**
		* VecVDo (full: VecVWznmOpkDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpk)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDOPK = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDOPK));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdOpk;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpk");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdOpk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdOpk", mask, MTXCRDOPK);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdOpk.equals(comp.MtxCrdOpk)) items.add(MTXCRDOPK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDOPK));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpk");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpk");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpk");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkData");
