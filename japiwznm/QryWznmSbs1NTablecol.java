/**
  * \file QryWznmSbs1NTablecol.java
  * Java API code for job QryWznmSbs1NTablecol
...
public class QryWznmSbs1NTablecol {
	/**
	  * StatApp (full: StatAppQryWznmSbs1NTablecol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSbs1NTablecol");
	...
	/**
	  * StatShr (full: StatShrQryWznmSbs1NTablecol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSbs1NTablecol");
	...
	/**
	  * StgIac (full: StgIacQryWznmSbs1NTablecol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSbs1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSbs1NTablecol";
