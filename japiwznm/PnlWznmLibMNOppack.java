/**
  * \file PnlWznmLibMNOppack.java
  * Java API code for job PnlWznmLibMNOppack
...
public class PnlWznmLibMNOppack {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLibMNOppack");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmLibMNOppack");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLibMNOppack");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLibMNOppack");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLibMNOppack";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLibMNOppack");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBMNOPPACKDATA, scrJref);
		...
		public QryWznmLibMNOppack.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibMNOppackData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBMNOPPACKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibMNOppackDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLIBMNOPPACKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQLibMNOppack();
			statappqry = (new QryWznmLibMNOppack()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLibMNOppack()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLibMNOppack()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLibMNOppack rst;
		public QryWznmLibMNOppack.StatApp statappqry;
		public QryWznmLibMNOppack.StatShr statshrqry;
		public QryWznmLibMNOppack.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLibMNOppackData");
