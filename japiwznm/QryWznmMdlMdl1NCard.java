/**
  * \file QryWznmMdlMdl1NCard.java
  * Java API code for job QryWznmMdlMdl1NCard
...
public class QryWznmMdlMdl1NCard {
	/**
	  * StatApp (full: StatAppQryWznmMdlMdl1NCard)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmMdlMdl1NCard");
	...
	/**
	  * StatShr (full: StatShrQryWznmMdlMdl1NCard)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmMdlMdl1NCard");
	...
	/**
	  * StgIac (full: StgIacQryWznmMdlMdl1NCard)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmMdlMdl1NCard");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmMdlMdl1NCard";
