/**
  * \file PnlWznmOpxSqkMNStub.java
  * Java API code for job PnlWznmOpxSqkMNStub
...
public class PnlWznmOpxSqkMNStub {
	/**
		* VecVDo (full: VecVWznmOpxSqkMNStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpxSqkMNStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxSqkMNStub");
	...
	/**
	  * StatApp (full: StatAppWznmOpxSqkMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpxSqkMNStub");
	...
	/**
	  * StatShr (full: StatShrWznmOpxSqkMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxSqkMNStub");
	...
	/**
	  * StgIac (full: StgIacWznmOpxSqkMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxSqkMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxSqkMNStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxSqkMNStub");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxSqkMNStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXSQKMNSTUBDATA, scrJref);
		...
		public QryWznmOpxSqkMNStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxSqkMNStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxSqkMNStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXSQKMNSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxSqkMNStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxSqkMNStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXSQKMNSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpxSqkMNStub();
			statappqry = (new QryWznmOpxSqkMNStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxSqkMNStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxSqkMNStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxSqkMNStub rst;
		public QryWznmOpxSqkMNStub.StatApp statappqry;
		public QryWznmOpxSqkMNStub.StatShr statshrqry;
		public QryWznmOpxSqkMNStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxSqkMNStubData");
