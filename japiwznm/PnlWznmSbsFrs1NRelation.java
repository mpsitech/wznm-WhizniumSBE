/**
  * \file PnlWznmSbsFrs1NRelation.java
  * Java API code for job PnlWznmSbsFrs1NRelation
...
public class PnlWznmSbsFrs1NRelation {
	/**
		* VecVDo (full: VecVWznmSbsFrs1NRelationDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbsFrs1NRelation)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsFrs1NRelation");
	...
	/**
	  * StatApp (full: StatAppWznmSbsFrs1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsFrs1NRelation");
	...
	/**
	  * StatShr (full: StatShrWznmSbsFrs1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsFrs1NRelation");
	...
	/**
	  * StgIac (full: StgIacWznmSbsFrs1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsFrs1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsFrs1NRelation";
	...
	/**
	  * Tag (full: TagWznmSbsFrs1NRelation)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsFrs1NRelation");
	...
	/**
		* DpchAppData (full: DpchAppWznmSbsFrs1NRelationData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSFRS1NRELATIONDATA, scrJref);
		...
		public QryWznmSbsFrs1NRelation.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsFrs1NRelationData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbsFrs1NRelationDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSFRS1NRELATIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsFrs1NRelationDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbsFrs1NRelationData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSFRS1NRELATIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSbsFrs1NRelation();
			statappqry = (new QryWznmSbsFrs1NRelation()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsFrs1NRelation()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsFrs1NRelation()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsFrs1NRelation rst;
		public QryWznmSbsFrs1NRelation.StatApp statappqry;
		public QryWznmSbsFrs1NRelation.StatShr statshrqry;
		public QryWznmSbsFrs1NRelation.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsFrs1NRelationData");
