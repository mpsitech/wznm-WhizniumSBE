/**
  * \file QryWznmChkRef1NCall.java
  * Java API code for job QryWznmChkRef1NCall
...
public class QryWznmChkRef1NCall {
	/**
	  * StatApp (full: StatAppQryWznmChkRef1NCall)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmChkRef1NCall");
	...
	/**
	  * StatShr (full: StatShrQryWznmChkRef1NCall)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmChkRef1NCall");
	...
	/**
	  * StgIac (full: StgIacQryWznmChkRef1NCall)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmChkRef1NCall");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmChkRef1NCall";
