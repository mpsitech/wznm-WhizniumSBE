/**
  * \file PnlWznmUsgList.java
  * Java API code for job PnlWznmUsgList
...
public class PnlWznmUsgList {
	/**
		* VecVDo (full: VecVWznmUsgListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmUsgList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmUsgList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmUsgList";
	...
	/**
	  * ContInf (full: ContInfWznmUsgList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsgList");
	...
	/**
	  * StatShr (full: StatShrWznmUsgList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsgList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsgList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsgList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsgList");
	...
	/**
		* DpchAppData (full: DpchAppWznmUsgListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGLISTDATA, scrJref);
		...
		public QryWznmUsgList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsgListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsgListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSGLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQUsgList();
			statappqry = (new QryWznmUsgList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsgList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsgList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsgList rst;
		public QryWznmUsgList.StatApp statappqry;
		public QryWznmUsgList.StatShr statshrqry;
		public QryWznmUsgList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsgListData");
