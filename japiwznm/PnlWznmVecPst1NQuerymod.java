/**
  * \file PnlWznmVecPst1NQuerymod.java
  * Java API code for job PnlWznmVecPst1NQuerymod
...
public class PnlWznmVecPst1NQuerymod {
	/**
		* VecVDo (full: VecVWznmVecPst1NQuerymodDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVecPst1NQuerymod)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecPst1NQuerymod");
	...
	/**
	  * StatApp (full: StatAppWznmVecPst1NQuerymod)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecPst1NQuerymod");
	...
	/**
	  * StatShr (full: StatShrWznmVecPst1NQuerymod)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecPst1NQuerymod");
	...
	/**
	  * StgIac (full: StgIacWznmVecPst1NQuerymod)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecPst1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecPst1NQuerymod";
	...
	/**
	  * Tag (full: TagWznmVecPst1NQuerymod)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecPst1NQuerymod");
	...
	/**
		* DpchAppData (full: DpchAppWznmVecPst1NQuerymodData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECPST1NQUERYMODDATA, scrJref);
		...
		public QryWznmVecPst1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecPst1NQuerymodData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecPst1NQuerymodDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECPST1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecPst1NQuerymodDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecPst1NQuerymodData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECPST1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVecPst1NQuerymod();
			statappqry = (new QryWznmVecPst1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecPst1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecPst1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecPst1NQuerymod rst;
		public QryWznmVecPst1NQuerymod.StatApp statappqry;
		public QryWznmVecPst1NQuerymod.StatShr statshrqry;
		public QryWznmVecPst1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecPst1NQuerymodData");
