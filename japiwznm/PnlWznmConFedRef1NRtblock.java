/**
  * \file PnlWznmConFedRef1NRtblock.java
  * Java API code for job PnlWznmConFedRef1NRtblock
...
public class PnlWznmConFedRef1NRtblock {
	/**
		* VecVDo (full: VecVWznmConFedRef1NRtblockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmConFedRef1NRtblock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmConFedRef1NRtblock");
	...
	/**
	  * StatApp (full: StatAppWznmConFedRef1NRtblock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmConFedRef1NRtblock");
	...
	/**
	  * StgIac (full: StgIacWznmConFedRef1NRtblock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmConFedRef1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmConFedRef1NRtblock";
	...
	/**
	  * Tag (full: TagWznmConFedRef1NRtblock)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmConFedRef1NRtblock");
	...
	/**
		* DpchAppData (full: DpchAppWznmConFedRef1NRtblockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONFEDREF1NRTBLOCKDATA, scrJref);
		...
		public QryWznmConFedRef1NRtblock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConFedRef1NRtblockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmConFedRef1NRtblockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONFEDREF1NRTBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConFedRef1NRtblockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmConFedRef1NRtblockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCONFEDREF1NRTBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQConFedRef1NRtblock();
			statappqry = (new QryWznmConFedRef1NRtblock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmConFedRef1NRtblock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmConFedRef1NRtblock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQConFedRef1NRtblock rst;
		public QryWznmConFedRef1NRtblock.StatApp statappqry;
		public QryWznmConFedRef1NRtblock.StatShr statshrqry;
		public QryWznmConFedRef1NRtblock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmConFedRef1NRtblockData");
