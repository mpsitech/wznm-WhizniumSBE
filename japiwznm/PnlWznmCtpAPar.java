/**
  * \file PnlWznmCtpAPar.java
  * Java API code for job PnlWznmCtpAPar
...
public class PnlWznmCtpAPar {
	/**
		* VecVDo (full: VecVWznmCtpAParDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCtpAPar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtpAPar");
	...
	/**
	  * StatApp (full: StatAppWznmCtpAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtpAPar");
	...
	/**
	  * StatShr (full: StatShrWznmCtpAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtpAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCtpAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCtpAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtpAPar");
	...
	/**
		* DpchAppData (full: DpchAppWznmCtpAParData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPAPARDATA, scrJref);
		...
		public QryWznmCtpAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpAParData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCtpAParDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpAParDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCtpAParData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTPAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQCtpAPar();
			statappqry = (new QryWznmCtpAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCtpAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCtpAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCtpAPar rst;
		public QryWznmCtpAPar.StatApp statappqry;
		public QryWznmCtpAPar.StatShr statshrqry;
		public QryWznmCtpAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtpAParData");
