/**
  * \file PnlWznmDlgList.java
  * Java API code for job PnlWznmDlgList
...
public class PnlWznmDlgList {
	/**
		* VecVDo (full: VecVWznmDlgListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmDlgList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmDlgList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmDlgList";
	...
	/**
	  * ContInf (full: ContInfWznmDlgList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmDlgList");
	...
	/**
	  * StatShr (full: StatShrWznmDlgList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmDlgList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOCARWIDTH, TCORETWIDTH, TCOREUWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoTypWidth;
		public int TcoCarWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmDlgList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoCarWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCarWidth", mask, TCOCARWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmDlgList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCarWidth", TcoCarWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoCarWidth == comp.TcoCarWidth) items.add(TCOCARWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOCARWIDTH, TCORETWIDTH, TCOREUWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOCAR = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOCAR, TCORET, TCOREU));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmDlgList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoCar = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCar", mask, TCOCAR);
		...
		public HashSet<Integer> comm(
			...
			if (TcoCar.equals(comp.TcoCar)) items.add(TCOCAR);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOCAR, TCORET, TCOREU));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmDlgListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGLISTDATA, scrJref);
		...
		public QryWznmDlgList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmDlgListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmDlgListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMDLGLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQDlgList();
			statappqry = (new QryWznmDlgList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmDlgList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmDlgList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQDlgList rst;
		public QryWznmDlgList.StatApp statappqry;
		public QryWznmDlgList.StatShr statshrqry;
		public QryWznmDlgList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmDlgListData");
