/**
  * \file QryWznmTbl1NCheck.java
  * Java API code for job QryWznmTbl1NCheck
...
public class QryWznmTbl1NCheck {
	/**
	  * StatApp (full: StatAppQryWznmTbl1NCheck)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTbl1NCheck");
	...
	/**
	  * StatShr (full: StatShrQryWznmTbl1NCheck)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTbl1NCheck");
	...
	/**
	  * StgIac (full: StgIacQryWznmTbl1NCheck)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTbl1NCheck");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTbl1NCheck";
