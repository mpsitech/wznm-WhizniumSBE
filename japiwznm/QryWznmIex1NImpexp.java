/**
  * \file QryWznmIex1NImpexp.java
  * Java API code for job QryWznmIex1NImpexp
...
public class QryWznmIex1NImpexp {
	/**
	  * StatApp (full: StatAppQryWznmIex1NImpexp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmIex1NImpexp");
	...
	/**
	  * StatShr (full: StatShrQryWznmIex1NImpexp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmIex1NImpexp");
	...
	/**
	  * StgIac (full: StgIacQryWznmIex1NImpexp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmIex1NImpexp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmIex1NImpexp";
