/**
  * \file CrdWznmBlk.java
  * Java API code for job CrdWznmBlk
...
public class CrdWznmBlk {
	/**
		* VecVDo (full: VecVWznmBlkDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmBlk)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDBLK = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBLK));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdBlk;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBlk");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdBlk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdBlk", mask, MTXCRDBLK);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdBlk.equals(comp.MtxCrdBlk)) items.add(MTXCRDBLK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDBLK));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmBlk");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBlk");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBlk");
	...
	/**
		* DpchAppDo (full: DpchAppWznmBlkDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBLKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBlkDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBlkData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBLKDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBlkData");
