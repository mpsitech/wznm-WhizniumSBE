/**
  * \file PnlWznmRelSup1NRelation.java
  * Java API code for job PnlWznmRelSup1NRelation
...
public class PnlWznmRelSup1NRelation {
	/**
		* VecVDo (full: VecVWznmRelSup1NRelationDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRelSup1NRelation)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelSup1NRelation");
	...
	/**
	  * StatApp (full: StatAppWznmRelSup1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRelSup1NRelation");
	...
	/**
	  * StatShr (full: StatShrWznmRelSup1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelSup1NRelation");
	...
	/**
	  * StgIac (full: StgIacWznmRelSup1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelSup1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelSup1NRelation";
	...
	/**
	  * Tag (full: TagWznmRelSup1NRelation)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelSup1NRelation");
	...
	/**
		* DpchAppData (full: DpchAppWznmRelSup1NRelationData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELSUP1NRELATIONDATA, scrJref);
		...
		public QryWznmRelSup1NRelation.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelSup1NRelationData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRelSup1NRelationDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELSUP1NRELATIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelSup1NRelationDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRelSup1NRelationData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELSUP1NRELATIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRelSup1NRelation();
			statappqry = (new QryWznmRelSup1NRelation()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelSup1NRelation()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelSup1NRelation()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelSup1NRelation rst;
		public QryWznmRelSup1NRelation.StatApp statappqry;
		public QryWznmRelSup1NRelation.StatShr statshrqry;
		public QryWznmRelSup1NRelation.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelSup1NRelationData");
