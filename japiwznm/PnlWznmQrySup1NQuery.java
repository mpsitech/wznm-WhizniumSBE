/**
  * \file PnlWznmQrySup1NQuery.java
  * Java API code for job PnlWznmQrySup1NQuery
...
public class PnlWznmQrySup1NQuery {
	/**
		* VecVDo (full: VecVWznmQrySup1NQueryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmQrySup1NQuery)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQrySup1NQuery");
	...
	/**
	  * StatApp (full: StatAppWznmQrySup1NQuery)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQrySup1NQuery");
	...
	/**
	  * StatShr (full: StatShrWznmQrySup1NQuery)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQrySup1NQuery");
	...
	/**
	  * StgIac (full: StgIacWznmQrySup1NQuery)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQrySup1NQuery");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQrySup1NQuery";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQrySup1NQuery");
	...
	/**
		* DpchAppData (full: DpchAppWznmQrySup1NQueryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYSUP1NQUERYDATA, scrJref);
		...
		public QryWznmQrySup1NQuery.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQrySup1NQueryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQrySup1NQueryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYSUP1NQUERYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQrySup1NQueryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQrySup1NQueryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYSUP1NQUERYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQQrySup1NQuery();
			statappqry = (new QryWznmQrySup1NQuery()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQrySup1NQuery()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQrySup1NQuery()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQrySup1NQuery rst;
		public QryWznmQrySup1NQuery.StatApp statappqry;
		public QryWznmQrySup1NQuery.StatShr statshrqry;
		public QryWznmQrySup1NQuery.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQrySup1NQueryData");
