/**
  * \file PnlWznmOpkARetval.java
  * Java API code for job PnlWznmOpkARetval
...
public class PnlWznmOpkARetval {
	/**
		* VecVDo (full: VecVWznmOpkARetvalDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpkARetval)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkARetval");
	...
	/**
	  * StatApp (full: StatAppWznmOpkARetval)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkARetval");
	...
	/**
	  * StatShr (full: StatShrWznmOpkARetval)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkARetval");
	...
	/**
	  * StgIac (full: StgIacWznmOpkARetval)
	  */
	public class StgIac extends Block {
		...
		public static final int TCOCMTWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOCMTWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkARetval");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkARetval";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOCMTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOCMT = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOVTY, TCOVEC, TCOCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkARetval");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOVTY, TCOVEC, TCOCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkARetvalData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKARETVALDATA, scrJref);
		...
		public QryWznmOpkARetval.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkARetvalData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkARetvalDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKARETVALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkARetvalDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkARetvalData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKARETVALDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQOpkARetval();
			statappqry = (new QryWznmOpkARetval()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkARetval()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkARetval()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkARetval rst;
		public QryWznmOpkARetval.StatApp statappqry;
		public QryWznmOpkARetval.StatShr statshrqry;
		public QryWznmOpkARetval.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkARetvalData");
