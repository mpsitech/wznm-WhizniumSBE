/**
  * \file PnlWznmSht1NBox.java
  * Java API code for job PnlWznmSht1NBox
...
public class PnlWznmSht1NBox {
	/**
		* VecVDo (full: VecVWznmSht1NBoxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSht1NBox)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSht1NBox");

			String itemtag = "ContitemInfWznmSht1NBox";
	...
	/**
	  * StatApp (full: StatAppWznmSht1NBox)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSht1NBox");

			String itemtag = "StatitemAppWznmSht1NBox";
	...
	/**
	  * StatShr (full: StatShrWznmSht1NBox)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSht1NBox");

			String itemtag = "StatitemShrWznmSht1NBox";
	...
	/**
	  * StgIac (full: StgIacWznmSht1NBox)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSht1NBox");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSht1NBox";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSht1NBox");

			String itemtag = "TagitemWznmSht1NBox";
	...
	/**
		* DpchAppData (full: DpchAppWznmSht1NBoxData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSHT1NBOXDATA, scrJref);
		...
		public QryWznmSht1NBox.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSht1NBoxData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSht1NBoxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSHT1NBOXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSht1NBoxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSht1NBoxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSHT1NBOXDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSht1NBox();
			statappqry = (new QryWznmSht1NBox()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSht1NBox()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSht1NBox()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSht1NBox rst;
		public QryWznmSht1NBox.StatApp statappqry;
		public QryWznmSht1NBox.StatShr statshrqry;
		public QryWznmSht1NBox.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSht1NBoxData");
