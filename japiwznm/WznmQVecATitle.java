/**
  ...
  * Java API code for record of table TblWznmQVecATitle
...
public class WznmQVecATitle {
	
	public WznmQVecATitle(
				int jnum
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQVecATitle");
