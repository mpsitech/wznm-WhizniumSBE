/**
  * \file QryWznmCarCar1NPanel.java
  * Java API code for job QryWznmCarCar1NPanel
...
public class QryWznmCarCar1NPanel {
	/**
	  * StatApp (full: StatAppQryWznmCarCar1NPanel)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmCarCar1NPanel");
	...
	/**
	  * StatShr (full: StatShrQryWznmCarCar1NPanel)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmCarCar1NPanel");
	...
	/**
	  * StgIac (full: StgIacQryWznmCarCar1NPanel)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmCarCar1NPanel");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmCarCar1NPanel";
