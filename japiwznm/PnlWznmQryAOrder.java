/**
  * \file PnlWznmQryAOrder.java
  * Java API code for job PnlWznmQryAOrder
...
public class PnlWznmQryAOrder {
	/**
		* VecVDo (full: VecVWznmQryAOrderDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmQryAOrder)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQryAOrder");
	...
	/**
	  * StatApp (full: StatAppWznmQryAOrder)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQryAOrder");
	...
	/**
	  * StatShr (full: StatShrWznmQryAOrder)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQryAOrder");
	...
	/**
	  * StgIac (full: StgIacWznmQryAOrder)
	  */
	public class StgIac extends Block {

		public static final int TCOSHOWIDTH = 1;
		public static final int TCOTCOWIDTH = 2;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSHOWIDTH, TCOTCOWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQryAOrder");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQryAOrder";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSHOWIDTH, TCOTCOWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSHO = 7;
		public static final int TCOTCO = 8;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSHO, TCOTCO));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryAOrder");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSHO, TCOTCO));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmQryAOrderData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYAORDERDATA, scrJref);
		...
		public QryWznmQryAOrder.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryAOrderData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQryAOrderDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYAORDERDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryAOrderDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQryAOrderData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYAORDERDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQQryAOrder();
			statappqry = (new QryWznmQryAOrder()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQryAOrder()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQryAOrder()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQryAOrder rst;
		public QryWznmQryAOrder.StatApp statappqry;
		public QryWznmQryAOrder.StatShr statshrqry;
		public QryWznmQryAOrder.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryAOrderData");
