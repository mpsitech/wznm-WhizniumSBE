/**
  * \file PnlWznmCal1NSensitivity.java
  * Java API code for job PnlWznmCal1NSensitivity
...
public class PnlWznmCal1NSensitivity {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCal1NSensitivity");

			String itemtag = "ContitemInfWznmCal1NSensitivity";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCal1NSensitivity");

			String itemtag = "StatitemAppWznmCal1NSensitivity";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCal1NSensitivity");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCal1NSensitivity";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCal1NSensitivity");

			String itemtag = "TagitemWznmCal1NSensitivity";
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAL1NSENSITIVITYDATA, scrJref);
		...
		public QryWznmCal1NSensitivity.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCal1NSensitivityData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAL1NSENSITIVITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCal1NSensitivityDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCAL1NSENSITIVITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCal1NSensitivity();
			statappqry = (new QryWznmCal1NSensitivity()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCal1NSensitivity()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCal1NSensitivity()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCal1NSensitivity rst;
		public QryWznmCal1NSensitivity.StatApp statappqry;
		public QryWznmCal1NSensitivity.StatShr statshrqry;
		public QryWznmCal1NSensitivity.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCal1NSensitivityData");
