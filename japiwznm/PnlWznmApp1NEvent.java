/**
  * \file PnlWznmApp1NEvent.java
  * Java API code for job PnlWznmApp1NEvent
...
public class PnlWznmApp1NEvent {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmApp1NEvent");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmApp1NEvent");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmApp1NEvent");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmApp1NEvent");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmApp1NEvent";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmApp1NEvent");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPP1NEVENTDATA, scrJref);
		...
		public QryWznmApp1NEvent.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmApp1NEventData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPP1NEVENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmApp1NEventDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMAPP1NEVENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQApp1NEvent();
			statappqry = (new QryWznmApp1NEvent()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmApp1NEvent()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmApp1NEvent()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQApp1NEvent rst;
		public QryWznmApp1NEvent.StatApp statappqry;
		public QryWznmApp1NEvent.StatShr statshrqry;
		public QryWznmApp1NEvent.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmApp1NEventData");
