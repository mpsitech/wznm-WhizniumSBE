/**
  * \file DlgWznmVisImpstr.java
  * Java API code for job DlgWznmVisImpstr
...
public class DlgWznmVisImpstr {
	/**
		* VecVDit (full: VecVDlgWznmVisImpstrDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVisImpstrDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVisImpstrDoImp)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmVisImpstrSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVisImpstr)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVisImpstr");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVisImpstr";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVisImpstr)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVisImpstr");

			String itemtag = "ContitemInfDlgWznmVisImpstr";
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVisImpstrImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVisImpstrImp");

			String itemtag = "ContitemInfDlgWznmVisImpstrImp";
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVisImpstrLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVisImpstrLfi");

			String itemtag = "ContitemInfDlgWznmVisImpstrLfi";
	...
	/**
	  * StatApp (full: StatAppDlgWznmVisImpstr)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVisImpstr");

			String itemtag = "StatitemAppDlgWznmVisImpstr";
	...
	/**
	  * StatShr (full: StatShrDlgWznmVisImpstr)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVisImpstr");

			String itemtag = "StatitemShrDlgWznmVisImpstr";
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVisImpstrIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVisImpstrIfi");

			String itemtag = "StatitemShrDlgWznmVisImpstrIfi";
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVisImpstrImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVisImpstrImp");

			String itemtag = "StatitemShrDlgWznmVisImpstrImp";
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVisImpstrLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVisImpstrLfi");

			String itemtag = "StatitemShrDlgWznmVisImpstrLfi";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVisImpstr");

			String itemtag = "TagitemDlgWznmVisImpstr";
	...
	/**
	  * TagIfi (full: TagDlgWznmVisImpstrIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVisImpstrIfi");

			String itemtag = "TagitemDlgWznmVisImpstrIfi";
	...
	/**
	  * TagImp (full: TagDlgWznmVisImpstrImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVisImpstrImp");

			String itemtag = "TagitemDlgWznmVisImpstrImp";
	...
	/**
	  * TagLfi (full: TagDlgWznmVisImpstrLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVisImpstrLfi");

			String itemtag = "TagitemDlgWznmVisImpstrLfi";
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmVisImpstrData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVISIMPSTRDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVisImpstrData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVisImpstrDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVISIMPSTRDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVisImpstrDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVisImpstrData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMVISIMPSTRDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVisImpstrData");
