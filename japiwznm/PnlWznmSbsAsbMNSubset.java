/**
  * \file PnlWznmSbsAsbMNSubset.java
  * Java API code for job PnlWznmSbsAsbMNSubset
...
public class PnlWznmSbsAsbMNSubset {
	/**
		* VecVDo (full: VecVWznmSbsAsbMNSubsetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbsAsbMNSubset)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsAsbMNSubset");

			String itemtag = "ContitemInfWznmSbsAsbMNSubset";
	...
	/**
	  * StatApp (full: StatAppWznmSbsAsbMNSubset)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsAsbMNSubset");

			String itemtag = "StatitemAppWznmSbsAsbMNSubset";
	...
	/**
	  * StatShr (full: StatShrWznmSbsAsbMNSubset)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsAsbMNSubset");

			String itemtag = "StatitemShrWznmSbsAsbMNSubset";
	...
	/**
	  * StgIac (full: StgIacWznmSbsAsbMNSubset)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsAsbMNSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsAsbMNSubset";
	...
	/**
	  * Tag (full: TagWznmSbsAsbMNSubset)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsAsbMNSubset");

			String itemtag = "TagitemWznmSbsAsbMNSubset";
	...
	/**
		* DpchAppData (full: DpchAppWznmSbsAsbMNSubsetData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSASBMNSUBSETDATA, scrJref);
		...
		public QryWznmSbsAsbMNSubset.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsAsbMNSubsetData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbsAsbMNSubsetDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSASBMNSUBSETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsAsbMNSubsetDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbsAsbMNSubsetData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSASBMNSUBSETDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQSbsAsbMNSubset();
			statappqry = (new QryWznmSbsAsbMNSubset()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsAsbMNSubset()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsAsbMNSubset()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsAsbMNSubset rst;
		public QryWznmSbsAsbMNSubset.StatApp statappqry;
		public QryWznmSbsAsbMNSubset.StatShr statshrqry;
		public QryWznmSbsAsbMNSubset.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsAsbMNSubsetData");
