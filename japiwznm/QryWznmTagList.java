...
public class QryWznmTagList {
	/**
		* VecVOrd (full: VecVQryWznmTagListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWznmTagList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTagList");

			String itemtag = "StatitemAppQryWznmTagList";
	...
	/**
	  * StatShr (full: StatShrQryWznmTagList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTagList");

			String itemtag = "StatitemShrQryWznmTagList";
	...
	/**
	  * StgIac (full: StgIacQryWznmTagList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTagList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTagList";
