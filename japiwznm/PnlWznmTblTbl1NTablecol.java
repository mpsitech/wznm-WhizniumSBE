/**
  * \file PnlWznmTblTbl1NTablecol.java
  * Java API code for job PnlWznmTblTbl1NTablecol
...
public class PnlWznmTblTbl1NTablecol {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblTbl1NTablecol");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblTbl1NTablecol");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblTbl1NTablecol");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblTbl1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblTbl1NTablecol";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblTbl1NTablecol");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLTBL1NTABLECOLDATA, scrJref);
		...
		public QryWznmTblTbl1NTablecol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblTbl1NTablecolData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLTBL1NTABLECOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblTbl1NTablecolDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLTBL1NTABLECOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblTbl1NTablecol();
			statappqry = (new QryWznmTblTbl1NTablecol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblTbl1NTablecol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblTbl1NTablecol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblTbl1NTablecol rst;
		public QryWznmTblTbl1NTablecol.StatApp statappqry;
		public QryWznmTblTbl1NTablecol.StatShr statshrqry;
		public QryWznmTblTbl1NTablecol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblTbl1NTablecolData");
