/**
  * \file PnlWznmOpxRef1NBlock.java
  * Java API code for job PnlWznmOpxRef1NBlock
...
public class PnlWznmOpxRef1NBlock {
	/**
		* VecVDo (full: VecVWznmOpxRef1NBlockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpxRef1NBlock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxRef1NBlock");
	...
	/**
	  * StatApp (full: StatAppWznmOpxRef1NBlock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpxRef1NBlock");
	...
	/**
	  * StatShr (full: StatShrWznmOpxRef1NBlock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxRef1NBlock");
	...
	/**
	  * StgIac (full: StgIacWznmOpxRef1NBlock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxRef1NBlock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxRef1NBlock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxRef1NBlock");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxRef1NBlockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXREF1NBLOCKDATA, scrJref);
		...
		public QryWznmOpxRef1NBlock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxRef1NBlockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxRef1NBlockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXREF1NBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxRef1NBlockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxRef1NBlockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXREF1NBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpxRef1NBlock();
			statappqry = (new QryWznmOpxRef1NBlock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxRef1NBlock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxRef1NBlock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxRef1NBlock rst;
		public QryWznmOpxRef1NBlock.StatApp statappqry;
		public QryWznmOpxRef1NBlock.StatShr statshrqry;
		public QryWznmOpxRef1NBlock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxRef1NBlockData");
