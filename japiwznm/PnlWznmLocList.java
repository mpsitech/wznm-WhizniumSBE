/**
  * \file PnlWznmLocList.java
  * Java API code for job PnlWznmLocList
...
public class PnlWznmLocList {
	/**
		* VecVDo (full: VecVWznmLocListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmLocList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmLocList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmLocList";
	...
	/**
	  * ContInf (full: ContInfWznmLocList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLocList");
	...
	/**
	  * StatShr (full: StatShrWznmLocList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLocList");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLocList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLocList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTITWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLocList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTIT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmLocListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLOCLISTDATA, scrJref);
		...
		public QryWznmLocList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLocListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmLocListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLOCLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLocListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmLocListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLOCLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQLocList();
			statappqry = (new QryWznmLocList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLocList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLocList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLocList rst;
		public QryWznmLocList.StatApp statappqry;
		public QryWznmLocList.StatShr statshrqry;
		public QryWznmLocList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLocListData");
