/**
  * \file PnlWznmIelList.java
  * Java API code for job PnlWznmIelList
...
public class PnlWznmIelList {
	/**
		* VecVDo (full: VecVWznmIelListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmIelList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmIelList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmIelList";
	...
	/**
	  * ContInf (full: ContInfWznmIelList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIelList");

			String itemtag = "ContitemInfWznmIelList";
	...
	/**
	  * StatShr (full: StatShrWznmIelList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIelList");

			String itemtag = "StatitemShrWznmIelList";
	...
	/**
	  * StgIac (full: StgIacWznmIelList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOSHOWIDTH = 2;
		public static final int TCOTYPWIDTH = 3;
		public static final int TCOIMEWIDTH = 4;
		public static final int TCOTCOWIDTH = 5;
		public static final int TCOCTYWIDTH = 6;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOIMEWIDTH, TCOTCOWIDTH, TCOCTYWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoShoWidth;
		public int TcoTypWidth;
		public int TcoImeWidth;
		public int TcoTcoWidth;
		public int TcoCtyWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmIelList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoImeWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoImeWidth", mask, TCOIMEWIDTH);
				TcoTcoWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTcoWidth", mask, TCOTCOWIDTH);
				TcoCtyWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoCtyWidth", mask, TCOCTYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmIelList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoImeWidth", TcoImeWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTcoWidth", TcoTcoWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoCtyWidth", TcoCtyWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoImeWidth == comp.TcoImeWidth) items.add(TCOIMEWIDTH);
			if (TcoTcoWidth == comp.TcoTcoWidth) items.add(TCOTCOWIDTH);
			if (TcoCtyWidth == comp.TcoCtyWidth) items.add(TCOCTYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOIMEWIDTH, TCOTCOWIDTH, TCOCTYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOIME = 11;
		public static final int TCOTCO = 12;
		public static final int TCOCTY = 13;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOIME, TCOTCO, TCOCTY));
		};
		...
		public String TcoIme;
		public String TcoTco;
		public String TcoCty;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIelList");

			String itemtag = "TagitemWznmIelList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoIme = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoIme", mask, TCOIME);
				TcoTco = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTco", mask, TCOTCO);
				TcoCty = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoCty", mask, TCOCTY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoIme.equals(comp.TcoIme)) items.add(TCOIME);
			if (TcoTco.equals(comp.TcoTco)) items.add(TCOTCO);
			if (TcoCty.equals(comp.TcoCty)) items.add(TCOCTY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOIME, TCOTCO, TCOCTY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmIelListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIELLISTDATA, scrJref);
		...
		public QryWznmIelList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIelListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIelListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIELLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIelListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIelListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIELLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQIelList();
			statappqry = (new QryWznmIelList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmIelList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmIelList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQIelList rst;
		public QryWznmIelList.StatApp statappqry;
		public QryWznmIelList.StatShr statshrqry;
		public QryWznmIelList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIelListData");
