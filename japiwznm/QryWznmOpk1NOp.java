/**
  * \file QryWznmOpk1NOp.java
  * Java API code for job QryWznmOpk1NOp
...
public class QryWznmOpk1NOp {
	/**
	  * StatApp (full: StatAppQryWznmOpk1NOp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmOpk1NOp");
	...
	/**
	  * StatShr (full: StatShrQryWznmOpk1NOp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmOpk1NOp");
	...
	/**
	  * StgIac (full: StgIacQryWznmOpk1NOp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmOpk1NOp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmOpk1NOp";
