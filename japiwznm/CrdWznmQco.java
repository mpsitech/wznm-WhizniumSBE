/**
  * \file CrdWznmQco.java
  * Java API code for job CrdWznmQco
...
public class CrdWznmQco {
	...
	public class ContInf extends Block {
		...
		public static final int MTXCRDQCO = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQCO));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdQco;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQco");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdQco = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdQco", mask, MTXCRDQCO);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdQco.equals(comp.MtxCrdQco)) items.add(MTXCRDQCO);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQCO));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQco");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQco");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQco");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQCODO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQcoDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQCODATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQcoData");
