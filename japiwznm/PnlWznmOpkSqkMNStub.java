/**
  * \file PnlWznmOpkSqkMNStub.java
  * Java API code for job PnlWznmOpkSqkMNStub
...
public class PnlWznmOpkSqkMNStub {
	/**
		* VecVDo (full: VecVWznmOpkSqkMNStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpkSqkMNStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkSqkMNStub");
	...
	/**
	  * StatApp (full: StatAppWznmOpkSqkMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkSqkMNStub");
	...
	/**
	  * StatShr (full: StatShrWznmOpkSqkMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkSqkMNStub");
	...
	/**
	  * StgIac (full: StgIacWznmOpkSqkMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkSqkMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkSqkMNStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkSqkMNStub");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkSqkMNStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKSQKMNSTUBDATA, scrJref);
		...
		public QryWznmOpkSqkMNStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkSqkMNStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkSqkMNStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKSQKMNSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkSqkMNStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkSqkMNStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKSQKMNSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpkSqkMNStub();
			statappqry = (new QryWznmOpkSqkMNStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkSqkMNStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkSqkMNStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkSqkMNStub rst;
		public QryWznmOpkSqkMNStub.StatApp statappqry;
		public QryWznmOpkSqkMNStub.StatShr statshrqry;
		public QryWznmOpkSqkMNStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkSqkMNStubData");
