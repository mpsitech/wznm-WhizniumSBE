/**
  * \file PnlWznmUsgMNUser.java
  * Java API code for job PnlWznmUsgMNUser
...
public class PnlWznmUsgMNUser {
	/**
		* VecVDo (full: VecVWznmUsgMNUserDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmUsgMNUser)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsgMNUser");
	...
	/**
	  * StatApp (full: StatAppWznmUsgMNUser)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmUsgMNUser");
	...
	/**
	  * StatShr (full: StatShrWznmUsgMNUser)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsgMNUser");
	...
	/**
	  * StgIac (full: StgIacWznmUsgMNUser)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsgMNUser");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsgMNUser";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsgMNUser");
	...
	/**
		* DpchAppData (full: DpchAppWznmUsgMNUserData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGMNUSERDATA, scrJref);
		...
		public QryWznmUsgMNUser.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgMNUserData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsgMNUserDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSGMNUSERDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsgMNUserDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsgMNUserData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSGMNUSERDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQUsgMNUser();
			statappqry = (new QryWznmUsgMNUser()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsgMNUser()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsgMNUser()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsgMNUser rst;
		public QryWznmUsgMNUser.StatApp statappqry;
		public QryWznmUsgMNUser.StatShr statshrqry;
		public QryWznmUsgMNUser.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsgMNUserData");
