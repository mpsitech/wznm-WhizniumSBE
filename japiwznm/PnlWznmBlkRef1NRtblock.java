/**
  * \file PnlWznmBlkRef1NRtblock.java
  * Java API code for job PnlWznmBlkRef1NRtblock
...
public class PnlWznmBlkRef1NRtblock {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBlkRef1NRtblock");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmBlkRef1NRtblock");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmBlkRef1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmBlkRef1NRtblock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBlkRef1NRtblock");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBLKREF1NRTBLOCKDATA, scrJref);
		...
		public QryWznmBlkRef1NRtblock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBlkRef1NRtblockData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBLKREF1NRTBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBlkRef1NRtblockDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBLKREF1NRTBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQBlkRef1NRtblock();
			statappqry = (new QryWznmBlkRef1NRtblock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmBlkRef1NRtblock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmBlkRef1NRtblock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQBlkRef1NRtblock rst;
		public QryWznmBlkRef1NRtblock.StatApp statappqry;
		public QryWznmBlkRef1NRtblock.StatShr statshrqry;
		public QryWznmBlkRef1NRtblock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBlkRef1NRtblockData");
