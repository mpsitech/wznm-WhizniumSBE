/**
  * \file CrdWznmEvt.java
  * Java API code for job CrdWznmEvt
...
public class CrdWznmEvt {
	/**
		* VecVDo (full: VecVWznmEvtDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmEvt)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDEVT = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDEVT));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdEvt;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmEvt");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdEvt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdEvt", mask, MTXCRDEVT);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdEvt.equals(comp.MtxCrdEvt)) items.add(MTXCRDEVT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDEVT));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmEvt");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmEvt");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmEvt");
	...
	/**
		* DpchAppDo (full: DpchAppWznmEvtDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMEVTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmEvtDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmEvtData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMEVTDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmEvtData");
