/**
  * \file QryWznmVisRef1NFile.java
  * Java API code for job QryWznmVisRef1NFile
...
public class QryWznmVisRef1NFile {
	/**
	  * StatApp (full: StatAppQryWznmVisRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVisRef1NFile");

			String itemtag = "StatitemAppQryWznmVisRef1NFile";
	...
	/**
	  * StatShr (full: StatShrQryWznmVisRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVisRef1NFile");

			String itemtag = "StatitemShrQryWznmVisRef1NFile";
	...
	/**
	  * StgIac (full: StgIacQryWznmVisRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVisRef1NFile");

			String itemtag = "StgitemIacQryWznmVisRef1NFile";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVisRef1NFile";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacQryWznmVisRef1NFile";
