/**
  * \file PnlWznmSgeRec.java
  * Java API code for job PnlWznmSgeRec
...
public class PnlWznmSgeRec {
	/**
		* VecVDo (full: VecVWznmSgeRecDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSgeRec)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSgeRec");
	...
	/**
	  * StatApp (full: StatAppWznmSgeRec)
	  */
	public class StatApp extends Block {

		public static final int INITDONEDETAIL = 1;
		public static final int INITDONE1NSENSITIVITY = 2;
		public static final int INITDONESQKMNSTUB = 3;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NSENSITIVITY, INITDONESQKMNSTUB));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSgeRec");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONE1NSENSITIVITY, INITDONESQKMNSTUB));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * StatShr (full: StatShrWznmSgeRec)
	  */
	public class StatShr extends Block {
		...
		public static final int SCRJREFSQKMNSTUB = 4;
		public static final int PNLSQKMNSTUBAVAIL = 5;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NSENSITIVITY, SCRJREFSQKMNSTUB, PNLSQKMNSTUBAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSgeRec");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREF1NSENSITIVITY, SCRJREFSQKMNSTUB, PNLSQKMNSTUBAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSgeRec");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSgeRecDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSGERECDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSgeRecDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSgeRecData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSGERECDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSgeRecData");
