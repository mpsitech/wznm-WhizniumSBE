/**
  * \file PnlWznmMty1NMachine.java
  * Java API code for job PnlWznmMty1NMachine
...
public class PnlWznmMty1NMachine {
	/**
		* VecVDo (full: VecVWznmMty1NMachineDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMty1NMachine)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMty1NMachine");
	...
	/**
	  * StatApp (full: StatAppWznmMty1NMachine)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMty1NMachine");
	...
	/**
	  * StatShr (full: StatShrWznmMty1NMachine)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMty1NMachine");
	...
	/**
	  * StgIac (full: StgIacWznmMty1NMachine)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMty1NMachine");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMty1NMachine";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMty1NMachine");
	...
	/**
		* DpchAppData (full: DpchAppWznmMty1NMachineData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTY1NMACHINEDATA, scrJref);
		...
		public QryWznmMty1NMachine.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMty1NMachineData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMty1NMachineDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTY1NMACHINEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMty1NMachineDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMty1NMachineData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTY1NMACHINEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQMty1NMachine();
			statappqry = (new QryWznmMty1NMachine()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMty1NMachine()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMty1NMachine()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMty1NMachine rst;
		public QryWznmMty1NMachine.StatApp statappqry;
		public QryWznmMty1NMachine.StatShr statshrqry;
		public QryWznmMty1NMachine.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMty1NMachineData");
