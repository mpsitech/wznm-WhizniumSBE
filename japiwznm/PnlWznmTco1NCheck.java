/**
  * \file PnlWznmTco1NCheck.java
  * Java API code for job PnlWznmTco1NCheck
...
public class PnlWznmTco1NCheck {
	/**
		* VecVDo (full: VecVWznmTco1NCheckDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTco1NCheck)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTco1NCheck");
	...
	/**
	  * StatApp (full: StatAppWznmTco1NCheck)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTco1NCheck");
	...
	/**
	  * StatShr (full: StatShrWznmTco1NCheck)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTco1NCheck");
	...
	/**
	  * StgIac (full: StgIacWznmTco1NCheck)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTco1NCheck");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTco1NCheck";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTco1NCheck");
	...
	/**
		* DpchAppData (full: DpchAppWznmTco1NCheckData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NCHECKDATA, scrJref);
		...
		public QryWznmTco1NCheck.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NCheckData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTco1NCheckDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCO1NCHECKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTco1NCheckDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTco1NCheckData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCO1NCHECKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTco1NCheck();
			statappqry = (new QryWznmTco1NCheck()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTco1NCheck()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTco1NCheck()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTco1NCheck rst;
		public QryWznmTco1NCheck.StatApp statappqry;
		public QryWznmTco1NCheck.StatShr statshrqry;
		public QryWznmTco1NCheck.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTco1NCheckData");
