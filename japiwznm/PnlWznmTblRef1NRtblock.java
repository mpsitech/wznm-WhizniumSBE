/**
  * \file PnlWznmTblRef1NRtblock.java
  * Java API code for job PnlWznmTblRef1NRtblock
...
public class PnlWznmTblRef1NRtblock {
	/**
		* VecVDo (full: VecVWznmTblRef1NRtblockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblRef1NRtblock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblRef1NRtblock");
	...
	/**
	  * StatApp (full: StatAppWznmTblRef1NRtblock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblRef1NRtblock");
	...
	/**
	  * StgIac (full: StgIacWznmTblRef1NRtblock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblRef1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblRef1NRtblock";
	...
	/**
	  * Tag (full: TagWznmTblRef1NRtblock)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblRef1NRtblock");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblRef1NRtblockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NRTBLOCKDATA, scrJref);
		...
		public QryWznmTblRef1NRtblock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NRtblockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblRef1NRtblockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLREF1NRTBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblRef1NRtblockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblRef1NRtblockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLREF1NRTBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblRef1NRtblock();
			statappqry = (new QryWznmTblRef1NRtblock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblRef1NRtblock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblRef1NRtblock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblRef1NRtblock rst;
		public QryWznmTblRef1NRtblock.StatApp statappqry;
		public QryWznmTblRef1NRtblock.StatShr statshrqry;
		public QryWznmTblRef1NRtblock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblRef1NRtblockData");
