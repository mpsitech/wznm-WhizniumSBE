...
public class PnlWznmSbsRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONEFRS1NRELATION = 5;
		public static final int INITDONETOS1NRELATION = 6;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONE1NSTUB, INITDONE1NTABLECOL, INITDONEFRS1NRELATION, INITDONETOS1NRELATION, INITDONEPST1NQUERYMOD, INITDONEASBMNSUBSET, INITDONEBSBMNSUBSET));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONE1NSTUB, INITDONE1NTABLECOL, INITDONEFRS1NRELATION, INITDONETOS1NRELATION, INITDONEPST1NQUERYMOD, INITDONEASBMNSUBSET, INITDONEBSBMNSUBSET));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFFRS1NRELATION = 6;
		public static final int SCRJREFTOS1NRELATION = 7;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREF1NSTUB, SCRJREF1NTABLECOL, SCRJREFFRS1NRELATION, SCRJREFTOS1NRELATION, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFASBMNSUBSET, SCRJREFBSBMNSUBSET, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, SCRJREF1NSTUB, SCRJREF1NTABLECOL, SCRJREFFRS1NRELATION, SCRJREFTOS1NRELATION, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFASBMNSUBSET, SCRJREFBSBMNSUBSET, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
