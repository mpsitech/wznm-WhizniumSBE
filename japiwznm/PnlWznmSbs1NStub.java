/**
  * \file PnlWznmSbs1NStub.java
  * Java API code for job PnlWznmSbs1NStub
...
public class PnlWznmSbs1NStub {
	/**
		* VecVDo (full: VecVWznmSbs1NStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbs1NStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbs1NStub");
	...
	/**
	  * StatApp (full: StatAppWznmSbs1NStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbs1NStub");
	...
	/**
	  * StatShr (full: StatShrWznmSbs1NStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbs1NStub");
	...
	/**
	  * StgIac (full: StgIacWznmSbs1NStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbs1NStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbs1NStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbs1NStub");
	...
	/**
		* DpchAppData (full: DpchAppWznmSbs1NStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBS1NSTUBDATA, scrJref);
		...
		public QryWznmSbs1NStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbs1NStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbs1NStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBS1NSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbs1NStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbs1NStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBS1NSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSbs1NStub();
			statappqry = (new QryWznmSbs1NStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbs1NStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbs1NStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbs1NStub rst;
		public QryWznmSbs1NStub.StatApp statappqry;
		public QryWznmSbs1NStub.StatShr statshrqry;
		public QryWznmSbs1NStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbs1NStubData");
