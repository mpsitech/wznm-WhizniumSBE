/**
  * \file PnlWznmTblATitle.java
  * Java API code for job PnlWznmTblATitle
...
public class PnlWznmTblATitle {
	/**
		* VecVDo (full: VecVWznmTblATitleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblATitle)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblATitle");
	...
	/**
	  * StatApp (full: StatAppWznmTblATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblATitle");
	...
	/**
	  * StatShr (full: StatShrWznmTblATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblATitle");
	...
	/**
	  * StgIac (full: StgIacWznmTblATitle)
	  */
	public class StgIac extends Block {

		public static final int TCOTYPWIDTH = 1;
		public static final int TCOLOCWIDTH = 2;
		public static final int TCOGNDWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOLOCWIDTH, TCOGNDWIDTH, TCOTITWIDTH));
		};

		public int TcoTypWidth;
		public int TcoLocWidth;
		public int TcoGndWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblATitle");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoGndWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoGndWidth", mask, TCOGNDWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblATitle";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoGndWidth", TcoGndWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoGndWidth == comp.TcoGndWidth) items.add(TCOGNDWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOLOCWIDTH, TCOGNDWIDTH, TCOTITWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOLOC = 8;
		public static final int TCOGND = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOLOC, TCOGND, TCOTIT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblATitle");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoGnd = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoGnd", mask, TCOGND);
		...
		public HashSet<Integer> comm(
			...
			if (TcoGnd.equals(comp.TcoGnd)) items.add(TCOGND);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOLOC, TCOGND, TCOTIT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmTblATitleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLATITLEDATA, scrJref);
		...
		public QryWznmTblATitle.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblATitleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblATitleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLATITLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblATitleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblATitleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLATITLEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQTblATitle();
			statappqry = (new QryWznmTblATitle()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblATitle()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblATitle()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblATitle rst;
		public QryWznmTblATitle.StatApp statappqry;
		public QryWznmTblATitle.StatShr statshrqry;
		public QryWznmTblATitle.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblATitleData");
