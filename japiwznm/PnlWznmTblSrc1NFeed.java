/**
  * \file PnlWznmTblSrc1NFeed.java
  * Java API code for job PnlWznmTblSrc1NFeed
...
public class PnlWznmTblSrc1NFeed {
	/**
		* VecVDo (full: VecVWznmTblSrc1NFeedDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTblSrc1NFeed)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTblSrc1NFeed");
	...
	/**
	  * StatApp (full: StatAppWznmTblSrc1NFeed)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTblSrc1NFeed");
	...
	/**
	  * StatShr (full: StatShrWznmTblSrc1NFeed)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTblSrc1NFeed");
	...
	/**
	  * StgIac (full: StgIacWznmTblSrc1NFeed)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTblSrc1NFeed");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTblSrc1NFeed";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTblSrc1NFeed");
	...
	/**
		* DpchAppData (full: DpchAppWznmTblSrc1NFeedData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLSRC1NFEEDDATA, scrJref);
		...
		public QryWznmTblSrc1NFeed.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblSrc1NFeedData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTblSrc1NFeedDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTBLSRC1NFEEDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTblSrc1NFeedDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTblSrc1NFeedData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTBLSRC1NFEEDDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTblSrc1NFeed();
			statappqry = (new QryWznmTblSrc1NFeed()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTblSrc1NFeed()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTblSrc1NFeed()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTblSrc1NFeed rst;
		public QryWznmTblSrc1NFeed.StatApp statappqry;
		public QryWznmTblSrc1NFeed.StatShr statshrqry;
		public QryWznmTblSrc1NFeed.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTblSrc1NFeedData");
