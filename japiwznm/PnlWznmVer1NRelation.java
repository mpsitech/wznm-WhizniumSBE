/**
  * \file PnlWznmVer1NRelation.java
  * Java API code for job PnlWznmVer1NRelation
...
public class PnlWznmVer1NRelation {
	/**
		* VecVDo (full: VecVWznmVer1NRelationDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NRelation)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NRelation");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NRelation)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NRelation");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NRelation)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NRelation");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NRelation)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NRelation");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NRelation";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NRelation");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NRelationData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NRELATIONDATA, scrJref);
		...
		public QryWznmVer1NRelation.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NRelationData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NRelationDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NRELATIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NRelationDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NRelationData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NRELATIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NRelation();
			statappqry = (new QryWznmVer1NRelation()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NRelation()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NRelation()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NRelation rst;
		public QryWznmVer1NRelation.StatApp statappqry;
		public QryWznmVer1NRelation.StatShr statshrqry;
		public QryWznmVer1NRelation.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NRelationData");
