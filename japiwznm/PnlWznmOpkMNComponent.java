/**
  * \file PnlWznmOpkMNComponent.java
  * Java API code for job PnlWznmOpkMNComponent
...
public class PnlWznmOpkMNComponent {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkMNComponent");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkMNComponent");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkMNComponent");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkMNComponent");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkMNComponent";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkMNComponent");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNCOMPONENTDATA, scrJref);
		...
		public QryWznmOpkMNComponent.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNComponentData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNCOMPONENTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNComponentDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKMNCOMPONENTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpkMNComponent();
			statappqry = (new QryWznmOpkMNComponent()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkMNComponent()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkMNComponent()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkMNComponent rst;
		public QryWznmOpkMNComponent.StatApp statappqry;
		public QryWznmOpkMNComponent.StatShr statshrqry;
		public QryWznmOpkMNComponent.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkMNComponentData");
