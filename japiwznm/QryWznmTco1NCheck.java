/**
  * \file QryWznmTco1NCheck.java
  * Java API code for job QryWznmTco1NCheck
...
public class QryWznmTco1NCheck {
	/**
	  * StatApp (full: StatAppQryWznmTco1NCheck)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTco1NCheck");
	...
	/**
	  * StatShr (full: StatShrQryWznmTco1NCheck)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTco1NCheck");
	...
	/**
	  * StgIac (full: StgIacQryWznmTco1NCheck)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTco1NCheck");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTco1NCheck";
