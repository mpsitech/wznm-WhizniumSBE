/**
  * \file PnlWznmMchAPar.java
  * Java API code for job PnlWznmMchAPar
...
public class PnlWznmMchAPar {
	/**
		* VecVDo (full: VecVWznmMchAParDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMchAPar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMchAPar");
	...
	/**
	  * StatApp (full: StatAppWznmMchAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMchAPar");
	...
	/**
	  * StatShr (full: StatShrWznmMchAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMchAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMchAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMchAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMchAPar");
	...
	/**
		* DpchAppData (full: DpchAppWznmMchAParData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHAPARDATA, scrJref);
		...
		public QryWznmMchAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchAParData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMchAParDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCHAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMchAParDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMchAParData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMCHAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQMchAPar();
			statappqry = (new QryWznmMchAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMchAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMchAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMchAPar rst;
		public QryWznmMchAPar.StatApp statappqry;
		public QryWznmMchAPar.StatShr statshrqry;
		public QryWznmMchAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMchAParData");
