/**
  * \file PnlWznmPnlMNQuery.java
  * Java API code for job PnlWznmPnlMNQuery
...
public class PnlWznmPnlMNQuery {
	/**
		* VecVDo (full: VecVWznmPnlMNQueryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmPnlMNQuery)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPnlMNQuery");

			String itemtag = "ContitemInfWznmPnlMNQuery";
	...
	/**
	  * StatApp (full: StatAppWznmPnlMNQuery)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPnlMNQuery");

			String itemtag = "StatitemAppWznmPnlMNQuery";
	...
	/**
	  * StatShr (full: StatShrWznmPnlMNQuery)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPnlMNQuery");

			String itemtag = "StatitemShrWznmPnlMNQuery";
	...
	/**
	  * StgIac (full: StgIacWznmPnlMNQuery)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPnlMNQuery");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPnlMNQuery";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPnlMNQuery");

			String itemtag = "TagitemWznmPnlMNQuery";
	...
	/**
		* DpchAppData (full: DpchAppWznmPnlMNQueryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPNLMNQUERYDATA, scrJref);
		...
		public QryWznmPnlMNQuery.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPnlMNQueryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmPnlMNQueryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPNLMNQUERYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPnlMNQueryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmPnlMNQueryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPNLMNQUERYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQPnlMNQuery();
			statappqry = (new QryWznmPnlMNQuery()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPnlMNQuery()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPnlMNQuery()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPnlMNQuery rst;
		public QryWznmPnlMNQuery.StatApp statappqry;
		public QryWznmPnlMNQuery.StatShr statshrqry;
		public QryWznmPnlMNQuery.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPnlMNQueryData");
