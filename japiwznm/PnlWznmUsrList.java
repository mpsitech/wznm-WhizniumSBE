/**
  * \file PnlWznmUsrList.java
  * Java API code for job PnlWznmUsrList
...
public class PnlWznmUsrList {
	/**
		* VecVDo (full: VecVWznmUsrListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmUsrList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmUsrList";
	...
	/**
	  * ContInf (full: ContInfWznmUsrList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsrList");
	...
	/**
	  * StatShr (full: StatShrWznmUsrList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsrList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsrList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsrList");
	...
	/**
		* DpchAppData (full: DpchAppWznmUsrListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRLISTDATA, scrJref);
		...
		public QryWznmUsrList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsrListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsrListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSRLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQUsrList();
			statappqry = (new QryWznmUsrList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsrList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsrList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsrList rst;
		public QryWznmUsrList.StatApp statappqry;
		public QryWznmUsrList.StatShr statshrqry;
		public QryWznmUsrList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsrListData");
