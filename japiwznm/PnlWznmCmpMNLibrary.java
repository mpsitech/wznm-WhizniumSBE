/**
  * \file PnlWznmCmpMNLibrary.java
  * Java API code for job PnlWznmCmpMNLibrary
...
public class PnlWznmCmpMNLibrary {
	/**
		* VecVDo (full: VecVWznmCmpMNLibraryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCmpMNLibrary)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCmpMNLibrary");
	...
	/**
	  * StatApp (full: StatAppWznmCmpMNLibrary)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCmpMNLibrary");
	...
	/**
	  * StatShr (full: StatShrWznmCmpMNLibrary)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCmpMNLibrary");
	...
	/**
	  * StgIac (full: StgIacWznmCmpMNLibrary)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCmpMNLibrary");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCmpMNLibrary";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCmpMNLibrary");
	...
	/**
		* DpchAppData (full: DpchAppWznmCmpMNLibraryData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPMNLIBRARYDATA, scrJref);
		...
		public QryWznmCmpMNLibrary.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpMNLibraryData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCmpMNLibraryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCMPMNLIBRARYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCmpMNLibraryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCmpMNLibraryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCMPMNLIBRARYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCmpMNLibrary();
			statappqry = (new QryWznmCmpMNLibrary()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCmpMNLibrary()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCmpMNLibrary()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCmpMNLibrary rst;
		public QryWznmCmpMNLibrary.StatApp statappqry;
		public QryWznmCmpMNLibrary.StatShr statshrqry;
		public QryWznmCmpMNLibrary.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCmpMNLibraryData");
