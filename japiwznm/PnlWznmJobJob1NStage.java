/**
  * \file PnlWznmJobJob1NStage.java
  * Java API code for job PnlWznmJobJob1NStage
...
public class PnlWznmJobJob1NStage {
	/**
		* VecVDo (full: VecVWznmJobJob1NStageDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmJobJob1NStage)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmJobJob1NStage");
	...
	/**
	  * StatApp (full: StatAppWznmJobJob1NStage)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmJobJob1NStage");
	...
	/**
	  * StatShr (full: StatShrWznmJobJob1NStage)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmJobJob1NStage");
	...
	/**
	  * StgIac (full: StgIacWznmJobJob1NStage)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmJobJob1NStage");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmJobJob1NStage";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmJobJob1NStage");
	...
	/**
		* DpchAppData (full: DpchAppWznmJobJob1NStageData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBJOB1NSTAGEDATA, scrJref);
		...
		public QryWznmJobJob1NStage.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobJob1NStageData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmJobJob1NStageDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMJOBJOB1NSTAGEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmJobJob1NStageDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmJobJob1NStageData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMJOBJOB1NSTAGEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQJobJob1NStage();
			statappqry = (new QryWznmJobJob1NStage()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmJobJob1NStage()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmJobJob1NStage()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQJobJob1NStage rst;
		public QryWznmJobJob1NStage.StatApp statappqry;
		public QryWznmJobJob1NStage.StatShr statshrqry;
		public QryWznmJobJob1NStage.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmJobJob1NStageData");
