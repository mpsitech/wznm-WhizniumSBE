/**
  * \file PnlWznmVisVis1NSheet.java
  * Java API code for job PnlWznmVisVis1NSheet
...
public class PnlWznmVisVis1NSheet {
	/**
		* VecVDo (full: VecVWznmVisVis1NSheetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVisVis1NSheet)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVisVis1NSheet");

			String itemtag = "ContitemInfWznmVisVis1NSheet";
	...
	/**
	  * StatApp (full: StatAppWznmVisVis1NSheet)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVisVis1NSheet");

			String itemtag = "StatitemAppWznmVisVis1NSheet";
	...
	/**
	  * StatShr (full: StatShrWznmVisVis1NSheet)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVisVis1NSheet");

			String itemtag = "StatitemShrWznmVisVis1NSheet";
	...
	/**
	  * StgIac (full: StgIacWznmVisVis1NSheet)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVisVis1NSheet");

			String itemtag = "StgitemIacWznmVisVis1NSheet";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVisVis1NSheet";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmVisVis1NSheet";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVisVis1NSheet");

			String itemtag = "TagitemWznmVisVis1NSheet";
	...
	/**
		* DpchAppData (full: DpchAppWznmVisVis1NSheetData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					String scrJref
					, StgIac stgiac
					, QryWznmVisVis1NSheet.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMVISVIS1NSHEETDATA, scrJref);
		...
		public QryWznmVisVis1NSheet.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisVis1NSheetData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVisVis1NSheetDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVISVIS1NSHEETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisVis1NSheetDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVisVis1NSheetData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVISVIS1NSHEETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVisVis1NSheet();
			statappqry = (new QryWznmVisVis1NSheet()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVisVis1NSheet()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVisVis1NSheet()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVisVis1NSheet rst;
		public QryWznmVisVis1NSheet.StatApp statappqry;
		public QryWznmVisVis1NSheet.StatShr statshrqry;
		public QryWznmVisVis1NSheet.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVisVis1NSheetData");
