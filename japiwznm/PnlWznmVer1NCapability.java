/**
  * \file PnlWznmVer1NCapability.java
  * Java API code for job PnlWznmVer1NCapability
...
public class PnlWznmVer1NCapability {
	/**
		* VecVDo (full: VecVWznmVer1NCapabilityDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NCapability)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NCapability");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NCapability)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NCapability");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NCapability)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NCapability");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NCapability)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NCapability");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NCapability";
	...
	/**
	  * Tag (full: TagWznmVer1NCapability)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NCapability");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NCapabilityData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCAPABILITYDATA, scrJref);
		...
		public QryWznmVer1NCapability.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NCapabilityData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NCapabilityDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NCAPABILITYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NCapabilityDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NCapabilityData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NCAPABILITYDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NCapability();
			statappqry = (new QryWznmVer1NCapability()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NCapability()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NCapability()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NCapability rst;
		public QryWznmVer1NCapability.StatApp statappqry;
		public QryWznmVer1NCapability.StatShr statshrqry;
		public QryWznmVer1NCapability.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NCapabilityData");
