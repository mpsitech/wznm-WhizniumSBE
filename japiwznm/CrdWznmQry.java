/**
  * \file CrdWznmQry.java
  * Java API code for job CrdWznmQry
...
public class CrdWznmQry {
	/**
		* VecVDo (full: VecVWznmQryDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmQry)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDQRY = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQRY));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdQry;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQry");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdQry = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdQry", mask, MTXCRDQRY);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdQry.equals(comp.MtxCrdQry)) items.add(MTXCRDQRY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDQRY));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQry");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQry");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQry");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQryDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQryData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryData");
