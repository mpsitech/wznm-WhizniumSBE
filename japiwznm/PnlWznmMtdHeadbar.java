/**
  * \file PnlWznmMtdHeadbar.java
  * Java API code for job PnlWznmMtdHeadbar
...
public class PnlWznmMtdHeadbar {
	/**
	  * StgInf (full: StgInfWznmMtdHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmMtdHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMtdHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmMtdHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTDHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtdHeadbarData");
