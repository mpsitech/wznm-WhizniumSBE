/**
  * \file CrdWznmCtp.java
  * Java API code for job CrdWznmCtp
...
public class CrdWznmCtp {
	/**
		* VecVDo (full: VecVWznmCtpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCtp)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDCTP = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDCTP));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdCtp;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCtp");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdCtp = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdCtp", mask, MTXCRDCTP);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdCtp.equals(comp.MtxCrdCtp)) items.add(MTXCRDCTP);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDCTP));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCtp");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCtp");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCtp");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCtpDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCTPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCtpDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCtpData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCTPDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCtpData");
