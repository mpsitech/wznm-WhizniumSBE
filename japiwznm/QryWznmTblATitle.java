/**
  * \file QryWznmTblATitle.java
  * Java API code for job QryWznmTblATitle
...
public class QryWznmTblATitle {
	/**
	  * StatApp (full: StatAppQryWznmTblATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblATitle");
	...
	/**
	  * StatShr (full: StatShrQryWznmTblATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblATitle");
	...
	/**
	  * StgIac (full: StgIacQryWznmTblATitle)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblATitle");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblATitle";
