/**
  * \file QryWznmVer1NImpexpcplx.java
  * Java API code for job QryWznmVer1NImpexpcplx
...
public class QryWznmVer1NImpexpcplx {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVer1NImpexpcplx");

			String itemtag = "StatitemAppQryWznmVer1NImpexpcplx";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVer1NImpexpcplx");

			String itemtag = "StatitemShrQryWznmVer1NImpexpcplx";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVer1NImpexpcplx");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVer1NImpexpcplx";
