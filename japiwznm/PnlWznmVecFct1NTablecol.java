/**
  * \file PnlWznmVecFct1NTablecol.java
  * Java API code for job PnlWznmVecFct1NTablecol
...
public class PnlWznmVecFct1NTablecol {
	/**
		* VecVDo (full: VecVWznmVecFct1NTablecolDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVecFct1NTablecol)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecFct1NTablecol");
	...
	/**
	  * StatApp (full: StatAppWznmVecFct1NTablecol)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecFct1NTablecol");
	...
	/**
	  * StatShr (full: StatShrWznmVecFct1NTablecol)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecFct1NTablecol");
	...
	/**
	  * StgIac (full: StgIacWznmVecFct1NTablecol)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecFct1NTablecol");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecFct1NTablecol";
	...
	/**
	  * Tag (full: TagWznmVecFct1NTablecol)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecFct1NTablecol");
	...
	/**
		* DpchAppData (full: DpchAppWznmVecFct1NTablecolData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECFCT1NTABLECOLDATA, scrJref);
		...
		public QryWznmVecFct1NTablecol.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecFct1NTablecolData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecFct1NTablecolDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECFCT1NTABLECOLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecFct1NTablecolDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecFct1NTablecolData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECFCT1NTABLECOLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVecFct1NTablecol();
			statappqry = (new QryWznmVecFct1NTablecol()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecFct1NTablecol()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecFct1NTablecol()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecFct1NTablecol rst;
		public QryWznmVecFct1NTablecol.StatApp statappqry;
		public QryWznmVecFct1NTablecol.StatShr statshrqry;
		public QryWznmVecFct1NTablecol.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecFct1NTablecolData");
