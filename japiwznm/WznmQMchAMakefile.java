/**
	...
	* Java API code for record of table TblWznmQMchAMakefile
...
public class WznmQMchAMakefile {
	
	public WznmQMchAMakefile(
				int jnum
				, String x1SrefKTag
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQMchAMakefile");
