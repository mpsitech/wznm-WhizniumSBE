/**
  * \file PnlWznmPnlHeadbar.java
  * Java API code for job PnlWznmPnlHeadbar
...
public class PnlWznmPnlHeadbar {
	/**
	  * StgInf (full: StgInfWznmPnlHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmPnlHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPnlHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmPnlHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPNLHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPnlHeadbarData");
