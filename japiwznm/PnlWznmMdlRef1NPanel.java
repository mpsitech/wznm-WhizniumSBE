/**
  * \file PnlWznmMdlRef1NPanel.java
  * Java API code for job PnlWznmMdlRef1NPanel
...
public class PnlWznmMdlRef1NPanel {
	/**
		* VecVDo (full: VecVWznmMdlRef1NPanelDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMdlRef1NPanel)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMdlRef1NPanel");
	...
	/**
	  * StatApp (full: StatAppWznmMdlRef1NPanel)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMdlRef1NPanel");
	...
	/**
	  * StatShr (full: StatShrWznmMdlRef1NPanel)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMdlRef1NPanel");
	...
	/**
	  * StgIac (full: StgIacWznmMdlRef1NPanel)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMdlRef1NPanel");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMdlRef1NPanel";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMdlRef1NPanel");
	...
	/**
		* DpchAppData (full: DpchAppWznmMdlRef1NPanelData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLREF1NPANELDATA, scrJref);
		...
		public QryWznmMdlRef1NPanel.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlRef1NPanelData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMdlRef1NPanelDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLREF1NPANELDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlRef1NPanelDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMdlRef1NPanelData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMDLREF1NPANELDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQMdlRef1NPanel();
			statappqry = (new QryWznmMdlRef1NPanel()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMdlRef1NPanel()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMdlRef1NPanel()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMdlRef1NPanel rst;
		public QryWznmMdlRef1NPanel.StatApp statappqry;
		public QryWznmMdlRef1NPanel.StatShr statshrqry;
		public QryWznmMdlRef1NPanel.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMdlRef1NPanelData");
