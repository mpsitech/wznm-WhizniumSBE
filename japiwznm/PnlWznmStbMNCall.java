/**
  * \file PnlWznmStbMNCall.java
  * Java API code for job PnlWznmStbMNCall
...
public class PnlWznmStbMNCall {
	/**
		* VecVDo (full: VecVWznmStbMNCallDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmStbMNCall)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmStbMNCall");
	...
	/**
	  * StatApp (full: StatAppWznmStbMNCall)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmStbMNCall");
	...
	/**
	  * StatShr (full: StatShrWznmStbMNCall)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmStbMNCall");
	...
	/**
	  * StgIac (full: StgIacWznmStbMNCall)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmStbMNCall");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmStbMNCall";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmStbMNCall");
	...
	/**
		* DpchAppData (full: DpchAppWznmStbMNCallData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBMNCALLDATA, scrJref);
		...
		public QryWznmStbMNCall.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbMNCallData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmStbMNCallDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBMNCALLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbMNCallDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmStbMNCallData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSTBMNCALLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQStbMNCall();
			statappqry = (new QryWznmStbMNCall()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmStbMNCall()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmStbMNCall()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQStbMNCall rst;
		public QryWznmStbMNCall.StatApp statappqry;
		public QryWznmStbMNCall.StatShr statshrqry;
		public QryWznmStbMNCall.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmStbMNCallData");
