...
public class PnlWznmPrsADetail {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPrsADetail");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPrsADetail");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPrsADetail");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPrsADetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPrsADetail";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPrsADetail");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRSADETAILDATA, scrJref);
		...
		public QryWznmPrsADetail.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrsADetailData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPRSADETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPrsADetailDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPRSADETAILDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQPrsADetail();
			statappqry = (new QryWznmPrsADetail()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPrsADetail()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPrsADetail()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPrsADetail rst;
		public QryWznmPrsADetail.StatApp statappqry;
		public QryWznmPrsADetail.StatShr statshrqry;
		public QryWznmPrsADetail.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPrsADetailData");
