/**
  * \file PnlWznmDlgHeadbar.java
  * Java API code for job PnlWznmDlgHeadbar
...
public class PnlWznmDlgHeadbar {
	/**
	  * StgInf (full: StgInfWznmDlgHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmDlgHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmDlgHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmDlgHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMDLGHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmDlgHeadbarData");
