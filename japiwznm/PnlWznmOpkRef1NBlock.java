/**
  * \file PnlWznmOpkRef1NBlock.java
  * Java API code for job PnlWznmOpkRef1NBlock
...
public class PnlWznmOpkRef1NBlock {
	/**
		* VecVDo (full: VecVWznmOpkRef1NBlockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpkRef1NBlock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkRef1NBlock");
	...
	/**
	  * StatApp (full: StatAppWznmOpkRef1NBlock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkRef1NBlock");
	...
	/**
	  * StatShr (full: StatShrWznmOpkRef1NBlock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkRef1NBlock");
	...
	/**
	  * StgIac (full: StgIacWznmOpkRef1NBlock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkRef1NBlock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkRef1NBlock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkRef1NBlock");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkRef1NBlockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKREF1NBLOCKDATA, scrJref);
		...
		public QryWznmOpkRef1NBlock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkRef1NBlockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkRef1NBlockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKREF1NBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkRef1NBlockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkRef1NBlockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKREF1NBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpkRef1NBlock();
			statappqry = (new QryWznmOpkRef1NBlock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkRef1NBlock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkRef1NBlock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkRef1NBlock rst;
		public QryWznmOpkRef1NBlock.StatApp statappqry;
		public QryWznmOpkRef1NBlock.StatShr statshrqry;
		public QryWznmOpkRef1NBlock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkRef1NBlockData");
