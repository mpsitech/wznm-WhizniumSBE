/**
	...
	* Java API code for record of table TblWznmQOpxARetval
...
public class WznmQOpxARetval {
	
	public WznmQOpxARetval(
				int jnum
				, String sref
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQOpxARetval");
