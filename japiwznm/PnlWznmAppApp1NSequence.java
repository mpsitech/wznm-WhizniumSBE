/**
  * \file PnlWznmAppApp1NSequence.java
  * Java API code for job PnlWznmAppApp1NSequence
...
public class PnlWznmAppApp1NSequence {
	/**
		* VecVDo (full: VecVWznmAppApp1NSequenceDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmAppApp1NSequence)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmAppApp1NSequence");
	...
	/**
	  * StatApp (full: StatAppWznmAppApp1NSequence)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmAppApp1NSequence");
	...
	/**
	  * StatShr (full: StatShrWznmAppApp1NSequence)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmAppApp1NSequence");
	...
	/**
	  * StgIac (full: StgIacWznmAppApp1NSequence)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmAppApp1NSequence");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmAppApp1NSequence";
	...
	/**
	  * Tag (full: TagWznmAppApp1NSequence)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmAppApp1NSequence");
	...
	/**
		* DpchAppData (full: DpchAppWznmAppApp1NSequenceData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPPAPP1NSEQUENCEDATA, scrJref);
		...
		public QryWznmAppApp1NSequence.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmAppApp1NSequenceData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmAppApp1NSequenceDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPPAPP1NSEQUENCEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmAppApp1NSequenceDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmAppApp1NSequenceData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMAPPAPP1NSEQUENCEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQAppApp1NSequence();
			statappqry = (new QryWznmAppApp1NSequence()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmAppApp1NSequence()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmAppApp1NSequence()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQAppApp1NSequence rst;
		public QryWznmAppApp1NSequence.StatApp statappqry;
		public QryWznmAppApp1NSequence.StatShr statshrqry;
		public QryWznmAppApp1NSequence.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmAppApp1NSequenceData");
