/**
  * \file PnlWznmPrjHeadbar.java
  * Java API code for job PnlWznmPrjHeadbar
...
public class PnlWznmPrjHeadbar {
	/**
	  * StgInf (full: StgInfWznmPrjHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmPrjHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPrjHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmPrjHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPRJHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPrjHeadbarData");
