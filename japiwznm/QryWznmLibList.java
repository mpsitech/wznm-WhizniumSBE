/**
  * \file QryWznmLibList.java
  * Java API code for job QryWznmLibList
...
public class QryWznmLibList {
	/**
		* VecVOrd (full: VecVQryWznmLibListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWznmLibList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmLibList");
	...
	/**
	  * StatShr (full: StatShrQryWznmLibList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmLibList");
	...
	/**
	  * StgIac (full: StgIacQryWznmLibList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmLibList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmLibList";
