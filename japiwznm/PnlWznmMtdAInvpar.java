/**
  * \file PnlWznmMtdAInvpar.java
  * Java API code for job PnlWznmMtdAInvpar
...
public class PnlWznmMtdAInvpar {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMtdAInvpar");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMtdAInvpar");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMtdAInvpar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMtdAInvpar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMtdAInvpar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMtdAInvpar");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDAINVPARDATA, scrJref);
		...
		public QryWznmMtdAInvpar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdAInvparData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDAINVPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdAInvparDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTDAINVPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQMtdAInvpar();
			statappqry = (new QryWznmMtdAInvpar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMtdAInvpar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMtdAInvpar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMtdAInvpar rst;
		public QryWznmMtdAInvpar.StatApp statappqry;
		public QryWznmMtdAInvpar.StatShr statshrqry;
		public QryWznmMtdAInvpar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtdAInvparData");
