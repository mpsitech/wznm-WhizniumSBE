/**
  * \file PnlWznmVecList.java
  * Java API code for job PnlWznmVecList
...
public class PnlWznmVecList {
	/**
		* VecVDo (full: VecVWznmVecListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmVecList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmVecList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmVecList";
	...
	/**
	  * ContInf (full: ContInfWznmVecList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecList");
	...
	/**
	  * StatShr (full: StatShrWznmVecList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOTGRWIDTH = 6;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOHKTWIDTH, TCOHKUWIDTH, TCOTGRWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTgrWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTgrWidth", mask, TCOTGRWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoTgrWidth", TcoTgrWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoTgrWidth == comp.TcoTgrWidth) items.add(TCOTGRWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOHKTWIDTH, TCOHKUWIDTH, TCOTGRWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTGR = 13;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCOHKT, TCOHKU, TCOTGR));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoTgr = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoTgr", mask, TCOTGR);
		...
		public HashSet<Integer> comm(
			...
			if (TcoTgr.equals(comp.TcoTgr)) items.add(TCOTGR);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOTYP, TCOVER, TCOHKT, TCOHKU, TCOTGR));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmVecListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECLISTDATA, scrJref);
		...
		public QryWznmVecList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQVecList();
			statappqry = (new QryWznmVecList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecList rst;
		public QryWznmVecList.StatApp statappqry;
		public QryWznmVecList.StatShr statshrqry;
		public QryWznmVecList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecListData");
