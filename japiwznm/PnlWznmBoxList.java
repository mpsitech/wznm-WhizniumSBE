/**
  * \file PnlWznmBoxList.java
  * Java API code for job PnlWznmBoxList
...
public class PnlWznmBoxList {
	/**
		* VecVDo (full: VecVWznmBoxListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmBoxList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmBoxList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmBoxList";
	...
	/**
	  * ContInf (full: ContInfWznmBoxList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBoxList");

			String itemtag = "ContitemInfWznmBoxList";
	...
	/**
	  * StatShr (full: StatShrWznmBoxList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBoxList");

			String itemtag = "StatitemShrWznmBoxList";
	...
	/**
	  * StgIac (full: StgIacWznmBoxList)
	  */
	public class StgIac extends Block {

		public static final int TCOSHTWIDTH = 1;
		public static final int TCOMTBWIDTH = 2;
		public static final int TCOUNVWIDTH = 3;
		...
		public StgIac(
			...
			this.TcoShtWidth = TcoShtWidth;
			this.TcoMtbWidth = TcoMtbWidth;
			this.TcoUnvWidth = TcoUnvWidth;

			mask = new HashSet<Integer>(Arrays.asList(TCOSHTWIDTH, TCOMTBWIDTH, TCOUNVWIDTH));
		};

		public int TcoShtWidth;
		public int TcoMtbWidth;
		public int TcoUnvWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmBoxList");

			String itemtag = "StgitemIacWznmBoxList";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoShtWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoShtWidth", mask, TCOSHTWIDTH);
				TcoMtbWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoMtbWidth", mask, TCOMTBWIDTH);
				TcoUnvWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoUnvWidth", mask, TCOUNVWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmBoxList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoShtWidth", TcoShtWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoMtbWidth", TcoMtbWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoUnvWidth", TcoUnvWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoShtWidth == comp.TcoShtWidth) items.add(TCOSHTWIDTH);
			if (TcoMtbWidth == comp.TcoMtbWidth) items.add(TCOMTBWIDTH);
			if (TcoUnvWidth == comp.TcoUnvWidth) items.add(TCOUNVWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSHTWIDTH, TCOMTBWIDTH, TCOUNVWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSHT = 8;
		public static final int TCOMTB = 9;
		public static final int TCOUNV = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSHT, TCOMTB, TCOUNV));
		};
		...
		public String TcoSht;
		public String TcoMtb;
		public String TcoUnv;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBoxList");

			String itemtag = "TagitemWznmBoxList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoSht = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSht", mask, TCOSHT);
				TcoMtb = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoMtb", mask, TCOMTB);
				TcoUnv = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoUnv", mask, TCOUNV);
		...
		public HashSet<Integer> comm(
			...
			if (TcoSht.equals(comp.TcoSht)) items.add(TCOSHT);
			if (TcoMtb.equals(comp.TcoMtb)) items.add(TCOMTB);
			if (TcoUnv.equals(comp.TcoUnv)) items.add(TCOUNV);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSHT, TCOMTB, TCOUNV));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmBoxListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXLISTDATA, scrJref);
		...
		public QryWznmBoxList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmBoxListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBoxListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBOXLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQBoxList();
			statappqry = (new QryWznmBoxList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmBoxList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmBoxList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQBoxList rst;
		public QryWznmBoxList.StatApp statappqry;
		public QryWznmBoxList.StatShr statshrqry;
		public QryWznmBoxList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBoxListData");
