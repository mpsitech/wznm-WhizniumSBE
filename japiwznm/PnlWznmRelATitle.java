/**
  * \file PnlWznmRelATitle.java
  * Java API code for job PnlWznmRelATitle
...
public class PnlWznmRelATitle {
	/**
		* VecVDo (full: VecVWznmRelATitleDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRelATitle)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelATitle");

			String itemtag = "ContitemInfWznmRelATitle";
	...
	/**
	  * StatApp (full: StatAppWznmRelATitle)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRelATitle");

			String itemtag = "StatitemAppWznmRelATitle";
	...
	/**
	  * StatShr (full: StatShrWznmRelATitle)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelATitle");

			String itemtag = "StatitemShrWznmRelATitle";
	...
	/**
	  * StgIac (full: StgIacWznmRelATitle)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelATitle");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelATitle";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelATitle");

			String itemtag = "TagitemWznmRelATitle";
	...
	/**
		* DpchAppData (full: DpchAppWznmRelATitleData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELATITLEDATA, scrJref);
		...
		public QryWznmRelATitle.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelATitleData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRelATitleDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELATITLEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelATitleDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRelATitleData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELATITLEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQRelATitle();
			statappqry = (new QryWznmRelATitle()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelATitle()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelATitle()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelATitle rst;
		public QryWznmRelATitle.StatApp statappqry;
		public QryWznmRelATitle.StatShr statshrqry;
		public QryWznmRelATitle.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelATitleData");
