/**
  * \file PnlWznmOpxList.java
  * Java API code for job PnlWznmOpxList
...
public class PnlWznmOpxList {
	/**
		* VecVDo (full: VecVWznmOpxListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmOpxList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmOpxList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmOpxList";
	...
	/**
	  * ContInf (full: ContInfWznmOpxList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpxList");

			String itemtag = "ContitemInfWznmOpxList";
	...
	/**
	  * StatShr (full: StatShrWznmOpxList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpxList");

			String itemtag = "StatitemShrWznmOpxList";
	...
	/**
	  * StgIac (full: StgIacWznmOpxList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOOPKWIDTH = 2;
		public static final int TCOSHDWIDTH = 3;
		...
		public StgIac(
			...
			this.TcoOpkWidth = TcoOpkWidth;
			this.TcoShdWidth = TcoShdWidth;

			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOOPKWIDTH, TCOSHDWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoOpkWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpxList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoOpkWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoOpkWidth", mask, TCOOPKWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpxList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoOpkWidth", TcoOpkWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoOpkWidth == comp.TcoOpkWidth) items.add(TCOOPKWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOOPKWIDTH, TCOSHDWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOOPK = 9;
		public static final int TCOSHD = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOOPK, TCOSHD));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpxList");

			String itemtag = "TagitemWznmOpxList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoOpk = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoOpk", mask, TCOOPK);
		...
		public HashSet<Integer> comm(
			...
			if (TcoOpk.equals(comp.TcoOpk)) items.add(TCOOPK);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOOPK, TCOSHD));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmOpxListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXLISTDATA, scrJref);
		...
		public QryWznmOpxList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpxListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPXLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpxListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpxListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPXLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQOpxList();
			statappqry = (new QryWznmOpxList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpxList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpxList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpxList rst;
		public QryWznmOpxList.StatApp statappqry;
		public QryWznmOpxList.StatShr statshrqry;
		public QryWznmOpxList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpxListData");
