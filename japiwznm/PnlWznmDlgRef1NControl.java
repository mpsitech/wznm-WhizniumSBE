/**
  * \file PnlWznmDlgRef1NControl.java
  * Java API code for job PnlWznmDlgRef1NControl
...
public class PnlWznmDlgRef1NControl {
	/**
		* VecVDo (full: VecVWznmDlgRef1NControlDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmDlgRef1NControl)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmDlgRef1NControl");

			String itemtag = "ContitemInfWznmDlgRef1NControl";
	...
	/**
	  * StatApp (full: StatAppWznmDlgRef1NControl)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmDlgRef1NControl");

			String itemtag = "StatitemAppWznmDlgRef1NControl";
	...
	/**
	  * StatShr (full: StatShrWznmDlgRef1NControl)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmDlgRef1NControl");

			String itemtag = "StatitemShrWznmDlgRef1NControl";
	...
	/**
	  * StgIac (full: StgIacWznmDlgRef1NControl)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmDlgRef1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmDlgRef1NControl";
	...
	/**
	  * Tag (full: TagWznmDlgRef1NControl)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmDlgRef1NControl");

			String itemtag = "TagitemWznmDlgRef1NControl";
	...
	/**
		* DpchAppData (full: DpchAppWznmDlgRef1NControlData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGREF1NCONTROLDATA, scrJref);
		...
		public QryWznmDlgRef1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgRef1NControlData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmDlgRef1NControlDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMDLGREF1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmDlgRef1NControlDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmDlgRef1NControlData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMDLGREF1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQDlgRef1NControl();
			statappqry = (new QryWznmDlgRef1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmDlgRef1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmDlgRef1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQDlgRef1NControl rst;
		public QryWznmDlgRef1NControl.StatApp statappqry;
		public QryWznmDlgRef1NControl.StatShr statshrqry;
		public QryWznmDlgRef1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmDlgRef1NControlData");
