/**
  * \file PnlWznmSbsBsbMNSubset.java
  * Java API code for job PnlWznmSbsBsbMNSubset
...
public class PnlWznmSbsBsbMNSubset {
	/**
		* VecVDo (full: VecVWznmSbsBsbMNSubsetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSbsBsbMNSubset)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSbsBsbMNSubset");
	...
	/**
	  * StatApp (full: StatAppWznmSbsBsbMNSubset)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSbsBsbMNSubset");
	...
	/**
	  * StatShr (full: StatShrWznmSbsBsbMNSubset)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSbsBsbMNSubset");
	...
	/**
	  * StgIac (full: StgIacWznmSbsBsbMNSubset)
	  */
	public class StgIac extends Block {

		public static final int TCOMREFWIDTH = 1;
		public static final int TCORTYWIDTH = 2;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCORTYWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSbsBsbMNSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSbsBsbMNSubset";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCORTYWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
	  * Tag (full: TagWznmSbsBsbMNSubset)
	  */
	public class Tag extends Block {
		...
		public static final int TCORTY = 8;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCORTY));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSbsBsbMNSubset");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCORTY));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmSbsBsbMNSubsetData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSBSBMNSUBSETDATA, scrJref);
		...
		public QryWznmSbsBsbMNSubset.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsBsbMNSubsetData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSbsBsbMNSubsetDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSBSBSBMNSUBSETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSbsBsbMNSubsetDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSbsBsbMNSubsetData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSBSBSBMNSUBSETDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQSbsBsbMNSubset();
			statappqry = (new QryWznmSbsBsbMNSubset()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSbsBsbMNSubset()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSbsBsbMNSubset()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSbsBsbMNSubset rst;
		public QryWznmSbsBsbMNSubset.StatApp statappqry;
		public QryWznmSbsBsbMNSubset.StatShr statshrqry;
		public QryWznmSbsBsbMNSubset.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSbsBsbMNSubsetData");
