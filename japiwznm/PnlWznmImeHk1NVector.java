/**
  * \file PnlWznmImeHk1NVector.java
  * Java API code for job PnlWznmImeHk1NVector
...
public class PnlWznmImeHk1NVector {
	/**
		* VecVDo (full: VecVWznmImeHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmImeHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmImeHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWznmImeHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmImeHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWznmImeHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmImeHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWznmImeHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmImeHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmImeHk1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmImeHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWznmImeHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMEHK1NVECTORDATA, scrJref);
		...
		public QryWznmImeHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmImeHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIMEHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmImeHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmImeHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIMEHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQImeHk1NVector();
			statappqry = (new QryWznmImeHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmImeHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmImeHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQImeHk1NVector rst;
		public QryWznmImeHk1NVector.StatApp statappqry;
		public QryWznmImeHk1NVector.StatShr statshrqry;
		public QryWznmImeHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmImeHk1NVectorData");
