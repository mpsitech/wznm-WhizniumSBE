/**
  * \file PnlWznmTcoRef1NQuerymod.java
  * Java API code for job PnlWznmTcoRef1NQuerymod
...
public class PnlWznmTcoRef1NQuerymod {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTcoRef1NQuerymod");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTcoRef1NQuerymod");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTcoRef1NQuerymod");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTcoRef1NQuerymod");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTcoRef1NQuerymod";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTcoRef1NQuerymod");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOREF1NQUERYMODDATA, scrJref);
		...
		public QryWznmTcoRef1NQuerymod.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoRef1NQuerymodData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOREF1NQUERYMODDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoRef1NQuerymodDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCOREF1NQUERYMODDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTcoRef1NQuerymod();
			statappqry = (new QryWznmTcoRef1NQuerymod()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTcoRef1NQuerymod()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTcoRef1NQuerymod()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTcoRef1NQuerymod rst;
		public QryWznmTcoRef1NQuerymod.StatApp statappqry;
		public QryWznmTcoRef1NQuerymod.StatShr statshrqry;
		public QryWznmTcoRef1NQuerymod.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoRef1NQuerymodData");
