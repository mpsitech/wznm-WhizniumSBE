/**
  * \file PnlWznmShtList.java
  * Java API code for job PnlWznmShtList
...
public class PnlWznmShtList {
	/**
		* VecVDo (full: VecVWznmShtListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmShtList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmShtList");

			String itemtag = "ContitemIacWznmShtList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmShtList";

			String itemtag;

			if (shorttags) itemtag = "Ci";
			else itemtag = "ContitemIacWznmShtList";
	...
	/**
	  * ContInf (full: ContInfWznmShtList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmShtList");

			String itemtag = "ContitemInfWznmShtList";
	...
	/**
	  * StatShr (full: StatShrWznmShtList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmShtList");

			String itemtag = "StatitemShrWznmShtList";
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			this.TcoVisWidth = TcoVisWidth;

			mask = new HashSet<Integer>(Arrays.asList(TCOTITWIDTH, TCOVISWIDTH));
		};

		public int TcoTitWidth;
		public int TcoVisWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmShtList");

			String itemtag = "StgitemIacWznmShtList";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoTitWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoTitWidth", mask, TCOTITWIDTH);
				TcoVisWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoVisWidth", mask, TCOVISWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmShtList";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmShtList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoVisWidth", TcoVisWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoVisWidth == comp.TcoVisWidth) items.add(TCOVISWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOTITWIDTH, TCOVISWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOVIS = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTIT, TCOVIS));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmShtList");

			String itemtag = "TagitemWznmShtList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoVis = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoVis", mask, TCOVIS);
		...
		public HashSet<Integer> comm(
			...
			if (TcoVis.equals(comp.TcoVis)) items.add(TCOVIS);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTIT, TCOVIS));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmShtListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					...
					, ContIac contiac
					, StgIac stgiac
					, QryWznmShtList.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMSHTLISTDATA, scrJref);
		...
		public QryWznmShtList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmShtListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmShtListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSHTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmShtListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmShtListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSHTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQShtList();
			statappqry = (new QryWznmShtList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmShtList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmShtList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQShtList rst;
		public QryWznmShtList.StatApp statappqry;
		public QryWznmShtList.StatShr statshrqry;
		public QryWznmShtList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmShtListData");
