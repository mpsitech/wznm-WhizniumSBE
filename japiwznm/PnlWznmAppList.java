/**
  * \file PnlWznmAppList.java
  * Java API code for job PnlWznmAppList
...
public class PnlWznmAppList {
	/**
		* VecVDo (full: VecVWznmAppListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmAppList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmAppList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmAppList";
	...
	/**
	  * ContInf (full: ContInfWznmAppList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmAppList");

			String itemtag = "ContitemInfWznmAppList";
	...
	/**
	  * StatShr (full: StatShrWznmAppList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmAppList");

			String itemtag = "StatitemShrWznmAppList";
	...
	public class StgIac extends Block {
		...
		public static final int TCOTRGWIDTH = 5;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOTRGWIDTH, TCOVERWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmAppList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmAppList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOGRPWIDTH, TCOOWNWIDTH, TCOSHOWIDTH, TCOTITWIDTH, TCOTRGWIDTH, TCOVERWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOTRG = 11;
		public static final int TCOVER = 12;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOSHO, TCOTIT, TCOTRG, TCOVER));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmAppList");

			String itemtag = "TagitemWznmAppList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOGRP, TCOOWN, TCOSHO, TCOTIT, TCOTRG, TCOVER));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmAppListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPPLISTDATA, scrJref);
		...
		public QryWznmAppList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmAppListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmAppListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMAPPLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmAppListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmAppListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMAPPLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQAppList();
			statappqry = (new QryWznmAppList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmAppList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmAppList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQAppList rst;
		public QryWznmAppList.StatApp statappqry;
		public QryWznmAppList.StatShr statshrqry;
		public QryWznmAppList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmAppListData");
