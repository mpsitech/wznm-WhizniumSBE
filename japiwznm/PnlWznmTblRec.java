...
public class PnlWznmTblRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONETBL1NTABLECOL = 4;
		public static final int INITDONE1NSUBSET = 5;
		public static final int INITDONEFR1NRELATION = 6;
		public static final int INITDONE1NIMPEXP = 7;
		public static final int INITDONE1NCHECK = 8;
		public static final int INITDONE1NSTUB = 9;
		public static final int INITDONETO1NRELATION = 10;
		public static final int INITDONEREF1NQUERYMOD = 11;
		public static final int INITDONEREF1NRTBLOCK = 12;
		public static final int INITDONEFCT1NTABLECOL = 13;
		public static final int INITDONEREF1NDIALOG = 14;
		public static final int INITDONEREF1NCALL = 15;
		public static final int INITDONESRC1NFEED = 16;
		public static final int INITDONEREF1NPANEL = 17;
		public static final int INITDONEHK1NVECTOR = 18;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONEALOADFCT, INITDONETBL1NTABLECOL, INITDONE1NSUBSET, INITDONEFR1NRELATION, INITDONE1NIMPEXP, INITDONE1NCHECK, INITDONE1NSTUB, INITDONETO1NRELATION, INITDONEREF1NQUERYMOD, INITDONEREF1NRTBLOCK, INITDONEFCT1NTABLECOL, INITDONEREF1NDIALOG, INITDONEREF1NCALL, INITDONESRC1NFEED, INITDONEREF1NPANEL, INITDONEHK1NVECTOR, INITDONEPST1NQUERYMOD, INITDONEMNVECTOR, INITDONEMNQUERY));
		};
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFTBL1NTABLECOL = 7;
		public static final int SCRJREF1NSUBSET = 8;
		public static final int PNL1NSUBSETAVAIL = 9;
		public static final int SCRJREFFR1NRELATION = 10;
		public static final int PNLFR1NRELATIONAVAIL = 11;
		public static final int SCRJREF1NIMPEXP = 12;
		public static final int PNL1NIMPEXPAVAIL = 13;
		public static final int SCRJREF1NCHECK = 14;
		public static final int PNL1NCHECKAVAIL = 15;
		public static final int SCRJREF1NSTUB = 16;
		public static final int PNL1NSTUBAVAIL = 17;
		public static final int SCRJREFTO1NRELATION = 18;
		public static final int PNLTO1NRELATIONAVAIL = 19;
		public static final int SCRJREFREF1NQUERYMOD = 20;
		public static final int SCRJREFREF1NRTBLOCK = 21;
		public static final int SCRJREFFCT1NTABLECOL = 22;
		public static final int PNLFCT1NTABLECOLAVAIL = 23;
		public static final int SCRJREFREF1NDIALOG = 24;
		public static final int PNLREF1NDIALOGAVAIL = 25;
		public static final int SCRJREFREF1NCALL = 26;
		public static final int PNLREF1NCALLAVAIL = 27;
		public static final int SCRJREFSRC1NFEED = 28;
		public static final int SCRJREFREF1NPANEL = 29;
		public static final int SCRJREFHK1NVECTOR = 30;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFREF1NQUERYMOD, SCRJREFREF1NRTBLOCK, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFHK1NVECTOR, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFREF1NQUERYMOD, SCRJREFREF1NRTBLOCK, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFHK1NVECTOR, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
