...
public class PnlWznmTblRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONEFR1NRELATION = 8;
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NSTUB = 10;
		public static final int PNL1NSTUBAVAIL = 11;
		public static final int SCRJREFTO1NRELATION = 12;
		public static final int PNLTO1NRELATIONAVAIL = 13;
		public static final int SCRJREFFR1NRELATION = 14;
		public static final int PNLFR1NRELATIONAVAIL = 15;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NPANEL, SCRJREFSRC1NFEED, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFREF1NPANEL, SCRJREFSRC1NFEED, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
