...
public class PnlWznmTblRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONE1NSTUB = 5;
		public static final int INITDONE1NSUBSET = 6;
		public static final int INITDONEFR1NRELATION = 7;
		public static final int INITDONETO1NRELATION = 8;
		public static final int INITDONE1NIMPEXP = 9;
		public static final int INITDONE1NCHECK = 10;
		public static final int INITDONEFCT1NTABLECOL = 11;
		public static final int INITDONESRC1NFEED = 12;
		public static final int INITDONEREF1NPANEL = 13;
		public static final int INITDONEREF1NRTBLOCK = 14;
		public static final int INITDONEREF1NQUERYMOD = 15;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEATITLE, INITDONEALOADFCT, INITDONETBL1NTABLECOL, INITDONE1NSTUB, INITDONE1NSUBSET, INITDONEFR1NRELATION, INITDONETO1NRELATION, INITDONE1NIMPEXP, INITDONE1NCHECK, INITDONEFCT1NTABLECOL, INITDONESRC1NFEED, INITDONEREF1NPANEL, INITDONEREF1NRTBLOCK, INITDONEREF1NQUERYMOD, INITDONEHK1NVECTOR, INITDONEREF1NCALL, INITDONEREF1NDIALOG, INITDONEPST1NQUERYMOD, INITDONEMNVECTOR, INITDONEMNQUERY));
		};
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREF1NSTUB = 8;
		public static final int PNL1NSTUBAVAIL = 9;
		public static final int SCRJREF1NSUBSET = 10;
		public static final int PNL1NSUBSETAVAIL = 11;
		public static final int SCRJREFFR1NRELATION = 12;
		public static final int PNLFR1NRELATIONAVAIL = 13;
		public static final int SCRJREFTO1NRELATION = 14;
		public static final int PNLTO1NRELATIONAVAIL = 15;
		...
		public static final int SCRJREFFCT1NTABLECOL = 20;
		public static final int PNLFCT1NTABLECOLAVAIL = 21;
		public static final int SCRJREFSRC1NFEED = 22;
		public static final int SCRJREFREF1NPANEL = 23;
		public static final int SCRJREFREF1NRTBLOCK = 24;
		public static final int SCRJREFREF1NQUERYMOD = 25;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFATITLE, PNLATITLEAVAIL, SCRJREFALOADFCT, PNLALOADFCTAVAIL, SCRJREFTBL1NTABLECOL, SCRJREF1NSTUB, PNL1NSTUBAVAIL, SCRJREF1NSUBSET, PNL1NSUBSETAVAIL, SCRJREFFR1NRELATION, PNLFR1NRELATIONAVAIL, SCRJREFTO1NRELATION, PNLTO1NRELATIONAVAIL, SCRJREF1NIMPEXP, PNL1NIMPEXPAVAIL, SCRJREF1NCHECK, PNL1NCHECKAVAIL, SCRJREFFCT1NTABLECOL, PNLFCT1NTABLECOLAVAIL, SCRJREFSRC1NFEED, SCRJREFREF1NPANEL, SCRJREFREF1NRTBLOCK, SCRJREFREF1NQUERYMOD, SCRJREFHK1NVECTOR, SCRJREFREF1NCALL, PNLREF1NCALLAVAIL, SCRJREFREF1NDIALOG, PNLREF1NDIALOGAVAIL, SCRJREFPST1NQUERYMOD, PNLPST1NQUERYMODAVAIL, SCRJREFMNVECTOR, PNLMNVECTORAVAIL, SCRJREFMNQUERY, PNLMNQUERYAVAIL, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
