/**
	...
	* Java API code for record of table TblWznmQPrjMNPerson
...
public class WznmQPrjMNPerson {
	
	public WznmQPrjMNPerson(
				int jnum
				, String stubMref
				, String ftmX1Startd
				, String ftmX1Stopd
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQPrjMNPerson");
