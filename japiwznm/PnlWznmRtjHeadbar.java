/**
  * \file PnlWznmRtjHeadbar.java
  * Java API code for job PnlWznmRtjHeadbar
...
public class PnlWznmRtjHeadbar {
	/**
	  * StgInf (full: StgInfWznmRtjHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmRtjHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRtjHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmRtjHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRTJHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRtjHeadbarData");
