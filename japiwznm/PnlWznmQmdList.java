/**
  * \file PnlWznmQmdList.java
  * Java API code for job PnlWznmQmdList
...
public class PnlWznmQmdList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmQmdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmQmdList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQmdList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQmdList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOQRYWIDTH = 2;
		public static final int TCOPSTWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOQRYWIDTH, TCOPSTWIDTH, TCORETWIDTH, TCOREUWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQmdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQmdList";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOTYPWIDTH, TCOQRYWIDTH, TCOPSTWIDTH, TCORETWIDTH, TCOREUWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOQRY = 9;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOQRY, TCOPST, TCORET, TCOREU));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQmdList");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOTYP, TCOQRY, TCOPST, TCORET, TCOREU));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQMDLISTDATA, scrJref);
		...
		public QryWznmQmdList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQmdListData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQMDLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQmdListDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQMDLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQQmdList();
			statappqry = (new QryWznmQmdList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQmdList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQmdList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQmdList rst;
		public QryWznmQmdList.StatApp statappqry;
		public QryWznmQmdList.StatShr statshrqry;
		public QryWznmQmdList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQmdListData");
