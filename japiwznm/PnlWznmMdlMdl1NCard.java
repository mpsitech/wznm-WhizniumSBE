/**
  * \file PnlWznmMdlMdl1NCard.java
  * Java API code for job PnlWznmMdlMdl1NCard
...
public class PnlWznmMdlMdl1NCard {
	/**
		* VecVDo (full: VecVWznmMdlMdl1NCardDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMdlMdl1NCard)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMdlMdl1NCard");
	...
	/**
	  * StatApp (full: StatAppWznmMdlMdl1NCard)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMdlMdl1NCard");
	...
	/**
	  * StatShr (full: StatShrWznmMdlMdl1NCard)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMdlMdl1NCard");
	...
	/**
	  * StgIac (full: StgIacWznmMdlMdl1NCard)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMdlMdl1NCard");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMdlMdl1NCard";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMdlMdl1NCard");
	...
	/**
		* DpchAppData (full: DpchAppWznmMdlMdl1NCardData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLMDL1NCARDDATA, scrJref);
		...
		public QryWznmMdlMdl1NCard.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlMdl1NCardData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMdlMdl1NCardDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMDLMDL1NCARDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMdlMdl1NCardDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMdlMdl1NCardData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMDLMDL1NCARDDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQMdlMdl1NCard();
			statappqry = (new QryWznmMdlMdl1NCard()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMdlMdl1NCard()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMdlMdl1NCard()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMdlMdl1NCard rst;
		public QryWznmMdlMdl1NCard.StatApp statappqry;
		public QryWznmMdlMdl1NCard.StatShr statshrqry;
		public QryWznmMdlMdl1NCard.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMdlMdl1NCardData");
