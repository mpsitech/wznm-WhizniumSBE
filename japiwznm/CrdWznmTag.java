/**
  * \file CrdWznmTag.java
  * Java API code for job CrdWznmTag
...
public class CrdWznmTag {
	/**
		* VecVDo (full: VecVWznmTagDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTag)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDTAG = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTAG));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdTag;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTag");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdTag = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdTag", mask, MTXCRDTAG);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdTag.equals(comp.MtxCrdTag)) items.add(MTXCRDTAG);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDTAG));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTag");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTag");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTag");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTagDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTAGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTagDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTagData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTAGDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTagData");
