/**
  * \file PnlWznmRelRef1NDialog.java
  * Java API code for job PnlWznmRelRef1NDialog
...
public class PnlWznmRelRef1NDialog {
	/**
		* VecVDo (full: VecVWznmRelRef1NDialogDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRelRef1NDialog)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelRef1NDialog");
	...
	/**
	  * StatApp (full: StatAppWznmRelRef1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRelRef1NDialog");
	...
	/**
	  * StatShr (full: StatShrWznmRelRef1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelRef1NDialog");
	...
	/**
	  * StgIac (full: StgIacWznmRelRef1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelRef1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelRef1NDialog";
	...
	/**
	  * Tag (full: TagWznmRelRef1NDialog)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelRef1NDialog");
	...
	/**
		* DpchAppData (full: DpchAppWznmRelRef1NDialogData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NDIALOGDATA, scrJref);
		...
		public QryWznmRelRef1NDialog.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NDialogData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRelRef1NDialogDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NDIALOGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NDialogDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRelRef1NDialogData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELREF1NDIALOGDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRelRef1NDialog();
			statappqry = (new QryWznmRelRef1NDialog()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelRef1NDialog()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelRef1NDialog()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelRef1NDialog rst;
		public QryWznmRelRef1NDialog.StatApp statappqry;
		public QryWznmRelRef1NDialog.StatShr statshrqry;
		public QryWznmRelRef1NDialog.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelRef1NDialogData");
