...
public class QryWznmTbl1NSubset {
	/**
	  * StatApp (full: StatAppQryWznmTbl1NSubset)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTbl1NSubset");
	...
	/**
	  * StatShr (full: StatShrQryWznmTbl1NSubset)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTbl1NSubset");
	...
	/**
	  * StgIac (full: StgIacQryWznmTbl1NSubset)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTbl1NSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTbl1NSubset";
