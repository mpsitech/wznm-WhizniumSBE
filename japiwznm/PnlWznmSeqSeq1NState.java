/**
  * \file PnlWznmSeqSeq1NState.java
  * Java API code for job PnlWznmSeqSeq1NState
...
public class PnlWznmSeqSeq1NState {
	/**
		* VecVDo (full: VecVWznmSeqSeq1NStateDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSeqSeq1NState)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSeqSeq1NState");
	...
	/**
	  * StatApp (full: StatAppWznmSeqSeq1NState)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSeqSeq1NState");
	...
	/**
	  * StatShr (full: StatShrWznmSeqSeq1NState)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSeqSeq1NState");
	...
	/**
	  * StgIac (full: StgIacWznmSeqSeq1NState)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSeqSeq1NState");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSeqSeq1NState";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSeqSeq1NState");
	...
	/**
		* DpchAppData (full: DpchAppWznmSeqSeq1NStateData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSEQSEQ1NSTATEDATA, scrJref);
		...
		public QryWznmSeqSeq1NState.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSeqSeq1NStateData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSeqSeq1NStateDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSEQSEQ1NSTATEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSeqSeq1NStateDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSeqSeq1NStateData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSEQSEQ1NSTATEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSeqSeq1NState();
			statappqry = (new QryWznmSeqSeq1NState()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSeqSeq1NState()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSeqSeq1NState()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSeqSeq1NState rst;
		public QryWznmSeqSeq1NState.StatApp statappqry;
		public QryWznmSeqSeq1NState.StatShr statshrqry;
		public QryWznmSeqSeq1NState.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSeqSeq1NStateData");
