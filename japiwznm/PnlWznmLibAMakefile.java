...
public class PnlWznmLibAMakefile {
	/**
		* VecVDo (full: VecVWznmLibAMakefileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmLibAMakefile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLibAMakefile");
	...
	/**
	  * StatApp (full: StatAppWznmLibAMakefile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmLibAMakefile");
	...
	/**
	  * StatShr (full: StatShrWznmLibAMakefile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLibAMakefile");
	...
	/**
	  * StgIac (full: StgIacWznmLibAMakefile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLibAMakefile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLibAMakefile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLibAMakefile");
	...
	/**
		* DpchAppData (full: DpchAppWznmLibAMakefileData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBAMAKEFILEDATA, scrJref);
		...
		public QryWznmLibAMakefile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibAMakefileData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmLibAMakefileDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLIBAMAKEFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLibAMakefileDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmLibAMakefileData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLIBAMAKEFILEDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQLibAMakefile();
			statappqry = (new QryWznmLibAMakefile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLibAMakefile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLibAMakefile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLibAMakefile rst;
		public QryWznmLibAMakefile.StatApp statappqry;
		public QryWznmLibAMakefile.StatShr statshrqry;
		public QryWznmLibAMakefile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLibAMakefileData");
