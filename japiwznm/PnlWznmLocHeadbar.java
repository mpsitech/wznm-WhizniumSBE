/**
  * \file PnlWznmLocHeadbar.java
  * Java API code for job PnlWznmLocHeadbar
...
public class PnlWznmLocHeadbar {
	/**
	  * StgInf (full: StgInfWznmLocHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmLocHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLocHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmLocHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLOCHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLocHeadbarData");
