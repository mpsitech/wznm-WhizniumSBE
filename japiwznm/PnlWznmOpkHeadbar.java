/**
  * \file PnlWznmOpkHeadbar.java
  * Java API code for job PnlWznmOpkHeadbar
...
public class PnlWznmOpkHeadbar {
	/**
	  * StgInf (full: StgInfWznmOpkHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmOpkHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkHeadbarData");
