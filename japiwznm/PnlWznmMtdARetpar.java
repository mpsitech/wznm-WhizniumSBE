/**
  * \file PnlWznmMtdARetpar.java
  * Java API code for job PnlWznmMtdARetpar
...
public class PnlWznmMtdARetpar {
	/**
		* VecVDo (full: VecVWznmMtdARetparDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMtdARetpar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMtdARetpar");
	...
	/**
	  * StatApp (full: StatAppWznmMtdARetpar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMtdARetpar");
	...
	/**
	  * StatShr (full: StatShrWznmMtdARetpar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMtdARetpar");
	...
	/**
	  * StgIac (full: StgIacWznmMtdARetpar)
	  */
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCOCMTWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMtdARetpar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMtdARetpar";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCOCMTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOVTY, TCOVEC, TCOLEN, TCOCMT));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMtdARetpar");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOVTY, TCOVEC, TCOLEN, TCOCMT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmMtdARetparData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDARETPARDATA, scrJref);
		...
		public QryWznmMtdARetpar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdARetparData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMtdARetparDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDARETPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdARetparDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMtdARetparData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTDARETPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQMtdARetpar();
			statappqry = (new QryWznmMtdARetpar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMtdARetpar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMtdARetpar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMtdARetpar rst;
		public QryWznmMtdARetpar.StatApp statappqry;
		public QryWznmMtdARetpar.StatShr statshrqry;
		public QryWznmMtdARetpar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtdARetparData");
