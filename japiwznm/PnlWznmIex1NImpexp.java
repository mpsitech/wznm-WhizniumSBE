/**
  * \file PnlWznmIex1NImpexp.java
  * Java API code for job PnlWznmIex1NImpexp
...
public class PnlWznmIex1NImpexp {
	/**
		* VecVDo (full: VecVWznmIex1NImpexpDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmIex1NImpexp)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIex1NImpexp");
	...
	/**
	  * StatApp (full: StatAppWznmIex1NImpexp)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmIex1NImpexp");
	...
	/**
	  * StatShr (full: StatShrWznmIex1NImpexp)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIex1NImpexp");
	...
	/**
	  * StgIac (full: StgIacWznmIex1NImpexp)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmIex1NImpexp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmIex1NImpexp";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIex1NImpexp");
	...
	/**
		* DpchAppData (full: DpchAppWznmIex1NImpexpData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEX1NIMPEXPDATA, scrJref);
		...
		public QryWznmIex1NImpexp.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIex1NImpexpData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIex1NImpexpDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEX1NIMPEXPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIex1NImpexpDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIex1NImpexpData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIEX1NIMPEXPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQIex1NImpexp();
			statappqry = (new QryWznmIex1NImpexp()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmIex1NImpexp()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmIex1NImpexp()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQIex1NImpexp rst;
		public QryWznmIex1NImpexp.StatApp statappqry;
		public QryWznmIex1NImpexp.StatShr statshrqry;
		public QryWznmIex1NImpexp.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIex1NImpexpData");
