/**
  * \file PnlWznmLocMNVersion.java
  * Java API code for job PnlWznmLocMNVersion
...
public class PnlWznmLocMNVersion {
	/**
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmLocMNVersion");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmLocMNVersion");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmLocMNVersion");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmLocMNVersion");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmLocMNVersion";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmLocMNVersion");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLOCMNVERSIONDATA, scrJref);
		...
		public QryWznmLocMNVersion.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLocMNVersionData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMLOCMNVERSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmLocMNVersionDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMLOCMNVERSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQLocMNVersion();
			statappqry = (new QryWznmLocMNVersion()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmLocMNVersion()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmLocMNVersion()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQLocMNVersion rst;
		public QryWznmLocMNVersion.StatApp statappqry;
		public QryWznmLocMNVersion.StatShr statshrqry;
		public QryWznmLocMNVersion.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmLocMNVersionData");
