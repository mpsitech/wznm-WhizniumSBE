/**
  * \file PnlWznmQryMNDialog.java
  * Java API code for job PnlWznmQryMNDialog
...
public class PnlWznmQryMNDialog {
	/**
		* VecVDo (full: VecVWznmQryMNDialogDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmQryMNDialog)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQryMNDialog");
	...
	/**
	  * StatApp (full: StatAppWznmQryMNDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmQryMNDialog");
	...
	/**
	  * StatShr (full: StatShrWznmQryMNDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQryMNDialog");
	...
	/**
	  * StgIac (full: StgIacWznmQryMNDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQryMNDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQryMNDialog";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQryMNDialog");
	...
	/**
		* DpchAppData (full: DpchAppWznmQryMNDialogData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYMNDIALOGDATA, scrJref);
		...
		public QryWznmQryMNDialog.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryMNDialogData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQryMNDialogDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQRYMNDIALOGDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQryMNDialogDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQryMNDialogData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQRYMNDIALOGDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQQryMNDialog();
			statappqry = (new QryWznmQryMNDialog()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQryMNDialog()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQryMNDialog()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQryMNDialog rst;
		public QryWznmQryMNDialog.StatApp statappqry;
		public QryWznmQryMNDialog.StatShr statshrqry;
		public QryWznmQryMNDialog.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQryMNDialogData");
