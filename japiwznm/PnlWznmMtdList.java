/**
  * \file PnlWznmMtdList.java
  * Java API code for job PnlWznmMtdList
...
public class PnlWznmMtdList {
	/**
		* VecVDo (full: VecVWznmMtdListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmMtdList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmMtdList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmMtdList";
	...
	/**
	  * ContInf (full: ContInfWznmMtdList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMtdList");

			String itemtag = "ContitemInfWznmMtdList";
	...
	/**
	  * StatShr (full: StatShrWznmMtdList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMtdList");

			String itemtag = "StatitemShrWznmMtdList";
	...
	/**
	  * StgIac (full: StgIacWznmMtdList)
	  */
	public class StgIac extends Block {

		public static final int TCOSRFWIDTH = 1;
		public static final int TCOJOBWIDTH = 2;
		public static final int TCOEXSWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOJOBWIDTH, TCOEXSWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoJobWidth;
		public int TcoExsWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMtdList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoExsWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoExsWidth", mask, TCOEXSWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMtdList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoExsWidth", TcoExsWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoExsWidth == comp.TcoExsWidth) items.add(TCOEXSWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOJOBWIDTH, TCOEXSWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOJOB = 9;
		public static final int TCOEXS = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOJOB, TCOEXS));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMtdList");

			String itemtag = "TagitemWznmMtdList";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoExs = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoExs", mask, TCOEXS);
		...
		public HashSet<Integer> comm(
			...
			if (TcoExs.equals(comp.TcoExs)) items.add(TCOEXS);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOJOB, TCOEXS));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmMtdListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDLISTDATA, scrJref);
		...
		public QryWznmMtdList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMtdListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMTDLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMtdListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMtdListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMTDLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQMtdList();
			statappqry = (new QryWznmMtdList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMtdList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMtdList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMtdList rst;
		public QryWznmMtdList.StatApp statappqry;
		public QryWznmMtdList.StatShr statshrqry;
		public QryWznmMtdList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMtdListData");
