/**
  * \file QryWznmTblALoadfct.java
  * Java API code for job QryWznmTblALoadfct
...
public class QryWznmTblALoadfct {
	/**
	  * StatApp (full: StatAppQryWznmTblALoadfct)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmTblALoadfct");
	...
	/**
	  * StatShr (full: StatShrQryWznmTblALoadfct)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmTblALoadfct");
	...
	/**
	  * StgIac (full: StgIacQryWznmTblALoadfct)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmTblALoadfct");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmTblALoadfct";
