/**
  * \file QryWznmBoxList.java
  * Java API code for job QryWznmBoxList
...
public class QryWznmBoxList {
	/**
		* VecVOrd (full: VecVQryWznmBoxListOrd)
		*/
	public static class VecVOrd {

		public static final int UNV = 1;
		public static final int MTB = 2;
		public static final int SHT = 3;
		...
		public static int getIx(
			...
			if (s.equals("unv")) return UNV;
			if (s.equals("mtb")) return MTB;
			if (s.equals("sht")) return SHT;
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmBoxList");

			String itemtag = "StatitemAppQryWznmBoxList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmBoxList");

			String itemtag = "StatitemShrQryWznmBoxList";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmBoxList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmBoxList";
