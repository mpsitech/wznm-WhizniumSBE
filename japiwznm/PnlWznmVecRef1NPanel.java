/**
  * \file PnlWznmVecRef1NPanel.java
  * Java API code for job PnlWznmVecRef1NPanel
...
public class PnlWznmVecRef1NPanel {
	/**
		* VecVDo (full: VecVWznmVecRef1NPanelDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVecRef1NPanel)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVecRef1NPanel");
	...
	/**
	  * StatApp (full: StatAppWznmVecRef1NPanel)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVecRef1NPanel");
	...
	/**
	  * StatShr (full: StatShrWznmVecRef1NPanel)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVecRef1NPanel");
	...
	/**
	  * StgIac (full: StgIacWznmVecRef1NPanel)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVecRef1NPanel");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVecRef1NPanel";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVecRef1NPanel");
	...
	/**
		* DpchAppData (full: DpchAppWznmVecRef1NPanelData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECREF1NPANELDATA, scrJref);
		...
		public QryWznmVecRef1NPanel.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecRef1NPanelData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecRef1NPanelDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVECREF1NPANELDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVecRef1NPanelDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVecRef1NPanelData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVECREF1NPANELDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVecRef1NPanel();
			statappqry = (new QryWznmVecRef1NPanel()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVecRef1NPanel()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVecRef1NPanel()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVecRef1NPanel rst;
		public QryWznmVecRef1NPanel.StatApp statappqry;
		public QryWznmVecRef1NPanel.StatShr statshrqry;
		public QryWznmVecRef1NPanel.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVecRef1NPanelData");
