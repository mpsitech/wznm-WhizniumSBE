/**
  * \file PnlWznmVerRef1NFile.java
  * Java API code for job PnlWznmVerRef1NFile
...
public class PnlWznmVerRef1NFile {
	/**
		* VecVDo (full: VecVWznmVerRef1NFileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVerRef1NFile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVerRef1NFile");
	...
	/**
	  * StatApp (full: StatAppWznmVerRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVerRef1NFile");
	...
	/**
	  * StatShr (full: StatShrWznmVerRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVerRef1NFile");
	...
	/**
	  * StgIac (full: StgIacWznmVerRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVerRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVerRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVerRef1NFile");
	...
	/**
		* DpchAppData (full: DpchAppWznmVerRef1NFileData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERREF1NFILEDATA, scrJref);
		...
		public QryWznmVerRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerRef1NFileData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVerRef1NFileDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVERREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVerRef1NFileDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVerRef1NFileData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVERREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVerRef1NFile();
			statappqry = (new QryWznmVerRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVerRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVerRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVerRef1NFile rst;
		public QryWznmVerRef1NFile.StatApp statappqry;
		public QryWznmVerRef1NFile.StatShr statshrqry;
		public QryWznmVerRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVerRef1NFileData");
