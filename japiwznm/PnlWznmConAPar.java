/**
  * \file PnlWznmConAPar.java
  * Java API code for job PnlWznmConAPar
...
public class PnlWznmConAPar {
	/**
		* VecVDo (full: VecVWznmConAParDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmConAPar)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmConAPar");
	...
	/**
	  * StatApp (full: StatAppWznmConAPar)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmConAPar");
	...
	/**
	  * StatShr (full: StatShrWznmConAPar)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmConAPar");
	...
	public class StgIac extends Block {
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOKEYWIDTH, TCOLOCWIDTH, TCOVALWIDTH));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmConAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmConAPar";
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOKEYWIDTH, TCOLOCWIDTH, TCOVALWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOKEY, TCOLOC, TCOVAL));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmConAPar");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOKEY, TCOLOC, TCOVAL));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmConAParData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONAPARDATA, scrJref);
		...
		public QryWznmConAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConAParData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmConAParDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCONAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmConAParDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmConAParData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCONAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQConAPar();
			statappqry = (new QryWznmConAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmConAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmConAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQConAPar rst;
		public QryWznmConAPar.StatApp statappqry;
		public QryWznmConAPar.StatShr statshrqry;
		public QryWznmConAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmConAParData");
