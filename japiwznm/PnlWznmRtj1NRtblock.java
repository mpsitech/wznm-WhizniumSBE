/**
  * \file PnlWznmRtj1NRtblock.java
  * Java API code for job PnlWznmRtj1NRtblock
...
public class PnlWznmRtj1NRtblock {
	/**
		* VecVDo (full: VecVWznmRtj1NRtblockDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRtj1NRtblock)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRtj1NRtblock");
	...
	/**
	  * StatApp (full: StatAppWznmRtj1NRtblock)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRtj1NRtblock");
	...
	/**
	  * StatShr (full: StatShrWznmRtj1NRtblock)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRtj1NRtblock");
	...
	/**
	  * StgIac (full: StgIacWznmRtj1NRtblock)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRtj1NRtblock");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRtj1NRtblock";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRtj1NRtblock");
	...
	/**
		* DpchAppData (full: DpchAppWznmRtj1NRtblockData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJ1NRTBLOCKDATA, scrJref);
		...
		public QryWznmRtj1NRtblock.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtj1NRtblockData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRtj1NRtblockDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJ1NRTBLOCKDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtj1NRtblockDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRtj1NRtblockData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRTJ1NRTBLOCKDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRtj1NRtblock();
			statappqry = (new QryWznmRtj1NRtblock()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRtj1NRtblock()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRtj1NRtblock()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRtj1NRtblock rst;
		public QryWznmRtj1NRtblock.StatApp statappqry;
		public QryWznmRtj1NRtblock.StatShr statshrqry;
		public QryWznmRtj1NRtblock.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRtj1NRtblockData");
