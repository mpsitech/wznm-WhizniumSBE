/**
  * \file PnlWznmVitHeadbar.java
  * Java API code for job PnlWznmVitHeadbar
...
public class PnlWznmVitHeadbar {
	/**
	  * StgInf (full: StgInfWznmVitHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmVitHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVitHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmVitHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVITHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVitHeadbarData");
