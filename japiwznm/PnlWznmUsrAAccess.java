/**
  * \file PnlWznmUsrAAccess.java
  * Java API code for job PnlWznmUsrAAccess
...
public class PnlWznmUsrAAccess {
	/**
		* VecVDo (full: VecVWznmUsrAAccessDo)
		*/
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmUsrAAccess");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmUsrAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmUsrAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmUsrAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmUsrAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmUsrAAccess");
	...
	/**
		* DpchAppData (full: DpchAppWznmUsrAAccessData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRAACCESSDATA, scrJref);
		...
		public QryWznmUsrAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrAAccessData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsrAAccessDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMUSRAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmUsrAAccessDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmUsrAAccessData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMUSRAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWznmQUsrAAccess();
			statappqry = (new QryWznmUsrAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmUsrAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmUsrAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQUsrAAccess rst;
		public QryWznmUsrAAccess.StatApp statappqry;
		public QryWznmUsrAAccess.StatShr statshrqry;
		public QryWznmUsrAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmUsrAAccessData");
