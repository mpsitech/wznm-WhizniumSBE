/**
  * \file PnlWznmTcoRef1NControl.java
  * Java API code for job PnlWznmTcoRef1NControl
...
public class PnlWznmTcoRef1NControl {
	/**
		* VecVDo (full: VecVWznmTcoRef1NControlDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmTcoRef1NControl)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmTcoRef1NControl");
	...
	/**
	  * StatApp (full: StatAppWznmTcoRef1NControl)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmTcoRef1NControl");
	...
	/**
	  * StatShr (full: StatShrWznmTcoRef1NControl)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmTcoRef1NControl");
	...
	/**
	  * StgIac (full: StgIacWznmTcoRef1NControl)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmTcoRef1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmTcoRef1NControl";
	...
	/**
	  * Tag (full: TagWznmTcoRef1NControl)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmTcoRef1NControl");
	...
	/**
		* DpchAppData (full: DpchAppWznmTcoRef1NControlData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOREF1NCONTROLDATA, scrJref);
		...
		public QryWznmTcoRef1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoRef1NControlData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmTcoRef1NControlDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMTCOREF1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmTcoRef1NControlDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmTcoRef1NControlData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMTCOREF1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQTcoRef1NControl();
			statappqry = (new QryWznmTcoRef1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmTcoRef1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmTcoRef1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQTcoRef1NControl rst;
		public QryWznmTcoRef1NControl.StatApp statappqry;
		public QryWznmTcoRef1NControl.StatShr statshrqry;
		public QryWznmTcoRef1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmTcoRef1NControlData");
