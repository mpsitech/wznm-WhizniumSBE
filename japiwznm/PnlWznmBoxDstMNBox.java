/**
  * \file PnlWznmBoxDstMNBox.java
  * Java API code for job PnlWznmBoxDstMNBox
...
public class PnlWznmBoxDstMNBox {
	/**
		* VecVDo (full: VecVWznmBoxDstMNBoxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmBoxDstMNBox)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBoxDstMNBox");

			String itemtag = "ContitemInfWznmBoxDstMNBox";
	...
	/**
	  * StatApp (full: StatAppWznmBoxDstMNBox)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmBoxDstMNBox");

			String itemtag = "StatitemAppWznmBoxDstMNBox";
	...
	/**
	  * StatShr (full: StatShrWznmBoxDstMNBox)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBoxDstMNBox");

			String itemtag = "StatitemShrWznmBoxDstMNBox";
	...
	/**
	  * StgIac (full: StgIacWznmBoxDstMNBox)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmBoxDstMNBox");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmBoxDstMNBox";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBoxDstMNBox");

			String itemtag = "TagitemWznmBoxDstMNBox";
	...
	/**
		* DpchAppData (full: DpchAppWznmBoxDstMNBoxData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXDSTMNBOXDATA, scrJref);
		...
		public QryWznmBoxDstMNBox.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxDstMNBoxData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmBoxDstMNBoxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXDSTMNBOXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxDstMNBoxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBoxDstMNBoxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBOXDSTMNBOXDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQBoxDstMNBox();
			statappqry = (new QryWznmBoxDstMNBox()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmBoxDstMNBox()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmBoxDstMNBox()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQBoxDstMNBox rst;
		public QryWznmBoxDstMNBox.StatApp statappqry;
		public QryWznmBoxDstMNBox.StatShr statshrqry;
		public QryWznmBoxDstMNBox.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBoxDstMNBoxData");
