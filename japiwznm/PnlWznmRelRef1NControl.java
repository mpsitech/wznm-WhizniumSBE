/**
  * \file PnlWznmRelRef1NControl.java
  * Java API code for job PnlWznmRelRef1NControl
...
public class PnlWznmRelRef1NControl {
	/**
		* VecVDo (full: VecVWznmRelRef1NControlDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRelRef1NControl)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRelRef1NControl");
	...
	/**
	  * StatApp (full: StatAppWznmRelRef1NControl)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRelRef1NControl");
	...
	/**
	  * StatShr (full: StatShrWznmRelRef1NControl)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRelRef1NControl");
	...
	/**
	  * StgIac (full: StgIacWznmRelRef1NControl)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmRelRef1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmRelRef1NControl";
	...
	/**
	  * Tag (full: TagWznmRelRef1NControl)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRelRef1NControl");
	...
	/**
		* DpchAppData (full: DpchAppWznmRelRef1NControlData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NCONTROLDATA, scrJref);
		...
		public QryWznmRelRef1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NControlData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRelRef1NControlDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRELREF1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRelRef1NControlDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRelRef1NControlData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRELREF1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQRelRef1NControl();
			statappqry = (new QryWznmRelRef1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmRelRef1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmRelRef1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQRelRef1NControl rst;
		public QryWznmRelRef1NControl.StatApp statappqry;
		public QryWznmRelRef1NControl.StatShr statshrqry;
		public QryWznmRelRef1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRelRef1NControlData");
