/**
  * \file QryWznmSbsBsbMNSubset.java
  * Java API code for job QryWznmSbsBsbMNSubset
...
public class QryWznmSbsBsbMNSubset {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSbsBsbMNSubset");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSbsBsbMNSubset");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSbsBsbMNSubset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSbsBsbMNSubset";
