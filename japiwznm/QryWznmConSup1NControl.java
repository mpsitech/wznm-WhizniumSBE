/**
  * \file QryWznmConSup1NControl.java
  * Java API code for job QryWznmConSup1NControl
...
public class QryWznmConSup1NControl {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmConSup1NControl");

			String itemtag = "StatitemAppQryWznmConSup1NControl";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmConSup1NControl");

			String itemtag = "StatitemShrQryWznmConSup1NControl";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmConSup1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmConSup1NControl";
