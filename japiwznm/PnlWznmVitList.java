/**
  * \file PnlWznmVitList.java
  * Java API code for job PnlWznmVitList
...
public class PnlWznmVitList {
	/**
		* VecVDo (full: VecVWznmVitListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmVitList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmVitList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmVitList";
	...
	/**
	  * ContInf (full: ContInfWznmVitList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVitList");
	...
	/**
	  * StatShr (full: StatShrWznmVitList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVitList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVitList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVitList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVitList");
	...
	/**
		* DpchAppData (full: DpchAppWznmVitListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVITLISTDATA, scrJref);
		...
		public QryWznmVitList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVitListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVitListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVITLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVitListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVitListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVITLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQVitList();
			statappqry = (new QryWznmVitList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVitList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVitList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVitList rst;
		public QryWznmVitList.StatApp statappqry;
		public QryWznmVitList.StatShr statshrqry;
		public QryWznmVitList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVitListData");
