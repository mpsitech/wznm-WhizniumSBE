/**
  * \file DlgWznmVerCustui.java
  * Java API code for job DlgWznmVerCustui
...
public class DlgWznmVerCustui {
	/**
		* VecVDit (full: VecVDlgWznmVerCustuiDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVerCustuiDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVerCustuiDoImp)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmVerCustuiSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVerCustui)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVerCustui");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVerCustui";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVerCustui)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerCustui");
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVerCustuiImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerCustuiImp");
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVerCustuiLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerCustuiLfi");
	...
	/**
	  * StatApp (full: StatAppDlgWznmVerCustui)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVerCustui");
	...
	/**
	  * StatShr (full: StatShrDlgWznmVerCustui)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerCustui");
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVerCustuiIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerCustuiIfi");
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVerCustuiImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerCustuiImp");
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVerCustuiLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerCustuiLfi");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerCustui");
	...
	/**
	  * TagIfi (full: TagDlgWznmVerCustuiIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerCustuiIfi");
	...
	/**
	  * TagImp (full: TagDlgWznmVerCustuiImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerCustuiImp");
	...
	/**
	  * TagLfi (full: TagDlgWznmVerCustuiLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerCustuiLfi");
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmVerCustuiData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERCUSTUIDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerCustuiData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVerCustuiDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERCUSTUIDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerCustuiDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVerCustuiData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMVERCUSTUIDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVerCustuiData");
