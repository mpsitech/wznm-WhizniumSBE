/**
  * \file PnlWznmImeHeadbar.java
  * Java API code for job PnlWznmImeHeadbar
...
public class PnlWznmImeHeadbar {
	/**
	  * StgInf (full: StgInfWznmImeHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmImeHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmImeHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmImeHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIMEHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmImeHeadbarData");
