/**
  * \file QryWznmSht1NBox.java
  * Java API code for job QryWznmSht1NBox
...
public class QryWznmSht1NBox {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmSht1NBox");

			String itemtag = "StatitemAppQryWznmSht1NBox";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmSht1NBox");

			String itemtag = "StatitemShrQryWznmSht1NBox";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmSht1NBox");

			String itemtag = "StgitemIacQryWznmSht1NBox";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmSht1NBox";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacQryWznmSht1NBox";
