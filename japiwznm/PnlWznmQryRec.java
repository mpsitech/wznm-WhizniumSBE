...
public class PnlWznmQryRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONESUP1NQUERY = 5;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEACLAUSE, INITDONEAORDER, INITDONE1NQUERYMOD, INITDONESUP1NQUERY, INITDONEQRY1NQUERYCOL, INITDONEMNTABLE, INITDONEMNPANEL, INITDONEMNDIALOG));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEACLAUSE, INITDONEAORDER, INITDONE1NQUERYMOD, INITDONESUP1NQUERY, INITDONEQRY1NQUERYCOL, INITDONEMNTABLE, INITDONEMNPANEL, INITDONEMNDIALOG));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFSUP1NQUERY = 6;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFACLAUSE, SCRJREFAORDER, SCRJREF1NQUERYMOD, SCRJREFSUP1NQUERY, SCRJREFQRY1NQUERYCOL, SCRJREFMNTABLE, SCRJREFMNPANEL, SCRJREFMNDIALOG, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFACLAUSE, SCRJREFAORDER, SCRJREF1NQUERYMOD, SCRJREFSUP1NQUERY, SCRJREFQRY1NQUERYCOL, SCRJREFMNTABLE, SCRJREFMNPANEL, SCRJREFMNDIALOG, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
