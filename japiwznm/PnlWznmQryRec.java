...
public class PnlWznmQryRec {
	...
	public class StatApp extends Block {
		...
		public static final int INITDONESUP1NQUERY = 4;
		public static final int INITDONE1NQUERYMOD = 5;
		public static final int INITDONEQRY1NQUERYCOL = 6;
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEACLAUSE, INITDONEAORDER, INITDONESUP1NQUERY, INITDONE1NQUERYMOD, INITDONEQRY1NQUERYCOL, INITDONEMNTABLE, INITDONEMNPANEL, INITDONEMNDIALOG));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(INITDONEDETAIL, INITDONEACLAUSE, INITDONEAORDER, INITDONESUP1NQUERY, INITDONE1NQUERYMOD, INITDONEQRY1NQUERYCOL, INITDONEMNTABLE, INITDONEMNPANEL, INITDONEMNDIALOG));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public static final int SCRJREFSUP1NQUERY = 5;
		public static final int SCRJREF1NQUERYMOD = 6;
		public static final int SCRJREFQRY1NQUERYCOL = 7;
		...
		public StatShr(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFACLAUSE, SCRJREFAORDER, SCRJREFSUP1NQUERY, SCRJREF1NQUERYMOD, SCRJREFQRY1NQUERYCOL, SCRJREFMNTABLE, SCRJREFMNPANEL, SCRJREFMNDIALOG, BUTREGULARIZEACTIVE));
		};
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZNMVEXPSTATE, SCRJREFDETAIL, SCRJREFACLAUSE, SCRJREFAORDER, SCRJREFSUP1NQUERY, SCRJREF1NQUERYMOD, SCRJREFQRY1NQUERYCOL, SCRJREFMNTABLE, SCRJREFMNPANEL, SCRJREFMNDIALOG, BUTREGULARIZEACTIVE));
			for (Integer ci: commitems) diffitems.remove(ci);
