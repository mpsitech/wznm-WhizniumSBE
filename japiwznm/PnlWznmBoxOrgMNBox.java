/**
  * \file PnlWznmBoxOrgMNBox.java
  * Java API code for job PnlWznmBoxOrgMNBox
...
public class PnlWznmBoxOrgMNBox {
	/**
		* VecVDo (full: VecVWznmBoxOrgMNBoxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmBoxOrgMNBox)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmBoxOrgMNBox");

			String itemtag = "ContitemInfWznmBoxOrgMNBox";
	...
	/**
	  * StatApp (full: StatAppWznmBoxOrgMNBox)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmBoxOrgMNBox");

			String itemtag = "StatitemAppWznmBoxOrgMNBox";
	...
	/**
	  * StatShr (full: StatShrWznmBoxOrgMNBox)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmBoxOrgMNBox");

			String itemtag = "StatitemShrWznmBoxOrgMNBox";
	...
	/**
	  * StgIac (full: StgIacWznmBoxOrgMNBox)
	  */
	public class StgIac extends Block {

		public static final int TCOMREFWIDTH = 1;
		public static final int TCOOCLWIDTH = 2;
		public static final int TCODCLWIDTH = 3;
		public static final int TCOWGTWIDTH = 4;
		...
		public StgIac(
			...
			this.TcoOclWidth = TcoOclWidth;
			this.TcoDclWidth = TcoDclWidth;
			this.TcoWgtWidth = TcoWgtWidth;

			mask = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOOCLWIDTH, TCODCLWIDTH, TCOWGTWIDTH));
		};

		public int TcoMrefWidth;
		public int TcoOclWidth;
		public int TcoDclWidth;
		public int TcoWgtWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmBoxOrgMNBox");

			String itemtag = "StgitemIacWznmBoxOrgMNBox";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoMrefWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoMrefWidth", mask, TCOMREFWIDTH);
				TcoOclWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoOclWidth", mask, TCOOCLWIDTH);
				TcoDclWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoDclWidth", mask, TCODCLWIDTH);
				TcoWgtWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoWgtWidth", mask, TCOWGTWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmBoxOrgMNBox";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmBoxOrgMNBox";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoOclWidth", TcoOclWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoDclWidth", TcoDclWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoWgtWidth", TcoWgtWidth);
		};
		...
		public HashSet<Integer> comm(
			...
			if (TcoOclWidth == comp.TcoOclWidth) items.add(TCOOCLWIDTH);
			if (TcoDclWidth == comp.TcoDclWidth) items.add(TCODCLWIDTH);
			if (TcoWgtWidth == comp.TcoWgtWidth) items.add(TCOWGTWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOMREFWIDTH, TCOOCLWIDTH, TCODCLWIDTH, TCOWGTWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOOCL = 8;
		public static final int TCODCL = 9;
		public static final int TCOWGT = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOOCL, TCODCL, TCOWGT));
		};
		...
		public String TcoOcl;
		public String TcoDcl;
		public String TcoWgt;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmBoxOrgMNBox");

			String itemtag = "TagitemWznmBoxOrgMNBox";
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoOcl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoOcl", mask, TCOOCL);
				TcoDcl = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoDcl", mask, TCODCL);
				TcoWgt = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoWgt", mask, TCOWGT);
		...
		public HashSet<Integer> comm(
			...
			if (TcoOcl.equals(comp.TcoOcl)) items.add(TCOOCL);
			if (TcoDcl.equals(comp.TcoDcl)) items.add(TCODCL);
			if (TcoWgt.equals(comp.TcoWgt)) items.add(TCOWGT);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOMREF, TCOOCL, TCODCL, TCOWGT));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmBoxOrgMNBoxData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					String scrJref
					, StgIac stgiac
					, QryWznmBoxOrgMNBox.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMBOXORGMNBOXDATA, scrJref);
		...
		public QryWznmBoxOrgMNBox.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxOrgMNBoxData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmBoxOrgMNBoxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMBOXORGMNBOXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmBoxOrgMNBoxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmBoxOrgMNBoxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMBOXORGMNBOXDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQBoxOrgMNBox();
			statappqry = (new QryWznmBoxOrgMNBox()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmBoxOrgMNBox()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmBoxOrgMNBox()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQBoxOrgMNBox rst;
		public QryWznmBoxOrgMNBox.StatApp statappqry;
		public QryWznmBoxOrgMNBox.StatShr statshrqry;
		public QryWznmBoxOrgMNBox.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmBoxOrgMNBoxData");
