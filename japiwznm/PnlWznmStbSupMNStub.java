/**
  * \file PnlWznmStbSupMNStub.java
  * Java API code for job PnlWznmStbSupMNStub
...
public class PnlWznmStbSupMNStub {
	/**
		* VecVDo (full: VecVWznmStbSupMNStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmStbSupMNStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmStbSupMNStub");

			String itemtag = "ContitemInfWznmStbSupMNStub";
	...
	/**
	  * StatApp (full: StatAppWznmStbSupMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmStbSupMNStub");

			String itemtag = "StatitemAppWznmStbSupMNStub";
	...
	/**
	  * StatShr (full: StatShrWznmStbSupMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmStbSupMNStub");

			String itemtag = "StatitemShrWznmStbSupMNStub";
	...
	/**
	  * StgIac (full: StgIacWznmStbSupMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmStbSupMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmStbSupMNStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmStbSupMNStub");

			String itemtag = "TagitemWznmStbSupMNStub";
	...
	/**
		* DpchAppData (full: DpchAppWznmStbSupMNStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBSUPMNSTUBDATA, scrJref);
		...
		public QryWznmStbSupMNStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbSupMNStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmStbSupMNStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSTBSUPMNSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmStbSupMNStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmStbSupMNStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSTBSUPMNSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQStbSupMNStub();
			statappqry = (new QryWznmStbSupMNStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmStbSupMNStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmStbSupMNStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQStbSupMNStub rst;
		public QryWznmStbSupMNStub.StatApp statappqry;
		public QryWznmStbSupMNStub.StatShr statshrqry;
		public QryWznmStbSupMNStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmStbSupMNStubData");
