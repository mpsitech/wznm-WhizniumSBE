/**
  * \file CrdWznmRtj.java
  * Java API code for job CrdWznmRtj
...
public class CrdWznmRtj {
	/**
		* VecVDo (full: VecVWznmRtjDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmRtj)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDRTJ = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDRTJ));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdRtj;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmRtj");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdRtj = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdRtj", mask, MTXCRDRTJ);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdRtj.equals(comp.MtxCrdRtj)) items.add(MTXCRDRTJ);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDRTJ));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmRtj");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmRtj");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmRtj");
	...
	/**
		* DpchAppDo (full: DpchAppWznmRtjDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMRTJDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmRtjDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmRtjData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMRTJDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmRtjData");
