/**
  * \file PnlWznmVer1NPreset.java
  * Java API code for job PnlWznmVer1NPreset
...
public class PnlWznmVer1NPreset {
	/**
		* VecVDo (full: VecVWznmVer1NPresetDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NPreset)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NPreset");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NPreset)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NPreset");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NPreset)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NPreset");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NPreset)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NPreset");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NPreset";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NPreset");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NPresetData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NPRESETDATA, scrJref);
		...
		public QryWznmVer1NPreset.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NPresetData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NPresetDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NPRESETDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NPresetDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NPresetData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NPRESETDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NPreset();
			statappqry = (new QryWznmVer1NPreset()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NPreset()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NPreset()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NPreset rst;
		public QryWznmVer1NPreset.StatApp statappqry;
		public QryWznmVer1NPreset.StatShr statshrqry;
		public QryWznmVer1NPreset.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NPresetData");
