/**
  * \file PnlWznmIexHk1NVector.java
  * Java API code for job PnlWznmIexHk1NVector
...
public class PnlWznmIexHk1NVector {
	/**
		* VecVDo (full: VecVWznmIexHk1NVectorDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmIexHk1NVector)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmIexHk1NVector");
	...
	/**
	  * StatApp (full: StatAppWznmIexHk1NVector)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmIexHk1NVector");
	...
	/**
	  * StatShr (full: StatShrWznmIexHk1NVector)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmIexHk1NVector");
	...
	/**
	  * StgIac (full: StgIacWznmIexHk1NVector)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmIexHk1NVector");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmIexHk1NVector";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmIexHk1NVector");
	...
	/**
		* DpchAppData (full: DpchAppWznmIexHk1NVectorData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXHK1NVECTORDATA, scrJref);
		...
		public QryWznmIexHk1NVector.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexHk1NVectorData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmIexHk1NVectorDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMIEXHK1NVECTORDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmIexHk1NVectorDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmIexHk1NVectorData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMIEXHK1NVECTORDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQIexHk1NVector();
			statappqry = (new QryWznmIexHk1NVector()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmIexHk1NVector()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmIexHk1NVector()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQIexHk1NVector rst;
		public QryWznmIexHk1NVector.StatApp statappqry;
		public QryWznmIexHk1NVector.StatShr statshrqry;
		public QryWznmIexHk1NVector.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmIexHk1NVectorData");
