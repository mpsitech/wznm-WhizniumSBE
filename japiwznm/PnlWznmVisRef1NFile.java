/**
  * \file PnlWznmVisRef1NFile.java
  * Java API code for job PnlWznmVisRef1NFile
...
public class PnlWznmVisRef1NFile {
	/**
		* VecVDo (full: VecVWznmVisRef1NFileDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVisRef1NFile)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVisRef1NFile");

			String itemtag = "ContitemInfWznmVisRef1NFile";
	...
	/**
	  * StatApp (full: StatAppWznmVisRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVisRef1NFile");

			String itemtag = "StatitemAppWznmVisRef1NFile";
	...
	/**
	  * StatShr (full: StatShrWznmVisRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVisRef1NFile");

			String itemtag = "StatitemShrWznmVisRef1NFile";
	...
	/**
	  * StgIac (full: StgIacWznmVisRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVisRef1NFile");

			String itemtag = "StgitemIacWznmVisRef1NFile";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVisRef1NFile";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacWznmVisRef1NFile";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVisRef1NFile");

			String itemtag = "TagitemWznmVisRef1NFile";
	...
	/**
		* DpchAppData (full: DpchAppWznmVisRef1NFileData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
					String scrJref
					, StgIac stgiac
					, QryWznmVisRef1NFile.StgIac stgiacqry
					, Integer[] mask
				) {
			super(VecWznmVDpch.DPCHAPPWZNMVISREF1NFILEDATA, scrJref);
		...
		public QryWznmVisRef1NFile.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisRef1NFileData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVisRef1NFileDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVISREF1NFILEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVisRef1NFileDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVisRef1NFileData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVISREF1NFILEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVisRef1NFile();
			statappqry = (new QryWznmVisRef1NFile()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVisRef1NFile()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVisRef1NFile()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVisRef1NFile rst;
		public QryWznmVisRef1NFile.StatApp statappqry;
		public QryWznmVisRef1NFile.StatShr statshrqry;
		public QryWznmVisRef1NFile.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVisRef1NFileData");
