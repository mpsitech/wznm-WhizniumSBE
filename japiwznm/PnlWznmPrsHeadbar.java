/**
  * \file PnlWznmPrsHeadbar.java
  * Java API code for job PnlWznmPrsHeadbar
...
public class PnlWznmPrsHeadbar {
	/**
	  * StgInf (full: StgInfWznmPrsHeadbar)
	  */
	public class StgInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgInfWznmPrsHeadbar");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPrsHeadbar");
	...
	/**
		* DpchEngData (full: DpchEngWznmPrsHeadbarData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPRSHEADBARDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPrsHeadbarData");
