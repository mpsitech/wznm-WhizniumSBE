/**
  * \file CrdWznmSge.java
  * Java API code for job CrdWznmSge
...
public class CrdWznmSge {
	/**
		* VecVDo (full: VecVWznmSgeDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSge)
	  */
	public class ContInf extends Block {

		public static final int NUMFSGE = 1;
		public static final int MRLAPPHLP = 2;
		public static final int MTXCRDSGE = 3;
		...
		public ContInf(
			...
			mask = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSGE));
		};

		public int numFSge;
		public String MrlAppHlp;
		public String MtxCrdSge;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSge");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				MtxCrdSge = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ci", "sref", "MtxCrdSge", mask, MTXCRDSGE);
		...
		public HashSet<Integer> comm(
			...
			if (MtxCrdSge.equals(comp.MtxCrdSge)) items.add(MTXCRDSGE);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(NUMFSGE, MRLAPPHLP, MTXCRDSGE));
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSge");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSge");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSge");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSgeDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSGEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSgeDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSgeData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSGEDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSgeData");
