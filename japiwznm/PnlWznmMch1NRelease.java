/**
  * \file PnlWznmMch1NRelease.java
  * Java API code for job PnlWznmMch1NRelease
...
public class PnlWznmMch1NRelease {
	/**
		* VecVDo (full: VecVWznmMch1NReleaseDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmMch1NRelease)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmMch1NRelease");
	...
	/**
	  * StatApp (full: StatAppWznmMch1NRelease)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmMch1NRelease");
	...
	/**
	  * StatShr (full: StatShrWznmMch1NRelease)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmMch1NRelease");
	...
	/**
	  * StgIac (full: StgIacWznmMch1NRelease)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmMch1NRelease");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmMch1NRelease";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmMch1NRelease");
	...
	/**
		* DpchAppData (full: DpchAppWznmMch1NReleaseData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCH1NRELEASEDATA, scrJref);
		...
		public QryWznmMch1NRelease.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMch1NReleaseData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmMch1NReleaseDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMMCH1NRELEASEDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmMch1NReleaseDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmMch1NReleaseData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMMCH1NRELEASEDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQMch1NRelease();
			statappqry = (new QryWznmMch1NRelease()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmMch1NRelease()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmMch1NRelease()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQMch1NRelease rst;
		public QryWznmMch1NRelease.StatApp statappqry;
		public QryWznmMch1NRelease.StatShr statshrqry;
		public QryWznmMch1NRelease.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmMch1NReleaseData");
