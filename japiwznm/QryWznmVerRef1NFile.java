/**
  * \file QryWznmVerRef1NFile.java
  * Java API code for job QryWznmVerRef1NFile
...
public class QryWznmVerRef1NFile {
	/**
	  * StatApp (full: StatAppQryWznmVerRef1NFile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVerRef1NFile");
	...
	/**
	  * StatShr (full: StatShrQryWznmVerRef1NFile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVerRef1NFile");
	...
	/**
	  * StgIac (full: StgIacQryWznmVerRef1NFile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVerRef1NFile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVerRef1NFile";
