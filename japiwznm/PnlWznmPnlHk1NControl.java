/**
  * \file PnlWznmPnlHk1NControl.java
  * Java API code for job PnlWznmPnlHk1NControl
...
public class PnlWznmPnlHk1NControl {
	/**
		* VecVDo (full: VecVWznmPnlHk1NControlDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmPnlHk1NControl)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmPnlHk1NControl");
	...
	/**
	  * StatApp (full: StatAppWznmPnlHk1NControl)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmPnlHk1NControl");
	...
	/**
	  * StatShr (full: StatShrWznmPnlHk1NControl)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmPnlHk1NControl");
	...
	/**
	  * StgIac (full: StgIacWznmPnlHk1NControl)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmPnlHk1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmPnlHk1NControl";
	...
	/**
	  * Tag (full: TagWznmPnlHk1NControl)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmPnlHk1NControl");
	...
	/**
		* DpchAppData (full: DpchAppWznmPnlHk1NControlData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPNLHK1NCONTROLDATA, scrJref);
		...
		public QryWznmPnlHk1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPnlHk1NControlData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmPnlHk1NControlDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMPNLHK1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmPnlHk1NControlDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmPnlHk1NControlData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMPNLHK1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQPnlHk1NControl();
			statappqry = (new QryWznmPnlHk1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmPnlHk1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmPnlHk1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQPnlHk1NControl rst;
		public QryWznmPnlHk1NControl.StatApp statappqry;
		public QryWznmPnlHk1NControl.StatShr statshrqry;
		public QryWznmPnlHk1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmPnlHk1NControlData");
