/**
  * \file QryWznmLibAMakefile.java
  * Java API code for job QryWznmLibAMakefile
...
public class QryWznmLibAMakefile {
	/**
	  * StatApp (full: StatAppQryWznmLibAMakefile)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmLibAMakefile");
	...
	/**
	  * StatShr (full: StatShrQryWznmLibAMakefile)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmLibAMakefile");
	...
	/**
	  * StgIac (full: StgIacQryWznmLibAMakefile)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmLibAMakefile");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmLibAMakefile";
