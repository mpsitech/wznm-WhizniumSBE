/**
  * \file PnlWznmCarHk1NControl.java
  * Java API code for job PnlWznmCarHk1NControl
...
public class PnlWznmCarHk1NControl {
	/**
		* VecVDo (full: VecVWznmCarHk1NControlDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmCarHk1NControl)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCarHk1NControl");
	...
	/**
	  * StatApp (full: StatAppWznmCarHk1NControl)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCarHk1NControl");
	...
	/**
	  * StatShr (full: StatShrWznmCarHk1NControl)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCarHk1NControl");
	...
	/**
	  * StgIac (full: StgIacWznmCarHk1NControl)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCarHk1NControl");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCarHk1NControl";
	...
	/**
	  * Tag (full: TagWznmCarHk1NControl)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCarHk1NControl");
	...
	/**
		* DpchAppData (full: DpchAppWznmCarHk1NControlData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARHK1NCONTROLDATA, scrJref);
		...
		public QryWznmCarHk1NControl.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarHk1NControlData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmCarHk1NControlDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCARHK1NCONTROLDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCarHk1NControlDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmCarHk1NControlData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCARHK1NCONTROLDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQCarHk1NControl();
			statappqry = (new QryWznmCarHk1NControl()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCarHk1NControl()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCarHk1NControl()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCarHk1NControl rst;
		public QryWznmCarHk1NControl.StatApp statappqry;
		public QryWznmCarHk1NControl.StatShr statshrqry;
		public QryWznmCarHk1NControl.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCarHk1NControlData");
