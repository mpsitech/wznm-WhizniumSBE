/**
  * \file QryWznmOpkSqkMNStub.java
  * Java API code for job QryWznmOpkSqkMNStub
...
public class QryWznmOpkSqkMNStub {
	/**
	  * StatApp (full: StatAppQryWznmOpkSqkMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmOpkSqkMNStub");
	...
	/**
	  * StatShr (full: StatShrQryWznmOpkSqkMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmOpkSqkMNStub");
	...
	/**
	  * StgIac (full: StgIacQryWznmOpkSqkMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmOpkSqkMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmOpkSqkMNStub";
