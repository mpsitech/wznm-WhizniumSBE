/**
  * \file QryWznmIexRef1NDialog.java
  * Java API code for job QryWznmIexRef1NDialog
...
public class QryWznmIexRef1NDialog {
	/**
	  * StatApp (full: StatAppQryWznmIexRef1NDialog)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmIexRef1NDialog");
	...
	/**
	  * StatShr (full: StatShrQryWznmIexRef1NDialog)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmIexRef1NDialog");
	...
	/**
	  * StgIac (full: StgIacQryWznmIexRef1NDialog)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmIexRef1NDialog");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmIexRef1NDialog";
