/**
  * \file DlgWznmVerGlobal.java
  * Java API code for job DlgWznmVerGlobal
...
public class DlgWznmVerGlobal {
	/**
		* VecVDit (full: VecVDlgWznmVerGlobalDit)
		*/
	...
	/**
		* VecVDo (full: VecVDlgWznmVerGlobalDo)
		*/
	...
	/**
		* VecVDoImp (full: VecVDlgWznmVerGlobalDoImp)
		*/
	...
	/**
		* VecVDoPpr (full: VecVDlgWznmVerGlobalDoPpr)
		*/
	...
	/**
		* VecVSge (full: VecVDlgWznmVerGlobalSge)
		*/
	...
	/**
	  * ContIac (full: ContIacDlgWznmVerGlobal)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWznmVerGlobal");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWznmVerGlobal";
	...
	/**
	  * ContInf (full: ContInfDlgWznmVerGlobal)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerGlobal");
	...
	/**
	  * ContInfImp (full: ContInfDlgWznmVerGlobalImp)
	  */
	public class ContInfImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerGlobalImp");
	...
	/**
	  * ContInfLfi (full: ContInfDlgWznmVerGlobalLfi)
	  */
	public class ContInfLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerGlobalLfi");
	...
	/**
	  * ContInfPpr (full: ContInfDlgWznmVerGlobalPpr)
	  */
	public class ContInfPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWznmVerGlobalPpr");
	...
	/**
	  * StatApp (full: StatAppDlgWznmVerGlobal)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWznmVerGlobal");
	...
	/**
	  * StatShr (full: StatShrDlgWznmVerGlobal)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerGlobal");
	...
	/**
	  * StatShrIfi (full: StatShrDlgWznmVerGlobalIfi)
	  */
	public class StatShrIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerGlobalIfi");
	...
	/**
	  * StatShrImp (full: StatShrDlgWznmVerGlobalImp)
	  */
	public class StatShrImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerGlobalImp");
	...
	/**
	  * StatShrLfi (full: StatShrDlgWznmVerGlobalLfi)
	  */
	public class StatShrLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerGlobalLfi");
	...
	/**
	  * StatShrPpr (full: StatShrDlgWznmVerGlobalPpr)
	  */
	public class StatShrPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWznmVerGlobalPpr");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerGlobal");
	...
	/**
	  * TagIfi (full: TagDlgWznmVerGlobalIfi)
	  */
	public class TagIfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerGlobalIfi");
	...
	/**
	  * TagImp (full: TagDlgWznmVerGlobalImp)
	  */
	public class TagImp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerGlobalImp");
	...
	/**
	  * TagLfi (full: TagDlgWznmVerGlobalLfi)
	  */
	public class TagLfi extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerGlobalLfi");
	...
	/**
	  * TagPpr (full: TagDlgWznmVerGlobalPpr)
	  */
	public class TagPpr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWznmVerGlobalPpr");
	...
	/**
		* DpchAppData (full: DpchAppDlgWznmVerGlobalData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERGLOBALDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerGlobalData");
	...
	/**
		* DpchAppDo (full: DpchAppDlgWznmVerGlobalDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPDLGWZNMVERGLOBALDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWznmVerGlobalDo");
	...
	/**
		* DpchEngData (full: DpchEngDlgWznmVerGlobalData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGDLGWZNMVERGLOBALDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWznmVerGlobalData");
