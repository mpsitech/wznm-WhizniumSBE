/**
  * \file PnlWznmVer1NImpexpcplx.java
  * Java API code for job PnlWznmVer1NImpexpcplx
...
public class PnlWznmVer1NImpexpcplx {
	/**
		* VecVDo (full: VecVWznmVer1NImpexpcplxDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmVer1NImpexpcplx)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmVer1NImpexpcplx");
	...
	/**
	  * StatApp (full: StatAppWznmVer1NImpexpcplx)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmVer1NImpexpcplx");
	...
	/**
	  * StatShr (full: StatShrWznmVer1NImpexpcplx)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmVer1NImpexpcplx");
	...
	/**
	  * StgIac (full: StgIacWznmVer1NImpexpcplx)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmVer1NImpexpcplx");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmVer1NImpexpcplx";
	...
	/**
	  * Tag (full: TagWznmVer1NImpexpcplx)
	  */
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmVer1NImpexpcplx");
	...
	/**
		* DpchAppData (full: DpchAppWznmVer1NImpexpcplxData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NIMPEXPCPLXDATA, scrJref);
		...
		public QryWznmVer1NImpexpcplx.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NImpexpcplxData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmVer1NImpexpcplxDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMVER1NIMPEXPCPLXDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmVer1NImpexpcplxDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmVer1NImpexpcplxData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMVER1NIMPEXPCPLXDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQVer1NImpexpcplx();
			statappqry = (new QryWznmVer1NImpexpcplx()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmVer1NImpexpcplx()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmVer1NImpexpcplx()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQVer1NImpexpcplx rst;
		public QryWznmVer1NImpexpcplx.StatApp statappqry;
		public QryWznmVer1NImpexpcplx.StatShr statshrqry;
		public QryWznmVer1NImpexpcplx.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmVer1NImpexpcplxData");
