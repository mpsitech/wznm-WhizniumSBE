/**
  * \file PnlWznmSgeSqkMNStub.java
  * Java API code for job PnlWznmSgeSqkMNStub
...
public class PnlWznmSgeSqkMNStub {
	/**
		* VecVDo (full: VecVWznmSgeSqkMNStubDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmSgeSqkMNStub)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmSgeSqkMNStub");
	...
	/**
	  * StatApp (full: StatAppWznmSgeSqkMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmSgeSqkMNStub");
	...
	/**
	  * StatShr (full: StatShrWznmSgeSqkMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmSgeSqkMNStub");
	...
	/**
	  * StgIac (full: StgIacWznmSgeSqkMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmSgeSqkMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmSgeSqkMNStub";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmSgeSqkMNStub");
	...
	/**
		* DpchAppData (full: DpchAppWznmSgeSqkMNStubData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSGESQKMNSTUBDATA, scrJref);
		...
		public QryWznmSgeSqkMNStub.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSgeSqkMNStubData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmSgeSqkMNStubDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMSGESQKMNSTUBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmSgeSqkMNStubDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmSgeSqkMNStubData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMSGESQKMNSTUBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQSgeSqkMNStub();
			statappqry = (new QryWznmSgeSqkMNStub()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmSgeSqkMNStub()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmSgeSqkMNStub()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQSgeSqkMNStub rst;
		public QryWznmSgeSqkMNStub.StatApp statappqry;
		public QryWznmSgeSqkMNStub.StatShr statshrqry;
		public QryWznmSgeSqkMNStub.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmSgeSqkMNStubData");
