/**
  * \file QryWznmShtList.java
  * Java API code for job QryWznmShtList
...
public class QryWznmShtList {
	/**
		* VecVOrd (full: VecVQryWznmShtListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWznmShtList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmShtList");

			String itemtag = "StatitemAppQryWznmShtList";
	...
	/**
	  * StatShr (full: StatShrQryWznmShtList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmShtList");

			String itemtag = "StatitemShrQryWznmShtList";
	...
	/**
	  * StgIac (full: StgIacQryWznmShtList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmShtList");

			String itemtag = "StgitemIacQryWznmShtList";
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmShtList";

			String itemtag;

			if (shorttags) itemtag = "Si";
			else itemtag = "StgitemIacQryWznmShtList";
