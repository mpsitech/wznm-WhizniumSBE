/**
  * \file QryWznmVecVec1NVectoritem.java
  * Java API code for job QryWznmVecVec1NVectoritem
...
public class QryWznmVecVec1NVectoritem {
	/**
	  * StatApp (full: StatAppQryWznmVecVec1NVectoritem)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmVecVec1NVectoritem");
	...
	/**
	  * StatShr (full: StatShrQryWznmVecVec1NVectoritem)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmVecVec1NVectoritem");
	...
	/**
	  * StgIac (full: StgIacQryWznmVecVec1NVectoritem)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmVecVec1NVectoritem");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmVecVec1NVectoritem";
