/**
  * \file QryWznmCalMNStub.java
  * Java API code for job QryWznmCalMNStub
...
public class QryWznmCalMNStub {
	/**
	  * StatApp (full: StatAppQryWznmCalMNStub)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmCalMNStub");
	...
	/**
	  * StatShr (full: StatShrQryWznmCalMNStub)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmCalMNStub");
	...
	/**
	  * StgIac (full: StgIacQryWznmCalMNStub)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmCalMNStub");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmCalMNStub";
