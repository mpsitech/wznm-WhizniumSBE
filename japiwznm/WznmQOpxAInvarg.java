/**
  ...
  * Java API code for record of table TblWznmQOpxAInvarg
...
public class WznmQOpxAInvarg {
	
	public WznmQOpxAInvarg(
				int jnum
				, String sref
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "WznmQOpxAInvarg");
