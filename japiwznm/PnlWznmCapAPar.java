/**
  * \file PnlWznmCapAPar.java
  * Java API code for job PnlWznmCapAPar
...
public class PnlWznmCapAPar {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmCapAPar");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmCapAPar");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmCapAPar");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmCapAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmCapAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmCapAPar");
	...
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAPAPARDATA, scrJref);
		...
		public QryWznmCapAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCapAParData");
	...
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMCAPAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmCapAParDo");
	...
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMCAPAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWznmQCapAPar();
			statappqry = (new QryWznmCapAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmCapAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmCapAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQCapAPar rst;
		public QryWznmCapAPar.StatApp statappqry;
		public QryWznmCapAPar.StatShr statshrqry;
		public QryWznmCapAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmCapAParData");
