/**
  * \file PnlWznmQcoList.java
  * Java API code for job PnlWznmQcoList
...
public class PnlWznmQcoList {
	/**
		* VecVDo (full: VecVWznmQcoListDo)
		*/
	...
	/**
	  * ContIac (full: ContIacWznmQcoList)
	  */
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWznmQcoList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWznmQcoList";
	...
	/**
	  * ContInf (full: ContInfWznmQcoList)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmQcoList");
	...
	/**
	  * StatShr (full: StatShrWznmQcoList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmQcoList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOQRYWIDTH = 4;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOQRYWIDTH, TCOTCOWIDTH));
		};

		public int TcoSrfWidth;
		public int TcoShoWidth;
		public int TcoTypWidth;
		public int TcoQryWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmQcoList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoQryWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoQryWidth", mask, TCOQRYWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmQcoList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoQryWidth", TcoQryWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoQryWidth == comp.TcoQryWidth) items.add(TCOQRYWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOQRYWIDTH, TCOTCOWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOQRY = 11;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOQRY, TCOTCO));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmQcoList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoQry = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoQry", mask, TCOQRY);
		...
		public HashSet<Integer> comm(
			...
			if (TcoQry.equals(comp.TcoQry)) items.add(TCOQRY);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSRF, TCOSHO, TCOTYP, TCOQRY, TCOTCO));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	/**
		* DpchAppData (full: DpchAppWznmQcoListData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQCOLISTDATA, scrJref);
		...
		public QryWznmQcoList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQcoListData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmQcoListDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMQCOLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmQcoListDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmQcoListData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMQCOLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWznmQQcoList();
			statappqry = (new QryWznmQcoList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmQcoList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmQcoList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQQcoList rst;
		public QryWznmQcoList.StatApp statappqry;
		public QryWznmQcoList.StatShr statshrqry;
		public QryWznmQcoList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmQcoListData");
