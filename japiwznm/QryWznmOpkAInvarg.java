/**
  * \file QryWznmOpkAInvarg.java
  * Java API code for job QryWznmOpkAInvarg
...
public class QryWznmOpkAInvarg {
	/**
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmOpkAInvarg");

			String itemtag = "StatitemAppQryWznmOpkAInvarg";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmOpkAInvarg");

			String itemtag = "StatitemShrQryWznmOpkAInvarg";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmOpkAInvarg");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmOpkAInvarg";
