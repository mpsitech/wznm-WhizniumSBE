/**
	* \file ContInfWznmAlert.java
	* Wznm Java API package alert informative content block
...
public class ContInfWznmAlert extends Block {
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmAlert");
