/**
  * \file PnlWznmOpkMNJob.java
  * Java API code for job PnlWznmOpkMNJob
...
public class PnlWznmOpkMNJob {
	/**
		* VecVDo (full: VecVWznmOpkMNJobDo)
		*/
	...
	/**
	  * ContInf (full: ContInfWznmOpkMNJob)
	  */
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWznmOpkMNJob");
	...
	/**
	  * StatApp (full: StatAppWznmOpkMNJob)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWznmOpkMNJob");
	...
	/**
	  * StatShr (full: StatShrWznmOpkMNJob)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWznmOpkMNJob");
	...
	/**
	  * StgIac (full: StgIacWznmOpkMNJob)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWznmOpkMNJob");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWznmOpkMNJob";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWznmOpkMNJob");
	...
	/**
		* DpchAppData (full: DpchAppWznmOpkMNJobData)
		*/
	public class DpchAppData extends DpchAppWznm {
		...
		public DpchAppData(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNJOBDATA, scrJref);
		...
		public QryWznmOpkMNJob.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNJobData");
	...
	/**
		* DpchAppDo (full: DpchAppWznmOpkMNJobDo)
		*/
	public class DpchAppDo extends DpchAppWznm {
		...
		public DpchAppDo(
			...
			super(VecWznmVDpch.DPCHAPPWZNMOPKMNJOBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWznmOpkMNJobDo");
	...
	/**
		* DpchEngData (full: DpchEngWznmOpkMNJobData)
		*/
	public class DpchEngData extends DpchEngWznm {
		...
		public DpchEngData() {
			super(VecWznmVDpch.DPCHENGWZNMOPKMNJOBDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWznmQOpkMNJob();
			statappqry = (new QryWznmOpkMNJob()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWznmOpkMNJob()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWznmOpkMNJob()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWznmQOpkMNJob rst;
		public QryWznmOpkMNJob.StatApp statappqry;
		public QryWznmOpkMNJob.StatShr statshrqry;
		public QryWznmOpkMNJob.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWznmOpkMNJobData");
