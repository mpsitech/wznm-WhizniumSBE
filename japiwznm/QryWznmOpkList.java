/**
  * \file QryWznmOpkList.java
  * Java API code for job QryWznmOpkList
...
public class QryWznmOpkList {
	/**
		* VecVOrd (full: VecVQryWznmOpkListOrd)
		*/
	...
	/**
	  * StatApp (full: StatAppQryWznmOpkList)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWznmOpkList");

			String itemtag = "StatitemAppQryWznmOpkList";
	...
	/**
	  * StatShr (full: StatShrQryWznmOpkList)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWznmOpkList");

			String itemtag = "StatitemShrQryWznmOpkList";
	...
	/**
	  * StgIac (full: StgIacQryWznmOpkList)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWznmOpkList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWznmOpkList";
