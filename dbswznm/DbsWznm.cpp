...
void DbsWznm::initMy() {
	...
	tblwznmmbox = new MyTblWznmMBox();
	((MyTblWznmMBox*) tblwznmmbox)->init(dbsMy);
	...
	tblwznmmsheet = new MyTblWznmMSheet();
	((MyTblWznmMSheet*) tblwznmmsheet)->init(dbsMy);
	...
	tblwznmmvisual = new MyTblWznmMVisual();
	((MyTblWznmMVisual*) tblwznmmvisual)->init(dbsMy);
	tblwznmrmboxmbox = new MyTblWznmRMBoxMBox();
	((MyTblWznmRMBoxMBox*) tblwznmrmboxmbox)->init(dbsMy);
	...
	tblwznmqboxdstmnbox = new MyTblWznmQBoxDstMNBox();
	((MyTblWznmQBoxDstMNBox*) tblwznmqboxdstmnbox)->init(dbsMy);
	tblwznmqboxlist = new MyTblWznmQBoxList();
	((MyTblWznmQBoxList*) tblwznmqboxlist)->init(dbsMy);
	tblwznmqboxorgmnbox = new MyTblWznmQBoxOrgMNBox();
	((MyTblWznmQBoxOrgMNBox*) tblwznmqboxorgmnbox)->init(dbsMy);
	...
	tblwznmqprjprj1nversion = new MyTblWznmQPrjPrj1NVersion();
	((MyTblWznmQPrjPrj1NVersion*) tblwznmqprjprj1nversion)->init(dbsMy);
	...
	tblwznmqsht1nbox = new MyTblWznmQSht1NBox();
	((MyTblWznmQSht1NBox*) tblwznmqsht1nbox)->init(dbsMy);
	tblwznmqshtlist = new MyTblWznmQShtList();
	((MyTblWznmQShtList*) tblwznmqshtlist)->init(dbsMy);
	...
	tblwznmqverver1nvisual = new MyTblWznmQVerVer1NVisual();
	((MyTblWznmQVerVer1NVisual*) tblwznmqverver1nvisual)->init(dbsMy);
	tblwznmqvisboxctx = new MyTblWznmQVisBoxctx();
	((MyTblWznmQVisBoxctx*) tblwznmqvisboxctx)->init(dbsMy);
	tblwznmqvislinkctx = new MyTblWznmQVisLinkctx();
	((MyTblWznmQVisLinkctx*) tblwznmqvislinkctx)->init(dbsMy);
	tblwznmqvislist = new MyTblWznmQVisList();
	((MyTblWznmQVisList*) tblwznmqvislist)->init(dbsMy);
	tblwznmqvisref1nfile = new MyTblWznmQVisRef1NFile();
	((MyTblWznmQVisRef1NFile*) tblwznmqvisref1nfile)->init(dbsMy);
	tblwznmqvisrowctx = new MyTblWznmQVisRowctx();
	((MyTblWznmQVisRowctx*) tblwznmqvisrowctx)->init(dbsMy);
	tblwznmqvisvis1nsheet = new MyTblWznmQVisVis1NSheet();
	((MyTblWznmQVisVis1NSheet*) tblwznmqvisvis1nsheet)->init(dbsMy);
...
void DbsWznm::initPg() {
	...
	tblwznmmbox = new PgTblWznmMBox();
	((PgTblWznmMBox*) tblwznmmbox)->init(dbsPg);
	...
	tblwznmmsheet = new PgTblWznmMSheet();
	((PgTblWznmMSheet*) tblwznmmsheet)->init(dbsPg);
	...
	tblwznmmvisual = new PgTblWznmMVisual();
	((PgTblWznmMVisual*) tblwznmmvisual)->init(dbsPg);
	tblwznmrmboxmbox = new PgTblWznmRMBoxMBox();
	((PgTblWznmRMBoxMBox*) tblwznmrmboxmbox)->init(dbsPg);
	...
	tblwznmqboxdstmnbox = new PgTblWznmQBoxDstMNBox();
	((PgTblWznmQBoxDstMNBox*) tblwznmqboxdstmnbox)->init(dbsPg);
	tblwznmqboxlist = new PgTblWznmQBoxList();
	((PgTblWznmQBoxList*) tblwznmqboxlist)->init(dbsPg);
	tblwznmqboxorgmnbox = new PgTblWznmQBoxOrgMNBox();
	((PgTblWznmQBoxOrgMNBox*) tblwznmqboxorgmnbox)->init(dbsPg);
	...
	tblwznmqprjprj1nversion = new PgTblWznmQPrjPrj1NVersion();
	((PgTblWznmQPrjPrj1NVersion*) tblwznmqprjprj1nversion)->init(dbsPg);
	...
	tblwznmqsht1nbox = new PgTblWznmQSht1NBox();
	((PgTblWznmQSht1NBox*) tblwznmqsht1nbox)->init(dbsPg);
	tblwznmqshtlist = new PgTblWznmQShtList();
	((PgTblWznmQShtList*) tblwznmqshtlist)->init(dbsPg);
	...
	tblwznmqverver1nvisual = new PgTblWznmQVerVer1NVisual();
	((PgTblWznmQVerVer1NVisual*) tblwznmqverver1nvisual)->init(dbsPg);
	tblwznmqvisboxctx = new PgTblWznmQVisBoxctx();
	((PgTblWznmQVisBoxctx*) tblwznmqvisboxctx)->init(dbsPg);
	tblwznmqvislinkctx = new PgTblWznmQVisLinkctx();
	((PgTblWznmQVisLinkctx*) tblwznmqvislinkctx)->init(dbsPg);
	tblwznmqvislist = new PgTblWznmQVisList();
	((PgTblWznmQVisList*) tblwznmqvislist)->init(dbsPg);
	tblwznmqvisref1nfile = new PgTblWznmQVisRef1NFile();
	((PgTblWznmQVisRef1NFile*) tblwznmqvisref1nfile)->init(dbsPg);
	tblwznmqvisrowctx = new PgTblWznmQVisRowctx();
	((PgTblWznmQVisRowctx*) tblwznmqvisrowctx)->init(dbsPg);
	tblwznmqvisvis1nsheet = new PgTblWznmQVisVis1NSheet();
	((PgTblWznmQVisVis1NSheet*) tblwznmqvisvis1nsheet)->init(dbsPg);
...
uint DbsWznm::getIxWSubsetByWznmMComponent(
	...
	if ((dneIxWSubset & TblWznmMComponent::VecWSubset::SBSWZNMBMCOMPONENTCCP) == 0) {
		a = false; a = (rec->ixVBasetype == VecWznmVMComponentBasetype::VUEAPP);
		args.push_back(a);
