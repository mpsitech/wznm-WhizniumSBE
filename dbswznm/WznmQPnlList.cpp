...
void WznmQPnlList::writeJSON(
	...
	if (shorttags) {
		...
		me["stubCarRefWznmMCard"] = stubCarRefWznmMCard;
...
void ListWznmQPnlList::writeJSON(
			Json::Value& sup
			, std::string difftag
		) {
	if (difftag == "") difftag = "ListWznmQPnlList";
