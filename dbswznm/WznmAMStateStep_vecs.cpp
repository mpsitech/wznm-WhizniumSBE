/**
	* \file WznmAMStateStep_vecs.cpp
	* database access for table TblWznmAMStateStep (implementation of vectors)
...
/******************************************************************************
 class TblWznmAMStateStep::VecVTrigger
 ******************************************************************************/

uint TblWznmAMStateStep::VecVTrigger::getIx(
			const string& sref
		) {
...
string TblWznmAMStateStep::VecVTrigger::getSref(
			const uint ix
		) {
...
string TblWznmAMStateStep::VecVTrigger::getTitle(
			const uint ix
...
void TblWznmAMStateStep::VecVTrigger::fillFeed(
			const uint ixWznmVLocale
			, Feed& feed
		) {
	feed.clear();
