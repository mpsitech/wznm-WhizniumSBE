...
/******************************************************************************
 namespace WznmPrctree
 ******************************************************************************/

// IP cust --- IBEGIN
/******************************************************************************
 namespace WznmPrctree::Ipformat
 ******************************************************************************/

unsigned int WznmPrctree::Ipformat::get(
			const string& path
			, bool& ip
		) {
...
void WznmPrctree::Ipformat::getPrefixInfixPostfix(
...
/******************************************************************************
 namespace WznmPrctree::Iptype
 ******************************************************************************/

unsigned int WznmPrctree::Iptype::get(
			string s
		) {
...
void WznmPrctree::readFileContent(
			const string& path
			, vector<Ip*>& ips
