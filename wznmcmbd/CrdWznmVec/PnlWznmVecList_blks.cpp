/**
	* \file PnlWznmVecList_blks.cpp
	* job handler for job PnlWznmVecList (implementation of blocks)
...
/******************************************************************************
 class PnlWznmVecList::VecVDo
 ******************************************************************************/

uint PnlWznmVecList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmVecList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmVecList::ContIac
 ******************************************************************************/

PnlWznmVecList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWznmVecList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmVecList"];}();
...
bool PnlWznmVecList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWznmVecList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWznmVecList";
...
void PnlWznmVecList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWznmVecList";
...
void PnlWznmVecList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWznmVecList";
...
set<uint> PnlWznmVecList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVecList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVecList::ContInf
 ******************************************************************************/

PnlWznmVecList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWznmVecList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmVecList";
...
void PnlWznmVecList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmVecList";
...
set<uint> PnlWznmVecList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVecList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVecList::StatShr
 ******************************************************************************/

PnlWznmVecList::StatShr::StatShr(
...
void PnlWznmVecList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmVecList";
...
void PnlWznmVecList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmVecList";
...
set<uint> PnlWznmVecList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVecList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
PnlWznmVecList::StgIac::StgIac(
			...
			, TcoTgrWidth(TcoTgrWidth)
		{
	mask = {TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOHKTWIDTH, TCOHKUWIDTH, TCOTGRWIDTH};
};

bool PnlWznmVecList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmVecList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoTgrWidth")) {TcoTgrWidth = me["TcoTgrWidth"].asUInt(); add(TCOTGRWIDTH);};
	};

	return basefound;
};

bool PnlWznmVecList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmVecList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmVecList";
	...
	if (basefound) {
		...
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Si", "sref", "TcoTgrWidth", TcoTgrWidth)) add(TCOTGRWIDTH);
	};

	return basefound;
};

void PnlWznmVecList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmVecList";
	...
	me["TcoTgrWidth"] = (Json::Value::UInt) TcoTgrWidth;
};

void PnlWznmVecList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmVecList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		...
		writeUintAttr(wr, itemtag, "sref", "TcoTgrWidth", TcoTgrWidth);
	xmlTextWriterEndElement(wr);
};

set<uint> PnlWznmVecList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
	...
	if (TcoTgrWidth == comp->TcoTgrWidth) insert(items, TCOTGRWIDTH);

	return(items);
};

set<uint> PnlWznmVecList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOHKTWIDTH, TCOHKUWIDTH, TCOTGRWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWznmVecList::Tag
 ******************************************************************************/

void PnlWznmVecList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmVecList";
...
void PnlWznmVecList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmVecList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoTgr", "Tags");
		};
...
/******************************************************************************
 class PnlWznmVecList::DpchAppData
 ******************************************************************************/

PnlWznmVecList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVECLISTDATA)
		{
};

string PnlWznmVecList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVecList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVecListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWznmVecList::StgIac();
	};
};

void PnlWznmVecList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmVecListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmVecList::DpchAppDo
 ******************************************************************************/

PnlWznmVecList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVECLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmVecList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVecList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVecListDo"];}();
...
void PnlWznmVecList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmVecListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmVecList::DpchEngData
 ******************************************************************************/

PnlWznmVecList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWznmVecList::StatShr* statshrqry
			, QryWznmVecList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMVECLISTDATA, jref)
		{
...
string PnlWznmVecList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVecList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmVecList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmVecListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmVecList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmVecList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmVecListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmVecList::StatApp::writeXML(wr);
