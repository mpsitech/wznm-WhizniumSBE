/**
	...
	* job handler for job PnlWznmVecSrc1NFeed (declarations)
...
/**
	* PnlWznmVecSrc1NFeed
	*/
class PnlWznmVecSrc1NFeed : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecSrc1NFeed* rst = NULL, QryWznmVecSrc1NFeed::StatShr* statshrqry = NULL, QryWznmVecSrc1NFeed::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVecSrc1NFeed(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVecSrc1NFeed();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVecSrc1NFeed::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
