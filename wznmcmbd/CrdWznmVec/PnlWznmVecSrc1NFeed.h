...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecSrc1NFeed* rst = NULL, QryWznmVecSrc1NFeed::StatShr* statshrqry = NULL, QryWznmVecSrc1NFeed::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
