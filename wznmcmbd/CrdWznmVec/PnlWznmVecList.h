/**
	* \file PnlWznmVecList.h
	* job handler for job PnlWznmVecList (declarations)
...
#ifndef PNLWZNMVECLIST_H
#define PNLWZNMVECLIST_H
...
#define VecVWznmVecListDo PnlWznmVecList::VecVDo

#define ContIacWznmVecList PnlWznmVecList::ContIac
#define ContInfWznmVecList PnlWznmVecList::ContInf
#define StatShrWznmVecList PnlWznmVecList::StatShr
#define StgIacWznmVecList PnlWznmVecList::StgIac
#define TagWznmVecList PnlWznmVecList::Tag

#define DpchAppWznmVecListData PnlWznmVecList::DpchAppData
#define DpchAppWznmVecListDo PnlWznmVecList::DpchAppDo
#define DpchEngWznmVecListData PnlWznmVecList::DpchEngData

/**
	* PnlWznmVecList
	*/
class PnlWznmVecList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOTGRWIDTH = 6;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoHktWidth = 100, const Sbecore::uint TcoHkuWidth = 100, const Sbecore::uint TcoTgrWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecList* rst = NULL, QryWznmVecList::StatShr* statshrqry = NULL, QryWznmVecList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVecList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVecList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVecList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
