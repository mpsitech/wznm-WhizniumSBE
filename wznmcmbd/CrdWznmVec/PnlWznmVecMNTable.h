...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecMNTable* rst = NULL, QryWznmVecMNTable::StatShr* statshrqry = NULL, QryWznmVecMNTable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
