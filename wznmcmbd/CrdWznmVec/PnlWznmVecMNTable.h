/**
	* \file PnlWznmVecMNTable.h
	* job handler for job PnlWznmVecMNTable (declarations)
...
#ifndef PNLWZNMVECMNTABLE_H
#define PNLWZNMVECMNTABLE_H
...
#define VecVWznmVecMNTableDo PnlWznmVecMNTable::VecVDo

#define ContInfWznmVecMNTable PnlWznmVecMNTable::ContInf
#define StatAppWznmVecMNTable PnlWznmVecMNTable::StatApp
#define StatShrWznmVecMNTable PnlWznmVecMNTable::StatShr
#define StgIacWznmVecMNTable PnlWznmVecMNTable::StgIac
#define TagWznmVecMNTable PnlWznmVecMNTable::Tag

#define DpchAppWznmVecMNTableData PnlWznmVecMNTable::DpchAppData
#define DpchAppWznmVecMNTableDo PnlWznmVecMNTable::DpchAppDo
#define DpchEngWznmVecMNTableData PnlWznmVecMNTable::DpchEngData

/**
	* PnlWznmVecMNTable
	*/
class PnlWznmVecMNTable : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecMNTable* rst = NULL, QryWznmVecMNTable::StatShr* statshrqry = NULL, QryWznmVecMNTable::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVecMNTable(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVecMNTable();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVecMNTable::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
