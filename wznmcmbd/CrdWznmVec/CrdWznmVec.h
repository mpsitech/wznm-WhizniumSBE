/**
	* \file CrdWznmVec.h
	* job handler for job CrdWznmVec (declarations)
...
#define VecVWznmVecDo CrdWznmVec::VecVDo
#define VecVWznmVecSge CrdWznmVec::VecVSge

#define ContInfWznmVec CrdWznmVec::ContInf
#define StatAppWznmVec CrdWznmVec::StatApp
#define StatShrWznmVec CrdWznmVec::StatShr
#define TagWznmVec CrdWznmVec::Tag

#define DpchAppWznmVecDo CrdWznmVec::DpchAppDo
#define DpchEngWznmVecData CrdWznmVec::DpchEngData

/**
	* CrdWznmVec
	*/
class CrdWznmVec : public JobWznm {

public:
	/**
		* VecVDo (full: VecVWznmVecDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppWznmVecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWznmVecData)
		*/
...
public:
	CrdWznmVec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmVec();
...
public:
	...
	PnlWznmVecRec* pnlrec;
	PnlWznmVecHeadbar* pnlheadbar;
	PnlWznmVecList* pnllist;
