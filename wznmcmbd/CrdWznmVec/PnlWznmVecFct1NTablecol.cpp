/**
	...
	* job handler for job PnlWznmVecFct1NTablecol (implementation)
...
#include "PnlWznmVecFct1NTablecol_blks.cpp"
#include "PnlWznmVecFct1NTablecol_evals.cpp"
...
/******************************************************************************
 class PnlWznmVecFct1NTablecol
 ******************************************************************************/

PnlWznmVecFct1NTablecol::PnlWznmVecFct1NTablecol(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMVECFCT1NTABLECOL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmVecFct1NTablecol(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmVecFct1NTablecol::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmVecFct1NTablecol::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmVecFct1NTablecol::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmVecFct1NTablecol::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECFCT1NTABLECOLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECFCT1NTABLECOLDO) {
...
void PnlWznmVecFct1NTablecol::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmVecFct1NTablecol::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecFct1NTablecol::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmVecFct1NTablecol::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQVecFct1NTablecol* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmVecFct1NTablecol::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmVecFct1NTablecol::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmVecFct1NTablecol::StgIac::JNUM)) {
...
void PnlWznmVecFct1NTablecol::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCTCO, jref)) if (ixPre == VecWznmVPreset::PREWZNMREFVER) {
			sref = "CrdWznmTco";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, ixPre, refPre, sref, recTco.ref, jrefNew);
		};
...
void PnlWznmVecFct1NTablecol::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmVecFct1NTablecol::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmVecFct1NTablecol::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
