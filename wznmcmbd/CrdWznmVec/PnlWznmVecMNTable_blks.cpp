...
void PnlWznmVecMNTable::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmVecMNTable::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmVecMNTable::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlWznmVecMNTable::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmVecMNTable"];}();
...
void PnlWznmVecMNTable::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmVecMNTable::Tag::writeJSON(
...
void PnlWznmVecMNTable::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVecMNTableData"];}();
...
void PnlWznmVecMNTable::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVecMNTableDo"];}();
...
void PnlWznmVecMNTable::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmVecMNTableData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmVecMNTable::StatApp::writeJSON(me);
