/**
	...
	* job handler for job PnlWznmVecATitle (implementation)
...
#include "PnlWznmVecATitle_blks.cpp"
#include "PnlWznmVecATitle_evals.cpp"
...
/******************************************************************************
 class PnlWznmVecATitle
 ******************************************************************************/

PnlWznmVecATitle::PnlWznmVecATitle(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMVECATITLE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmVecATitle(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmVecATitle::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmVecATitle::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmVecATitle::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECATITLEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECATITLEDO) {
...
void PnlWznmVecATitle::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmVecATitle::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecATitle::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmVecATitle::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQVecATitle* recSelNew = NULL;

	WznmAMVectorTitle* _recVecAtit = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmVecATitle::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmVecATitle::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmVecATitle::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recVecAtit = WznmAMVectorTitle();

			if (recSelNew) {
				if (dbswznm->tblwznmamvectortitle->loadRecByRef(recSelNew->ref, &_recVecAtit)) {
					recVecAtit = *_recVecAtit;
					delete _recVecAtit;
				};
			};
...
void PnlWznmVecATitle::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecATitle::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecATitle::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecATitle::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmVecATitle::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmVecATitle::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
