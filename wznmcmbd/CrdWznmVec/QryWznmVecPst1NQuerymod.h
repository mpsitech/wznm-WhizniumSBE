...
#define StatAppQryWznmVecPst1NQuerymod QryWznmVecPst1NQuerymod::StatApp
#define StatShrQryWznmVecPst1NQuerymod QryWznmVecPst1NQuerymod::StatShr
#define StgIacQryWznmVecPst1NQuerymod QryWznmVecPst1NQuerymod::StgIac

/**
	* QryWznmVecPst1NQuerymod
	*/
class QryWznmVecPst1NQuerymod : public JobWznm {
...
public:
	QryWznmVecPst1NQuerymod(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmVecPst1NQuerymod();
...
public:
	...
	WznmQVecPst1NQuerymod* getRecByJnum(const Sbecore::uint jnum);
