/**
	* \file PnlWznmVecVec1NVectoritem.h
	* job handler for job PnlWznmVecVec1NVectoritem (declarations)
...
#ifndef PNLWZNMVECVEC1NVECTORITEM_H
#define PNLWZNMVECVEC1NVECTORITEM_H
...
#define VecVWznmVecVec1NVectoritemDo PnlWznmVecVec1NVectoritem::VecVDo

#define ContInfWznmVecVec1NVectoritem PnlWznmVecVec1NVectoritem::ContInf
#define StatAppWznmVecVec1NVectoritem PnlWznmVecVec1NVectoritem::StatApp
#define StatShrWznmVecVec1NVectoritem PnlWznmVecVec1NVectoritem::StatShr
#define StgIacWznmVecVec1NVectoritem PnlWznmVecVec1NVectoritem::StgIac
#define TagWznmVecVec1NVectoritem PnlWznmVecVec1NVectoritem::Tag

#define DpchAppWznmVecVec1NVectoritemData PnlWznmVecVec1NVectoritem::DpchAppData
#define DpchAppWznmVecVec1NVectoritemDo PnlWznmVecVec1NVectoritem::DpchAppDo
#define DpchEngWznmVecVec1NVectoritemData PnlWznmVecVec1NVectoritem::DpchEngData

/**
	* PnlWznmVecVec1NVectoritem
	*/
class PnlWznmVecVec1NVectoritem : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecVec1NVectoritem* rst = NULL, QryWznmVecVec1NVectoritem::StatShr* statshrqry = NULL, QryWznmVecVec1NVectoritem::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVecVec1NVectoritem(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVecVec1NVectoritem();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVecVec1NVectoritem::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
