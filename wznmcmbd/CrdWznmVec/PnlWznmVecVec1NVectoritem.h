...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVecVec1NVectoritem* rst = NULL, QryWznmVecVec1NVectoritem::StatShr* statshrqry = NULL, QryWznmVecVec1NVectoritem::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
