/**
	...
	* job handler for job PnlWznmVecPst1NQuerymod (implementation)
...
#include "PnlWznmVecPst1NQuerymod_blks.cpp"
#include "PnlWznmVecPst1NQuerymod_evals.cpp"
...
/******************************************************************************
 class PnlWznmVecPst1NQuerymod
 ******************************************************************************/

PnlWznmVecPst1NQuerymod::PnlWznmVecPst1NQuerymod(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMVECPST1NQUERYMOD, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmVecPst1NQuerymod(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmVecPst1NQuerymod::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmVecPst1NQuerymod::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmVecPst1NQuerymod::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmVecPst1NQuerymod::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECPST1NQUERYMODDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVECPST1NQUERYMODDO) {
...
void PnlWznmVecPst1NQuerymod::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmVecPst1NQuerymod::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVecPst1NQuerymod::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmVecPst1NQuerymod::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQVecPst1NQuerymod* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmVecPst1NQuerymod::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmVecPst1NQuerymod::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmVecPst1NQuerymod::StgIac::JNUM)) {
...
void PnlWznmVecPst1NQuerymod::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmVecPst1NQuerymod::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmVecPst1NQuerymod::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmVecPst1NQuerymod::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
