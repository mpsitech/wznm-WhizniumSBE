/**
	...
	* job handler for job PnlWznmSteATrig (implementation)
...
#include "PnlWznmSteATrig_blks.cpp"
#include "PnlWznmSteATrig_evals.cpp"
...
/******************************************************************************
 class PnlWznmSteATrig
 ******************************************************************************/

PnlWznmSteATrig::PnlWznmSteATrig(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSTEATRIG, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSteATrig(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSteATrig::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSteATrig::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSteATrig::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTEATRIGDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTEATRIGDO) {
...
void PnlWznmSteATrig::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSteATrig::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteATrig::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSteATrig::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSteATrig* recSelNew = NULL;

	WznmAMStateTrig* _recSteAtrg = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSteATrig::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSteATrig::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSteATrig::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recSteAtrg = WznmAMStateTrig();

			if (recSelNew) {
				if (dbswznm->tblwznmamstatetrig->loadRecByRef(recSelNew->ref, &_recSteAtrg)) {
					recSteAtrg = *_recSteAtrg;
					delete _recSteAtrg;
				};
			};
...
void PnlWznmSteATrig::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteATrig::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteATrig::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteATrig::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSteATrig::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSteATrig::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
