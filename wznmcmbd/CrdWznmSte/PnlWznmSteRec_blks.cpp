...
void PnlWznmSteRec::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmSteRec";
...
void PnlWznmSteRec::StatApp::writeXML(
	...
	else itemtag = "StatitemAppWznmSteRec";
...
PnlWznmSteRec::StatShr::StatShr(
			...
			, jrefAAction(jrefAAction)
			, jrefATrig(jrefATrig)
			, ButRegularizeActive(ButRegularizeActive)
		{
	mask = {IXWZNMVEXPSTATE, JREFDETAIL, JREFAACTION, JREFATRIG, BUTREGULARIZEACTIVE};
};
...
void PnlWznmSteRec::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmSteRec";
...
set<uint> PnlWznmSteRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, JREFDETAIL, JREFAACTION, JREFATRIG, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
void PnlWznmSteRec::Tag::writeXML(
	...
	else itemtag = "TagitemWznmSteRec";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "State");
		};
	xmlTextWriterEndElement(wr);
};
...
PnlWznmSteRec::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTERECDO)
		{
	ixVDo = 0;
};
...
void PnlWznmSteRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmSteRecDo"];}();
...
void PnlWznmSteRec::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmSteRecDo");
	else
...
PnlWznmSteRec::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSTERECDATA, jref)
		{
...
void PnlWznmSteRec::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmSteRec::DpchEngData::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmSteRecData");
