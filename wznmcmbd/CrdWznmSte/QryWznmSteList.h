/**
	...
	* job handler for job QryWznmSteList (declarations)
...
#define QRYWZNMSTELIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmSteListOrd QryWznmSteList::VecVOrd

#define StatAppQryWznmSteList QryWznmSteList::StatApp
#define StatShrQryWznmSteList QryWznmSteList::StatShr
#define StgIacQryWznmSteList QryWznmSteList::StgIac

/**
	* QryWznmSteList
	*/
class QryWznmSteList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmSteListOrd)
		*/
	class VecVOrd {

	public:
		static const Sbecore::uint SEQ = 1;
	...
	/**
		* StatApp (full: StatAppQryWznmSteList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmSteList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmSteList)
		*/
...
public:
	QryWznmSteList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmSteList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preSeq, const bool addwhere);
	...
	WznmQSteList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWznmSteMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
