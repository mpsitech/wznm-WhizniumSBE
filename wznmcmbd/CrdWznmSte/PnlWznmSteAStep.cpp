/**
	...
	* job handler for job PnlWznmSteAStep (implementation)
...
#include "PnlWznmSteAStep_blks.cpp"
#include "PnlWznmSteAStep_evals.cpp"
...
/******************************************************************************
 class PnlWznmSteAStep
 ******************************************************************************/

PnlWznmSteAStep::PnlWznmSteAStep(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSTEASTEP, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSteAStep(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSteAStep::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSteAStep::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSteAStep::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTEASTEPDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTEASTEPDO) {
...
void PnlWznmSteAStep::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSteAStep::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteAStep::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSteAStep::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSteAStep* recSelNew = NULL;

	WznmAMStateStep* _recSteAstp = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSteAStep::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSteAStep::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSteAStep::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recSteAstp = WznmAMStateStep();

			if (recSelNew) {
				if (dbswznm->tblwznmamstatestep->loadRecByRef(recSelNew->ref, &_recSteAstp)) {
					recSteAstp = *_recSteAstp;
					delete _recSteAstp;
				};
			};
...
void PnlWznmSteAStep::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteAStep::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteAStep::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSteAStep::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSteAStep::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSteAStep::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
