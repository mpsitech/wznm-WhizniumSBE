/**
	...
	* job handler for job PnlWznmSteATrig (declarations)
...
/**
	* PnlWznmSteATrig
	*/
class PnlWznmSteATrig : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSteATrig* rst = NULL, QryWznmSteATrig::StatShr* statshrqry = NULL, QryWznmSteATrig::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSteATrig(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSteATrig();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSteATrig::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
