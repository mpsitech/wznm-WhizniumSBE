...
#include "PnlWznmConSup1NControl_blks.cpp"
#include "PnlWznmConSup1NControl_evals.cpp"
...
/******************************************************************************
 class PnlWznmConSup1NControl
 ******************************************************************************/

PnlWznmConSup1NControl::PnlWznmConSup1NControl(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCONSUP1NCONTROL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmConSup1NControl(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmConSup1NControl::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmConSup1NControl::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCONSUP1NCONTROLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCONSUP1NCONTROLDO) {
...
void PnlWznmConSup1NControl::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmConSup1NControl::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmConSup1NControl::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmConSup1NControl::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQConSup1NControl* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (!has(diffitems, QryWznmConSup1NControl::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmConSup1NControl::StgIac::JNUM)) {
...
void PnlWznmConSup1NControl::handleDpchAppDoButUpClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmConSup1NControl::handleDpchAppDoButDownClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmConSup1NControl::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmConSup1NControl::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmConSup1NControl::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmConSup1NControl::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
