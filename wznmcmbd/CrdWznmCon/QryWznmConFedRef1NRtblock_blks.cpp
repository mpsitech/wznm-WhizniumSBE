/**
	* \file QryWznmConFedRef1NRtblock_blks.cpp
	* job handler for job QryWznmConFedRef1NRtblock (implementation of blocks)
...
void QryWznmConFedRef1NRtblock::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmConFedRef1NRtblock";
...
void QryWznmConFedRef1NRtblock::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmConFedRef1NRtblock";
...
void QryWznmConFedRef1NRtblock::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmConFedRef1NRtblock";
...
void QryWznmConFedRef1NRtblock::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmConFedRef1NRtblock";
...
bool QryWznmConFedRef1NRtblock::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmConFedRef1NRtblock"];}();
...
void QryWznmConFedRef1NRtblock::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
