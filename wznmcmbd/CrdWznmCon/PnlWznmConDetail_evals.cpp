...
bool PnlWznmConDetail::evalButHkuViewAvail(
	...
	// con.hkuEq(0)|((pre.ixCrdaccPnl()&con.hktEq(pnl)&pre.refCar())|(pre.ixCrdaccPnl()&con.hktEq(pnl)&pre.refVer())|(pre.ixCrdaccDlg()&con.hktEq(dlg)&pre.refCar())|(pre.ixCrdaccDlg()&con.hktEq(dlg)&pre.refVer())|(pre.ixCrdaccCar()&con.hktEq(car)&pre.refVer()))
...
bool PnlWznmConDetail::evalButReuViewAvail(
	...
	// con.reuEq(0)|((pre.ixCrdaccDlg()&con.retEq(dlg)&pre.refCar())|(pre.ixCrdaccDlg()&con.retEq(dlg)&pre.refVer())|(pre.ixCrdaccQco()&con.retEq(qco)&pre.refVer())|(pre.ixCrdaccRel()&con.retEq(rel)&pre.refVer()))
