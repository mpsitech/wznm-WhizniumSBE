...
bool PnlWznmConDetail::evalButHkuViewAvail(
	...
	// con.hkuEq(0)|((pre.ixCrdaccDlg()&con.hktEq(dlg)&pre.refCar())|(pre.ixCrdaccDlg()&con.hktEq(dlg)&pre.refVer())|(pre.ixCrdaccPnl()&con.hktEq(pnl)&pre.refCar())|(pre.ixCrdaccPnl()&con.hktEq(pnl)&pre.refVer())|(pre.ixCrdaccCar()&con.hktEq(car)&pre.refVer()))
