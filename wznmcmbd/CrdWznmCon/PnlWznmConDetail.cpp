...
void PnlWznmConDetail::refreshTag(
	...
	StrMod::srefsToVector(contiac.TxfTag, ss);
...
void PnlWznmConDetail::refreshFedVit(
	...
	StrMod::srefsToVector(contiac.TxfFedVit, ss);
...
void PnlWznmConDetail::refreshFedTag(
	...
	StrMod::srefsToVector(contiac.TxfFedTag, ss);
...
void PnlWznmConDetail::handleCall(
	...
	if (call->ixVCall == VecWznmVCall::CALLWZNMCONJTITMOD_CONEQ) {
