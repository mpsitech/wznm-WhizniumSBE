...
/**
	* PnlWznmConRec
	*/
class PnlWznmConRec : public JobWznm {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneAPar = false, const bool initdoneSup1NControl = false, const bool initdoneFedRef1NRtblock = false);
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneAPar = false, const bool initdoneSup1NControl = false, const bool initdoneFedRef1NRtblock = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREFSUP1NCONTROL = 4;
		static const Sbecore::uint JREFFEDREF1NRTBLOCK = 5;
		static const Sbecore::uint PNLFEDREF1NRTBLOCKAVAIL = 6;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 7;

	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefAPar = 0, const Sbecore::ubigint jrefSup1NControl = 0, const Sbecore::ubigint jrefFedRef1NRtblock = 0, const bool pnlfedref1nrtblockAvail = false, const bool ButRegularizeActive = true);

	public:
		Sbecore::uint ixWznmVExpstate;
		Sbecore::ubigint jrefDetail;
		Sbecore::ubigint jrefAPar;
		Sbecore::ubigint jrefSup1NControl;
		Sbecore::ubigint jrefFedRef1NRtblock;
	...
	bool evalPnlfedref1nrtblockAvail(DbsWznm* dbswznm);
	bool evalButRegularizeActive(DbsWznm* dbswznm);

public:
	PnlWznmConRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmConRec();
