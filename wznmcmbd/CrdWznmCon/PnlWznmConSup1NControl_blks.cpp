/**
	* \file PnlWznmConSup1NControl_blks.cpp
	* job handler for job PnlWznmConSup1NControl (implementation of blocks)
...
void PnlWznmConSup1NControl::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmConSup1NControl";
...
void PnlWznmConSup1NControl::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmConSup1NControl";
...
void PnlWznmConSup1NControl::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmConSup1NControl";
...
void PnlWznmConSup1NControl::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmConSup1NControl";
...
void PnlWznmConSup1NControl::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmConSup1NControl";
...
void PnlWznmConSup1NControl::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmConSup1NControl";
...
void PnlWznmConSup1NControl::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmConSup1NControl::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmConSup1NControl";
...
void PnlWznmConSup1NControl::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmConSup1NControl";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Sub-controls");
...
PnlWznmConSup1NControl::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCONSUP1NCONTROLDATA)
		{
};
...
void PnlWznmConSup1NControl::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmConSup1NControlData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmConSup1NControl::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCONSUP1NCONTROLDO)
		{
	ixVDo = 0;
};
...
void PnlWznmConSup1NControl::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmConSup1NControlDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmConSup1NControl::DpchEngData::DpchEngData(
			...
			, QryWznmConSup1NControl::StatShr* statshrqry
			, QryWznmConSup1NControl::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCONSUP1NCONTROLDATA, jref)
		{
...
void PnlWznmConSup1NControl::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmConSup1NControl::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmConSup1NControlData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmConSup1NControl::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmConSup1NControl::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmConSup1NControlData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmConSup1NControl::StatApp::writeXML(wr);
