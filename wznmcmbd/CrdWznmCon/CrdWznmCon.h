/**
	* \file CrdWznmCon.h
	* job handler for job CrdWznmCon (declarations)
...
#define VecVWznmConDo CrdWznmCon::VecVDo
#define VecVWznmConSge CrdWznmCon::VecVSge

#define ContInfWznmCon CrdWznmCon::ContInf
#define StatAppWznmCon CrdWznmCon::StatApp
#define StatShrWznmCon CrdWznmCon::StatShr
#define TagWznmCon CrdWznmCon::Tag

#define DpchAppWznmConDo CrdWznmCon::DpchAppDo
#define DpchEngWznmConData CrdWznmCon::DpchEngData

/**
	* CrdWznmCon
	*/
class CrdWznmCon : public JobWznm {
...
public:
	CrdWznmCon(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmCon();
...
public:
	...
	PnlWznmConHeadbar* pnlheadbar;
	PnlWznmConList* pnllist;
	PnlWznmConRec* pnlrec;
