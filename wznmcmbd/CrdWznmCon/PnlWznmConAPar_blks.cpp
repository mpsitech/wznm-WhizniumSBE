/**
	* \file PnlWznmConAPar_blks.cpp
	* job handler for job PnlWznmConAPar (implementation of blocks)
...
void PnlWznmConAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmConAPar";
...
void PnlWznmConAPar::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmConAPar";
...
void PnlWznmConAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmConAPar";
...
void PnlWznmConAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmConAPar";
...
void PnlWznmConAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmConAPar";
...
void PnlWznmConAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmConAPar";
...
bool PnlWznmConAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmConAPar"];}();
...
void PnlWznmConAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmConAPar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmConAPar";
...
void PnlWznmConAPar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmConAPar";
...
PnlWznmConAPar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCONAPARDATA)
		{
};
...
void PnlWznmConAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmConAParData"];}();
...
void PnlWznmConAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmConAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmConAPar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCONAPARDO)
		{
	ixVDo = 0;
};
...
void PnlWznmConAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmConAParDo"];}();
...
void PnlWznmConAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmConAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmConAPar::DpchEngData::DpchEngData(
			...
			, QryWznmConAPar::StatShr* statshrqry
			, QryWznmConAPar::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCONAPARDATA, jref)
		{
...
void PnlWznmConAPar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmConAPar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmConAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmConAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmConAPar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmConAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmConAPar::StatApp::writeXML(wr);
