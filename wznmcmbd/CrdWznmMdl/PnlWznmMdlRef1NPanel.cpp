/**
	...
	* job handler for job PnlWznmMdlRef1NPanel (implementation)
...
#include "PnlWznmMdlRef1NPanel_blks.cpp"
#include "PnlWznmMdlRef1NPanel_evals.cpp"
...
/******************************************************************************
 class PnlWznmMdlRef1NPanel
 ******************************************************************************/

PnlWznmMdlRef1NPanel::PnlWznmMdlRef1NPanel(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMMDLREF1NPANEL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmMdlRef1NPanel(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmMdlRef1NPanel::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmMdlRef1NPanel::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmMdlRef1NPanel::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmMdlRef1NPanel::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMDLREF1NPANELDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMDLREF1NPANELDO) {
...
void PnlWznmMdlRef1NPanel::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmMdlRef1NPanel::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMdlRef1NPanel::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmMdlRef1NPanel::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQMdlRef1NPanel* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmMdlRef1NPanel::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmMdlRef1NPanel::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmMdlRef1NPanel::StgIac::JNUM)) {
...
void PnlWznmMdlRef1NPanel::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmMdlRef1NPanel::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmMdlRef1NPanel::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmMdlRef1NPanel::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
