/**
	...
	* job handler for job PnlWznmMdlList (declarations)
...
/**
	* PnlWznmMdlList
	*/
class PnlWznmMdlList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMdlList* rst = NULL, QryWznmMdlList::StatShr* statshrqry = NULL, QryWznmMdlList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMdlList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMdlList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMdlList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
