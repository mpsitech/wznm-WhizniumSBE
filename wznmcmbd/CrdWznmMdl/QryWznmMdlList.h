/**
	...
	* job handler for job QryWznmMdlList (declarations)
...
#define VecVQryWznmMdlListOrd QryWznmMdlList::VecVOrd

#define StatAppQryWznmMdlList QryWznmMdlList::StatApp
#define StatShrQryWznmMdlList QryWznmMdlList::StatShr
#define StgIacQryWznmMdlList QryWznmMdlList::StgIac

/**
	* QryWznmMdlList
	*/
class QryWznmMdlList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmMdlListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmMdlList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmMdlList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmMdlList)
		*/
...
public:
	QryWznmMdlList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmMdlList();
...
public:
	...
	WznmQMdlList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWznmMdlMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
