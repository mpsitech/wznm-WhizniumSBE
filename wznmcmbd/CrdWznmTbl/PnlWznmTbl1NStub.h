...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTbl1NStub* rst = NULL, QryWznmTbl1NStub::StatShr* statshrqry = NULL, QryWznmTbl1NStub::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
