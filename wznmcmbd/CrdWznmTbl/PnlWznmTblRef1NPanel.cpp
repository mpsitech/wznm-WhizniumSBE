/**
	...
	* job handler for job PnlWznmTblRef1NPanel (implementation)
...
#include "PnlWznmTblRef1NPanel_blks.cpp"
#include "PnlWznmTblRef1NPanel_evals.cpp"
...
/******************************************************************************
 class PnlWznmTblRef1NPanel
 ******************************************************************************/

PnlWznmTblRef1NPanel::PnlWznmTblRef1NPanel(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLREF1NPANEL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblRef1NPanel(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblRef1NPanel::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblRef1NPanel::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmTblRef1NPanel::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NPanel::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NPANELDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NPANELDO) {
...
void PnlWznmTblRef1NPanel::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NPanel::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblRef1NPanel::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblRef1NPanel::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblRef1NPanel* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblRef1NPanel::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblRef1NPanel::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblRef1NPanel::StgIac::JNUM)) {
...
void PnlWznmTblRef1NPanel::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTblRef1NPanel::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblRef1NPanel::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblRef1NPanel::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
