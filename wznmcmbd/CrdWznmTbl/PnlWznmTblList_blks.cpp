/**
	* \file PnlWznmTblList_blks.cpp
	* job handler for job PnlWznmTblList (implementation of blocks)
...
/******************************************************************************
 class PnlWznmTblList::VecVDo
 ******************************************************************************/

uint PnlWznmTblList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmTblList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmTblList::ContIac
 ******************************************************************************/

PnlWznmTblList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
		{
...
bool PnlWznmTblList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmTblList"];}();
...
bool PnlWznmTblList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWznmTblList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWznmTblList";
...
void PnlWznmTblList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWznmTblList";
...
void PnlWznmTblList::ContIac::writeXML(
	...
	else itemtag = "ContitemIacWznmTblList";
...
set<uint> PnlWznmTblList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblList::ContInf
 ******************************************************************************/

PnlWznmTblList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWznmTblList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTblList";
...
void PnlWznmTblList::ContInf::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmTblList";
...
set<uint> PnlWznmTblList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblList::StatShr
 ******************************************************************************/

PnlWznmTblList::StatShr::StatShr(
...
void PnlWznmTblList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTblList";
...
void PnlWznmTblList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmTblList";
...
set<uint> PnlWznmTblList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblList::StgIac
 ******************************************************************************/

PnlWznmTblList::StgIac::StgIac(
...
bool PnlWznmTblList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTblList"];}();
...
bool PnlWznmTblList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmTblList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmTblList";
...
void PnlWznmTblList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmTblList";
...
void PnlWznmTblList::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmTblList";
...
set<uint> PnlWznmTblList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOSHOWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWznmTblList::Tag
 ******************************************************************************/

void PnlWznmTblList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTblList";
...
void PnlWznmTblList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTblList";
...
/******************************************************************************
 class PnlWznmTblList::DpchAppData
 ******************************************************************************/

PnlWznmTblList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLLISTDATA)
		{
};

string PnlWznmTblList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblListData"];}();
...
void PnlWznmTblList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTblList::DpchAppDo
 ******************************************************************************/

PnlWznmTblList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmTblList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblListDo"];}();
...
void PnlWznmTblList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTblList::DpchEngData
 ******************************************************************************/

PnlWznmTblList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTBLLISTDATA, jref)
		{
...
string PnlWznmTblList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTblList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTblListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTblList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTblList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTblListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTblList::StatApp::writeXML(wr);
