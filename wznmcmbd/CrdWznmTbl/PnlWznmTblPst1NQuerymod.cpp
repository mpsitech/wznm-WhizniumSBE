/**
	...
	* job handler for job PnlWznmTblPst1NQuerymod (implementation)
...
#include "PnlWznmTblPst1NQuerymod_blks.cpp"
#include "PnlWznmTblPst1NQuerymod_evals.cpp"
...
/******************************************************************************
 class PnlWznmTblPst1NQuerymod
 ******************************************************************************/

PnlWznmTblPst1NQuerymod::PnlWznmTblPst1NQuerymod(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLPST1NQUERYMOD, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblPst1NQuerymod(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblPst1NQuerymod::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblPst1NQuerymod::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmTblPst1NQuerymod::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblPst1NQuerymod::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLPST1NQUERYMODDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLPST1NQUERYMODDO) {
...
void PnlWznmTblPst1NQuerymod::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblPst1NQuerymod::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblPst1NQuerymod::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblPst1NQuerymod::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblPst1NQuerymod* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblPst1NQuerymod::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblPst1NQuerymod::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblPst1NQuerymod::StgIac::JNUM)) {
...
void PnlWznmTblPst1NQuerymod::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTblPst1NQuerymod::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblPst1NQuerymod::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblPst1NQuerymod::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
