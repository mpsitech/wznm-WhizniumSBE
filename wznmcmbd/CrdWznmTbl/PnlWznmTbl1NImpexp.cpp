/**
	...
	* job handler for job PnlWznmTbl1NImpexp (implementation)
...
#include "PnlWznmTbl1NImpexp_blks.cpp"
#include "PnlWznmTbl1NImpexp_evals.cpp"
...
/******************************************************************************
 class PnlWznmTbl1NImpexp
 ******************************************************************************/

PnlWznmTbl1NImpexp::PnlWznmTbl1NImpexp(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBL1NIMPEXP, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTbl1NImpexp(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTbl1NImpexp::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTbl1NImpexp::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmTbl1NImpexp::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTbl1NImpexp::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBL1NIMPEXPDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBL1NIMPEXPDO) {
...
void PnlWznmTbl1NImpexp::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTbl1NImpexp::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTbl1NImpexp::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTbl1NImpexp::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTbl1NImpexp* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTbl1NImpexp::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTbl1NImpexp::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTbl1NImpexp::StgIac::JNUM)) {
...
void PnlWznmTbl1NImpexp::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTbl1NImpexp::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTbl1NImpexp::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTbl1NImpexp::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
