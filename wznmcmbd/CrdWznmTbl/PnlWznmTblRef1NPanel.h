/**
	...
	* job handler for job PnlWznmTblRef1NPanel (declarations)
...
/**
	...
	*/
class PnlWznmTblRef1NPanel : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTblRef1NPanel* rst = NULL, QryWznmTblRef1NPanel::StatShr* statshrqry = NULL, QryWznmTblRef1NPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmTblRef1NPanel(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTblRef1NPanel();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmTblRef1NPanel::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
