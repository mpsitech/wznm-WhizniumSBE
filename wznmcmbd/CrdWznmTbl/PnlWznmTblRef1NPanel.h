...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTblRef1NPanel* rst = NULL, QryWznmTblRef1NPanel::StatShr* statshrqry = NULL, QryWznmTblRef1NPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
