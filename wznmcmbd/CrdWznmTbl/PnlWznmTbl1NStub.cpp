/**
	...
	* job handler for job PnlWznmTbl1NStub (implementation)
...
#include "PnlWznmTbl1NStub_blks.cpp"
#include "PnlWznmTbl1NStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmTbl1NStub
 ******************************************************************************/

PnlWznmTbl1NStub::PnlWznmTbl1NStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBL1NSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTbl1NStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTbl1NStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTbl1NStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTbl1NStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBL1NSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBL1NSTUBDO) {
...
void PnlWznmTbl1NStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTbl1NStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTbl1NStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTbl1NStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTbl1NStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTbl1NStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTbl1NStub::StgIac::JNUM)) {
...
void PnlWznmTbl1NStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTbl1NStub::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTbl1NStub::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTbl1NStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTbl1NStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTbl1NStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
