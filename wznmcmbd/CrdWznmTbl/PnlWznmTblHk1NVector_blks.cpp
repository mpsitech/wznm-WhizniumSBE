/**
	* \file PnlWznmTblHk1NVector_blks.cpp
	* job handler for job PnlWznmTblHk1NVector (implementation of blocks)
...
void PnlWznmTblHk1NVector::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmTblHk1NVector";
...
bool PnlWznmTblHk1NVector::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTblHk1NVector"];}();
...
void PnlWznmTblHk1NVector::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTblHk1NVector::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTblHk1NVector";
...
void PnlWznmTblHk1NVector::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTblHk1NVector";
...
PnlWznmTblHk1NVector::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLHK1NVECTORDATA)
		{
};
...
void PnlWznmTblHk1NVector::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblHk1NVectorData"];}();
...
void PnlWznmTblHk1NVector::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblHk1NVectorData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTblHk1NVector::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLHK1NVECTORDO)
		{
	ixVDo = 0;
};
...
void PnlWznmTblHk1NVector::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblHk1NVectorDo"];}();
...
void PnlWznmTblHk1NVector::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblHk1NVectorDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTblHk1NVector::DpchEngData::DpchEngData(
			...
			, QryWznmTblHk1NVector::StatShr* statshrqry
			, QryWznmTblHk1NVector::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTBLHK1NVECTORDATA, jref)
		{
...
void PnlWznmTblHk1NVector::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTblHk1NVector::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTblHk1NVectorData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTblHk1NVector::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTblHk1NVector::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTblHk1NVectorData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTblHk1NVector::StatApp::writeXML(wr);
