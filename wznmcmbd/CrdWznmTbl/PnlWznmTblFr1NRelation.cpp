/**
	...
	* job handler for job PnlWznmTblFr1NRelation (implementation)
...
#include "PnlWznmTblFr1NRelation_blks.cpp"
#include "PnlWznmTblFr1NRelation_evals.cpp"
...
/******************************************************************************
 class PnlWznmTblFr1NRelation
 ******************************************************************************/

PnlWznmTblFr1NRelation::PnlWznmTblFr1NRelation(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLFR1NRELATION, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblFr1NRelation(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblFr1NRelation::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblFr1NRelation::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmTblFr1NRelation::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblFr1NRelation::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLFR1NRELATIONDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLFR1NRELATIONDO) {
...
void PnlWznmTblFr1NRelation::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblFr1NRelation::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblFr1NRelation::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblFr1NRelation::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblFr1NRelation* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblFr1NRelation::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblFr1NRelation::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblFr1NRelation::StgIac::JNUM)) {
...
void PnlWznmTblFr1NRelation::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTblFr1NRelation::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblFr1NRelation::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblFr1NRelation::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
