/**
	...
	* job handler for job PnlWznmTblTbl1NTablecol (implementation)
...
#include "PnlWznmTblTbl1NTablecol_blks.cpp"
#include "PnlWznmTblTbl1NTablecol_evals.cpp"
...
/******************************************************************************
 class PnlWznmTblTbl1NTablecol
 ******************************************************************************/

PnlWznmTblTbl1NTablecol::PnlWznmTblTbl1NTablecol(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLTBL1NTABLECOL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblTbl1NTablecol(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblTbl1NTablecol::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblTbl1NTablecol::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmTblTbl1NTablecol::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblTbl1NTablecol::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLTBL1NTABLECOLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLTBL1NTABLECOLDO) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblTbl1NTablecol::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblTbl1NTablecol* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblTbl1NTablecol::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblTbl1NTablecol::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblTbl1NTablecol::StgIac::JNUM)) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButUpClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButDownClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButNewAvail) {
		if ((xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCTCO, jref) & VecWznmWAccess::EDIT) != 0) if (refTbl != 0) {
			sref = "CrdWznmTco";
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblTbl1NTablecol::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblTbl1NTablecol::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblTbl1NTablecol::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
