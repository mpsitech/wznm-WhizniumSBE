...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTblTbl1NTablecol* rst = NULL, QryWznmTblTbl1NTablecol::StatShr* statshrqry = NULL, QryWznmTblTbl1NTablecol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
