...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTbl1NCheck* rst = NULL, QryWznmTbl1NCheck::StatShr* statshrqry = NULL, QryWznmTbl1NCheck::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
