/**
	* \file QryWznmTblRef1NPanel_blks.cpp
	* job handler for job QryWznmTblRef1NPanel (implementation of blocks)
...
void QryWznmTblRef1NPanel::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWznmTblRef1NPanel";
...
void QryWznmTblRef1NPanel::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmTblRef1NPanel";
...
bool QryWznmTblRef1NPanel::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmTblRef1NPanel"];}();
