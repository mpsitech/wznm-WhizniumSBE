...
void PnlWznmTblALoadfct::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTblALoadfct::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmTblALoadfct::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlWznmTblALoadfct::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTblALoadfct"];}();

	basefound = (me != Json::nullValue);

	if (basefound) {
		if (me.isMember("TcoLotWidth")) {TcoLotWidth = me["TcoLotWidth"].asUInt(); add(TCOLOTWIDTH);};
		if (me.isMember("TcoFnaWidth")) {TcoFnaWidth = me["TcoFnaWidth"].asUInt(); add(TCOFNAWIDTH);};
		if (me.isMember("TcoLdxWidth")) {TcoLdxWidth = me["TcoLdxWidth"].asUInt(); add(TCOLDXWIDTH);};
		if (me.isMember("TcoLbyWidth")) {TcoLbyWidth = me["TcoLbyWidth"].asUInt(); add(TCOLBYWIDTH);};
		if (me.isMember("TcoOrdWidth")) {TcoOrdWidth = me["TcoOrdWidth"].asUInt(); add(TCOORDWIDTH);};
		if (me.isMember("TcoLitWidth")) {TcoLitWidth = me["TcoLitWidth"].asUInt(); add(TCOLITWIDTH);};
	};
...
void PnlWznmTblALoadfct::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTblALoadfct::Tag::writeJSON(
	...
	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Load functions";
		me["TcoLot"] = "Load type";
		me["TcoFna"] = "Fct. name";
		me["TcoLdx"] = "Load tbl. col.";
		me["TcoLby"] = "Load by tbl. cols.";
		me["TcoOrd"] = "Ord. by tbl. cols.";
		me["TcoLit"] = "Limitation type";
	};
...
void PnlWznmTblALoadfct::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblALoadfctData"];}();
...
void PnlWznmTblALoadfct::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblALoadfctDo"];}();
...
void PnlWznmTblALoadfct::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTblALoadfctData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTblALoadfct::StatApp::writeJSON(me);
