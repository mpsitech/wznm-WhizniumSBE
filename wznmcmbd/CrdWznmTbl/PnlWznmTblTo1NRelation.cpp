/**
	...
	* job handler for job PnlWznmTblTo1NRelation (implementation)
...
#include "PnlWznmTblTo1NRelation_blks.cpp"
#include "PnlWznmTblTo1NRelation_evals.cpp"
...
/******************************************************************************
 class PnlWznmTblTo1NRelation
 ******************************************************************************/

PnlWznmTblTo1NRelation::PnlWznmTblTo1NRelation(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLTO1NRELATION, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblTo1NRelation(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblTo1NRelation::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblTo1NRelation::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmTblTo1NRelation::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblTo1NRelation::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLTO1NRELATIONDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLTO1NRELATIONDO) {
...
void PnlWznmTblTo1NRelation::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblTo1NRelation::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblTo1NRelation::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblTo1NRelation::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblTo1NRelation* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblTo1NRelation::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblTo1NRelation::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblTo1NRelation::StgIac::JNUM)) {
...
void PnlWznmTblTo1NRelation::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmTblTo1NRelation::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblTo1NRelation::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblTo1NRelation::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
