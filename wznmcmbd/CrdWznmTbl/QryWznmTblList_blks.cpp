...
/******************************************************************************
 class QryWznmTblList::VecVOrd
 ******************************************************************************/

uint QryWznmTblList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryWznmTblList::VecVOrd::getSref(
			const uint ix
		) {
...
void QryWznmTblList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWznmTblList::StatApp
 ******************************************************************************/

void QryWznmTblList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmTblList";
...
void QryWznmTblList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmTblList";
...
/******************************************************************************
 class QryWznmTblList::StatShr
 ******************************************************************************/

QryWznmTblList::StatShr::StatShr(
			const uint ntot
...
void QryWznmTblList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmTblList";
...
void QryWznmTblList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmTblList";
...
set<uint> QryWznmTblList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmTblList::StgIac
 ******************************************************************************/

QryWznmTblList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmTblList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmTblList"];}();
...
bool QryWznmTblList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmTblList");
	else
...
void QryWznmTblList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmTblList";
...
void QryWznmTblList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> QryWznmTblList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmTblList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
