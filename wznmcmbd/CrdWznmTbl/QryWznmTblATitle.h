...
#define QRYWZNMTBLATITLE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmTblATitle QryWznmTblATitle::StatApp
#define StatShrQryWznmTblATitle QryWznmTblATitle::StatShr
#define StgIacQryWznmTblATitle QryWznmTblATitle::StgIac

/**
	* QryWznmTblATitle
	*/
class QryWznmTblATitle : public JobWznm {
...
public:
	QryWznmTblATitle(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmTblATitle();
...
public:
	...
	WznmQTblATitle* getRecByJnum(const Sbecore::uint jnum);
