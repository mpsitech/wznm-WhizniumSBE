/**
	...
	* job handler for job PnlWznmTblRef1NRtblock (implementation)
...
#include "PnlWznmTblRef1NRtblock_blks.cpp"
...
/******************************************************************************
 class PnlWznmTblRef1NRtblock
 ******************************************************************************/

PnlWznmTblRef1NRtblock::PnlWznmTblRef1NRtblock(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLREF1NRTBLOCK, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblRef1NRtblock(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblRef1NRtblock::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblRef1NRtblock::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmTblRef1NRtblock::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NRtblock::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NRTBLOCKDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NRTBLOCKDO) {
...
void PnlWznmTblRef1NRtblock::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NRtblock::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblRef1NRtblock::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblRef1NRtblock::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblRef1NRtblock* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblRef1NRtblock::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblRef1NRtblock::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblRef1NRtblock::StgIac::JNUM)) {
...
void PnlWznmTblRef1NRtblock::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblRef1NRtblock::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblRef1NRtblock::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
