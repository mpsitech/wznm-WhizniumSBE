...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQTblRef1NCall* rst = NULL, QryWznmTblRef1NCall::StatShr* statshrqry = NULL, QryWznmTblRef1NCall::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
