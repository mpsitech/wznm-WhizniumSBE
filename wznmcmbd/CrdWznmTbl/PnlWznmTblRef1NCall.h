/**
	...
	* job handler for job PnlWznmTblRef1NCall (declarations)
...
/**
	* PnlWznmTblRef1NCall
	*/
class PnlWznmTblRef1NCall : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQTblRef1NCall* rst = NULL, QryWznmTblRef1NCall::StatShr* statshrqry = NULL, QryWznmTblRef1NCall::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmTblRef1NCall(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTblRef1NCall();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmTblRef1NCall::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
