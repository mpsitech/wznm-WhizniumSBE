/**
	* \file CrdWznmTbl.h
	* job handler for job CrdWznmTbl (declarations)
...
#define VecVWznmTblDo CrdWznmTbl::VecVDo
#define VecVWznmTblSge CrdWznmTbl::VecVSge

#define ContInfWznmTbl CrdWznmTbl::ContInf
#define StatAppWznmTbl CrdWznmTbl::StatApp
#define StatShrWznmTbl CrdWznmTbl::StatShr
#define TagWznmTbl CrdWznmTbl::Tag

#define DpchAppWznmTblDo CrdWznmTbl::DpchAppDo
#define DpchEngWznmTblData CrdWznmTbl::DpchEngData

/**
	* CrdWznmTbl
	*/
class CrdWznmTbl : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDTBL = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdTbl = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdTbl;
...
public:
	CrdWznmTbl(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmTbl();
...
public:
	...
	PnlWznmTblRec* pnlrec;
	PnlWznmTblHeadbar* pnlheadbar;
	PnlWznmTblList* pnllist;
