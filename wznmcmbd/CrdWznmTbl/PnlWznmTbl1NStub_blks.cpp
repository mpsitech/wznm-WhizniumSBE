/**
	* \file PnlWznmTbl1NStub_blks.cpp
	* job handler for job PnlWznmTbl1NStub (implementation of blocks)
...
void PnlWznmTbl1NStub::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTbl1NStub";
...
void PnlWznmTbl1NStub::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmTbl1NStub";
...
void PnlWznmTbl1NStub::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmTbl1NStub";
...
void PnlWznmTbl1NStub::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmTbl1NStub";
...
void PnlWznmTbl1NStub::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTbl1NStub";
...
void PnlWznmTbl1NStub::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmTbl1NStub";
...
bool PnlWznmTbl1NStub::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTbl1NStub"];}();
...
void PnlWznmTbl1NStub::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTbl1NStub::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTbl1NStub";
...
void PnlWznmTbl1NStub::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTbl1NStub";
...
PnlWznmTbl1NStub::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBL1NSTUBDATA)
		{
};
...
void PnlWznmTbl1NStub::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTbl1NStubData"];}();
...
void PnlWznmTbl1NStub::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTbl1NStubData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTbl1NStub::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBL1NSTUBDO)
		{
	ixVDo = 0;
};
...
void PnlWznmTbl1NStub::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTbl1NStubDo"];}();
...
void PnlWznmTbl1NStub::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTbl1NStubDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTbl1NStub::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTBL1NSTUBDATA, jref)
		{
...
void PnlWznmTbl1NStub::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTbl1NStub::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTbl1NStubData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTbl1NStub::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTbl1NStub::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTbl1NStubData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTbl1NStub::StatApp::writeXML(wr);
