/**
	* \file PnlWznmTblATitle_blks.cpp
	* job handler for job PnlWznmTblATitle (implementation of blocks)
...
/******************************************************************************
 class PnlWznmTblATitle::VecVDo
 ******************************************************************************/

uint PnlWznmTblATitle::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmTblATitle::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmTblATitle::ContInf
 ******************************************************************************/

PnlWznmTblATitle::ContInf::ContInf(
...
void PnlWznmTblATitle::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTblATitle";
...
void PnlWznmTblATitle::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmTblATitle";
...
set<uint> PnlWznmTblATitle::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblATitle::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblATitle::StatApp
 ******************************************************************************/

void PnlWznmTblATitle::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmTblATitle";
...
void PnlWznmTblATitle::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmTblATitle";
...
/******************************************************************************
 class PnlWznmTblATitle::StatShr
 ******************************************************************************/

PnlWznmTblATitle::StatShr::StatShr(
...
void PnlWznmTblATitle::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTblATitle";
...
void PnlWznmTblATitle::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmTblATitle";
...
set<uint> PnlWznmTblATitle::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblATitle::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblATitle::StgIac
 ******************************************************************************/

PnlWznmTblATitle::StgIac::StgIac(
...
bool PnlWznmTblATitle::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTblATitle"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoGndWidth")) {TcoGndWidth = me["TcoGndWidth"].asUInt(); add(TCOGNDWIDTH);};
...
bool PnlWznmTblATitle::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmTblATitle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmTblATitle";
...
void PnlWznmTblATitle::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmTblATitle";
...
void PnlWznmTblATitle::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmTblATitle";
...
set<uint> PnlWznmTblATitle::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTblATitle::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTblATitle::Tag
 ******************************************************************************/

void PnlWznmTblATitle::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTblATitle";
...
void PnlWznmTblATitle::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTblATitle";
...
/******************************************************************************
 class PnlWznmTblATitle::DpchAppData
 ******************************************************************************/

PnlWznmTblATitle::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLATITLEDATA)
		{
};

string PnlWznmTblATitle::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblATitle::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblATitleData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmTblATitle::StgIac();
	};
};

void PnlWznmTblATitle::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblATitleData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTblATitle::DpchAppDo
 ******************************************************************************/

PnlWznmTblATitle::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLATITLEDO)
		{
	ixVDo = 0;
};

string PnlWznmTblATitle::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblATitle::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblATitleDo"];}();
...
void PnlWznmTblATitle::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblATitleDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTblATitle::DpchEngData
 ******************************************************************************/

PnlWznmTblATitle::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmTblATitle::StatShr* statshrqry
			, QryWznmTblATitle::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTBLATITLEDATA, jref)
		{
...
string PnlWznmTblATitle::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTblATitle::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTblATitle::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTblATitleData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTblATitle::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTblATitle::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTblATitleData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTblATitle::StatApp::writeXML(wr);
