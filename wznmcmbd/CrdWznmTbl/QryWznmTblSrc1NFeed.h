...
#define QRYWZNMTBLSRC1NFEED_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmTblSrc1NFeed QryWznmTblSrc1NFeed::StatApp
#define StatShrQryWznmTblSrc1NFeed QryWznmTblSrc1NFeed::StatShr
#define StgIacQryWznmTblSrc1NFeed QryWznmTblSrc1NFeed::StgIac

/**
	* QryWznmTblSrc1NFeed
	*/
class QryWznmTblSrc1NFeed : public JobWznm {
...
public:
	QryWznmTblSrc1NFeed(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmTblSrc1NFeed();
...
public:
	...
	WznmQTblSrc1NFeed* getRecByJnum(const Sbecore::uint jnum);
