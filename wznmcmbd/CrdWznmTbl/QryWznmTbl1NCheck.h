...
#define QRYWZNMTBL1NCHECK_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmTbl1NCheck QryWznmTbl1NCheck::StatApp
#define StatShrQryWznmTbl1NCheck QryWznmTbl1NCheck::StatShr
#define StgIacQryWznmTbl1NCheck QryWznmTbl1NCheck::StgIac

/**
	* QryWznmTbl1NCheck
	*/
class QryWznmTbl1NCheck : public JobWznm {
...
public:
	QryWznmTbl1NCheck(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmTbl1NCheck();
...
public:
	...
	WznmQTbl1NCheck* getRecByJnum(const Sbecore::uint jnum);
