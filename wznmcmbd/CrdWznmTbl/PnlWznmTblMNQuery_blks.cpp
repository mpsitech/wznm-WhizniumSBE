/**
	* \file PnlWznmTblMNQuery_blks.cpp
	* job handler for job PnlWznmTblMNQuery (implementation of blocks)
...
void PnlWznmTblMNQuery::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTblMNQuery";
...
void PnlWznmTblMNQuery::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmTblMNQuery";
...
void PnlWznmTblMNQuery::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmTblMNQuery";
...
void PnlWznmTblMNQuery::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmTblMNQuery";
...
void PnlWznmTblMNQuery::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTblMNQuery";
...
void PnlWznmTblMNQuery::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmTblMNQuery";
...
bool PnlWznmTblMNQuery::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTblMNQuery"];}();
...
void PnlWznmTblMNQuery::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTblMNQuery::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTblMNQuery";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Source for queries";
		me["TcoMref"] = "Query";
...
void PnlWznmTblMNQuery::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTblMNQuery";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Source for queries");
...
PnlWznmTblMNQuery::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLMNQUERYDATA)
		{
};
...
void PnlWznmTblMNQuery::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblMNQueryData"];}();
...
void PnlWznmTblMNQuery::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblMNQueryData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTblMNQuery::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTBLMNQUERYDO)
		{
	ixVDo = 0;
};
...
void PnlWznmTblMNQuery::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTblMNQueryDo"];}();
...
void PnlWznmTblMNQuery::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTblMNQueryDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTblMNQuery::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTBLMNQUERYDATA, jref)
		{
...
void PnlWznmTblMNQuery::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTblMNQuery::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTblMNQueryData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTblMNQuery::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTblMNQuery::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTblMNQueryData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTblMNQuery::StatApp::writeXML(wr);
