/**
	...
	* job handler for job PnlWznmTblRef1NCall (implementation)
...
#include "PnlWznmTblRef1NCall_blks.cpp"
...
/******************************************************************************
 class PnlWznmTblRef1NCall
 ******************************************************************************/

PnlWznmTblRef1NCall::PnlWznmTblRef1NCall(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTBLREF1NCALL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTblRef1NCall(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTblRef1NCall::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTblRef1NCall::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmTblRef1NCall::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NCall::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NCALLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTBLREF1NCALLDO) {
...
void PnlWznmTblRef1NCall::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTblRef1NCall::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTblRef1NCall::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTblRef1NCall::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTblRef1NCall* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTblRef1NCall::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTblRef1NCall::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTblRef1NCall::StgIac::JNUM)) {
...
void PnlWznmTblRef1NCall::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTblRef1NCall::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTblRef1NCall::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
