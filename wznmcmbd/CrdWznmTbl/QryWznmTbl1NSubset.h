...
#define QRYWZNMTBL1NSUBSET_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmTbl1NSubset QryWznmTbl1NSubset::StatApp
#define StatShrQryWznmTbl1NSubset QryWznmTbl1NSubset::StatShr
#define StgIacQryWznmTbl1NSubset QryWznmTbl1NSubset::StgIac

/**
	* QryWznmTbl1NSubset
	*/
class QryWznmTbl1NSubset : public JobWznm {
...
public:
	QryWznmTbl1NSubset(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmTbl1NSubset();
...
public:
	...
	WznmQTbl1NSubset* getRecByJnum(const Sbecore::uint jnum);
