...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTblTo1NRelation* rst = NULL, QryWznmTblTo1NRelation::StatShr* statshrqry = NULL, QryWznmTblTo1NRelation::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
