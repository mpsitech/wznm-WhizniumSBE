/**
	...
	* job handler for job PnlWznmOpxSqkMNStub (implementation)
...
#include "PnlWznmOpxSqkMNStub_blks.cpp"
#include "PnlWznmOpxSqkMNStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmOpxSqkMNStub
 ******************************************************************************/

PnlWznmOpxSqkMNStub::PnlWznmOpxSqkMNStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMOPXSQKMNSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmOpxSqkMNStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmOpxSqkMNStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmOpxSqkMNStub::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmOpxSqkMNStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmOpxSqkMNStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXSQKMNSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXSQKMNSTUBDO) {
...
void PnlWznmOpxSqkMNStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmOpxSqkMNStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxSqkMNStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmOpxSqkMNStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQOpxSqkMNStub* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmOpxSqkMNStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmOpxSqkMNStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmOpxSqkMNStub::StgIac::JNUM)) {
...
void PnlWznmOpxSqkMNStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmOpxSqkMNStub::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxSqkMNStub::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxSqkMNStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmOpxSqkMNStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmOpxSqkMNStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
