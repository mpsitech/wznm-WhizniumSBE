/**
	...
	* job handler for job PnlWznmOpxRef1NBlock (implementation)
...
#include "PnlWznmOpxRef1NBlock_blks.cpp"
#include "PnlWznmOpxRef1NBlock_evals.cpp"
...
/******************************************************************************
 class PnlWznmOpxRef1NBlock
 ******************************************************************************/

PnlWznmOpxRef1NBlock::PnlWznmOpxRef1NBlock(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMOPXREF1NBLOCK, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmOpxRef1NBlock(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmOpxRef1NBlock::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmOpxRef1NBlock::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmOpxRef1NBlock::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmOpxRef1NBlock::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXREF1NBLOCKDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXREF1NBLOCKDO) {
...
void PnlWznmOpxRef1NBlock::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmOpxRef1NBlock::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxRef1NBlock::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmOpxRef1NBlock::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQOpxRef1NBlock* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmOpxRef1NBlock::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmOpxRef1NBlock::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmOpxRef1NBlock::StgIac::JNUM)) {
...
void PnlWznmOpxRef1NBlock::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	ubigint refOpx = xchg->getRefPreset(VecWznmVPreset::PREWZNMREFOPX, jref);

	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCBLK, jref)) if (refOpx != 0) {
			sref = "CrdWznmBlk";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, VecWznmVPreset::PREWZNMREFOPX, refOpx, sref, recBlk.ref, jrefNew);
		};
...
void PnlWznmOpxRef1NBlock::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButNewAvail) {
		if ((xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCBLK, jref) & VecWznmWAccess::EDIT) != 0) if (refOpx != 0) {
			sref = "CrdWznmBlk";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, VecWznmVPreset::PREWZNMREFOPX, refOpx, sref, -1, jrefNew);
		};
...
void PnlWznmOpxRef1NBlock::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxRef1NBlock::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmOpxRef1NBlock::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmOpxRef1NBlock::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
