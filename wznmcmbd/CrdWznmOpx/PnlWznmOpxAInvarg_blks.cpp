/**
	* \file PnlWznmOpxAInvarg_blks.cpp
	* job handler for job PnlWznmOpxAInvarg (implementation of blocks)
...
void PnlWznmOpxAInvarg::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmOpxAInvarg";
...
bool PnlWznmOpxAInvarg::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmOpxAInvarg"];}();
...
void PnlWznmOpxAInvarg::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmOpxAInvarg::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmOpxAInvarg";
...
void PnlWznmOpxAInvarg::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmOpxAInvarg";
...
PnlWznmOpxAInvarg::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPXAINVARGDATA)
		{
};
...
void PnlWznmOpxAInvarg::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpxAInvargData"];}();
...
void PnlWznmOpxAInvarg::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpxAInvargData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmOpxAInvarg::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPXAINVARGDO)
		{
	ixVDo = 0;
};
...
void PnlWznmOpxAInvarg::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpxAInvargDo"];}();
...
void PnlWznmOpxAInvarg::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpxAInvargDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmOpxAInvarg::DpchEngData::DpchEngData(
			...
			, QryWznmOpxAInvarg::StatShr* statshrqry
			, QryWznmOpxAInvarg::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMOPXAINVARGDATA, jref)
		{
...
void PnlWznmOpxAInvarg::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmOpxAInvarg::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmOpxAInvargData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmOpxAInvarg::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmOpxAInvarg::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmOpxAInvargData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmOpxAInvarg::StatApp::writeXML(wr);
