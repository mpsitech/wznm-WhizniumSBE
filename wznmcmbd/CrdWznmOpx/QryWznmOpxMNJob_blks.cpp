/**
	* \file QryWznmOpxMNJob_blks.cpp
	* job handler for job QryWznmOpxMNJob (implementation of blocks)
...
/******************************************************************************
 class QryWznmOpxMNJob::StatApp
 ******************************************************************************/

void QryWznmOpxMNJob::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmOpxMNJob";
...
void QryWznmOpxMNJob::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmOpxMNJob";
...
/******************************************************************************
 class QryWznmOpxMNJob::StatShr
 ******************************************************************************/

QryWznmOpxMNJob::StatShr::StatShr(
			const uint ntot
...
void QryWznmOpxMNJob::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmOpxMNJob";
...
void QryWznmOpxMNJob::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmOpxMNJob";
...
set<uint> QryWznmOpxMNJob::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmOpxMNJob::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmOpxMNJob::StgIac
 ******************************************************************************/

QryWznmOpxMNJob::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmOpxMNJob::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmOpxMNJob"];}();
...
bool QryWznmOpxMNJob::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmOpxMNJob");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmOpxMNJob";
...
void QryWznmOpxMNJob::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmOpxMNJob";
...
void QryWznmOpxMNJob::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmOpxMNJob";
...
set<uint> QryWznmOpxMNJob::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmOpxMNJob::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
