/**
	* \file CrdWznmOpx.h
	* job handler for job CrdWznmOpx (declarations)
...
#define VecVWznmOpxDo CrdWznmOpx::VecVDo
#define VecVWznmOpxSge CrdWznmOpx::VecVSge

#define ContInfWznmOpx CrdWznmOpx::ContInf
#define StatAppWznmOpx CrdWznmOpx::StatApp
#define StatShrWznmOpx CrdWznmOpx::StatShr
#define TagWznmOpx CrdWznmOpx::Tag

#define DpchAppWznmOpxDo CrdWznmOpx::DpchAppDo
#define DpchEngWznmOpxData CrdWznmOpx::DpchEngData

/**
	* CrdWznmOpx
	*/
class CrdWznmOpx : public JobWznm {
...
public:
	CrdWznmOpx(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmOpx();
...
public:
	...
	PnlWznmOpxRec* pnlrec;
	PnlWznmOpxHeadbar* pnlheadbar;
	PnlWznmOpxList* pnllist;
