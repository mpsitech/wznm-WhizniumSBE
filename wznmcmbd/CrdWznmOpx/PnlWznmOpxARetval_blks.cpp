/**
	* \file PnlWznmOpxARetval_blks.cpp
	* job handler for job PnlWznmOpxARetval (implementation of blocks)
...
/******************************************************************************
 class PnlWznmOpxARetval::VecVDo
 ******************************************************************************/

uint PnlWznmOpxARetval::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmOpxARetval::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmOpxARetval::ContInf
 ******************************************************************************/

PnlWznmOpxARetval::ContInf::ContInf(
...
void PnlWznmOpxARetval::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmOpxARetval";
...
void PnlWznmOpxARetval::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmOpxARetval";
...
set<uint> PnlWznmOpxARetval::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpxARetval::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpxARetval::StatApp
 ******************************************************************************/

void PnlWznmOpxARetval::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmOpxARetval";
...
void PnlWznmOpxARetval::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmOpxARetval";
...
/******************************************************************************
 class PnlWznmOpxARetval::StatShr
 ******************************************************************************/

PnlWznmOpxARetval::StatShr::StatShr(
...
void PnlWznmOpxARetval::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmOpxARetval";
...
void PnlWznmOpxARetval::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmOpxARetval";
...
set<uint> PnlWznmOpxARetval::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpxARetval::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpxARetval::StgIac
 ******************************************************************************/

PnlWznmOpxARetval::StgIac::StgIac(
...
bool PnlWznmOpxARetval::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmOpxARetval"];}();
...
bool PnlWznmOpxARetval::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmOpxARetval");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmOpxARetval";
...
void PnlWznmOpxARetval::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmOpxARetval";
...
void PnlWznmOpxARetval::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmOpxARetval";
...
set<uint> PnlWznmOpxARetval::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpxARetval::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpxARetval::Tag
 ******************************************************************************/

void PnlWznmOpxARetval::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmOpxARetval";
...
void PnlWznmOpxARetval::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmOpxARetval";
...
/******************************************************************************
 class PnlWznmOpxARetval::DpchAppData
 ******************************************************************************/

PnlWznmOpxARetval::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPXARETVALDATA)
		{
};

string PnlWznmOpxARetval::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpxARetval::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpxARetvalData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmOpxARetval::StgIac();
	};
};

void PnlWznmOpxARetval::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpxARetvalData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmOpxARetval::DpchAppDo
 ******************************************************************************/

PnlWznmOpxARetval::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPXARETVALDO)
		{
	ixVDo = 0;
};

string PnlWznmOpxARetval::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpxARetval::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpxARetvalDo"];}();
...
void PnlWznmOpxARetval::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpxARetvalDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmOpxARetval::DpchEngData
 ******************************************************************************/

PnlWznmOpxARetval::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmOpxARetval::StatShr* statshrqry
			, QryWznmOpxARetval::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMOPXARETVALDATA, jref)
		{
...
string PnlWznmOpxARetval::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpxARetval::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmOpxARetval::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmOpxARetvalData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmOpxARetval::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmOpxARetval::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmOpxARetvalData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmOpxARetval::StatApp::writeXML(wr);
