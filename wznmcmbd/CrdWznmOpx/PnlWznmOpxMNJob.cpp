/**
	...
	* job handler for job PnlWznmOpxMNJob (implementation)
...
#include "PnlWznmOpxMNJob_blks.cpp"
#include "PnlWznmOpxMNJob_evals.cpp"
...
/******************************************************************************
 class PnlWznmOpxMNJob
 ******************************************************************************/

PnlWznmOpxMNJob::PnlWznmOpxMNJob(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMOPXMNJOB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmOpxMNJob(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmOpxMNJob::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmOpxMNJob::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmOpxMNJob::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXMNJOBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPXMNJOBDO) {
...
void PnlWznmOpxMNJob::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmOpxMNJob::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxMNJob::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmOpxMNJob::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmOpxMNJob::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmOpxMNJob::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmOpxMNJob::StgIac::JNUM)) {
...
void PnlWznmOpxMNJob::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmOpxMNJob::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxMNJob::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpxMNJob::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmOpxMNJob::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmOpxMNJob::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
