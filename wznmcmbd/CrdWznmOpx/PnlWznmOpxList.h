/**
	...
	* job handler for job PnlWznmOpxList (declarations)
...
/**
	* PnlWznmOpxList
	*/
class PnlWznmOpxList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQOpxList* rst = NULL, QryWznmOpxList::StatShr* statshrqry = NULL, QryWznmOpxList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmOpxList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmOpxList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmOpxList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
