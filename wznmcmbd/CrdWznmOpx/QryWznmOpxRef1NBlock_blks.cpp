/**
	* \file QryWznmOpxRef1NBlock_blks.cpp
	* job handler for job QryWznmOpxRef1NBlock (implementation of blocks)
...
void QryWznmOpxRef1NBlock::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmOpxRef1NBlock";
...
void QryWznmOpxRef1NBlock::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmOpxRef1NBlock";
...
void QryWznmOpxRef1NBlock::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmOpxRef1NBlock";
...
void QryWznmOpxRef1NBlock::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmOpxRef1NBlock";
...
bool QryWznmOpxRef1NBlock::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmOpxRef1NBlock"];}();
...
void QryWznmOpxRef1NBlock::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
