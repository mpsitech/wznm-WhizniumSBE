...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQOpxRef1NBlock* rst = NULL, QryWznmOpxRef1NBlock::StatShr* statshrqry = NULL, QryWznmOpxRef1NBlock::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
