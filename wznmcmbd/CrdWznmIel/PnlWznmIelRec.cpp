/**
	...
	* job handler for job PnlWznmIelRec (implementation)
...
#include "PnlWznmIelRec_blks.cpp"
#include "PnlWznmIelRec_evals.cpp"
...
PnlWznmIelRec::PnlWznmIelRec(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMIELREC, jrefSup, ixWznmVLocale)
		{
...
DpchEngWznm* PnlWznmIelRec::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmIelRec::refresh(
	...
	// IP refresh --- BEGIN
	// continf
	continf.TxtRef = StubWznm::getStubIelStd(dbswznm, recIel.ref, ixWznmVLocale, Stub::VecVNonetype::FULL);

	// statshr
	if (recIel.ref == 0) statshr.ixWznmVExpstate = VecWznmVExpstate::MIND;
	...
	if (statshr.ixWznmVExpstate == VecWznmVExpstate::MIND) {
		...
		if (!pnldetail) pnldetail = new PnlWznmIelDetail(xchg, dbswznm, jref, ixWznmVLocale);
	};
...
void PnlWznmIelRec::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFIEL) {
		...
		if (dbswznm->tblwznmmimpexpcol->loadRecByRef(xchg->getRefPreset(VecWznmVPreset::PREWZNMREFIEL, jref), &_recIel)) {
			recIel = *_recIel;
			delete _recIel;
...
void PnlWznmIelRec::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMIELRECDO) {
...
void PnlWznmIelRec::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmIelRec::handleDpchAppDoButMinimizeClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmIelRec::handleDpchAppDoButRegularizeClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmIelRec::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
	if (call->ixVCall == VecWznmVCall::CALLWZNMIEL_IM2EQ) {
...
bool PnlWznmIelRec::handleCallWznmIel_im2Eq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
...
bool PnlWznmIelRec::handleCallWznmIel_imeEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmIelRec::handleCallWznmIel_pstEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmIelRec::handleCallWznmIel_stbEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmIelRec::handleCallWznmIel_vitEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmIelRec::handleCallWznmIelUpd_refEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
