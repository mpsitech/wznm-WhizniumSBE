/**
	* \file CrdWznmIel.h
	* job handler for job CrdWznmIel (declarations)
...
#define VecVWznmIelDo CrdWznmIel::VecVDo
#define VecVWznmIelSge CrdWznmIel::VecVSge

#define ContInfWznmIel CrdWznmIel::ContInf
#define StatAppWznmIel CrdWznmIel::StatApp
#define StatShrWznmIel CrdWznmIel::StatShr
#define TagWznmIel CrdWznmIel::Tag

#define DpchAppWznmIelDo CrdWznmIel::DpchAppDo
#define DpchEngWznmIelData CrdWznmIel::DpchEngData

/**
	* CrdWznmIel
	*/
class CrdWznmIel : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDIEL = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdIel = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdIel;
...
public:
	CrdWznmIel(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmIel();
...
public:
	...
	PnlWznmIelList* pnllist;
	PnlWznmIelHeadbar* pnlheadbar;
	PnlWznmIelRec* pnlrec;
