...
uint VecWznmVCall::getIx(
	...
	if (s == "callwznmbox.shteq") return CALLWZNMBOX_SHTEQ;
	if (s == "callwznmboxmod") return CALLWZNMBOXMOD;
	if (s == "callwznmboxmod.shteq") return CALLWZNMBOXMOD_SHTEQ;
	if (s == "callwznmboxrboxmod.dsteq") return CALLWZNMBOXRBOXMOD_DSTEQ;
	if (s == "callwznmboxrboxmod.orgeq") return CALLWZNMBOXRBOXMOD_ORGEQ;
	if (s == "callwznmboxupd.refeq") return CALLWZNMBOXUPD_REFEQ;
	...
	if (s == "callwznmsht.viseq") return CALLWZNMSHT_VISEQ;
	if (s == "callwznmshtmod") return CALLWZNMSHTMOD;
	if (s == "callwznmshtmod.viseq") return CALLWZNMSHTMOD_VISEQ;
	if (s == "callwznmshtupd.refeq") return CALLWZNMSHTUPD_REFEQ;
	...
	if (s == "callwznmvis.vereq") return CALLWZNMVIS_VEREQ;
	if (s == "callwznmvismod") return CALLWZNMVISMOD;
	if (s == "callwznmvismod.vereq") return CALLWZNMVISMOD_VEREQ;
	if (s == "callwznmvisupd.refeq") return CALLWZNMVISUPD_REFEQ;
...
string VecWznmVCall::getSref(
	...
	if (ix == CALLWZNMBOX_SHTEQ) return("CallWznmBox.shtEq");
	if (ix == CALLWZNMBOXMOD) return("CallWznmBoxMod");
	if (ix == CALLWZNMBOXMOD_SHTEQ) return("CallWznmBoxMod.shtEq");
	if (ix == CALLWZNMBOXRBOXMOD_DSTEQ) return("CallWznmBoxRboxMod.dstEq");
	if (ix == CALLWZNMBOXRBOXMOD_ORGEQ) return("CallWznmBoxRboxMod.orgEq");
	if (ix == CALLWZNMBOXUPD_REFEQ) return("CallWznmBoxUpd.refEq");
	...
	if (ix == CALLWZNMSHT_VISEQ) return("CallWznmSht.visEq");
	if (ix == CALLWZNMSHTMOD) return("CallWznmShtMod");
	if (ix == CALLWZNMSHTMOD_VISEQ) return("CallWznmShtMod.visEq");
	if (ix == CALLWZNMSHTUPD_REFEQ) return("CallWznmShtUpd.refEq");
	...
	if (ix == CALLWZNMVIS_VEREQ) return("CallWznmVis.verEq");
	if (ix == CALLWZNMVISMOD) return("CallWznmVisMod");
	if (ix == CALLWZNMVISMOD_VEREQ) return("CallWznmVisMod.verEq");
	if (ix == CALLWZNMVISUPD_REFEQ) return("CallWznmVisUpd.refEq");
