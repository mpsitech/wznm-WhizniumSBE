/**
	* \file VecWznmVError.cpp
	* vector VecWznmVError (implementation)
...
/******************************************************************************
 namespace VecWznmVError
 ******************************************************************************/

uint VecWznmVError::getIx(
			const string& sref
		) {
...
string VecWznmVError::getTitle(
	...
	if (ixWznmVLocale == 1) {
		...
		if (ix == LIC_CTWARN) return("Last contact with licensing server was on &lastAttempt;. WhizniumSBE will cease to function unless contact is re-established by &finalAttempt;.");
