...
string VecWznmVOpengtype::getTitle(
	...
	if (ixWznmVLocale == 1) {
		if (ix == WZNMOPD1) return("wznmopd1 with WznmCompl/WznmGen/WznmPrcfile/WznmPrctree/WznmWrapi/WznmWrapp/WznmWrcsapi/WznmWrdbs/WznmWrjapi/WznmWrpyapi/WznmWrsrv/WznmWrswapi/WznmWrvue/WznmWrweb");
