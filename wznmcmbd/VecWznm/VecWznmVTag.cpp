/**
	* \file VecWznmVTag.cpp
	* vector VecWznmVTag (implementation)
...
/******************************************************************************
 namespace VecWznmVTag
 ******************************************************************************/

uint VecWznmVTag::getIx(
			const string& sref
		) {
...
string VecWznmVTag::getTitle(
			const uint ix
			, const uint ixWznmVLocale
		) {
	if (ixWznmVLocale == 1) {
		if (ix == ABOUT) return("About WhizniumSBE");
		if (ix == ALWAYS) return("always");
		...
		if (ix == HELP) return("WhizniumSBE help");
		if (ix == HOUR) return("hour");
		if (ix == HOURS) return("hours");
