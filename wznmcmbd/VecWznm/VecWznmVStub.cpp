...
uint VecWznmVStub::getIx(
	...
	if (s == "stubwznmboxstd") return STUBWZNMBOXSTD;
	...
	if (s == "stubwznmshtstd") return STUBWZNMSHTSTD;
	...
	if (s == "stubwznmvisstd") return STUBWZNMVISSTD;
...
string VecWznmVStub::getSref(
	...
	if (ix == STUBWZNMBOXSTD) return("StubWznmBoxStd");
	...
	if (ix == STUBWZNMSHTSTD) return("StubWznmShtStd");
	...
	if (ix == STUBWZNMVISSTD) return("StubWznmVisStd");
