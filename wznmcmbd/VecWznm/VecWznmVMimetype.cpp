/**
	* \file VecWznmVMimetype.cpp
	* vector VecWznmVMimetype (implementation)
...
/******************************************************************************
 namespace VecWznmVMimetype
 ******************************************************************************/

uint VecWznmVMimetype::getIx(
			const string& sref
		) {
...
string VecWznmVMimetype::getSref(
			const uint ix
		) {
...
string VecWznmVMimetype::getTitle(
			const uint ix
		) {
