...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerMNLocale* rst = NULL, QryWznmVerMNLocale::StatShr* statshrqry = NULL, QryWznmVerMNLocale::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
