/**
	* \file PnlWznmVerMNLocale.h
	* job handler for job PnlWznmVerMNLocale (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMVERMNLOCALE_H
#define PNLWZNMVERMNLOCALE_H
...
#define VecVWznmVerMNLocaleDo PnlWznmVerMNLocale::VecVDo

#define ContInfWznmVerMNLocale PnlWznmVerMNLocale::ContInf
#define StatAppWznmVerMNLocale PnlWznmVerMNLocale::StatApp
#define StatShrWznmVerMNLocale PnlWznmVerMNLocale::StatShr
#define StgIacWznmVerMNLocale PnlWznmVerMNLocale::StgIac
#define TagWznmVerMNLocale PnlWznmVerMNLocale::Tag

#define DpchAppWznmVerMNLocaleData PnlWznmVerMNLocale::DpchAppData
#define DpchAppWznmVerMNLocaleDo PnlWznmVerMNLocale::DpchAppDo
#define DpchEngWznmVerMNLocaleData PnlWznmVerMNLocale::DpchEngData

/**
	* PnlWznmVerMNLocale
	*/
class PnlWznmVerMNLocale : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerMNLocale* rst = NULL, QryWznmVerMNLocale::StatShr* statshrqry = NULL, QryWznmVerMNLocale::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVerMNLocale(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVerMNLocale();
...
public:
	...
	QryWznmVerMNLocale* qry;

	WznmRMLocaleMVersion recLocRver;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVerMNLocale::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
