...
#include "DlgWznmVerBscui_blks.cpp"
#include "DlgWznmVerBscui_evals.cpp"
...
/******************************************************************************
 class DlgWznmVerBscui
 ******************************************************************************/

DlgWznmVerBscui::DlgWznmVerBscui(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::DLGWZNMVERBSCUI, jrefSup, ixWznmVLocale)
		{
	...
	iex = new JobWznmIexBui(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* DlgWznmVerBscui::getNewDpchEng(
			set<uint> items
		) {
...
void DlgWznmVerBscui::refreshIfi(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVerBscui::refreshImp(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVerBscui::refreshPpr(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVerBscui::refreshLfi(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVerBscui::handleRequest(
	...
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPDLGWZNMVERBSCUIDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPDLGWZNMVERBSCUIDO) {
...
void DlgWznmVerBscui::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void DlgWznmVerBscui::handleDpchAppDataContiac(
			DbsWznm* dbswznm
			, ContIac* _contiac
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppDoButDneClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppDoImpButRunClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppDoImpButStoClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppDoPprButRunClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppDoPprButStoClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVerBscui::handleDpchAppWznmAlert(
			DbsWznm* dbswznm
...
void DlgWznmVerBscui::handleDpchRetWznm(
			DbsWznm* dbswznm
			, DpchRetWznm* dpchret
		) {
...
void DlgWznmVerBscui::handleUploadInSgeIdle(
			DbsWznm* dbswznm
...
string DlgWznmVerBscui::handleDownloadInSgeDone(
			DbsWznm* dbswznm
		) {
...
void DlgWznmVerBscui::handleTimerInSgeImpidle(
			DbsWznm* dbswznm
			, const string& sref
		) {
	changeStage(dbswznm, nextIxVSgeSuccess);
...
string DlgWznmVerBscui::getSquawk(
			DbsWznm* dbswznm
		) {
	string retval;
	// IP getSquawk --- RBEGIN
	if ( (ixVSge == VecVSge::PARSE) || (ixVSge == VecVSge::ALRWZNMPER) || (ixVSge == VecVSge::PRSDONE) || (ixVSge == VecVSge::IMPORT) || (ixVSge == VecVSge::ALRWZNMIER) || (ixVSge == VecVSge::IMPDONE) || (ixVSge == VecVSge::POSTPRC) ) {
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			else if (ixVSge == VecVSge::IMPORT) retval = "importing basic user interface structure (" + to_string(iex->impcnt) + " records added)";
...
uint DlgWznmVerBscui::enterSgeIdle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgeIdle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeIdle --- INSERT
};

uint DlgWznmVerBscui::enterSgePrsidle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgePrsidle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgePrsidle --- INSERT
};

uint DlgWznmVerBscui::enterSgeParse(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	uint retval;
	...
	if (iex->ixVSge != JobWznmIexBui::VecVSge::PRSDONE) {
		if (reqCmd) {
			if (iex->ixVSge == JobWznmIexBui::VecVSge::PRSERR) cout << "\t" << iex->getSquawk(dbswznm) << endl;
...
void DlgWznmVerBscui::leaveSgeParse(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeParse --- INSERT
};

uint DlgWznmVerBscui::enterSgeAlrwznmper(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	...
	if (iex->ixVSge == JobWznmIexBui::VecVSge::PRSERR) continf.TxtMsg1 = iex->getSquawk(dbswznm);
...
void DlgWznmVerBscui::leaveSgeAlrwznmper(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeAlrwznmper --- INSERT
};

uint DlgWznmVerBscui::enterSgePrsdone(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgePrsdone(
			DbsWznm* dbswznm
		) {
	// IP leaveSgePrsdone --- INSERT
};

uint DlgWznmVerBscui::enterSgeImpidle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgeImpidle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeImpidle --- INSERT
};

uint DlgWznmVerBscui::enterSgeImport(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	uint retval;
	...
	if (iex->ixVSge == JobWznmIexBui::VecVSge::IMPERR) retval = nextIxVSgeFailure;
...
void DlgWznmVerBscui::leaveSgeImport(
			DbsWznm* dbswznm
		) {
	invalidateWakeups();
...
uint DlgWznmVerBscui::enterSgeAlrwznmier(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgeAlrwznmier(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeAlrwznmier --- INSERT
};

uint DlgWznmVerBscui::enterSgeImpdone(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	...
	if (ifitxt) {
		...
		Filename = "IexWznmBui_" + StrMod::lc(Prjshort) + ".xml";
		srefKMimetype = "xml";
	};
...
void DlgWznmVerBscui::leaveSgeImpdone(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeImpdone --- INSERT
};

uint DlgWznmVerBscui::enterSgePostprc(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgePostprc(
			DbsWznm* dbswznm
		) {
	// IP leaveSgePostprc --- IBEGIN
	ubigint refWznmMVersion = xchg->getRefPreset(VecWznmVPreset::PREWZNMREFVER, jref);

	Wznm::updateVerste(dbswznm, refWznmMVersion, VecWznmVMVersionState::DSNBSCUI);
	// IP leaveSgePostprc --- IEND
};

uint DlgWznmVerBscui::enterSgeDone(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVerBscui::leaveSgeDone(
			DbsWznm* dbswznm
		) {
