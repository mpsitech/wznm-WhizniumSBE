...
bool DlgWznmVerDeploy::evalButDneActive(
			DbsWznm* dbswznm
		) {
	// sge(idle|done)
...
bool DlgWznmVerDeploy::evalImpButRunActive(
			DbsWznm* dbswznm
		) {
	// sge(prsdone)
...
bool DlgWznmVerDeploy::evalImpButStoActive(
			DbsWznm* dbswznm
		) {
	// sge(impidle|import)
...
bool DlgWznmVerDeploy::evalIfiUldActive(
			DbsWznm* dbswznm
		) {
	// sge(idle)
