...
void QryWznmVer1NImpexpcplx::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryWznmVer1NImpexpcplx::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryWznmVer1NImpexpcplx::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmVer1NImpexpcplx"];}();
...
void QryWznmVer1NImpexpcplx::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
