...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const std::string& shortMenu = "", const Sbecore::uint DetLstLocNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFDetLstLoc = NULL, Sbecore::Feed* feedFDetPupBvr = NULL, Sbecore::Feed* feedFDetPupPlc = NULL, Sbecore::Feed* feedFDetPupPrj = NULL, Sbecore::Feed* feedFDetRbuVni = NULL, Sbecore::Feed* feedFSge = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
