/**
	* \file PnlWznmVerMNLocale_blks.cpp
	* job handler for job PnlWznmVerMNLocale (implementation of blocks)
...
/******************************************************************************
 class PnlWznmVerMNLocale::VecVDo
 ******************************************************************************/

uint PnlWznmVerMNLocale::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmVerMNLocale::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmVerMNLocale::ContInf
 ******************************************************************************/

PnlWznmVerMNLocale::ContInf::ContInf(
...
void PnlWznmVerMNLocale::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmVerMNLocale";
...
void PnlWznmVerMNLocale::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmVerMNLocale";
...
set<uint> PnlWznmVerMNLocale::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVerMNLocale::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVerMNLocale::StatApp
 ******************************************************************************/

void PnlWznmVerMNLocale::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmVerMNLocale";
...
void PnlWznmVerMNLocale::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmVerMNLocale";
...
/******************************************************************************
 class PnlWznmVerMNLocale::StatShr
 ******************************************************************************/

PnlWznmVerMNLocale::StatShr::StatShr(
...
void PnlWznmVerMNLocale::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmVerMNLocale";
...
void PnlWznmVerMNLocale::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmVerMNLocale";
...
set<uint> PnlWznmVerMNLocale::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVerMNLocale::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVerMNLocale::StgIac
 ******************************************************************************/

PnlWznmVerMNLocale::StgIac::StgIac(
...
bool PnlWznmVerMNLocale::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmVerMNLocale");
	else
...
void PnlWznmVerMNLocale::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmVerMNLocale";
...
void PnlWznmVerMNLocale::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWznmVerMNLocale::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmVerMNLocale::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmVerMNLocale::Tag
 ******************************************************************************/

void PnlWznmVerMNLocale::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmVerMNLocale";
...
void PnlWznmVerMNLocale::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmVerMNLocale";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Locales");
			writeStringAttr(wr, itemtag, "sref", "TcoMref", "Locale");
		};
...
/******************************************************************************
 class PnlWznmVerMNLocale::DpchAppData
 ******************************************************************************/

PnlWznmVerMNLocale::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVERMNLOCALEDATA)
		{
};

string PnlWznmVerMNLocale::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVerMNLocale::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmVerMNLocaleData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmVerMNLocale::DpchAppDo
 ******************************************************************************/

PnlWznmVerMNLocale::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMVERMNLOCALEDO)
		{
	ixVDo = 0;
};

string PnlWznmVerMNLocale::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVerMNLocale::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmVerMNLocaleDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmVerMNLocale::DpchEngData
 ******************************************************************************/

PnlWznmVerMNLocale::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmVerMNLocale::StatShr* statshrqry
			, QryWznmVerMNLocale::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMVERMNLOCALEDATA, jref)
		{
...
string PnlWznmVerMNLocale::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmVerMNLocale::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmVerMNLocale::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmVerMNLocaleData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmVerMNLocale::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmVerMNLocale::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmVerMNLocaleData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmVerMNLocale::StatApp::writeXML(wr);
