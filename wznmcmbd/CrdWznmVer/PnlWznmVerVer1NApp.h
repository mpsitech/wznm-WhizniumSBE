...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NApp* rst = NULL, QryWznmVerVer1NApp::StatShr* statshrqry = NULL, QryWznmVerVer1NApp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
