...
#define VecVWznmVerVer1NAppDo PnlWznmVerVer1NApp::VecVDo

#define ContInfWznmVerVer1NApp PnlWznmVerVer1NApp::ContInf
#define StatAppWznmVerVer1NApp PnlWznmVerVer1NApp::StatApp
#define StatShrWznmVerVer1NApp PnlWznmVerVer1NApp::StatShr
#define StgIacWznmVerVer1NApp PnlWznmVerVer1NApp::StgIac
#define TagWznmVerVer1NApp PnlWznmVerVer1NApp::Tag

#define DpchAppWznmVerVer1NAppData PnlWznmVerVer1NApp::DpchAppData
#define DpchAppWznmVerVer1NAppDo PnlWznmVerVer1NApp::DpchAppDo
#define DpchEngWznmVerVer1NAppData PnlWznmVerVer1NApp::DpchEngData

/**
	* PnlWznmVerVer1NApp
	*/
class PnlWznmVerVer1NApp : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NApp* rst = NULL, QryWznmVerVer1NApp::StatShr* statshrqry = NULL, QryWznmVerVer1NApp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVerVer1NApp(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVerVer1NApp();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVerVer1NApp::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
