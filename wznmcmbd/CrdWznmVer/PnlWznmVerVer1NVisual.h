/**
	* \file PnlWznmVerVer1NVisual.h
	* job handler for job PnlWznmVerVer1NVisual (declarations)
...
#ifndef PNLWZNMVERVER1NVISUAL_H
#define PNLWZNMVERVER1NVISUAL_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#include "QryWznmVerVer1NVisual.h"

#define VecVWznmVerVer1NVisualDo PnlWznmVerVer1NVisual::VecVDo

#define ContInfWznmVerVer1NVisual PnlWznmVerVer1NVisual::ContInf
#define StatAppWznmVerVer1NVisual PnlWznmVerVer1NVisual::StatApp
#define StatShrWznmVerVer1NVisual PnlWznmVerVer1NVisual::StatShr
#define StgIacWznmVerVer1NVisual PnlWznmVerVer1NVisual::StgIac
#define TagWznmVerVer1NVisual PnlWznmVerVer1NVisual::Tag

#define DpchAppWznmVerVer1NVisualData PnlWznmVerVer1NVisual::DpchAppData
#define DpchAppWznmVerVer1NVisualDo PnlWznmVerVer1NVisual::DpchAppDo
#define DpchEngWznmVerVer1NVisualData PnlWznmVerVer1NVisual::DpchEngData

/**
	* PnlWznmVerVer1NVisual
	*/
class PnlWznmVerVer1NVisual : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NVisual* rst = NULL, QryWznmVerVer1NVisual::StatShr* statshrqry = NULL, QryWznmVerVer1NVisual::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVerVer1NVisual(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVerVer1NVisual();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVerVer1NVisual::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
