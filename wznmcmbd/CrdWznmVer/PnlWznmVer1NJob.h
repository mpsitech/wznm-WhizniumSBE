...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVer1NJob* rst = NULL, QryWznmVer1NJob::StatShr* statshrqry = NULL, QryWznmVer1NJob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
