...
void PnlWznmVerBvr1NVersion::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmVerBvr1NVersion::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmVerBvr1NVersion::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlWznmVerBvr1NVersion::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmVerBvr1NVersion"];}();
...
void PnlWznmVerBvr1NVersion::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmVerBvr1NVersion::Tag::writeJSON(
...
void PnlWznmVerBvr1NVersion::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVerBvr1NVersionData"];}();
...
void PnlWznmVerBvr1NVersion::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmVerBvr1NVersionDo"];}();
...
void PnlWznmVerBvr1NVersion::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmVerBvr1NVersionData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmVerBvr1NVersion::StatApp::writeJSON(me);
