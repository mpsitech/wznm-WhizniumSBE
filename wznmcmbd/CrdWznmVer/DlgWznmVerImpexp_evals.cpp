/**
	* \file DlgWznmVerImpexp_evals.cpp
	* job handler for job DlgWznmVerImpexp (implementation of availability/activation evaluation)
...
bool DlgWznmVerImpexp::evalButDneActive(
			DbsWznm* dbswznm
		) {
	// sge(idle|done)
...
bool DlgWznmVerImpexp::evalImpButRunActive(
			DbsWznm* dbswznm
		) {
	// sge(prsdone)
...
bool DlgWznmVerImpexp::evalImpButStoActive(
			DbsWznm* dbswznm
		) {
	// sge(impidle|import)
...
bool DlgWznmVerImpexp::evalIfiUldActive(
			DbsWznm* dbswznm
		) {
	// sge(idle)
