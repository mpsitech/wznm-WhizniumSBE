...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NError* rst = NULL, QryWznmVerVer1NError::StatShr* statshrqry = NULL, QryWznmVerVer1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
