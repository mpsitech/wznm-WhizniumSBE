/**
	* \file PnlWznmVerVer1NError.h
	* job handler for job PnlWznmVerVer1NError (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMVERVER1NERROR_H
#define PNLWZNMVERVER1NERROR_H
...
#define VecVWznmVerVer1NErrorDo PnlWznmVerVer1NError::VecVDo

#define ContInfWznmVerVer1NError PnlWznmVerVer1NError::ContInf
#define StatAppWznmVerVer1NError PnlWznmVerVer1NError::StatApp
#define StatShrWznmVerVer1NError PnlWznmVerVer1NError::StatShr
#define StgIacWznmVerVer1NError PnlWznmVerVer1NError::StgIac
#define TagWznmVerVer1NError PnlWznmVerVer1NError::Tag

#define DpchAppWznmVerVer1NErrorData PnlWznmVerVer1NError::DpchAppData
#define DpchAppWznmVerVer1NErrorDo PnlWznmVerVer1NError::DpchAppDo
#define DpchEngWznmVerVer1NErrorData PnlWznmVerVer1NError::DpchEngData

/**
	* PnlWznmVerVer1NError
	*/
class PnlWznmVerVer1NError : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NError* rst = NULL, QryWznmVerVer1NError::StatShr* statshrqry = NULL, QryWznmVerVer1NError::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVerVer1NError(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVerVer1NError();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVerVer1NError::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
