...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVer1NCall* rst = NULL, QryWznmVer1NCall::StatShr* statshrqry = NULL, QryWznmVer1NCall::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
