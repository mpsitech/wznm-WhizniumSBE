/**
	* \file PnlWznmVerVer1NModule.h
	* job handler for job PnlWznmVerVer1NModule (declarations)
...
#ifndef PNLWZNMVERVER1NMODULE_H
#define PNLWZNMVERVER1NMODULE_H
...
#define VecVWznmVerVer1NModuleDo PnlWznmVerVer1NModule::VecVDo

#define ContInfWznmVerVer1NModule PnlWznmVerVer1NModule::ContInf
#define StatAppWznmVerVer1NModule PnlWznmVerVer1NModule::StatApp
#define StatShrWznmVerVer1NModule PnlWznmVerVer1NModule::StatShr
#define StgIacWznmVerVer1NModule PnlWznmVerVer1NModule::StgIac
#define TagWznmVerVer1NModule PnlWznmVerVer1NModule::Tag

#define DpchAppWznmVerVer1NModuleData PnlWznmVerVer1NModule::DpchAppData
#define DpchAppWznmVerVer1NModuleDo PnlWznmVerVer1NModule::DpchAppDo
#define DpchEngWznmVerVer1NModuleData PnlWznmVerVer1NModule::DpchEngData

/**
	* PnlWznmVerVer1NModule
	*/
class PnlWznmVerVer1NModule : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NModule* rst = NULL, QryWznmVerVer1NModule::StatShr* statshrqry = NULL, QryWznmVerVer1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVerVer1NModule(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVerVer1NModule();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVerVer1NModule::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
