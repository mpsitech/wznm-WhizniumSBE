...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVerVer1NModule* rst = NULL, QryWznmVerVer1NModule::StatShr* statshrqry = NULL, QryWznmVerVer1NModule::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
