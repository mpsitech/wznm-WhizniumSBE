...
void QryWznmVer1NVector::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
...
void QryWznmVer1NVector::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool QryWznmVer1NVector::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmVer1NVector"];}();
...
void QryWznmVer1NVector::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
