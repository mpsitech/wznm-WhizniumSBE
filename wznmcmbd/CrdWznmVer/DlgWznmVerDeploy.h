/**
	...
	* job handler for job DlgWznmVerDeploy (declarations)
...
#define DpchEngDlgWznmVerDeployData DlgWznmVerDeploy::DpchEngData

/**
	* DlgWznmVerDeploy
	*/
class DlgWznmVerDeploy : public JobWznm {
...
public:
	DlgWznmVerDeploy(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~DlgWznmVerDeploy();
