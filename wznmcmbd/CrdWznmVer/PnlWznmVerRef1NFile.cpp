/**
	...
	* job handler for job PnlWznmVerRef1NFile (implementation)
...
#include "PnlWznmVerRef1NFile_blks.cpp"
#include "PnlWznmVerRef1NFile_evals.cpp"
...
/******************************************************************************
 class PnlWznmVerRef1NFile
 ******************************************************************************/

PnlWznmVerRef1NFile::PnlWznmVerRef1NFile(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMVERREF1NFILE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmVerRef1NFile(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmVerRef1NFile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmVerRef1NFile::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmVerRef1NFile::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmVerRef1NFile::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVERREF1NFILEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMVERREF1NFILEDO) {
...
void PnlWznmVerRef1NFile::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmVerRef1NFile::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVerRef1NFile::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmVerRef1NFile::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQVerRef1NFile* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmVerRef1NFile::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmVerRef1NFile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmVerRef1NFile::StgIac::JNUM)) {
...
void PnlWznmVerRef1NFile::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmVerRef1NFile::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmVerRef1NFile::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmVerRef1NFile::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmVerRef1NFile::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmVerRef1NFile::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
