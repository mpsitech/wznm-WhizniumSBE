/**
	* \file QryWznmErrList.h
	* job handler for job QryWznmErrList (declarations)
...
#ifndef QRYWZNMERRLIST_H
#define QRYWZNMERRLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmErrListOrd QryWznmErrList::VecVOrd

#define StatAppQryWznmErrList QryWznmErrList::StatApp
#define StatShrQryWznmErrList QryWznmErrList::StatShr
#define StgIacQryWznmErrList QryWznmErrList::StgIac

/**
	* QryWznmErrList
	*/
class QryWznmErrList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmErrListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmErrList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmErrList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmErrList)
		*/
...
public:
	QryWznmErrList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmErrList();
...
public:
	...
	WznmQErrList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmErrMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
