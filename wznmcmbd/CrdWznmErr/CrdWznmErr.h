/**
	* \file CrdWznmErr.h
	* job handler for job CrdWznmErr (declarations)
...
#define VecVWznmErrDo CrdWznmErr::VecVDo
#define VecVWznmErrSge CrdWznmErr::VecVSge

#define ContInfWznmErr CrdWznmErr::ContInf
#define StatAppWznmErr CrdWznmErr::StatApp
#define StatShrWznmErr CrdWznmErr::StatShr
#define TagWznmErr CrdWznmErr::Tag

#define DpchAppWznmErrDo CrdWznmErr::DpchAppDo
#define DpchEngWznmErrData CrdWznmErr::DpchEngData

/**
	* CrdWznmErr
	*/
class CrdWznmErr : public JobWznm {
...
public:
	CrdWznmErr(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmErr();
...
public:
	...
	PnlWznmErrRec* pnlrec;
	PnlWznmErrHeadbar* pnlheadbar;
	PnlWznmErrList* pnllist;
