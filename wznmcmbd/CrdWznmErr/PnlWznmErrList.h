/**
	* \file PnlWznmErrList.h
	* job handler for job PnlWznmErrList (declarations)
...
#ifndef PNLWZNMERRLIST_H
#define PNLWZNMERRLIST_H
...
#define VecVWznmErrListDo PnlWznmErrList::VecVDo

#define ContIacWznmErrList PnlWznmErrList::ContIac
#define ContInfWznmErrList PnlWznmErrList::ContInf
#define StatShrWznmErrList PnlWznmErrList::StatShr
#define StgIacWznmErrList PnlWznmErrList::StgIac
#define TagWznmErrList PnlWznmErrList::Tag

#define DpchAppWznmErrListData PnlWznmErrList::DpchAppData
#define DpchAppWznmErrListDo PnlWznmErrList::DpchAppDo
#define DpchEngWznmErrListData PnlWznmErrList::DpchEngData

/**
	* PnlWznmErrList
	*/
class PnlWznmErrList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQErrList* rst = NULL, QryWznmErrList::StatShr* statshrqry = NULL, QryWznmErrList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmErrList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmErrList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmErrList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
