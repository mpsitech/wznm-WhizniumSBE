/**
	* \file PnlWznmErrRec.h
	* job handler for job PnlWznmErrRec (declarations)
...
#ifndef PNLWZNMERRREC_H
#define PNLWZNMERRREC_H
...
#define VecVWznmErrRecDo PnlWznmErrRec::VecVDo

#define ContInfWznmErrRec PnlWznmErrRec::ContInf
#define StatAppWznmErrRec PnlWznmErrRec::StatApp
#define StatShrWznmErrRec PnlWznmErrRec::StatShr
#define TagWznmErrRec PnlWznmErrRec::Tag

#define DpchAppWznmErrRecDo PnlWznmErrRec::DpchAppDo
#define DpchEngWznmErrRecData PnlWznmErrRec::DpchEngData

/**
	* PnlWznmErrRec
	*/
class PnlWznmErrRec : public JobWznm {
...
public:
	PnlWznmErrRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmErrRec();
