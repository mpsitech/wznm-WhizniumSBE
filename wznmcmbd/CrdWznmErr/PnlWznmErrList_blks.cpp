/**
	* \file PnlWznmErrList_blks.cpp
	* job handler for job PnlWznmErrList (implementation of blocks)
...
bool PnlWznmErrList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmErrList"];}();
...
void PnlWznmErrList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmErrList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmErrList";
...
void PnlWznmErrList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmErrList";
...
void PnlWznmErrList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmErrList";
...
void PnlWznmErrList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmErrList";
...
bool PnlWznmErrList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmErrList"];}();
...
void PnlWznmErrList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmErrList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmErrList";
...
void PnlWznmErrList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmErrList";
...
PnlWznmErrList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMERRLISTDATA)
		{
};
...
void PnlWznmErrList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmErrListData"];}();
...
void PnlWznmErrList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmErrListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmErrList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMERRLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWznmErrList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmErrListDo"];}();
...
void PnlWznmErrList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmErrListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmErrList::DpchEngData::DpchEngData(
			...
			, QryWznmErrList::StatShr* statshrqry
			, QryWznmErrList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMERRLISTDATA, jref)
		{
...
void PnlWznmErrList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmErrList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmErrListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmErrList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmErrList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmErrListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmErrList::StatApp::writeXML(wr);
