/**
	...
	* job handler for job PnlWznmErrHeadbar (declarations)
...
/**
	* PnlWznmErrHeadbar
	*/
class PnlWznmErrHeadbar : public JobWznm {
...
public:
	PnlWznmErrHeadbar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmErrHeadbar();
