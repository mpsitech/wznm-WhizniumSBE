/**
	* \file CrdWznmQmd.h
	* job handler for job CrdWznmQmd (declarations)
...
#define VecVWznmQmdDo CrdWznmQmd::VecVDo
#define VecVWznmQmdSge CrdWznmQmd::VecVSge

#define ContInfWznmQmd CrdWznmQmd::ContInf
#define StatAppWznmQmd CrdWznmQmd::StatApp
#define StatShrWznmQmd CrdWznmQmd::StatShr
#define TagWznmQmd CrdWznmQmd::Tag

#define DpchAppWznmQmdDo CrdWznmQmd::DpchAppDo
#define DpchEngWznmQmdData CrdWznmQmd::DpchEngData

/**
	* CrdWznmQmd
	*/
class CrdWznmQmd : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDQMD = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdQmd = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdQmd;
...
public:
	CrdWznmQmd(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmQmd();
...
public:
	...
	PnlWznmQmdRec* pnlrec;
	PnlWznmQmdHeadbar* pnlheadbar;
	PnlWznmQmdList* pnllist;
