/**
	...
	* job handler for job PnlWznmQmdRec (implementation)
...
#include "PnlWznmQmdRec_blks.cpp"
#include "PnlWznmQmdRec_evals.cpp"
...
PnlWznmQmdRec::PnlWznmQmdRec(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMQMDREC, jrefSup, ixWznmVLocale)
		{
...
DpchEngWznm* PnlWznmQmdRec::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmQmdRec::refresh(
	...
	// IP refresh --- BEGIN
	// continf
	continf.TxtRef = StubWznm::getStubQmdStd(dbswznm, recQmd.ref, ixWznmVLocale, Stub::VecVNonetype::FULL);

	// statshr
	if (recQmd.ref == 0) statshr.ixWznmVExpstate = VecWznmVExpstate::MIND;
	...
	if (statshr.ixWznmVExpstate == VecWznmVExpstate::MIND) {
		...
		if (!pnldetail) pnldetail = new PnlWznmQmdDetail(xchg, dbswznm, jref, ixWznmVLocale);
	};
...
void PnlWznmQmdRec::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFQMD) {
		...
		if (dbswznm->tblwznmmquerymod->loadRecByRef(xchg->getRefPreset(VecWznmVPreset::PREWZNMREFQMD, jref), &_recQmd)) {
			recQmd = *_recQmd;
			delete _recQmd;
...
void PnlWznmQmdRec::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQMDRECDO) {
...
void PnlWznmQmdRec::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmQmdRec::handleDpchAppDoButMinimizeClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQmdRec::handleDpchAppDoButRegularizeClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQmdRec::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
	if (call->ixVCall == VecWznmVCall::CALLWZNMQMD_REUEQ) {
...
bool PnlWznmQmdRec::handleCallWznmQmd_reuEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
...
bool PnlWznmQmdRec::handleCallWznmQmd_retEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const uint ixInv
			, bool& boolvalRet
...
bool PnlWznmQmdRec::handleCallWznmQmd_qryEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmQmdRec::handleCallWznmQmd_pstEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
			, const ubigint refInv
			, bool& boolvalRet
...
bool PnlWznmQmdRec::handleCallWznmQmdUpd_refEq(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
