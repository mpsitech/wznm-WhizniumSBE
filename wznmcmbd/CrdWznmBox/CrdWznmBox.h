/**
	* \file CrdWznmBox.h
	* job handler for job CrdWznmBox (declarations)
...
#include "PnlWznmBoxHeadbar.h"
#include "PnlWznmBoxRec.h"

#define VecVWznmBoxDo CrdWznmBox::VecVDo
#define VecVWznmBoxSge CrdWznmBox::VecVSge

#define ContInfWznmBox CrdWznmBox::ContInf
#define StatAppWznmBox CrdWznmBox::StatApp
#define StatShrWznmBox CrdWznmBox::StatShr
#define TagWznmBox CrdWznmBox::Tag

#define DpchAppWznmBoxDo CrdWznmBox::DpchAppDo
#define DpchEngWznmBoxData CrdWznmBox::DpchEngData

/**
	* CrdWznmBox
	*/
class CrdWznmBox : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDBOX = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdBox = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdBox;
...
public:
	CrdWznmBox(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmBox();
...
public:
	...
	PnlWznmBoxList* pnllist;
	PnlWznmBoxHeadbar* pnlheadbar;
	PnlWznmBoxRec* pnlrec;
