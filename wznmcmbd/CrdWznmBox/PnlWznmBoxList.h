/**
	* \file PnlWznmBoxList.h
	* job handler for job PnlWznmBoxList (declarations)
...
#ifndef PNLWZNMBOXLIST_H
#define PNLWZNMBOXLIST_H
...
#define VecVWznmBoxListDo PnlWznmBoxList::VecVDo

#define ContIacWznmBoxList PnlWznmBoxList::ContIac
#define ContInfWznmBoxList PnlWznmBoxList::ContInf
#define StatShrWznmBoxList PnlWznmBoxList::StatShr
#define StgIacWznmBoxList PnlWznmBoxList::StgIac
#define TagWznmBoxList PnlWznmBoxList::Tag

#define DpchAppWznmBoxListData PnlWznmBoxList::DpchAppData
#define DpchAppWznmBoxListDo PnlWznmBoxList::DpchAppDo
#define DpchEngWznmBoxListData PnlWznmBoxList::DpchEngData

/**
	* PnlWznmBoxList
	*/
class PnlWznmBoxList : public JobWznm {
...
public:
	...
	public:
		static const Sbecore::uint TCOSHTWIDTH = 1;
		static const Sbecore::uint TCOMTBWIDTH = 2;
		static const Sbecore::uint TCOUNVWIDTH = 3;

	public:
		StgIac(const Sbecore::uint TcoShtWidth = 100, const Sbecore::uint TcoMtbWidth = 100, const Sbecore::uint TcoUnvWidth = 100);

	public:
		Sbecore::uint TcoShtWidth;
		Sbecore::uint TcoMtbWidth;
		Sbecore::uint TcoUnvWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQBoxList* rst = NULL, QryWznmBoxList::StatShr* statshrqry = NULL, QryWznmBoxList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmBoxList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmBoxList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmBoxList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
