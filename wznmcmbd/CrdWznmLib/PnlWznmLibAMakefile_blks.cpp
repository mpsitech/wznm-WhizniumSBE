...
/******************************************************************************
 class PnlWznmLibAMakefile::VecVDo
 ******************************************************************************/

uint PnlWznmLibAMakefile::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmLibAMakefile::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmLibAMakefile::ContInf
 ******************************************************************************/

PnlWznmLibAMakefile::ContInf::ContInf(
...
void PnlWznmLibAMakefile::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmLibAMakefile";
...
void PnlWznmLibAMakefile::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmLibAMakefile";
...
set<uint> PnlWznmLibAMakefile::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAMakefile::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAMakefile::StatApp
 ******************************************************************************/

void PnlWznmLibAMakefile::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmLibAMakefile";
...
void PnlWznmLibAMakefile::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmLibAMakefile";
...
/******************************************************************************
 class PnlWznmLibAMakefile::StatShr
 ******************************************************************************/

PnlWznmLibAMakefile::StatShr::StatShr(
...
void PnlWznmLibAMakefile::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmLibAMakefile";
...
void PnlWznmLibAMakefile::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmLibAMakefile";
...
set<uint> PnlWznmLibAMakefile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAMakefile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAMakefile::StgIac
 ******************************************************************************/
...
bool PnlWznmLibAMakefile::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmLibAMakefile");
	else
...
void PnlWznmLibAMakefile::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmLibAMakefile";
...
void PnlWznmLibAMakefile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> PnlWznmLibAMakefile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAMakefile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAMakefile::Tag
 ******************************************************************************/

void PnlWznmLibAMakefile::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmLibAMakefile";
...
void PnlWznmLibAMakefile::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmLibAMakefile";
...
/******************************************************************************
 class PnlWznmLibAMakefile::DpchAppData
 ******************************************************************************/

PnlWznmLibAMakefile::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAMAKEFILEDATA)
		{
};

string PnlWznmLibAMakefile::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAMakefile::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLibAMakefileData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmLibAMakefile::DpchAppDo
 ******************************************************************************/

PnlWznmLibAMakefile::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAMAKEFILEDO)
		{
	ixVDo = 0;
};

string PnlWznmLibAMakefile::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAMakefile::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLibAMakefileDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmLibAMakefile::DpchEngData
 ******************************************************************************/

PnlWznmLibAMakefile::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmLibAMakefile::StatShr* statshrqry
			, QryWznmLibAMakefile::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBAMAKEFILEDATA, jref)
		{
...
string PnlWznmLibAMakefile::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAMakefile::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmLibAMakefile::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmLibAMakefileData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmLibAMakefile::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmLibAMakefile::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmLibAMakefileData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmLibAMakefile::StatApp::writeXML(wr);
