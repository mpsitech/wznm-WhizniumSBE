/**
	...
	* job handler for job PnlWznmLibAMakefile (declarations)
...
#define VecVWznmLibAMakefileDo PnlWznmLibAMakefile::VecVDo

#define ContInfWznmLibAMakefile PnlWznmLibAMakefile::ContInf
#define StatAppWznmLibAMakefile PnlWznmLibAMakefile::StatApp
#define StatShrWznmLibAMakefile PnlWznmLibAMakefile::StatShr
#define StgIacWznmLibAMakefile PnlWznmLibAMakefile::StgIac
#define TagWznmLibAMakefile PnlWznmLibAMakefile::Tag

#define DpchAppWznmLibAMakefileData PnlWznmLibAMakefile::DpchAppData
#define DpchAppWznmLibAMakefileDo PnlWznmLibAMakefile::DpchAppDo
#define DpchEngWznmLibAMakefileData PnlWznmLibAMakefile::DpchEngData

/**
	* PnlWznmLibAMakefile
	*/
class PnlWznmLibAMakefile : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQLibAMakefile* rst = NULL, QryWznmLibAMakefile::StatShr* statshrqry = NULL, QryWznmLibAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmLibAMakefile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLibAMakefile();
...
public:
	...
	QryWznmLibAMakefile* qry;

	WznmAMLibraryMakefile recLibAmkf;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmLibAMakefile::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
