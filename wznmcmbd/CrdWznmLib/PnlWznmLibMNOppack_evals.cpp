...
bool PnlWznmLibMNOppack::evalButViewAvail(
			DbsWznm* dbswznm
		) {
...
bool PnlWznmLibMNOppack::evalButViewActive(
			DbsWznm* dbswznm
		) {
	// sel()
...
bool PnlWznmLibMNOppack::evalButAddAvail(
			DbsWznm* dbswznm
		) {
...
bool PnlWznmLibMNOppack::evalButSubAvail(
			DbsWznm* dbswznm
		) {
	// pre.ixCrdaccLibIncl(edit)
...
bool PnlWznmLibMNOppack::evalButSubActive(
			DbsWznm* dbswznm
		) {
	// sel()
