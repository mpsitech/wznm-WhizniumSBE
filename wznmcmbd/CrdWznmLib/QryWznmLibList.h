...
#define QRYWZNMLIBLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmLibListOrd QryWznmLibList::VecVOrd

#define StatAppQryWznmLibList QryWznmLibList::StatApp
#define StatShrQryWznmLibList QryWznmLibList::StatShr
#define StgIacQryWznmLibList QryWznmLibList::StgIac

/**
	* QryWznmLibList
	*/
class QryWznmLibList : public JobWznm {
...
public:
	QryWznmLibList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmLibList();
...
public:
	...
	WznmQLibList* getRecByJnum(const Sbecore::uint jnum);
