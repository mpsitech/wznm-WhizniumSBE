...
#define VecVWznmLibAPkglistDo PnlWznmLibAPkglist::VecVDo

#define ContInfWznmLibAPkglist PnlWznmLibAPkglist::ContInf
#define StatAppWznmLibAPkglist PnlWznmLibAPkglist::StatApp
#define StatShrWznmLibAPkglist PnlWznmLibAPkglist::StatShr
#define StgIacWznmLibAPkglist PnlWznmLibAPkglist::StgIac
#define TagWznmLibAPkglist PnlWznmLibAPkglist::Tag

#define DpchAppWznmLibAPkglistData PnlWznmLibAPkglist::DpchAppData
#define DpchAppWznmLibAPkglistDo PnlWznmLibAPkglist::DpchAppDo
#define DpchEngWznmLibAPkglistData PnlWznmLibAPkglist::DpchEngData

/**
	* PnlWznmLibAPkglist
	*/
class PnlWznmLibAPkglist : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQLibAPkglist* rst = NULL, QryWznmLibAPkglist::StatShr* statshrqry = NULL, QryWznmLibAPkglist::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmLibAPkglist(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLibAPkglist();
...
public:
	...
	QryWznmLibAPkglist* qry;

	WznmAMLibraryPkglist recLibApkl;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmLibAPkglist::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
