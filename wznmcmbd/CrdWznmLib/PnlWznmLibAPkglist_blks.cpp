...
/******************************************************************************
 class PnlWznmLibAPkglist::VecVDo
 ******************************************************************************/

uint PnlWznmLibAPkglist::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmLibAPkglist::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmLibAPkglist::ContInf
 ******************************************************************************/

PnlWznmLibAPkglist::ContInf::ContInf(
...
void PnlWznmLibAPkglist::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmLibAPkglist";
...
void PnlWznmLibAPkglist::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmLibAPkglist";
...
set<uint> PnlWznmLibAPkglist::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAPkglist::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAPkglist::StatApp
 ******************************************************************************/

void PnlWznmLibAPkglist::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmLibAPkglist";
...
void PnlWznmLibAPkglist::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmLibAPkglist";
...
/******************************************************************************
 class PnlWznmLibAPkglist::StatShr
 ******************************************************************************/

PnlWznmLibAPkglist::StatShr::StatShr(
...
void PnlWznmLibAPkglist::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmLibAPkglist";
...
void PnlWznmLibAPkglist::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmLibAPkglist";
...
set<uint> PnlWznmLibAPkglist::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAPkglist::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAPkglist::StgIac
 ******************************************************************************/
...
bool PnlWznmLibAPkglist::StgIac::readJSON(
	...
	if (basefound) {
		...
		if (me.isMember("TcoPklWidth")) {TcoPklWidth = me["TcoPklWidth"].asUInt(); add(TCOPKLWIDTH);};
	};
...
bool PnlWznmLibAPkglist::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmLibAPkglist");
	else
...
void PnlWznmLibAPkglist::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmLibAPkglist";
...
set<uint> PnlWznmLibAPkglist::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmLibAPkglist::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmLibAPkglist::Tag
 ******************************************************************************/

void PnlWznmLibAPkglist::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmLibAPkglist";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Package lists";
		me["TcoMch"] = "Machine";
		me["TcoPkl"] = "Package list";
	};
...
void PnlWznmLibAPkglist::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmLibAPkglist";
...
/******************************************************************************
 class PnlWznmLibAPkglist::DpchAppData
 ******************************************************************************/

PnlWznmLibAPkglist::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAPKGLISTDATA)
		{
};

string PnlWznmLibAPkglist::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAPkglist::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLibAPkglistData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmLibAPkglist::DpchAppDo
 ******************************************************************************/

PnlWznmLibAPkglist::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLIBAPKGLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmLibAPkglist::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAPkglist::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLibAPkglistDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmLibAPkglist::DpchEngData
 ******************************************************************************/

PnlWznmLibAPkglist::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmLibAPkglist::StatShr* statshrqry
			, QryWznmLibAPkglist::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLIBAPKGLISTDATA, jref)
		{
...
string PnlWznmLibAPkglist::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmLibAPkglist::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmLibAPkglist::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmLibAPkglistData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmLibAPkglist::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmLibAPkglist::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmLibAPkglistData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmLibAPkglist::StatApp::writeXML(wr);
