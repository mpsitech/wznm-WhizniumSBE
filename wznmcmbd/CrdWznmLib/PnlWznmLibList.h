/**
	* \file PnlWznmLibList.h
	* job handler for job PnlWznmLibList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMLIBLIST_H
#define PNLWZNMLIBLIST_H
...
#define VecVWznmLibListDo PnlWznmLibList::VecVDo

#define ContIacWznmLibList PnlWznmLibList::ContIac
#define ContInfWznmLibList PnlWznmLibList::ContInf
#define StatShrWznmLibList PnlWznmLibList::StatShr
#define StgIacWznmLibList PnlWznmLibList::StgIac
#define TagWznmLibList PnlWznmLibList::Tag

#define DpchAppWznmLibListData PnlWznmLibList::DpchAppData
#define DpchAppWznmLibListDo PnlWznmLibList::DpchAppDo
#define DpchEngWznmLibListData PnlWznmLibList::DpchEngData

/**
	* PnlWznmLibList
	*/
class PnlWznmLibList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOLTYWIDTH = 4;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoLtyWidth = 100);

	public:
		Sbecore::uint TcoSrfWidth;
		Sbecore::uint TcoTitWidth;
		Sbecore::uint TcoVerWidth;
		Sbecore::uint TcoLtyWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQLibList* rst = NULL, QryWznmLibList::StatShr* statshrqry = NULL, QryWznmLibList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmLibList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLibList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmLibList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
