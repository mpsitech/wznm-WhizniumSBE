...
#define StatAppQryWznmLibAMakefile QryWznmLibAMakefile::StatApp
#define StatShrQryWznmLibAMakefile QryWznmLibAMakefile::StatShr
#define StgIacQryWznmLibAMakefile QryWznmLibAMakefile::StgIac

/**
	* QryWznmLibAMakefile
	*/
class QryWznmLibAMakefile : public JobWznm {
...
public:
	QryWznmLibAMakefile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmLibAMakefile();
...
public:
	...
	WznmQLibAMakefile* getRecByJnum(const Sbecore::uint jnum);
