/**
	...
	* job handler for job PnlWznmLibRef1NFile (implementation)
...
#include "PnlWznmLibRef1NFile_blks.cpp"
#include "PnlWznmLibRef1NFile_evals.cpp"
...
/******************************************************************************
 class PnlWznmLibRef1NFile
 ******************************************************************************/

PnlWznmLibRef1NFile::PnlWznmLibRef1NFile(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMLIBREF1NFILE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmLibRef1NFile(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmLibRef1NFile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmLibRef1NFile::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmLibRef1NFile::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmLibRef1NFile::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMLIBREF1NFILEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMLIBREF1NFILEDO) {
...
void PnlWznmLibRef1NFile::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmLibRef1NFile::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmLibRef1NFile::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmLibRef1NFile::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQLibRef1NFile* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmLibRef1NFile::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmLibRef1NFile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmLibRef1NFile::StgIac::JNUM)) {
...
void PnlWznmLibRef1NFile::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmLibRef1NFile::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmLibRef1NFile::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmLibRef1NFile::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmLibRef1NFile::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmLibRef1NFile::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
