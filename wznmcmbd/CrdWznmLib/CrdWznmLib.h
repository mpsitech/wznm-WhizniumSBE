/**
	* \file CrdWznmLib.h
	* job handler for job CrdWznmLib (declarations)
...
#define VecVWznmLibDo CrdWznmLib::VecVDo
#define VecVWznmLibSge CrdWznmLib::VecVSge

#define ContInfWznmLib CrdWznmLib::ContInf
#define StatAppWznmLib CrdWznmLib::StatApp
#define StatShrWznmLib CrdWznmLib::StatShr
#define TagWznmLib CrdWznmLib::Tag

#define DpchAppWznmLibDo CrdWznmLib::DpchAppDo
#define DpchEngWznmLibData CrdWznmLib::DpchEngData

/**
	* CrdWznmLib
	*/
class CrdWznmLib : public JobWznm {
...
public:
	CrdWznmLib(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmLib();
...
public:
	...
	PnlWznmLibList* pnllist;
	PnlWznmLibHeadbar* pnlheadbar;
	PnlWznmLibRec* pnlrec;
