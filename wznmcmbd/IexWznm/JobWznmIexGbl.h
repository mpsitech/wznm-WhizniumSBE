/**
	* \file JobWznmIexGbl.h
	* job handler for job JobWznmIexGbl (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef JOBWZNMIEXGBL_H
#define JOBWZNMIEXGBL_H

#include "IexWznmGbl.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexGblSge JobWznmIexGbl::VecVSge

/**
	* JobWznmIexGbl
	*/
class JobWznmIexGbl : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexGblSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexGbl(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexGbl();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmGbl::icsWznmVIopInsAll());
