/**
	* \file JobWznmIexUix.h
	* job handler for job JobWznmIexUix (declarations)
...
#ifndef JOBWZNMIEXUIX_H
#define JOBWZNMIEXUIX_H

#include "IexWznmUix.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexUixSge JobWznmIexUix::VecVSge

/**
	* JobWznmIexUix
	*/
class JobWznmIexUix : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexUixSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexUix(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexUix();
...
public:
	// IP cust --- IBEGIN
	void removeControl(DbsWznm* dbswznm, const Sbecore::ubigint refWznmMControl);
	// IP cust --- IEND
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmUix::icsWznmVIopInsAll());
