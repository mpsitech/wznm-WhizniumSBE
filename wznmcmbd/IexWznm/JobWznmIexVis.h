/**
	* \file JobWznmIexVis.h
	* job handler for job JobWznmIexVis (declarations)
...
#ifndef JOBWZNMIEXVIS_H
#define JOBWZNMIEXVIS_H

#include "IexWznmVis.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexVisSge JobWznmIexVis::VecVSge

/**
	* JobWznmIexVis
	*/
class JobWznmIexVis : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexVisSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexVis(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexVis();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmVis::icsWznmVIopInsAll());
