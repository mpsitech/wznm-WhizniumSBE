/**
	* \file JobWznmIexOpk_blks.cpp
	* job handler for job JobWznmIexOpk (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexOpk::VecVSge
 ******************************************************************************/

uint JobWznmIexOpk::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexOpk::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexOpk::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
