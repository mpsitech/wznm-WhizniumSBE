/**
	* \file JobWznmIexIni_blks.cpp
	* job handler for job JobWznmIexIni (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexIni::VecVSge
 ******************************************************************************/

uint JobWznmIexIni::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexIni::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexIni::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
