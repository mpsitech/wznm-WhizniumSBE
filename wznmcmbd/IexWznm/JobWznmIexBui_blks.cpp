/**
	* \file JobWznmIexBui_blks.cpp
	* job handler for job JobWznmIexBui (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexBui::VecVSge
 ******************************************************************************/

uint JobWznmIexBui::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexBui::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexBui::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
