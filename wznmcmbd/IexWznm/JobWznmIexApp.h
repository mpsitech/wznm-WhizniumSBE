...
#define JOBWZNMIEXAPP_H

#include "IexWznmApp.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexAppSge JobWznmIexApp::VecVSge

/**
	* JobWznmIexApp
	*/
class JobWznmIexApp : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexAppSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexApp(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexApp();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmApp::icsWznmVIopInsAll());
