/**
	* \file JobWznmIexBui.h
	* job handler for job JobWznmIexBui (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef JOBWZNMIEXBUI_H
#define JOBWZNMIEXBUI_H

#include "IexWznmBui.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexBuiSge JobWznmIexBui::VecVSge

/**
	* JobWznmIexBui
	*/
class JobWznmIexBui : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexBuiSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexBui(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexBui();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmBui::icsWznmVIopInsAll());
