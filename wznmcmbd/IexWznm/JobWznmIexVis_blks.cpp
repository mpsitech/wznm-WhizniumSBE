/**
	* \file JobWznmIexVis_blks.cpp
	* job handler for job JobWznmIexVis (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexVis::VecVSge
 ******************************************************************************/

uint JobWznmIexVis::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexVis::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexVis::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
