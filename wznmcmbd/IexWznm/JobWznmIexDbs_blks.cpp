/**
	* \file JobWznmIexDbs_blks.cpp
	* job handler for job JobWznmIexDbs (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexDbs::VecVSge
 ******************************************************************************/

uint JobWznmIexDbs::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexDbs::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexDbs::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
