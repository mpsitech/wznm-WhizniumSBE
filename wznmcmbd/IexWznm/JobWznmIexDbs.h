/**
	* \file JobWznmIexDbs.h
	* job handler for job JobWznmIexDbs (declarations)
...
#ifndef JOBWZNMIEXDBS_H
#define JOBWZNMIEXDBS_H

#include "IexWznmDbs.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexDbsSge JobWznmIexDbs::VecVSge

/**
	* JobWznmIexDbs
	*/
class JobWznmIexDbs : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexDbsSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexDbs(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexDbs();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmDbs::icsWznmVIopInsAll());
