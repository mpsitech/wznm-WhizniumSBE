/**
	* \file JobWznmIexPrj.h
	* job handler for job JobWznmIexPrj (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef JOBWZNMIEXPRJ_H
#define JOBWZNMIEXPRJ_H

#include "IexWznmPrj.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexPrjSge JobWznmIexPrj::VecVSge

/**
	* JobWznmIexPrj
	*/
class JobWznmIexPrj : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexPrjSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexPrj(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexPrj();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmPrj::icsWznmVIopInsAll());
