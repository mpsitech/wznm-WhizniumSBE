/**
	* \file JobWznmIexJob.h
	* job handler for job JobWznmIexJob (declarations)
...
#ifndef JOBWZNMIEXJOB_H
#define JOBWZNMIEXJOB_H

#include "IexWznmJob.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexJobSge JobWznmIexJob::VecVSge

/**
	* JobWznmIexJob
	*/
class JobWznmIexJob : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexJobSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexJob(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexJob();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmJob::icsWznmVIopInsAll());
