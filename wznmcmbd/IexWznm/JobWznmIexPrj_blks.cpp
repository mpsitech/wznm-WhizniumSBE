/**
	* \file JobWznmIexPrj_blks.cpp
	* job handler for job JobWznmIexPrj (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexPrj::VecVSge
 ******************************************************************************/

uint JobWznmIexPrj::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexPrj::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexPrj::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
