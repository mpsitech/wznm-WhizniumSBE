/**
	* \file JobWznmIexApp_blks.cpp
	* job handler for job JobWznmIexApp (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexApp::VecVSge
 ******************************************************************************/

uint JobWznmIexApp::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexApp::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexApp::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
