/**
	* \file JobWznmIexUix_blks.cpp
	* job handler for job JobWznmIexUix (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexUix::VecVSge
 ******************************************************************************/

uint JobWznmIexUix::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexUix::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexUix::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
