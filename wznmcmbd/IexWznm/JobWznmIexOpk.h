/**
	* \file JobWznmIexOpk.h
	* job handler for job JobWznmIexOpk (declarations)
...
#ifndef JOBWZNMIEXOPK_H
#define JOBWZNMIEXOPK_H

#include "IexWznmOpk.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexOpkSge JobWznmIexOpk::VecVSge

/**
	* JobWznmIexOpk
	*/
class JobWznmIexOpk : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexOpkSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexOpk(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexOpk();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmOpk::icsWznmVIopInsAll());
