/**
	* \file JobWznmIexIex_blks.cpp
	* job handler for job JobWznmIexIex (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexIex::VecVSge
 ******************************************************************************/

uint JobWznmIexIex::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexIex::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexIex::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
