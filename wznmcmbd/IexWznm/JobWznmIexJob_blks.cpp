/**
	* \file JobWznmIexJob_blks.cpp
	* job handler for job JobWznmIexJob (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexJob::VecVSge
 ******************************************************************************/

uint JobWznmIexJob::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexJob::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexJob::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
