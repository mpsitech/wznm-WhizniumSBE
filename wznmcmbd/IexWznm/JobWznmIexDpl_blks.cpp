/**
	* \file JobWznmIexDpl_blks.cpp
	* job handler for job JobWznmIexDpl (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexDpl::VecVSge
 ******************************************************************************/

uint JobWznmIexDpl::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexDpl::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexDpl::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
