/**
	* \file JobWznmIexGbl_blks.cpp
	* job handler for job JobWznmIexGbl (implementation of blocks)
...
/******************************************************************************
 class JobWznmIexGbl::VecVSge
 ******************************************************************************/

uint JobWznmIexGbl::VecVSge::getIx(
			const string& sref
		) {
...
string JobWznmIexGbl::VecVSge::getSref(
			const uint ix
		) {
...
void JobWznmIexGbl::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
