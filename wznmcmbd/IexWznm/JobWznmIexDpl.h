/**
	* \file JobWznmIexDpl.h
	* job handler for job JobWznmIexDpl (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef JOBWZNMIEXDPL_H
#define JOBWZNMIEXDPL_H

#include "IexWznmDpl.h"

// IP include.cust --- INSERT

#define VecVJobWznmIexDplSge JobWznmIexDpl::VecVSge

/**
	* JobWznmIexDpl
	*/
class JobWznmIexDpl : public JobWznm {

public:
	/**
		* VecVSge (full: VecVJobWznmIexDplSge)
		*/
	class VecVSge {
...
public:
	JobWznmIexDpl(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~JobWznmIexDpl();
...
public:
	...
	void collect(DbsWznm* dbswznm, const std::map<Sbecore::uint,Sbecore::uint>& _icsWznmVIop = IexWznmDpl::icsWznmVIopInsAll());
