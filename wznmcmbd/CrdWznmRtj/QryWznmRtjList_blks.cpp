/**
	* \file QryWznmRtjList_blks.cpp
	* job handler for job QryWznmRtjList (implementation of blocks)
...
void QryWznmRtjList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmRtjList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWznmRtjList";
...
void QryWznmRtjList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmRtjList";
...
bool QryWznmRtjList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmRtjList"];}();
