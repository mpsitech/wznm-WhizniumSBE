...
#define StatAppQryWznmRtj1NRtblock QryWznmRtj1NRtblock::StatApp
#define StatShrQryWznmRtj1NRtblock QryWznmRtj1NRtblock::StatShr
#define StgIacQryWznmRtj1NRtblock QryWznmRtj1NRtblock::StgIac

/**
	* QryWznmRtj1NRtblock
	*/
class QryWznmRtj1NRtblock : public JobWznm {
...
public:
	QryWznmRtj1NRtblock(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmRtj1NRtblock();
...
public:
	...
	WznmQRtj1NRtblock* getRecByJnum(const Sbecore::uint jnum);
