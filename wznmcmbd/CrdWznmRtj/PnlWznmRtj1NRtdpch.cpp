/**
	...
	* job handler for job PnlWznmRtj1NRtdpch (implementation)
...
#include "PnlWznmRtj1NRtdpch_blks.cpp"
#include "PnlWznmRtj1NRtdpch_evals.cpp"
...
/******************************************************************************
 class PnlWznmRtj1NRtdpch
 ******************************************************************************/

PnlWznmRtj1NRtdpch::PnlWznmRtj1NRtdpch(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRTJ1NRTDPCH, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRtj1NRtdpch(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRtj1NRtdpch::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRtj1NRtdpch::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmRtj1NRtdpch::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRtj1NRtdpch::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRTJ1NRTDPCHDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRTJ1NRTDPCHDO) {
...
void PnlWznmRtj1NRtdpch::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRtj1NRtdpch::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRtj1NRtdpch::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRtj1NRtdpch::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRtj1NRtdpch* recSelNew = NULL;

	WznmMRtdpch* _recRtd = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRtj1NRtdpch::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRtj1NRtdpch::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRtj1NRtdpch::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recRtd = WznmMRtdpch();

			if (recSelNew) {
				if (dbswznm->tblwznmmrtdpch->loadRecByRef(recSelNew->ref, &_recRtd)) {
					recRtd = *_recRtd;
					delete _recRtd;
				};
			};
...
void PnlWznmRtj1NRtdpch::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRtj1NRtdpch::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRtj1NRtdpch::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRtj1NRtdpch::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
