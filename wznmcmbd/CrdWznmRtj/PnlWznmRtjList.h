/**
	...
	* job handler for job PnlWznmRtjList (declarations)
...
/**
	* PnlWznmRtjList
	*/
class PnlWznmRtjList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQRtjList* rst = NULL, QryWznmRtjList::StatShr* statshrqry = NULL, QryWznmRtjList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmRtjList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmRtjList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmRtjList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
