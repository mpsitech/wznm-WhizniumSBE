/**
	* \file QryWznmRtjList.h
	* job handler for job QryWznmRtjList (declarations)
...
#ifndef QRYWZNMRTJLIST_H
#define QRYWZNMRTJLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmRtjListOrd QryWznmRtjList::VecVOrd

#define StatAppQryWznmRtjList QryWznmRtjList::StatApp
#define StatShrQryWznmRtjList QryWznmRtjList::StatShr
#define StgIacQryWznmRtjList QryWznmRtjList::StgIac

/**
	* QryWznmRtjList
	*/
class QryWznmRtjList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmRtjListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmRtjList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmRtjList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmRtjList)
		*/
...
public:
	QryWznmRtjList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmRtjList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preApp, const Sbecore::ubigint preSup, const Sbecore::ubigint preJob, const bool addwhere);
	...
	WznmQRtjList* getRecByJnum(const Sbecore::uint jnum);
