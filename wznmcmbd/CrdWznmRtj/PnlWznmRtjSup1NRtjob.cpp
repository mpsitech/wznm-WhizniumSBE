...
#include "PnlWznmRtjSup1NRtjob_blks.cpp"
#include "PnlWznmRtjSup1NRtjob_evals.cpp"
...
/******************************************************************************
 class PnlWznmRtjSup1NRtjob
 ******************************************************************************/

PnlWznmRtjSup1NRtjob::PnlWznmRtjSup1NRtjob(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRTJSUP1NRTJOB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRtjSup1NRtjob(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRtjSup1NRtjob::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRtjSup1NRtjob::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRTJSUP1NRTJOBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRTJSUP1NRTJOBDO) {
...
void PnlWznmRtjSup1NRtjob::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRtjSup1NRtjob::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRtjSup1NRtjob::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRtjSup1NRtjob::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRtjSup1NRtjob* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (!has(diffitems, QryWznmRtjSup1NRtjob::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRtjSup1NRtjob::StgIac::JNUM)) {
...
void PnlWznmRtjSup1NRtjob::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCRTJ, jref)) if (ixPre == VecWznmVPreset::PREWZNMREFAPP) {
			sref = "CrdWznmRtj";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, ixPre, refPre, sref, recRtj.ref, jrefNew);
		};
...
void PnlWznmRtjSup1NRtjob::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRtjSup1NRtjob::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRtjSup1NRtjob::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
