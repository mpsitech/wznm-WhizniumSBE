...
#define QRYWZNMRTJSUP1NRTJOB_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmRtjSup1NRtjob QryWznmRtjSup1NRtjob::StatApp
#define StatShrQryWznmRtjSup1NRtjob QryWznmRtjSup1NRtjob::StatShr
#define StgIacQryWznmRtjSup1NRtjob QryWznmRtjSup1NRtjob::StgIac

/**
	* QryWznmRtjSup1NRtjob
	*/
class QryWznmRtjSup1NRtjob : public JobWznm {
...
public:
	QryWznmRtjSup1NRtjob(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmRtjSup1NRtjob();
...
public:
	...
	WznmQRtjSup1NRtjob* getRecByJnum(const Sbecore::uint jnum);
