/**
	* \file CrdWznmRtj.h
	* job handler for job CrdWznmRtj (declarations)
...
#define VecVWznmRtjDo CrdWznmRtj::VecVDo
#define VecVWznmRtjSge CrdWznmRtj::VecVSge

#define ContInfWznmRtj CrdWznmRtj::ContInf
#define StatAppWznmRtj CrdWznmRtj::StatApp
#define StatShrWznmRtj CrdWznmRtj::StatShr
#define TagWznmRtj CrdWznmRtj::Tag

#define DpchAppWznmRtjDo CrdWznmRtj::DpchAppDo
#define DpchEngWznmRtjData CrdWznmRtj::DpchEngData

/**
	* CrdWznmRtj
	*/
class CrdWznmRtj : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDRTJ = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdRtj = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdRtj;
...
public:
	CrdWznmRtj(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmRtj();
...
public:
	...
	PnlWznmRtjRec* pnlrec;
	PnlWznmRtjHeadbar* pnlheadbar;
	PnlWznmRtjList* pnllist;
