...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCarHk1NControl* rst = NULL, QryWznmCarHk1NControl::StatShr* statshrqry = NULL, QryWznmCarHk1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
