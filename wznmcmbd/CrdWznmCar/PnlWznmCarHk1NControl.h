/**
	* \file PnlWznmCarHk1NControl.h
	* job handler for job PnlWznmCarHk1NControl (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMCARHK1NCONTROL_H
#define PNLWZNMCARHK1NCONTROL_H
...
#define VecVWznmCarHk1NControlDo PnlWznmCarHk1NControl::VecVDo

#define ContInfWznmCarHk1NControl PnlWznmCarHk1NControl::ContInf
#define StatAppWznmCarHk1NControl PnlWznmCarHk1NControl::StatApp
#define StatShrWznmCarHk1NControl PnlWznmCarHk1NControl::StatShr
#define StgIacWznmCarHk1NControl PnlWznmCarHk1NControl::StgIac
#define TagWznmCarHk1NControl PnlWznmCarHk1NControl::Tag

#define DpchAppWznmCarHk1NControlData PnlWznmCarHk1NControl::DpchAppData
#define DpchAppWznmCarHk1NControlDo PnlWznmCarHk1NControl::DpchAppDo
#define DpchEngWznmCarHk1NControlData PnlWznmCarHk1NControl::DpchEngData

/**
	* PnlWznmCarHk1NControl
	*/
class PnlWznmCarHk1NControl : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCarHk1NControl* rst = NULL, QryWznmCarHk1NControl::StatShr* statshrqry = NULL, QryWznmCarHk1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCarHk1NControl(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCarHk1NControl();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCarHk1NControl::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
