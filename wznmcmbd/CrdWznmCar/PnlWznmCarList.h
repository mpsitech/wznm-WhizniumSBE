/**
	* \file PnlWznmCarList.h
	* job handler for job PnlWznmCarList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMCARLIST_H
#define PNLWZNMCARLIST_H
...
#define VecVWznmCarListDo PnlWznmCarList::VecVDo

#define ContIacWznmCarList PnlWznmCarList::ContIac
#define ContInfWznmCarList PnlWznmCarList::ContInf
#define StatShrWznmCarList PnlWznmCarList::StatShr
#define StgIacWznmCarList PnlWznmCarList::StgIac
#define TagWznmCarList PnlWznmCarList::Tag

#define DpchAppWznmCarListData PnlWznmCarList::DpchAppData
#define DpchAppWznmCarListDo PnlWznmCarList::DpchAppDo
#define DpchEngWznmCarListData PnlWznmCarList::DpchEngData

/**
	* PnlWznmCarList
	*/
class PnlWznmCarList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoMdlWidth = 100, const Sbecore::uint TcoRetWidth = 100, const Sbecore::uint TcoReuWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCarList* rst = NULL, QryWznmCarList::StatShr* statshrqry = NULL, QryWznmCarList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCarList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCarList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCarList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
