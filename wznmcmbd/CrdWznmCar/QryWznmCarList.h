...
#define VecVQryWznmCarListOrd QryWznmCarList::VecVOrd

#define StatAppQryWznmCarList QryWznmCarList::StatApp
#define StatShrQryWznmCarList QryWznmCarList::StatShr
#define StgIacQryWznmCarList QryWznmCarList::StgIac

/**
	* QryWznmCarList
	*/
class QryWznmCarList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmCarListOrd)
		*/
	class VecVOrd {
...
public:
	QryWznmCarList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmCarList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preMdl, const Sbecore::uint preRet, const Sbecore::ubigint preReu, const bool addwhere);
	...
	WznmQCarList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWznmCarMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
