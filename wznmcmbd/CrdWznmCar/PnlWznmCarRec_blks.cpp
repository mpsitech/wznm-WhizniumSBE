/**
	* \file PnlWznmCarRec_blks.cpp
	* job handler for job PnlWznmCarRec (implementation of blocks)
...
void PnlWznmCarRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmCarRec";
...
void PnlWznmCarRec::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmCarRec";
...
void PnlWznmCarRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	me["initdoneCar1NPanel"] = initdoneCar1NPanel;
	me["initdone1NDialog"] = initdone1NDialog;
	me["initdoneHk1NControl"] = initdoneHk1NControl;
};

void PnlWznmCarRec::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const bool initdoneDetail
	...
	else itemtag = "StatitemAppWznmCarRec";
...
void PnlWznmCarRec::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmCarRec";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	me["srefIxWznmVExpstate"] = VecWznmVExpstate::getSref(ixWznmVExpstate);
	me["scrJrefDetail"] = Scr::scramble(jrefDetail);
	me["scrJrefCar1NPanel"] = Scr::scramble(jrefCar1NPanel);
	me["scrJref1NDialog"] = Scr::scramble(jref1NDialog);
...
void PnlWznmCarRec::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmCarRec";
...
void PnlWznmCarRec::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmCarRec";
...
void PnlWznmCarRec::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmCarRec";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Card");
		};
	xmlTextWriterEndElement(wr);
};
...
PnlWznmCarRec::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCARRECDO)
		{
	ixVDo = 0;
};
...
void PnlWznmCarRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCarRecDo"];}();
...
void PnlWznmCarRec::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCarRecDo");
	else
...
PnlWznmCarRec::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCARRECDATA, jref)
		{
...
void PnlWznmCarRec::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmCarRec::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmCarRecData"] = Json::Value(Json::objectValue);
...
void PnlWznmCarRec::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmCarRecData");
