...
#define ContInfWznmCar CrdWznmCar::ContInf
#define StatAppWznmCar CrdWznmCar::StatApp
#define StatShrWznmCar CrdWznmCar::StatShr
#define TagWznmCar CrdWznmCar::Tag

#define DpchAppWznmCarDo CrdWznmCar::DpchAppDo
#define DpchEngWznmCarData CrdWznmCar::DpchEngData

/**
	* CrdWznmCar
	*/
class CrdWznmCar : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDCAR = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdCar = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdCar;
...
public:
	CrdWznmCar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmCar();
