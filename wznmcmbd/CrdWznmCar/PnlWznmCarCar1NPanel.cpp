/**
	...
	* job handler for job PnlWznmCarCar1NPanel (implementation)
...
#include "PnlWznmCarCar1NPanel_blks.cpp"
#include "PnlWznmCarCar1NPanel_evals.cpp"
...
/******************************************************************************
 class PnlWznmCarCar1NPanel
 ******************************************************************************/

PnlWznmCarCar1NPanel::PnlWznmCarCar1NPanel(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCARCAR1NPANEL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmCarCar1NPanel(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmCarCar1NPanel::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmCarCar1NPanel::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmCarCar1NPanel::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmCarCar1NPanel::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCARCAR1NPANELDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCARCAR1NPANELDO) {
...
void PnlWznmCarCar1NPanel::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmCarCar1NPanel::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCarCar1NPanel::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmCarCar1NPanel::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQCarCar1NPanel* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmCarCar1NPanel::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmCarCar1NPanel::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmCarCar1NPanel::StgIac::JNUM)) {
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButUpClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButDownClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCPNL, jref)) if (refCar != 0) {
			sref = "CrdWznmPnl";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, VecWznmVPreset::PREWZNMREFCAR, refCar, sref, recPnl.ref, jrefNew);
		};
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButNewAvail) {
		if ((xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCPNL, jref) & VecWznmWAccess::EDIT) != 0) if (refCar != 0) {
			sref = "CrdWznmPnl";
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCarCar1NPanel::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmCarCar1NPanel::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmCarCar1NPanel::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
