/**
	* \file PnlWznmCarCar1NPanel.h
	* job handler for job PnlWznmCarCar1NPanel (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMCARCAR1NPANEL_H
#define PNLWZNMCARCAR1NPANEL_H
...
#define VecVWznmCarCar1NPanelDo PnlWznmCarCar1NPanel::VecVDo

#define ContInfWznmCarCar1NPanel PnlWznmCarCar1NPanel::ContInf
#define StatAppWznmCarCar1NPanel PnlWznmCarCar1NPanel::StatApp
#define StatShrWznmCarCar1NPanel PnlWznmCarCar1NPanel::StatShr
#define StgIacWznmCarCar1NPanel PnlWznmCarCar1NPanel::StgIac
#define TagWznmCarCar1NPanel PnlWznmCarCar1NPanel::Tag

#define DpchAppWznmCarCar1NPanelData PnlWznmCarCar1NPanel::DpchAppData
#define DpchAppWznmCarCar1NPanelDo PnlWznmCarCar1NPanel::DpchAppDo
#define DpchEngWznmCarCar1NPanelData PnlWznmCarCar1NPanel::DpchEngData

/**
	* PnlWznmCarCar1NPanel
	*/
class PnlWznmCarCar1NPanel : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCarCar1NPanel* rst = NULL, QryWznmCarCar1NPanel::StatShr* statshrqry = NULL, QryWznmCarCar1NPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCarCar1NPanel(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCarCar1NPanel();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCarCar1NPanel::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
