...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCarCar1NPanel* rst = NULL, QryWznmCarCar1NPanel::StatShr* statshrqry = NULL, QryWznmCarCar1NPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
