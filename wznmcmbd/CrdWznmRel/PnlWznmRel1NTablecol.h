...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQRel1NTablecol* rst = NULL, QryWznmRel1NTablecol::StatShr* statshrqry = NULL, QryWznmRel1NTablecol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
