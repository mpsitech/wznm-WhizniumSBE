/**
	...
	* job handler for job PnlWznmRel1NTablecol (implementation)
...
#include "PnlWznmRel1NTablecol_blks.cpp"
...
/******************************************************************************
 class PnlWznmRel1NTablecol
 ******************************************************************************/

PnlWznmRel1NTablecol::PnlWznmRel1NTablecol(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMREL1NTABLECOL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRel1NTablecol(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRel1NTablecol::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRel1NTablecol::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmRel1NTablecol::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRel1NTablecol::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMREL1NTABLECOLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMREL1NTABLECOLDO) {
...
void PnlWznmRel1NTablecol::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRel1NTablecol::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRel1NTablecol::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRel1NTablecol::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRel1NTablecol* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRel1NTablecol::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRel1NTablecol::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRel1NTablecol::StgIac::JNUM)) {
...
void PnlWznmRel1NTablecol::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRel1NTablecol::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRel1NTablecol::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
