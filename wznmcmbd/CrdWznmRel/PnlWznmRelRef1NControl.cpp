/**
	...
	* job handler for job PnlWznmRelRef1NControl (implementation)
...
#include "PnlWznmRelRef1NControl_blks.cpp"
#include "PnlWznmRelRef1NControl_evals.cpp"
...
/******************************************************************************
 class PnlWznmRelRef1NControl
 ******************************************************************************/

PnlWznmRelRef1NControl::PnlWznmRelRef1NControl(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRELREF1NCONTROL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRelRef1NControl(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRelRef1NControl::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRelRef1NControl::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmRelRef1NControl::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NControl::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NCONTROLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NCONTROLDO) {
...
void PnlWznmRelRef1NControl::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NControl::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelRef1NControl::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRelRef1NControl::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRelRef1NControl* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRelRef1NControl::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRelRef1NControl::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRelRef1NControl::StgIac::JNUM)) {
...
void PnlWznmRelRef1NControl::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmRelRef1NControl::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRelRef1NControl::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRelRef1NControl::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
