...
void QryWznmRelList::rerun_orderSQL(
	...
	if (preIxOrd == VecVOrd::FRT) sqlstr += " ORDER BY TblWznmMRelation.frRefWznmMTable ASC";
	...
	else if (preIxOrd == VecVOrd::TBL) sqlstr += " ORDER BY TblWznmMRelation.refWznmMTable ASC";
};
