...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQRelATitle* rst = NULL, QryWznmRelATitle::StatShr* statshrqry = NULL, QryWznmRelATitle::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
