/**
	...
	* job handler for job PnlWznmRelSup1NRelation (implementation)
...
#include "PnlWznmRelSup1NRelation_blks.cpp"
#include "PnlWznmRelSup1NRelation_evals.cpp"
...
/******************************************************************************
 class PnlWznmRelSup1NRelation
 ******************************************************************************/

PnlWznmRelSup1NRelation::PnlWznmRelSup1NRelation(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRELSUP1NRELATION, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRelSup1NRelation(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRelSup1NRelation::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRelSup1NRelation::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmRelSup1NRelation::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRelSup1NRelation::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELSUP1NRELATIONDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELSUP1NRELATIONDO) {
...
void PnlWznmRelSup1NRelation::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRelSup1NRelation::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelSup1NRelation::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRelSup1NRelation::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRelSup1NRelation* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRelSup1NRelation::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRelSup1NRelation::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRelSup1NRelation::StgIac::JNUM)) {
...
void PnlWznmRelSup1NRelation::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmRelSup1NRelation::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRelSup1NRelation::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRelSup1NRelation::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
