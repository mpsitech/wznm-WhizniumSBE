/**
	...
	* job handler for job PnlWznmRelRef1NDialog (implementation)
...
#include "PnlWznmRelRef1NDialog_blks.cpp"
#include "PnlWznmRelRef1NDialog_evals.cpp"
...
/******************************************************************************
 class PnlWznmRelRef1NDialog
 ******************************************************************************/

PnlWznmRelRef1NDialog::PnlWznmRelRef1NDialog(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRELREF1NDIALOG, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRelRef1NDialog(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRelRef1NDialog::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRelRef1NDialog::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmRelRef1NDialog::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NDialog::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NDIALOGDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NDIALOGDO) {
...
void PnlWznmRelRef1NDialog::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NDialog::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelRef1NDialog::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRelRef1NDialog::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRelRef1NDialog* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRelRef1NDialog::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRelRef1NDialog::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRelRef1NDialog::StgIac::JNUM)) {
...
void PnlWznmRelRef1NDialog::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmRelRef1NDialog::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRelRef1NDialog::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRelRef1NDialog::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
