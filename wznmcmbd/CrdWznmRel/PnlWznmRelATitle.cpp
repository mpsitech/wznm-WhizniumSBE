/**
	* \file PnlWznmRelATitle.cpp
	* job handler for job PnlWznmRelATitle (implementation)
...
#include "PnlWznmRelATitle_blks.cpp"
#include "PnlWznmRelATitle_evals.cpp"
...
/******************************************************************************
 class PnlWznmRelATitle
 ******************************************************************************/

PnlWznmRelATitle::PnlWznmRelATitle(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRELATITLE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRelATitle(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRelATitle::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRelATitle::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFREL) {
		recRelAtit = WznmAMRelationTitle();
...
void PnlWznmRelATitle::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELATITLEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELATITLEDO) {
...
void PnlWznmRelATitle::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRelATitle::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelATitle::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRelATitle::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRelATitle* recSelNew = NULL;

	WznmAMRelationTitle* _recRelAtit = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRelATitle::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRelATitle::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRelATitle::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recRelAtit = WznmAMRelationTitle();

			if (recSelNew) {
				if (dbswznm->tblwznmamrelationtitle->loadRecByRef(recSelNew->ref, &_recRelAtit)) {
					recRelAtit = *_recRelAtit;
					delete _recRelAtit;
				};
			};
...
void PnlWznmRelATitle::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelATitle::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelATitle::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelATitle::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRelATitle::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRelATitle::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
