...
set<uint> PnlWznmRelRec::StatShr::diff(
	...
	diffitems = {IXWZNMVEXPSTATE, JREFDETAIL, JREFATITLE, JREF1NTABLECOL, JREFSUP1NRELATION, JREFREF1NPANEL, JREFREF1NDIALOG, JREFREF1NCONTROL, BUTREGULARIZEACTIVE};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
void PnlWznmRelRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmRelRecDo"];}();
