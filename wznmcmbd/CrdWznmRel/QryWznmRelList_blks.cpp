...
void QryWznmRelList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmRelList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmRelList";
...
void QryWznmRelList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmRelList";
...
void QryWznmRelList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmRelList";
...
void QryWznmRelList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmRelList";
...
void QryWznmRelList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
