/**
	* \file CrdWznmRel.h
	* job handler for job CrdWznmRel (declarations)
...
/**
	* CrdWznmRel
	*/
class CrdWznmRel : public JobWznm {
...
public:
	CrdWznmRel(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmRel();
...
public:
	...
	PnlWznmRelRec* pnlrec;
	PnlWznmRelHeadbar* pnlheadbar;
	PnlWznmRelList* pnllist;
