/**
	...
	* job handler for job PnlWznmRelRef1NPanel (implementation)
...
#include "PnlWznmRelRef1NPanel_blks.cpp"
#include "PnlWznmRelRef1NPanel_evals.cpp"
...
/******************************************************************************
 class PnlWznmRelRef1NPanel
 ******************************************************************************/

PnlWznmRelRef1NPanel::PnlWznmRelRef1NPanel(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMRELREF1NPANEL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmRelRef1NPanel(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmRelRef1NPanel::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmRelRef1NPanel::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmRelRef1NPanel::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NPanel::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NPANELDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMRELREF1NPANELDO) {
...
void PnlWznmRelRef1NPanel::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmRelRef1NPanel::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmRelRef1NPanel::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmRelRef1NPanel::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQRelRef1NPanel* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmRelRef1NPanel::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmRelRef1NPanel::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmRelRef1NPanel::StgIac::JNUM)) {
...
void PnlWznmRelRef1NPanel::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmRelRef1NPanel::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmRelRef1NPanel::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmRelRef1NPanel::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
