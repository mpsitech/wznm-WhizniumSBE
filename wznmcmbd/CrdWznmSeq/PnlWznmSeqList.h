/**
	* \file PnlWznmSeqList.h
	* job handler for job PnlWznmSeqList (declarations)
...
#ifndef PNLWZNMSEQLIST_H
#define PNLWZNMSEQLIST_H
...
#define VecVWznmSeqListDo PnlWznmSeqList::VecVDo

#define ContIacWznmSeqList PnlWznmSeqList::ContIac
#define ContInfWznmSeqList PnlWznmSeqList::ContInf
#define StatShrWznmSeqList PnlWznmSeqList::StatShr
#define StgIacWznmSeqList PnlWznmSeqList::StgIac
#define TagWznmSeqList PnlWznmSeqList::Tag

#define DpchAppWznmSeqListData PnlWznmSeqList::DpchAppData
#define DpchAppWznmSeqListDo PnlWznmSeqList::DpchAppDo
#define DpchEngWznmSeqListData PnlWznmSeqList::DpchEngData

/**
	* PnlWznmSeqList
	*/
class PnlWznmSeqList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOAPPWIDTH = 3;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoAppWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSeqList* rst = NULL, QryWznmSeqList::StatShr* statshrqry = NULL, QryWznmSeqList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSeqList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSeqList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSeqList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
