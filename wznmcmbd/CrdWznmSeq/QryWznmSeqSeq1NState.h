/**
	* \file QryWznmSeqSeq1NState.h
	* job handler for job QryWznmSeqSeq1NState (declarations)
...
#ifndef QRYWZNMSEQSEQ1NSTATE_H
#define QRYWZNMSEQSEQ1NSTATE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmSeqSeq1NState QryWznmSeqSeq1NState::StatApp
#define StatShrQryWznmSeqSeq1NState QryWznmSeqSeq1NState::StatShr
#define StgIacQryWznmSeqSeq1NState QryWznmSeqSeq1NState::StgIac

/**
	* QryWznmSeqSeq1NState
	*/
class QryWznmSeqSeq1NState : public JobWznm {
...
public:
	QryWznmSeqSeq1NState(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmSeqSeq1NState();
...
public:
	...
	WznmQSeqSeq1NState* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWznmSteMod_seqEq(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
