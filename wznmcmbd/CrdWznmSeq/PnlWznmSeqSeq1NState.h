/**
	* \file PnlWznmSeqSeq1NState.h
	* job handler for job PnlWznmSeqSeq1NState (declarations)
...
#ifndef PNLWZNMSEQSEQ1NSTATE_H
#define PNLWZNMSEQSEQ1NSTATE_H
...
#define VecVWznmSeqSeq1NStateDo PnlWznmSeqSeq1NState::VecVDo

#define ContInfWznmSeqSeq1NState PnlWznmSeqSeq1NState::ContInf
#define StatAppWznmSeqSeq1NState PnlWznmSeqSeq1NState::StatApp
#define StatShrWznmSeqSeq1NState PnlWznmSeqSeq1NState::StatShr
#define StgIacWznmSeqSeq1NState PnlWznmSeqSeq1NState::StgIac
#define TagWznmSeqSeq1NState PnlWznmSeqSeq1NState::Tag

#define DpchAppWznmSeqSeq1NStateData PnlWznmSeqSeq1NState::DpchAppData
#define DpchAppWznmSeqSeq1NStateDo PnlWznmSeqSeq1NState::DpchAppDo
#define DpchEngWznmSeqSeq1NStateData PnlWznmSeqSeq1NState::DpchEngData

/**
	* PnlWznmSeqSeq1NState
	*/
class PnlWznmSeqSeq1NState : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSeqSeq1NState* rst = NULL, QryWznmSeqSeq1NState::StatShr* statshrqry = NULL, QryWznmSeqSeq1NState::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSeqSeq1NState(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSeqSeq1NState();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSeqSeq1NState::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
