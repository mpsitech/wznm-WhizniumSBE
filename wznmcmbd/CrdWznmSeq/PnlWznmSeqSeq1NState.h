...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSeqSeq1NState* rst = NULL, QryWznmSeqSeq1NState::StatShr* statshrqry = NULL, QryWznmSeqSeq1NState::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
