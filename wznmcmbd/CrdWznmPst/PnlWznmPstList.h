/**
	* \file PnlWznmPstList.h
	* job handler for job PnlWznmPstList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMPSTLIST_H
#define PNLWZNMPSTLIST_H
...
#define VecVWznmPstListDo PnlWznmPstList::VecVDo

#define ContIacWznmPstList PnlWznmPstList::ContIac
#define ContInfWznmPstList PnlWznmPstList::ContInf
#define StatShrWznmPstList PnlWznmPstList::StatShr
#define StgIacWznmPstList PnlWznmPstList::StgIac
#define TagWznmPstList PnlWznmPstList::Tag

#define DpchAppWznmPstListData PnlWznmPstList::DpchAppData
#define DpchAppWznmPstListDo PnlWznmPstList::DpchAppDo
#define DpchEngWznmPstListData PnlWznmPstList::DpchEngData

/**
	* PnlWznmPstList
	*/
class PnlWznmPstList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOATYWIDTH = 6;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoRetWidth = 100, const Sbecore::uint TcoReuWidth = 100, const Sbecore::uint TcoAtyWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQPstList* rst = NULL, QryWznmPstList::StatShr* statshrqry = NULL, QryWznmPstList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmPstList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPstList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPstList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
