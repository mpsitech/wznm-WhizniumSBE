/**
	...
	* job handler for job PnlWznmPst1NQuerymod (implementation)
...
#include "PnlWznmPst1NQuerymod_blks.cpp"
#include "PnlWznmPst1NQuerymod_evals.cpp"
...
/******************************************************************************
 class PnlWznmPst1NQuerymod
 ******************************************************************************/

PnlWznmPst1NQuerymod::PnlWznmPst1NQuerymod(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMPST1NQUERYMOD, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmPst1NQuerymod(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmPst1NQuerymod::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmPst1NQuerymod::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmPst1NQuerymod::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmPst1NQuerymod::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMPST1NQUERYMODDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMPST1NQUERYMODDO) {
...
void PnlWznmPst1NQuerymod::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmPst1NQuerymod::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmPst1NQuerymod::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmPst1NQuerymod::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQPst1NQuerymod* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmPst1NQuerymod::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmPst1NQuerymod::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmPst1NQuerymod::StgIac::JNUM)) {
...
void PnlWznmPst1NQuerymod::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmPst1NQuerymod::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmPst1NQuerymod::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmPst1NQuerymod::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
