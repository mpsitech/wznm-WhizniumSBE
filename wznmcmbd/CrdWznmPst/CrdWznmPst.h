/**
	* \file CrdWznmPst.h
	* job handler for job CrdWznmPst (declarations)
...
#define VecVWznmPstDo CrdWznmPst::VecVDo
#define VecVWznmPstSge CrdWznmPst::VecVSge

#define ContInfWznmPst CrdWznmPst::ContInf
#define StatAppWznmPst CrdWznmPst::StatApp
#define StatShrWznmPst CrdWznmPst::StatShr
#define TagWznmPst CrdWznmPst::Tag

#define DpchAppWznmPstDo CrdWznmPst::DpchAppDo
#define DpchEngWznmPstData CrdWznmPst::DpchEngData

/**
	* CrdWznmPst
	*/
class CrdWznmPst : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDPST = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdPst = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdPst;
...
public:
	CrdWznmPst(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmPst();
...
public:
	...
	PnlWznmPstList* pnllist;
	PnlWznmPstHeadbar* pnlheadbar;
	PnlWznmPstRec* pnlrec;
