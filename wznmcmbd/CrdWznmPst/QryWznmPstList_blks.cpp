/**
	* \file QryWznmPstList_blks.cpp
	* job handler for job QryWznmPstList (implementation of blocks)
...
void QryWznmPstList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmPstList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWznmPstList";
...
void QryWznmPstList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmPstList";
...
bool QryWznmPstList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmPstList"];}();
