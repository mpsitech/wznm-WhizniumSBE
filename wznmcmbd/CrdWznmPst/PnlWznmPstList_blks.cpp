/**
	* \file PnlWznmPstList_blks.cpp
	* job handler for job PnlWznmPstList (implementation of blocks)
...
/******************************************************************************
 class PnlWznmPstList::VecVDo
 ******************************************************************************/

uint PnlWznmPstList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmPstList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmPstList::ContIac
 ******************************************************************************/

PnlWznmPstList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWznmPstList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmPstList"];}();
...
bool PnlWznmPstList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWznmPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWznmPstList";
...
void PnlWznmPstList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWznmPstList";
...
void PnlWznmPstList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWznmPstList";
...
set<uint> PnlWznmPstList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPstList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPstList::ContInf
 ******************************************************************************/

PnlWznmPstList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWznmPstList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmPstList";
...
void PnlWznmPstList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmPstList";
...
set<uint> PnlWznmPstList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPstList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPstList::StatShr
 ******************************************************************************/

PnlWznmPstList::StatShr::StatShr(
...
void PnlWznmPstList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmPstList";
...
void PnlWznmPstList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmPstList";
...
set<uint> PnlWznmPstList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPstList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPstList::StgIac
 ******************************************************************************/

PnlWznmPstList::StgIac::StgIac(
			...
			, TcoAtyWidth(TcoAtyWidth)
		{
	mask = {TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOATYWIDTH};
};

bool PnlWznmPstList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmPstList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoAtyWidth")) {TcoAtyWidth = me["TcoAtyWidth"].asUInt(); add(TCOATYWIDTH);};
	};

	return basefound;
};

bool PnlWznmPstList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmPstList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmPstList";
...
void PnlWznmPstList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmPstList";
	...
	me["TcoAtyWidth"] = (Json::Value::UInt) TcoAtyWidth;
};

void PnlWznmPstList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmPstList";
...
set<uint> PnlWznmPstList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPstList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOTITWIDTH, TCOVERWIDTH, TCORETWIDTH, TCOREUWIDTH, TCOATYWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWznmPstList::Tag
 ******************************************************************************/

void PnlWznmPstList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmPstList";
...
void PnlWznmPstList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmPstList";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Presettings");
			...
			writeStringAttr(wr, itemtag, "sref", "TcoAty", "Arg. type");
		};
...
/******************************************************************************
 class PnlWznmPstList::DpchAppData
 ******************************************************************************/

PnlWznmPstList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPSTLISTDATA)
		{
};

string PnlWznmPstList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPstList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmPstListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWznmPstList::StgIac();
	};
};

void PnlWznmPstList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmPstListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmPstList::DpchAppDo
 ******************************************************************************/

PnlWznmPstList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPSTLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmPstList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPstList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmPstListDo"];}();
...
void PnlWznmPstList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmPstListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmPstList::DpchEngData
 ******************************************************************************/

PnlWznmPstList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWznmPstList::StatShr* statshrqry
			, QryWznmPstList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMPSTLISTDATA, jref)
		{
...
string PnlWznmPstList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPstList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmPstList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmPstListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmPstList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmPstList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmPstListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmPstList::StatApp::writeXML(wr);
