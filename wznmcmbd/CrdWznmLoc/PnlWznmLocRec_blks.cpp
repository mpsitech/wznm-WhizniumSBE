...
void PnlWznmLocRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmLocRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmLocRec::Tag::writeJSON(
...
void PnlWznmLocRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmLocRecDo"];}();
...
void PnlWznmLocRec::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmLocRecData"] = Json::Value(Json::objectValue);
