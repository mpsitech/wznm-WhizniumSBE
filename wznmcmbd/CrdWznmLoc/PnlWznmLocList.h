/**
	* \file PnlWznmLocList.h
	* job handler for job PnlWznmLocList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMLOCLIST_H
#define PNLWZNMLOCLIST_H
...
#define VecVWznmLocListDo PnlWznmLocList::VecVDo

#define ContIacWznmLocList PnlWznmLocList::ContIac
#define ContInfWznmLocList PnlWznmLocList::ContInf
#define StatShrWznmLocList PnlWznmLocList::StatShr
#define StgIacWznmLocList PnlWznmLocList::StgIac
#define TagWznmLocList PnlWznmLocList::Tag

#define DpchAppWznmLocListData PnlWznmLocList::DpchAppData
#define DpchAppWznmLocListDo PnlWznmLocList::DpchAppDo
#define DpchEngWznmLocListData PnlWznmLocList::DpchEngData

/**
	* PnlWznmLocList
	*/
class PnlWznmLocList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQLocList* rst = NULL, QryWznmLocList::StatShr* statshrqry = NULL, QryWznmLocList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmLocList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLocList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmLocList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
