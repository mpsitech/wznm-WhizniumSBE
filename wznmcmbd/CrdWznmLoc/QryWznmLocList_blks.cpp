...
void QryWznmLocList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmLocList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmLocList";
...
void QryWznmLocList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmLocList";
...
void QryWznmLocList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmLocList";
...
void QryWznmLocList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmLocList";
...
void QryWznmLocList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
