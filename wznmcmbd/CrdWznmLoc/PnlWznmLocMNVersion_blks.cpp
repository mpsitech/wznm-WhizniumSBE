/**
	* \file PnlWznmLocMNVersion_blks.cpp
	* job handler for job PnlWznmLocMNVersion (implementation of blocks)
...
void PnlWznmLocMNVersion::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmLocMNVersion";
...
void PnlWznmLocMNVersion::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmLocMNVersion";
...
void PnlWznmLocMNVersion::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmLocMNVersion";
...
void PnlWznmLocMNVersion::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmLocMNVersion";
...
void PnlWznmLocMNVersion::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmLocMNVersion";
...
void PnlWznmLocMNVersion::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmLocMNVersion";
...
bool PnlWznmLocMNVersion::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmLocMNVersion"];}();
...
void PnlWznmLocMNVersion::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmLocMNVersion::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmLocMNVersion";
...
void PnlWznmLocMNVersion::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmLocMNVersion";
...
PnlWznmLocMNVersion::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLOCMNVERSIONDATA)
		{
};
...
void PnlWznmLocMNVersion::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmLocMNVersionData"];}();
...
void PnlWznmLocMNVersion::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLocMNVersionData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmLocMNVersion::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMLOCMNVERSIONDO)
		{
	ixVDo = 0;
};
...
void PnlWznmLocMNVersion::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmLocMNVersionDo"];}();
...
void PnlWznmLocMNVersion::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmLocMNVersionDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmLocMNVersion::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMLOCMNVERSIONDATA, jref)
		{
...
void PnlWznmLocMNVersion::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmLocMNVersion::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmLocMNVersionData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmLocMNVersion::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmLocMNVersion::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmLocMNVersionData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmLocMNVersion::StatApp::writeXML(wr);
