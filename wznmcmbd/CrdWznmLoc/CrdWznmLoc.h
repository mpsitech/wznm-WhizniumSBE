/**
	* \file CrdWznmLoc.h
	* job handler for job CrdWznmLoc (declarations)
...
/**
	* CrdWznmLoc
	*/
class CrdWznmLoc : public JobWznm {
...
public:
	CrdWznmLoc(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmLoc();
...
public:
	...
	PnlWznmLocList* pnllist;
	PnlWznmLocHeadbar* pnlheadbar;
	PnlWznmLocRec* pnlrec;
