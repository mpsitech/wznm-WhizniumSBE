/**
	...
	* job handler for job PnlWznmLocMNVersion (declarations)
...
/**
	* PnlWznmLocMNVersion
	*/
class PnlWznmLocMNVersion : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQLocMNVersion* rst = NULL, QryWznmLocMNVersion::StatShr* statshrqry = NULL, QryWznmLocMNVersion::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmLocMNVersion(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLocMNVersion();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmLocMNVersion::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
