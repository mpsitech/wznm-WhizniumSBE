/**
	...
	* job handler for job PnlWznmLocRec (declarations)
...
/**
	* PnlWznmLocRec
	*/
class PnlWznmLocRec : public JobWznm {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneMNVersion = false);
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneMNVersion = false);
	};
	...
	public:
		...
		static const Sbecore::uint JREFMNVERSION = 3;
		static const Sbecore::uint BUTREGULARIZEACTIVE = 4;

	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefMNVersion = 0, const bool ButRegularizeActive = true);
...
public:
	PnlWznmLocRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmLocRec();
