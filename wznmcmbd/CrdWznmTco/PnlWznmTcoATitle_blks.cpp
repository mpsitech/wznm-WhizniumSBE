/**
	* \file PnlWznmTcoATitle_blks.cpp
	* job handler for job PnlWznmTcoATitle (implementation of blocks)
...
/******************************************************************************
 class PnlWznmTcoATitle::VecVDo
 ******************************************************************************/

uint PnlWznmTcoATitle::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmTcoATitle::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmTcoATitle::ContInf
 ******************************************************************************/

PnlWznmTcoATitle::ContInf::ContInf(
...
void PnlWznmTcoATitle::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTcoATitle";
...
void PnlWznmTcoATitle::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmTcoATitle";
...
set<uint> PnlWznmTcoATitle::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTcoATitle::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTcoATitle::StatApp
 ******************************************************************************/

void PnlWznmTcoATitle::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmTcoATitle";
...
void PnlWznmTcoATitle::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmTcoATitle";
...
/******************************************************************************
 class PnlWznmTcoATitle::StatShr
 ******************************************************************************/

PnlWznmTcoATitle::StatShr::StatShr(
...
void PnlWznmTcoATitle::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTcoATitle";
...
void PnlWznmTcoATitle::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmTcoATitle";
...
set<uint> PnlWznmTcoATitle::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTcoATitle::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTcoATitle::StgIac
 ******************************************************************************/

PnlWznmTcoATitle::StgIac::StgIac(
...
bool PnlWznmTcoATitle::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTcoATitle"];}();
...
bool PnlWznmTcoATitle::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmTcoATitle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmTcoATitle";
...
void PnlWznmTcoATitle::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmTcoATitle";
...
void PnlWznmTcoATitle::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmTcoATitle";
...
set<uint> PnlWznmTcoATitle::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmTcoATitle::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmTcoATitle::Tag
 ******************************************************************************/

void PnlWznmTcoATitle::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTcoATitle";
...
void PnlWznmTcoATitle::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTcoATitle";
...
/******************************************************************************
 class PnlWznmTcoATitle::DpchAppData
 ******************************************************************************/

PnlWznmTcoATitle::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCOATITLEDATA)
		{
};

string PnlWznmTcoATitle::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTcoATitle::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTcoATitleData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmTcoATitle::StgIac();
	};
};

void PnlWznmTcoATitle::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTcoATitleData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTcoATitle::DpchAppDo
 ******************************************************************************/

PnlWznmTcoATitle::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCOATITLEDO)
		{
	ixVDo = 0;
};

string PnlWznmTcoATitle::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTcoATitle::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTcoATitleDo"];}();
...
void PnlWznmTcoATitle::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTcoATitleDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmTcoATitle::DpchEngData
 ******************************************************************************/

PnlWznmTcoATitle::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmTcoATitle::StatShr* statshrqry
			, QryWznmTcoATitle::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTCOATITLEDATA, jref)
		{
...
string PnlWznmTcoATitle::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmTcoATitle::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTcoATitle::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTcoATitleData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTcoATitle::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTcoATitle::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTcoATitleData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTcoATitle::StatApp::writeXML(wr);
