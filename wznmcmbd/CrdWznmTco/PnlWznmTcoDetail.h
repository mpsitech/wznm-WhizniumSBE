...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstOpt = NULL, Sbecore::Feed* feedFPupAxf = NULL, Sbecore::Feed* feedFPupFct = NULL, Sbecore::Feed* feedFPupSty = NULL, Sbecore::Feed* feedFPupTyp = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
