...
void QryWznmTcoList::rerun_orderSQL(
	...
	if (preIxOrd == VecVOrd::TBL) sqlstr += " ORDER BY TblWznmMTablecol.tblRefWznmMTable ASC";
	else if (preIxOrd == VecVOrd::FCT) sqlstr += " ORDER BY TblWznmMTablecol.fctIxVTbl ASC";
