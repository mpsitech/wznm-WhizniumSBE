...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTco1NCheck* rst = NULL, QryWznmTco1NCheck::StatShr* statshrqry = NULL, QryWznmTco1NCheck::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
