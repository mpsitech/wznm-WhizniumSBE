/**
	...
	* job handler for job PnlWznmTco1NImpexpcol (declarations)
...
/**
	...
	*/
class PnlWznmTco1NImpexpcol : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQTco1NImpexpcol* rst = NULL, QryWznmTco1NImpexpcol::StatShr* statshrqry = NULL, QryWznmTco1NImpexpcol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmTco1NImpexpcol(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTco1NImpexpcol();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmTco1NImpexpcol::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
