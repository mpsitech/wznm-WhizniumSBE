...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQTco1NImpexpcol* rst = NULL, QryWznmTco1NImpexpcol::StatShr* statshrqry = NULL, QryWznmTco1NImpexpcol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
