...
public:
	...
	public:
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneATitle = false, const bool initdone1NQuerycol = false, const bool initdone1NImpexpcol = false, const bool initdoneRef1NControl = false, const bool initdoneRef1NQuerymod = false, const bool initdone1NCheck = false);
	};
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefATitle = 0, const bool pnlatitleAvail = false, const Sbecore::ubigint jref1NQuerycol = 0, const bool pnl1nquerycolAvail = false, const Sbecore::ubigint jref1NImpexpcol = 0, const bool pnl1nimpexpcolAvail = false, const Sbecore::ubigint jrefRef1NControl = 0, const bool pnlref1ncontrolAvail = false, const Sbecore::ubigint jrefRef1NQuerymod = 0, const bool pnlref1nquerymodAvail = false, const Sbecore::ubigint jref1NCheck = 0, const bool ButRegularizeActive = true);
