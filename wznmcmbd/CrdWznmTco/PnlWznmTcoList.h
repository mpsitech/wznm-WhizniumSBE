/**
	* \file PnlWznmTcoList.h
	* job handler for job PnlWznmTcoList (declarations)
...
#ifndef PNLWZNMTCOLIST_H
#define PNLWZNMTCOLIST_H
...
#define VecVWznmTcoListDo PnlWznmTcoList::VecVDo

#define ContIacWznmTcoList PnlWznmTcoList::ContIac
#define ContInfWznmTcoList PnlWznmTcoList::ContInf
#define StatShrWznmTcoList PnlWznmTcoList::StatShr
#define StgIacWznmTcoList PnlWznmTcoList::StgIac
#define TagWznmTcoList PnlWznmTcoList::Tag

#define DpchAppWznmTcoListData PnlWznmTcoList::DpchAppData
#define DpchAppWznmTcoListDo PnlWznmTcoList::DpchAppDo
#define DpchEngWznmTcoListData PnlWznmTcoList::DpchEngData

/**
	* PnlWznmTcoList
	*/
class PnlWznmTcoList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOFCTWIDTH = 5;
		static const Sbecore::uint TCOSTYWIDTH = 6;
		static const Sbecore::uint TCOAXFWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoShoWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoTblWidth = 100, const Sbecore::uint TcoFctWidth = 100, const Sbecore::uint TcoStyWidth = 100, const Sbecore::uint TcoAxfWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTcoList* rst = NULL, QryWznmTcoList::StatShr* statshrqry = NULL, QryWznmTcoList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmTcoList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTcoList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmTcoList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
