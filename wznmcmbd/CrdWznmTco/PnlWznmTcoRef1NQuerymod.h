/**
	...
	* job handler for job PnlWznmTcoRef1NQuerymod (declarations)
...
/**
	...
	*/
class PnlWznmTcoRef1NQuerymod : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQTcoRef1NQuerymod* rst = NULL, QryWznmTcoRef1NQuerymod::StatShr* statshrqry = NULL, QryWznmTcoRef1NQuerymod::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmTcoRef1NQuerymod(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTcoRef1NQuerymod();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmTcoRef1NQuerymod::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
