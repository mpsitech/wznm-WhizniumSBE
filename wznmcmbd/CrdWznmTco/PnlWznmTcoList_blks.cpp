/**
	* \file PnlWznmTcoList_blks.cpp
	* job handler for job PnlWznmTcoList (implementation of blocks)
...
bool PnlWznmTcoList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmTcoList"];}();
...
void PnlWznmTcoList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTcoList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmTcoList";
...
void PnlWznmTcoList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmTcoList";
...
void PnlWznmTcoList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmTcoList";
...
void PnlWznmTcoList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmTcoList";
...
bool PnlWznmTcoList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmTcoList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoAxfWidth")) {TcoAxfWidth = me["TcoAxfWidth"].asUInt(); add(TCOAXFWIDTH);};
	};
...
void PnlWznmTcoList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmTcoList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmTcoList";
	...
	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		...
		me["TcoTyp"] = "Type";
		me["TcoTbl"] = "Table";
		me["TcoFct"] = "Function table of reference";
		me["TcoSty"] = "Subtype";
		me["TcoAxf"] = "Axis functionality";
	};
...
void PnlWznmTcoList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmTcoList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoFct", "Function table of reference");
			writeStringAttr(wr, itemtag, "sref", "TcoSty", "Subtype");
			writeStringAttr(wr, itemtag, "sref", "TcoAxf", "Axis functionality");
		};
...
PnlWznmTcoList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCOLISTDATA)
		{
};
...
void PnlWznmTcoList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTcoListData"];}();
...
void PnlWznmTcoList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTcoListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTcoList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMTCOLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWznmTcoList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmTcoListDo"];}();
...
void PnlWznmTcoList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmTcoListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmTcoList::DpchEngData::DpchEngData(
			...
			, QryWznmTcoList::StatShr* statshrqry
			, QryWznmTcoList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMTCOLISTDATA, jref)
		{
...
void PnlWznmTcoList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmTcoList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmTcoListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmTcoList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmTcoList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmTcoListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmTcoList::StatApp::writeXML(wr);
