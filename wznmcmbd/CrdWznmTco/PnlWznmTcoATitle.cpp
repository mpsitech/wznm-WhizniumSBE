/**
	...
	* job handler for job PnlWznmTcoATitle (implementation)
...
#include "PnlWznmTcoATitle_blks.cpp"
#include "PnlWznmTcoATitle_evals.cpp"
...
/******************************************************************************
 class PnlWznmTcoATitle
 ******************************************************************************/

PnlWznmTcoATitle::PnlWznmTcoATitle(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMTCOATITLE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmTcoATitle(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmTcoATitle::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmTcoATitle::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFTCO) {
		recTcoAtit = WznmAMTablecolTitle();
...
void PnlWznmTcoATitle::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTCOATITLEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMTCOATITLEDO) {
...
void PnlWznmTcoATitle::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmTcoATitle::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTcoATitle::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmTcoATitle::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQTcoATitle* recSelNew = NULL;

	WznmAMTablecolTitle* _recTcoAtit = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmTcoATitle::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmTcoATitle::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmTcoATitle::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recTcoAtit = WznmAMTablecolTitle();

			if (recSelNew) {
				if (dbswznm->tblwznmamtablecoltitle->loadRecByRef(recSelNew->ref, &_recTcoAtit)) {
					recTcoAtit = *_recTcoAtit;
					delete _recTcoAtit;
				};
			};
...
void PnlWznmTcoATitle::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTcoATitle::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTcoATitle::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmTcoATitle::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmTcoATitle::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmTcoATitle::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
