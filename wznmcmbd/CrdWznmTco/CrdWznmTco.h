/**
	* \file CrdWznmTco.h
	* job handler for job CrdWznmTco (declarations)
...
#define VecVWznmTcoDo CrdWznmTco::VecVDo
#define VecVWznmTcoSge CrdWznmTco::VecVSge

#define ContInfWznmTco CrdWznmTco::ContInf
#define StatAppWznmTco CrdWznmTco::StatApp
#define StatShrWznmTco CrdWznmTco::StatShr
#define TagWznmTco CrdWznmTco::Tag

#define DpchAppWznmTcoDo CrdWznmTco::DpchAppDo
#define DpchEngWznmTcoData CrdWznmTco::DpchEngData

/**
	* CrdWznmTco
	*/
class CrdWznmTco : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDTCO = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdTco = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdTco;
...
public:
	CrdWznmTco(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmTco();
...
public:
	...
	PnlWznmTcoList* pnllist;
	PnlWznmTcoHeadbar* pnlheadbar;
	PnlWznmTcoRec* pnlrec;
