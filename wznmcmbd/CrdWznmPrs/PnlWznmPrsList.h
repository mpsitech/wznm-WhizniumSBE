/**
	...
	* job handler for job PnlWznmPrsList (declarations)
...
/**
	* PnlWznmPrsList
	*/
class PnlWznmPrsList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQPrsList* rst = NULL, QryWznmPrsList::StatShr* statshrqry = NULL, QryWznmPrsList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmPrsList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPrsList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPrsList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
