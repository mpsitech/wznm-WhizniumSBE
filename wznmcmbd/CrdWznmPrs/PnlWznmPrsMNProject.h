/**
	...
	* job handler for job PnlWznmPrsMNProject (declarations)
...
/**
	* PnlWznmPrsMNProject
	*/
class PnlWznmPrsMNProject : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQPrsMNProject* rst = NULL, QryWznmPrsMNProject::StatShr* statshrqry = NULL, QryWznmPrsMNProject::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmPrsMNProject(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPrsMNProject();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPrsMNProject::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
