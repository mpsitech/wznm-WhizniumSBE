/**
	...
	* job handler for job PnlWznmPrsADetail (declarations)
...
/**
	* PnlWznmPrsADetail
	*/
class PnlWznmPrsADetail : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQPrsADetail* rst = NULL, QryWznmPrsADetail::StatShr* statshrqry = NULL, QryWznmPrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmPrsADetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPrsADetail();
...
public:
	...
	QryWznmPrsADetail* qry;

	WznmAMPersonDetail recPrsAdet;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPrsADetail::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
