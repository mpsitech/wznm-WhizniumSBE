/**
	* \file CrdWznmPrs.h
	* job handler for job CrdWznmPrs (declarations)
...
/**
	* CrdWznmPrs
	*/
class CrdWznmPrs : public JobWznm {
...
public:
	CrdWznmPrs(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmPrs();
...
public:
	...
	PnlWznmPrsList* pnllist;
	PnlWznmPrsRec* pnlrec;
	PnlWznmPrsHeadbar* pnlheadbar;
