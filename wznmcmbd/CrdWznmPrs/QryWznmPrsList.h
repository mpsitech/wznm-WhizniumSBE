...
#define VecVQryWznmPrsListOrd QryWznmPrsList::VecVOrd

#define StatAppQryWznmPrsList QryWznmPrsList::StatApp
#define StatShrQryWznmPrsList QryWznmPrsList::StatShr
#define StgIacQryWznmPrsList QryWznmPrsList::StgIac

/**
	* QryWznmPrsList
	*/
class QryWznmPrsList : public JobWznm {
...
public:
	QryWznmPrsList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmPrsList();
...
public:
	...
	WznmQPrsList* getRecByJnum(const Sbecore::uint jnum);
