/**
	* \file PnlWznmPrsMNProject_blks.cpp
	* job handler for job PnlWznmPrsMNProject (implementation of blocks)
...
/******************************************************************************
 class PnlWznmPrsMNProject::VecVDo
 ******************************************************************************/

uint PnlWznmPrsMNProject::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmPrsMNProject::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmPrsMNProject::ContInf
 ******************************************************************************/

PnlWznmPrsMNProject::ContInf::ContInf(
...
void PnlWznmPrsMNProject::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmPrsMNProject";
...
void PnlWznmPrsMNProject::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmPrsMNProject";
...
set<uint> PnlWznmPrsMNProject::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPrsMNProject::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPrsMNProject::StatApp
 ******************************************************************************/

void PnlWznmPrsMNProject::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmPrsMNProject";
...
void PnlWznmPrsMNProject::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmPrsMNProject";
...
/******************************************************************************
 class PnlWznmPrsMNProject::StatShr
 ******************************************************************************/

PnlWznmPrsMNProject::StatShr::StatShr(
...
void PnlWznmPrsMNProject::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmPrsMNProject";
...
void PnlWznmPrsMNProject::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmPrsMNProject";
...
set<uint> PnlWznmPrsMNProject::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPrsMNProject::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPrsMNProject::StgIac
 ******************************************************************************/

PnlWznmPrsMNProject::StgIac::StgIac(
...
bool PnlWznmPrsMNProject::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmPrsMNProject"];}();
...
bool PnlWznmPrsMNProject::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmPrsMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmPrsMNProject";
...
void PnlWznmPrsMNProject::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmPrsMNProject";
...
void PnlWznmPrsMNProject::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmPrsMNProject";
...
set<uint> PnlWznmPrsMNProject::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmPrsMNProject::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmPrsMNProject::Tag
 ******************************************************************************/

void PnlWznmPrsMNProject::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmPrsMNProject";
...
void PnlWznmPrsMNProject::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmPrsMNProject";
...
/******************************************************************************
 class PnlWznmPrsMNProject::DpchAppData
 ******************************************************************************/

PnlWznmPrsMNProject::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRSMNPROJECTDATA)
		{
};

string PnlWznmPrsMNProject::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPrsMNProject::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmPrsMNProjectData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmPrsMNProject::StgIac();
	};
};

void PnlWznmPrsMNProject::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmPrsMNProjectData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmPrsMNProject::DpchAppDo
 ******************************************************************************/

PnlWznmPrsMNProject::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMPRSMNPROJECTDO)
		{
	ixVDo = 0;
};

string PnlWznmPrsMNProject::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPrsMNProject::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmPrsMNProjectDo"];}();
...
void PnlWznmPrsMNProject::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmPrsMNProjectDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmPrsMNProject::DpchEngData
 ******************************************************************************/

PnlWznmPrsMNProject::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMPRSMNPROJECTDATA, jref)
		{
...
string PnlWznmPrsMNProject::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmPrsMNProject::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmPrsMNProject::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmPrsMNProjectData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmPrsMNProject::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmPrsMNProject::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmPrsMNProjectData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmPrsMNProject::StatApp::writeXML(wr);
