...
bool PnlWznmPnlDetail::evalButReuViewAvail(
	...
	// pnl.reuEq(0)|((pre.ixCrdaccVec()&pnl.retEq(vec)&pre.refVer())|(pre.ixCrdaccRel()&pnl.retEq(rel)&pre.refVer())|(pre.ixCrdaccTbl()&pnl.retEq(tbl)&pre.refVer())|(pre.ixCrdaccMdl()&pnl.retEq(mdl)&pre.refVer()))
