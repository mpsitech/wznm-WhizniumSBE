/**
	* \file PnlWznmPnlMNQuery.cpp
	* job handler for job PnlWznmPnlMNQuery (implementation)
...
#include "PnlWznmPnlMNQuery_blks.cpp"
#include "PnlWznmPnlMNQuery_evals.cpp"
...
/******************************************************************************
 class PnlWznmPnlMNQuery
 ******************************************************************************/

PnlWznmPnlMNQuery::PnlWznmPnlMNQuery(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMPNLMNQUERY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmPnlMNQuery(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmPnlMNQuery::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmPnlMNQuery::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmPnlMNQuery::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmPnlMNQuery::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMPNLMNQUERYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMPNLMNQUERYDO) {
...
void PnlWznmPnlMNQuery::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmPnlMNQuery::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmPnlMNQuery::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmPnlMNQuery::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQPnlMNQuery* recSelNew = NULL;

	WznmRMPanelMQuery* _recPnlRqry = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmPnlMNQuery::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmPnlMNQuery::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmPnlMNQuery::StgIac::JNUM)) {
			...
			if (recSelNew) {
				if (dbswznm->tblwznmrmpanelmquery->loadRecByRef(recSelNew->ref, &_recPnlRqry)) {
					recPnlRqry = *_recPnlRqry;
					delete _recPnlRqry;
				};
...
void PnlWznmPnlMNQuery::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmPnlMNQuery::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmPnlMNQuery::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmPnlMNQuery::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmPnlMNQuery::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmPnlMNQuery::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
