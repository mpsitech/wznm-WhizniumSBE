/**
	* \file QryWznmPnlList.h
	* job handler for job QryWznmPnlList (declarations)
...
#ifndef QRYWZNMPNLLIST_H
#define QRYWZNMPNLLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmPnlListOrd QryWznmPnlList::VecVOrd

#define StatAppQryWznmPnlList QryWznmPnlList::StatApp
#define StatShrQryWznmPnlList QryWznmPnlList::StatShr
#define StgIacQryWznmPnlList QryWznmPnlList::StgIac

/**
	* QryWznmPnlList
	*/
class QryWznmPnlList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmPnlListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmPnlList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmPnlList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmPnlList)
		*/
...
public:
	QryWznmPnlList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmPnlList();
...
public:
	...
	WznmQPnlList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmPnlMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
