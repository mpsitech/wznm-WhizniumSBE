/**
	* \file PnlWznmCapRec.h
	* job handler for job PnlWznmCapRec (declarations)
...
#ifndef PNLWZNMCAPREC_H
#define PNLWZNMCAPREC_H
...
#define ContInfWznmCapRec PnlWznmCapRec::ContInf
#define StatAppWznmCapRec PnlWznmCapRec::StatApp
#define StatShrWznmCapRec PnlWznmCapRec::StatShr
#define TagWznmCapRec PnlWznmCapRec::Tag

#define DpchAppWznmCapRecDo PnlWznmCapRec::DpchAppDo
#define DpchEngWznmCapRecData PnlWznmCapRec::DpchEngData

/**
	* PnlWznmCapRec
	*/
class PnlWznmCapRec : public JobWznm {
...
public:
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefAPar = 0, const bool ButRegularizeActive = true);
...
public:
	PnlWznmCapRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCapRec();
