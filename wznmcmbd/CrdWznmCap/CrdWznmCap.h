...
#define ContInfWznmCap CrdWznmCap::ContInf
#define StatAppWznmCap CrdWznmCap::StatApp
#define StatShrWznmCap CrdWznmCap::StatShr
#define TagWznmCap CrdWznmCap::Tag

#define DpchAppWznmCapDo CrdWznmCap::DpchAppDo
#define DpchEngWznmCapData CrdWznmCap::DpchEngData

/**
	* CrdWznmCap
	*/
class CrdWznmCap : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDCAP = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdCap = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdCap;
...
public:
	CrdWznmCap(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmCap();
