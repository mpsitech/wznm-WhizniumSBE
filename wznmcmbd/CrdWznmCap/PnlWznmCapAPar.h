/**
	...
	* job handler for job PnlWznmCapAPar (declarations)
...
/**
	* PnlWznmCapAPar
	*/
class PnlWznmCapAPar : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCapAPar* rst = NULL, QryWznmCapAPar::StatShr* statshrqry = NULL, QryWznmCapAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCapAPar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCapAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCapAPar::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
