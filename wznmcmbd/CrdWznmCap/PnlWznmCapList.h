/**
	* \file PnlWznmCapList.h
	* job handler for job PnlWznmCapList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMCAPLIST_H
#define PNLWZNMCAPLIST_H
...
#define VecVWznmCapListDo PnlWznmCapList::VecVDo

#define ContIacWznmCapList PnlWznmCapList::ContIac
#define ContInfWznmCapList PnlWznmCapList::ContInf
#define StatShrWznmCapList PnlWznmCapList::StatShr
#define StgIacWznmCapList PnlWznmCapList::StgIac
#define TagWznmCapList PnlWznmCapList::Tag

#define DpchAppWznmCapListData PnlWznmCapList::DpchAppData
#define DpchAppWznmCapListDo PnlWznmCapList::DpchAppDo
#define DpchEngWznmCapListData PnlWznmCapList::DpchEngData

/**
	* PnlWznmCapList
	*/
class PnlWznmCapList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOTPLWIDTH = 4;
		static const Sbecore::uint TCOATFWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoTplWidth = 100, const Sbecore::uint TcoAtfWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCapList* rst = NULL, QryWznmCapList::StatShr* statshrqry = NULL, QryWznmCapList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCapList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCapList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCapList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
