/**
	* \file PnlWznmCapAPar_blks.cpp
	* job handler for job PnlWznmCapAPar (implementation of blocks)
...
/******************************************************************************
 class PnlWznmCapAPar::VecVDo
 ******************************************************************************/

uint PnlWznmCapAPar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmCapAPar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmCapAPar::ContInf
 ******************************************************************************/

PnlWznmCapAPar::ContInf::ContInf(
...
void PnlWznmCapAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmCapAPar";
...
void PnlWznmCapAPar::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmCapAPar";
...
set<uint> PnlWznmCapAPar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCapAPar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCapAPar::StatApp
 ******************************************************************************/

void PnlWznmCapAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmCapAPar";
...
void PnlWznmCapAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmCapAPar";
...
/******************************************************************************
 class PnlWznmCapAPar::StatShr
 ******************************************************************************/

PnlWznmCapAPar::StatShr::StatShr(
...
void PnlWznmCapAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmCapAPar";
...
void PnlWznmCapAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmCapAPar";
...
set<uint> PnlWznmCapAPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCapAPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCapAPar::StgIac
 ******************************************************************************/

PnlWznmCapAPar::StgIac::StgIac(
...
bool PnlWznmCapAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmCapAPar"];}();
...
bool PnlWznmCapAPar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmCapAPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmCapAPar";
...
void PnlWznmCapAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmCapAPar";
...
void PnlWznmCapAPar::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmCapAPar";
...
set<uint> PnlWznmCapAPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCapAPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCapAPar::Tag
 ******************************************************************************/

void PnlWznmCapAPar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmCapAPar";
...
void PnlWznmCapAPar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmCapAPar";
...
/******************************************************************************
 class PnlWznmCapAPar::DpchAppData
 ******************************************************************************/

PnlWznmCapAPar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAPAPARDATA)
		{
};

string PnlWznmCapAPar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCapAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCapAParData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmCapAPar::StgIac();
	};
};

void PnlWznmCapAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCapAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmCapAPar::DpchAppDo
 ******************************************************************************/

PnlWznmCapAPar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCAPAPARDO)
		{
	ixVDo = 0;
};

string PnlWznmCapAPar::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCapAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCapAParDo"];}();
...
void PnlWznmCapAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCapAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmCapAPar::DpchEngData
 ******************************************************************************/

PnlWznmCapAPar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCAPAPARDATA, jref)
		{
...
string PnlWznmCapAPar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCapAPar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmCapAPar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmCapAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmCapAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmCapAPar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmCapAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmCapAPar::StatApp::writeXML(wr);
