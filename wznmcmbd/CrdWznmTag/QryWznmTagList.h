...
#define VecVQryWznmTagListOrd QryWznmTagList::VecVOrd

#define StatAppQryWznmTagList QryWznmTagList::StatApp
#define StatShrQryWznmTagList QryWznmTagList::StatShr
#define StgIacQryWznmTagList QryWznmTagList::StgIac

/**
	* QryWznmTagList
	*/
class QryWznmTagList : public JobWznm {
...
public:
	QryWznmTagList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmTagList();
...
public:
	...
	WznmQTagList* getRecByJnum(const Sbecore::uint jnum);
