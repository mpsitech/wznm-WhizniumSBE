/**
	* \file PnlWznmTagRec.h
	* job handler for job PnlWznmTagRec (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMTAGREC_H
#define PNLWZNMTAGREC_H
...
#define VecVWznmTagRecDo PnlWznmTagRec::VecVDo

#define ContInfWznmTagRec PnlWznmTagRec::ContInf
#define StatAppWznmTagRec PnlWznmTagRec::StatApp
#define StatShrWznmTagRec PnlWznmTagRec::StatShr
#define TagWznmTagRec PnlWznmTagRec::Tag

#define DpchAppWznmTagRecDo PnlWznmTagRec::DpchAppDo
#define DpchEngWznmTagRecData PnlWznmTagRec::DpchEngData

/**
	* PnlWznmTagRec
	*/
class PnlWznmTagRec : public JobWznm {
...
public:
	PnlWznmTagRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmTagRec();
