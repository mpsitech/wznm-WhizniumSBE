/**
	* \file CrdWznmTag.h
	* job handler for job CrdWznmTag (declarations)
...
#define VecVWznmTagDo CrdWznmTag::VecVDo
#define VecVWznmTagSge CrdWznmTag::VecVSge

#define ContInfWznmTag CrdWznmTag::ContInf
#define StatAppWznmTag CrdWznmTag::StatApp
#define StatShrWznmTag CrdWznmTag::StatShr
#define TagWznmTag CrdWznmTag::Tag

#define DpchAppWznmTagDo CrdWznmTag::DpchAppDo
#define DpchEngWznmTagData CrdWznmTag::DpchEngData

/**
	* CrdWznmTag
	*/
class CrdWznmTag : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDTAG = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdTag = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdTag;
...
public:
	...
	PnlWznmTagList* pnllist;
	PnlWznmTagHeadbar* pnlheadbar;
	PnlWznmTagRec* pnlrec;
