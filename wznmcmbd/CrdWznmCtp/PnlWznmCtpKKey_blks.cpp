/**
	* \file PnlWznmCtpKKey_blks.cpp
	* job handler for job PnlWznmCtpKKey (implementation of blocks)
...
/******************************************************************************
 class PnlWznmCtpKKey::VecVDo
 ******************************************************************************/

uint PnlWznmCtpKKey::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmCtpKKey::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmCtpKKey::ContInf
 ******************************************************************************/

PnlWznmCtpKKey::ContInf::ContInf(
...
void PnlWznmCtpKKey::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmCtpKKey";
...
void PnlWznmCtpKKey::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmCtpKKey";
...
set<uint> PnlWznmCtpKKey::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpKKey::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCtpKKey::StatApp
 ******************************************************************************/

void PnlWznmCtpKKey::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmCtpKKey";
...
void PnlWznmCtpKKey::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmCtpKKey";
...
/******************************************************************************
 class PnlWznmCtpKKey::StatShr
 ******************************************************************************/

PnlWznmCtpKKey::StatShr::StatShr(
...
void PnlWznmCtpKKey::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmCtpKKey";
...
void PnlWznmCtpKKey::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmCtpKKey";
...
set<uint> PnlWznmCtpKKey::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpKKey::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCtpKKey::StgIac
 ******************************************************************************/

PnlWznmCtpKKey::StgIac::StgIac(
...
bool PnlWznmCtpKKey::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmCtpKKey"];}();
...
bool PnlWznmCtpKKey::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmCtpKKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmCtpKKey";
...
void PnlWznmCtpKKey::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmCtpKKey";
...
void PnlWznmCtpKKey::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmCtpKKey";
...
set<uint> PnlWznmCtpKKey::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmCtpKKey::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmCtpKKey::Tag
 ******************************************************************************/

void PnlWznmCtpKKey::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmCtpKKey";
...
void PnlWznmCtpKKey::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmCtpKKey";
...
/******************************************************************************
 class PnlWznmCtpKKey::DpchAppData
 ******************************************************************************/

PnlWznmCtpKKey::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKKEYDATA)
		{
};

string PnlWznmCtpKKey::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCtpKKey::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCtpKKeyData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmCtpKKey::StgIac();
	};
};

void PnlWznmCtpKKey::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCtpKKeyData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmCtpKKey::DpchAppDo
 ******************************************************************************/

PnlWznmCtpKKey::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPKKEYDO)
		{
	ixVDo = 0;
};

string PnlWznmCtpKKey::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCtpKKey::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCtpKKeyDo"];}();
...
void PnlWznmCtpKKey::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCtpKKeyDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmCtpKKey::DpchEngData
 ******************************************************************************/

PnlWznmCtpKKey::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmCtpKKey::StatShr* statshrqry
			, QryWznmCtpKKey::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCTPKKEYDATA, jref)
		{
...
string PnlWznmCtpKKey::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmCtpKKey::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmCtpKKey::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmCtpKKeyData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmCtpKKey::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmCtpKKey::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmCtpKKeyData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmCtpKKey::StatApp::writeXML(wr);
