/**
	...
	* job handler for job PnlWznmCtpAPar (implementation)
...
#include "PnlWznmCtpAPar_blks.cpp"
#include "PnlWznmCtpAPar_evals.cpp"
...
/******************************************************************************
 class PnlWznmCtpAPar
 ******************************************************************************/

PnlWznmCtpAPar::PnlWznmCtpAPar(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCTPAPAR, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmCtpAPar(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmCtpAPar::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmCtpAPar::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmCtpAPar::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCTPAPARDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCTPAPARDO) {
...
void PnlWznmCtpAPar::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmCtpAPar::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmCtpAPar::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmCtpAPar::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmCtpAPar::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmCtpAPar::StgIac::JNUM)) {
...
void PnlWznmCtpAPar::handleDpchAppDoButUpClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDoButDownClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpAPar::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmCtpAPar::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmCtpAPar::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
