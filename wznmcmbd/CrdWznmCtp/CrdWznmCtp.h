/**
	* \file CrdWznmCtp.h
	* job handler for job CrdWznmCtp (declarations)
...
#define VecVWznmCtpDo CrdWznmCtp::VecVDo
#define VecVWznmCtpSge CrdWznmCtp::VecVSge

#define ContInfWznmCtp CrdWznmCtp::ContInf
#define StatAppWznmCtp CrdWznmCtp::StatApp
#define StatShrWznmCtp CrdWznmCtp::StatShr
#define TagWznmCtp CrdWznmCtp::Tag

#define DpchAppWznmCtpDo CrdWznmCtp::DpchAppDo
#define DpchEngWznmCtpData CrdWznmCtp::DpchEngData

/**
	* CrdWznmCtp
	*/
class CrdWznmCtp : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDCTP = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdCtp = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdCtp;
...
public:
	CrdWznmCtp(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmCtp();
...
public:
	...
	PnlWznmCtpHeadbar* pnlheadbar;
	PnlWznmCtpList* pnllist;
	PnlWznmCtpRec* pnlrec;
