/**
	* \file PnlWznmCtpAPar.h
	* job handler for job PnlWznmCtpAPar (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMCTPAPAR_H
#define PNLWZNMCTPAPAR_H
...
#define VecVWznmCtpAParDo PnlWznmCtpAPar::VecVDo

#define ContInfWznmCtpAPar PnlWznmCtpAPar::ContInf
#define StatAppWznmCtpAPar PnlWznmCtpAPar::StatApp
#define StatShrWznmCtpAPar PnlWznmCtpAPar::StatShr
#define StgIacWznmCtpAPar PnlWznmCtpAPar::StgIac
#define TagWznmCtpAPar PnlWznmCtpAPar::Tag

#define DpchAppWznmCtpAParData PnlWznmCtpAPar::DpchAppData
#define DpchAppWznmCtpAParDo PnlWznmCtpAPar::DpchAppDo
#define DpchEngWznmCtpAParData PnlWznmCtpAPar::DpchEngData

/**
	* PnlWznmCtpAPar
	*/
class PnlWznmCtpAPar : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCtpAPar* rst = NULL, QryWznmCtpAPar::StatShr* statshrqry = NULL, QryWznmCtpAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCtpAPar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCtpAPar();
...
public:
	...
	WznmAMCapabilityPar recCpbApar;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCtpAPar::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
