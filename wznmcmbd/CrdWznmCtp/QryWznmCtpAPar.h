/**
	* \file QryWznmCtpAPar.h
	* job handler for job QryWznmCtpAPar (declarations)
...
#ifndef QRYWZNMCTPAPAR_H
#define QRYWZNMCTPAPAR_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmCtpAPar QryWznmCtpAPar::StatApp
#define StatShrQryWznmCtpAPar QryWznmCtpAPar::StatShr
#define StgIacQryWznmCtpAPar QryWznmCtpAPar::StgIac

/**
	* QryWznmCtpAPar
	*/
class QryWznmCtpAPar : public JobWznm {

public:
	/**
		* StatApp (full: StatAppQryWznmCtpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmCtpAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmCtpAPar)
		*/
...
public:
	QryWznmCtpAPar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmCtpAPar();
...
public:
	...
	WznmQCtpAPar* getRecByJnum(const Sbecore::uint jnum);
