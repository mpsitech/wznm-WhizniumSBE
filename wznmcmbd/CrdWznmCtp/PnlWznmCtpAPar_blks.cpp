/**
	* \file PnlWznmCtpAPar_blks.cpp
	* job handler for job PnlWznmCtpAPar (implementation of blocks)
...
void PnlWznmCtpAPar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmCtpAPar";
...
void PnlWznmCtpAPar::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmCtpAPar";
...
void PnlWznmCtpAPar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmCtpAPar";
...
void PnlWznmCtpAPar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmCtpAPar";
...
void PnlWznmCtpAPar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmCtpAPar";
...
void PnlWznmCtpAPar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmCtpAPar";
...
bool PnlWznmCtpAPar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmCtpAPar"];}();
...
void PnlWznmCtpAPar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmCtpAPar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmCtpAPar";
...
void PnlWznmCtpAPar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmCtpAPar";
...
PnlWznmCtpAPar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPAPARDATA)
		{
};
...
void PnlWznmCtpAPar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCtpAParData"];}();
...
void PnlWznmCtpAPar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCtpAParData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmCtpAPar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMCTPAPARDO)
		{
	ixVDo = 0;
};
...
void PnlWznmCtpAPar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCtpAParDo"];}();
...
void PnlWznmCtpAPar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmCtpAParDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmCtpAPar::DpchEngData::DpchEngData(
			...
			, QryWznmCtpAPar::StatShr* statshrqry
			, QryWznmCtpAPar::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMCTPAPARDATA, jref)
		{
...
void PnlWznmCtpAPar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmCtpAPar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmCtpAParData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmCtpAPar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmCtpAPar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmCtpAParData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmCtpAPar::StatApp::writeXML(wr);
