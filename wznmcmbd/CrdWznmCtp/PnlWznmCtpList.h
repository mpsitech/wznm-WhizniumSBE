/**
	* \file PnlWznmCtpList.h
	* job handler for job PnlWznmCtpList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMCTPLIST_H
#define PNLWZNMCTPLIST_H
...
#define VecVWznmCtpListDo PnlWznmCtpList::VecVDo

#define ContIacWznmCtpList PnlWznmCtpList::ContIac
#define ContInfWznmCtpList PnlWznmCtpList::ContInf
#define StatShrWznmCtpList PnlWznmCtpList::StatShr
#define StgIacWznmCtpList PnlWznmCtpList::StgIac
#define TagWznmCtpList PnlWznmCtpList::Tag

#define DpchAppWznmCtpListData PnlWznmCtpList::DpchAppData
#define DpchAppWznmCtpListDo PnlWznmCtpList::DpchAppDo
#define DpchEngWznmCtpListData PnlWznmCtpList::DpchEngData

/**
	* PnlWznmCtpList
	*/
class PnlWznmCtpList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOATFWIDTH = 4;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoAtfWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCtpList* rst = NULL, QryWznmCtpList::StatShr* statshrqry = NULL, QryWznmCtpList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCtpList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCtpList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCtpList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
