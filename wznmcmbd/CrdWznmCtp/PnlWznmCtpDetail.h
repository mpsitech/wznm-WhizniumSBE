/**
	...
	* job handler for job PnlWznmCtpDetail (declarations)
...
/**
	* PnlWznmCtpDetail
	*/
class PnlWznmCtpDetail : public JobWznm {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::MIND, const bool LstAtfAlt = true, const Sbecore::uint LstAtfNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstAtf = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});

	public:
		ContIac contiac;
		ContInf continf;
		Sbecore::Feed feedFLstAtf;
		StatShr statshr;
...
public:
	PnlWznmCtpDetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCtpDetail();
