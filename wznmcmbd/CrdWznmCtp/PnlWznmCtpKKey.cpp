/**
	...
	* job handler for job PnlWznmCtpKKey (implementation)
...
#include "PnlWznmCtpKKey_blks.cpp"
#include "PnlWznmCtpKKey_evals.cpp"
...
/******************************************************************************
 class PnlWznmCtpKKey
 ******************************************************************************/

PnlWznmCtpKKey::PnlWznmCtpKKey(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCTPKKEY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmCtpKKey(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmCtpKKey::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmCtpKKey::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmCtpKKey::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCTPKKEYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCTPKKEYDO) {
...
void PnlWznmCtpKKey::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmCtpKKey::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmCtpKKey::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmCtpKKey::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmCtpKKey::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmCtpKKey::StgIac::JNUM)) {
...
void PnlWznmCtpKKey::handleDpchAppDoButUpClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDoButDownClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCtpKKey::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmCtpKKey::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmCtpKKey::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
