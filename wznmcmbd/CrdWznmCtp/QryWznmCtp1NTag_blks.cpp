/**
	* \file QryWznmCtp1NTag_blks.cpp
	* job handler for job QryWznmCtp1NTag (implementation of blocks)
...
/******************************************************************************
 class QryWznmCtp1NTag::StatApp
 ******************************************************************************/

void QryWznmCtp1NTag::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmCtp1NTag";
...
void QryWznmCtp1NTag::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmCtp1NTag";
...
/******************************************************************************
 class QryWznmCtp1NTag::StatShr
 ******************************************************************************/

QryWznmCtp1NTag::StatShr::StatShr(
			const uint ntot
...
void QryWznmCtp1NTag::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmCtp1NTag";
...
void QryWznmCtp1NTag::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmCtp1NTag";
...
set<uint> QryWznmCtp1NTag::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmCtp1NTag::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmCtp1NTag::StgIac
 ******************************************************************************/

QryWznmCtp1NTag::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmCtp1NTag::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmCtp1NTag"];}();
...
bool QryWznmCtp1NTag::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmCtp1NTag");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmCtp1NTag";
...
void QryWznmCtp1NTag::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmCtp1NTag";
...
void QryWznmCtp1NTag::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmCtp1NTag";
...
set<uint> QryWznmCtp1NTag::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmCtp1NTag::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
