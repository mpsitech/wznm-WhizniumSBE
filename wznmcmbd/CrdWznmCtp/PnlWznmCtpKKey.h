/**
	* \file PnlWznmCtpKKey.h
	* job handler for job PnlWznmCtpKKey (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMCTPKKEY_H
#define PNLWZNMCTPKKEY_H
...
#define VecVWznmCtpKKeyDo PnlWznmCtpKKey::VecVDo

#define ContInfWznmCtpKKey PnlWznmCtpKKey::ContInf
#define StatAppWznmCtpKKey PnlWznmCtpKKey::StatApp
#define StatShrWznmCtpKKey PnlWznmCtpKKey::StatShr
#define StgIacWznmCtpKKey PnlWznmCtpKKey::StgIac
#define TagWznmCtpKKey PnlWznmCtpKKey::Tag

#define DpchAppWznmCtpKKeyData PnlWznmCtpKKey::DpchAppData
#define DpchAppWznmCtpKKeyDo PnlWznmCtpKKey::DpchAppDo
#define DpchEngWznmCtpKKeyData PnlWznmCtpKKey::DpchEngData

/**
	* PnlWznmCtpKKey
	*/
class PnlWznmCtpKKey : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCtpKKey* rst = NULL, QryWznmCtpKKey::StatShr* statshrqry = NULL, QryWznmCtpKKey::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCtpKKey(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCtpKKey();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCtpKKey::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
