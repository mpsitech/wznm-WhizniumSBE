...
DpchRetWznm* WznmWrswapiBase::run(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, DpchInvWznmWrswapiBase* dpchinv
		) {
...
// IP cust --- IBEGIN
void WznmWrswapiBase::writeApiSw(
			DbsWznm* dbswznm
...
void WznmWrswapiBase::writeVecdpchSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, ListWznmMBlock& blks
		) {
