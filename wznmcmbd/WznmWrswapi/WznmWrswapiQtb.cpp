...
DpchRetWznm* WznmWrswapiQtb::run(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, DpchInvWznmWrswapiQtb* dpchinv
		) {
...
// IP cust --- IBEGIN
void WznmWrswapiQtb::writeQtbSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMTable* tbl
...
string WznmWrswapiQtb::getTcoSwType(
...
string WznmWrswapiQtb::getQcoSwType(
			const uint ixVBasetype
		) {
...
string WznmWrswapiQtb::getQcoTcoSwType(
			WznmMQuerycol* qco
			, const ListWznmMTablecol& tcos
		) {
	string swtype;
...
string WznmWrswapiQtb::getQcoSwDefault(
