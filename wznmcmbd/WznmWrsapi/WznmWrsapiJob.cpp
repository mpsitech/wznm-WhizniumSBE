...
void WznmWrsapiJob::writeBlkcontSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, WznmMBlock* blk
...
void WznmWrsapiJob::writeBlkdpchSw(
			DbsWznm* dbswznm
			, const string& orgweb
			, const string& Prjshort
			, fstream& outfile
...
void WznmWrsapiJob::writeBlkstatSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, WznmMBlock* blk
...
void WznmWrsapiJob::writeBlkstgSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, WznmMBlock* blk
...
void WznmWrsapiJob::writeBlktagSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, WznmMBlock* blk
...
void WznmWrsapiJob::wrBitvarConstrhdrSw(
			fstream& outfile
			, WznmAMBlockItem* bit
		) {
...
void WznmWrsapiJob::wrBitvarConstrSw(
			fstream& outfile
			, WznmAMBlockItem* bit
		) {
...
// adapted version from WznmWrsrv.cpp
void WznmWrsapiJob::wrBitvarReadxmlSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, const string& subsref
...
// adapted version from WznmWrsrv.cpp
void WznmWrsapiJob::wrBitvarWritexmlSw(
			DbsWznm* dbswznm
			, fstream& outfile
			, WznmMJob* job
			, const string& subsref
...
// adapted version from WznmWrsrv.cpp
void WznmWrsapiJob::wrBitvarCompareSw(
			fstream& outfile
			, const string& subsref
			, WznmAMBlockItem* bit
		) {
...
string WznmWrsapiJob::getBlkclass(
			DbsWznm* dbswznm
			, WznmMJob* job
			, WznmMBlock* blk
		) {
...
string WznmWrsapiJob::getBlknew(
			DbsWznm* dbswznm
			, WznmMJob* job
			, WznmMBlock* blk
		) {
...
string WznmWrsapiJob::getBitSwType(
			WznmAMBlockItem* bit
		) {
...
string WznmWrsapiJob::getBitXMLType(
			WznmAMBlockItem* bit
		) {
	if (bit->ixWznmVVartype == VecWznmVVartype::BOOLEAN) return("Bool");
	if (bit->ixWznmVVartype == VecWznmVVartype::TINYINT) return("Int");
...
string WznmWrsapiJob::getVecclass(
			DbsWznm* dbswznm
			, WznmMJob* job
			, WznmMVector* vec
		) {
