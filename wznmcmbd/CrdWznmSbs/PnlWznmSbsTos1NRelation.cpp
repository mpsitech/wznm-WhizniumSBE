/**
	...
	* job handler for job PnlWznmSbsTos1NRelation (implementation)
...
#include "PnlWznmSbsTos1NRelation_blks.cpp"
#include "PnlWznmSbsTos1NRelation_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbsTos1NRelation
 ******************************************************************************/

PnlWznmSbsTos1NRelation::PnlWznmSbsTos1NRelation(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBSTOS1NRELATION, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbsTos1NRelation(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbsTos1NRelation::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbsTos1NRelation::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmSbsTos1NRelation::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbsTos1NRelation::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSTOS1NRELATIONDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSTOS1NRELATIONDO) {
...
void PnlWznmSbsTos1NRelation::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbsTos1NRelation::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsTos1NRelation::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbsTos1NRelation::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbsTos1NRelation* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbsTos1NRelation::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbsTos1NRelation::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbsTos1NRelation::StgIac::JNUM)) {
...
void PnlWznmSbsTos1NRelation::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCREL, jref)) if (ixPre == VecWznmVPreset::PREWZNMREFVER) {
			sref = "CrdWznmRel";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, ixPre, refPre, sref, recRel.ref, jrefNew);
		};
...
void PnlWznmSbsTos1NRelation::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbsTos1NRelation::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbsTos1NRelation::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
