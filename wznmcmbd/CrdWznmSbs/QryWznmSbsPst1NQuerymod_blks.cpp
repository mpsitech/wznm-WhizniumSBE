/**
	* \file QryWznmSbsPst1NQuerymod_blks.cpp
	* job handler for job QryWznmSbsPst1NQuerymod (implementation of blocks)
...
void QryWznmSbsPst1NQuerymod::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmSbsPst1NQuerymod";
...
void QryWznmSbsPst1NQuerymod::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmSbsPst1NQuerymod";
...
void QryWznmSbsPst1NQuerymod::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmSbsPst1NQuerymod";
...
void QryWznmSbsPst1NQuerymod::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmSbsPst1NQuerymod";
...
bool QryWznmSbsPst1NQuerymod::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmSbsPst1NQuerymod"];}();
...
void QryWznmSbsPst1NQuerymod::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
