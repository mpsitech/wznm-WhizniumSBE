/**
	...
	* job handler for job PnlWznmSbsPst1NQuerymod (declarations)
...
/**
	...
	*/
class PnlWznmSbsPst1NQuerymod : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSbsPst1NQuerymod* rst = NULL, QryWznmSbsPst1NQuerymod::StatShr* statshrqry = NULL, QryWznmSbsPst1NQuerymod::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSbsPst1NQuerymod(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSbsPst1NQuerymod();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSbsPst1NQuerymod::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
