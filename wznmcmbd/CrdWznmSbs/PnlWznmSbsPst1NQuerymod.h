...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSbsPst1NQuerymod* rst = NULL, QryWznmSbsPst1NQuerymod::StatShr* statshrqry = NULL, QryWznmSbsPst1NQuerymod::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
