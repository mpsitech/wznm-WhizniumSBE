/**
	...
	* job handler for job PnlWznmSbsATitle (implementation)
...
#include "PnlWznmSbsATitle_blks.cpp"
#include "PnlWznmSbsATitle_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbsATitle
 ******************************************************************************/

PnlWznmSbsATitle::PnlWznmSbsATitle(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBSATITLE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbsATitle(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbsATitle::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbsATitle::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbsATitle::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSATITLEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSATITLEDO) {
...
void PnlWznmSbsATitle::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbsATitle::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsATitle::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbsATitle::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbsATitle* recSelNew = NULL;

	WznmAMSubsetTitle* _recSbsAtit = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbsATitle::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbsATitle::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbsATitle::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recSbsAtit = WznmAMSubsetTitle();

			if (recSelNew) {
				if (dbswznm->tblwznmamsubsettitle->loadRecByRef(recSelNew->ref, &_recSbsAtit)) {
					recSbsAtit = *_recSbsAtit;
					delete _recSbsAtit;
				};
			};
...
void PnlWznmSbsATitle::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsATitle::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsATitle::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsATitle::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbsATitle::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbsATitle::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
