...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSbsATitle* rst = NULL, QryWznmSbsATitle::StatShr* statshrqry = NULL, QryWznmSbsATitle::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
