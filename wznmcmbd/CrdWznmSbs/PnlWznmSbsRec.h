...
public:
	...
	public:
		...
		static const Sbecore::uint JREFTOS1NRELATION = 4;
		static const Sbecore::uint JREF1NSTUB = 5;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefATitle = 0, const Sbecore::ubigint jrefTos1NRelation = 0, const Sbecore::ubigint jref1NStub = 0, const Sbecore::ubigint jref1NTablecol = 0, const Sbecore::ubigint jrefFrs1NRelation = 0, const Sbecore::ubigint jrefPst1NQuerymod = 0, const bool pnlpst1nquerymodAvail = false, const Sbecore::ubigint jrefAsbMNSubset = 0, const Sbecore::ubigint jrefBsbMNSubset = 0, const bool ButRegularizeActive = true);
