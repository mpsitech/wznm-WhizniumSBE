...
void PnlWznmSbsATitle::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmSbsATitle::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmSbsATitle::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool PnlWznmSbsATitle::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmSbsATitle"];}();
...
void PnlWznmSbsATitle::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmSbsATitle::Tag::writeJSON(
...
void PnlWznmSbsATitle::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmSbsATitleData"];}();
...
void PnlWznmSbsATitle::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmSbsATitleDo"];}();
...
void PnlWznmSbsATitle::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmSbsATitleData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmSbsATitle::StatApp::writeJSON(me);
