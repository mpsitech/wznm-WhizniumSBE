/**
	...
	* job handler for job PnlWznmSbsBsbMNSubset (implementation)
...
#include "PnlWznmSbsBsbMNSubset_blks.cpp"
#include "PnlWznmSbsBsbMNSubset_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbsBsbMNSubset
 ******************************************************************************/

PnlWznmSbsBsbMNSubset::PnlWznmSbsBsbMNSubset(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBSBSBMNSUBSET, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbsBsbMNSubset(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbsBsbMNSubset::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbsBsbMNSubset::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmSbsBsbMNSubset::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbsBsbMNSubset::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSBSBMNSUBSETDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSBSBMNSUBSETDO) {
...
void PnlWznmSbsBsbMNSubset::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbsBsbMNSubset::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbsBsbMNSubset* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbsBsbMNSubset::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbsBsbMNSubset::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbsBsbMNSubset::StgIac::JNUM)) {
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsBsbMNSubset::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbsBsbMNSubset::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbsBsbMNSubset::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
