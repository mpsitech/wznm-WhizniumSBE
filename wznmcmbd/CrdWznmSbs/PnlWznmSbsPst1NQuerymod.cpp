/**
	...
	* job handler for job PnlWznmSbsPst1NQuerymod (implementation)
...
#include "PnlWznmSbsPst1NQuerymod_blks.cpp"
#include "PnlWznmSbsPst1NQuerymod_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbsPst1NQuerymod
 ******************************************************************************/

PnlWznmSbsPst1NQuerymod::PnlWznmSbsPst1NQuerymod(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBSPST1NQUERYMOD, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbsPst1NQuerymod(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbsPst1NQuerymod::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbsPst1NQuerymod::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmSbsPst1NQuerymod::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbsPst1NQuerymod::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSPST1NQUERYMODDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSPST1NQUERYMODDO) {
...
void PnlWznmSbsPst1NQuerymod::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbsPst1NQuerymod::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsPst1NQuerymod::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbsPst1NQuerymod::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbsPst1NQuerymod* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbsPst1NQuerymod::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbsPst1NQuerymod::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbsPst1NQuerymod::StgIac::JNUM)) {
...
void PnlWznmSbsPst1NQuerymod::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmSbsPst1NQuerymod::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbsPst1NQuerymod::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbsPst1NQuerymod::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
