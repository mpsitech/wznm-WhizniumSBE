/**
	...
	* job handler for job PnlWznmSbsFrs1NRelation (implementation)
...
#include "PnlWznmSbsFrs1NRelation_blks.cpp"
#include "PnlWznmSbsFrs1NRelation_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbsFrs1NRelation
 ******************************************************************************/

PnlWznmSbsFrs1NRelation::PnlWznmSbsFrs1NRelation(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBSFRS1NRELATION, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbsFrs1NRelation(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbsFrs1NRelation::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbsFrs1NRelation::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmSbsFrs1NRelation::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbsFrs1NRelation::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSFRS1NRELATIONDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBSFRS1NRELATIONDO) {
...
void PnlWznmSbsFrs1NRelation::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbsFrs1NRelation::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbsFrs1NRelation::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbsFrs1NRelation::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbsFrs1NRelation* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbsFrs1NRelation::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbsFrs1NRelation::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbsFrs1NRelation::StgIac::JNUM)) {
...
void PnlWznmSbsFrs1NRelation::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmSbsFrs1NRelation::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbsFrs1NRelation::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbsFrs1NRelation::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
