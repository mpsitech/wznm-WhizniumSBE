/**
	...
	* job handler for job PnlWznmSbs1NTablecol (implementation)
...
#include "PnlWznmSbs1NTablecol_blks.cpp"
#include "PnlWznmSbs1NTablecol_evals.cpp"
...
/******************************************************************************
 class PnlWznmSbs1NTablecol
 ******************************************************************************/

PnlWznmSbs1NTablecol::PnlWznmSbs1NTablecol(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSBS1NTABLECOL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSbs1NTablecol(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSbs1NTablecol::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSbs1NTablecol::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmSbs1NTablecol::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSbs1NTablecol::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBS1NTABLECOLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSBS1NTABLECOLDO) {
...
void PnlWznmSbs1NTablecol::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSbs1NTablecol::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbs1NTablecol::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSbs1NTablecol::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSbs1NTablecol* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSbs1NTablecol::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSbs1NTablecol::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSbs1NTablecol::StgIac::JNUM)) {
...
void PnlWznmSbs1NTablecol::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSbs1NTablecol::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSbs1NTablecol::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSbs1NTablecol::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
