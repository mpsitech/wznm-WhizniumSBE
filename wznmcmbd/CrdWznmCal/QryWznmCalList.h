...
/**
	* QryWznmCalList
	*/
class QryWznmCalList : public JobWznm {
...
public:
	QryWznmCalList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmCalList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::uint preTyp, const Sbecore::ubigint preVer, const Sbecore::uint preRet, const Sbecore::ubigint preReu, const Sbecore::uint preIat, const Sbecore::uint preRat, const bool addwhere);
	...
	WznmQCalList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmCalMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
