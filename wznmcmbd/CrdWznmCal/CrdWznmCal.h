/**
	* \file CrdWznmCal.h
	* job handler for job CrdWznmCal (declarations)
...
#define VecVWznmCalDo CrdWznmCal::VecVDo
#define VecVWznmCalSge CrdWznmCal::VecVSge

#define ContInfWznmCal CrdWznmCal::ContInf
#define StatAppWznmCal CrdWznmCal::StatApp
#define StatShrWznmCal CrdWznmCal::StatShr
#define TagWznmCal CrdWznmCal::Tag

#define DpchAppWznmCalDo CrdWznmCal::DpchAppDo
#define DpchEngWznmCalData CrdWznmCal::DpchEngData

/**
	* CrdWznmCal
	*/
class CrdWznmCal : public JobWznm {
...
public:
	CrdWznmCal(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmCal();
...
public:
	...
	PnlWznmCalList* pnllist;
	PnlWznmCalHeadbar* pnlheadbar;
	PnlWznmCalRec* pnlrec;
