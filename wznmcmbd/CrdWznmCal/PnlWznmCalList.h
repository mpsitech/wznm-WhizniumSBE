/**
	* \file PnlWznmCalList.h
	* job handler for job PnlWznmCalList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMCALLIST_H
#define PNLWZNMCALLIST_H
...
#define VecVWznmCalListDo PnlWznmCalList::VecVDo

#define ContIacWznmCalList PnlWznmCalList::ContIac
#define ContInfWznmCalList PnlWznmCalList::ContInf
#define StatShrWznmCalList PnlWznmCalList::StatShr
#define StgIacWznmCalList PnlWznmCalList::StgIac
#define TagWznmCalList PnlWznmCalList::Tag

#define DpchAppWznmCalListData PnlWznmCalList::DpchAppData
#define DpchAppWznmCalListDo PnlWznmCalList::DpchAppDo
#define DpchEngWznmCalListData PnlWznmCalList::DpchEngData

/**
	* PnlWznmCalList
	*/
class PnlWznmCalList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOIATWIDTH = 6;
		static const Sbecore::uint TCORATWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoRetWidth = 100, const Sbecore::uint TcoReuWidth = 100, const Sbecore::uint TcoIatWidth = 100, const Sbecore::uint TcoRatWidth = 100);
	...
	public:
		...
		Sbecore::uint TcoIatWidth;
		Sbecore::uint TcoRatWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCalList* rst = NULL, QryWznmCalList::StatShr* statshrqry = NULL, QryWznmCalList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCalList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCalList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCalList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
