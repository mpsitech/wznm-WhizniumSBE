...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQCal1NSensitivity* rst = NULL, QryWznmCal1NSensitivity::StatShr* statshrqry = NULL, QryWznmCal1NSensitivity::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
