/**
	* \file PnlWznmMtdARetpar_blks.cpp
	* job handler for job PnlWznmMtdARetpar (implementation of blocks)
...
/******************************************************************************
 class PnlWznmMtdARetpar::VecVDo
 ******************************************************************************/

uint PnlWznmMtdARetpar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmMtdARetpar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmMtdARetpar::ContInf
 ******************************************************************************/

PnlWznmMtdARetpar::ContInf::ContInf(
...
void PnlWznmMtdARetpar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmMtdARetpar";
...
void PnlWznmMtdARetpar::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmMtdARetpar";
...
set<uint> PnlWznmMtdARetpar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdARetpar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdARetpar::StatApp
 ******************************************************************************/

void PnlWznmMtdARetpar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmMtdARetpar";
...
void PnlWznmMtdARetpar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmMtdARetpar";
...
/******************************************************************************
 class PnlWznmMtdARetpar::StatShr
 ******************************************************************************/

PnlWznmMtdARetpar::StatShr::StatShr(
...
void PnlWznmMtdARetpar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmMtdARetpar";
...
void PnlWznmMtdARetpar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmMtdARetpar";
...
set<uint> PnlWznmMtdARetpar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdARetpar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdARetpar::StgIac
 ******************************************************************************/

PnlWznmMtdARetpar::StgIac::StgIac(
	...
	mask = {TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCOCMTWIDTH};
};

bool PnlWznmMtdARetpar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmMtdARetpar"];}();
...
bool PnlWznmMtdARetpar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmMtdARetpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmMtdARetpar";
...
void PnlWznmMtdARetpar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmMtdARetpar";
...
void PnlWznmMtdARetpar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmMtdARetpar";
...
set<uint> PnlWznmMtdARetpar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdARetpar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOVTYWIDTH, TCOVECWIDTH, TCOLENWIDTH, TCOCMTWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWznmMtdARetpar::Tag
 ******************************************************************************/

void PnlWznmMtdARetpar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmMtdARetpar";
...
void PnlWznmMtdARetpar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmMtdARetpar";
...
/******************************************************************************
 class PnlWznmMtdARetpar::DpchAppData
 ******************************************************************************/

PnlWznmMtdARetpar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDARETPARDATA)
		{
};

string PnlWznmMtdARetpar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdARetpar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmMtdARetparData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmMtdARetpar::StgIac();
	};
};

void PnlWznmMtdARetpar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmMtdARetparData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmMtdARetpar::DpchAppDo
 ******************************************************************************/

PnlWznmMtdARetpar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDARETPARDO)
		{
	ixVDo = 0;
};

string PnlWznmMtdARetpar::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdARetpar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmMtdARetparDo"];}();
...
void PnlWznmMtdARetpar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmMtdARetparDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmMtdARetpar::DpchEngData
 ******************************************************************************/

PnlWznmMtdARetpar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmMtdARetpar::StatShr* statshrqry
			, QryWznmMtdARetpar::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTDARETPARDATA, jref)
		{
...
string PnlWznmMtdARetpar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdARetpar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmMtdARetpar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmMtdARetparData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmMtdARetpar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmMtdARetpar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmMtdARetparData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmMtdARetpar::StatApp::writeXML(wr);
