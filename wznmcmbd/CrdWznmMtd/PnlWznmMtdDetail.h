/**
	...
	* job handler for job PnlWznmMtdDetail (declarations)
...
/**
	* PnlWznmMtdDetail
	*/
class PnlWznmMtdDetail : public JobWznm {
...
public:
	...
	bool evalChkExsActive(DbsWznm* dbswznm);

public:
	PnlWznmMtdDetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMtdDetail();
...
public:
	...
	void refreshRecMtd(DbsWznm* dbswznm, std::set<Sbecore::uint>& moditems);
