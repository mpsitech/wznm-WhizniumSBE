/**
	* \file CrdWznmMtd.h
	* job handler for job CrdWznmMtd (declarations)
...
#define VecVWznmMtdDo CrdWznmMtd::VecVDo
#define VecVWznmMtdSge CrdWznmMtd::VecVSge

#define ContInfWznmMtd CrdWznmMtd::ContInf
#define StatAppWznmMtd CrdWznmMtd::StatApp
#define StatShrWznmMtd CrdWznmMtd::StatShr
#define TagWznmMtd CrdWznmMtd::Tag

#define DpchAppWznmMtdDo CrdWznmMtd::DpchAppDo
#define DpchEngWznmMtdData CrdWznmMtd::DpchEngData

/**
	* CrdWznmMtd
	*/
class CrdWznmMtd : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDMTD = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdMtd = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdMtd;
...
public:
	CrdWznmMtd(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmMtd();
...
public:
	...
	PnlWznmMtdRec* pnlrec;
	PnlWznmMtdHeadbar* pnlheadbar;
	PnlWznmMtdList* pnllist;
