/**
	* \file QryWznmMtdList.h
	* job handler for job QryWznmMtdList (declarations)
...
#ifndef QRYWZNMMTDLIST_H
#define QRYWZNMMTDLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmMtdListOrd QryWznmMtdList::VecVOrd

#define StatAppQryWznmMtdList QryWznmMtdList::StatApp
#define StatShrQryWznmMtdList QryWznmMtdList::StatShr
#define StgIacQryWznmMtdList QryWznmMtdList::StgIac

/**
	* QryWznmMtdList
	*/
class QryWznmMtdList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmMtdListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmMtdList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmMtdList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmMtdList)
		*/
...
public:
	QryWznmMtdList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmMtdList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preJob, const bool addwhere);
	...
	WznmQMtdList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmMtdMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
