/**
	* \file PnlWznmMtdAInvpar_blks.cpp
	* job handler for job PnlWznmMtdAInvpar (implementation of blocks)
...
/******************************************************************************
 class PnlWznmMtdAInvpar::VecVDo
 ******************************************************************************/

uint PnlWznmMtdAInvpar::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmMtdAInvpar::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmMtdAInvpar::ContInf
 ******************************************************************************/

PnlWznmMtdAInvpar::ContInf::ContInf(
...
void PnlWznmMtdAInvpar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmMtdAInvpar";
...
set<uint> PnlWznmMtdAInvpar::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdAInvpar::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdAInvpar::StatApp
 ******************************************************************************/

void PnlWznmMtdAInvpar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmMtdAInvpar";
...
/******************************************************************************
 class PnlWznmMtdAInvpar::StatShr
 ******************************************************************************/

PnlWznmMtdAInvpar::StatShr::StatShr(
...
void PnlWznmMtdAInvpar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmMtdAInvpar";
...
set<uint> PnlWznmMtdAInvpar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdAInvpar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdAInvpar::StgIac
 ******************************************************************************/

PnlWznmMtdAInvpar::StgIac::StgIac(
...
bool PnlWznmMtdAInvpar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmMtdAInvpar"];}();
...
bool PnlWznmMtdAInvpar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmMtdAInvpar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmMtdAInvpar";
...
set<uint> PnlWznmMtdAInvpar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmMtdAInvpar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmMtdAInvpar::Tag
 ******************************************************************************/

void PnlWznmMtdAInvpar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmMtdAInvpar";
...
void PnlWznmMtdAInvpar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmMtdAInvpar";
...
/******************************************************************************
 class PnlWznmMtdAInvpar::DpchAppData
 ******************************************************************************/

PnlWznmMtdAInvpar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDAINVPARDATA)
		{
};

string PnlWznmMtdAInvpar::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdAInvpar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmMtdAInvparData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmMtdAInvpar::StgIac();
	};
};

void PnlWznmMtdAInvpar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmMtdAInvparData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmMtdAInvpar::DpchAppDo
 ******************************************************************************/

PnlWznmMtdAInvpar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDAINVPARDO)
		{
	ixVDo = 0;
};

string PnlWznmMtdAInvpar::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdAInvpar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmMtdAInvparDo"];}();
...
void PnlWznmMtdAInvpar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmMtdAInvparDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmMtdAInvpar::DpchEngData
 ******************************************************************************/

PnlWznmMtdAInvpar::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTDAINVPARDATA, jref)
		{
...
string PnlWznmMtdAInvpar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmMtdAInvpar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmMtdAInvpar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmMtdAInvparData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmMtdAInvpar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmMtdAInvpar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmMtdAInvparData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmMtdAInvpar::StatApp::writeXML(wr);
