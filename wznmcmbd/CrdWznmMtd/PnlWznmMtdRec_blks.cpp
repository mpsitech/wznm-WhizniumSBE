/**
	* \file PnlWznmMtdRec_blks.cpp
	* job handler for job PnlWznmMtdRec (implementation of blocks)
...
void PnlWznmMtdRec::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmMtdRec";
...
void PnlWznmMtdRec::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmMtdRec";
...
void PnlWznmMtdRec::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void PnlWznmMtdRec::StatApp::writeXML(
	...
	else itemtag = "StatitemAppWznmMtdRec";
...
void PnlWznmMtdRec::StatShr::writeJSON(
	...
	if (difftag.length() == 0) difftag = "StatShrWznmMtdRec";
...
void PnlWznmMtdRec::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmMtdRec";
...
void PnlWznmMtdRec::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmMtdRec";
...
void PnlWznmMtdRec::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmMtdRec";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Method");
		};
	xmlTextWriterEndElement(wr);
};
...
PnlWznmMtdRec::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMMTDRECDO)
		{
	ixVDo = 0;
};
...
void PnlWznmMtdRec::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmMtdRecDo");
	else
...
PnlWznmMtdRec::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMMTDRECDATA, jref)
		{
...
void PnlWznmMtdRec::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmMtdRec::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmMtdRecData"] = Json::Value(Json::objectValue);
...
void PnlWznmMtdRec::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmMtdRecData");
