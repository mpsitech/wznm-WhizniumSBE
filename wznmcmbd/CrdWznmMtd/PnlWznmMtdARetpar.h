/**
	...
	* job handler for job PnlWznmMtdARetpar (declarations)
...
#define VecVWznmMtdARetparDo PnlWznmMtdARetpar::VecVDo

#define ContInfWznmMtdARetpar PnlWznmMtdARetpar::ContInf
#define StatAppWznmMtdARetpar PnlWznmMtdARetpar::StatApp
#define StatShrWznmMtdARetpar PnlWznmMtdARetpar::StatShr
#define StgIacWznmMtdARetpar PnlWznmMtdARetpar::StgIac
#define TagWznmMtdARetpar PnlWznmMtdARetpar::Tag

#define DpchAppWznmMtdARetparData PnlWznmMtdARetpar::DpchAppData
#define DpchAppWznmMtdARetparDo PnlWznmMtdARetpar::DpchAppDo
#define DpchEngWznmMtdARetparData PnlWznmMtdARetpar::DpchEngData

/**
	* PnlWznmMtdARetpar
	*/
class PnlWznmMtdARetpar : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMtdARetpar* rst = NULL, QryWznmMtdARetpar::StatShr* statshrqry = NULL, QryWznmMtdARetpar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMtdARetpar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMtdARetpar();
...
public:
	...
	QryWznmMtdARetpar* qry;

	WznmAMMethodRetpar recMtdArpa;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMtdARetpar::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
