/**
	...
	* job handler for job PnlWznmMtdList (declarations)
...
/**
	* PnlWznmMtdList
	*/
class PnlWznmMtdList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMtdList* rst = NULL, QryWznmMtdList::StatShr* statshrqry = NULL, QryWznmMtdList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMtdList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMtdList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMtdList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
