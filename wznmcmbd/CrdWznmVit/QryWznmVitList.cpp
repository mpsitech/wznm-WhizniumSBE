...
void QryWznmVitList::rerun_orderSQL(
	...
	if (preIxOrd == VecVOrd::SRF) sqlstr += " ORDER BY TblWznmMVectoritem.sref ASC";
	else if (preIxOrd == VecVOrd::VEC) sqlstr += " ORDER BY TblWznmMVectoritem.vecRefWznmMVector ASC";
};
