/**
	* \file CrdWznmVit.h
	* job handler for job CrdWznmVit (declarations)
...
#define VecVWznmVitDo CrdWznmVit::VecVDo
#define VecVWznmVitSge CrdWznmVit::VecVSge

#define ContInfWznmVit CrdWznmVit::ContInf
#define StatAppWznmVit CrdWznmVit::StatApp
#define StatShrWznmVit CrdWznmVit::StatShr
#define TagWznmVit CrdWznmVit::Tag

#define DpchAppWznmVitDo CrdWznmVit::DpchAppDo
#define DpchEngWznmVitData CrdWznmVit::DpchEngData

/**
	* CrdWznmVit
	*/
class CrdWznmVit : public JobWznm {
...
public:
	CrdWznmVit(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmVit();
...
public:
	...
	PnlWznmVitList* pnllist;
	PnlWznmVitHeadbar* pnlheadbar;
	PnlWznmVitRec* pnlrec;
