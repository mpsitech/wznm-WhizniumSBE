/**
	* \file PnlWznmVitList.h
	* job handler for job PnlWznmVitList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMVITLIST_H
#define PNLWZNMVITLIST_H
...
#define VecVWznmVitListDo PnlWznmVitList::VecVDo

#define ContIacWznmVitList PnlWznmVitList::ContIac
#define ContInfWznmVitList PnlWznmVitList::ContInf
#define StatShrWznmVitList PnlWznmVitList::StatShr
#define StgIacWznmVitList PnlWznmVitList::StgIac
#define TagWznmVitList PnlWznmVitList::Tag

#define DpchAppWznmVitListData PnlWznmVitList::DpchAppData
#define DpchAppWznmVitListDo PnlWznmVitList::DpchAppDo
#define DpchEngWznmVitListData PnlWznmVitList::DpchEngData

/**
	* PnlWznmVitList
	*/
class PnlWznmVitList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQVitList* rst = NULL, QryWznmVitList::StatShr* statshrqry = NULL, QryWznmVitList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmVitList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVitList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmVitList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
