...
#define VecVQryWznmUsrListOrd QryWznmUsrList::VecVOrd

#define StatAppQryWznmUsrList QryWznmUsrList::StatApp
#define StatShrQryWznmUsrList QryWznmUsrList::StatShr
#define StgIacQryWznmUsrList QryWznmUsrList::StgIac

/**
	* QryWznmUsrList
	*/
class QryWznmUsrList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmUsrListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmUsrList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmUsrList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmUsrList)
		*/
...
public:
	QryWznmUsrList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmUsrList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const Sbecore::ubigint preGrp, const Sbecore::ubigint preOwn, const Sbecore::ubigint prePrs, const std::string& preSrf, const Sbecore::ubigint preUsg, const bool addwhere);
	...
	WznmQUsrList* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmUsrMod(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
