...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQUsr1NSession* rst = NULL, QryWznmUsr1NSession::StatShr* statshrqry = NULL, QryWznmUsr1NSession::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
