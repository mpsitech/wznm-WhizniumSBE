/**
	* \file PnlWznmUsrAAccess_blks.cpp
	* job handler for job PnlWznmUsrAAccess (implementation of blocks)
...
/******************************************************************************
 class PnlWznmUsrAAccess::VecVDo
 ******************************************************************************/

uint PnlWznmUsrAAccess::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmUsrAAccess::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmUsrAAccess::ContInf
 ******************************************************************************/

PnlWznmUsrAAccess::ContInf::ContInf(
...
void PnlWznmUsrAAccess::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmUsrAAccess";
...
void PnlWznmUsrAAccess::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmUsrAAccess";
...
set<uint> PnlWznmUsrAAccess::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmUsrAAccess::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmUsrAAccess::StatApp
 ******************************************************************************/

void PnlWznmUsrAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmUsrAAccess";
...
void PnlWznmUsrAAccess::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmUsrAAccess";
...
/******************************************************************************
 class PnlWznmUsrAAccess::StatShr
 ******************************************************************************/

PnlWznmUsrAAccess::StatShr::StatShr(
...
void PnlWznmUsrAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmUsrAAccess";
...
void PnlWznmUsrAAccess::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmUsrAAccess";
...
set<uint> PnlWznmUsrAAccess::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmUsrAAccess::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmUsrAAccess::StgIac
 ******************************************************************************/

PnlWznmUsrAAccess::StgIac::StgIac(
...
bool PnlWznmUsrAAccess::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmUsrAAccess"];}();
...
bool PnlWznmUsrAAccess::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmUsrAAccess");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmUsrAAccess";
...
void PnlWznmUsrAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmUsrAAccess";
...
void PnlWznmUsrAAccess::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmUsrAAccess";
...
set<uint> PnlWznmUsrAAccess::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmUsrAAccess::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmUsrAAccess::Tag
 ******************************************************************************/

void PnlWznmUsrAAccess::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmUsrAAccess";
...
void PnlWznmUsrAAccess::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmUsrAAccess";
...
/******************************************************************************
 class PnlWznmUsrAAccess::DpchAppData
 ******************************************************************************/

PnlWznmUsrAAccess::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMUSRAACCESSDATA)
		{
};

string PnlWznmUsrAAccess::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmUsrAAccess::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmUsrAAccessData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmUsrAAccess::StgIac();
	};
};

void PnlWznmUsrAAccess::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmUsrAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmUsrAAccess::DpchAppDo
 ******************************************************************************/

PnlWznmUsrAAccess::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMUSRAACCESSDO)
		{
	ixVDo = 0;
};

string PnlWznmUsrAAccess::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmUsrAAccess::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmUsrAAccessDo"];}();
...
void PnlWznmUsrAAccess::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmUsrAAccessDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmUsrAAccess::DpchEngData
 ******************************************************************************/

PnlWznmUsrAAccess::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmUsrAAccess::StatShr* statshrqry
			, QryWznmUsrAAccess::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMUSRAACCESSDATA, jref)
		{
...
string PnlWznmUsrAAccess::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmUsrAAccess::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmUsrAAccess::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmUsrAAccessData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmUsrAAccess::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmUsrAAccess::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmUsrAAccessData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmUsrAAccess::StatApp::writeXML(wr);
