/**
	* \file CrdWznmUsr_blks.cpp
	* job handler for job CrdWznmUsr (implementation of blocks)
...
void CrdWznmUsr::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void CrdWznmUsr::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmUsr";
...
void CrdWznmUsr::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmUsr";
...
void CrdWznmUsr::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWznmUsr";
...
void CrdWznmUsr::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVReqitmode
	...
	else itemtag = "StatitemAppWznmUsr";
...
void CrdWznmUsr::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmUsr";
...
void CrdWznmUsr::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmUsr";
...
void CrdWznmUsr::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmUsr";
...
CrdWznmUsr::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMUSRDO)
		{
	ixVDo = 0;
};
...
void CrdWznmUsr::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmUsrDo"];}();
...
void CrdWznmUsr::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmUsrDo");
	else
...
CrdWznmUsr::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMUSRDATA, jref)
		{
...
void CrdWznmUsr::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void CrdWznmUsr::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmUsrData"] = Json::Value(Json::objectValue);
...
void CrdWznmUsr::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmUsrData");
