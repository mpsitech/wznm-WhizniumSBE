/**
	* \file PnlWznmUsrList.h
	* job handler for job PnlWznmUsrList (declarations)
...
#ifndef PNLWZNMUSRLIST_H
#define PNLWZNMUSRLIST_H
...
#define VecVWznmUsrListDo PnlWznmUsrList::VecVDo

#define ContIacWznmUsrList PnlWznmUsrList::ContIac
#define ContInfWznmUsrList PnlWznmUsrList::ContInf
#define StatShrWznmUsrList PnlWznmUsrList::StatShr
#define StgIacWznmUsrList PnlWznmUsrList::StgIac
#define TagWznmUsrList PnlWznmUsrList::Tag

#define DpchAppWznmUsrListData PnlWznmUsrList::DpchAppData
#define DpchAppWznmUsrListDo PnlWznmUsrList::DpchAppDo
#define DpchEngWznmUsrListData PnlWznmUsrList::DpchEngData

/**
	* PnlWznmUsrList
	*/
class PnlWznmUsrList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoGrpWidth = 100, const Sbecore::uint TcoOwnWidth = 100, const Sbecore::uint TcoPrsWidth = 100, const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoUsgWidth = 100, const Sbecore::uint TcoSteWidth = 100, const Sbecore::uint TcoLclWidth = 100, const Sbecore::uint TcoUlvWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQUsrList* rst = NULL, QryWznmUsrList::StatShr* statshrqry = NULL, QryWznmUsrList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmUsrList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsrList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmUsrList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
