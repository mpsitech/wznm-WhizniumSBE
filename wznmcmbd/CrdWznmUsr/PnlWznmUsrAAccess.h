/**
	* \file PnlWznmUsrAAccess.h
	* job handler for job PnlWznmUsrAAccess (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMUSRAACCESS_H
#define PNLWZNMUSRAACCESS_H
...
#define VecVWznmUsrAAccessDo PnlWznmUsrAAccess::VecVDo

#define ContInfWznmUsrAAccess PnlWznmUsrAAccess::ContInf
#define StatAppWznmUsrAAccess PnlWznmUsrAAccess::StatApp
#define StatShrWznmUsrAAccess PnlWznmUsrAAccess::StatShr
#define StgIacWznmUsrAAccess PnlWznmUsrAAccess::StgIac
#define TagWznmUsrAAccess PnlWznmUsrAAccess::Tag

#define DpchAppWznmUsrAAccessData PnlWznmUsrAAccess::DpchAppData
#define DpchAppWznmUsrAAccessDo PnlWznmUsrAAccess::DpchAppDo
#define DpchEngWznmUsrAAccessData PnlWznmUsrAAccess::DpchEngData

/**
	* PnlWznmUsrAAccess
	*/
class PnlWznmUsrAAccess : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQUsrAAccess* rst = NULL, QryWznmUsrAAccess::StatShr* statshrqry = NULL, QryWznmUsrAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmUsrAAccess(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsrAAccess();
...
public:
	...
	QryWznmUsrAAccess* qry;

	WznmAMUserAccess recUsrAacc;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmUsrAAccess::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
