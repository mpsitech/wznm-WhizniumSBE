/**
	* \file PnlWznmCmpList.h
	* job handler for job PnlWznmCmpList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 25 Aug 2020
	* \date modified: 25 Aug 2020
	*/

#ifndef PNLWZNMCMPLIST_H
#define PNLWZNMCMPLIST_H
...
#define VecVWznmCmpListDo PnlWznmCmpList::VecVDo

#define ContIacWznmCmpList PnlWznmCmpList::ContIac
#define ContInfWznmCmpList PnlWznmCmpList::ContInf
#define StatShrWznmCmpList PnlWznmCmpList::StatShr
#define StgIacWznmCmpList PnlWznmCmpList::StgIac
#define TagWznmCmpList PnlWznmCmpList::Tag

#define DpchAppWznmCmpListData PnlWznmCmpList::DpchAppData
#define DpchAppWznmCmpListDo PnlWznmCmpList::DpchAppDo
#define DpchEngWznmCmpListData PnlWznmCmpList::DpchEngData

/**
	* PnlWznmCmpList
	*/
class PnlWznmCmpList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQCmpList* rst = NULL, QryWznmCmpList::StatShr* statshrqry = NULL, QryWznmCmpList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmCmpList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmCmpList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmCmpList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
