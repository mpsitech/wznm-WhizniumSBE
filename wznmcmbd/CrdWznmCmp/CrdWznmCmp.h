...
#define ContInfWznmCmp CrdWznmCmp::ContInf
#define StatAppWznmCmp CrdWznmCmp::StatApp
#define StatShrWznmCmp CrdWznmCmp::StatShr
#define TagWznmCmp CrdWznmCmp::Tag

#define DpchAppWznmCmpDo CrdWznmCmp::DpchAppDo
#define DpchEngWznmCmpData CrdWznmCmp::DpchEngData

/**
	* CrdWznmCmp
	*/
class CrdWznmCmp : public JobWznm {
...
public:
	CrdWznmCmp(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmCmp();
