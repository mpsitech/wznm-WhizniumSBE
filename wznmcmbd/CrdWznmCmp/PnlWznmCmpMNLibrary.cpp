/**
	...
	* job handler for job PnlWznmCmpMNLibrary (implementation)
...
#include "PnlWznmCmpMNLibrary_blks.cpp"
#include "PnlWznmCmpMNLibrary_evals.cpp"
...
/******************************************************************************
 class PnlWznmCmpMNLibrary
 ******************************************************************************/

PnlWznmCmpMNLibrary::PnlWznmCmpMNLibrary(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCMPMNLIBRARY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmCmpMNLibrary(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmCmpMNLibrary::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmCmpMNLibrary::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmCmpMNLibrary::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFCMP) {
		recCmpRlib = WznmRMComponentMLibrary();
...
void PnlWznmCmpMNLibrary::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCMPMNLIBRARYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCMPMNLIBRARYDO) {
...
void PnlWznmCmpMNLibrary::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmCmpMNLibrary::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCmpMNLibrary::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmCmpMNLibrary::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQCmpMNLibrary* recSelNew = NULL;

	WznmRMComponentMLibrary* _recCmpRlib = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmCmpMNLibrary::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmCmpMNLibrary::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmCmpMNLibrary::StgIac::JNUM)) {
			...
			if (recSelNew) {
				if (dbswznm->tblwznmrmcomponentmlibrary->loadRecByRef(recSelNew->ref, &_recCmpRlib)) {
...
void PnlWznmCmpMNLibrary::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmCmpMNLibrary::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCmpMNLibrary::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmCmpMNLibrary::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmCmpMNLibrary::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmCmpMNLibrary::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
