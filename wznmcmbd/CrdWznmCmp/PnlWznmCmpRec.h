...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdone1NRelease = false, const bool initdoneMNLibrary = false, const bool initdoneMNOppack = false);
