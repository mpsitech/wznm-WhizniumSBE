...
void CrdWznmCmp::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWznmCmp::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void CrdWznmCmp::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWznmCmp::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmCmpDo"];}();
...
void CrdWznmCmp::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmCmpData"] = Json::Value(Json::objectValue);
