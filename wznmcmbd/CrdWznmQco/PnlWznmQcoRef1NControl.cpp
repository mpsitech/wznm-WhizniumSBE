/**
	...
	* job handler for job PnlWznmQcoRef1NControl (implementation)
...
#include "PnlWznmQcoRef1NControl_blks.cpp"
#include "PnlWznmQcoRef1NControl_evals.cpp"
...
/******************************************************************************
 class PnlWznmQcoRef1NControl
 ******************************************************************************/

PnlWznmQcoRef1NControl::PnlWznmQcoRef1NControl(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMQCOREF1NCONTROL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmQcoRef1NControl(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmQcoRef1NControl::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmQcoRef1NControl::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmQcoRef1NControl::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmQcoRef1NControl::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQCOREF1NCONTROLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQCOREF1NCONTROLDO) {
...
void PnlWznmQcoRef1NControl::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmQcoRef1NControl::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQcoRef1NControl::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmQcoRef1NControl::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQQcoRef1NControl* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmQcoRef1NControl::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmQcoRef1NControl::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmQcoRef1NControl::StgIac::JNUM)) {
...
void PnlWznmQcoRef1NControl::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmQcoRef1NControl::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmQcoRef1NControl::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmQcoRef1NControl::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
