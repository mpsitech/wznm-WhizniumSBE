...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQQcoRef1NControl* rst = NULL, QryWznmQcoRef1NControl::StatShr* statshrqry = NULL, QryWznmQcoRef1NControl::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
