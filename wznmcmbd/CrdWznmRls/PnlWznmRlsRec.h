/**
	* \file PnlWznmRlsRec.h
	* job handler for job PnlWznmRlsRec (declarations)
...
#ifndef PNLWZNMRLSREC_H
#define PNLWZNMRLSREC_H
...
#define VecVWznmRlsRecDo PnlWznmRlsRec::VecVDo

#define ContInfWznmRlsRec PnlWznmRlsRec::ContInf
#define StatAppWznmRlsRec PnlWznmRlsRec::StatApp
#define StatShrWznmRlsRec PnlWznmRlsRec::StatShr
#define TagWznmRlsRec PnlWznmRlsRec::Tag

#define DpchAppWznmRlsRecDo PnlWznmRlsRec::DpchAppDo
#define DpchEngWznmRlsRecData PnlWznmRlsRec::DpchEngData

/**
	* PnlWznmRlsRec
	*/
class PnlWznmRlsRec : public JobWznm {
...
public:
	PnlWznmRlsRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmRlsRec();
