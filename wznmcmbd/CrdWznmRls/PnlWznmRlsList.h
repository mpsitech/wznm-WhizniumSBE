/**
	* \file PnlWznmRlsList.h
	* job handler for job PnlWznmRlsList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMRLSLIST_H
#define PNLWZNMRLSLIST_H
...
#define VecVWznmRlsListDo PnlWznmRlsList::VecVDo

#define ContIacWznmRlsList PnlWznmRlsList::ContIac
#define ContInfWznmRlsList PnlWznmRlsList::ContInf
#define StatShrWznmRlsList PnlWznmRlsList::StatShr
#define StgIacWznmRlsList PnlWznmRlsList::StgIac
#define TagWznmRlsList PnlWznmRlsList::Tag

#define DpchAppWznmRlsListData PnlWznmRlsList::DpchAppData
#define DpchAppWznmRlsListDo PnlWznmRlsList::DpchAppDo
#define DpchEngWznmRlsListData PnlWznmRlsList::DpchEngData

/**
	* PnlWznmRlsList
	*/
class PnlWznmRlsList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoCmpWidth = 100, const Sbecore::uint TcoMchWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQRlsList* rst = NULL, QryWznmRlsList::StatShr* statshrqry = NULL, QryWznmRlsList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmRlsList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmRlsList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmRlsList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
