/**
	...
	* job handler for job PnlWznmPrjList (declarations)
...
/**
	* PnlWznmPrjList
	*/
class PnlWznmPrjList : public JobWznm {
...
public:
	PnlWznmPrjList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPrjList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPrjList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
