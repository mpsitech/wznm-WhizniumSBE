...
void PnlWznmPrjHeadbar::StgInf::writeJSON(
...
void PnlWznmPrjHeadbar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void PnlWznmPrjHeadbar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmPrjHeadbarData"] = Json::Value(Json::objectValue);
