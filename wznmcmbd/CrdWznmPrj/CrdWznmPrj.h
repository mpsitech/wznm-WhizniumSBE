/**
	* \file CrdWznmPrj.h
	* job handler for job CrdWznmPrj (declarations)
...
/**
	* CrdWznmPrj
	*/
class CrdWznmPrj : public JobWznm {
...
public:
	...
	bool evalMitCrdIpxAvail(DbsWznm* dbswznm);

public:
	CrdWznmPrj(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmPrj();
...
private:
	...
	void handleDpchAppDoMitCrdIpxClick(DbsWznm* dbswznm, DpchEngWznm** dpcheng);
