...
void QryWznmPrjList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmPrjList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmPrjList";
...
void QryWznmPrjList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmPrjList";
...
void QryWznmPrjList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmPrjList";
...
void QryWznmPrjList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmPrjList";
...
bool QryWznmPrjList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmPrjList"];}();
...
void QryWznmPrjList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
