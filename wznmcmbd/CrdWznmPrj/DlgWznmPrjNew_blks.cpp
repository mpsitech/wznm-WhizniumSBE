...
bool DlgWznmPrjNew::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWznmPrjNew"];}();
...
void DlgWznmPrjNew::DpchAppData::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWznmPrjNewData"];}();
...
void DlgWznmPrjNew::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWznmPrjNewDo"];}();
