/**
	* \file PnlWznmPrjMNPerson.h
	* job handler for job PnlWznmPrjMNPerson (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMPRJMNPERSON_H
#define PNLWZNMPRJMNPERSON_H
...
#define VecVWznmPrjMNPersonDo PnlWznmPrjMNPerson::VecVDo

#define ContInfWznmPrjMNPerson PnlWznmPrjMNPerson::ContInf
#define StatAppWznmPrjMNPerson PnlWznmPrjMNPerson::StatApp
#define StatShrWznmPrjMNPerson PnlWznmPrjMNPerson::StatShr
#define StgIacWznmPrjMNPerson PnlWznmPrjMNPerson::StgIac
#define TagWznmPrjMNPerson PnlWznmPrjMNPerson::Tag

#define DpchAppWznmPrjMNPersonData PnlWznmPrjMNPerson::DpchAppData
#define DpchAppWznmPrjMNPersonDo PnlWznmPrjMNPerson::DpchAppDo
#define DpchEngWznmPrjMNPersonData PnlWznmPrjMNPerson::DpchEngData

/**
	* PnlWznmPrjMNPerson
	*/
class PnlWznmPrjMNPerson : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQPrjMNPerson* rst = NULL, QryWznmPrjMNPerson::StatShr* statshrqry = NULL, QryWznmPrjMNPerson::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmPrjMNPerson(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmPrjMNPerson();
...
public:
	...
	QryWznmPrjMNPerson* qry;

	WznmRMPersonMProject recPrsRprj;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmPrjMNPerson::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
