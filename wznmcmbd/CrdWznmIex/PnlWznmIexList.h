...
#define VecVWznmIexListDo PnlWznmIexList::VecVDo

#define ContIacWznmIexList PnlWznmIexList::ContIac
#define ContInfWznmIexList PnlWznmIexList::ContInf
#define StatShrWznmIexList PnlWznmIexList::StatShr
#define StgIacWznmIexList PnlWznmIexList::StgIac
#define TagWznmIexList PnlWznmIexList::Tag

#define DpchAppWznmIexListData PnlWznmIexList::DpchAppData
#define DpchAppWznmIexListDo PnlWznmIexList::DpchAppDo
#define DpchEngWznmIexListData PnlWznmIexList::DpchEngData

/**
	* PnlWznmIexList
	*/
class PnlWznmIexList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOMIVWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoShoWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoMivWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQIexList* rst = NULL, QryWznmIexList::StatShr* statshrqry = NULL, QryWznmIexList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmIexList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmIexList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmIexList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
