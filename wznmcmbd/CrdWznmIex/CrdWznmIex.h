...
#define ContInfWznmIex CrdWznmIex::ContInf
#define StatAppWznmIex CrdWznmIex::StatApp
#define StatShrWznmIex CrdWznmIex::StatShr
#define TagWznmIex CrdWznmIex::Tag

#define DpchAppWznmIexDo CrdWznmIex::DpchAppDo
#define DpchEngWznmIexData CrdWznmIex::DpchEngData

/**
	* CrdWznmIex
	*/
class CrdWznmIex : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDIEX = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdIex = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdIex;
...
public:
	CrdWznmIex(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmIex();
