/**
	* \file PnlWznmDlgList.h
	* job handler for job PnlWznmDlgList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMDLGLIST_H
#define PNLWZNMDLGLIST_H
...
#define VecVWznmDlgListDo PnlWznmDlgList::VecVDo

#define ContIacWznmDlgList PnlWznmDlgList::ContIac
#define ContInfWznmDlgList PnlWznmDlgList::ContInf
#define StatShrWznmDlgList PnlWznmDlgList::StatShr
#define StgIacWznmDlgList PnlWznmDlgList::StgIac
#define TagWznmDlgList PnlWznmDlgList::Tag

#define DpchAppWznmDlgListData PnlWznmDlgList::DpchAppData
#define DpchAppWznmDlgListDo PnlWznmDlgList::DpchAppDo
#define DpchEngWznmDlgListData PnlWznmDlgList::DpchEngData

/**
	* PnlWznmDlgList
	*/
class PnlWznmDlgList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQDlgList* rst = NULL, QryWznmDlgList::StatShr* statshrqry = NULL, QryWznmDlgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmDlgList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmDlgList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmDlgList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
