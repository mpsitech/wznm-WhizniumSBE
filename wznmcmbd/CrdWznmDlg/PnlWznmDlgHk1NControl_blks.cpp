/**
	* \file PnlWznmDlgHk1NControl_blks.cpp
	* job handler for job PnlWznmDlgHk1NControl (implementation of blocks)
...
void PnlWznmDlgHk1NControl::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmDlgHk1NControl";
...
bool PnlWznmDlgHk1NControl::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmDlgHk1NControl"];}();
...
void PnlWznmDlgHk1NControl::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmDlgHk1NControl::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmDlgHk1NControl";
...
void PnlWznmDlgHk1NControl::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmDlgHk1NControl";
...
PnlWznmDlgHk1NControl::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGHK1NCONTROLDATA)
		{
};
...
void PnlWznmDlgHk1NControl::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmDlgHk1NControlData"];}();
...
void PnlWznmDlgHk1NControl::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmDlgHk1NControlData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgHk1NControl::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGHK1NCONTROLDO)
		{
	ixVDo = 0;
};
...
void PnlWznmDlgHk1NControl::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmDlgHk1NControlDo"];}();
...
void PnlWznmDlgHk1NControl::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmDlgHk1NControlDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgHk1NControl::DpchEngData::DpchEngData(
			...
			, QryWznmDlgHk1NControl::StatShr* statshrqry
			, QryWznmDlgHk1NControl::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMDLGHK1NCONTROLDATA, jref)
		{
...
void PnlWznmDlgHk1NControl::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmDlgHk1NControl::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmDlgHk1NControlData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmDlgHk1NControl::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmDlgHk1NControl::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmDlgHk1NControlData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmDlgHk1NControl::StatApp::writeXML(wr);
