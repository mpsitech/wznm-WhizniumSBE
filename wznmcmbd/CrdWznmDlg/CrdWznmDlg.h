/**
	* \file CrdWznmDlg.h
	* job handler for job CrdWznmDlg (declarations)
...
#define VecVWznmDlgDo CrdWznmDlg::VecVDo
#define VecVWznmDlgSge CrdWznmDlg::VecVSge

#define ContInfWznmDlg CrdWznmDlg::ContInf
#define StatAppWznmDlg CrdWznmDlg::StatApp
#define StatShrWznmDlg CrdWznmDlg::StatShr
#define TagWznmDlg CrdWznmDlg::Tag

#define DpchAppWznmDlgDo CrdWznmDlg::DpchAppDo
#define DpchEngWznmDlgData CrdWznmDlg::DpchEngData

/**
	* CrdWznmDlg
	*/
class CrdWznmDlg : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDDLG = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdDlg = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdDlg;
...
public:
	CrdWznmDlg(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmDlg();
...
public:
	...
	PnlWznmDlgList* pnllist;
	PnlWznmDlgHeadbar* pnlheadbar;
	PnlWznmDlgRec* pnlrec;
