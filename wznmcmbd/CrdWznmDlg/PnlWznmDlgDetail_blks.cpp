/**
	* \file PnlWznmDlgDetail_blks.cpp
	* job handler for job PnlWznmDlgDetail (implementation of blocks)
...
bool PnlWznmDlgDetail::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmDlgDetail"];}();
...
void PnlWznmDlgDetail::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmDlgDetail::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmDlgDetail";
...
void PnlWznmDlgDetail::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmDlgDetail";
...
void PnlWznmDlgDetail::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmDlgDetail";
...
void PnlWznmDlgDetail::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmDlgDetail";
...
void PnlWznmDlgDetail::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmDlgDetail";
...
void PnlWznmDlgDetail::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmDlgDetail";
...
void PnlWznmDlgDetail::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmDlgDetail";
...
void PnlWznmDlgDetail::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmDlgDetail";
...
PnlWznmDlgDetail::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGDETAILDATA)
		{
};
...
void PnlWznmDlgDetail::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmDlgDetailData"];}();
...
void PnlWznmDlgDetail::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmDlgDetailData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgDetail::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMDLGDETAILDO)
		{
	ixVDo = 0;
};
...
void PnlWznmDlgDetail::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmDlgDetailDo"];}();
...
void PnlWznmDlgDetail::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmDlgDetailDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmDlgDetail::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMDLGDETAILDATA, jref)
		{
...
void PnlWznmDlgDetail::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmDlgDetail::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmDlgDetailData"] = Json::Value(Json::objectValue);
...
void PnlWznmDlgDetail::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmDlgDetailData");
