...
public:
	DpchInvWznmWrdbsSql(const Sbecore::ubigint oref = 0, const Sbecore::ubigint jref = 0, const Sbecore::ubigint refWznmMRelease = 0, const std::string& Prjshort = "", const std::string& folder = "");
