/**
	...
	* job handler for job PnlWznmEvtHeadbar (declarations)
...
/**
	* PnlWznmEvtHeadbar
	*/
class PnlWznmEvtHeadbar : public JobWznm {
...
public:
	PnlWznmEvtHeadbar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmEvtHeadbar();
