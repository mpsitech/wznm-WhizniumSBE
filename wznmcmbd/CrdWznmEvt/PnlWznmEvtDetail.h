/**
	...
	* job handler for job PnlWznmEvtDetail (declarations)
...
/**
	* PnlWznmEvtDetail
	*/
class PnlWznmEvtDetail : public JobWznm {
...
public:
	PnlWznmEvtDetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmEvtDetail();
...
public:
	...
	void refreshRecEvt(DbsWznm* dbswznm, std::set<Sbecore::uint>& moditems);
