/**
	* \file CrdWznmEvt.h
	* job handler for job CrdWznmEvt (declarations)
...
#define VecVWznmEvtDo CrdWznmEvt::VecVDo
#define VecVWznmEvtSge CrdWznmEvt::VecVSge

#define ContInfWznmEvt CrdWznmEvt::ContInf
#define StatAppWznmEvt CrdWznmEvt::StatApp
#define StatShrWznmEvt CrdWznmEvt::StatShr
#define TagWznmEvt CrdWznmEvt::Tag

#define DpchAppWznmEvtDo CrdWznmEvt::DpchAppDo
#define DpchEngWznmEvtData CrdWznmEvt::DpchEngData

/**
	* CrdWznmEvt
	*/
class CrdWznmEvt : public JobWznm {
...
public:
	CrdWznmEvt(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmEvt();
...
public:
	...
	PnlWznmEvtRec* pnlrec;
	PnlWznmEvtHeadbar* pnlheadbar;
	PnlWznmEvtList* pnllist;
