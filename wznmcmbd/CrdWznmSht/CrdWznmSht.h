/**
	* \file CrdWznmSht.h
	* job handler for job CrdWznmSht (declarations)
...
#include "PnlWznmShtHeadbar.h"
#include "PnlWznmShtRec.h"

#define VecVWznmShtDo CrdWznmSht::VecVDo
#define VecVWznmShtSge CrdWznmSht::VecVSge

#define ContInfWznmSht CrdWznmSht::ContInf
#define StatAppWznmSht CrdWznmSht::StatApp
#define StatShrWznmSht CrdWznmSht::StatShr
#define TagWznmSht CrdWznmSht::Tag

#define DpchAppWznmShtDo CrdWznmSht::DpchAppDo
#define DpchEngWznmShtData CrdWznmSht::DpchEngData

/**
	* CrdWznmSht
	*/
class CrdWznmSht : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSHT = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdSht = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdSht;
...
public:
	CrdWznmSht(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmSht();
...
public:
	...
	PnlWznmShtList* pnllist;
	PnlWznmShtHeadbar* pnlheadbar;
	PnlWznmShtRec* pnlrec;
