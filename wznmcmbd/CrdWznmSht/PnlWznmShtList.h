/**
	* \file PnlWznmShtList.h
	* job handler for job PnlWznmShtList (declarations)
...
#ifndef PNLWZNMSHTLIST_H
#define PNLWZNMSHTLIST_H
...
#define VecVWznmShtListDo PnlWznmShtList::VecVDo

#define ContIacWznmShtList PnlWznmShtList::ContIac
#define ContInfWznmShtList PnlWznmShtList::ContInf
#define StatShrWznmShtList PnlWznmShtList::StatShr
#define StgIacWznmShtList PnlWznmShtList::StgIac
#define TagWznmShtList PnlWznmShtList::Tag

#define DpchAppWznmShtListData PnlWznmShtList::DpchAppData
#define DpchAppWznmShtListDo PnlWznmShtList::DpchAppDo
#define DpchEngWznmShtListData PnlWznmShtList::DpchEngData

/**
	* PnlWznmShtList
	*/
class PnlWznmShtList : public JobWznm {
...
public:
	...
	public:
		static const Sbecore::uint TCOTITWIDTH = 1;
		static const Sbecore::uint TCOVISWIDTH = 2;

	public:
		StgIac(const Sbecore::uint TcoTitWidth = 250, const Sbecore::uint TcoVisWidth = 100);

	public:
		Sbecore::uint TcoTitWidth;
		Sbecore::uint TcoVisWidth;
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQShtList* rst = NULL, QryWznmShtList::StatShr* statshrqry = NULL, QryWznmShtList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWznmShtList::StatShr statshrqry;
		QryWznmShtList::StgIac stgiacqry;
...
public:
	PnlWznmShtList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmShtList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmShtList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
