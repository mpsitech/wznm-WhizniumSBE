/**
	...
	* job handler for job PnlWznmSht1NBox (declarations)
...
/**
	* PnlWznmSht1NBox
	*/
class PnlWznmSht1NBox : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSht1NBox* rst = NULL, QryWznmSht1NBox::StatShr* statshrqry = NULL, QryWznmSht1NBox::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSht1NBox(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSht1NBox();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSht1NBox::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
