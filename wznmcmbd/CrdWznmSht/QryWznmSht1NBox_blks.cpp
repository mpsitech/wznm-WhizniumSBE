/**
	* \file QryWznmSht1NBox_blks.cpp
	* job handler for job QryWznmSht1NBox (implementation of blocks)
...
/******************************************************************************
 class QryWznmSht1NBox::StatApp
 ******************************************************************************/

void QryWznmSht1NBox::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmSht1NBox";
...
void QryWznmSht1NBox::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmSht1NBox";
...
/******************************************************************************
 class QryWznmSht1NBox::StatShr
 ******************************************************************************/

QryWznmSht1NBox::StatShr::StatShr(
			const uint ntot
...
void QryWznmSht1NBox::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmSht1NBox";
...
void QryWznmSht1NBox::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmSht1NBox";
...
set<uint> QryWznmSht1NBox::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmSht1NBox::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmSht1NBox::StgIac
 ******************************************************************************/

QryWznmSht1NBox::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmSht1NBox::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmSht1NBox"];}();
...
bool QryWznmSht1NBox::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmSht1NBox");
	else
...
void QryWznmSht1NBox::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmSht1NBox";
...
void QryWznmSht1NBox::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> QryWznmSht1NBox::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmSht1NBox::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
