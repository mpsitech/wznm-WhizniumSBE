/**
	...
	* job handler for job PnlWznmShtHeadbar (declarations)
...
/**
	* PnlWznmShtHeadbar
	*/
class PnlWznmShtHeadbar : public JobWznm {
...
public:
	PnlWznmShtHeadbar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmShtHeadbar();
