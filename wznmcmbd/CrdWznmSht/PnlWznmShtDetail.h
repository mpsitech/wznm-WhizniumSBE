/**
	...
	* job handler for job PnlWznmShtDetail (declarations)
...
/**
	* PnlWznmShtDetail
	*/
class PnlWznmShtDetail : public JobWznm {
...
public:
	...
	bool evalTxtVisActive(DbsWznm* dbswznm);
	bool evalButVisViewAvail(DbsWznm* dbswznm);
	bool evalButVisViewActive(DbsWznm* dbswznm);

public:
	PnlWznmShtDetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmShtDetail();
...
public:
	...
	void refreshRecSht(DbsWznm* dbswznm, std::set<Sbecore::uint>& moditems);
