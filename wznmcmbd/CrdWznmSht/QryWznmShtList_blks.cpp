/**
	* \file QryWznmShtList_blks.cpp
	* job handler for job QryWznmShtList (implementation of blocks)
...
/******************************************************************************
 class QryWznmShtList::VecVOrd
 ******************************************************************************/

uint QryWznmShtList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryWznmShtList::VecVOrd::getSref(
			const uint ix
		) {
...
void QryWznmShtList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWznmShtList::StatApp
 ******************************************************************************/

void QryWznmShtList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmShtList";
...
void QryWznmShtList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmShtList";
...
/******************************************************************************
 class QryWznmShtList::StatShr
 ******************************************************************************/

QryWznmShtList::StatShr::StatShr(
			const uint ntot
...
void QryWznmShtList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmShtList";
...
void QryWznmShtList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmShtList";
...
set<uint> QryWznmShtList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmShtList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmShtList::StgIac
 ******************************************************************************/

QryWznmShtList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmShtList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmShtList"];}();
...
bool QryWznmShtList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmShtList");
	else
...
void QryWznmShtList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmShtList";
...
void QryWznmShtList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
...
set<uint> QryWznmShtList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmShtList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
