/**
	* \file PnlWznmMchAPar.h
	* job handler for job PnlWznmMchAPar (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMMCHAPAR_H
#define PNLWZNMMCHAPAR_H
...
#define VecVWznmMchAParDo PnlWznmMchAPar::VecVDo

#define ContInfWznmMchAPar PnlWznmMchAPar::ContInf
#define StatAppWznmMchAPar PnlWznmMchAPar::StatApp
#define StatShrWznmMchAPar PnlWznmMchAPar::StatShr
#define StgIacWznmMchAPar PnlWznmMchAPar::StgIac
#define TagWznmMchAPar PnlWznmMchAPar::Tag

#define DpchAppWznmMchAParData PnlWznmMchAPar::DpchAppData
#define DpchAppWznmMchAParDo PnlWznmMchAPar::DpchAppDo
#define DpchEngWznmMchAParData PnlWznmMchAPar::DpchEngData

/**
	* PnlWznmMchAPar
	*/
class PnlWznmMchAPar : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMchAPar* rst = NULL, QryWznmMchAPar::StatShr* statshrqry = NULL, QryWznmMchAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMchAPar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMchAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMchAPar::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
