/**
	...
	* job handler for job PnlWznmMchAMakefile (implementation)
...
#include "PnlWznmMchAMakefile_blks.cpp"
#include "PnlWznmMchAMakefile_evals.cpp"
...
/******************************************************************************
 class PnlWznmMchAMakefile
 ******************************************************************************/

PnlWznmMchAMakefile::PnlWznmMchAMakefile(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMMCHAMAKEFILE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmMchAMakefile(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmMchAMakefile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmMchAMakefile::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmMchAMakefile::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFMCH) {
		recMchAmkf = WznmAMMachineMakefile();
...
void PnlWznmMchAMakefile::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMCHAMAKEFILEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMCHAMAKEFILEDO) {
...
void PnlWznmMchAMakefile::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmMchAMakefile::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMchAMakefile::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmMchAMakefile::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQMchAMakefile* recSelNew = NULL;

	WznmAMMachineMakefile* _recMchAmkf = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmMchAMakefile::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmMchAMakefile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmMchAMakefile::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recMchAmkf = WznmAMMachineMakefile();

			if (recSelNew) {
				if (dbswznm->tblwznmammachinemakefile->loadRecByRef(recSelNew->ref, &_recMchAmkf)) {
...
void PnlWznmMchAMakefile::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMchAMakefile::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMchAMakefile::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMchAMakefile::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmMchAMakefile::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmMchAMakefile::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
