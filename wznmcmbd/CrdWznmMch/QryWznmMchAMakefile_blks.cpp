/**
	* \file QryWznmMchAMakefile_blks.cpp
	* job handler for job QryWznmMchAMakefile (implementation of blocks)
...
/******************************************************************************
 class QryWznmMchAMakefile::StatApp
 ******************************************************************************/

void QryWznmMchAMakefile::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmMchAMakefile";
...
void QryWznmMchAMakefile::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmMchAMakefile";
...
/******************************************************************************
 class QryWznmMchAMakefile::StatShr
 ******************************************************************************/

QryWznmMchAMakefile::StatShr::StatShr(
			const uint ntot
...
void QryWznmMchAMakefile::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmMchAMakefile";
...
void QryWznmMchAMakefile::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmMchAMakefile";
...
set<uint> QryWznmMchAMakefile::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMchAMakefile::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmMchAMakefile::StgIac
 ******************************************************************************/

QryWznmMchAMakefile::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmMchAMakefile::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmMchAMakefile");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmMchAMakefile";
...
void QryWznmMchAMakefile::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmMchAMakefile";
...
void QryWznmMchAMakefile::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmMchAMakefile";
...
set<uint> QryWznmMchAMakefile::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmMchAMakefile::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
