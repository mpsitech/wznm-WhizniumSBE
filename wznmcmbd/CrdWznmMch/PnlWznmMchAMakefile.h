/**
	...
	* job handler for job PnlWznmMchAMakefile (declarations)
...
/**
	* PnlWznmMchAMakefile
	*/
class PnlWznmMchAMakefile : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMchAMakefile* rst = NULL, QryWznmMchAMakefile::StatShr* statshrqry = NULL, QryWznmMchAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMchAMakefile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMchAMakefile();
...
public:
	...
	QryWznmMchAMakefile* qry;

	WznmAMMachineMakefile recMchAmkf;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMchAMakefile::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
