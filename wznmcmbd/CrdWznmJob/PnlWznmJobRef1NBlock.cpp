/**
	...
	* job handler for job PnlWznmJobRef1NBlock (implementation)
...
#include "PnlWznmJobRef1NBlock_blks.cpp"
#include "PnlWznmJobRef1NBlock_evals.cpp"
...
/******************************************************************************
 class PnlWznmJobRef1NBlock
 ******************************************************************************/

PnlWznmJobRef1NBlock::PnlWznmJobRef1NBlock(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMJOBREF1NBLOCK, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmJobRef1NBlock(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmJobRef1NBlock::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmJobRef1NBlock::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmJobRef1NBlock::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmJobRef1NBlock::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOBREF1NBLOCKDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOBREF1NBLOCKDO) {
...
void PnlWznmJobRef1NBlock::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmJobRef1NBlock::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJobRef1NBlock::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmJobRef1NBlock::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQJobRef1NBlock* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmJobRef1NBlock::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmJobRef1NBlock::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmJobRef1NBlock::StgIac::JNUM)) {
...
void PnlWznmJobRef1NBlock::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCBLK, jref)) if (refJob != 0) {
			sref = "CrdWznmBlk";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, VecWznmVPreset::PREWZNMREFJOB, refJob, sref, recBlk.ref, jrefNew);
		};
...
void PnlWznmJobRef1NBlock::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButNewAvail) {
		if ((xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCBLK, jref) & VecWznmWAccess::EDIT) != 0) if (refJob != 0) {
			sref = "CrdWznmBlk";
...
void PnlWznmJobRef1NBlock::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJobRef1NBlock::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmJobRef1NBlock::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmJobRef1NBlock::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
