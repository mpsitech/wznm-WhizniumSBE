/**
	* \file QryWznmJobACmd_blks.cpp
	* job handler for job QryWznmJobACmd (implementation of blocks)
...
/******************************************************************************
 class QryWznmJobACmd::StatApp
 ******************************************************************************/

void QryWznmJobACmd::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmJobACmd";
...
void QryWznmJobACmd::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmJobACmd";
...
/******************************************************************************
 class QryWznmJobACmd::StatShr
 ******************************************************************************/

QryWznmJobACmd::StatShr::StatShr(
			const uint ntot
...
void QryWznmJobACmd::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmJobACmd";
...
void QryWznmJobACmd::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmJobACmd";
...
set<uint> QryWznmJobACmd::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobACmd::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmJobACmd::StgIac
 ******************************************************************************/

QryWznmJobACmd::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmJobACmd::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmJobACmd"];}();
...
bool QryWznmJobACmd::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmJobACmd");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmJobACmd";
...
void QryWznmJobACmd::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmJobACmd";
...
void QryWznmJobACmd::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmJobACmd";
...
set<uint> QryWznmJobACmd::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobACmd::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
