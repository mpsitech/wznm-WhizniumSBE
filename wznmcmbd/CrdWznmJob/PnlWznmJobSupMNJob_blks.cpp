/**
	* \file PnlWznmJobSupMNJob_blks.cpp
	* job handler for job PnlWznmJobSupMNJob (implementation of blocks)
...
void PnlWznmJobSupMNJob::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmJobSupMNJob";
...
bool PnlWznmJobSupMNJob::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmJobSupMNJob"];}();
...
void PnlWznmJobSupMNJob::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmJobSupMNJob::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmJobSupMNJob";
...
void PnlWznmJobSupMNJob::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmJobSupMNJob";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Sub-jobs");
...
PnlWznmJobSupMNJob::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUPMNJOBDATA)
		{
};
...
void PnlWznmJobSupMNJob::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmJobSupMNJobData"];}();
...
void PnlWznmJobSupMNJob::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobSupMNJobData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmJobSupMNJob::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUPMNJOBDO)
		{
	ixVDo = 0;
};
...
void PnlWznmJobSupMNJob::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmJobSupMNJobDo"];}();
...
void PnlWznmJobSupMNJob::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobSupMNJobDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmJobSupMNJob::DpchEngData::DpchEngData(
			...
			, QryWznmJobSupMNJob::StatShr* statshrqry
			, QryWznmJobSupMNJob::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMJOBSUPMNJOBDATA, jref)
		{
...
void PnlWznmJobSupMNJob::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmJobSupMNJob::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmJobSupMNJobData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmJobSupMNJob::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmJobSupMNJob::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmJobSupMNJobData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmJobSupMNJob::StatApp::writeXML(wr);
