...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQJobJob1NStage* rst = NULL, QryWznmJobJob1NStage::StatShr* statshrqry = NULL, QryWznmJobJob1NStage::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
