/**
	* \file PnlWznmJobSubMNJob_blks.cpp
	* job handler for job PnlWznmJobSubMNJob (implementation of blocks)
...
/******************************************************************************
 class PnlWznmJobSubMNJob::VecVDo
 ******************************************************************************/

uint PnlWznmJobSubMNJob::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmJobSubMNJob::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmJobSubMNJob::ContInf
 ******************************************************************************/

PnlWznmJobSubMNJob::ContInf::ContInf(
...
void PnlWznmJobSubMNJob::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmJobSubMNJob";
...
void PnlWznmJobSubMNJob::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmJobSubMNJob";
...
set<uint> PnlWznmJobSubMNJob::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmJobSubMNJob::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmJobSubMNJob::StatApp
 ******************************************************************************/

void PnlWznmJobSubMNJob::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmJobSubMNJob";
...
void PnlWznmJobSubMNJob::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmJobSubMNJob";
...
/******************************************************************************
 class PnlWznmJobSubMNJob::StatShr
 ******************************************************************************/

PnlWznmJobSubMNJob::StatShr::StatShr(
...
void PnlWznmJobSubMNJob::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmJobSubMNJob";
...
void PnlWznmJobSubMNJob::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmJobSubMNJob";
...
set<uint> PnlWznmJobSubMNJob::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmJobSubMNJob::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmJobSubMNJob::StgIac
 ******************************************************************************/

PnlWznmJobSubMNJob::StgIac::StgIac(
...
bool PnlWznmJobSubMNJob::StgIac::readJSON(
	...
	if (basefound) {
		...
		if (me.isMember("TcoMltWidth")) {TcoMltWidth = me["TcoMltWidth"].asUInt(); add(TCOMLTWIDTH);};
		if (me.isMember("TcoCsaWidth")) {TcoCsaWidth = me["TcoCsaWidth"].asUInt(); add(TCOCSAWIDTH);};
	};

	return basefound;
};

bool PnlWznmJobSubMNJob::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmJobSubMNJob");
	else
...
void PnlWznmJobSubMNJob::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmJobSubMNJob";
...
set<uint> PnlWznmJobSubMNJob::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmJobSubMNJob::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmJobSubMNJob::Tag
 ******************************************************************************/

void PnlWznmJobSubMNJob::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmJobSubMNJob";
...
void PnlWznmJobSubMNJob::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmJobSubMNJob";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Super jobs");
			writeStringAttr(wr, itemtag, "sref", "TcoMref", "Job");
			writeStringAttr(wr, itemtag, "sref", "TcoSho", "Acronym");
			writeStringAttr(wr, itemtag, "sref", "TcoMlt", "Multi");
			writeStringAttr(wr, itemtag, "sref", "TcoCsa", "Constructor action");
		};
...
/******************************************************************************
 class PnlWznmJobSubMNJob::DpchAppData
 ******************************************************************************/

PnlWznmJobSubMNJob::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUBMNJOBDATA)
		{
};

string PnlWznmJobSubMNJob::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmJobSubMNJob::DpchAppData::readJSON(
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmJobSubMNJob::StgIac();
	};
};

void PnlWznmJobSubMNJob::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobSubMNJobData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmJobSubMNJob::DpchAppDo
 ******************************************************************************/

PnlWznmJobSubMNJob::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBSUBMNJOBDO)
		{
	ixVDo = 0;
};

string PnlWznmJobSubMNJob::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmJobSubMNJob::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobSubMNJobDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmJobSubMNJob::DpchEngData
 ******************************************************************************/

PnlWznmJobSubMNJob::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmJobSubMNJob::StatShr* statshrqry
			, QryWznmJobSubMNJob::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMJOBSUBMNJOBDATA, jref)
		{
...
string PnlWznmJobSubMNJob::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmJobSubMNJob::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmJobSubMNJob::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmJobSubMNJobData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmJobSubMNJob::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmJobSubMNJob::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmJobSubMNJobData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmJobSubMNJob::StatApp::writeXML(wr);
