/**
	* \file QryWznmJobMNOp_blks.cpp
	* job handler for job QryWznmJobMNOp (implementation of blocks)
...
/******************************************************************************
 class QryWznmJobMNOp::StatApp
 ******************************************************************************/

void QryWznmJobMNOp::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmJobMNOp";
...
void QryWznmJobMNOp::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmJobMNOp";
...
/******************************************************************************
 class QryWznmJobMNOp::StatShr
 ******************************************************************************/

QryWznmJobMNOp::StatShr::StatShr(
			const uint ntot
...
void QryWznmJobMNOp::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmJobMNOp";
...
void QryWznmJobMNOp::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmJobMNOp";
...
set<uint> QryWznmJobMNOp::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobMNOp::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmJobMNOp::StgIac
 ******************************************************************************/

QryWznmJobMNOp::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmJobMNOp::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmJobMNOp"];}();
...
bool QryWznmJobMNOp::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmJobMNOp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmJobMNOp";
...
void QryWznmJobMNOp::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmJobMNOp";
...
void QryWznmJobMNOp::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmJobMNOp";
...
set<uint> QryWznmJobMNOp::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobMNOp::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
