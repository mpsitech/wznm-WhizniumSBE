/**
	* \file PnlWznmJobAVar_blks.cpp
	* job handler for job PnlWznmJobAVar (implementation of blocks)
...
void PnlWznmJobAVar::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmJobAVar";
...
void PnlWznmJobAVar::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmJobAVar";
...
void PnlWznmJobAVar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmJobAVar";
...
void PnlWznmJobAVar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmJobAVar";
...
void PnlWznmJobAVar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmJobAVar";
...
void PnlWznmJobAVar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmJobAVar";
...
bool PnlWznmJobAVar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmJobAVar"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoShrWidth")) {TcoShrWidth = me["TcoShrWidth"].asUInt(); add(TCOSHRWIDTH);};
...
void PnlWznmJobAVar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmJobAVar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmJobAVar";
...
void PnlWznmJobAVar::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmJobAVar";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoShr", "Shared");
...
PnlWznmJobAVar::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBAVARDATA)
		{
};
...
void PnlWznmJobAVar::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmJobAVarData"];}();
...
void PnlWznmJobAVar::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobAVarData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmJobAVar::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMJOBAVARDO)
		{
	ixVDo = 0;
};
...
void PnlWznmJobAVar::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmJobAVarDo"];}();
...
void PnlWznmJobAVar::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmJobAVarDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmJobAVar::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMJOBAVARDATA, jref)
		{
...
void PnlWznmJobAVar::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmJobAVar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmJobAVarData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmJobAVar::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmJobAVar::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmJobAVarData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmJobAVar::StatApp::writeXML(wr);
