/**
	* \file QryWznmJobAVar_blks.cpp
	* job handler for job QryWznmJobAVar (implementation of blocks)
...
/******************************************************************************
 class QryWznmJobAVar::StatApp
 ******************************************************************************/

void QryWznmJobAVar::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmJobAVar";
...
void QryWznmJobAVar::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmJobAVar";
...
/******************************************************************************
 class QryWznmJobAVar::StatShr
 ******************************************************************************/

QryWznmJobAVar::StatShr::StatShr(
			const uint ntot
...
void QryWznmJobAVar::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmJobAVar";
...
void QryWznmJobAVar::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmJobAVar";
...
set<uint> QryWznmJobAVar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobAVar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmJobAVar::StgIac
 ******************************************************************************/

QryWznmJobAVar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmJobAVar::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmJobAVar"];}();
...
bool QryWznmJobAVar::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmJobAVar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmJobAVar";
...
void QryWznmJobAVar::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmJobAVar";
...
void QryWznmJobAVar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmJobAVar";
...
set<uint> QryWznmJobAVar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmJobAVar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
