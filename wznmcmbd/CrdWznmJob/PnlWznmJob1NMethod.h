...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQJob1NMethod* rst = NULL, QryWznmJob1NMethod::StatShr* statshrqry = NULL, QryWznmJob1NMethod::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
