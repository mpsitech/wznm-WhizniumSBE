/**
	...
	* job handler for job PnlWznmJobAVar (declarations)
...
/**
	* PnlWznmJobAVar
	*/
class PnlWznmJobAVar : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQJobAVar* rst = NULL, QryWznmJobAVar::StatShr* statshrqry = NULL, QryWznmJobAVar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmJobAVar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmJobAVar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmJobAVar::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
