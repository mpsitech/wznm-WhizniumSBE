...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQJobAVar* rst = NULL, QryWznmJobAVar::StatShr* statshrqry = NULL, QryWznmJobAVar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
