...
#define QRYWZNMJOBJOB1NSTAGE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmJobJob1NStage QryWznmJobJob1NStage::StatApp
#define StatShrQryWznmJobJob1NStage QryWznmJobJob1NStage::StatShr
#define StgIacQryWznmJobJob1NStage QryWznmJobJob1NStage::StgIac

/**
	* QryWznmJobJob1NStage
	*/
class QryWznmJobJob1NStage : public JobWznm {
...
public:
	QryWznmJobJob1NStage(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmJobJob1NStage();
...
public:
	...
	WznmQJobJob1NStage* getRecByJnum(const Sbecore::uint jnum);
