/**
	* \file CrdWznmJob.h
	* job handler for job CrdWznmJob (declarations)
...
#define ContInfWznmJob CrdWznmJob::ContInf
#define StatAppWznmJob CrdWznmJob::StatApp
#define StatShrWznmJob CrdWznmJob::StatShr
#define TagWznmJob CrdWznmJob::Tag

#define DpchAppWznmJobDo CrdWznmJob::DpchAppDo
#define DpchEngWznmJobData CrdWznmJob::DpchEngData

/**
	* CrdWznmJob
	*/
class CrdWznmJob : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDJOB = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdJob = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdJob;
...
public:
	CrdWznmJob(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmJob();
