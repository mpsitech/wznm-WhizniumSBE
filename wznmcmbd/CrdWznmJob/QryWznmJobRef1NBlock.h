/**
	...
	* job handler for job QryWznmJobRef1NBlock (declarations)
...
/**
	...
	*/
class QryWznmJobRef1NBlock : public JobWznm {
...
public:
	QryWznmJobRef1NBlock(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmJobRef1NBlock();
...
public:
	...
	WznmQJobRef1NBlock* getRecByJnum(const Sbecore::uint jnum);
