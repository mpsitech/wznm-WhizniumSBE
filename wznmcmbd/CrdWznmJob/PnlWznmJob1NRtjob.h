...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQJob1NRtjob* rst = NULL, QryWznmJob1NRtjob::StatShr* statshrqry = NULL, QryWznmJob1NRtjob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
