/**
	...
	* job handler for job PnlWznmJob1NSensitivity (implementation)
...
#include "PnlWznmJob1NSensitivity_blks.cpp"
...
/******************************************************************************
 class PnlWznmJob1NSensitivity
 ******************************************************************************/

PnlWznmJob1NSensitivity::PnlWznmJob1NSensitivity(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMJOB1NSENSITIVITY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmJob1NSensitivity(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmJob1NSensitivity::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmJob1NSensitivity::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmJob1NSensitivity::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmJob1NSensitivity::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOB1NSENSITIVITYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOB1NSENSITIVITYDO) {
...
void PnlWznmJob1NSensitivity::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmJob1NSensitivity::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJob1NSensitivity::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmJob1NSensitivity::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQJob1NSensitivity* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmJob1NSensitivity::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmJob1NSensitivity::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmJob1NSensitivity::StgIac::JNUM)) {
...
void PnlWznmJob1NSensitivity::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmJob1NSensitivity::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmJob1NSensitivity::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
