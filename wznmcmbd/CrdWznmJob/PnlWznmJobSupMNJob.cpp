/**
	...
	* job handler for job PnlWznmJobSupMNJob (implementation)
...
#include "PnlWznmJobSupMNJob_blks.cpp"
#include "PnlWznmJobSupMNJob_evals.cpp"
...
/******************************************************************************
 class PnlWznmJobSupMNJob
 ******************************************************************************/

PnlWznmJobSupMNJob::PnlWznmJobSupMNJob(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMJOBSUPMNJOB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmJobSupMNJob(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmJobSupMNJob::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmJobSupMNJob::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmJobSupMNJob::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmJobSupMNJob::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOBSUPMNJOBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMJOBSUPMNJOBDO) {
...
void PnlWznmJobSupMNJob::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmJobSupMNJob::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJobSupMNJob::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmJobSupMNJob::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQJobSupMNJob* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmJobSupMNJob::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmJobSupMNJob::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmJobSupMNJob::StgIac::JNUM)) {
...
void PnlWznmJobSupMNJob::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmJobSupMNJob::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJobSupMNJob::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmJobSupMNJob::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmJobSupMNJob::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmJobSupMNJob::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
