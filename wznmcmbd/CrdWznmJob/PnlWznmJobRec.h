...
public:
	...
	public:
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdoneACmd = false, const bool initdoneAVar = false, const bool initdone1NRtjob = false, const bool initdone1NMethod = false, const bool initdoneJob1NStage = false, const bool initdone1NSensitivity = false, const bool initdoneHk1NVector = false, const bool initdoneRef1NBlock = false, const bool initdoneSupMNJob = false, const bool initdoneMNOp = false, const bool initdoneMNOppack = false, const bool initdoneSubMNJob = false);
	};
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefACmd = 0, const Sbecore::ubigint jrefAVar = 0, const Sbecore::ubigint jref1NRtjob = 0, const Sbecore::ubigint jref1NMethod = 0, const Sbecore::ubigint jrefJob1NStage = 0, const Sbecore::ubigint jref1NSensitivity = 0, const Sbecore::ubigint jrefHk1NVector = 0, const Sbecore::ubigint jrefRef1NBlock = 0, const Sbecore::ubigint jrefSupMNJob = 0, const Sbecore::ubigint jrefMNOp = 0, const Sbecore::ubigint jrefMNOppack = 0, const Sbecore::ubigint jrefSubMNJob = 0, const bool pnlsubmnjobAvail = false, const bool ButRegularizeActive = true);
