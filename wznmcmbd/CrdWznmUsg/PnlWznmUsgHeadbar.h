/**
	...
	* job handler for job PnlWznmUsgHeadbar (declarations)
...
/**
	* PnlWznmUsgHeadbar
	*/
class PnlWznmUsgHeadbar : public JobWznm {
...
public:
	PnlWznmUsgHeadbar(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsgHeadbar();
