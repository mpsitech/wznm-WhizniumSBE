/**
	* \file PnlWznmUsgAAccess.h
	* job handler for job PnlWznmUsgAAccess (declarations)
...
#ifndef PNLWZNMUSGAACCESS_H
#define PNLWZNMUSGAACCESS_H
...
#define VecVWznmUsgAAccessDo PnlWznmUsgAAccess::VecVDo

#define ContInfWznmUsgAAccess PnlWznmUsgAAccess::ContInf
#define StatAppWznmUsgAAccess PnlWznmUsgAAccess::StatApp
#define StatShrWznmUsgAAccess PnlWznmUsgAAccess::StatShr
#define StgIacWznmUsgAAccess PnlWznmUsgAAccess::StgIac
#define TagWznmUsgAAccess PnlWznmUsgAAccess::Tag

#define DpchAppWznmUsgAAccessData PnlWznmUsgAAccess::DpchAppData
#define DpchAppWznmUsgAAccessDo PnlWznmUsgAAccess::DpchAppDo
#define DpchEngWznmUsgAAccessData PnlWznmUsgAAccess::DpchEngData

/**
	* PnlWznmUsgAAccess
	*/
class PnlWznmUsgAAccess : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQUsgAAccess* rst = NULL, QryWznmUsgAAccess::StatShr* statshrqry = NULL, QryWznmUsgAAccess::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmUsgAAccess(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsgAAccess();
...
public:
	...
	QryWznmUsgAAccess* qry;

	WznmAMUsergroupAccess recUsgAacc;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmUsgAAccess::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
