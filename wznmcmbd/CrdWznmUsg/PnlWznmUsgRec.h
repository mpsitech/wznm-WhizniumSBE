/**
	...
	* job handler for job PnlWznmUsgRec (declarations)
...
/**
	* PnlWznmUsgRec
	*/
class PnlWznmUsgRec : public JobWznm {
...
public:
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefAAccess = 0, const Sbecore::ubigint jrefMNUser = 0, const bool ButRegularizeActive = true);
...
public:
	PnlWznmUsgRec(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsgRec();
