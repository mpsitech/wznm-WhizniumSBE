/**
	* \file QryWznmUsgList_blks.cpp
	* job handler for job QryWznmUsgList (implementation of blocks)
...
/******************************************************************************
 class QryWznmUsgList::VecVOrd
 ******************************************************************************/

uint QryWznmUsgList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWznmUsgList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWznmUsgList::StatApp
 ******************************************************************************/

void QryWznmUsgList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmUsgList";
...
void QryWznmUsgList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmUsgList";
...
/******************************************************************************
 class QryWznmUsgList::StatShr
 ******************************************************************************/

QryWznmUsgList::StatShr::StatShr(
			const uint ntot
...
void QryWznmUsgList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmUsgList";
...
void QryWznmUsgList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmUsgList";
...
set<uint> QryWznmUsgList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmUsgList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmUsgList::StgIac
 ******************************************************************************/

QryWznmUsgList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmUsgList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmUsgList";
...
void QryWznmUsgList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmUsgList";
...
void QryWznmUsgList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmUsgList";
...
set<uint> QryWznmUsgList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmUsgList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
