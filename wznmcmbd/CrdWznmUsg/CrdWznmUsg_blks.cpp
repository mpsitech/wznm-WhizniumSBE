/**
	* \file CrdWznmUsg_blks.cpp
	* job handler for job CrdWznmUsg (implementation of blocks)
...
void CrdWznmUsg::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void CrdWznmUsg::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmUsg";
...
void CrdWznmUsg::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmUsg";
...
void CrdWznmUsg::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWznmUsg";
...
void CrdWznmUsg::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVReqitmode
	...
	else itemtag = "StatitemAppWznmUsg";
...
void CrdWznmUsg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmUsg";
...
void CrdWznmUsg::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmUsg";
...
void CrdWznmUsg::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmUsg";
...
CrdWznmUsg::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMUSGDO)
		{
	ixVDo = 0;
};
...
void CrdWznmUsg::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmUsgDo"];}();
...
void CrdWznmUsg::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmUsgDo");
	else
...
CrdWznmUsg::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMUSGDATA, jref)
		{
...
void CrdWznmUsg::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void CrdWznmUsg::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmUsgData"] = Json::Value(Json::objectValue);
...
void CrdWznmUsg::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmUsgData");
