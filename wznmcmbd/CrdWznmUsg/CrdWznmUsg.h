/**
	* \file CrdWznmUsg.h
	* job handler for job CrdWznmUsg (declarations)
...
#define VecVWznmUsgDo CrdWznmUsg::VecVDo
#define VecVWznmUsgSge CrdWznmUsg::VecVSge

#define ContInfWznmUsg CrdWznmUsg::ContInf
#define StatAppWznmUsg CrdWznmUsg::StatApp
#define StatShrWznmUsg CrdWznmUsg::StatShr
#define TagWznmUsg CrdWznmUsg::Tag

#define DpchAppWznmUsgDo CrdWznmUsg::DpchAppDo
#define DpchEngWznmUsgData CrdWznmUsg::DpchEngData

/**
	* CrdWznmUsg
	*/
class CrdWznmUsg : public JobWznm {

public:
	/**
		* VecVDo (full: VecVWznmUsgDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppWznmUsgDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWznmUsgData)
		*/
...
public:
	CrdWznmUsg(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmUsg();
...
public:
	...
	PnlWznmUsgList* pnllist;
	PnlWznmUsgHeadbar* pnlheadbar;
	PnlWznmUsgRec* pnlrec;
