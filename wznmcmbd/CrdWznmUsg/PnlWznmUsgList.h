/**
	* \file PnlWznmUsgList.h
	* job handler for job PnlWznmUsgList (declarations)
...
#ifndef PNLWZNMUSGLIST_H
#define PNLWZNMUSGLIST_H
...
#define VecVWznmUsgListDo PnlWznmUsgList::VecVDo

#define ContIacWznmUsgList PnlWznmUsgList::ContIac
#define ContInfWznmUsgList PnlWznmUsgList::ContInf
#define StatShrWznmUsgList PnlWznmUsgList::StatShr
#define StgIacWznmUsgList PnlWznmUsgList::StgIac
#define TagWznmUsgList PnlWznmUsgList::Tag

#define DpchAppWznmUsgListData PnlWznmUsgList::DpchAppData
#define DpchAppWznmUsgListDo PnlWznmUsgList::DpchAppDo
#define DpchEngWznmUsgListData PnlWznmUsgList::DpchEngData

/**
	* PnlWznmUsgList
	*/
class PnlWznmUsgList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQUsgList* rst = NULL, QryWznmUsgList::StatShr* statshrqry = NULL, QryWznmUsgList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmUsgList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmUsgList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmUsgList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
