/**
	...
	* job handler for job PnlWznmUsgMNUser (implementation)
...
#include "PnlWznmUsgMNUser_blks.cpp"
#include "PnlWznmUsgMNUser_evals.cpp"
...
/******************************************************************************
 class PnlWznmUsgMNUser
 ******************************************************************************/

PnlWznmUsgMNUser::PnlWznmUsgMNUser(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMUSGMNUSER, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmUsgMNUser(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmUsgMNUser::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmUsgMNUser::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmUsgMNUser::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMUSGMNUSERDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMUSGMNUSERDO) {
...
void PnlWznmUsgMNUser::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmUsgMNUser::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmUsgMNUser::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmUsgMNUser::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmUsgMNUser::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmUsgMNUser::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmUsgMNUser::StgIac::JNUM)) {
			...
			if (recSelNew) {
				...
				if (dbswznm->tblwznmmuser->loadRecByRef(recSelNew->mref, &_recUsr)) {
					recUsr = *_recUsr;
					delete _recUsr;
				};
			};
...
void PnlWznmUsgMNUser::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCUSR, jref)) {
			sref = "CrdWznmUsr";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, 0, 0, sref, recUsr.ref, jrefNew);
		};
...
void PnlWznmUsgMNUser::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmUsgMNUser::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmUsgMNUser::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmUsgMNUser::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmUsgMNUser::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
