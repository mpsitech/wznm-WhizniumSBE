...
bool DlgWznmFilNew::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWznmFilNew"];}();
...
void DlgWznmFilNew::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
bool DlgWznmFilNew::ContIacDet::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacDlgWznmFilNewDet"];}();
...
void DlgWznmFilNew::ContIacDet::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const bool initdone
...
void DlgWznmFilNew::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::StatShrDet::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::StatShrFil::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::TagDet::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::TagFil::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void DlgWznmFilNew::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWznmFilNewData"];}();
...
void DlgWznmFilNew::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppDlgWznmFilNewDo"];}();
...
void DlgWznmFilNew::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngDlgWznmFilNewData"] = Json::Value(Json::objectValue);
	...
	if (has(TAGFIL)) TagFil::writeJSON(ixWznmVLocale, me);
};
