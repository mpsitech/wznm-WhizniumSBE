...
void PnlWznmFilHeadbar::StgInf::writeJSON(
...
void PnlWznmFilHeadbar::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
...
void PnlWznmFilHeadbar::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmFilHeadbarData"] = Json::Value(Json::objectValue);
