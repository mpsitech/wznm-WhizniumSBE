/**
	* \file PnlWznmFilList_blks.cpp
	* job handler for job PnlWznmFilList (implementation of blocks)
...
/******************************************************************************
 class PnlWznmFilList::VecVDo
 ******************************************************************************/

uint PnlWznmFilList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmFilList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmFilList::ContIac
 ******************************************************************************/

PnlWznmFilList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWznmFilList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmFilList"];}();
...
bool PnlWznmFilList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWznmFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWznmFilList";
...
void PnlWznmFilList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWznmFilList";
...
void PnlWznmFilList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWznmFilList";
...
set<uint> PnlWznmFilList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmFilList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmFilList::ContInf
 ******************************************************************************/

PnlWznmFilList::ContInf::ContInf(
...
void PnlWznmFilList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmFilList";
...
void PnlWznmFilList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmFilList";
...
set<uint> PnlWznmFilList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmFilList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmFilList::StatShr
 ******************************************************************************/

PnlWznmFilList::StatShr::StatShr(
...
void PnlWznmFilList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmFilList";
...
void PnlWznmFilList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmFilList";
...
set<uint> PnlWznmFilList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmFilList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmFilList::StgIac
 ******************************************************************************/

PnlWznmFilList::StgIac::StgIac(
...
bool PnlWznmFilList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmFilList"];}();
...
bool PnlWznmFilList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmFilList";
...
void PnlWznmFilList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmFilList";
...
void PnlWznmFilList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmFilList";
...
set<uint> PnlWznmFilList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmFilList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmFilList::Tag
 ******************************************************************************/

void PnlWznmFilList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmFilList";
...
void PnlWznmFilList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmFilList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoSiz", "Size [byte]");
		};
...
/******************************************************************************
 class PnlWznmFilList::DpchAppData
 ******************************************************************************/

PnlWznmFilList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMFILLISTDATA)
		{
};

string PnlWznmFilList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmFilList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmFilListData"];}();
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryWznmFilList::StgIac();
	};
};

void PnlWznmFilList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmFilListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmFilList::DpchAppDo
 ******************************************************************************/

PnlWznmFilList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMFILLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmFilList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmFilList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmFilListDo"];}();
...
void PnlWznmFilList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmFilListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmFilList::DpchEngData
 ******************************************************************************/

PnlWznmFilList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWznmFilList::StatShr* statshrqry
			, QryWznmFilList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMFILLISTDATA, jref)
		{
...
string PnlWznmFilList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmFilList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmFilList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmFilListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmFilList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmFilList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmFilListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmFilList::StatApp::writeXML(wr);
