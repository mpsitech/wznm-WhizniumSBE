...
#define QRYWZNMAPPREF1NFILE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmAppRef1NFile QryWznmAppRef1NFile::StatApp
#define StatShrQryWznmAppRef1NFile QryWznmAppRef1NFile::StatShr
#define StgIacQryWznmAppRef1NFile QryWznmAppRef1NFile::StgIac

/**
	* QryWznmAppRef1NFile
	*/
class QryWznmAppRef1NFile : public JobWznm {
...
public:
	QryWznmAppRef1NFile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmAppRef1NFile();
...
public:
	...
	WznmQAppRef1NFile* getRecByJnum(const Sbecore::uint jnum);
