...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQApp1NRtjob* rst = NULL, QryWznmApp1NRtjob::StatShr* statshrqry = NULL, QryWznmApp1NRtjob::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
