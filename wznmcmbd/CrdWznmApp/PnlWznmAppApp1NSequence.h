...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQAppApp1NSequence* rst = NULL, QryWznmAppApp1NSequence::StatShr* statshrqry = NULL, QryWznmAppApp1NSequence::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
