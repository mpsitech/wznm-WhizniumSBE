/**
	* \file PnlWznmAppApp1NSequence.h
	* job handler for job PnlWznmAppApp1NSequence (declarations)
...
#ifndef PNLWZNMAPPAPP1NSEQUENCE_H
#define PNLWZNMAPPAPP1NSEQUENCE_H
...
#define VecVWznmAppApp1NSequenceDo PnlWznmAppApp1NSequence::VecVDo

#define ContInfWznmAppApp1NSequence PnlWznmAppApp1NSequence::ContInf
#define StatAppWznmAppApp1NSequence PnlWznmAppApp1NSequence::StatApp
#define StatShrWznmAppApp1NSequence PnlWznmAppApp1NSequence::StatShr
#define StgIacWznmAppApp1NSequence PnlWznmAppApp1NSequence::StgIac
#define TagWznmAppApp1NSequence PnlWznmAppApp1NSequence::Tag

#define DpchAppWznmAppApp1NSequenceData PnlWznmAppApp1NSequence::DpchAppData
#define DpchAppWznmAppApp1NSequenceDo PnlWznmAppApp1NSequence::DpchAppDo
#define DpchEngWznmAppApp1NSequenceData PnlWznmAppApp1NSequence::DpchEngData

/**
	* PnlWznmAppApp1NSequence
	*/
class PnlWznmAppApp1NSequence : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQAppApp1NSequence* rst = NULL, QryWznmAppApp1NSequence::StatShr* statshrqry = NULL, QryWznmAppApp1NSequence::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmAppApp1NSequence(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmAppApp1NSequence();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmAppApp1NSequence::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
