/**
	* \file PnlWznmAppRef1NFile.h
	* job handler for job PnlWznmAppRef1NFile (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMAPPREF1NFILE_H
#define PNLWZNMAPPREF1NFILE_H
...
#define VecVWznmAppRef1NFileDo PnlWznmAppRef1NFile::VecVDo

#define ContInfWznmAppRef1NFile PnlWznmAppRef1NFile::ContInf
#define StatAppWznmAppRef1NFile PnlWznmAppRef1NFile::StatApp
#define StatShrWznmAppRef1NFile PnlWznmAppRef1NFile::StatShr
#define StgIacWznmAppRef1NFile PnlWznmAppRef1NFile::StgIac
#define TagWznmAppRef1NFile PnlWznmAppRef1NFile::Tag

#define DpchAppWznmAppRef1NFileData PnlWznmAppRef1NFile::DpchAppData
#define DpchAppWznmAppRef1NFileDo PnlWznmAppRef1NFile::DpchAppDo
#define DpchEngWznmAppRef1NFileData PnlWznmAppRef1NFile::DpchEngData

/**
	* PnlWznmAppRef1NFile
	*/
class PnlWznmAppRef1NFile : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQAppRef1NFile* rst = NULL, QryWznmAppRef1NFile::StatShr* statshrqry = NULL, QryWznmAppRef1NFile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmAppRef1NFile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmAppRef1NFile();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmAppRef1NFile::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
