/**
	...
	* job handler for job QryWznmApp1NEvent (declarations)
...
/**
	* QryWznmApp1NEvent
	*/
class QryWznmApp1NEvent : public JobWznm {
...
public:
	QryWznmApp1NEvent(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmApp1NEvent();
...
public:
	...
	WznmQApp1NEvent* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWznmEvtMod_appEq(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
