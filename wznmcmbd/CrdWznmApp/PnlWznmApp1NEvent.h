...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQApp1NEvent* rst = NULL, QryWznmApp1NEvent::StatShr* statshrqry = NULL, QryWznmApp1NEvent::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
