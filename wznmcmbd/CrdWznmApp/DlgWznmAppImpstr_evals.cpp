/**
	* \file DlgWznmAppImpstr_evals.cpp
	* job handler for job DlgWznmAppImpstr (implementation of availability/activation evaluation)
...
bool DlgWznmAppImpstr::evalImpButRunActive(
			DbsWznm* dbswznm
		) {
	// sge(prsdone)
...
bool DlgWznmAppImpstr::evalImpButStoActive(
			DbsWznm* dbswznm
		) {
	// sge(impidle|import)
