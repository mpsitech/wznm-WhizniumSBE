/**
	* \file PnlWznmApp1NEvent_blks.cpp
	* job handler for job PnlWznmApp1NEvent (implementation of blocks)
...
void PnlWznmApp1NEvent::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmApp1NEvent";
...
void PnlWznmApp1NEvent::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmApp1NEvent";
...
void PnlWznmApp1NEvent::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmApp1NEvent";
...
void PnlWznmApp1NEvent::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmApp1NEvent";
...
void PnlWznmApp1NEvent::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmApp1NEvent";
...
void PnlWznmApp1NEvent::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmApp1NEvent";
...
bool PnlWznmApp1NEvent::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmApp1NEvent"];}();
...
void PnlWznmApp1NEvent::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmApp1NEvent::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmApp1NEvent";
...
void PnlWznmApp1NEvent::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmApp1NEvent";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Events");
			writeStringAttr(wr, itemtag, "sref", "TcoRef", "Event");
		};
...
PnlWznmApp1NEvent::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMAPP1NEVENTDATA)
		{
};
...
void PnlWznmApp1NEvent::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmApp1NEventData"];}();
...
void PnlWznmApp1NEvent::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmApp1NEventData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmApp1NEvent::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMAPP1NEVENTDO)
		{
	ixVDo = 0;
};
...
void PnlWznmApp1NEvent::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmApp1NEventDo"];}();
...
void PnlWznmApp1NEvent::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmApp1NEventDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmApp1NEvent::DpchEngData::DpchEngData(
			...
			, QryWznmApp1NEvent::StatShr* statshrqry
			, QryWznmApp1NEvent::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMAPP1NEVENTDATA, jref)
		{
...
void PnlWznmApp1NEvent::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmApp1NEvent::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmApp1NEventData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmApp1NEvent::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmApp1NEvent::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmApp1NEventData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmApp1NEvent::StatApp::writeXML(wr);
