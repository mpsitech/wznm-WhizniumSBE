...
/******************************************************************************
 class QryWznmApp1NRtjob::StatApp
 ******************************************************************************/

void QryWznmApp1NRtjob::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmApp1NRtjob";
...
void QryWznmApp1NRtjob::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmApp1NRtjob";
...
/******************************************************************************
 class QryWznmApp1NRtjob::StatShr
 ******************************************************************************/

QryWznmApp1NRtjob::StatShr::StatShr(
			const uint ntot
...
void QryWznmApp1NRtjob::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmApp1NRtjob";
...
void QryWznmApp1NRtjob::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmApp1NRtjob";
...
set<uint> QryWznmApp1NRtjob::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmApp1NRtjob::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmApp1NRtjob::StgIac
 ******************************************************************************/

QryWznmApp1NRtjob::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmApp1NRtjob::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmApp1NRtjob"];}();
...
bool QryWznmApp1NRtjob::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmApp1NRtjob");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmApp1NRtjob";
...
void QryWznmApp1NRtjob::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmApp1NRtjob";
...
void QryWznmApp1NRtjob::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmApp1NRtjob";
...
set<uint> QryWznmApp1NRtjob::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmApp1NRtjob::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
