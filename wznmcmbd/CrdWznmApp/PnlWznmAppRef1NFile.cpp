/**
	...
	* job handler for job PnlWznmAppRef1NFile (implementation)
...
#include "PnlWznmAppRef1NFile_blks.cpp"
#include "PnlWznmAppRef1NFile_evals.cpp"
...
/******************************************************************************
 class PnlWznmAppRef1NFile
 ******************************************************************************/

PnlWznmAppRef1NFile::PnlWznmAppRef1NFile(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMAPPREF1NFILE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmAppRef1NFile(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmAppRef1NFile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmAppRef1NFile::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmAppRef1NFile::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmAppRef1NFile::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMAPPREF1NFILEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMAPPREF1NFILEDO) {
...
void PnlWznmAppRef1NFile::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmAppRef1NFile::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmAppRef1NFile::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmAppRef1NFile::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQAppRef1NFile* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmAppRef1NFile::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmAppRef1NFile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmAppRef1NFile::StgIac::JNUM)) {
...
void PnlWznmAppRef1NFile::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmAppRef1NFile::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmAppRef1NFile::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmAppRef1NFile::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmAppRef1NFile::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmAppRef1NFile::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
