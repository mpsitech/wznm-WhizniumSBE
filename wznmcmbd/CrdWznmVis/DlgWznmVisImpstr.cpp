/**
	* \file DlgWznmVisImpstr.cpp
	* job handler for job DlgWznmVisImpstr (implementation)
...
#include "DlgWznmVisImpstr_blks.cpp"
#include "DlgWznmVisImpstr_evals.cpp"
...
/******************************************************************************
 class DlgWznmVisImpstr
 ******************************************************************************/

DlgWznmVisImpstr::DlgWznmVisImpstr(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::DLGWZNMVISIMPSTR, jrefSup, ixWznmVLocale)
		{
	...
	iex = new JobWznmIexVis(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* DlgWznmVisImpstr::getNewDpchEng(
			set<uint> items
		) {
...
void DlgWznmVisImpstr::refreshIfi(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVisImpstr::refreshImp(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVisImpstr::refreshLfi(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void DlgWznmVisImpstr::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPDLGWZNMVISIMPSTRDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPDLGWZNMVISIMPSTRDO) {
...
void DlgWznmVisImpstr::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void DlgWznmVisImpstr::handleDpchAppDataContiac(
			DbsWznm* dbswznm
			, ContIac* _contiac
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVisImpstr::handleDpchAppDoButDneClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVisImpstr::handleDpchAppDoImpButRunClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVisImpstr::handleDpchAppDoImpButStoClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void DlgWznmVisImpstr::handleDpchAppWznmAlert(
			DbsWznm* dbswznm
...
void DlgWznmVisImpstr::handleUploadInSgeIdle(
			DbsWznm* dbswznm
...
string DlgWznmVisImpstr::handleDownloadInSgeDone(
			DbsWznm* dbswznm
		) {
	return(""); // IP handleDownloadInSgeDone --- LINE
};

void DlgWznmVisImpstr::handleTimerWithSrefMonInSgeImport(
			DbsWznm* dbswznm
		) {
...
void DlgWznmVisImpstr::handleTimerInSgeImpidle(
			DbsWznm* dbswznm
			, const string& sref
		) {
	changeStage(dbswznm, nextIxVSgeSuccess);
...
void DlgWznmVisImpstr::handleTimerInSgePrsidle(
			DbsWznm* dbswznm
			, const string& sref
		) {
	changeStage(dbswznm, nextIxVSgeSuccess);
...
void DlgWznmVisImpstr::changeStage(
			DbsWznm* dbswznm
			, uint _ixVSge
			, DpchEngWznm** dpcheng
		) {
...
string DlgWznmVisImpstr::getSquawk(
			DbsWznm* dbswznm
		) {
	string retval;
	// IP getSquawk --- RBEGIN
...
uint DlgWznmVisImpstr::enterSgeIdle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVisImpstr::leaveSgeIdle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeIdle --- INSERT
};

uint DlgWznmVisImpstr::enterSgePrsidle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVisImpstr::leaveSgePrsidle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgePrsidle --- INSERT
};

uint DlgWznmVisImpstr::enterSgeParse(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	uint retval;
	...
	if (iex->ixVSge != JobWznmIexVis::VecVSge::PRSDONE) {
		if (reqCmd) {
			if (iex->ixVSge == JobWznmIexVis::VecVSge::PRSERR) cout << "\t" << iex->getSquawk(dbswznm) << endl;
...
void DlgWznmVisImpstr::leaveSgeParse(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeParse --- INSERT
};

uint DlgWznmVisImpstr::enterSgeAlrwznmper(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	...
	if (iex->ixVSge == JobWznmIexVis::VecVSge::PRSERR) continf.TxtMsg1 = iex->getSquawk(dbswznm);
...
void DlgWznmVisImpstr::leaveSgeAlrwznmper(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeAlrwznmper --- INSERT
};

uint DlgWznmVisImpstr::enterSgePrsdone(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVisImpstr::leaveSgePrsdone(
			DbsWznm* dbswznm
		) {
	// IP leaveSgePrsdone --- INSERT
};

uint DlgWznmVisImpstr::enterSgeImpidle(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVisImpstr::leaveSgeImpidle(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeImpidle --- INSERT
};

uint DlgWznmVisImpstr::enterSgeImport(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	uint retval;
	...
	if (iex->ixVSge == JobWznmIexVis::VecVSge::IMPERR) retval = nextIxVSgeFailure;
...
void DlgWznmVisImpstr::leaveSgeImport(
			DbsWznm* dbswznm
		) {
	invalidateWakeups();
...
uint DlgWznmVisImpstr::enterSgeAlrwznmier(
			DbsWznm* dbswznm
			, const bool reenter
		) {
...
void DlgWznmVisImpstr::leaveSgeAlrwznmier(
			DbsWznm* dbswznm
		) {
	// IP leaveSgeAlrwznmier --- INSERT
};

uint DlgWznmVisImpstr::enterSgeDone(
			DbsWznm* dbswznm
			, const bool reenter
		) {
	...
	ubigint refWznmMVisual, refWznmMVersion;
	string Prjshort, Filename, srefKMimetype;

	refWznmMVisual = xchg->getRefPreset(VecWznmVPreset::PREWZNMREFVIS, jref);
	dbswznm->loadRefBySQL("SELECT verRefWznmMVersion FROM TblWznmMVisual WHERE ref = " + to_string(refWznmMVisual), refWznmMVersion);

	Prjshort = Wznm::getPrjshort(dbswznm, refWznmMVersion);

	if (ifitxt) {
		Filename = "IexWznmVis_" + StrMod::lc(Prjshort) + ".txt";
		srefKMimetype = "txt";
	} else if (ifixml) {
		Filename = "IexWznmVis_" + StrMod::lc(Prjshort) + ".xml";
		srefKMimetype = "xml";
	};

	//Acv::addfile(dbswznm, xchg->acvpath, infilename, xchg->getRefPreset(VecWznmVPreset::PREWZNMGROUP, jref), xchg->getRefPreset(VecWznmVPreset::PREWZNMOWNER, jref), VecWznmVMFileRefTbl::VIS, refWznmMVisual, "visstr", Filename, srefKMimetype, "");
...
void DlgWznmVisImpstr::leaveSgeDone(
			DbsWznm* dbswznm
		) {
