/**
	...
	* job handler for job PnlWznmVisDetail (declarations)
...
/**
	* PnlWznmVisDetail
	*/
class PnlWznmVisDetail : public JobWznm {
...
public:
	PnlWznmVisDetail(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmVisDetail();
...
public:
	...
	void refreshRecVis(DbsWznm* dbswznm, std::set<Sbecore::uint>& moditems);
