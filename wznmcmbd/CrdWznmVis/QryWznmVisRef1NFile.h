/**
	* \file QryWznmVisRef1NFile.h
	* job handler for job QryWznmVisRef1NFile (declarations)
...
#ifndef QRYWZNMVISREF1NFILE_H
#define QRYWZNMVISREF1NFILE_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmVisRef1NFile QryWznmVisRef1NFile::StatApp
#define StatShrQryWznmVisRef1NFile QryWznmVisRef1NFile::StatShr
#define StgIacQryWznmVisRef1NFile QryWznmVisRef1NFile::StgIac

/**
	* QryWznmVisRef1NFile
	*/
class QryWznmVisRef1NFile : public JobWznm {
...
public:
	QryWznmVisRef1NFile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmVisRef1NFile();
...
public:
	...
	WznmQVisRef1NFile* getRecByJnum(const Sbecore::uint jnum);
