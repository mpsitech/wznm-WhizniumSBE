/**
	* \file PnlWznmMtyAMakefile.h
	* job handler for job PnlWznmMtyAMakefile (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMMTYAMAKEFILE_H
#define PNLWZNMMTYAMAKEFILE_H
...
#define VecVWznmMtyAMakefileDo PnlWznmMtyAMakefile::VecVDo

#define ContInfWznmMtyAMakefile PnlWznmMtyAMakefile::ContInf
#define StatAppWznmMtyAMakefile PnlWznmMtyAMakefile::StatApp
#define StatShrWznmMtyAMakefile PnlWznmMtyAMakefile::StatShr
#define StgIacWznmMtyAMakefile PnlWznmMtyAMakefile::StgIac
#define TagWznmMtyAMakefile PnlWznmMtyAMakefile::Tag

#define DpchAppWznmMtyAMakefileData PnlWznmMtyAMakefile::DpchAppData
#define DpchAppWznmMtyAMakefileDo PnlWznmMtyAMakefile::DpchAppDo
#define DpchEngWznmMtyAMakefileData PnlWznmMtyAMakefile::DpchEngData

/**
	* PnlWznmMtyAMakefile
	*/
class PnlWznmMtyAMakefile : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQMtyAMakefile* rst = NULL, QryWznmMtyAMakefile::StatShr* statshrqry = NULL, QryWznmMtyAMakefile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmMtyAMakefile(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmMtyAMakefile();
...
public:
	...
	QryWznmMtyAMakefile* qry;

	WznmAMMachtypeMakefile recMtyAmkf;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmMtyAMakefile::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
