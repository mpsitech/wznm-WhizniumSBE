/**
	* \file PnlWznmMtyAMakefile.cpp
	* job handler for job PnlWznmMtyAMakefile (implementation)
...
#include "PnlWznmMtyAMakefile_blks.cpp"
#include "PnlWznmMtyAMakefile_evals.cpp"
...
/******************************************************************************
 class PnlWznmMtyAMakefile
 ******************************************************************************/

PnlWznmMtyAMakefile::PnlWznmMtyAMakefile(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMMTYAMAKEFILE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmMtyAMakefile(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmMtyAMakefile::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmMtyAMakefile::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmMtyAMakefile::updatePreset(
			DbsWznm* dbswznm
	...
	if (ixWznmVPreset == VecWznmVPreset::PREWZNMREFMTY) {
		recMtyAmkf = WznmAMMachtypeMakefile();
...
void PnlWznmMtyAMakefile::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMTYAMAKEFILEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMMTYAMAKEFILEDO) {
...
void PnlWznmMtyAMakefile::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmMtyAMakefile::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMtyAMakefile::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmMtyAMakefile::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQMtyAMakefile* recSelNew = NULL;

	WznmAMMachtypeMakefile* _recMtyAmkf = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmMtyAMakefile::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmMtyAMakefile::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmMtyAMakefile::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recMtyAmkf = WznmAMMachtypeMakefile();

			if (recSelNew) {
				if (dbswznm->tblwznmammachtypemakefile->loadRecByRef(recSelNew->ref, &_recMtyAmkf)) {
					recMtyAmkf = *_recMtyAmkf;
					delete _recMtyAmkf;
				};
			};
...
void PnlWznmMtyAMakefile::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMtyAMakefile::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMtyAMakefile::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmMtyAMakefile::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmMtyAMakefile::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmMtyAMakefile::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
