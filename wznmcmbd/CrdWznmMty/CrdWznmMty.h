/**
	* \file CrdWznmMty.h
	* job handler for job CrdWznmMty (declarations)
...
#define VecVWznmMtyDo CrdWznmMty::VecVDo
#define VecVWznmMtySge CrdWznmMty::VecVSge

#define ContInfWznmMty CrdWznmMty::ContInf
#define StatAppWznmMty CrdWznmMty::StatApp
#define StatShrWznmMty CrdWznmMty::StatShr
#define TagWznmMty CrdWznmMty::Tag

#define DpchAppWznmMtyDo CrdWznmMty::DpchAppDo
#define DpchEngWznmMtyData CrdWznmMty::DpchEngData

/**
	* CrdWznmMty
	*/
class CrdWznmMty : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDMTY = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdMty = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdMty;
...
public:
	CrdWznmMty(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0);
	~CrdWznmMty();
...
public:
	...
	PnlWznmMtyList* pnllist;
	PnlWznmMtyHeadbar* pnlheadbar;
	PnlWznmMtyRec* pnlrec;
