...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, Sbecore::Xmlio::Feed* feedFLstBlk = NULL, Sbecore::Xmlio::Feed* feedFLstCal = NULL, Sbecore::Xmlio::Feed* feedFLstJob = NULL, Sbecore::Xmlio::Feed* feedFLstMtd = NULL, Sbecore::Xmlio::Feed* feedFLstSge = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});
