...
#define QRYWZNMOPKLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmOpkListOrd QryWznmOpkList::VecVOrd

#define StatAppQryWznmOpkList QryWznmOpkList::StatApp
#define StatShrQryWznmOpkList QryWznmOpkList::StatShr
#define StgIacQryWznmOpkList QryWznmOpkList::StgIac

/**
	* QryWznmOpkList
	*/
class QryWznmOpkList : public JobWznm {
...
public:
	QryWznmOpkList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmOpkList();
...
public:
	...
	WznmQOpkList* getRecByJnum(const Sbecore::uint jnum);
