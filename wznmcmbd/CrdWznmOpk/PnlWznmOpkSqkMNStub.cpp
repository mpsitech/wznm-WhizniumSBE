/**
	...
	* job handler for job PnlWznmOpkSqkMNStub (implementation)
...
#include "PnlWznmOpkSqkMNStub_blks.cpp"
#include "PnlWznmOpkSqkMNStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmOpkSqkMNStub
 ******************************************************************************/

PnlWznmOpkSqkMNStub::PnlWznmOpkSqkMNStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMOPKSQKMNSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmOpkSqkMNStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmOpkSqkMNStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmOpkSqkMNStub::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmOpkSqkMNStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmOpkSqkMNStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPKSQKMNSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPKSQKMNSTUBDO) {
...
void PnlWznmOpkSqkMNStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmOpkSqkMNStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkSqkMNStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmOpkSqkMNStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQOpkSqkMNStub* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmOpkSqkMNStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmOpkSqkMNStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmOpkSqkMNStub::StgIac::JNUM)) {
...
void PnlWznmOpkSqkMNStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmOpkSqkMNStub::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkSqkMNStub::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkSqkMNStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmOpkSqkMNStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmOpkSqkMNStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
