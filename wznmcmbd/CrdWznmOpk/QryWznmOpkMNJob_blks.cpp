/**
	* \file QryWznmOpkMNJob_blks.cpp
	* job handler for job QryWznmOpkMNJob (implementation of blocks)
...
/******************************************************************************
 class QryWznmOpkMNJob::StatApp
 ******************************************************************************/

void QryWznmOpkMNJob::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmOpkMNJob";
...
void QryWznmOpkMNJob::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmOpkMNJob";
...
/******************************************************************************
 class QryWznmOpkMNJob::StatShr
 ******************************************************************************/

QryWznmOpkMNJob::StatShr::StatShr(
			const uint ntot
...
void QryWznmOpkMNJob::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmOpkMNJob";
...
void QryWznmOpkMNJob::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmOpkMNJob";
...
set<uint> QryWznmOpkMNJob::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmOpkMNJob::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmOpkMNJob::StgIac
 ******************************************************************************/

QryWznmOpkMNJob::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmOpkMNJob::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmOpkMNJob"];}();
...
bool QryWznmOpkMNJob::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmOpkMNJob");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmOpkMNJob";
...
void QryWznmOpkMNJob::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmOpkMNJob";
...
void QryWznmOpkMNJob::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmOpkMNJob";
...
set<uint> QryWznmOpkMNJob::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmOpkMNJob::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
