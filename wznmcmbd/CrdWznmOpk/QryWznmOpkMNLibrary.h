/**
	...
	* job handler for job QryWznmOpkMNLibrary (declarations)
...
/**
	* QryWznmOpkMNLibrary
	*/
class QryWznmOpkMNLibrary : public JobWznm {
...
public:
	QryWznmOpkMNLibrary(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmOpkMNLibrary();
...
public:
	...
	WznmQOpkMNLibrary* getRecByJnum(const Sbecore::uint jnum);
...
private:
	...
	bool handleCallWznmLibRopkMod_opkEq(DbsWznm* dbswznm, const Sbecore::ubigint jrefTrig);
