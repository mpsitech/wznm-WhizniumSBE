/**
	...
	* job handler for job PnlWznmOpkAInvarg (implementation)
...
#include "PnlWznmOpkAInvarg_blks.cpp"
#include "PnlWznmOpkAInvarg_evals.cpp"
...
/******************************************************************************
 class PnlWznmOpkAInvarg
 ******************************************************************************/

PnlWznmOpkAInvarg::PnlWznmOpkAInvarg(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMOPKAINVARG, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmOpkAInvarg(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmOpkAInvarg::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmOpkAInvarg::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmOpkAInvarg::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmOpkAInvarg::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDO) {
...
void PnlWznmOpkAInvarg::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmOpkAInvarg::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkAInvarg::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmOpkAInvarg::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQOpkAInvarg* recSelNew = NULL;

	WznmAMOppackInvarg* _recOpkAinv = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmOpkAInvarg::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmOpkAInvarg::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmOpkAInvarg::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recOpkAinv = WznmAMOppackInvarg();

			if (recSelNew) {
				if (dbswznm->tblwznmamoppackinvarg->loadRecByRef(recSelNew->ref, &_recOpkAinv)) {
					recOpkAinv = *_recOpkAinv;
					delete _recOpkAinv;
				};
			};
...
void PnlWznmOpkAInvarg::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkAInvarg::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkAInvarg::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmOpkAInvarg::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmOpkAInvarg::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmOpkAInvarg::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
