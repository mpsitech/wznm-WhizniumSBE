/**
	* \file PnlWznmOpkAInvarg_blks.cpp
	* job handler for job PnlWznmOpkAInvarg (implementation of blocks)
...
/******************************************************************************
 class PnlWznmOpkAInvarg::VecVDo
 ******************************************************************************/

uint PnlWznmOpkAInvarg::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmOpkAInvarg::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmOpkAInvarg::ContInf
 ******************************************************************************/

PnlWznmOpkAInvarg::ContInf::ContInf(
...
void PnlWznmOpkAInvarg::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmOpkAInvarg";
...
void PnlWznmOpkAInvarg::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmOpkAInvarg";
...
set<uint> PnlWznmOpkAInvarg::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpkAInvarg::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpkAInvarg::StatApp
 ******************************************************************************/

void PnlWznmOpkAInvarg::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmOpkAInvarg";
...
void PnlWznmOpkAInvarg::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmOpkAInvarg";
...
/******************************************************************************
 class PnlWznmOpkAInvarg::StatShr
 ******************************************************************************/

PnlWznmOpkAInvarg::StatShr::StatShr(
...
void PnlWznmOpkAInvarg::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmOpkAInvarg";
...
void PnlWznmOpkAInvarg::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmOpkAInvarg";
...
set<uint> PnlWznmOpkAInvarg::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpkAInvarg::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpkAInvarg::StgIac
 ******************************************************************************/

PnlWznmOpkAInvarg::StgIac::StgIac(
...
bool PnlWznmOpkAInvarg::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmOpkAInvarg"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoDvlWidth")) {TcoDvlWidth = me["TcoDvlWidth"].asUInt(); add(TCODVLWIDTH);};
...
bool PnlWznmOpkAInvarg::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmOpkAInvarg");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmOpkAInvarg";
...
void PnlWznmOpkAInvarg::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmOpkAInvarg";
...
void PnlWznmOpkAInvarg::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmOpkAInvarg";
...
set<uint> PnlWznmOpkAInvarg::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmOpkAInvarg::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmOpkAInvarg::Tag
 ******************************************************************************/

void PnlWznmOpkAInvarg::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmOpkAInvarg";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Invocation arguments";
...
void PnlWznmOpkAInvarg::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmOpkAInvarg";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Invocation arguments");
			writeStringAttr(wr, itemtag, "sref", "TcoSrf", "Identifier");
			writeStringAttr(wr, itemtag, "sref", "TcoVty", "Var. type");
			writeStringAttr(wr, itemtag, "sref", "TcoVec", "Vector");
			writeStringAttr(wr, itemtag, "sref", "TcoDvl", "Def. val.");
...
/******************************************************************************
 class PnlWznmOpkAInvarg::DpchAppData
 ******************************************************************************/

PnlWznmOpkAInvarg::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDATA)
		{
};

string PnlWznmOpkAInvarg::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpkAInvarg::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpkAInvargData"];}();
	...
	if (basefound) {
		...
		stgiac = StgIac();
		stgiacqry = QryWznmOpkAInvarg::StgIac();
	};
};

void PnlWznmOpkAInvarg::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpkAInvargData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmOpkAInvarg::DpchAppDo
 ******************************************************************************/

PnlWznmOpkAInvarg::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMOPKAINVARGDO)
		{
	ixVDo = 0;
};

string PnlWznmOpkAInvarg::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpkAInvarg::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmOpkAInvargDo"];}();
...
void PnlWznmOpkAInvarg::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmOpkAInvargDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmOpkAInvarg::DpchEngData
 ******************************************************************************/

PnlWznmOpkAInvarg::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			, QryWznmOpkAInvarg::StatShr* statshrqry
			, QryWznmOpkAInvarg::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMOPKAINVARGDATA, jref)
		{
...
string PnlWznmOpkAInvarg::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmOpkAInvarg::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmOpkAInvarg::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmOpkAInvargData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmOpkAInvarg::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmOpkAInvarg::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmOpkAInvargData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmOpkAInvarg::StatApp::writeXML(wr);
