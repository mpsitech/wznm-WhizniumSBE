/**
	* \file CrdWznmOpk.h
	* job handler for job CrdWznmOpk (declarations)
...
#define VecVWznmOpkDo CrdWznmOpk::VecVDo
#define VecVWznmOpkSge CrdWznmOpk::VecVSge

#define ContInfWznmOpk CrdWznmOpk::ContInf
#define StatAppWznmOpk CrdWznmOpk::StatApp
#define StatShrWznmOpk CrdWznmOpk::StatShr
#define TagWznmOpk CrdWznmOpk::Tag

#define DpchAppWznmOpkDo CrdWznmOpk::DpchAppDo
#define DpchEngWznmOpkData CrdWznmOpk::DpchEngData

/**
	* CrdWznmOpk
	*/
class CrdWznmOpk : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDOPK = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdOpk = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdOpk;
...
public:
	CrdWznmOpk(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmOpk();
...
public:
	...
	PnlWznmOpkList* pnllist;
	PnlWznmOpkHeadbar* pnlheadbar;
	PnlWznmOpkRec* pnlrec;
