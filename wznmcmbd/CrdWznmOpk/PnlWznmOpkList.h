/**
	* \file PnlWznmOpkList.h
	* job handler for job PnlWznmOpkList (declarations)
...
#ifndef PNLWZNMOPKLIST_H
#define PNLWZNMOPKLIST_H
...
#define VecVWznmOpkListDo PnlWznmOpkList::VecVDo

#define ContIacWznmOpkList PnlWznmOpkList::ContIac
#define ContInfWznmOpkList PnlWznmOpkList::ContInf
#define StatShrWznmOpkList PnlWznmOpkList::StatShr
#define StgIacWznmOpkList PnlWznmOpkList::StgIac
#define TagWznmOpkList PnlWznmOpkList::Tag

#define DpchAppWznmOpkListData PnlWznmOpkList::DpchAppData
#define DpchAppWznmOpkListDo PnlWznmOpkList::DpchAppDo
#define DpchEngWznmOpkListData PnlWznmOpkList::DpchEngData

/**
	* PnlWznmOpkList
	*/
class PnlWznmOpkList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOSHDWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoShdWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQOpkList* rst = NULL, QryWznmOpkList::StatShr* statshrqry = NULL, QryWznmOpkList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmOpkList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmOpkList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmOpkList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
