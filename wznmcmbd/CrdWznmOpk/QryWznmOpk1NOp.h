...
#define QRYWZNMOPK1NOP_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmOpk1NOp QryWznmOpk1NOp::StatApp
#define StatShrQryWznmOpk1NOp QryWznmOpk1NOp::StatShr
#define StgIacQryWznmOpk1NOp QryWznmOpk1NOp::StgIac

/**
	* QryWznmOpk1NOp
	*/
class QryWznmOpk1NOp : public JobWznm {
...
public:
	QryWznmOpk1NOp(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmOpk1NOp();
...
public:
	...
	WznmQOpk1NOp* getRecByJnum(const Sbecore::uint jnum);
