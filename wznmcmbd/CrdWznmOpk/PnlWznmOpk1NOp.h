...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQOpk1NOp* rst = NULL, QryWznmOpk1NOp::StatShr* statshrqry = NULL, QryWznmOpk1NOp::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
