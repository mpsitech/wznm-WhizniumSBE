...
#define StatAppQryWznmImeIme1NImpexpcol QryWznmImeIme1NImpexpcol::StatApp
#define StatShrQryWznmImeIme1NImpexpcol QryWznmImeIme1NImpexpcol::StatShr
#define StgIacQryWznmImeIme1NImpexpcol QryWznmImeIme1NImpexpcol::StgIac

/**
	* QryWznmImeIme1NImpexpcol
	*/
class QryWznmImeIme1NImpexpcol : public JobWznm {
...
public:
	QryWznmImeIme1NImpexpcol(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmImeIme1NImpexpcol();
...
public:
	...
	WznmQImeIme1NImpexpcol* getRecByJnum(const Sbecore::uint jnum);
