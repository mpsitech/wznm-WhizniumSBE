/**
	* \file CrdWznmIme.h
	* job handler for job CrdWznmIme (declarations)
...
#define VecVWznmImeDo CrdWznmIme::VecVDo
#define VecVWznmImeSge CrdWznmIme::VecVSge

#define ContInfWznmIme CrdWznmIme::ContInf
#define StatAppWznmIme CrdWznmIme::StatApp
#define StatShrWznmIme CrdWznmIme::StatShr
#define TagWznmIme CrdWznmIme::Tag

#define DpchAppWznmImeDo CrdWznmIme::DpchAppDo
#define DpchEngWznmImeData CrdWznmIme::DpchEngData

/**
	* CrdWznmIme
	*/
class CrdWznmIme : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDIME = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdIme = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdIme;
...
public:
	CrdWznmIme(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmIme();
...
public:
	...
	PnlWznmImeRec* pnlrec;
	PnlWznmImeHeadbar* pnlheadbar;
	PnlWznmImeList* pnllist;
