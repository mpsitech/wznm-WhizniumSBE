/**
	* \file PnlWznmImeIme1NImpexpcol.h
	* job handler for job PnlWznmImeIme1NImpexpcol (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMIMEIME1NIMPEXPCOL_H
#define PNLWZNMIMEIME1NIMPEXPCOL_H
...
#define VecVWznmImeIme1NImpexpcolDo PnlWznmImeIme1NImpexpcol::VecVDo

#define ContInfWznmImeIme1NImpexpcol PnlWznmImeIme1NImpexpcol::ContInf
#define StatAppWznmImeIme1NImpexpcol PnlWznmImeIme1NImpexpcol::StatApp
#define StatShrWznmImeIme1NImpexpcol PnlWznmImeIme1NImpexpcol::StatShr
#define StgIacWznmImeIme1NImpexpcol PnlWznmImeIme1NImpexpcol::StgIac
#define TagWznmImeIme1NImpexpcol PnlWznmImeIme1NImpexpcol::Tag

#define DpchAppWznmImeIme1NImpexpcolData PnlWznmImeIme1NImpexpcol::DpchAppData
#define DpchAppWznmImeIme1NImpexpcolDo PnlWznmImeIme1NImpexpcol::DpchAppDo
#define DpchEngWznmImeIme1NImpexpcolData PnlWznmImeIme1NImpexpcol::DpchEngData

/**
	* PnlWznmImeIme1NImpexpcol
	*/
class PnlWznmImeIme1NImpexpcol : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQImeIme1NImpexpcol* rst = NULL, QryWznmImeIme1NImpexpcol::StatShr* statshrqry = NULL, QryWznmImeIme1NImpexpcol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmImeIme1NImpexpcol(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmImeIme1NImpexpcol();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmImeIme1NImpexpcol::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
