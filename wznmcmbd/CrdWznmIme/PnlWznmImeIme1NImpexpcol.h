...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQImeIme1NImpexpcol* rst = NULL, QryWznmImeIme1NImpexpcol::StatShr* statshrqry = NULL, QryWznmImeIme1NImpexpcol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
