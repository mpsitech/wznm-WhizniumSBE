/**
	...
	* job handler for job PnlWznmImeSup1NImpexp (implementation)
...
#include "PnlWznmImeSup1NImpexp_blks.cpp"
#include "PnlWznmImeSup1NImpexp_evals.cpp"
...
/******************************************************************************
 class PnlWznmImeSup1NImpexp
 ******************************************************************************/

PnlWznmImeSup1NImpexp::PnlWznmImeSup1NImpexp(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMIMESUP1NIMPEXP, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmImeSup1NImpexp(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmImeSup1NImpexp::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmImeSup1NImpexp::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmImeSup1NImpexp::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmImeSup1NImpexp::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMIMESUP1NIMPEXPDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMIMESUP1NIMPEXPDO) {
...
void PnlWznmImeSup1NImpexp::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmImeSup1NImpexp::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmImeSup1NImpexp::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmImeSup1NImpexp::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQImeSup1NImpexp* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmImeSup1NImpexp::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmImeSup1NImpexp::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmImeSup1NImpexp::StgIac::JNUM)) {
...
void PnlWznmImeSup1NImpexp::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
	...
	if (statshr.ButViewAvail && statshr.ButViewActive) {
		if (xchg->getIxPreset(VecWznmVPreset::PREWZNMIXCRDACCIME, jref)) if (ixPre == VecWznmVPreset::PREWZNMREFIEX) {
			sref = "CrdWznmIme";
			xchg->triggerIxRefSrefIntvalToRefCall(dbswznm, VecWznmVCall::CALLWZNMCRDOPEN, jref, ixPre, refPre, sref, recIme.ref, jrefNew);
		};
		if (jrefNew == 0) {
...
void PnlWznmImeSup1NImpexp::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmImeSup1NImpexp::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmImeSup1NImpexp::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
