...
#define VecVQryWznmImeListOrd QryWznmImeList::VecVOrd

#define StatAppQryWznmImeList QryWznmImeList::StatApp
#define StatShrQryWznmImeList QryWznmImeList::StatShr
#define StgIacQryWznmImeList QryWznmImeList::StgIac

/**
	* QryWznmImeList
	*/
class QryWznmImeList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmImeListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmImeList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmImeList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmImeList)
		*/
...
public:
	QryWznmImeList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmImeList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::ubigint preIex, const Sbecore::ubigint preSup, const Sbecore::ubigint preTbl, const bool addwhere);
	...
	WznmQImeList* getRecByJnum(const Sbecore::uint jnum);
