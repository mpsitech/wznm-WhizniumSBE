...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::MIND, const bool LstReaAlt = true, const bool LstWriAlt = true, const Sbecore::uint LstReaNumFirstdisp = 1, const Sbecore::uint LstWriNumFirstdisp = 1);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFLstRea = NULL, Sbecore::Feed* feedFLstWri = NULL, Sbecore::Feed* feedFPupRet = NULL, Sbecore::Feed* feedFPupTyp = NULL, StatShr* statshr = NULL, const std::set<Sbecore::uint>& mask = {NONE});

	public:
		ContIac contiac;
		ContInf continf;
		Sbecore::Feed feedFLstRea;
		Sbecore::Feed feedFLstWri;
