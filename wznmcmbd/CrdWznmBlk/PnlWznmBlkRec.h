...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneAItem = false, const bool initdone1NRtdpch = false, const bool initdoneRef1NRtblock = false);
