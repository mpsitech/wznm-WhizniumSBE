/**
	...
	* job handler for job PnlWznmBlkAItem (declarations)
...
/**
	* PnlWznmBlkAItem
	*/
class PnlWznmBlkAItem : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQBlkAItem* rst = NULL, QryWznmBlkAItem::StatShr* statshrqry = NULL, QryWznmBlkAItem::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmBlkAItem(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmBlkAItem();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmBlkAItem::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
