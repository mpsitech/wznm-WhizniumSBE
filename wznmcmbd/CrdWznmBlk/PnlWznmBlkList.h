/**
	* \file PnlWznmBlkList.h
	* job handler for job PnlWznmBlkList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 11 Jul 2020
	* \date modified: 11 Jul 2020
	*/

#ifndef PNLWZNMBLKLIST_H
#define PNLWZNMBLKLIST_H
...
#define VecVWznmBlkListDo PnlWznmBlkList::VecVDo

#define ContIacWznmBlkList PnlWznmBlkList::ContIac
#define ContInfWznmBlkList PnlWznmBlkList::ContInf
#define StatShrWznmBlkList PnlWznmBlkList::StatShr
#define StgIacWznmBlkList PnlWznmBlkList::StgIac
#define TagWznmBlkList PnlWznmBlkList::Tag

#define DpchAppWznmBlkListData PnlWznmBlkList::DpchAppData
#define DpchAppWznmBlkListDo PnlWznmBlkList::DpchAppDo
#define DpchEngWznmBlkListData PnlWznmBlkList::DpchEngData

/**
	* PnlWznmBlkList
	*/
class PnlWznmBlkList : public JobWznm {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoRetWidth = 100, const Sbecore::uint TcoReuWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQBlkList* rst = NULL, QryWznmBlkList::StatShr* statshrqry = NULL, QryWznmBlkList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmBlkList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmBlkList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmBlkList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
