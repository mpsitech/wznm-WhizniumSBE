/**
	* \file PnlWznmBlkAItem_blks.cpp
	* job handler for job PnlWznmBlkAItem (implementation of blocks)
...
void PnlWznmBlkAItem::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmBlkAItem";
...
void PnlWznmBlkAItem::StatApp::writeXML(
	...
	else itemtag = "StatitemAppWznmBlkAItem";
...
void PnlWznmBlkAItem::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmBlkAItem";
...
bool PnlWznmBlkAItem::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmBlkAItem"];}();
...
void PnlWznmBlkAItem::StgIac::writeJSON(
	...
	me["TcoFedWidth"] = (Json::Value::UInt) TcoFedWidth;
	me["TcoTblWidth"] = (Json::Value::UInt) TcoTblWidth;
	me["TcoBl2Width"] = (Json::Value::UInt) TcoBl2Width;
...
void PnlWznmBlkAItem::Tag::writeXML(
	...
	else itemtag = "TagitemWznmBlkAItem";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Items");
			...
			writeStringAttr(wr, itemtag, "sref", "TcoCon", "Control");
			writeStringAttr(wr, itemtag, "sref", "TcoVec", "Vector");
			writeStringAttr(wr, itemtag, "sref", "TcoFed", "Feed");
			writeStringAttr(wr, itemtag, "sref", "TcoTbl", "Table");
			writeStringAttr(wr, itemtag, "sref", "TcoBl2", "Block");
			writeStringAttr(wr, itemtag, "sref", "TcoDfv", "Def. val.");
...
PnlWznmBlkAItem::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMBLKAITEMDATA)
		{
};
...
void PnlWznmBlkAItem::DpchAppData::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmBlkAItemData"];}();
...
void PnlWznmBlkAItem::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmBlkAItemData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmBlkAItem::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMBLKAITEMDO)
		{
	ixVDo = 0;
};
...
void PnlWznmBlkAItem::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmBlkAItemDo"];}();
...
void PnlWznmBlkAItem::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmBlkAItemDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmBlkAItem::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMBLKAITEMDATA, jref)
		{
...
void PnlWznmBlkAItem::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmBlkAItem::DpchEngData::writeXML(
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmBlkAItemData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmBlkAItem::StatApp::writeXML(wr);
