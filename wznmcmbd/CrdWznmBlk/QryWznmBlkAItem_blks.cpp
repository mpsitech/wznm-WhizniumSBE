/**
	* \file QryWznmBlkAItem_blks.cpp
	* job handler for job QryWznmBlkAItem (implementation of blocks)
...
/******************************************************************************
 class QryWznmBlkAItem::StatApp
 ******************************************************************************/

void QryWznmBlkAItem::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmBlkAItem";
...
void QryWznmBlkAItem::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmBlkAItem";
...
/******************************************************************************
 class QryWznmBlkAItem::StatShr
 ******************************************************************************/

QryWznmBlkAItem::StatShr::StatShr(
			const uint ntot
...
void QryWznmBlkAItem::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmBlkAItem";
...
void QryWznmBlkAItem::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmBlkAItem";
...
set<uint> QryWznmBlkAItem::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWznmBlkAItem::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWznmBlkAItem::StgIac
 ******************************************************************************/

QryWznmBlkAItem::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWznmBlkAItem::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmBlkAItem"];}();
...
bool QryWznmBlkAItem::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWznmBlkAItem");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWznmBlkAItem";
...
void QryWznmBlkAItem::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWznmBlkAItem";
...
void QryWznmBlkAItem::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWznmBlkAItem";
...
set<uint> QryWznmBlkAItem::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWznmBlkAItem::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
