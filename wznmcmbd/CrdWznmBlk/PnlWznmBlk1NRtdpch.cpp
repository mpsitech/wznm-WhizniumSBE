/**
	...
	* job handler for job PnlWznmBlk1NRtdpch (implementation)
...
#include "PnlWznmBlk1NRtdpch_blks.cpp"
...
/******************************************************************************
 class PnlWznmBlk1NRtdpch
 ******************************************************************************/

PnlWznmBlk1NRtdpch::PnlWznmBlk1NRtdpch(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMBLK1NRTDPCH, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmBlk1NRtdpch(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmBlk1NRtdpch::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmBlk1NRtdpch::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmBlk1NRtdpch::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmBlk1NRtdpch::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMBLK1NRTDPCHDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMBLK1NRTDPCHDO) {
...
void PnlWznmBlk1NRtdpch::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmBlk1NRtdpch::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmBlk1NRtdpch::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmBlk1NRtdpch::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQBlk1NRtdpch* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmBlk1NRtdpch::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmBlk1NRtdpch::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmBlk1NRtdpch::StgIac::JNUM)) {
...
void PnlWznmBlk1NRtdpch::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmBlk1NRtdpch::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmBlk1NRtdpch::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
