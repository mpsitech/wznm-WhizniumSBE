...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQBlkRef1NRtblock* rst = NULL, QryWznmBlkRef1NRtblock::StatShr* statshrqry = NULL, QryWznmBlkRef1NRtblock::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
