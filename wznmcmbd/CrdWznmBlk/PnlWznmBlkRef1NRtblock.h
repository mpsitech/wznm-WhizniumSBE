/**
	...
	* job handler for job PnlWznmBlkRef1NRtblock (declarations)
...
/**
	...
	*/
class PnlWznmBlkRef1NRtblock : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQBlkRef1NRtblock* rst = NULL, QryWznmBlkRef1NRtblock::StatShr* statshrqry = NULL, QryWznmBlkRef1NRtblock::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmBlkRef1NRtblock(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmBlkRef1NRtblock();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmBlkRef1NRtblock::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
