...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StgIac* stgiac = NULL, ListWznmQBlk1NRtdpch* rst = NULL, QryWznmBlk1NRtdpch::StatShr* statshrqry = NULL, QryWznmBlk1NRtdpch::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
