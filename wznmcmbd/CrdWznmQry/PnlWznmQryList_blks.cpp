/**
	* \file PnlWznmQryList_blks.cpp
	* job handler for job PnlWznmQryList (implementation of blocks)
...
/******************************************************************************
 class PnlWznmQryList::VecVDo
 ******************************************************************************/

uint PnlWznmQryList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmQryList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmQryList::ContIac
 ******************************************************************************/

PnlWznmQryList::ContIac::ContIac(
			const uint numFTos
		) :
			Block()
			, numFTos(numFTos)
...
bool PnlWznmQryList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmQryList"];}();
...
bool PnlWznmQryList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacWznmQryList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacWznmQryList";
...
void PnlWznmQryList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContIacWznmQryList";
...
void PnlWznmQryList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemIacWznmQryList";
...
set<uint> PnlWznmQryList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryList::ContInf
 ******************************************************************************/

PnlWznmQryList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlWznmQryList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmQryList";
...
void PnlWznmQryList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmQryList";
...
set<uint> PnlWznmQryList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryList::StatShr
 ******************************************************************************/

PnlWznmQryList::StatShr::StatShr(
...
void PnlWznmQryList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmQryList";
...
void PnlWznmQryList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmQryList";
...
set<uint> PnlWznmQryList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryList::StgIac
 ******************************************************************************/

PnlWznmQryList::StgIac::StgIac(
			...
			, TcoSrlWidth(TcoSrlWidth)
			, TcoTblWidth(TcoTblWidth)
			, TcoQtbWidth(TcoQtbWidth)
		{
	mask = {TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOQTBWIDTH};
};

bool PnlWznmQryList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmQryList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoSrlWidth")) {TcoSrlWidth = me["TcoSrlWidth"].asUInt(); add(TCOSRLWIDTH);};
		if (me.isMember("TcoTblWidth")) {TcoTblWidth = me["TcoTblWidth"].asUInt(); add(TCOTBLWIDTH);};
		if (me.isMember("TcoQtbWidth")) {TcoQtbWidth = me["TcoQtbWidth"].asUInt(); add(TCOQTBWIDTH);};
	};

	return basefound;
};

bool PnlWznmQryList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmQryList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacWznmQryList";
	...
	if (basefound) {
		...
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Si", "sref", "TcoQtbWidth", TcoQtbWidth)) add(TCOQTBWIDTH);
	};

	return basefound;
};

void PnlWznmQryList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmQryList";
	...
	me["TcoSrlWidth"] = (Json::Value::UInt) TcoSrlWidth;
	me["TcoTblWidth"] = (Json::Value::UInt) TcoTblWidth;
	me["TcoQtbWidth"] = (Json::Value::UInt) TcoQtbWidth;
};

void PnlWznmQryList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacWznmQryList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		...
		writeUintAttr(wr, itemtag, "sref", "TcoQtbWidth", TcoQtbWidth);
	xmlTextWriterEndElement(wr);
};

set<uint> PnlWznmQryList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
	...
	if (TcoQtbWidth == comp->TcoQtbWidth) insert(items, TCOQTBWIDTH);

	return(items);
};

set<uint> PnlWznmQryList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOTYPWIDTH, TCOVERWIDTH, TCOSUPWIDTH, TCOSRLWIDTH, TCOTBLWIDTH, TCOQTBWIDTH};
	for (auto it = commitems.begin(); it != commitems.end(); it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlWznmQryList::Tag
 ******************************************************************************/

void PnlWznmQryList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmQryList";
	...
	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		...
		me["TcoTyp"] = "Type";
		me["TcoVer"] = "Version";
		me["TcoSup"] = "Super query";
		me["TcoSrl"] = "Role of sub";
		me["TcoTbl"] = "Main src. tbl.";
		me["TcoQtb"] = "Table";
	};
...
void PnlWznmQryList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmQryList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoSup", "Super query");
			writeStringAttr(wr, itemtag, "sref", "TcoSrl", "Role of sub");
			writeStringAttr(wr, itemtag, "sref", "TcoTbl", "Main src. tbl.");
			writeStringAttr(wr, itemtag, "sref", "TcoQtb", "Table");
		};
...
/******************************************************************************
 class PnlWznmQryList::DpchAppData
 ******************************************************************************/

PnlWznmQryList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMQRYLISTDATA)
		{
};

string PnlWznmQryList::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmQryListData"];}();
...
void PnlWznmQryList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmQryListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmQryList::DpchAppDo
 ******************************************************************************/

PnlWznmQryList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMQRYLISTDO)
		{
	ixVDo = 0;
};

string PnlWznmQryList::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmQryListDo"];}();
...
void PnlWznmQryList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmQryListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmQryList::DpchEngData
 ******************************************************************************/

PnlWznmQryList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, QryWznmQryList::StatShr* statshrqry
			, QryWznmQryList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMQRYLISTDATA, jref)
		{
...
string PnlWznmQryList::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmQryList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmQryListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmQryList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmQryList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmQryListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmQryList::StatApp::writeXML(wr);
