/**
	...
	* job handler for job PnlWznmQryMNTable (implementation)
...
#include "PnlWznmQryMNTable_blks.cpp"
#include "PnlWznmQryMNTable_evals.cpp"
...
/******************************************************************************
 class PnlWznmQryMNTable
 ******************************************************************************/

PnlWznmQryMNTable::PnlWznmQryMNTable(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMQRYMNTABLE, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmQryMNTable(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmQryMNTable::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmQryMNTable::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmQryMNTable::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmQryMNTable::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYMNTABLEDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYMNTABLEDO) {
...
void PnlWznmQryMNTable::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmQryMNTable::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryMNTable::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmQryMNTable::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQQryMNTable* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmQryMNTable::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmQryMNTable::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmQryMNTable::StgIac::JNUM)) {
...
void PnlWznmQryMNTable::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryMNTable::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryMNTable::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmQryMNTable::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmQryMNTable::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
