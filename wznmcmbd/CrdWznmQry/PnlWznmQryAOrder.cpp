/**
	...
	* job handler for job PnlWznmQryAOrder (implementation)
...
#include "PnlWznmQryAOrder_blks.cpp"
#include "PnlWznmQryAOrder_evals.cpp"
...
/******************************************************************************
 class PnlWznmQryAOrder
 ******************************************************************************/

PnlWznmQryAOrder::PnlWznmQryAOrder(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMQRYAORDER, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmQryAOrder(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmQryAOrder::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmQryAOrder::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmQryAOrder::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYAORDERDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYAORDERDO) {
...
void PnlWznmQryAOrder::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmQryAOrder::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryAOrder::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmQryAOrder::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQQryAOrder* recSelNew = NULL;

	WznmAMQueryOrder* _recQryAord = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmQryAOrder::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmQryAOrder::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmQryAOrder::StgIac::JNUM)) {
			if (!recSelNew) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

			recQryAord = WznmAMQueryOrder();

			if (recSelNew) {
				if (dbswznm->tblwznmamqueryorder->loadRecByRef(recSelNew->ref, &_recQryAord)) {
					recQryAord = *_recQryAord;
					delete _recQryAord;
				};
			};
...
void PnlWznmQryAOrder::handleDpchAppDoButNewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryAOrder::handleDpchAppDoButDuplicateClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryAOrder::handleDpchAppDoButDeleteClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQryAOrder::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmQryAOrder::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmQryAOrder::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
