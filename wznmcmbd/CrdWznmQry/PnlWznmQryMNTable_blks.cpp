/**
	* \file PnlWznmQryMNTable_blks.cpp
	* job handler for job PnlWznmQryMNTable (implementation of blocks)
...
/******************************************************************************
 class PnlWznmQryMNTable::VecVDo
 ******************************************************************************/

uint PnlWznmQryMNTable::VecVDo::getIx(
			const string& sref
		) {
...
string PnlWznmQryMNTable::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlWznmQryMNTable::ContInf
 ******************************************************************************/

PnlWznmQryMNTable::ContInf::ContInf(
...
void PnlWznmQryMNTable::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmQryMNTable";
...
void PnlWznmQryMNTable::ContInf::writeXML(
	...
	else itemtag = "ContitemInfWznmQryMNTable";
...
set<uint> PnlWznmQryMNTable::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryMNTable::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryMNTable::StatApp
 ******************************************************************************/

void PnlWznmQryMNTable::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmQryMNTable";
...
void PnlWznmQryMNTable::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmQryMNTable";
...
/******************************************************************************
 class PnlWznmQryMNTable::StatShr
 ******************************************************************************/

PnlWznmQryMNTable::StatShr::StatShr(
...
void PnlWznmQryMNTable::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmQryMNTable";
...
void PnlWznmQryMNTable::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmQryMNTable";
...
set<uint> PnlWznmQryMNTable::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryMNTable::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryMNTable::StgIac
 ******************************************************************************/

PnlWznmQryMNTable::StgIac::StgIac(
...
bool PnlWznmQryMNTable::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmQryMNTable"];}();

	basefound = (me != Json::nullValue);

	if (basefound) {
		if (me.isMember("TcoMrefWidth")) {TcoMrefWidth = me["TcoMrefWidth"].asUInt(); add(TCOMREFWIDTH);};
		if (me.isMember("TcoTqmdWidth")) {TcoTqmdWidth = me["TcoTqmdWidth"].asUInt(); add(TCOTQMDWIDTH);};
		if (me.isMember("TcoSrcWidth")) {TcoSrcWidth = me["TcoSrcWidth"].asUInt(); add(TCOSRCWIDTH);};
		if (me.isMember("TcoPfxWidth")) {TcoPfxWidth = me["TcoPfxWidth"].asUInt(); add(TCOPFXWIDTH);};
	};

	return basefound;
};

bool PnlWznmQryMNTable::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacWznmQryMNTable");
	else
...
void PnlWznmQryMNTable::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacWznmQryMNTable";
...
set<uint> PnlWznmQryMNTable::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlWznmQryMNTable::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWznmQryMNTable::Tag
 ******************************************************************************/

void PnlWznmQryMNTable::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmQryMNTable";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Source tables";
		me["TcoMref"] = "Table";
		me["TcoTqmd"] = "Query modifiers";
		me["TcoSrc"] = "Source";
		me["TcoPfx"] = "Prefix";
	};
...
void PnlWznmQryMNTable::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmQryMNTable";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Source tables");
			writeStringAttr(wr, itemtag, "sref", "TcoMref", "Table");
			writeStringAttr(wr, itemtag, "sref", "TcoTqmd", "Query modifiers");
			writeStringAttr(wr, itemtag, "sref", "TcoSrc", "Source");
...
/******************************************************************************
 class PnlWznmQryMNTable::DpchAppData
 ******************************************************************************/

PnlWznmQryMNTable::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMQRYMNTABLEDATA)
		{
};

string PnlWznmQryMNTable::DpchAppData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryMNTable::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmQryMNTableData"];}();
...
void PnlWznmQryMNTable::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmQryMNTableData");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmQryMNTable::DpchAppDo
 ******************************************************************************/

PnlWznmQryMNTable::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMQRYMNTABLEDO)
		{
	ixVDo = 0;
};

string PnlWznmQryMNTable::DpchAppDo::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryMNTable::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmQryMNTableDo"];}();
...
void PnlWznmQryMNTable::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmQryMNTableDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlWznmQryMNTable::DpchEngData
 ******************************************************************************/

PnlWznmQryMNTable::DpchEngData::DpchEngData(
			const ubigint jref
			, ContInf* continf
			, Feed* feedFCsiQst
			, StatShr* statshr
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMQRYMNTABLEDATA, jref)
		{
...
string PnlWznmQryMNTable::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWznmQryMNTable::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmQryMNTable::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmQryMNTableData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmQryMNTable::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmQryMNTable::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmQryMNTableData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmQryMNTable::StatApp::writeXML(wr);
