/**
	* \file QryWznmQrySup1NQuery_blks.cpp
	* job handler for job QryWznmQrySup1NQuery (implementation of blocks)
...
void QryWznmQrySup1NQuery::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmQrySup1NQuery";
...
void QryWznmQrySup1NQuery::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmQrySup1NQuery";
...
void QryWznmQrySup1NQuery::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmQrySup1NQuery";
...
void QryWznmQrySup1NQuery::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmQrySup1NQuery";
...
bool QryWznmQrySup1NQuery::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmQrySup1NQuery"];}();
...
void QryWznmQrySup1NQuery::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
