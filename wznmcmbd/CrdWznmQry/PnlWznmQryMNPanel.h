...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQQryMNPanel* rst = NULL, QryWznmQryMNPanel::StatShr* statshrqry = NULL, QryWznmQryMNPanel::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
