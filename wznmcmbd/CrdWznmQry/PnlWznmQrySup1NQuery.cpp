/**
	...
	* job handler for job PnlWznmQrySup1NQuery (implementation)
...
#include "PnlWznmQrySup1NQuery_blks.cpp"
#include "PnlWznmQrySup1NQuery_evals.cpp"
...
/******************************************************************************
 class PnlWznmQrySup1NQuery
 ******************************************************************************/

PnlWznmQrySup1NQuery::PnlWznmQrySup1NQuery(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMQRYSUP1NQUERY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmQrySup1NQuery(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmQrySup1NQuery::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmQrySup1NQuery::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmQrySup1NQuery::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmQrySup1NQuery::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYSUP1NQUERYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMQRYSUP1NQUERYDO) {
...
void PnlWznmQrySup1NQuery::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmQrySup1NQuery::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmQrySup1NQuery::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmQrySup1NQuery::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQQrySup1NQuery* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmQrySup1NQuery::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmQrySup1NQuery::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmQrySup1NQuery::StgIac::JNUM)) {
...
void PnlWznmQrySup1NQuery::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmQrySup1NQuery::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmQrySup1NQuery::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmQrySup1NQuery::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
