/**
	* \file PnlWznmQryQry1NQuerycol.h
	* job handler for job PnlWznmQryQry1NQuerycol (declarations)
...
#ifndef PNLWZNMQRYQRY1NQUERYCOL_H
#define PNLWZNMQRYQRY1NQUERYCOL_H
...
#define VecVWznmQryQry1NQuerycolDo PnlWznmQryQry1NQuerycol::VecVDo

#define ContInfWznmQryQry1NQuerycol PnlWznmQryQry1NQuerycol::ContInf
#define StatAppWznmQryQry1NQuerycol PnlWznmQryQry1NQuerycol::StatApp
#define StatShrWznmQryQry1NQuerycol PnlWznmQryQry1NQuerycol::StatShr
#define StgIacWznmQryQry1NQuerycol PnlWznmQryQry1NQuerycol::StgIac
#define TagWznmQryQry1NQuerycol PnlWznmQryQry1NQuerycol::Tag

#define DpchAppWznmQryQry1NQuerycolData PnlWznmQryQry1NQuerycol::DpchAppData
#define DpchAppWznmQryQry1NQuerycolDo PnlWznmQryQry1NQuerycol::DpchAppDo
#define DpchEngWznmQryQry1NQuerycolData PnlWznmQryQry1NQuerycol::DpchEngData

/**
	* PnlWznmQryQry1NQuerycol
	*/
class PnlWznmQryQry1NQuerycol : public JobWznm {

public:
	/**
		* VecVDo (full: VecVWznmQryQry1NQuerycolDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWznmQryQry1NQuerycol)
	  */
	...
	/**
		* StatApp (full: StatAppWznmQryQry1NQuerycol)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrWznmQryQry1NQuerycol)
		*/
	...
	/**
		* StgIac (full: StgIacWznmQryQry1NQuerycol)
		*/
	...
	/**
		* Tag (full: TagWznmQryQry1NQuerycol)
		*/
	class Tag {
	...
	/**
		* DpchAppData (full: DpchAppWznmQryQry1NQuerycolData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWznmQryQry1NQuerycolDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWznmQryQry1NQuerycolData)
		*/
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQQryQry1NQuerycol* rst = NULL, QryWznmQryQry1NQuerycol::StatShr* statshrqry = NULL, QryWznmQryQry1NQuerycol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmQryQry1NQuerycol(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmQryQry1NQuerycol();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmQryQry1NQuerycol::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
