...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQQryQry1NQuerycol* rst = NULL, QryWznmQryQry1NQuerycol::StatShr* statshrqry = NULL, QryWznmQryQry1NQuerycol::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
