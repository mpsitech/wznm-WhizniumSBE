...
#define QRYWZNMQRYMNDIALOG_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWznmQryMNDialog QryWznmQryMNDialog::StatApp
#define StatShrQryWznmQryMNDialog QryWznmQryMNDialog::StatShr
#define StgIacQryWznmQryMNDialog QryWznmQryMNDialog::StgIac

/**
	* QryWznmQryMNDialog
	*/
class QryWznmQryMNDialog : public JobWznm {
...
public:
	QryWznmQryMNDialog(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmQryMNDialog();
...
public:
	...
	WznmQQryMNDialog* getRecByJnum(const Sbecore::uint jnum);
