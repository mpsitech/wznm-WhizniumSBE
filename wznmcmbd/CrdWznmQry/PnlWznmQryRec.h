...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdoneAClause = false, const bool initdoneAOrder = false, const bool initdoneQry1NQuerycol = false, const bool initdone1NQuerymod = false, const bool initdoneSup1NQuery = false, const bool initdoneMNTable = false, const bool initdoneMNPanel = false, const bool initdoneMNDialog = false);
	...
	public:
		...
		static const Sbecore::uint JREFQRY1NQUERYCOL = 5;
	...
	public:
		StatShr(const Sbecore::uint ixWznmVExpstate = VecWznmVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jrefAClause = 0, const Sbecore::ubigint jrefAOrder = 0, const Sbecore::ubigint jrefQry1NQuerycol = 0, const Sbecore::ubigint jref1NQuerymod = 0, const Sbecore::ubigint jrefSup1NQuery = 0, const Sbecore::ubigint jrefMNTable = 0, const Sbecore::ubigint jrefMNPanel = 0, const Sbecore::ubigint jrefMNDialog = 0, const bool ButRegularizeActive = true);
