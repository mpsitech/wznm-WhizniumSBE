/**
	* \file PnlWznmQryList.h
	* job handler for job PnlWznmQryList (declarations)
	* \author Alexander Wirthmueller
	* \date created: 27 Aug 2020
	* \date modified: 27 Aug 2020
	*/

#ifndef PNLWZNMQRYLIST_H
#define PNLWZNMQRYLIST_H
...
#define VecVWznmQryListDo PnlWznmQryList::VecVDo

#define ContIacWznmQryList PnlWznmQryList::ContIac
#define ContInfWznmQryList PnlWznmQryList::ContInf
#define StatShrWznmQryList PnlWznmQryList::StatShr
#define StgIacWznmQryList PnlWznmQryList::StgIac
#define TagWznmQryList PnlWznmQryList::Tag

#define DpchAppWznmQryListData PnlWznmQryList::DpchAppData
#define DpchAppWznmQryListDo PnlWznmQryList::DpchAppDo
#define DpchEngWznmQryListData PnlWznmQryList::DpchEngData

/**
	* PnlWznmQryList
	*/
class PnlWznmQryList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOSUPWIDTH = 4;
		static const Sbecore::uint TCOSRLWIDTH = 5;
		static const Sbecore::uint TCOTBLWIDTH = 6;
		static const Sbecore::uint TCOQTBWIDTH = 7;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoVerWidth = 100, const Sbecore::uint TcoSupWidth = 100, const Sbecore::uint TcoSrlWidth = 100, const Sbecore::uint TcoTblWidth = 100, const Sbecore::uint TcoQtbWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQQryList* rst = NULL, QryWznmQryList::StatShr* statshrqry = NULL, QryWznmQryList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmQryList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmQryList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmQryList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
