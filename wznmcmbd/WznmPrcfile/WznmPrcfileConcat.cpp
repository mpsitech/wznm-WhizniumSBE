/**
	* \file WznmPrcfileConcat.cpp
	* Wznm operation processor - concatenate text from multiple input files into output file (implementation)
...
DpchRetWznm* WznmPrcfileConcat::run(
			XchgWznm* xchg
			, DbsWznm* dbswznm
