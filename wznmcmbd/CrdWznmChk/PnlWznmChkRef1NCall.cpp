...
#include "PnlWznmChkRef1NCall_blks.cpp"
#include "PnlWznmChkRef1NCall_evals.cpp"
...
/******************************************************************************
 class PnlWznmChkRef1NCall
 ******************************************************************************/

PnlWznmChkRef1NCall::PnlWznmChkRef1NCall(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMCHKREF1NCALL, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmChkRef1NCall(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmChkRef1NCall::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmChkRef1NCall::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCHKREF1NCALLDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMCHKREF1NCALLDO) {
...
void PnlWznmChkRef1NCall::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmChkRef1NCall::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmChkRef1NCall::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmChkRef1NCall::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQChkRef1NCall* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (!has(diffitems, QryWznmChkRef1NCall::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmChkRef1NCall::StgIac::JNUM)) {
...
void PnlWznmChkRef1NCall::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmChkRef1NCall::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmChkRef1NCall::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmChkRef1NCall::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
