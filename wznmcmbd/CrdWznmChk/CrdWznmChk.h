/**
	* \file CrdWznmChk.h
	* job handler for job CrdWznmChk (declarations)
...
#define VecVWznmChkDo CrdWznmChk::VecVDo
#define VecVWznmChkSge CrdWznmChk::VecVSge

#define ContInfWznmChk CrdWznmChk::ContInf
#define StatAppWznmChk CrdWznmChk::StatApp
#define StatShrWznmChk CrdWznmChk::StatShr
#define TagWznmChk CrdWznmChk::Tag

#define DpchAppWznmChkDo CrdWznmChk::DpchAppDo
#define DpchEngWznmChkData CrdWznmChk::DpchEngData

/**
	* CrdWznmChk
	*/
class CrdWznmChk : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDCHK = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdChk = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdChk;
...
public:
	CrdWznmChk(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmChk();
...
public:
	...
	PnlWznmChkList* pnllist;
	PnlWznmChkHeadbar* pnlheadbar;
	PnlWznmChkRec* pnlrec;
