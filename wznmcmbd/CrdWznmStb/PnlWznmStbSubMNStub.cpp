/**
	...
	* job handler for job PnlWznmStbSubMNStub (implementation)
...
#include "PnlWznmStbSubMNStub_blks.cpp"
#include "PnlWznmStbSubMNStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmStbSubMNStub
 ******************************************************************************/

PnlWznmStbSubMNStub::PnlWznmStbSubMNStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSTBSUBMNSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmStbSubMNStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmStbSubMNStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmStbSubMNStub::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmStbSubMNStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmStbSubMNStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBSUBMNSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBSUBMNSTUBDO) {
...
void PnlWznmStbSubMNStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmStbSubMNStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSubMNStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmStbSubMNStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQStbSubMNStub* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmStbSubMNStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmStbSubMNStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmStbSubMNStub::StgIac::JNUM)) {
...
void PnlWznmStbSubMNStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmStbSubMNStub::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSubMNStub::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSubMNStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmStbSubMNStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmStbSubMNStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
