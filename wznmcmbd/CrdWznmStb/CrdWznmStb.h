/**
	* \file CrdWznmStb.h
	* job handler for job CrdWznmStb (declarations)
...
#define VecVWznmStbDo CrdWznmStb::VecVDo
#define VecVWznmStbSge CrdWznmStb::VecVSge

#define ContInfWznmStb CrdWznmStb::ContInf
#define StatAppWznmStb CrdWznmStb::StatApp
#define StatShrWznmStb CrdWznmStb::StatShr
#define TagWznmStb CrdWznmStb::Tag

#define DpchAppWznmStbDo CrdWznmStb::DpchAppDo
#define DpchEngWznmStbData CrdWznmStb::DpchEngData

/**
	* CrdWznmStb
	*/
class CrdWznmStb : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSTB = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdStb = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdStb;
...
public:
	CrdWznmStb(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmStb();
...
public:
	...
	PnlWznmStbRec* pnlrec;
	PnlWznmStbHeadbar* pnlheadbar;
	PnlWznmStbList* pnllist;
