...
PnlWznmStbRec::StatShr::StatShr(
			...
			, jrefSupMNStub(jrefSupMNStub)
			, jrefSubMNStub(jrefSubMNStub)
			, jrefMNSquawk(jrefMNSquawk)
			, jrefMNCall(jrefMNCall)
...
void PnlWznmStbRec::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmStbRecDo"];}();
