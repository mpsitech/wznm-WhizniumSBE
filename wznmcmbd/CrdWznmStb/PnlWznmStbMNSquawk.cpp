...
#include "PnlWznmStbMNSquawk_blks.cpp"
#include "PnlWznmStbMNSquawk_evals.cpp"
...
/******************************************************************************
 class PnlWznmStbMNSquawk
 ******************************************************************************/

PnlWznmStbMNSquawk::PnlWznmStbMNSquawk(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSTBMNSQUAWK, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmStbMNSquawk(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmStbMNSquawk::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmStbMNSquawk::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmStbMNSquawk::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmStbMNSquawk::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBMNSQUAWKDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBMNSQUAWKDO) {
...
void PnlWznmStbMNSquawk::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmStbMNSquawk::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbMNSquawk::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmStbMNSquawk::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQStbMNSquawk* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmStbMNSquawk::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmStbMNSquawk::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmStbMNSquawk::StgIac::JNUM)) {
			...
			if (recSelNew) {
				...
				if (dbswznm->tblwznmmsquawk->loadRecByRef(recSelNew->mref, &_recSqk)) {
					recSqk = *_recSqk;
					delete _recSqk;
				};
			};
...
void PnlWznmStbMNSquawk::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmStbMNSquawk::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbMNSquawk::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbMNSquawk::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmStbMNSquawk::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmStbMNSquawk::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
