/**
	* \file PnlWznmStbList_blks.cpp
	* job handler for job PnlWznmStbList (implementation of blocks)
...
bool PnlWznmStbList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWznmStbList"];}();
...
void PnlWznmStbList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmStbList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmStbList";
...
void PnlWznmStbList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWznmStbList";
...
void PnlWznmStbList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmStbList";
...
void PnlWznmStbList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWznmStbList";
...
bool PnlWznmStbList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmStbList"];}();
	...
	if (basefound) {
		...
		if (me.isMember("TcoExaWidth")) {TcoExaWidth = me["TcoExaWidth"].asUInt(); add(TCOEXAWIDTH);};
	};
...
void PnlWznmStbList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	...
	me["TcoExaWidth"] = (Json::Value::UInt) TcoExaWidth;
};
...
void PnlWznmStbList::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmStbList";
...
void PnlWznmStbList::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmStbList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoExa", "Example");
		};
...
PnlWznmStbList::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBLISTDATA)
		{
};
...
void PnlWznmStbList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmStbListData"];}();
...
void PnlWznmStbList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmStbListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmStbList::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWznmStbList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmStbListDo"];}();
...
void PnlWznmStbList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmStbListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmStbList::DpchEngData::DpchEngData(
			...
			, QryWznmStbList::StatShr* statshrqry
			, QryWznmStbList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSTBLISTDATA, jref)
		{
...
void PnlWznmStbList::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmStbList::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmStbListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmStbList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmStbList::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmStbListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmStbList::StatApp::writeXML(wr);
