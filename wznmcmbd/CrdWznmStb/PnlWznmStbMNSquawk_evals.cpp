...
bool PnlWznmStbMNSquawk::evalButViewAvail(
	...
	// !sel()|((pre.ixCrdaccOpk()&pre.refVer())|(pre.ixCrdaccSge()&pre.refVer())|(pre.ixCrdaccOpx()&pre.refVer()))
...
bool PnlWznmStbMNSquawk::evalButViewActive(
			DbsWznm* dbswznm
		) {
	// sel()
...
bool PnlWznmStbMNSquawk::evalButAddAvail(
			DbsWznm* dbswznm
		) {
...
bool PnlWznmStbMNSquawk::evalButSubAvail(
			DbsWznm* dbswznm
		) {
	// pre.ixCrdaccStbIncl(edit)
...
bool PnlWznmStbMNSquawk::evalButSubActive(
			DbsWznm* dbswznm
		) {
	// sel()
