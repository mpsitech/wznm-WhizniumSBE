...
void QryWznmStbList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWznmStbList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWznmStbList";
...
void QryWznmStbList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWznmStbList";
...
void QryWznmStbList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWznmStbList";
...
void QryWznmStbList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWznmStbList";
...
bool QryWznmStbList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWznmStbList"];}();
...
void QryWznmStbList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
