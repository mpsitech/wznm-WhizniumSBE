...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQStbSupMNStub* rst = NULL, QryWznmStbSupMNStub::StatShr* statshrqry = NULL, QryWznmStbSupMNStub::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
