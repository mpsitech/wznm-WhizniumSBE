/**
	* \file PnlWznmStbSupMNStub.cpp
	* job handler for job PnlWznmStbSupMNStub (implementation)
...
#include "PnlWznmStbSupMNStub_blks.cpp"
#include "PnlWznmStbSupMNStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmStbSupMNStub
 ******************************************************************************/

PnlWznmStbSupMNStub::PnlWznmStbSupMNStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSTBSUPMNSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmStbSupMNStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmStbSupMNStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmStbSupMNStub::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
			, const bool unmute
		) {
...
void PnlWznmStbSupMNStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmStbSupMNStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBSUPMNSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSTBSUPMNSTUBDO) {
...
void PnlWznmStbSupMNStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmStbSupMNStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSupMNStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmStbSupMNStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQStbSupMNStub* recSelNew = NULL;

	WznmRMStubMStub* _recStbRstb = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmStbSupMNStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmStbSupMNStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmStbSupMNStub::StgIac::JNUM)) {
			...
			if (recSelNew) {
				if (dbswznm->tblwznmrmstubmstub->loadRecByRef(recSelNew->ref, &_recStbRstb)) {
					recStbRstb = *_recStbRstb;
					delete _recStbRstb;
				};
...
void PnlWznmStbSupMNStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmStbSupMNStub::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSupMNStub::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmStbSupMNStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmStbSupMNStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmStbSupMNStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
