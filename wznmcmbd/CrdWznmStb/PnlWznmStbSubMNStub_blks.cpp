/**
	* \file PnlWznmStbSubMNStub_blks.cpp
	* job handler for job PnlWznmStbSubMNStub (implementation of blocks)
...
void PnlWznmStbSubMNStub::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWznmStbSubMNStub";
...
void PnlWznmStbSubMNStub::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWznmStbSubMNStub";
...
void PnlWznmStbSubMNStub::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWznmVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWznmStbSubMNStub";
...
void PnlWznmStbSubMNStub::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWznmVExpstate
	...
	else itemtag = "StatitemAppWznmStbSubMNStub";
...
void PnlWznmStbSubMNStub::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWznmStbSubMNStub";
...
void PnlWznmStbSubMNStub::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWznmStbSubMNStub";
...
bool PnlWznmStbSubMNStub::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWznmStbSubMNStub"];}();
...
void PnlWznmStbSubMNStub::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWznmStbSubMNStub::Tag::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWznmStbSubMNStub";

	Json::Value& me = sup[difftag] = Json::Value(Json::objectValue);

	if (ixWznmVLocale == VecWznmVLocale::ENUS) {
		me["Cpt"] = "Included stubs";
		me["TcoMref"] = "Stub";
	};
...
void PnlWznmStbSubMNStub::Tag::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWznmStbSubMNStub";

	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixWznmVLocale == VecWznmVLocale::ENUS) {
			writeStringAttr(wr, itemtag, "sref", "Cpt", "Included stubs");
...
PnlWznmStbSubMNStub::DpchAppData::DpchAppData() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBSUBMNSTUBDATA)
		{
};
...
void PnlWznmStbSubMNStub::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmStbSubMNStubData"];}();
...
void PnlWznmStbSubMNStub::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmStbSubMNStubData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmStbSubMNStub::DpchAppDo::DpchAppDo() :
			DpchAppWznm(VecWznmVDpch::DPCHAPPWZNMSTBSUBMNSTUBDO)
		{
	ixVDo = 0;
};
...
void PnlWznmStbSubMNStub::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWznmStbSubMNStubDo"];}();
...
void PnlWznmStbSubMNStub::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWznmStbSubMNStubDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWznmStbSubMNStub::DpchEngData::DpchEngData(
			...
			DpchEngWznm(VecWznmVDpch::DPCHENGWZNMSTBSUBMNSTUBDATA, jref)
		{
...
void PnlWznmStbSubMNStub::DpchEngData::merge(
			DpchEngWznm* dpcheng
		) {
...
void PnlWznmStbSubMNStub::DpchEngData::writeJSON(
			const uint ixWznmVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWznmStbSubMNStubData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWznmStbSubMNStub::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWznmStbSubMNStub::DpchEngData::writeXML(
			const uint ixWznmVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWznmStbSubMNStubData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wznm");
		...
		if (has(STATAPPQRY)) QryWznmStbSubMNStub::StatApp::writeXML(wr);
