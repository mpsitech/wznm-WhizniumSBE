/**
	* \file PnlWznmStbList.h
	* job handler for job PnlWznmStbList (declarations)
...
#ifndef PNLWZNMSTBLIST_H
#define PNLWZNMSTBLIST_H
...
#define VecVWznmStbListDo PnlWznmStbList::VecVDo

#define ContIacWznmStbList PnlWznmStbList::ContIac
#define ContInfWznmStbList PnlWznmStbList::ContInf
#define StatShrWznmStbList PnlWznmStbList::StatShr
#define StgIacWznmStbList PnlWznmStbList::StgIac
#define TagWznmStbList PnlWznmStbList::Tag

#define DpchAppWznmStbListData PnlWznmStbList::DpchAppData
#define DpchAppWznmStbListDo PnlWznmStbList::DpchAppDo
#define DpchEngWznmStbListData PnlWznmStbList::DpchEngData

/**
	* PnlWznmStbList
	*/
class PnlWznmStbList : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint TCOSBSWIDTH = 4;
		static const Sbecore::uint TCOEXAWIDTH = 5;

	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTypWidth = 100, const Sbecore::uint TcoTblWidth = 100, const Sbecore::uint TcoSbsWidth = 100, const Sbecore::uint TcoExaWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQStbList* rst = NULL, QryWznmStbList::StatShr* statshrqry = NULL, QryWznmStbList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmStbList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmStbList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmStbList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
