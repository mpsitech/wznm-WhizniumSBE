/**
	...
	* job handler for job PnlWznmSgeSqkMNStub (implementation)
...
#include "PnlWznmSgeSqkMNStub_blks.cpp"
#include "PnlWznmSgeSqkMNStub_evals.cpp"
...
/******************************************************************************
 class PnlWznmSgeSqkMNStub
 ******************************************************************************/

PnlWznmSgeSqkMNStub::PnlWznmSgeSqkMNStub(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSGESQKMNSTUB, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSgeSqkMNStub(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSgeSqkMNStub::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSgeSqkMNStub::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmSgeSqkMNStub::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSgeSqkMNStub::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSGESQKMNSTUBDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSGESQKMNSTUBDO) {
...
void PnlWznmSgeSqkMNStub::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSgeSqkMNStub::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSgeSqkMNStub::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSgeSqkMNStub::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSgeSqkMNStub* recSelNew = NULL;

	WznmRMSquawkMStub* _recSqkRstb = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSgeSqkMNStub::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSgeSqkMNStub::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSgeSqkMNStub::StgIac::JNUM)) {
			...
			if (recSelNew) {
				if (dbswznm->tblwznmrmsquawkmstub->loadRecByRef(recSelNew->ref, &_recSqkRstb)) {
					recSqkRstb = *_recSqkRstb;
					delete _recSqkRstb;
				};
...
void PnlWznmSgeSqkMNStub::handleDpchAppDoButViewClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	ubigint jrefNew = 0;
...
void PnlWznmSgeSqkMNStub::handleDpchAppDoButAddClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSgeSqkMNStub::handleDpchAppDoButSubClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSgeSqkMNStub::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSgeSqkMNStub::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSgeSqkMNStub::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
