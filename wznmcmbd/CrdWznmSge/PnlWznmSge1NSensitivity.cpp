/**
	...
	* job handler for job PnlWznmSge1NSensitivity (implementation)
...
#include "PnlWznmSge1NSensitivity_blks.cpp"
...
/******************************************************************************
 class PnlWznmSge1NSensitivity
 ******************************************************************************/

PnlWznmSge1NSensitivity::PnlWznmSge1NSensitivity(
			XchgWznm* xchg
			, DbsWznm* dbswznm
			, const ubigint jrefSup
			, const uint ixWznmVLocale
		) :
			JobWznm(xchg, VecWznmVJob::PNLWZNMSGE1NSENSITIVITY, jrefSup, ixWznmVLocale)
		{
	...
	qry = new QryWznmSge1NSensitivity(xchg, dbswznm, jref, ixWznmVLocale);
...
DpchEngWznm* PnlWznmSge1NSensitivity::getNewDpchEng(
			set<uint> items
		) {
...
void PnlWznmSge1NSensitivity::refresh(
			DbsWznm* dbswznm
			, set<uint>& moditems
		) {
...
void PnlWznmSge1NSensitivity::updatePreset(
			DbsWznm* dbswznm
...
void PnlWznmSge1NSensitivity::handleRequest(
			DbsWznm* dbswznm
			, ReqWznm* req
		) {
	if (req->ixVBasetype == ReqWznm::VecVBasetype::CMD) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSGE1NSENSITIVITYDATA) {
		...
		} else if (req->dpchapp->ixWznmVDpch == VecWznmVDpch::DPCHAPPWZNMSGE1NSENSITIVITYDO) {
...
void PnlWznmSge1NSensitivity::handleDpchAppWznmInit(
			DbsWznm* dbswznm
...
void PnlWznmSge1NSensitivity::handleDpchAppDataStgiac(
			DbsWznm* dbswznm
			, StgIac* _stgiac
			, DpchEngWznm** dpcheng
		) {
...
void PnlWznmSge1NSensitivity::handleDpchAppDataStgiacqry(
			DbsWznm* dbswznm
			, QryWznmSge1NSensitivity::StgIac* _stgiacqry
			, DpchEngWznm** dpcheng
		) {
	set<uint> diffitems;
	set<uint> moditems;
	...
	WznmQSge1NSensitivity* recSelNew = NULL;
	...
	if (!diffitems.empty()) {
		...
		if (has(diffitems, QryWznmSge1NSensitivity::StgIac::JNUM)) recSelNew = qry->getRecByJnum(_stgiacqry->jnum);

		if (!has(diffitems, QryWznmSge1NSensitivity::StgIac::JNUM) || (diffitems.size() > 1)) {
			qry->rerun(dbswznm);
			insert(moditems, {DpchEngData::STATSHRQRY, DpchEngData::RST});
		};

		if (has(diffitems, QryWznmSge1NSensitivity::StgIac::JNUM)) {
...
void PnlWznmSge1NSensitivity::handleDpchAppDoButRefreshClick(
			DbsWznm* dbswznm
			, DpchEngWznm** dpcheng
		) {
	set<uint> moditems;
...
void PnlWznmSge1NSensitivity::handleCall(
			DbsWznm* dbswznm
			, Call* call
		) {
...
bool PnlWznmSge1NSensitivity::handleCallWznmStatChg(
			DbsWznm* dbswznm
			, const ubigint jrefTrig
		) {
	bool retval = false;
