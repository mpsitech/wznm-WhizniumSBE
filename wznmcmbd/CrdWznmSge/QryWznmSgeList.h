...
#define QRYWZNMSGELIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWznmSgeListOrd QryWznmSgeList::VecVOrd

#define StatAppQryWznmSgeList QryWznmSgeList::StatApp
#define StatShrQryWznmSgeList QryWznmSgeList::StatShr
#define StgIacQryWznmSgeList QryWznmSgeList::StgIac

/**
	* QryWznmSgeList
	*/
class QryWznmSgeList : public JobWznm {

public:
	/**
		* VecVOrd (full: VecVQryWznmSgeListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryWznmSgeList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryWznmSgeList)
		*/
	...
	/**
		* StgIac (full: StgIacQryWznmSgeList)
		*/
...
public:
	QryWznmSgeList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~QryWznmSgeList();
...
public:
	...
	void rerun_filtSQL(std::string& sqlstr, const std::string& preSrf, const Sbecore::uint preTyp, const Sbecore::ubigint preJob, const bool addwhere);
	...
	WznmQSgeList* getRecByJnum(const Sbecore::uint jnum);
