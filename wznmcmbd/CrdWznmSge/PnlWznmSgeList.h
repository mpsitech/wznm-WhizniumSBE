/**
	...
	* job handler for job PnlWznmSgeList (declarations)
...
/**
	* PnlWznmSgeList
	*/
class PnlWznmSgeList : public JobWznm {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSgeList* rst = NULL, QryWznmSgeList::StatShr* statshrqry = NULL, QryWznmSgeList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWznmSgeList(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale);
	~PnlWznmSgeList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWznm* dbswznm, QryWznmSgeList::StgIac* _stgiacqry, DpchEngWznm** dpcheng);
