...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, Sbecore::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWznmQSgeList* rst = NULL, QryWznmSgeList::StatShr* statshrqry = NULL, QryWznmSgeList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
