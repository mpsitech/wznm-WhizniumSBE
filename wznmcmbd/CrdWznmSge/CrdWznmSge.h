/**
	* \file CrdWznmSge.h
	* job handler for job CrdWznmSge (declarations)
...
#define VecVWznmSgeDo CrdWznmSge::VecVDo
#define VecVWznmSgeSge CrdWznmSge::VecVSge

#define ContInfWznmSge CrdWznmSge::ContInf
#define StatAppWznmSge CrdWznmSge::StatApp
#define StatShrWznmSge CrdWznmSge::StatShr
#define TagWznmSge CrdWznmSge::Tag

#define DpchAppWznmSgeDo CrdWznmSge::DpchAppDo
#define DpchEngWznmSgeData CrdWznmSge::DpchEngData

/**
	* CrdWznmSge
	*/
class CrdWznmSge : public JobWznm {
...
public:
	...
	public:
		...
		static const Sbecore::uint MTXCRDSGE = 3;

	public:
		ContInf(const Sbecore::uint numFSge = 1, const std::string& MrlAppHlp = "", const std::string& MtxCrdSge = "");

	public:
		Sbecore::uint numFSge;
		std::string MrlAppHlp;
		std::string MtxCrdSge;
...
public:
	CrdWznmSge(XchgWznm* xchg, DbsWznm* dbswznm, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWznmVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWznmVPreset = VecWznmVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWznmSge();
...
public:
	...
	PnlWznmSgeList* pnllist;
	PnlWznmSgeHeadbar* pnlheadbar;
	PnlWznmSgeRec* pnlrec;
