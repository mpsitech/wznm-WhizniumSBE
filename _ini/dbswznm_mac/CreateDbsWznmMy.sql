...
CREATE TABLE TblWznmMBox(
	ref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	refWznmMSheet BIGINT UNSIGNED,
	unvIxWznmVMaintable INT UNSIGNED,
	unvUref BIGINT UNSIGNED,
	x SMALLINT,
	y SMALLINT,
...
CREATE TABLE TblWznmMSheet(
	ref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	visRefWznmMVisual BIGINT UNSIGNED,
	visNum INT UNSIGNED,
	Title VARCHAR(50),
	INDEX (visRefWznmMVisual),
	INDEX (visNum)
) ENGINE = MYISAM;
...
CREATE TABLE TblWznmRMBoxMBox(
	ref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	orgRefWznmMBox BIGINT UNSIGNED,
	dstRefWznmMBox BIGINT UNSIGNED,
	orgClk TINYINT UNSIGNED,
	dstClk TINYINT UNSIGNED,
	Weight TINYINT UNSIGNED,
	INDEX (orgRefWznmMBox),
	INDEX (dstRefWznmMBox)
) ENGINE = MYISAM;
...
CREATE TABLE TblWznmQBoxDstMNBox(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
...
CREATE TABLE TblWznmQBoxOrgMNBox(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
	mref BIGINT UNSIGNED,
...
CREATE TABLE TblWznmQVerVer1NVisual(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
	ref BIGINT UNSIGNED,
...
CREATE TABLE TblWznmQVisBoxctx(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	qwr TINYINT,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
	tref BIGINT UNSIGNED,
	ref BIGINT UNSIGNED,
	unvIxWznmVMaintable INT UNSIGNED,
	unvUref BIGINT UNSIGNED,
	x SMALLINT,
...
CREATE TABLE TblWznmQVisLinkctx(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	qwr TINYINT,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
...
CREATE TABLE TblWznmQVisRef1NFile(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
	ref BIGINT UNSIGNED,
...
CREATE TABLE TblWznmQVisRowctx(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	qwr TINYINT,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
...
CREATE TABLE TblWznmQVisVis1NSheet(
	qref BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
	jref BIGINT UNSIGNED,
	jnum INT UNSIGNED,
	ref BIGINT UNSIGNED,
