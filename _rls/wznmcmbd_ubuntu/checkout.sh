...
mkdir $BUILDROOT/wznmcmbd/CrdWznmVis
mkdir $BUILDROOT/wznmcmbd/CrdWznmSht
mkdir $BUILDROOT/wznmcmbd/CrdWznmBox
...
mkdir $BUILDROOT/wznmcmbd/WznmWrvis
...
mkdir $BUILDROOT/wznmcmbd/WznmComplvis
...
cp Makefile_CrdWznmVis $BUILDROOT/wznmcmbd/CrdWznmVis/Makefile

cp ../../wznmcmbd/CrdWznmVis/*.h $BUILDROOT/wznmcmbd/CrdWznmVis/
cp ../../wznmcmbd/CrdWznmVis/*.cpp $BUILDROOT/wznmcmbd/CrdWznmVis/

cp Makefile_CrdWznmSht $BUILDROOT/wznmcmbd/CrdWznmSht/Makefile

cp ../../wznmcmbd/CrdWznmSht/*.h $BUILDROOT/wznmcmbd/CrdWznmSht/
cp ../../wznmcmbd/CrdWznmSht/*.cpp $BUILDROOT/wznmcmbd/CrdWznmSht/

cp Makefile_CrdWznmBox $BUILDROOT/wznmcmbd/CrdWznmBox/Makefile

cp ../../wznmcmbd/CrdWznmBox/*.h $BUILDROOT/wznmcmbd/CrdWznmBox/
cp ../../wznmcmbd/CrdWznmBox/*.cpp $BUILDROOT/wznmcmbd/CrdWznmBox/
...
cp Makefile_WznmWrvis $BUILDROOT/wznmcmbd/WznmWrvis/Makefile

cp ../../wznmcmbd/WznmWrvis/*.h $BUILDROOT/wznmcmbd/WznmWrvis/
cp ../../wznmcmbd/WznmWrvis/*.cpp $BUILDROOT/wznmcmbd/WznmWrvis/
...
cp Makefile_WznmComplvis $BUILDROOT/wznmcmbd/WznmComplvis/Makefile

cp ../../wznmcmbd/WznmComplvis/*.h $BUILDROOT/wznmcmbd/WznmComplvis/
cp ../../wznmcmbd/WznmComplvis/*.cpp $BUILDROOT/wznmcmbd/WznmComplvis/
