...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCalMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCalMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCalMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCalMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCalMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCalMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCalMNStub) this.continf = dpcheng.ContInfWznmCalMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCalMNStub) this.statapp = dpcheng.StatAppWznmCalMNStub;
				if (dpcheng.StatShrWznmCalMNStub) this.statshr = dpcheng.StatShrWznmCalMNStub;
				if (dpcheng.StgIacWznmCalMNStub) this.stgiac = dpcheng.StgIacWznmCalMNStub;
				if (dpcheng.TagWznmCalMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmCalMNStub);
					this.tag = dpcheng.TagWznmCalMNStub;
				}
				if (dpcheng.ListWznmQCalMNStub) this.rst = dpcheng.ListWznmQCalMNStub;
				if (dpcheng.StatAppQryWznmCalMNStub) this.statappqry = dpcheng.StatAppQryWznmCalMNStub;
				if (dpcheng.StatShrQryWznmCalMNStub) this.statshrqry = dpcheng.StatShrQryWznmCalMNStub;
				if (dpcheng.StgIacQryWznmCalMNStub) this.stgiacqry = dpcheng.StgIacQryWznmCalMNStub;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCalMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCalMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
