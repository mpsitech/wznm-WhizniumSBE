...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCarHk1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCarHk1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCarHk1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCarHk1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCarHk1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCarHk1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCarHk1NControl) this.continf = dpcheng.ContInfWznmCarHk1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCarHk1NControl) this.statapp = dpcheng.StatAppWznmCarHk1NControl;
				if (dpcheng.StatShrWznmCarHk1NControl) this.statshr = dpcheng.StatShrWznmCarHk1NControl;
				if (dpcheng.StgIacWznmCarHk1NControl) this.stgiac = dpcheng.StgIacWznmCarHk1NControl;
				if (dpcheng.TagWznmCarHk1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmCarHk1NControl);
					this.tag = dpcheng.TagWznmCarHk1NControl;
				}
				if (dpcheng.ListWznmQCarHk1NControl) this.rst = dpcheng.ListWznmQCarHk1NControl;
				if (dpcheng.StatAppQryWznmCarHk1NControl) this.statappqry = dpcheng.StatAppQryWznmCarHk1NControl;
				if (dpcheng.StatShrQryWznmCarHk1NControl) this.statshrqry = dpcheng.StatShrQryWznmCarHk1NControl;
				if (dpcheng.StgIacQryWznmCarHk1NControl) this.stgiacqry = dpcheng.StgIacQryWznmCarHk1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCarHk1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCarHk1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCarHk1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
