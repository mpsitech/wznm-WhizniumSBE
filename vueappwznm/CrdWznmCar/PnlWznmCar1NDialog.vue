...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCar1NDialog.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCar1NDialogData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCar1NDialog": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCar1NDialog"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCar1NDialogData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCar1NDialogData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCar1NDialog) this.continf = dpcheng.ContInfWznmCar1NDialog;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCar1NDialog) this.statapp = dpcheng.StatAppWznmCar1NDialog;
				if (dpcheng.StatShrWznmCar1NDialog) this.statshr = dpcheng.StatShrWznmCar1NDialog;
				if (dpcheng.StgIacWznmCar1NDialog) this.stgiac = dpcheng.StgIacWznmCar1NDialog;
				if (dpcheng.TagWznmCar1NDialog) {
					Wznm.unescapeBlock(dpcheng.TagWznmCar1NDialog);
					this.tag = dpcheng.TagWznmCar1NDialog;
				}
				if (dpcheng.ListWznmQCar1NDialog) this.rst = dpcheng.ListWznmQCar1NDialog;
				if (dpcheng.StatAppQryWznmCar1NDialog) this.statappqry = dpcheng.StatAppQryWznmCar1NDialog;
				if (dpcheng.StatShrQryWznmCar1NDialog) this.statshrqry = dpcheng.StatShrQryWznmCar1NDialog;
				if (dpcheng.StgIacQryWznmCar1NDialog) this.stgiacqry = dpcheng.StgIacQryWznmCar1NDialog;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCar1NDialog) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCar1NDialogData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCar1NDialogData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
