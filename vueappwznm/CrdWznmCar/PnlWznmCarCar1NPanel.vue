...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCarCar1NPanel.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCarCar1NPanelData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCarCar1NPanel": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCarCar1NPanel"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCarCar1NPanelData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCarCar1NPanelData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCarCar1NPanel) this.continf = dpcheng.ContInfWznmCarCar1NPanel;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCarCar1NPanel) this.statapp = dpcheng.StatAppWznmCarCar1NPanel;
				if (dpcheng.StatShrWznmCarCar1NPanel) this.statshr = dpcheng.StatShrWznmCarCar1NPanel;
				if (dpcheng.StgIacWznmCarCar1NPanel) this.stgiac = dpcheng.StgIacWznmCarCar1NPanel;
				if (dpcheng.TagWznmCarCar1NPanel) {
					Wznm.unescapeBlock(dpcheng.TagWznmCarCar1NPanel);
					this.tag = dpcheng.TagWznmCarCar1NPanel;
				}
				if (dpcheng.ListWznmQCarCar1NPanel) this.rst = dpcheng.ListWznmQCarCar1NPanel;
				if (dpcheng.StatAppQryWznmCarCar1NPanel) this.statappqry = dpcheng.StatAppQryWznmCarCar1NPanel;
				if (dpcheng.StatShrQryWznmCarCar1NPanel) this.statshrqry = dpcheng.StatShrQryWznmCarCar1NPanel;
				if (dpcheng.StgIacQryWznmCarCar1NPanel) this.stgiacqry = dpcheng.StgIacQryWznmCarCar1NPanel;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCarCar1NPanel) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCarCar1NPanelData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCarCar1NPanelData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
