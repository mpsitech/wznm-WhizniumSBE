...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCapAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCapAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCapAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCapAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCapAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCapAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCapAPar) this.continf = dpcheng.ContInfWznmCapAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCapAPar) this.statapp = dpcheng.StatAppWznmCapAPar;
				if (dpcheng.StatShrWznmCapAPar) this.statshr = dpcheng.StatShrWznmCapAPar;
				if (dpcheng.StgIacWznmCapAPar) this.stgiac = dpcheng.StgIacWznmCapAPar;
				if (dpcheng.TagWznmCapAPar) {
					Wznm.unescapeBlock(dpcheng.TagWznmCapAPar);
					this.tag = dpcheng.TagWznmCapAPar;
				}
				if (dpcheng.ListWznmQCapAPar) this.rst = dpcheng.ListWznmQCapAPar;
				if (dpcheng.StatAppQryWznmCapAPar) this.statappqry = dpcheng.StatAppQryWznmCapAPar;
				if (dpcheng.StatShrQryWznmCapAPar) this.statshrqry = dpcheng.StatShrQryWznmCapAPar;
				if (dpcheng.StgIacQryWznmCapAPar) this.stgiacqry = dpcheng.StgIacQryWznmCapAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCapAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCapAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
