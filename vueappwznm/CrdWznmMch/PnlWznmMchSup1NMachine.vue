...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMchSup1NMachine.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMchSup1NMachineData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMchSup1NMachine": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMchSup1NMachine"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMchSup1NMachineData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMchSup1NMachineData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmMchSup1NMachine) this.continf = dpcheng.ContInfWznmMchSup1NMachine;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmMchSup1NMachine) this.statapp = dpcheng.StatAppWznmMchSup1NMachine;
				if (dpcheng.StatShrWznmMchSup1NMachine) this.statshr = dpcheng.StatShrWznmMchSup1NMachine;
				if (dpcheng.StgIacWznmMchSup1NMachine) this.stgiac = dpcheng.StgIacWznmMchSup1NMachine;
				if (dpcheng.TagWznmMchSup1NMachine) {
					Wznm.unescapeBlock(dpcheng.TagWznmMchSup1NMachine);
					this.tag = dpcheng.TagWznmMchSup1NMachine;
				}
				if (dpcheng.ListWznmQMchSup1NMachine) this.rst = dpcheng.ListWznmQMchSup1NMachine;
				if (dpcheng.StatAppQryWznmMchSup1NMachine) this.statappqry = dpcheng.StatAppQryWznmMchSup1NMachine;
				if (dpcheng.StatShrQryWznmMchSup1NMachine) this.statshrqry = dpcheng.StatShrQryWznmMchSup1NMachine;
				if (dpcheng.StgIacQryWznmMchSup1NMachine) this.stgiacqry = dpcheng.StgIacQryWznmMchSup1NMachine;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQMchSup1NMachine) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMchSup1NMachineData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMchSup1NMachineData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
