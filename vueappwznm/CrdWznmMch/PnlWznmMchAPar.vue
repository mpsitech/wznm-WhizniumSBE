...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMchAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMchAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMchAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMchAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMchAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMchAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmMchAPar) this.continf = dpcheng.ContInfWznmMchAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmMchAPar) this.statapp = dpcheng.StatAppWznmMchAPar;
				if (dpcheng.StatShrWznmMchAPar) this.statshr = dpcheng.StatShrWznmMchAPar;
				if (dpcheng.StgIacWznmMchAPar) this.stgiac = dpcheng.StgIacWznmMchAPar;
				if (dpcheng.TagWznmMchAPar) {
					Wznm.unescapeBlock(dpcheng.TagWznmMchAPar);
					this.tag = dpcheng.TagWznmMchAPar;
				}
				if (dpcheng.ListWznmQMchAPar) this.rst = dpcheng.ListWznmQMchAPar;
				if (dpcheng.StatAppQryWznmMchAPar) this.statappqry = dpcheng.StatAppQryWznmMchAPar;
				if (dpcheng.StatShrQryWznmMchAPar) this.statshrqry = dpcheng.StatShrQryWznmMchAPar;
				if (dpcheng.StgIacQryWznmMchAPar) this.stgiacqry = dpcheng.StgIacQryWznmMchAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMchAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMchAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
