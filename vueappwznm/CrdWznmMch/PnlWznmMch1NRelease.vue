...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMch1NRelease.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMch1NReleaseData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMch1NRelease": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMch1NRelease"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMch1NReleaseData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMch1NReleaseData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmMch1NRelease) this.continf = dpcheng.ContInfWznmMch1NRelease;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmMch1NRelease) this.statapp = dpcheng.StatAppWznmMch1NRelease;
				if (dpcheng.StatShrWznmMch1NRelease) this.statshr = dpcheng.StatShrWznmMch1NRelease;
				if (dpcheng.StgIacWznmMch1NRelease) this.stgiac = dpcheng.StgIacWznmMch1NRelease;
				if (dpcheng.TagWznmMch1NRelease) {
					Wznm.unescapeBlock(dpcheng.TagWznmMch1NRelease);
					this.tag = dpcheng.TagWznmMch1NRelease;
				}
				if (dpcheng.ListWznmQMch1NRelease) this.rst = dpcheng.ListWznmQMch1NRelease;
				if (dpcheng.StatAppQryWznmMch1NRelease) this.statappqry = dpcheng.StatAppQryWznmMch1NRelease;
				if (dpcheng.StatShrQryWznmMch1NRelease) this.statshrqry = dpcheng.StatShrQryWznmMch1NRelease;
				if (dpcheng.StgIacQryWznmMch1NRelease) this.stgiacqry = dpcheng.StgIacQryWznmMch1NRelease;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQMch1NRelease) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMch1NReleaseData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMch1NReleaseData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
