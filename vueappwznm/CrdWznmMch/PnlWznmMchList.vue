...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMchList.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMchListData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMchList": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMchList"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMchListData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMchListData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContIacWznmMchList) this.contiac = dpcheng.ContIacWznmMchList;
				if (dpcheng.ContInfWznmMchList) this.continf = dpcheng.ContInfWznmMchList;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.FeedFTos) this.feedFTos = dpcheng.FeedFTos;
				if (dpcheng.StatShrWznmMchList) this.statshr = dpcheng.StatShrWznmMchList;
				if (dpcheng.StgIacWznmMchList) this.stgiac = dpcheng.StgIacWznmMchList;
				if (dpcheng.TagWznmMchList) {
					Wznm.unescapeBlock(dpcheng.TagWznmMchList);
					this.tag = dpcheng.TagWznmMchList;
				}
				if (dpcheng.ListWznmQMchList) this.rst = dpcheng.ListWznmQMchList;
				if (dpcheng.StatAppQryWznmMchList) this.statappqry = dpcheng.StatAppQryWznmMchList;
				if (dpcheng.StatShrQryWznmMchList) this.statshrqry = dpcheng.StatShrQryWznmMchList;
				if (dpcheng.StgIacQryWznmMchList) this.stgiacqry = dpcheng.StgIacQryWznmMchList;
				if (dpcheng.ContInfWznmMchList) {
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMchListData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMchListData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
