...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmApp1NEvent.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmApp1NEventData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmApp1NEvent": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmApp1NEvent"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmApp1NEventData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmApp1NEventData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmApp1NEvent) this.continf = dpcheng.ContInfWznmApp1NEvent;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmApp1NEvent) this.statapp = dpcheng.StatAppWznmApp1NEvent;
				if (dpcheng.StatShrWznmApp1NEvent) this.statshr = dpcheng.StatShrWznmApp1NEvent;
				if (dpcheng.StgIacWznmApp1NEvent) this.stgiac = dpcheng.StgIacWznmApp1NEvent;
				if (dpcheng.TagWznmApp1NEvent) {
					Wznm.unescapeBlock(dpcheng.TagWznmApp1NEvent);
					this.tag = dpcheng.TagWznmApp1NEvent;
				}
				if (dpcheng.ListWznmQApp1NEvent) this.rst = dpcheng.ListWznmQApp1NEvent;
				if (dpcheng.StatAppQryWznmApp1NEvent) this.statappqry = dpcheng.StatAppQryWznmApp1NEvent;
				if (dpcheng.StatShrQryWznmApp1NEvent) this.statshrqry = dpcheng.StatShrQryWznmApp1NEvent;
				if (dpcheng.StgIacQryWznmApp1NEvent) this.stgiacqry = dpcheng.StgIacQryWznmApp1NEvent;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQApp1NEvent) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmApp1NEventData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmApp1NEventData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
