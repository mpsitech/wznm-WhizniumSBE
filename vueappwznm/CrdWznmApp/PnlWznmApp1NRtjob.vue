...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmApp1NRtjob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmApp1NRtjobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmApp1NRtjob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmApp1NRtjob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmApp1NRtjobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmApp1NRtjobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmApp1NRtjob) this.continf = dpcheng.ContInfWznmApp1NRtjob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmApp1NRtjob) this.statapp = dpcheng.StatAppWznmApp1NRtjob;
				if (dpcheng.StatShrWznmApp1NRtjob) this.statshr = dpcheng.StatShrWznmApp1NRtjob;
				if (dpcheng.StgIacWznmApp1NRtjob) this.stgiac = dpcheng.StgIacWznmApp1NRtjob;
				if (dpcheng.TagWznmApp1NRtjob) {
					Wznm.unescapeBlock(dpcheng.TagWznmApp1NRtjob);
					this.tag = dpcheng.TagWznmApp1NRtjob;
				}
				if (dpcheng.ListWznmQApp1NRtjob) this.rst = dpcheng.ListWznmQApp1NRtjob;
				if (dpcheng.StatAppQryWznmApp1NRtjob) this.statappqry = dpcheng.StatAppQryWznmApp1NRtjob;
				if (dpcheng.StatShrQryWznmApp1NRtjob) this.statshrqry = dpcheng.StatShrQryWznmApp1NRtjob;
				if (dpcheng.StgIacQryWznmApp1NRtjob) this.stgiacqry = dpcheng.StgIacQryWznmApp1NRtjob;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQApp1NRtjob) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmApp1NRtjobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmApp1NRtjobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
