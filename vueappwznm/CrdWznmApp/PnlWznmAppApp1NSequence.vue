...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmAppApp1NSequence.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmAppApp1NSequenceData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmAppApp1NSequence": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmAppApp1NSequence"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmAppApp1NSequenceData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmAppApp1NSequenceData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmAppApp1NSequence) this.continf = dpcheng.ContInfWznmAppApp1NSequence;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmAppApp1NSequence) this.statapp = dpcheng.StatAppWznmAppApp1NSequence;
				if (dpcheng.StatShrWznmAppApp1NSequence) this.statshr = dpcheng.StatShrWznmAppApp1NSequence;
				if (dpcheng.StgIacWznmAppApp1NSequence) this.stgiac = dpcheng.StgIacWznmAppApp1NSequence;
				if (dpcheng.TagWznmAppApp1NSequence) {
					Wznm.unescapeBlock(dpcheng.TagWznmAppApp1NSequence);
					this.tag = dpcheng.TagWznmAppApp1NSequence;
				}
				if (dpcheng.ListWznmQAppApp1NSequence) this.rst = dpcheng.ListWznmQAppApp1NSequence;
				if (dpcheng.StatAppQryWznmAppApp1NSequence) this.statappqry = dpcheng.StatAppQryWznmAppApp1NSequence;
				if (dpcheng.StatShrQryWznmAppApp1NSequence) this.statshrqry = dpcheng.StatShrQryWznmAppApp1NSequence;
				if (dpcheng.StgIacQryWznmAppApp1NSequence) this.stgiacqry = dpcheng.StgIacQryWznmAppApp1NSequence;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQAppApp1NSequence) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmAppApp1NSequenceData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmAppApp1NSequenceData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
