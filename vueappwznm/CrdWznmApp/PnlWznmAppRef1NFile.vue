...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmAppRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmAppRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmAppRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmAppRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmAppRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmAppRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmAppRef1NFile) this.continf = dpcheng.ContInfWznmAppRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmAppRef1NFile) this.statapp = dpcheng.StatAppWznmAppRef1NFile;
				if (dpcheng.StatShrWznmAppRef1NFile) this.statshr = dpcheng.StatShrWznmAppRef1NFile;
				if (dpcheng.StgIacWznmAppRef1NFile) this.stgiac = dpcheng.StgIacWznmAppRef1NFile;
				if (dpcheng.TagWznmAppRef1NFile) {
					Wznm.unescapeBlock(dpcheng.TagWznmAppRef1NFile);
					this.tag = dpcheng.TagWznmAppRef1NFile;
				}
				if (dpcheng.ListWznmQAppRef1NFile) this.rst = dpcheng.ListWznmQAppRef1NFile;
				if (dpcheng.StatAppQryWznmAppRef1NFile) this.statappqry = dpcheng.StatAppQryWznmAppRef1NFile;
				if (dpcheng.StatShrQryWznmAppRef1NFile) this.statshrqry = dpcheng.StatShrQryWznmAppRef1NFile;
				if (dpcheng.StgIacQryWznmAppRef1NFile) this.stgiacqry = dpcheng.StgIacQryWznmAppRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQAppRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmAppRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmAppRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
