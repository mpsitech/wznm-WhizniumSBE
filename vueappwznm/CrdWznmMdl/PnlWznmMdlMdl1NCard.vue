...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMdlMdl1NCard.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMdlMdl1NCardData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMdlMdl1NCard": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMdlMdl1NCard"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMdlMdl1NCardData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMdlMdl1NCardData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmMdlMdl1NCard) this.continf = dpcheng.ContInfWznmMdlMdl1NCard;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmMdlMdl1NCard) this.statapp = dpcheng.StatAppWznmMdlMdl1NCard;
				if (dpcheng.StatShrWznmMdlMdl1NCard) this.statshr = dpcheng.StatShrWznmMdlMdl1NCard;
				if (dpcheng.StgIacWznmMdlMdl1NCard) this.stgiac = dpcheng.StgIacWznmMdlMdl1NCard;
				if (dpcheng.TagWznmMdlMdl1NCard) {
					Wznm.unescapeBlock(dpcheng.TagWznmMdlMdl1NCard);
					this.tag = dpcheng.TagWznmMdlMdl1NCard;
				}
				if (dpcheng.ListWznmQMdlMdl1NCard) this.rst = dpcheng.ListWznmQMdlMdl1NCard;
				if (dpcheng.StatAppQryWznmMdlMdl1NCard) this.statappqry = dpcheng.StatAppQryWznmMdlMdl1NCard;
				if (dpcheng.StatShrQryWznmMdlMdl1NCard) this.statshrqry = dpcheng.StatShrQryWznmMdlMdl1NCard;
				if (dpcheng.StgIacQryWznmMdlMdl1NCard) this.stgiacqry = dpcheng.StgIacQryWznmMdlMdl1NCard;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQMdlMdl1NCard) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMdlMdl1NCardData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMdlMdl1NCardData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
