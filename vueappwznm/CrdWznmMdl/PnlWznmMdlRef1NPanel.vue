...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmMdlRef1NPanel.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmMdlRef1NPanelData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmMdlRef1NPanel": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmMdlRef1NPanel"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmMdlRef1NPanelData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmMdlRef1NPanelData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmMdlRef1NPanel) this.continf = dpcheng.ContInfWznmMdlRef1NPanel;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmMdlRef1NPanel) this.statapp = dpcheng.StatAppWznmMdlRef1NPanel;
				if (dpcheng.StatShrWznmMdlRef1NPanel) this.statshr = dpcheng.StatShrWznmMdlRef1NPanel;
				if (dpcheng.StgIacWznmMdlRef1NPanel) this.stgiac = dpcheng.StgIacWznmMdlRef1NPanel;
				if (dpcheng.TagWznmMdlRef1NPanel) {
					Wznm.unescapeBlock(dpcheng.TagWznmMdlRef1NPanel);
					this.tag = dpcheng.TagWznmMdlRef1NPanel;
				}
				if (dpcheng.ListWznmQMdlRef1NPanel) this.rst = dpcheng.ListWznmQMdlRef1NPanel;
				if (dpcheng.StatAppQryWznmMdlRef1NPanel) this.statappqry = dpcheng.StatAppQryWznmMdlRef1NPanel;
				if (dpcheng.StatShrQryWznmMdlRef1NPanel) this.statshrqry = dpcheng.StatShrQryWznmMdlRef1NPanel;
				if (dpcheng.StgIacQryWznmMdlRef1NPanel) this.stgiacqry = dpcheng.StgIacQryWznmMdlRef1NPanel;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQMdlRef1NPanel) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmMdlRef1NPanelData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmMdlRef1NPanelData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
