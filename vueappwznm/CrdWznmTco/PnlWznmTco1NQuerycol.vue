...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTco1NQuerycol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTco1NQuerycolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTco1NQuerycol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTco1NQuerycol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTco1NQuerycolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTco1NQuerycolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTco1NQuerycol) this.continf = dpcheng.ContInfWznmTco1NQuerycol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTco1NQuerycol) this.statapp = dpcheng.StatAppWznmTco1NQuerycol;
				if (dpcheng.StatShrWznmTco1NQuerycol) this.statshr = dpcheng.StatShrWznmTco1NQuerycol;
				if (dpcheng.StgIacWznmTco1NQuerycol) this.stgiac = dpcheng.StgIacWznmTco1NQuerycol;
				if (dpcheng.TagWznmTco1NQuerycol) {
					Wznm.unescapeBlock(dpcheng.TagWznmTco1NQuerycol);
					this.tag = dpcheng.TagWznmTco1NQuerycol;
				}
				if (dpcheng.ListWznmQTco1NQuerycol) this.rst = dpcheng.ListWznmQTco1NQuerycol;
				if (dpcheng.StatAppQryWznmTco1NQuerycol) this.statappqry = dpcheng.StatAppQryWznmTco1NQuerycol;
				if (dpcheng.StatShrQryWznmTco1NQuerycol) this.statshrqry = dpcheng.StatShrQryWznmTco1NQuerycol;
				if (dpcheng.StgIacQryWznmTco1NQuerycol) this.stgiacqry = dpcheng.StgIacQryWznmTco1NQuerycol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTco1NQuerycol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTco1NQuerycolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTco1NQuerycolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
