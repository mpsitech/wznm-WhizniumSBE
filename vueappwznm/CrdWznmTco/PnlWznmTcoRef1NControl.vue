...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTcoRef1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTcoRef1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTcoRef1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTcoRef1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTcoRef1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTcoRef1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTcoRef1NControl) this.continf = dpcheng.ContInfWznmTcoRef1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTcoRef1NControl) this.statapp = dpcheng.StatAppWznmTcoRef1NControl;
				if (dpcheng.StatShrWznmTcoRef1NControl) this.statshr = dpcheng.StatShrWznmTcoRef1NControl;
				if (dpcheng.StgIacWznmTcoRef1NControl) this.stgiac = dpcheng.StgIacWznmTcoRef1NControl;
				if (dpcheng.TagWznmTcoRef1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmTcoRef1NControl);
					this.tag = dpcheng.TagWznmTcoRef1NControl;
				}
				if (dpcheng.ListWznmQTcoRef1NControl) this.rst = dpcheng.ListWznmQTcoRef1NControl;
				if (dpcheng.StatAppQryWznmTcoRef1NControl) this.statappqry = dpcheng.StatAppQryWznmTcoRef1NControl;
				if (dpcheng.StatShrQryWznmTcoRef1NControl) this.statshrqry = dpcheng.StatShrQryWznmTcoRef1NControl;
				if (dpcheng.StgIacQryWznmTcoRef1NControl) this.stgiacqry = dpcheng.StgIacQryWznmTcoRef1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTcoRef1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTcoRef1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTcoRef1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
