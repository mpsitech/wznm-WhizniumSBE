...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTcoRef1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTcoRef1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTcoRef1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTcoRef1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTcoRef1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTcoRef1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTcoRef1NQuerymod) this.continf = dpcheng.ContInfWznmTcoRef1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTcoRef1NQuerymod) this.statapp = dpcheng.StatAppWznmTcoRef1NQuerymod;
				if (dpcheng.StatShrWznmTcoRef1NQuerymod) this.statshr = dpcheng.StatShrWznmTcoRef1NQuerymod;
				if (dpcheng.StgIacWznmTcoRef1NQuerymod) this.stgiac = dpcheng.StgIacWznmTcoRef1NQuerymod;
				if (dpcheng.TagWznmTcoRef1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmTcoRef1NQuerymod);
					this.tag = dpcheng.TagWznmTcoRef1NQuerymod;
				}
				if (dpcheng.ListWznmQTcoRef1NQuerymod) this.rst = dpcheng.ListWznmQTcoRef1NQuerymod;
				if (dpcheng.StatAppQryWznmTcoRef1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmTcoRef1NQuerymod;
				if (dpcheng.StatShrQryWznmTcoRef1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmTcoRef1NQuerymod;
				if (dpcheng.StgIacQryWznmTcoRef1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmTcoRef1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTcoRef1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTcoRef1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTcoRef1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
