...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTco1NCheck.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTco1NCheckData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTco1NCheck": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTco1NCheck"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTco1NCheckData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTco1NCheckData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTco1NCheck) this.continf = dpcheng.ContInfWznmTco1NCheck;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTco1NCheck) this.statapp = dpcheng.StatAppWznmTco1NCheck;
				if (dpcheng.StatShrWznmTco1NCheck) this.statshr = dpcheng.StatShrWznmTco1NCheck;
				if (dpcheng.StgIacWznmTco1NCheck) this.stgiac = dpcheng.StgIacWznmTco1NCheck;
				if (dpcheng.TagWznmTco1NCheck) {
					Wznm.unescapeBlock(dpcheng.TagWznmTco1NCheck);
					this.tag = dpcheng.TagWznmTco1NCheck;
				}
				if (dpcheng.ListWznmQTco1NCheck) this.rst = dpcheng.ListWznmQTco1NCheck;
				if (dpcheng.StatAppQryWznmTco1NCheck) this.statappqry = dpcheng.StatAppQryWznmTco1NCheck;
				if (dpcheng.StatShrQryWznmTco1NCheck) this.statshrqry = dpcheng.StatShrQryWznmTco1NCheck;
				if (dpcheng.StgIacQryWznmTco1NCheck) this.stgiacqry = dpcheng.StgIacQryWznmTco1NCheck;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTco1NCheck) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTco1NCheckData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTco1NCheckData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
