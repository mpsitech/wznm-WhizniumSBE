...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVerVer1NApp.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVerVer1NAppData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVerVer1NApp": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVerVer1NApp"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVerVer1NAppData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVerVer1NAppData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVerVer1NApp) this.continf = dpcheng.ContInfWznmVerVer1NApp;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVerVer1NApp) this.statapp = dpcheng.StatAppWznmVerVer1NApp;
				if (dpcheng.StatShrWznmVerVer1NApp) this.statshr = dpcheng.StatShrWznmVerVer1NApp;
				if (dpcheng.StgIacWznmVerVer1NApp) this.stgiac = dpcheng.StgIacWznmVerVer1NApp;
				if (dpcheng.TagWznmVerVer1NApp) {
					Wznm.unescapeBlock(dpcheng.TagWznmVerVer1NApp);
					this.tag = dpcheng.TagWznmVerVer1NApp;
				}
				if (dpcheng.ListWznmQVerVer1NApp) this.rst = dpcheng.ListWznmQVerVer1NApp;
				if (dpcheng.StatAppQryWznmVerVer1NApp) this.statappqry = dpcheng.StatAppQryWznmVerVer1NApp;
				if (dpcheng.StatShrQryWznmVerVer1NApp) this.statshrqry = dpcheng.StatShrQryWznmVerVer1NApp;
				if (dpcheng.StgIacQryWznmVerVer1NApp) this.stgiacqry = dpcheng.StgIacQryWznmVerVer1NApp;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVerVer1NApp) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVerVer1NAppData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVerVer1NAppData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
