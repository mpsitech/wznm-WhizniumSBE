...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NImpexpcplx.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NImpexpcplxData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NImpexpcplx": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NImpexpcplx"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NImpexpcplxData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NImpexpcplxData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NImpexpcplx) this.continf = dpcheng.ContInfWznmVer1NImpexpcplx;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NImpexpcplx) this.statapp = dpcheng.StatAppWznmVer1NImpexpcplx;
				if (dpcheng.StatShrWznmVer1NImpexpcplx) this.statshr = dpcheng.StatShrWznmVer1NImpexpcplx;
				if (dpcheng.StgIacWznmVer1NImpexpcplx) this.stgiac = dpcheng.StgIacWznmVer1NImpexpcplx;
				if (dpcheng.TagWznmVer1NImpexpcplx) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NImpexpcplx);
					this.tag = dpcheng.TagWznmVer1NImpexpcplx;
				}
				if (dpcheng.ListWznmQVer1NImpexpcplx) this.rst = dpcheng.ListWznmQVer1NImpexpcplx;
				if (dpcheng.StatAppQryWznmVer1NImpexpcplx) this.statappqry = dpcheng.StatAppQryWznmVer1NImpexpcplx;
				if (dpcheng.StatShrQryWznmVer1NImpexpcplx) this.statshrqry = dpcheng.StatShrQryWznmVer1NImpexpcplx;
				if (dpcheng.StgIacQryWznmVer1NImpexpcplx) this.stgiacqry = dpcheng.StgIacQryWznmVer1NImpexpcplx;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NImpexpcplx) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NImpexpcplxData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NImpexpcplxData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
