...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVerMNLocale.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVerMNLocaleData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVerMNLocale": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVerMNLocale"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVerMNLocaleData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVerMNLocaleData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVerMNLocale) this.continf = dpcheng.ContInfWznmVerMNLocale;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVerMNLocale) this.statapp = dpcheng.StatAppWznmVerMNLocale;
				if (dpcheng.StatShrWznmVerMNLocale) this.statshr = dpcheng.StatShrWznmVerMNLocale;
				if (dpcheng.StgIacWznmVerMNLocale) this.stgiac = dpcheng.StgIacWznmVerMNLocale;
				if (dpcheng.TagWznmVerMNLocale) {
					Wznm.unescapeBlock(dpcheng.TagWznmVerMNLocale);
					this.tag = dpcheng.TagWznmVerMNLocale;
				}
				if (dpcheng.ListWznmQVerMNLocale) this.rst = dpcheng.ListWznmQVerMNLocale;
				if (dpcheng.StatAppQryWznmVerMNLocale) this.statappqry = dpcheng.StatAppQryWznmVerMNLocale;
				if (dpcheng.StatShrQryWznmVerMNLocale) this.statshrqry = dpcheng.StatShrQryWznmVerMNLocale;
				if (dpcheng.StgIacQryWznmVerMNLocale) this.stgiacqry = dpcheng.StgIacQryWznmVerMNLocale;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVerMNLocale) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVerMNLocaleData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVerMNLocaleData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
