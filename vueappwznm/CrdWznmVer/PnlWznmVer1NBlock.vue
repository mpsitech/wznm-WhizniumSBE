...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NBlock.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NBlockData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NBlock": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NBlock"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NBlockData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NBlockData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NBlock) this.continf = dpcheng.ContInfWznmVer1NBlock;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NBlock) this.statapp = dpcheng.StatAppWznmVer1NBlock;
				if (dpcheng.StatShrWznmVer1NBlock) this.statshr = dpcheng.StatShrWznmVer1NBlock;
				if (dpcheng.StgIacWznmVer1NBlock) this.stgiac = dpcheng.StgIacWznmVer1NBlock;
				if (dpcheng.TagWznmVer1NBlock) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NBlock);
					this.tag = dpcheng.TagWznmVer1NBlock;
				}
				if (dpcheng.ListWznmQVer1NBlock) this.rst = dpcheng.ListWznmQVer1NBlock;
				if (dpcheng.StatAppQryWznmVer1NBlock) this.statappqry = dpcheng.StatAppQryWznmVer1NBlock;
				if (dpcheng.StatShrQryWznmVer1NBlock) this.statshrqry = dpcheng.StatShrQryWznmVer1NBlock;
				if (dpcheng.StgIacQryWznmVer1NBlock) this.stgiacqry = dpcheng.StgIacQryWznmVer1NBlock;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NBlock) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NBlockData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NBlockData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
