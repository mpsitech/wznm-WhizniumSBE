...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NPreset.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NPresetData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NPreset": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NPreset"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NPresetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NPresetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NPreset) this.continf = dpcheng.ContInfWznmVer1NPreset;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NPreset) this.statapp = dpcheng.StatAppWznmVer1NPreset;
				if (dpcheng.StatShrWznmVer1NPreset) this.statshr = dpcheng.StatShrWznmVer1NPreset;
				if (dpcheng.StgIacWznmVer1NPreset) this.stgiac = dpcheng.StgIacWznmVer1NPreset;
				if (dpcheng.TagWznmVer1NPreset) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NPreset);
					this.tag = dpcheng.TagWznmVer1NPreset;
				}
				if (dpcheng.ListWznmQVer1NPreset) this.rst = dpcheng.ListWznmQVer1NPreset;
				if (dpcheng.StatAppQryWznmVer1NPreset) this.statappqry = dpcheng.StatAppQryWznmVer1NPreset;
				if (dpcheng.StatShrQryWznmVer1NPreset) this.statshrqry = dpcheng.StatShrQryWznmVer1NPreset;
				if (dpcheng.StgIacQryWznmVer1NPreset) this.stgiacqry = dpcheng.StgIacQryWznmVer1NPreset;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NPreset) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NPresetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NPresetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
