...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NCall.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NCallData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NCall": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NCall"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NCallData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NCallData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NCall) this.continf = dpcheng.ContInfWznmVer1NCall;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NCall) this.statapp = dpcheng.StatAppWznmVer1NCall;
				if (dpcheng.StatShrWznmVer1NCall) this.statshr = dpcheng.StatShrWznmVer1NCall;
				if (dpcheng.StgIacWznmVer1NCall) this.stgiac = dpcheng.StgIacWznmVer1NCall;
				if (dpcheng.TagWznmVer1NCall) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NCall);
					this.tag = dpcheng.TagWznmVer1NCall;
				}
				if (dpcheng.ListWznmQVer1NCall) this.rst = dpcheng.ListWznmQVer1NCall;
				if (dpcheng.StatAppQryWznmVer1NCall) this.statappqry = dpcheng.StatAppQryWznmVer1NCall;
				if (dpcheng.StatShrQryWznmVer1NCall) this.statshrqry = dpcheng.StatShrQryWznmVer1NCall;
				if (dpcheng.StgIacQryWznmVer1NCall) this.stgiacqry = dpcheng.StgIacQryWznmVer1NCall;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NCallData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NCallData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
