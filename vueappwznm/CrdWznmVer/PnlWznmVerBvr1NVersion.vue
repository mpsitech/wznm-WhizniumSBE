...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVerBvr1NVersion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVerBvr1NVersionData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVerBvr1NVersion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVerBvr1NVersion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVerBvr1NVersionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVerBvr1NVersionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVerBvr1NVersion) this.continf = dpcheng.ContInfWznmVerBvr1NVersion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVerBvr1NVersion) this.statapp = dpcheng.StatAppWznmVerBvr1NVersion;
				if (dpcheng.StatShrWznmVerBvr1NVersion) this.statshr = dpcheng.StatShrWznmVerBvr1NVersion;
				if (dpcheng.StgIacWznmVerBvr1NVersion) this.stgiac = dpcheng.StgIacWznmVerBvr1NVersion;
				if (dpcheng.TagWznmVerBvr1NVersion) {
					Wznm.unescapeBlock(dpcheng.TagWznmVerBvr1NVersion);
					this.tag = dpcheng.TagWznmVerBvr1NVersion;
				}
				if (dpcheng.ListWznmQVerBvr1NVersion) this.rst = dpcheng.ListWznmQVerBvr1NVersion;
				if (dpcheng.StatAppQryWznmVerBvr1NVersion) this.statappqry = dpcheng.StatAppQryWznmVerBvr1NVersion;
				if (dpcheng.StatShrQryWznmVerBvr1NVersion) this.statshrqry = dpcheng.StatShrQryWznmVerBvr1NVersion;
				if (dpcheng.StgIacQryWznmVerBvr1NVersion) this.stgiacqry = dpcheng.StgIacQryWznmVerBvr1NVersion;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVerBvr1NVersion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVerBvr1NVersionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVerBvr1NVersionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
