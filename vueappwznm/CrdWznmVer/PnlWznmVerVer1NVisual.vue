...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVerVer1NVisual.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVerVer1NVisualData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVerVer1NVisual": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVerVer1NVisual"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVerVer1NVisualData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVerVer1NVisualData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVerVer1NVisual) this.continf = dpcheng.ContInfWznmVerVer1NVisual;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVerVer1NVisual) this.statapp = dpcheng.StatAppWznmVerVer1NVisual;
				if (dpcheng.StatShrWznmVerVer1NVisual) this.statshr = dpcheng.StatShrWznmVerVer1NVisual;
				if (dpcheng.StgIacWznmVerVer1NVisual) this.stgiac = dpcheng.StgIacWznmVerVer1NVisual;
				if (dpcheng.TagWznmVerVer1NVisual) {
					Wznm.unescapeBlock(dpcheng.TagWznmVerVer1NVisual);
					this.tag = dpcheng.TagWznmVerVer1NVisual;
				}
				if (dpcheng.ListWznmQVerVer1NVisual) this.rst = dpcheng.ListWznmQVerVer1NVisual;
				if (dpcheng.StatAppQryWznmVerVer1NVisual) this.statappqry = dpcheng.StatAppQryWznmVerVer1NVisual;
				if (dpcheng.StatShrQryWznmVerVer1NVisual) this.statshrqry = dpcheng.StatShrQryWznmVerVer1NVisual;
				if (dpcheng.StgIacQryWznmVerVer1NVisual) this.stgiacqry = dpcheng.StgIacQryWznmVerVer1NVisual;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVerVer1NVisual) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVerVer1NVisualData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVerVer1NVisualData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
