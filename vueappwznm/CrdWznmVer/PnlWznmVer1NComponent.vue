...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NComponent.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NComponentData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NComponent": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NComponent"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NComponentData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NComponentData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NComponent) this.continf = dpcheng.ContInfWznmVer1NComponent;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NComponent) this.statapp = dpcheng.StatAppWznmVer1NComponent;
				if (dpcheng.StatShrWznmVer1NComponent) this.statshr = dpcheng.StatShrWznmVer1NComponent;
				if (dpcheng.StgIacWznmVer1NComponent) this.stgiac = dpcheng.StgIacWznmVer1NComponent;
				if (dpcheng.TagWznmVer1NComponent) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NComponent);
					this.tag = dpcheng.TagWznmVer1NComponent;
				}
				if (dpcheng.ListWznmQVer1NComponent) this.rst = dpcheng.ListWznmQVer1NComponent;
				if (dpcheng.StatAppQryWznmVer1NComponent) this.statappqry = dpcheng.StatAppQryWznmVer1NComponent;
				if (dpcheng.StatShrQryWznmVer1NComponent) this.statshrqry = dpcheng.StatShrQryWznmVer1NComponent;
				if (dpcheng.StgIacQryWznmVer1NComponent) this.stgiacqry = dpcheng.StgIacQryWznmVer1NComponent;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NComponent) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NComponentData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NComponentData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
