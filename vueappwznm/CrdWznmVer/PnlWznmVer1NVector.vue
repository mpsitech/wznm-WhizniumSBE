...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NVector) this.continf = dpcheng.ContInfWznmVer1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NVector) this.statapp = dpcheng.StatAppWznmVer1NVector;
				if (dpcheng.StatShrWznmVer1NVector) this.statshr = dpcheng.StatShrWznmVer1NVector;
				if (dpcheng.StgIacWznmVer1NVector) this.stgiac = dpcheng.StgIacWznmVer1NVector;
				if (dpcheng.TagWznmVer1NVector) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NVector);
					this.tag = dpcheng.TagWznmVer1NVector;
				}
				if (dpcheng.ListWznmQVer1NVector) this.rst = dpcheng.ListWznmQVer1NVector;
				if (dpcheng.StatAppQryWznmVer1NVector) this.statappqry = dpcheng.StatAppQryWznmVer1NVector;
				if (dpcheng.StatShrQryWznmVer1NVector) this.statshrqry = dpcheng.StatShrQryWznmVer1NVector;
				if (dpcheng.StgIacQryWznmVer1NVector) this.stgiacqry = dpcheng.StgIacQryWznmVer1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
