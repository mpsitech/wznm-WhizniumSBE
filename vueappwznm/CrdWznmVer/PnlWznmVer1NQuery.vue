...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NQuery.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NQueryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NQuery": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NQuery"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NQueryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NQueryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NQuery) this.continf = dpcheng.ContInfWznmVer1NQuery;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NQuery) this.statapp = dpcheng.StatAppWznmVer1NQuery;
				if (dpcheng.StatShrWznmVer1NQuery) this.statshr = dpcheng.StatShrWznmVer1NQuery;
				if (dpcheng.StgIacWznmVer1NQuery) this.stgiac = dpcheng.StgIacWznmVer1NQuery;
				if (dpcheng.TagWznmVer1NQuery) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NQuery);
					this.tag = dpcheng.TagWznmVer1NQuery;
				}
				if (dpcheng.ListWznmQVer1NQuery) this.rst = dpcheng.ListWznmQVer1NQuery;
				if (dpcheng.StatAppQryWznmVer1NQuery) this.statappqry = dpcheng.StatAppQryWznmVer1NQuery;
				if (dpcheng.StatShrQryWznmVer1NQuery) this.statshrqry = dpcheng.StatShrQryWznmVer1NQuery;
				if (dpcheng.StgIacQryWznmVer1NQuery) this.stgiacqry = dpcheng.StgIacQryWznmVer1NQuery;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NQuery) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NQueryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NQueryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
