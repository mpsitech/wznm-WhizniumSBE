...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NTable.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NTableData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NTable": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NTable"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NTableData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NTableData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NTable) this.continf = dpcheng.ContInfWznmVer1NTable;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NTable) this.statapp = dpcheng.StatAppWznmVer1NTable;
				if (dpcheng.StatShrWznmVer1NTable) this.statshr = dpcheng.StatShrWznmVer1NTable;
				if (dpcheng.StgIacWznmVer1NTable) this.stgiac = dpcheng.StgIacWznmVer1NTable;
				if (dpcheng.TagWznmVer1NTable) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NTable);
					this.tag = dpcheng.TagWznmVer1NTable;
				}
				if (dpcheng.ListWznmQVer1NTable) this.rst = dpcheng.ListWznmQVer1NTable;
				if (dpcheng.StatAppQryWznmVer1NTable) this.statappqry = dpcheng.StatAppQryWznmVer1NTable;
				if (dpcheng.StatShrQryWznmVer1NTable) this.statshrqry = dpcheng.StatShrQryWznmVer1NTable;
				if (dpcheng.StgIacQryWznmVer1NTable) this.stgiacqry = dpcheng.StgIacQryWznmVer1NTable;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NTable) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NTableData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NTableData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
