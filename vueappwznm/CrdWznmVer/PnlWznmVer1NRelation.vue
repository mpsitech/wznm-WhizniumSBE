...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVer1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVer1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVer1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVer1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVer1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVer1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVer1NRelation) this.continf = dpcheng.ContInfWznmVer1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVer1NRelation) this.statapp = dpcheng.StatAppWznmVer1NRelation;
				if (dpcheng.StatShrWznmVer1NRelation) this.statshr = dpcheng.StatShrWznmVer1NRelation;
				if (dpcheng.StgIacWznmVer1NRelation) this.stgiac = dpcheng.StgIacWznmVer1NRelation;
				if (dpcheng.TagWznmVer1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmVer1NRelation);
					this.tag = dpcheng.TagWznmVer1NRelation;
				}
				if (dpcheng.ListWznmQVer1NRelation) this.rst = dpcheng.ListWznmQVer1NRelation;
				if (dpcheng.StatAppQryWznmVer1NRelation) this.statappqry = dpcheng.StatAppQryWznmVer1NRelation;
				if (dpcheng.StatShrQryWznmVer1NRelation) this.statshrqry = dpcheng.StatShrQryWznmVer1NRelation;
				if (dpcheng.StgIacQryWznmVer1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmVer1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVer1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVer1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVer1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
