...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVerRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVerRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVerRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVerRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVerRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVerRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVerRef1NFile) this.continf = dpcheng.ContInfWznmVerRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVerRef1NFile) this.statapp = dpcheng.StatAppWznmVerRef1NFile;
				if (dpcheng.StatShrWznmVerRef1NFile) this.statshr = dpcheng.StatShrWznmVerRef1NFile;
				if (dpcheng.StgIacWznmVerRef1NFile) this.stgiac = dpcheng.StgIacWznmVerRef1NFile;
				if (dpcheng.TagWznmVerRef1NFile) {
					Wznm.unescapeBlock(dpcheng.TagWznmVerRef1NFile);
					this.tag = dpcheng.TagWznmVerRef1NFile;
				}
				if (dpcheng.ListWznmQVerRef1NFile) this.rst = dpcheng.ListWznmQVerRef1NFile;
				if (dpcheng.StatAppQryWznmVerRef1NFile) this.statappqry = dpcheng.StatAppQryWznmVerRef1NFile;
				if (dpcheng.StatShrQryWznmVerRef1NFile) this.statshrqry = dpcheng.StatShrQryWznmVerRef1NFile;
				if (dpcheng.StgIacQryWznmVerRef1NFile) this.stgiacqry = dpcheng.StgIacQryWznmVerRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVerRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVerRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVerRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
