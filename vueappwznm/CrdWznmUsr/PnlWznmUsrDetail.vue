...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmUsrDetail.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmUsrDetail"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmUsrDetailData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmUsrDetailData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContIacWznmUsrDetail) this.contiac = dpcheng.ContIacWznmUsrDetail;
				if (dpcheng.ContInfWznmUsrDetail) this.continf = dpcheng.ContInfWznmUsrDetail;
				...
				if (dpcheng.StatAppWznmUsrDetail) this.statapp = dpcheng.StatAppWznmUsrDetail;
				if (dpcheng.StatShrWznmUsrDetail) this.statshr = dpcheng.StatShrWznmUsrDetail;
				if (dpcheng.TagWznmUsrDetail) {
					Wznm.unescapeBlock(dpcheng.TagWznmUsrDetail);
					this.tag = dpcheng.TagWznmUsrDetail;
				}
				if (dpcheng.ContIacWznmUsrDetail) {
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmUsrDetailData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmUsrDetailData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
