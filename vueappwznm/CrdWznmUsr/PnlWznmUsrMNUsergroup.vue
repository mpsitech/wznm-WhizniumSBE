...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmUsrMNUsergroup.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmUsrMNUsergroupData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmUsrMNUsergroup": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmUsrMNUsergroup"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmUsrMNUsergroupData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmUsrMNUsergroupData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmUsrMNUsergroup) this.continf = dpcheng.ContInfWznmUsrMNUsergroup;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmUsrMNUsergroup) this.statapp = dpcheng.StatAppWznmUsrMNUsergroup;
				if (dpcheng.StatShrWznmUsrMNUsergroup) this.statshr = dpcheng.StatShrWznmUsrMNUsergroup;
				if (dpcheng.StgIacWznmUsrMNUsergroup) this.stgiac = dpcheng.StgIacWznmUsrMNUsergroup;
				if (dpcheng.TagWznmUsrMNUsergroup) {
					Wznm.unescapeBlock(dpcheng.TagWznmUsrMNUsergroup);
					this.tag = dpcheng.TagWznmUsrMNUsergroup;
				}
				if (dpcheng.ListWznmQUsrMNUsergroup) this.rst = dpcheng.ListWznmQUsrMNUsergroup;
				if (dpcheng.StatAppQryWznmUsrMNUsergroup) this.statappqry = dpcheng.StatAppQryWznmUsrMNUsergroup;
				if (dpcheng.StatShrQryWznmUsrMNUsergroup) this.statshrqry = dpcheng.StatShrQryWznmUsrMNUsergroup;
				if (dpcheng.StgIacQryWznmUsrMNUsergroup) this.stgiacqry = dpcheng.StgIacQryWznmUsrMNUsergroup;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQUsrMNUsergroup) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmUsrMNUsergroupData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmUsrMNUsergroupData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
