...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmUsrAAccess.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmUsrAAccessData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmUsrAAccess": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmUsrAAccess"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmUsrAAccessData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmUsrAAccessData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmUsrAAccess) this.continf = dpcheng.ContInfWznmUsrAAccess;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmUsrAAccess) this.statapp = dpcheng.StatAppWznmUsrAAccess;
				if (dpcheng.StatShrWznmUsrAAccess) this.statshr = dpcheng.StatShrWznmUsrAAccess;
				if (dpcheng.StgIacWznmUsrAAccess) this.stgiac = dpcheng.StgIacWznmUsrAAccess;
				if (dpcheng.TagWznmUsrAAccess) {
					Wznm.unescapeBlock(dpcheng.TagWznmUsrAAccess);
					this.tag = dpcheng.TagWznmUsrAAccess;
				}
				if (dpcheng.ListWznmQUsrAAccess) this.rst = dpcheng.ListWznmQUsrAAccess;
				if (dpcheng.StatAppQryWznmUsrAAccess) this.statappqry = dpcheng.StatAppQryWznmUsrAAccess;
				if (dpcheng.StatShrQryWznmUsrAAccess) this.statshrqry = dpcheng.StatShrQryWznmUsrAAccess;
				if (dpcheng.StgIacQryWznmUsrAAccess) this.stgiacqry = dpcheng.StgIacQryWznmUsrAAccess;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQUsrAAccess) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmUsrAAccessData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmUsrAAccessData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
