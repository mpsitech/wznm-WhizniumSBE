...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmQcoRef1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmQcoRef1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmQcoRef1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmQcoRef1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmQcoRef1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmQcoRef1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmQcoRef1NControl) this.continf = dpcheng.ContInfWznmQcoRef1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmQcoRef1NControl) this.statapp = dpcheng.StatAppWznmQcoRef1NControl;
				if (dpcheng.StatShrWznmQcoRef1NControl) this.statshr = dpcheng.StatShrWznmQcoRef1NControl;
				if (dpcheng.StgIacWznmQcoRef1NControl) this.stgiac = dpcheng.StgIacWznmQcoRef1NControl;
				if (dpcheng.TagWznmQcoRef1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmQcoRef1NControl);
					this.tag = dpcheng.TagWznmQcoRef1NControl;
				}
				if (dpcheng.ListWznmQQcoRef1NControl) this.rst = dpcheng.ListWznmQQcoRef1NControl;
				if (dpcheng.StatAppQryWznmQcoRef1NControl) this.statappqry = dpcheng.StatAppQryWznmQcoRef1NControl;
				if (dpcheng.StatShrQryWznmQcoRef1NControl) this.statshrqry = dpcheng.StatShrQryWznmQcoRef1NControl;
				if (dpcheng.StgIacQryWznmQcoRef1NControl) this.stgiacqry = dpcheng.StgIacQryWznmQcoRef1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQQcoRef1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmQcoRef1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmQcoRef1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
