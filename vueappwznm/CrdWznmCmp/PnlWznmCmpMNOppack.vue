...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCmpMNOppack.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCmpMNOppackData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCmpMNOppack": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCmpMNOppack"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCmpMNOppackData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCmpMNOppackData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCmpMNOppack) this.continf = dpcheng.ContInfWznmCmpMNOppack;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCmpMNOppack) this.statapp = dpcheng.StatAppWznmCmpMNOppack;
				if (dpcheng.StatShrWznmCmpMNOppack) this.statshr = dpcheng.StatShrWznmCmpMNOppack;
				if (dpcheng.StgIacWznmCmpMNOppack) this.stgiac = dpcheng.StgIacWznmCmpMNOppack;
				if (dpcheng.TagWznmCmpMNOppack) {
					Wznm.unescapeBlock(dpcheng.TagWznmCmpMNOppack);
					this.tag = dpcheng.TagWznmCmpMNOppack;
				}
				if (dpcheng.ListWznmQCmpMNOppack) this.rst = dpcheng.ListWznmQCmpMNOppack;
				if (dpcheng.StatAppQryWznmCmpMNOppack) this.statappqry = dpcheng.StatAppQryWznmCmpMNOppack;
				if (dpcheng.StatShrQryWznmCmpMNOppack) this.statshrqry = dpcheng.StatShrQryWznmCmpMNOppack;
				if (dpcheng.StgIacQryWznmCmpMNOppack) this.stgiacqry = dpcheng.StgIacQryWznmCmpMNOppack;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCmpMNOppack) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCmpMNOppackData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCmpMNOppackData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
