...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCmpList.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCmpListData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCmpList": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCmpList"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCmpListData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCmpListData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContIacWznmCmpList) this.contiac = dpcheng.ContIacWznmCmpList;
				if (dpcheng.ContInfWznmCmpList) this.continf = dpcheng.ContInfWznmCmpList;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.FeedFTos) this.feedFTos = dpcheng.FeedFTos;
				if (dpcheng.StatShrWznmCmpList) this.statshr = dpcheng.StatShrWznmCmpList;
				if (dpcheng.StgIacWznmCmpList) this.stgiac = dpcheng.StgIacWznmCmpList;
				if (dpcheng.TagWznmCmpList) {
					Wznm.unescapeBlock(dpcheng.TagWznmCmpList);
					this.tag = dpcheng.TagWznmCmpList;
				}
				if (dpcheng.ListWznmQCmpList) this.rst = dpcheng.ListWznmQCmpList;
				if (dpcheng.StatAppQryWznmCmpList) this.statappqry = dpcheng.StatAppQryWznmCmpList;
				if (dpcheng.StatShrQryWznmCmpList) this.statshrqry = dpcheng.StatShrQryWznmCmpList;
				if (dpcheng.StgIacQryWznmCmpList) this.stgiacqry = dpcheng.StgIacQryWznmCmpList;
				if (dpcheng.ContInfWznmCmpList) {
				...
				*/
				...
				if (dpcheng.TagWznmCmpList) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoSrf", text: this.tag.TcoSrf}, {value: "TcoTit", text: this.tag.TcoTit}, {value: "TcoTyp", text: this.tag.TcoTyp}, {value: "TcoVer", text: this.tag.TcoVer});
					/*
					*/
				...
				if (dpcheng.ListWznmQCmpList) {
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoSrf: rec["srf"], TcoTit: rec["tit"], TcoTyp: rec["typ2"], TcoVer: rec["ver"]})
						/*
						*/
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCmpListData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCmpListData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
