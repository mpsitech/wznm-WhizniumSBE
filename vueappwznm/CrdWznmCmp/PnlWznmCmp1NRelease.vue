...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCmp1NRelease.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCmp1NReleaseData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCmp1NRelease": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCmp1NRelease"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCmp1NReleaseData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCmp1NReleaseData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCmp1NRelease) this.continf = dpcheng.ContInfWznmCmp1NRelease;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCmp1NRelease) this.statapp = dpcheng.StatAppWznmCmp1NRelease;
				if (dpcheng.StatShrWznmCmp1NRelease) this.statshr = dpcheng.StatShrWznmCmp1NRelease;
				if (dpcheng.StgIacWznmCmp1NRelease) this.stgiac = dpcheng.StgIacWznmCmp1NRelease;
				if (dpcheng.TagWznmCmp1NRelease) {
					Wznm.unescapeBlock(dpcheng.TagWznmCmp1NRelease);
					this.tag = dpcheng.TagWznmCmp1NRelease;
				}
				if (dpcheng.ListWznmQCmp1NRelease) this.rst = dpcheng.ListWznmQCmp1NRelease;
				if (dpcheng.StatAppQryWznmCmp1NRelease) this.statappqry = dpcheng.StatAppQryWznmCmp1NRelease;
				if (dpcheng.StatShrQryWznmCmp1NRelease) this.statshrqry = dpcheng.StatShrQryWznmCmp1NRelease;
				if (dpcheng.StgIacQryWznmCmp1NRelease) this.stgiacqry = dpcheng.StgIacQryWznmCmp1NRelease;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCmp1NRelease) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCmp1NReleaseData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCmp1NReleaseData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
