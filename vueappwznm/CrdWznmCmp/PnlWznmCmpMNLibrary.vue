...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCmpMNLibrary.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCmpMNLibraryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCmpMNLibrary": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCmpMNLibrary"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCmpMNLibraryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCmpMNLibraryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCmpMNLibrary) this.continf = dpcheng.ContInfWznmCmpMNLibrary;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCmpMNLibrary) this.statapp = dpcheng.StatAppWznmCmpMNLibrary;
				if (dpcheng.StatShrWznmCmpMNLibrary) this.statshr = dpcheng.StatShrWznmCmpMNLibrary;
				if (dpcheng.StgIacWznmCmpMNLibrary) this.stgiac = dpcheng.StgIacWznmCmpMNLibrary;
				if (dpcheng.TagWznmCmpMNLibrary) {
					Wznm.unescapeBlock(dpcheng.TagWznmCmpMNLibrary);
					this.tag = dpcheng.TagWznmCmpMNLibrary;
				}
				if (dpcheng.ListWznmQCmpMNLibrary) this.rst = dpcheng.ListWznmQCmpMNLibrary;
				if (dpcheng.StatAppQryWznmCmpMNLibrary) this.statappqry = dpcheng.StatAppQryWznmCmpMNLibrary;
				if (dpcheng.StatShrQryWznmCmpMNLibrary) this.statshrqry = dpcheng.StatShrQryWznmCmpMNLibrary;
				if (dpcheng.StgIacQryWznmCmpMNLibrary) this.stgiacqry = dpcheng.StgIacQryWznmCmpMNLibrary;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCmpMNLibrary) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCmpMNLibraryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCmpMNLibraryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
