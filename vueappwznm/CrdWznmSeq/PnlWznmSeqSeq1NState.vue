...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSeqSeq1NState.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSeqSeq1NStateData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSeqSeq1NState": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSeqSeq1NState"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSeqSeq1NStateData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSeqSeq1NStateData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSeqSeq1NState) this.continf = dpcheng.ContInfWznmSeqSeq1NState;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSeqSeq1NState) this.statapp = dpcheng.StatAppWznmSeqSeq1NState;
				if (dpcheng.StatShrWznmSeqSeq1NState) this.statshr = dpcheng.StatShrWznmSeqSeq1NState;
				if (dpcheng.StgIacWznmSeqSeq1NState) this.stgiac = dpcheng.StgIacWznmSeqSeq1NState;
				if (dpcheng.TagWznmSeqSeq1NState) {
					Wznm.unescapeBlock(dpcheng.TagWznmSeqSeq1NState);
					this.tag = dpcheng.TagWznmSeqSeq1NState;
				}
				if (dpcheng.ListWznmQSeqSeq1NState) this.rst = dpcheng.ListWznmQSeqSeq1NState;
				if (dpcheng.StatAppQryWznmSeqSeq1NState) this.statappqry = dpcheng.StatAppQryWznmSeqSeq1NState;
				if (dpcheng.StatShrQryWznmSeqSeq1NState) this.statshrqry = dpcheng.StatShrQryWznmSeqSeq1NState;
				if (dpcheng.StgIacQryWznmSeqSeq1NState) this.stgiacqry = dpcheng.StgIacQryWznmSeqSeq1NState;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSeqSeq1NState) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSeqSeq1NStateData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSeqSeq1NStateData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
