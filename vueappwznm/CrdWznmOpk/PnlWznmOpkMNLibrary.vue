...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpkMNLibrary.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpkMNLibraryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpkMNLibrary": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpkMNLibrary"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpkMNLibraryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpkMNLibraryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpkMNLibrary) this.continf = dpcheng.ContInfWznmOpkMNLibrary;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpkMNLibrary) this.statapp = dpcheng.StatAppWznmOpkMNLibrary;
				if (dpcheng.StatShrWznmOpkMNLibrary) this.statshr = dpcheng.StatShrWznmOpkMNLibrary;
				if (dpcheng.StgIacWznmOpkMNLibrary) this.stgiac = dpcheng.StgIacWznmOpkMNLibrary;
				if (dpcheng.TagWznmOpkMNLibrary) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpkMNLibrary);
					this.tag = dpcheng.TagWznmOpkMNLibrary;
				}
				if (dpcheng.ListWznmQOpkMNLibrary) this.rst = dpcheng.ListWznmQOpkMNLibrary;
				if (dpcheng.StatAppQryWznmOpkMNLibrary) this.statappqry = dpcheng.StatAppQryWznmOpkMNLibrary;
				if (dpcheng.StatShrQryWznmOpkMNLibrary) this.statshrqry = dpcheng.StatShrQryWznmOpkMNLibrary;
				if (dpcheng.StgIacQryWznmOpkMNLibrary) this.stgiacqry = dpcheng.StgIacQryWznmOpkMNLibrary;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpkMNLibrary) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpkMNLibraryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpkMNLibraryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
