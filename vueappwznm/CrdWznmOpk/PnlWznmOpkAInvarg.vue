...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpkAInvarg.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpkAInvargData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpkAInvarg": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpkAInvarg"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpkAInvargData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpkAInvargData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpkAInvarg) this.continf = dpcheng.ContInfWznmOpkAInvarg;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpkAInvarg) this.statapp = dpcheng.StatAppWznmOpkAInvarg;
				if (dpcheng.StatShrWznmOpkAInvarg) this.statshr = dpcheng.StatShrWznmOpkAInvarg;
				if (dpcheng.StgIacWznmOpkAInvarg) this.stgiac = dpcheng.StgIacWznmOpkAInvarg;
				if (dpcheng.TagWznmOpkAInvarg) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpkAInvarg);
					this.tag = dpcheng.TagWznmOpkAInvarg;
				}
				if (dpcheng.ListWznmQOpkAInvarg) this.rst = dpcheng.ListWznmQOpkAInvarg;
				if (dpcheng.StatAppQryWznmOpkAInvarg) this.statappqry = dpcheng.StatAppQryWznmOpkAInvarg;
				if (dpcheng.StatShrQryWznmOpkAInvarg) this.statshrqry = dpcheng.StatShrQryWznmOpkAInvarg;
				if (dpcheng.StgIacQryWznmOpkAInvarg) this.stgiacqry = dpcheng.StgIacQryWznmOpkAInvarg;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpkAInvarg) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpkAInvargData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpkAInvargData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
