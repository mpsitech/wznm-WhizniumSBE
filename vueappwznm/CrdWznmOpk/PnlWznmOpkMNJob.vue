...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpkMNJob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpkMNJobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpkMNJob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpkMNJob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpkMNJobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpkMNJobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpkMNJob) this.continf = dpcheng.ContInfWznmOpkMNJob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpkMNJob) this.statapp = dpcheng.StatAppWznmOpkMNJob;
				if (dpcheng.StatShrWznmOpkMNJob) this.statshr = dpcheng.StatShrWznmOpkMNJob;
				if (dpcheng.StgIacWznmOpkMNJob) this.stgiac = dpcheng.StgIacWznmOpkMNJob;
				if (dpcheng.TagWznmOpkMNJob) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpkMNJob);
					this.tag = dpcheng.TagWznmOpkMNJob;
				}
				if (dpcheng.ListWznmQOpkMNJob) this.rst = dpcheng.ListWznmQOpkMNJob;
				if (dpcheng.StatAppQryWznmOpkMNJob) this.statappqry = dpcheng.StatAppQryWznmOpkMNJob;
				if (dpcheng.StatShrQryWznmOpkMNJob) this.statshrqry = dpcheng.StatShrQryWznmOpkMNJob;
				if (dpcheng.StgIacQryWznmOpkMNJob) this.stgiacqry = dpcheng.StgIacQryWznmOpkMNJob;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpkMNJobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpkMNJobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
