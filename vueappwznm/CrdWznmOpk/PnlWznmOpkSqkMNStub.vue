...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpkSqkMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpkSqkMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpkSqkMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpkSqkMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpkSqkMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpkSqkMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpkSqkMNStub) this.continf = dpcheng.ContInfWznmOpkSqkMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpkSqkMNStub) this.statapp = dpcheng.StatAppWznmOpkSqkMNStub;
				if (dpcheng.StatShrWznmOpkSqkMNStub) this.statshr = dpcheng.StatShrWznmOpkSqkMNStub;
				if (dpcheng.StgIacWznmOpkSqkMNStub) this.stgiac = dpcheng.StgIacWznmOpkSqkMNStub;
				if (dpcheng.TagWznmOpkSqkMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpkSqkMNStub);
					this.tag = dpcheng.TagWznmOpkSqkMNStub;
				}
				if (dpcheng.ListWznmQOpkSqkMNStub) this.rst = dpcheng.ListWznmQOpkSqkMNStub;
				if (dpcheng.StatAppQryWznmOpkSqkMNStub) this.statappqry = dpcheng.StatAppQryWznmOpkSqkMNStub;
				if (dpcheng.StatShrQryWznmOpkSqkMNStub) this.statshrqry = dpcheng.StatShrQryWznmOpkSqkMNStub;
				if (dpcheng.StgIacQryWznmOpkSqkMNStub) this.stgiacqry = dpcheng.StgIacQryWznmOpkSqkMNStub;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpkSqkMNStub) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpkSqkMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpkSqkMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
