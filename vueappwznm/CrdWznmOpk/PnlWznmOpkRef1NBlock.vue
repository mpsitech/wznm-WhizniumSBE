...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpkRef1NBlock.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpkRef1NBlockData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpkRef1NBlock": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpkRef1NBlock"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpkRef1NBlockData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpkRef1NBlockData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpkRef1NBlock) this.continf = dpcheng.ContInfWznmOpkRef1NBlock;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpkRef1NBlock) this.statapp = dpcheng.StatAppWznmOpkRef1NBlock;
				if (dpcheng.StatShrWznmOpkRef1NBlock) this.statshr = dpcheng.StatShrWznmOpkRef1NBlock;
				if (dpcheng.StgIacWznmOpkRef1NBlock) this.stgiac = dpcheng.StgIacWznmOpkRef1NBlock;
				if (dpcheng.TagWznmOpkRef1NBlock) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpkRef1NBlock);
					this.tag = dpcheng.TagWznmOpkRef1NBlock;
				}
				if (dpcheng.ListWznmQOpkRef1NBlock) this.rst = dpcheng.ListWznmQOpkRef1NBlock;
				if (dpcheng.StatAppQryWznmOpkRef1NBlock) this.statappqry = dpcheng.StatAppQryWznmOpkRef1NBlock;
				if (dpcheng.StatShrQryWznmOpkRef1NBlock) this.statshrqry = dpcheng.StatShrQryWznmOpkRef1NBlock;
				if (dpcheng.StgIacQryWznmOpkRef1NBlock) this.stgiacqry = dpcheng.StgIacQryWznmOpkRef1NBlock;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpkRef1NBlock) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpkRef1NBlockData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpkRef1NBlockData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
