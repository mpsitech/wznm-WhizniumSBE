...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpk1NOp.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpk1NOpData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpk1NOp": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpk1NOp"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpk1NOpData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpk1NOpData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpk1NOp) this.continf = dpcheng.ContInfWznmOpk1NOp;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpk1NOp) this.statapp = dpcheng.StatAppWznmOpk1NOp;
				if (dpcheng.StatShrWznmOpk1NOp) this.statshr = dpcheng.StatShrWznmOpk1NOp;
				if (dpcheng.StgIacWznmOpk1NOp) this.stgiac = dpcheng.StgIacWznmOpk1NOp;
				if (dpcheng.TagWznmOpk1NOp) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpk1NOp);
					this.tag = dpcheng.TagWznmOpk1NOp;
				}
				if (dpcheng.ListWznmQOpk1NOp) this.rst = dpcheng.ListWznmQOpk1NOp;
				if (dpcheng.StatAppQryWznmOpk1NOp) this.statappqry = dpcheng.StatAppQryWznmOpk1NOp;
				if (dpcheng.StatShrQryWznmOpk1NOp) this.statshrqry = dpcheng.StatShrQryWznmOpk1NOp;
				if (dpcheng.StgIacQryWznmOpk1NOp) this.stgiacqry = dpcheng.StgIacQryWznmOpk1NOp;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpk1NOpData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpk1NOpData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
