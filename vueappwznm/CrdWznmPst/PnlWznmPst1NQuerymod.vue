...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmPst1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmPst1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmPst1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmPst1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmPst1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmPst1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmPst1NQuerymod) this.continf = dpcheng.ContInfWznmPst1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmPst1NQuerymod) this.statapp = dpcheng.StatAppWznmPst1NQuerymod;
				if (dpcheng.StatShrWznmPst1NQuerymod) this.statshr = dpcheng.StatShrWznmPst1NQuerymod;
				if (dpcheng.StgIacWznmPst1NQuerymod) this.stgiac = dpcheng.StgIacWznmPst1NQuerymod;
				if (dpcheng.TagWznmPst1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmPst1NQuerymod);
					this.tag = dpcheng.TagWznmPst1NQuerymod;
				}
				if (dpcheng.ListWznmQPst1NQuerymod) this.rst = dpcheng.ListWznmQPst1NQuerymod;
				if (dpcheng.StatAppQryWznmPst1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmPst1NQuerymod;
				if (dpcheng.StatShrQryWznmPst1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmPst1NQuerymod;
				if (dpcheng.StgIacQryWznmPst1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmPst1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQPst1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmPst1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmPst1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
