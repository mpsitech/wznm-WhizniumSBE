...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmLibRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmLibRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmLibRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmLibRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmLibRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmLibRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmLibRef1NFile) this.continf = dpcheng.ContInfWznmLibRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmLibRef1NFile) this.statapp = dpcheng.StatAppWznmLibRef1NFile;
				if (dpcheng.StatShrWznmLibRef1NFile) this.statshr = dpcheng.StatShrWznmLibRef1NFile;
				if (dpcheng.StgIacWznmLibRef1NFile) this.stgiac = dpcheng.StgIacWznmLibRef1NFile;
				if (dpcheng.TagWznmLibRef1NFile) {
					Wznm.unescapeBlock(dpcheng.TagWznmLibRef1NFile);
					this.tag = dpcheng.TagWznmLibRef1NFile;
				}
				if (dpcheng.ListWznmQLibRef1NFile) this.rst = dpcheng.ListWznmQLibRef1NFile;
				if (dpcheng.StatAppQryWznmLibRef1NFile) this.statappqry = dpcheng.StatAppQryWznmLibRef1NFile;
				if (dpcheng.StatShrQryWznmLibRef1NFile) this.statshrqry = dpcheng.StatShrQryWznmLibRef1NFile;
				if (dpcheng.StgIacQryWznmLibRef1NFile) this.stgiacqry = dpcheng.StgIacQryWznmLibRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQLibRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmLibRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmLibRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
