...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRlsList.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRlsListData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRlsList": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRlsList"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRlsListData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRlsListData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContIacWznmRlsList) this.contiac = dpcheng.ContIacWznmRlsList;
				if (dpcheng.ContInfWznmRlsList) this.continf = dpcheng.ContInfWznmRlsList;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.FeedFTos) this.feedFTos = dpcheng.FeedFTos;
				if (dpcheng.StatShrWznmRlsList) this.statshr = dpcheng.StatShrWznmRlsList;
				if (dpcheng.StgIacWznmRlsList) this.stgiac = dpcheng.StgIacWznmRlsList;
				if (dpcheng.TagWznmRlsList) {
					Wznm.unescapeBlock(dpcheng.TagWznmRlsList);
					this.tag = dpcheng.TagWznmRlsList;
				}
				if (dpcheng.ListWznmQRlsList) this.rst = dpcheng.ListWznmQRlsList;
				if (dpcheng.StatAppQryWznmRlsList) this.statappqry = dpcheng.StatAppQryWznmRlsList;
				if (dpcheng.StatShrQryWznmRlsList) this.statshrqry = dpcheng.StatShrQryWznmRlsList;
				if (dpcheng.StgIacQryWznmRlsList) this.stgiacqry = dpcheng.StgIacQryWznmRlsList;
				if (dpcheng.ContInfWznmRlsList) {
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRlsListData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRlsListData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
