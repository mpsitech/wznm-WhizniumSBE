...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmDlgMNQuery.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmDlgMNQueryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmDlgMNQuery": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmDlgMNQuery"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmDlgMNQueryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmDlgMNQueryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmDlgMNQuery) this.continf = dpcheng.ContInfWznmDlgMNQuery;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmDlgMNQuery) this.statapp = dpcheng.StatAppWznmDlgMNQuery;
				if (dpcheng.StatShrWznmDlgMNQuery) this.statshr = dpcheng.StatShrWznmDlgMNQuery;
				if (dpcheng.StgIacWznmDlgMNQuery) this.stgiac = dpcheng.StgIacWznmDlgMNQuery;
				if (dpcheng.TagWznmDlgMNQuery) {
					Wznm.unescapeBlock(dpcheng.TagWznmDlgMNQuery);
					this.tag = dpcheng.TagWznmDlgMNQuery;
				}
				if (dpcheng.ListWznmQDlgMNQuery) this.rst = dpcheng.ListWznmQDlgMNQuery;
				if (dpcheng.StatAppQryWznmDlgMNQuery) this.statappqry = dpcheng.StatAppQryWznmDlgMNQuery;
				if (dpcheng.StatShrQryWznmDlgMNQuery) this.statshrqry = dpcheng.StatShrQryWznmDlgMNQuery;
				if (dpcheng.StgIacQryWznmDlgMNQuery) this.stgiacqry = dpcheng.StgIacQryWznmDlgMNQuery;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQDlgMNQuery) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmDlgMNQueryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmDlgMNQueryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
