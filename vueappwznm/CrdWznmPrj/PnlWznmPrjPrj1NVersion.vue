...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmPrjPrj1NVersion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmPrjPrj1NVersionData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmPrjPrj1NVersion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmPrjPrj1NVersion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmPrjPrj1NVersionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmPrjPrj1NVersionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmPrjPrj1NVersion) this.continf = dpcheng.ContInfWznmPrjPrj1NVersion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmPrjPrj1NVersion) this.statapp = dpcheng.StatAppWznmPrjPrj1NVersion;
				if (dpcheng.StatShrWznmPrjPrj1NVersion) this.statshr = dpcheng.StatShrWznmPrjPrj1NVersion;
				if (dpcheng.StgIacWznmPrjPrj1NVersion) this.stgiac = dpcheng.StgIacWznmPrjPrj1NVersion;
				if (dpcheng.TagWznmPrjPrj1NVersion) {
					Wznm.unescapeBlock(dpcheng.TagWznmPrjPrj1NVersion);
					this.tag = dpcheng.TagWznmPrjPrj1NVersion;
				}
				if (dpcheng.ListWznmQPrjPrj1NVersion) this.rst = dpcheng.ListWznmQPrjPrj1NVersion;
				if (dpcheng.StatAppQryWznmPrjPrj1NVersion) this.statappqry = dpcheng.StatAppQryWznmPrjPrj1NVersion;
				if (dpcheng.StatShrQryWznmPrjPrj1NVersion) this.statshrqry = dpcheng.StatShrQryWznmPrjPrj1NVersion;
				if (dpcheng.StgIacQryWznmPrjPrj1NVersion) this.stgiacqry = dpcheng.StgIacQryWznmPrjPrj1NVersion;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQPrjPrj1NVersion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmPrjPrj1NVersionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmPrjPrj1NVersionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
