...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmJobHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmJobHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmJobHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmJobHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmJobHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmJobHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmJobHk1NVector) this.continf = dpcheng.ContInfWznmJobHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmJobHk1NVector) this.statapp = dpcheng.StatAppWznmJobHk1NVector;
				if (dpcheng.StatShrWznmJobHk1NVector) this.statshr = dpcheng.StatShrWznmJobHk1NVector;
				if (dpcheng.StgIacWznmJobHk1NVector) this.stgiac = dpcheng.StgIacWznmJobHk1NVector;
				if (dpcheng.TagWznmJobHk1NVector) {
					Wznm.unescapeBlock(dpcheng.TagWznmJobHk1NVector);
					this.tag = dpcheng.TagWznmJobHk1NVector;
				}
				if (dpcheng.ListWznmQJobHk1NVector) this.rst = dpcheng.ListWznmQJobHk1NVector;
				if (dpcheng.StatAppQryWznmJobHk1NVector) this.statappqry = dpcheng.StatAppQryWznmJobHk1NVector;
				if (dpcheng.StatShrQryWznmJobHk1NVector) this.statshrqry = dpcheng.StatShrQryWznmJobHk1NVector;
				if (dpcheng.StgIacQryWznmJobHk1NVector) this.stgiacqry = dpcheng.StgIacQryWznmJobHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQJobHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmJobHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmJobHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
