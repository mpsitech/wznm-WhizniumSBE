...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmJobRef1NBlock.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmJobRef1NBlockData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmJobRef1NBlock": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmJobRef1NBlock"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmJobRef1NBlockData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmJobRef1NBlockData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmJobRef1NBlock) this.continf = dpcheng.ContInfWznmJobRef1NBlock;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmJobRef1NBlock) this.statapp = dpcheng.StatAppWznmJobRef1NBlock;
				if (dpcheng.StatShrWznmJobRef1NBlock) this.statshr = dpcheng.StatShrWznmJobRef1NBlock;
				if (dpcheng.StgIacWznmJobRef1NBlock) this.stgiac = dpcheng.StgIacWznmJobRef1NBlock;
				if (dpcheng.TagWznmJobRef1NBlock) {
					Wznm.unescapeBlock(dpcheng.TagWznmJobRef1NBlock);
					this.tag = dpcheng.TagWznmJobRef1NBlock;
				}
				if (dpcheng.ListWznmQJobRef1NBlock) this.rst = dpcheng.ListWznmQJobRef1NBlock;
				if (dpcheng.StatAppQryWznmJobRef1NBlock) this.statappqry = dpcheng.StatAppQryWznmJobRef1NBlock;
				if (dpcheng.StatShrQryWznmJobRef1NBlock) this.statshrqry = dpcheng.StatShrQryWznmJobRef1NBlock;
				if (dpcheng.StgIacQryWznmJobRef1NBlock) this.stgiacqry = dpcheng.StgIacQryWznmJobRef1NBlock;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQJobRef1NBlock) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmJobRef1NBlockData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmJobRef1NBlockData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
