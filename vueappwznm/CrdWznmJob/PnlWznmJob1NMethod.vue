...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmJob1NMethod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmJob1NMethodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmJob1NMethod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmJob1NMethod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmJob1NMethodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmJob1NMethodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmJob1NMethod) this.continf = dpcheng.ContInfWznmJob1NMethod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmJob1NMethod) this.statapp = dpcheng.StatAppWznmJob1NMethod;
				if (dpcheng.StatShrWznmJob1NMethod) this.statshr = dpcheng.StatShrWznmJob1NMethod;
				if (dpcheng.StgIacWznmJob1NMethod) this.stgiac = dpcheng.StgIacWznmJob1NMethod;
				if (dpcheng.TagWznmJob1NMethod) {
					Wznm.unescapeBlock(dpcheng.TagWznmJob1NMethod);
					this.tag = dpcheng.TagWznmJob1NMethod;
				}
				if (dpcheng.ListWznmQJob1NMethod) this.rst = dpcheng.ListWznmQJob1NMethod;
				if (dpcheng.StatAppQryWznmJob1NMethod) this.statappqry = dpcheng.StatAppQryWznmJob1NMethod;
				if (dpcheng.StatShrQryWznmJob1NMethod) this.statshrqry = dpcheng.StatShrQryWznmJob1NMethod;
				if (dpcheng.StgIacQryWznmJob1NMethod) this.stgiacqry = dpcheng.StgIacQryWznmJob1NMethod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQJob1NMethod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmJob1NMethodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmJob1NMethodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
