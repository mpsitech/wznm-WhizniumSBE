...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmJobSupMNJob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmJobSupMNJobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmJobSupMNJob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmJobSupMNJob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmJobSupMNJobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmJobSupMNJobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmJobSupMNJob) this.continf = dpcheng.ContInfWznmJobSupMNJob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmJobSupMNJob) this.statapp = dpcheng.StatAppWznmJobSupMNJob;
				if (dpcheng.StatShrWznmJobSupMNJob) this.statshr = dpcheng.StatShrWznmJobSupMNJob;
				if (dpcheng.StgIacWznmJobSupMNJob) this.stgiac = dpcheng.StgIacWznmJobSupMNJob;
				if (dpcheng.TagWznmJobSupMNJob) {
					Wznm.unescapeBlock(dpcheng.TagWznmJobSupMNJob);
					this.tag = dpcheng.TagWznmJobSupMNJob;
				}
				if (dpcheng.ListWznmQJobSupMNJob) this.rst = dpcheng.ListWznmQJobSupMNJob;
				if (dpcheng.StatAppQryWznmJobSupMNJob) this.statappqry = dpcheng.StatAppQryWznmJobSupMNJob;
				if (dpcheng.StatShrQryWznmJobSupMNJob) this.statshrqry = dpcheng.StatShrQryWznmJobSupMNJob;
				if (dpcheng.StgIacQryWznmJobSupMNJob) this.stgiacqry = dpcheng.StgIacQryWznmJobSupMNJob;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQJobSupMNJob) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmJobSupMNJobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmJobSupMNJobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
