...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmJob1NRtjob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmJob1NRtjobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmJob1NRtjob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmJob1NRtjob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmJob1NRtjobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmJob1NRtjobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmJob1NRtjob) this.continf = dpcheng.ContInfWznmJob1NRtjob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmJob1NRtjob) this.statapp = dpcheng.StatAppWznmJob1NRtjob;
				if (dpcheng.StatShrWznmJob1NRtjob) this.statshr = dpcheng.StatShrWznmJob1NRtjob;
				if (dpcheng.StgIacWznmJob1NRtjob) this.stgiac = dpcheng.StgIacWznmJob1NRtjob;
				if (dpcheng.TagWznmJob1NRtjob) {
					Wznm.unescapeBlock(dpcheng.TagWznmJob1NRtjob);
					this.tag = dpcheng.TagWznmJob1NRtjob;
				}
				if (dpcheng.ListWznmQJob1NRtjob) this.rst = dpcheng.ListWznmQJob1NRtjob;
				if (dpcheng.StatAppQryWznmJob1NRtjob) this.statappqry = dpcheng.StatAppQryWznmJob1NRtjob;
				if (dpcheng.StatShrQryWznmJob1NRtjob) this.statshrqry = dpcheng.StatShrQryWznmJob1NRtjob;
				if (dpcheng.StgIacQryWznmJob1NRtjob) this.stgiacqry = dpcheng.StgIacQryWznmJob1NRtjob;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQJob1NRtjob) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmJob1NRtjobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmJob1NRtjobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
