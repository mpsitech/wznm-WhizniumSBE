...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmBoxOrgMNBox.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmBoxOrgMNBoxData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmBoxOrgMNBox": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmBoxOrgMNBox"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmBoxOrgMNBoxData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmBoxOrgMNBoxData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmBoxOrgMNBox) this.continf = dpcheng.ContInfWznmBoxOrgMNBox;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmBoxOrgMNBox) this.statapp = dpcheng.StatAppWznmBoxOrgMNBox;
				if (dpcheng.StatShrWznmBoxOrgMNBox) this.statshr = dpcheng.StatShrWznmBoxOrgMNBox;
				if (dpcheng.StgIacWznmBoxOrgMNBox) this.stgiac = dpcheng.StgIacWznmBoxOrgMNBox;
				if (dpcheng.TagWznmBoxOrgMNBox) {
					Wznm.unescapeBlock(dpcheng.TagWznmBoxOrgMNBox);
					this.tag = dpcheng.TagWznmBoxOrgMNBox;
				}
				if (dpcheng.ListWznmQBoxOrgMNBox) this.rst = dpcheng.ListWznmQBoxOrgMNBox;
				if (dpcheng.StatAppQryWznmBoxOrgMNBox) this.statappqry = dpcheng.StatAppQryWznmBoxOrgMNBox;
				if (dpcheng.StatShrQryWznmBoxOrgMNBox) this.statshrqry = dpcheng.StatShrQryWznmBoxOrgMNBox;
				if (dpcheng.StgIacQryWznmBoxOrgMNBox) this.stgiacqry = dpcheng.StgIacQryWznmBoxOrgMNBox;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQBoxOrgMNBox) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmBoxOrgMNBoxData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmBoxOrgMNBoxData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
