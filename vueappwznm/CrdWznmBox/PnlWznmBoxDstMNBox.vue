...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmBoxDstMNBox.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmBoxDstMNBoxData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmBoxDstMNBox": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmBoxDstMNBox"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmBoxDstMNBoxData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmBoxDstMNBoxData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmBoxDstMNBox) this.continf = dpcheng.ContInfWznmBoxDstMNBox;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmBoxDstMNBox) this.statapp = dpcheng.StatAppWznmBoxDstMNBox;
				if (dpcheng.StatShrWznmBoxDstMNBox) this.statshr = dpcheng.StatShrWznmBoxDstMNBox;
				if (dpcheng.StgIacWznmBoxDstMNBox) this.stgiac = dpcheng.StgIacWznmBoxDstMNBox;
				if (dpcheng.TagWznmBoxDstMNBox) {
					Wznm.unescapeBlock(dpcheng.TagWznmBoxDstMNBox);
					this.tag = dpcheng.TagWznmBoxDstMNBox;
				}
				if (dpcheng.ListWznmQBoxDstMNBox) this.rst = dpcheng.ListWznmQBoxDstMNBox;
				if (dpcheng.StatAppQryWznmBoxDstMNBox) this.statappqry = dpcheng.StatAppQryWznmBoxDstMNBox;
				if (dpcheng.StatShrQryWznmBoxDstMNBox) this.statshrqry = dpcheng.StatShrQryWznmBoxDstMNBox;
				if (dpcheng.StgIacQryWznmBoxDstMNBox) this.stgiacqry = dpcheng.StgIacQryWznmBoxDstMNBox;
				/*
				...
				*/
				...
				if (dpcheng.TagWznmBoxDstMNBox) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoMref", text: this.tag.TcoMref}, {value: "TcoOcl", text: this.tag.TcoOcl}, {value: "TcoDcl", text: this.tag.TcoDcl}, {value: "TcoWgt", text: this.tag.TcoWgt});
					/*
					*/
				...
				if (dpcheng.ListWznmQBoxDstMNBox) {
					var rows = [];
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoMref: rec["mref"], TcoOcl: rec["ocl"], TcoDcl: rec["dcl"], TcoWgt: rec["wgt"]})
						/*
						*/
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmBoxDstMNBoxData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmBoxDstMNBoxData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
