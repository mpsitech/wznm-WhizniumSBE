...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmImeHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmImeHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmImeHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmImeHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmImeHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmImeHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmImeHk1NVector) this.continf = dpcheng.ContInfWznmImeHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmImeHk1NVector) this.statapp = dpcheng.StatAppWznmImeHk1NVector;
				if (dpcheng.StatShrWznmImeHk1NVector) this.statshr = dpcheng.StatShrWznmImeHk1NVector;
				if (dpcheng.StgIacWznmImeHk1NVector) this.stgiac = dpcheng.StgIacWznmImeHk1NVector;
				if (dpcheng.TagWznmImeHk1NVector) {
					Wznm.unescapeBlock(dpcheng.TagWznmImeHk1NVector);
					this.tag = dpcheng.TagWznmImeHk1NVector;
				}
				if (dpcheng.ListWznmQImeHk1NVector) this.rst = dpcheng.ListWznmQImeHk1NVector;
				if (dpcheng.StatAppQryWznmImeHk1NVector) this.statappqry = dpcheng.StatAppQryWznmImeHk1NVector;
				if (dpcheng.StatShrQryWznmImeHk1NVector) this.statshrqry = dpcheng.StatShrQryWznmImeHk1NVector;
				if (dpcheng.StgIacQryWznmImeHk1NVector) this.stgiacqry = dpcheng.StgIacQryWznmImeHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQImeHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmImeHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmImeHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
