...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmImeSup1NImpexp.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmImeSup1NImpexpData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmImeSup1NImpexp": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmImeSup1NImpexp"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmImeSup1NImpexpData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmImeSup1NImpexpData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmImeSup1NImpexp) this.continf = dpcheng.ContInfWznmImeSup1NImpexp;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmImeSup1NImpexp) this.statapp = dpcheng.StatAppWznmImeSup1NImpexp;
				if (dpcheng.StatShrWznmImeSup1NImpexp) this.statshr = dpcheng.StatShrWznmImeSup1NImpexp;
				if (dpcheng.StgIacWznmImeSup1NImpexp) this.stgiac = dpcheng.StgIacWznmImeSup1NImpexp;
				if (dpcheng.TagWznmImeSup1NImpexp) {
					Wznm.unescapeBlock(dpcheng.TagWznmImeSup1NImpexp);
					this.tag = dpcheng.TagWznmImeSup1NImpexp;
				}
				if (dpcheng.ListWznmQImeSup1NImpexp) this.rst = dpcheng.ListWznmQImeSup1NImpexp;
				if (dpcheng.StatAppQryWznmImeSup1NImpexp) this.statappqry = dpcheng.StatAppQryWznmImeSup1NImpexp;
				if (dpcheng.StatShrQryWznmImeSup1NImpexp) this.statshrqry = dpcheng.StatShrQryWznmImeSup1NImpexp;
				if (dpcheng.StgIacQryWznmImeSup1NImpexp) this.stgiacqry = dpcheng.StgIacQryWznmImeSup1NImpexp;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQImeSup1NImpexp) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmImeSup1NImpexpData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmImeSup1NImpexpData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
