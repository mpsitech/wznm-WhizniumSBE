...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmImeIme1NImpexpcol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWznmImeIme1NImpexpcolDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmImeIme1NImpexpcolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmImeIme1NImpexpcol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmImeIme1NImpexpcol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmImeIme1NImpexpcolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmImeIme1NImpexpcolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmImeIme1NImpexpcol) this.continf = dpcheng.ContInfWznmImeIme1NImpexpcol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmImeIme1NImpexpcol) this.statapp = dpcheng.StatAppWznmImeIme1NImpexpcol;
				if (dpcheng.StatShrWznmImeIme1NImpexpcol) this.statshr = dpcheng.StatShrWznmImeIme1NImpexpcol;
				if (dpcheng.StgIacWznmImeIme1NImpexpcol) this.stgiac = dpcheng.StgIacWznmImeIme1NImpexpcol;
				if (dpcheng.TagWznmImeIme1NImpexpcol) {
					Wznm.unescapeBlock(dpcheng.TagWznmImeIme1NImpexpcol);
					this.tag = dpcheng.TagWznmImeIme1NImpexpcol;
				}
				if (dpcheng.ListWznmQImeIme1NImpexpcol) this.rst = dpcheng.ListWznmQImeIme1NImpexpcol;
				if (dpcheng.StatAppQryWznmImeIme1NImpexpcol) this.statappqry = dpcheng.StatAppQryWznmImeIme1NImpexpcol;
				if (dpcheng.StatShrQryWznmImeIme1NImpexpcol) this.statshrqry = dpcheng.StatShrQryWznmImeIme1NImpexpcol;
				if (dpcheng.StgIacQryWznmImeIme1NImpexpcol) this.stgiacqry = dpcheng.StgIacQryWznmImeIme1NImpexpcol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQImeIme1NImpexpcol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmImeIme1NImpexpcolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmImeIme1NImpexpcolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
