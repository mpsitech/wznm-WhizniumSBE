...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmQryMNPanel.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmQryMNPanelData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmQryMNPanel": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmQryMNPanel"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmQryMNPanelData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmQryMNPanelData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmQryMNPanel) this.continf = dpcheng.ContInfWznmQryMNPanel;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmQryMNPanel) this.statapp = dpcheng.StatAppWznmQryMNPanel;
				if (dpcheng.StatShrWznmQryMNPanel) this.statshr = dpcheng.StatShrWznmQryMNPanel;
				if (dpcheng.StgIacWznmQryMNPanel) this.stgiac = dpcheng.StgIacWznmQryMNPanel;
				if (dpcheng.TagWznmQryMNPanel) {
					Wznm.unescapeBlock(dpcheng.TagWznmQryMNPanel);
					this.tag = dpcheng.TagWznmQryMNPanel;
				}
				if (dpcheng.ListWznmQQryMNPanel) this.rst = dpcheng.ListWznmQQryMNPanel;
				if (dpcheng.StatAppQryWznmQryMNPanel) this.statappqry = dpcheng.StatAppQryWznmQryMNPanel;
				if (dpcheng.StatShrQryWznmQryMNPanel) this.statshrqry = dpcheng.StatShrQryWznmQryMNPanel;
				if (dpcheng.StgIacQryWznmQryMNPanel) this.stgiacqry = dpcheng.StgIacQryWznmQryMNPanel;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQQryMNPanel) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmQryMNPanelData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmQryMNPanelData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
