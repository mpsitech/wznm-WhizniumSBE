...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmQryMNDialog.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmQryMNDialogData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmQryMNDialog": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmQryMNDialog"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmQryMNDialogData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmQryMNDialogData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmQryMNDialog) this.continf = dpcheng.ContInfWznmQryMNDialog;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmQryMNDialog) this.statapp = dpcheng.StatAppWznmQryMNDialog;
				if (dpcheng.StatShrWznmQryMNDialog) this.statshr = dpcheng.StatShrWznmQryMNDialog;
				if (dpcheng.StgIacWznmQryMNDialog) this.stgiac = dpcheng.StgIacWznmQryMNDialog;
				if (dpcheng.TagWznmQryMNDialog) {
					Wznm.unescapeBlock(dpcheng.TagWznmQryMNDialog);
					this.tag = dpcheng.TagWznmQryMNDialog;
				}
				if (dpcheng.ListWznmQQryMNDialog) this.rst = dpcheng.ListWznmQQryMNDialog;
				if (dpcheng.StatAppQryWznmQryMNDialog) this.statappqry = dpcheng.StatAppQryWznmQryMNDialog;
				if (dpcheng.StatShrQryWznmQryMNDialog) this.statshrqry = dpcheng.StatShrQryWznmQryMNDialog;
				if (dpcheng.StgIacQryWznmQryMNDialog) this.stgiacqry = dpcheng.StgIacQryWznmQryMNDialog;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQQryMNDialog) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmQryMNDialogData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmQryMNDialogData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
