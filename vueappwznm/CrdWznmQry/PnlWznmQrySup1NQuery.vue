...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmQrySup1NQuery.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmQrySup1NQueryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmQrySup1NQuery": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmQrySup1NQuery"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmQrySup1NQueryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmQrySup1NQueryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmQrySup1NQuery) this.continf = dpcheng.ContInfWznmQrySup1NQuery;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmQrySup1NQuery) this.statapp = dpcheng.StatAppWznmQrySup1NQuery;
				if (dpcheng.StatShrWznmQrySup1NQuery) this.statshr = dpcheng.StatShrWznmQrySup1NQuery;
				if (dpcheng.StgIacWznmQrySup1NQuery) this.stgiac = dpcheng.StgIacWznmQrySup1NQuery;
				if (dpcheng.TagWznmQrySup1NQuery) {
					Wznm.unescapeBlock(dpcheng.TagWznmQrySup1NQuery);
					this.tag = dpcheng.TagWznmQrySup1NQuery;
				}
				if (dpcheng.ListWznmQQrySup1NQuery) this.rst = dpcheng.ListWznmQQrySup1NQuery;
				if (dpcheng.StatAppQryWznmQrySup1NQuery) this.statappqry = dpcheng.StatAppQryWznmQrySup1NQuery;
				if (dpcheng.StatShrQryWznmQrySup1NQuery) this.statshrqry = dpcheng.StatShrQryWznmQrySup1NQuery;
				if (dpcheng.StgIacQryWznmQrySup1NQuery) this.stgiacqry = dpcheng.StgIacQryWznmQrySup1NQuery;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQQrySup1NQuery) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmQrySup1NQueryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmQrySup1NQueryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
