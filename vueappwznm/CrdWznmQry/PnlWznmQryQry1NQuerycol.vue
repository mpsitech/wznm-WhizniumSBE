...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmQryQry1NQuerycol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmQryQry1NQuerycolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmQryQry1NQuerycol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmQryQry1NQuerycol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmQryQry1NQuerycolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmQryQry1NQuerycolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmQryQry1NQuerycol) this.continf = dpcheng.ContInfWznmQryQry1NQuerycol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmQryQry1NQuerycol) this.statapp = dpcheng.StatAppWznmQryQry1NQuerycol;
				if (dpcheng.StatShrWznmQryQry1NQuerycol) this.statshr = dpcheng.StatShrWznmQryQry1NQuerycol;
				if (dpcheng.StgIacWznmQryQry1NQuerycol) this.stgiac = dpcheng.StgIacWznmQryQry1NQuerycol;
				if (dpcheng.TagWznmQryQry1NQuerycol) {
					Wznm.unescapeBlock(dpcheng.TagWznmQryQry1NQuerycol);
					this.tag = dpcheng.TagWznmQryQry1NQuerycol;
				}
				if (dpcheng.ListWznmQQryQry1NQuerycol) this.rst = dpcheng.ListWznmQQryQry1NQuerycol;
				if (dpcheng.StatAppQryWznmQryQry1NQuerycol) this.statappqry = dpcheng.StatAppQryWznmQryQry1NQuerycol;
				if (dpcheng.StatShrQryWznmQryQry1NQuerycol) this.statshrqry = dpcheng.StatShrQryWznmQryQry1NQuerycol;
				if (dpcheng.StgIacQryWznmQryQry1NQuerycol) this.stgiacqry = dpcheng.StgIacQryWznmQryQry1NQuerycol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQQryQry1NQuerycol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmQryQry1NQuerycolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmQryQry1NQuerycolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
