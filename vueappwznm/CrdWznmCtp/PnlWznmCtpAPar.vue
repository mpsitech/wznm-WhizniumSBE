...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCtpAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCtpAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCtpAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCtpAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCtpAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCtpAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCtpAPar) this.continf = dpcheng.ContInfWznmCtpAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCtpAPar) this.statapp = dpcheng.StatAppWznmCtpAPar;
				if (dpcheng.StatShrWznmCtpAPar) this.statshr = dpcheng.StatShrWznmCtpAPar;
				if (dpcheng.StgIacWznmCtpAPar) this.stgiac = dpcheng.StgIacWznmCtpAPar;
				if (dpcheng.TagWznmCtpAPar) {
					Wznm.unescapeBlock(dpcheng.TagWznmCtpAPar);
					this.tag = dpcheng.TagWznmCtpAPar;
				}
				if (dpcheng.ListWznmQCtpAPar) this.rst = dpcheng.ListWznmQCtpAPar;
				if (dpcheng.StatAppQryWznmCtpAPar) this.statappqry = dpcheng.StatAppQryWznmCtpAPar;
				if (dpcheng.StatShrQryWznmCtpAPar) this.statshrqry = dpcheng.StatShrQryWznmCtpAPar;
				if (dpcheng.StgIacQryWznmCtpAPar) this.stgiacqry = dpcheng.StgIacQryWznmCtpAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCtpAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCtpAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
