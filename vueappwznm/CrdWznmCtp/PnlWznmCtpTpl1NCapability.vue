...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWznmCtpTpl1NCapability',
		...
		mounted() {
			//console.log("PnlWznmCtpTpl1NCapability.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWznmCtpTpl1NCapabilityDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCtpTpl1NCapabilityData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCtpTpl1NCapability": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCtpTpl1NCapability"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCtpTpl1NCapabilityData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCtpTpl1NCapabilityData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCtpTpl1NCapability) this.continf = dpcheng.ContInfWznmCtpTpl1NCapability;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCtpTpl1NCapability) this.statapp = dpcheng.StatAppWznmCtpTpl1NCapability;
				if (dpcheng.StatShrWznmCtpTpl1NCapability) this.statshr = dpcheng.StatShrWznmCtpTpl1NCapability;
				if (dpcheng.StgIacWznmCtpTpl1NCapability) this.stgiac = dpcheng.StgIacWznmCtpTpl1NCapability;
				if (dpcheng.TagWznmCtpTpl1NCapability) {
					Wznm.unescapeBlock(dpcheng.TagWznmCtpTpl1NCapability);
					this.tag = dpcheng.TagWznmCtpTpl1NCapability;
				}
				if (dpcheng.ListWznmQCtpTpl1NCapability) this.rst = dpcheng.ListWznmQCtpTpl1NCapability;
				if (dpcheng.StatAppQryWznmCtpTpl1NCapability) this.statappqry = dpcheng.StatAppQryWznmCtpTpl1NCapability;
				if (dpcheng.StatShrQryWznmCtpTpl1NCapability) this.statshrqry = dpcheng.StatShrQryWznmCtpTpl1NCapability;
				if (dpcheng.StgIacQryWznmCtpTpl1NCapability) this.stgiacqry = dpcheng.StgIacQryWznmCtpTpl1NCapability;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQCtpTpl1NCapability) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCtpTpl1NCapabilityData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCtpTpl1NCapabilityData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
