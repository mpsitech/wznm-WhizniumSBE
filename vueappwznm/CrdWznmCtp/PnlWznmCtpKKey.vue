...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCtpKKey.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCtpKKeyData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCtpKKey": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCtpKKey"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCtpKKeyData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCtpKKeyData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCtpKKey) this.continf = dpcheng.ContInfWznmCtpKKey;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCtpKKey) this.statapp = dpcheng.StatAppWznmCtpKKey;
				if (dpcheng.StatShrWznmCtpKKey) this.statshr = dpcheng.StatShrWznmCtpKKey;
				if (dpcheng.StgIacWznmCtpKKey) this.stgiac = dpcheng.StgIacWznmCtpKKey;
				if (dpcheng.TagWznmCtpKKey) {
					Wznm.unescapeBlock(dpcheng.TagWznmCtpKKey);
					this.tag = dpcheng.TagWznmCtpKKey;
				}
				if (dpcheng.ListWznmQCtpKKey) this.rst = dpcheng.ListWznmQCtpKKey;
				if (dpcheng.StatAppQryWznmCtpKKey) this.statappqry = dpcheng.StatAppQryWznmCtpKKey;
				if (dpcheng.StatShrQryWznmCtpKKey) this.statshrqry = dpcheng.StatShrQryWznmCtpKKey;
				if (dpcheng.StgIacQryWznmCtpKKey) this.stgiacqry = dpcheng.StgIacQryWznmCtpKKey;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCtpKKeyData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCtpKKeyData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
