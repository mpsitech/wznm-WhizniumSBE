...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmCtp1NTag.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmCtp1NTagData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmCtp1NTag": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmCtp1NTag"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmCtp1NTagData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmCtp1NTagData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmCtp1NTag) this.continf = dpcheng.ContInfWznmCtp1NTag;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmCtp1NTag) this.statapp = dpcheng.StatAppWznmCtp1NTag;
				if (dpcheng.StatShrWznmCtp1NTag) this.statshr = dpcheng.StatShrWznmCtp1NTag;
				if (dpcheng.StgIacWznmCtp1NTag) this.stgiac = dpcheng.StgIacWznmCtp1NTag;
				if (dpcheng.TagWznmCtp1NTag) {
					Wznm.unescapeBlock(dpcheng.TagWznmCtp1NTag);
					this.tag = dpcheng.TagWznmCtp1NTag;
				}
				if (dpcheng.ListWznmQCtp1NTag) this.rst = dpcheng.ListWznmQCtp1NTag;
				if (dpcheng.StatAppQryWznmCtp1NTag) this.statappqry = dpcheng.StatAppQryWznmCtp1NTag;
				if (dpcheng.StatShrQryWznmCtp1NTag) this.statshrqry = dpcheng.StatShrQryWznmCtp1NTag;
				if (dpcheng.StgIacQryWznmCtp1NTag) this.stgiacqry = dpcheng.StgIacQryWznmCtp1NTag;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmCtp1NTagData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmCtp1NTagData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
