...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmIexRef1NDialog.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmIexRef1NDialogData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmIexRef1NDialog": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmIexRef1NDialog"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmIexRef1NDialogData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmIexRef1NDialogData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmIexRef1NDialog) this.continf = dpcheng.ContInfWznmIexRef1NDialog;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmIexRef1NDialog) this.statapp = dpcheng.StatAppWznmIexRef1NDialog;
				if (dpcheng.StatShrWznmIexRef1NDialog) this.statshr = dpcheng.StatShrWznmIexRef1NDialog;
				if (dpcheng.StgIacWznmIexRef1NDialog) this.stgiac = dpcheng.StgIacWznmIexRef1NDialog;
				if (dpcheng.TagWznmIexRef1NDialog) {
					Wznm.unescapeBlock(dpcheng.TagWznmIexRef1NDialog);
					this.tag = dpcheng.TagWznmIexRef1NDialog;
				}
				if (dpcheng.ListWznmQIexRef1NDialog) this.rst = dpcheng.ListWznmQIexRef1NDialog;
				if (dpcheng.StatAppQryWznmIexRef1NDialog) this.statappqry = dpcheng.StatAppQryWznmIexRef1NDialog;
				if (dpcheng.StatShrQryWznmIexRef1NDialog) this.statshrqry = dpcheng.StatShrQryWznmIexRef1NDialog;
				if (dpcheng.StgIacQryWznmIexRef1NDialog) this.stgiacqry = dpcheng.StgIacQryWznmIexRef1NDialog;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQIexRef1NDialog) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmIexRef1NDialogData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmIexRef1NDialogData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
