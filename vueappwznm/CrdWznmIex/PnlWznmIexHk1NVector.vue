...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmIexHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmIexHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmIexHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmIexHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmIexHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmIexHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmIexHk1NVector) this.continf = dpcheng.ContInfWznmIexHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmIexHk1NVector) this.statapp = dpcheng.StatAppWznmIexHk1NVector;
				if (dpcheng.StatShrWznmIexHk1NVector) this.statshr = dpcheng.StatShrWznmIexHk1NVector;
				if (dpcheng.StgIacWznmIexHk1NVector) this.stgiac = dpcheng.StgIacWznmIexHk1NVector;
				if (dpcheng.TagWznmIexHk1NVector) {
					Wznm.unescapeBlock(dpcheng.TagWznmIexHk1NVector);
					this.tag = dpcheng.TagWznmIexHk1NVector;
				}
				if (dpcheng.ListWznmQIexHk1NVector) this.rst = dpcheng.ListWznmQIexHk1NVector;
				if (dpcheng.StatAppQryWznmIexHk1NVector) this.statappqry = dpcheng.StatAppQryWznmIexHk1NVector;
				if (dpcheng.StatShrQryWznmIexHk1NVector) this.statshrqry = dpcheng.StatShrQryWznmIexHk1NVector;
				if (dpcheng.StgIacQryWznmIexHk1NVector) this.stgiacqry = dpcheng.StgIacQryWznmIexHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQIexHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmIexHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmIexHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
