...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmIex1NImpexp.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmIex1NImpexpData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmIex1NImpexp": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmIex1NImpexp"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmIex1NImpexpData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmIex1NImpexpData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmIex1NImpexp) this.continf = dpcheng.ContInfWznmIex1NImpexp;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmIex1NImpexp) this.statapp = dpcheng.StatAppWznmIex1NImpexp;
				if (dpcheng.StatShrWznmIex1NImpexp) this.statshr = dpcheng.StatShrWznmIex1NImpexp;
				if (dpcheng.StgIacWznmIex1NImpexp) this.stgiac = dpcheng.StgIacWznmIex1NImpexp;
				if (dpcheng.TagWznmIex1NImpexp) {
					Wznm.unescapeBlock(dpcheng.TagWznmIex1NImpexp);
					this.tag = dpcheng.TagWznmIex1NImpexp;
				}
				if (dpcheng.ListWznmQIex1NImpexp) this.rst = dpcheng.ListWznmQIex1NImpexp;
				if (dpcheng.StatAppQryWznmIex1NImpexp) this.statappqry = dpcheng.StatAppQryWznmIex1NImpexp;
				if (dpcheng.StatShrQryWznmIex1NImpexp) this.statshrqry = dpcheng.StatShrQryWznmIex1NImpexp;
				if (dpcheng.StgIacQryWznmIex1NImpexp) this.stgiacqry = dpcheng.StgIacQryWznmIex1NImpexp;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQIex1NImpexp) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmIex1NImpexpData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmIex1NImpexpData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
