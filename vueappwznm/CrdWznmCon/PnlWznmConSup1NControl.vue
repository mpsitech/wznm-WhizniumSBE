...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmConSup1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmConSup1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmConSup1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmConSup1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmConSup1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmConSup1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmConSup1NControl) this.continf = dpcheng.ContInfWznmConSup1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmConSup1NControl) this.statapp = dpcheng.StatAppWznmConSup1NControl;
				if (dpcheng.StatShrWznmConSup1NControl) this.statshr = dpcheng.StatShrWznmConSup1NControl;
				if (dpcheng.StgIacWznmConSup1NControl) this.stgiac = dpcheng.StgIacWznmConSup1NControl;
				if (dpcheng.TagWznmConSup1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmConSup1NControl);
					this.tag = dpcheng.TagWznmConSup1NControl;
				}
				if (dpcheng.ListWznmQConSup1NControl) this.rst = dpcheng.ListWznmQConSup1NControl;
				if (dpcheng.StatAppQryWznmConSup1NControl) this.statappqry = dpcheng.StatAppQryWznmConSup1NControl;
				if (dpcheng.StatShrQryWznmConSup1NControl) this.statshrqry = dpcheng.StatShrQryWznmConSup1NControl;
				if (dpcheng.StgIacQryWznmConSup1NControl) this.stgiacqry = dpcheng.StgIacQryWznmConSup1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQConSup1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmConSup1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmConSup1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
