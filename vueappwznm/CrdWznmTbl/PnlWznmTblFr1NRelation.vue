...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblFr1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblFr1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblFr1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblFr1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblFr1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblFr1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblFr1NRelation) this.continf = dpcheng.ContInfWznmTblFr1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblFr1NRelation) this.statapp = dpcheng.StatAppWznmTblFr1NRelation;
				if (dpcheng.StatShrWznmTblFr1NRelation) this.statshr = dpcheng.StatShrWznmTblFr1NRelation;
				if (dpcheng.StgIacWznmTblFr1NRelation) this.stgiac = dpcheng.StgIacWznmTblFr1NRelation;
				if (dpcheng.TagWznmTblFr1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblFr1NRelation);
					this.tag = dpcheng.TagWznmTblFr1NRelation;
				}
				if (dpcheng.ListWznmQTblFr1NRelation) this.rst = dpcheng.ListWznmQTblFr1NRelation;
				if (dpcheng.StatAppQryWznmTblFr1NRelation) this.statappqry = dpcheng.StatAppQryWznmTblFr1NRelation;
				if (dpcheng.StatShrQryWznmTblFr1NRelation) this.statshrqry = dpcheng.StatShrQryWznmTblFr1NRelation;
				if (dpcheng.StgIacQryWznmTblFr1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmTblFr1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblFr1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblFr1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblFr1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
