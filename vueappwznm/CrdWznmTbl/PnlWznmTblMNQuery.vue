...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblMNQuery.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblMNQueryData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblMNQuery": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblMNQuery"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblMNQueryData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblMNQueryData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblMNQuery) this.continf = dpcheng.ContInfWznmTblMNQuery;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblMNQuery) this.statapp = dpcheng.StatAppWznmTblMNQuery;
				if (dpcheng.StatShrWznmTblMNQuery) this.statshr = dpcheng.StatShrWznmTblMNQuery;
				if (dpcheng.StgIacWznmTblMNQuery) this.stgiac = dpcheng.StgIacWznmTblMNQuery;
				if (dpcheng.TagWznmTblMNQuery) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblMNQuery);
					this.tag = dpcheng.TagWznmTblMNQuery;
				}
				if (dpcheng.ListWznmQTblMNQuery) this.rst = dpcheng.ListWznmQTblMNQuery;
				if (dpcheng.StatAppQryWznmTblMNQuery) this.statappqry = dpcheng.StatAppQryWznmTblMNQuery;
				if (dpcheng.StatShrQryWznmTblMNQuery) this.statshrqry = dpcheng.StatShrQryWznmTblMNQuery;
				if (dpcheng.StgIacQryWznmTblMNQuery) this.stgiacqry = dpcheng.StgIacQryWznmTblMNQuery;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblMNQuery) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblMNQueryData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblMNQueryData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
