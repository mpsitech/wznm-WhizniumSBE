...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblTbl1NTablecol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblTbl1NTablecolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblTbl1NTablecol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblTbl1NTablecol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblTbl1NTablecolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblTbl1NTablecolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblTbl1NTablecol) this.continf = dpcheng.ContInfWznmTblTbl1NTablecol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblTbl1NTablecol) this.statapp = dpcheng.StatAppWznmTblTbl1NTablecol;
				if (dpcheng.StatShrWznmTblTbl1NTablecol) this.statshr = dpcheng.StatShrWznmTblTbl1NTablecol;
				if (dpcheng.StgIacWznmTblTbl1NTablecol) this.stgiac = dpcheng.StgIacWznmTblTbl1NTablecol;
				if (dpcheng.TagWznmTblTbl1NTablecol) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblTbl1NTablecol);
					this.tag = dpcheng.TagWznmTblTbl1NTablecol;
				}
				if (dpcheng.ListWznmQTblTbl1NTablecol) this.rst = dpcheng.ListWznmQTblTbl1NTablecol;
				if (dpcheng.StatAppQryWznmTblTbl1NTablecol) this.statappqry = dpcheng.StatAppQryWznmTblTbl1NTablecol;
				if (dpcheng.StatShrQryWznmTblTbl1NTablecol) this.statshrqry = dpcheng.StatShrQryWznmTblTbl1NTablecol;
				if (dpcheng.StgIacQryWznmTblTbl1NTablecol) this.stgiacqry = dpcheng.StgIacQryWznmTblTbl1NTablecol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblTbl1NTablecol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblTbl1NTablecolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblTbl1NTablecolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
