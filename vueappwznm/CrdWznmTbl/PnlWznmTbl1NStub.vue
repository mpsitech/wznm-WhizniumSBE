...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTbl1NStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTbl1NStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTbl1NStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTbl1NStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTbl1NStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTbl1NStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTbl1NStub) this.continf = dpcheng.ContInfWznmTbl1NStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTbl1NStub) this.statapp = dpcheng.StatAppWznmTbl1NStub;
				if (dpcheng.StatShrWznmTbl1NStub) this.statshr = dpcheng.StatShrWznmTbl1NStub;
				if (dpcheng.StgIacWznmTbl1NStub) this.stgiac = dpcheng.StgIacWznmTbl1NStub;
				if (dpcheng.TagWznmTbl1NStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmTbl1NStub);
					this.tag = dpcheng.TagWznmTbl1NStub;
				}
				if (dpcheng.ListWznmQTbl1NStub) this.rst = dpcheng.ListWznmQTbl1NStub;
				if (dpcheng.StatAppQryWznmTbl1NStub) this.statappqry = dpcheng.StatAppQryWznmTbl1NStub;
				if (dpcheng.StatShrQryWznmTbl1NStub) this.statshrqry = dpcheng.StatShrQryWznmTbl1NStub;
				if (dpcheng.StgIacQryWznmTbl1NStub) this.stgiacqry = dpcheng.StgIacQryWznmTbl1NStub;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTbl1NStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTbl1NStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
