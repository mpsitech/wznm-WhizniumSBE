...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblTo1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblTo1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblTo1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblTo1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblTo1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblTo1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblTo1NRelation) this.continf = dpcheng.ContInfWznmTblTo1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblTo1NRelation) this.statapp = dpcheng.StatAppWznmTblTo1NRelation;
				if (dpcheng.StatShrWznmTblTo1NRelation) this.statshr = dpcheng.StatShrWznmTblTo1NRelation;
				if (dpcheng.StgIacWznmTblTo1NRelation) this.stgiac = dpcheng.StgIacWznmTblTo1NRelation;
				if (dpcheng.TagWznmTblTo1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblTo1NRelation);
					this.tag = dpcheng.TagWznmTblTo1NRelation;
				}
				if (dpcheng.ListWznmQTblTo1NRelation) this.rst = dpcheng.ListWznmQTblTo1NRelation;
				if (dpcheng.StatAppQryWznmTblTo1NRelation) this.statappqry = dpcheng.StatAppQryWznmTblTo1NRelation;
				if (dpcheng.StatShrQryWznmTblTo1NRelation) this.statshrqry = dpcheng.StatShrQryWznmTblTo1NRelation;
				if (dpcheng.StgIacQryWznmTblTo1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmTblTo1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblTo1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblTo1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblTo1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
