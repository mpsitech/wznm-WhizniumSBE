...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTbl1NCheck.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTbl1NCheckData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTbl1NCheck": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTbl1NCheck"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTbl1NCheckData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTbl1NCheckData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTbl1NCheck) this.continf = dpcheng.ContInfWznmTbl1NCheck;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTbl1NCheck) this.statapp = dpcheng.StatAppWznmTbl1NCheck;
				if (dpcheng.StatShrWznmTbl1NCheck) this.statshr = dpcheng.StatShrWznmTbl1NCheck;
				if (dpcheng.StgIacWznmTbl1NCheck) this.stgiac = dpcheng.StgIacWznmTbl1NCheck;
				if (dpcheng.TagWznmTbl1NCheck) {
					Wznm.unescapeBlock(dpcheng.TagWznmTbl1NCheck);
					this.tag = dpcheng.TagWznmTbl1NCheck;
				}
				if (dpcheng.ListWznmQTbl1NCheck) this.rst = dpcheng.ListWznmQTbl1NCheck;
				if (dpcheng.StatAppQryWznmTbl1NCheck) this.statappqry = dpcheng.StatAppQryWznmTbl1NCheck;
				if (dpcheng.StatShrQryWznmTbl1NCheck) this.statshrqry = dpcheng.StatShrQryWznmTbl1NCheck;
				if (dpcheng.StgIacQryWznmTbl1NCheck) this.stgiacqry = dpcheng.StgIacQryWznmTbl1NCheck;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTbl1NCheck) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTbl1NCheckData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTbl1NCheckData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
