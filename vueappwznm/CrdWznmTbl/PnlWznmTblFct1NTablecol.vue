...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblFct1NTablecol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblFct1NTablecolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblFct1NTablecol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblFct1NTablecol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblFct1NTablecolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblFct1NTablecolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblFct1NTablecol) this.continf = dpcheng.ContInfWznmTblFct1NTablecol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblFct1NTablecol) this.statapp = dpcheng.StatAppWznmTblFct1NTablecol;
				if (dpcheng.StatShrWznmTblFct1NTablecol) this.statshr = dpcheng.StatShrWznmTblFct1NTablecol;
				if (dpcheng.StgIacWznmTblFct1NTablecol) this.stgiac = dpcheng.StgIacWznmTblFct1NTablecol;
				if (dpcheng.TagWznmTblFct1NTablecol) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblFct1NTablecol);
					this.tag = dpcheng.TagWznmTblFct1NTablecol;
				}
				if (dpcheng.ListWznmQTblFct1NTablecol) this.rst = dpcheng.ListWznmQTblFct1NTablecol;
				if (dpcheng.StatAppQryWznmTblFct1NTablecol) this.statappqry = dpcheng.StatAppQryWznmTblFct1NTablecol;
				if (dpcheng.StatShrQryWznmTblFct1NTablecol) this.statshrqry = dpcheng.StatShrQryWznmTblFct1NTablecol;
				if (dpcheng.StgIacQryWznmTblFct1NTablecol) this.stgiacqry = dpcheng.StgIacQryWznmTblFct1NTablecol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblFct1NTablecol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblFct1NTablecolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblFct1NTablecolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
