...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTbl1NImpexp.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTbl1NImpexpData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTbl1NImpexp": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTbl1NImpexp"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTbl1NImpexpData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTbl1NImpexpData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTbl1NImpexp) this.continf = dpcheng.ContInfWznmTbl1NImpexp;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTbl1NImpexp) this.statapp = dpcheng.StatAppWznmTbl1NImpexp;
				if (dpcheng.StatShrWznmTbl1NImpexp) this.statshr = dpcheng.StatShrWznmTbl1NImpexp;
				if (dpcheng.StgIacWznmTbl1NImpexp) this.stgiac = dpcheng.StgIacWznmTbl1NImpexp;
				if (dpcheng.TagWznmTbl1NImpexp) {
					Wznm.unescapeBlock(dpcheng.TagWznmTbl1NImpexp);
					this.tag = dpcheng.TagWznmTbl1NImpexp;
				}
				if (dpcheng.ListWznmQTbl1NImpexp) this.rst = dpcheng.ListWznmQTbl1NImpexp;
				if (dpcheng.StatAppQryWznmTbl1NImpexp) this.statappqry = dpcheng.StatAppQryWznmTbl1NImpexp;
				if (dpcheng.StatShrQryWznmTbl1NImpexp) this.statshrqry = dpcheng.StatShrQryWznmTbl1NImpexp;
				if (dpcheng.StgIacQryWznmTbl1NImpexp) this.stgiacqry = dpcheng.StgIacQryWznmTbl1NImpexp;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTbl1NImpexp) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTbl1NImpexpData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTbl1NImpexpData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
