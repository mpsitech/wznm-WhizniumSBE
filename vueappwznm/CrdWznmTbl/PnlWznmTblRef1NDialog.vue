...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblRef1NDialog.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblRef1NDialogData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblRef1NDialog": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblRef1NDialog"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblRef1NDialogData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblRef1NDialogData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblRef1NDialog) this.continf = dpcheng.ContInfWznmTblRef1NDialog;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblRef1NDialog) this.statapp = dpcheng.StatAppWznmTblRef1NDialog;
				if (dpcheng.StatShrWznmTblRef1NDialog) this.statshr = dpcheng.StatShrWznmTblRef1NDialog;
				if (dpcheng.StgIacWznmTblRef1NDialog) this.stgiac = dpcheng.StgIacWznmTblRef1NDialog;
				if (dpcheng.TagWznmTblRef1NDialog) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblRef1NDialog);
					this.tag = dpcheng.TagWznmTblRef1NDialog;
				}
				if (dpcheng.ListWznmQTblRef1NDialog) this.rst = dpcheng.ListWznmQTblRef1NDialog;
				if (dpcheng.StatAppQryWznmTblRef1NDialog) this.statappqry = dpcheng.StatAppQryWznmTblRef1NDialog;
				if (dpcheng.StatShrQryWznmTblRef1NDialog) this.statshrqry = dpcheng.StatShrQryWznmTblRef1NDialog;
				if (dpcheng.StgIacQryWznmTblRef1NDialog) this.stgiacqry = dpcheng.StgIacQryWznmTblRef1NDialog;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblRef1NDialog) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblRef1NDialogData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblRef1NDialogData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
