...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblHk1NVector.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblHk1NVectorData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblHk1NVector": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblHk1NVector"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblHk1NVectorData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblHk1NVectorData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblHk1NVector) this.continf = dpcheng.ContInfWznmTblHk1NVector;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblHk1NVector) this.statapp = dpcheng.StatAppWznmTblHk1NVector;
				if (dpcheng.StatShrWznmTblHk1NVector) this.statshr = dpcheng.StatShrWznmTblHk1NVector;
				if (dpcheng.StgIacWznmTblHk1NVector) this.stgiac = dpcheng.StgIacWznmTblHk1NVector;
				if (dpcheng.TagWznmTblHk1NVector) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblHk1NVector);
					this.tag = dpcheng.TagWznmTblHk1NVector;
				}
				if (dpcheng.ListWznmQTblHk1NVector) this.rst = dpcheng.ListWznmQTblHk1NVector;
				if (dpcheng.StatAppQryWznmTblHk1NVector) this.statappqry = dpcheng.StatAppQryWznmTblHk1NVector;
				if (dpcheng.StatShrQryWznmTblHk1NVector) this.statshrqry = dpcheng.StatShrQryWznmTblHk1NVector;
				if (dpcheng.StgIacQryWznmTblHk1NVector) this.stgiacqry = dpcheng.StgIacQryWznmTblHk1NVector;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblHk1NVector) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblHk1NVectorData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblHk1NVectorData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
