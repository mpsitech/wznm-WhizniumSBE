...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblSrc1NFeed.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblSrc1NFeedData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblSrc1NFeed": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblSrc1NFeed"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblSrc1NFeedData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblSrc1NFeedData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblSrc1NFeed) this.continf = dpcheng.ContInfWznmTblSrc1NFeed;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblSrc1NFeed) this.statapp = dpcheng.StatAppWznmTblSrc1NFeed;
				if (dpcheng.StatShrWznmTblSrc1NFeed) this.statshr = dpcheng.StatShrWznmTblSrc1NFeed;
				if (dpcheng.StgIacWznmTblSrc1NFeed) this.stgiac = dpcheng.StgIacWznmTblSrc1NFeed;
				if (dpcheng.TagWznmTblSrc1NFeed) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblSrc1NFeed);
					this.tag = dpcheng.TagWznmTblSrc1NFeed;
				}
				if (dpcheng.ListWznmQTblSrc1NFeed) this.rst = dpcheng.ListWznmQTblSrc1NFeed;
				if (dpcheng.StatAppQryWznmTblSrc1NFeed) this.statappqry = dpcheng.StatAppQryWznmTblSrc1NFeed;
				if (dpcheng.StatShrQryWznmTblSrc1NFeed) this.statshrqry = dpcheng.StatShrQryWznmTblSrc1NFeed;
				if (dpcheng.StgIacQryWznmTblSrc1NFeed) this.stgiacqry = dpcheng.StgIacQryWznmTblSrc1NFeed;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblSrc1NFeed) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblSrc1NFeedData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblSrc1NFeedData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
