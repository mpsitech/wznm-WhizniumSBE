...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblRef1NPanel.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblRef1NPanelData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblRef1NPanel": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblRef1NPanel"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblRef1NPanelData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblRef1NPanelData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblRef1NPanel) this.continf = dpcheng.ContInfWznmTblRef1NPanel;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblRef1NPanel) this.statapp = dpcheng.StatAppWznmTblRef1NPanel;
				if (dpcheng.StatShrWznmTblRef1NPanel) this.statshr = dpcheng.StatShrWznmTblRef1NPanel;
				if (dpcheng.StgIacWznmTblRef1NPanel) this.stgiac = dpcheng.StgIacWznmTblRef1NPanel;
				if (dpcheng.TagWznmTblRef1NPanel) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblRef1NPanel);
					this.tag = dpcheng.TagWznmTblRef1NPanel;
				}
				if (dpcheng.ListWznmQTblRef1NPanel) this.rst = dpcheng.ListWznmQTblRef1NPanel;
				if (dpcheng.StatAppQryWznmTblRef1NPanel) this.statappqry = dpcheng.StatAppQryWznmTblRef1NPanel;
				if (dpcheng.StatShrQryWznmTblRef1NPanel) this.statshrqry = dpcheng.StatShrQryWznmTblRef1NPanel;
				if (dpcheng.StgIacQryWznmTblRef1NPanel) this.stgiacqry = dpcheng.StgIacQryWznmTblRef1NPanel;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblRef1NPanel) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblRef1NPanelData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblRef1NPanelData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
