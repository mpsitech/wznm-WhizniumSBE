...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTbl1NSubset.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTbl1NSubsetData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTbl1NSubset": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTbl1NSubset"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTbl1NSubsetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTbl1NSubsetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTbl1NSubset) this.continf = dpcheng.ContInfWznmTbl1NSubset;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTbl1NSubset) this.statapp = dpcheng.StatAppWznmTbl1NSubset;
				if (dpcheng.StatShrWznmTbl1NSubset) this.statshr = dpcheng.StatShrWznmTbl1NSubset;
				if (dpcheng.StgIacWznmTbl1NSubset) this.stgiac = dpcheng.StgIacWznmTbl1NSubset;
				if (dpcheng.TagWznmTbl1NSubset) {
					Wznm.unescapeBlock(dpcheng.TagWznmTbl1NSubset);
					this.tag = dpcheng.TagWznmTbl1NSubset;
				}
				if (dpcheng.ListWznmQTbl1NSubset) this.rst = dpcheng.ListWznmQTbl1NSubset;
				if (dpcheng.StatAppQryWznmTbl1NSubset) this.statappqry = dpcheng.StatAppQryWznmTbl1NSubset;
				if (dpcheng.StatShrQryWznmTbl1NSubset) this.statshrqry = dpcheng.StatShrQryWznmTbl1NSubset;
				if (dpcheng.StgIacQryWznmTbl1NSubset) this.stgiacqry = dpcheng.StgIacQryWznmTbl1NSubset;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTbl1NSubset) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTbl1NSubsetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTbl1NSubsetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
