...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblRef1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblRef1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblRef1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblRef1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblRef1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblRef1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblRef1NQuerymod) this.continf = dpcheng.ContInfWznmTblRef1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblRef1NQuerymod) this.statapp = dpcheng.StatAppWznmTblRef1NQuerymod;
				if (dpcheng.StatShrWznmTblRef1NQuerymod) this.statshr = dpcheng.StatShrWznmTblRef1NQuerymod;
				if (dpcheng.StgIacWznmTblRef1NQuerymod) this.stgiac = dpcheng.StgIacWznmTblRef1NQuerymod;
				if (dpcheng.TagWznmTblRef1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblRef1NQuerymod);
					this.tag = dpcheng.TagWznmTblRef1NQuerymod;
				}
				if (dpcheng.ListWznmQTblRef1NQuerymod) this.rst = dpcheng.ListWznmQTblRef1NQuerymod;
				if (dpcheng.StatAppQryWznmTblRef1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmTblRef1NQuerymod;
				if (dpcheng.StatShrQryWznmTblRef1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmTblRef1NQuerymod;
				if (dpcheng.StgIacQryWznmTblRef1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmTblRef1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblRef1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblRef1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblRef1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
