...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmTblPst1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmTblPst1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmTblPst1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmTblPst1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmTblPst1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmTblPst1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmTblPst1NQuerymod) this.continf = dpcheng.ContInfWznmTblPst1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmTblPst1NQuerymod) this.statapp = dpcheng.StatAppWznmTblPst1NQuerymod;
				if (dpcheng.StatShrWznmTblPst1NQuerymod) this.statshr = dpcheng.StatShrWznmTblPst1NQuerymod;
				if (dpcheng.StgIacWznmTblPst1NQuerymod) this.stgiac = dpcheng.StgIacWznmTblPst1NQuerymod;
				if (dpcheng.TagWznmTblPst1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmTblPst1NQuerymod);
					this.tag = dpcheng.TagWznmTblPst1NQuerymod;
				}
				if (dpcheng.ListWznmQTblPst1NQuerymod) this.rst = dpcheng.ListWznmQTblPst1NQuerymod;
				if (dpcheng.StatAppQryWznmTblPst1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmTblPst1NQuerymod;
				if (dpcheng.StatShrQryWznmTblPst1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmTblPst1NQuerymod;
				if (dpcheng.StgIacQryWznmTblPst1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmTblPst1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQTblPst1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmTblPst1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmTblPst1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
