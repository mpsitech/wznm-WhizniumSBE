...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVisRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVisRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVisRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVisRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVisRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVisRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVisRef1NFile) this.continf = dpcheng.ContInfWznmVisRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVisRef1NFile) this.statapp = dpcheng.StatAppWznmVisRef1NFile;
				if (dpcheng.StatShrWznmVisRef1NFile) this.statshr = dpcheng.StatShrWznmVisRef1NFile;
				if (dpcheng.StgIacWznmVisRef1NFile) this.stgiac = dpcheng.StgIacWznmVisRef1NFile;
				if (dpcheng.TagWznmVisRef1NFile) {
					Wznm.unescapeBlock(dpcheng.TagWznmVisRef1NFile);
					this.tag = dpcheng.TagWznmVisRef1NFile;
				}
				if (dpcheng.ListWznmQVisRef1NFile) this.rst = dpcheng.ListWznmQVisRef1NFile;
				if (dpcheng.StatAppQryWznmVisRef1NFile) this.statappqry = dpcheng.StatAppQryWznmVisRef1NFile;
				if (dpcheng.StatShrQryWznmVisRef1NFile) this.statshrqry = dpcheng.StatShrQryWznmVisRef1NFile;
				if (dpcheng.StgIacQryWznmVisRef1NFile) this.stgiacqry = dpcheng.StgIacQryWznmVisRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVisRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVisRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVisRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
