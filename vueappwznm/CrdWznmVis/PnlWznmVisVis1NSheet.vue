...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVisVis1NSheet.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVisVis1NSheetData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVisVis1NSheet": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVisVis1NSheet"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVisVis1NSheetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVisVis1NSheetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVisVis1NSheet) this.continf = dpcheng.ContInfWznmVisVis1NSheet;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVisVis1NSheet) this.statapp = dpcheng.StatAppWznmVisVis1NSheet;
				if (dpcheng.StatShrWznmVisVis1NSheet) this.statshr = dpcheng.StatShrWznmVisVis1NSheet;
				if (dpcheng.StgIacWznmVisVis1NSheet) this.stgiac = dpcheng.StgIacWznmVisVis1NSheet;
				if (dpcheng.TagWznmVisVis1NSheet) {
					Wznm.unescapeBlock(dpcheng.TagWznmVisVis1NSheet);
					this.tag = dpcheng.TagWznmVisVis1NSheet;
				}
				if (dpcheng.ListWznmQVisVis1NSheet) this.rst = dpcheng.ListWznmQVisVis1NSheet;
				if (dpcheng.StatAppQryWznmVisVis1NSheet) this.statappqry = dpcheng.StatAppQryWznmVisVis1NSheet;
				if (dpcheng.StatShrQryWznmVisVis1NSheet) this.statshrqry = dpcheng.StatShrQryWznmVisVis1NSheet;
				if (dpcheng.StgIacQryWznmVisVis1NSheet) this.stgiacqry = dpcheng.StgIacQryWznmVisVis1NSheet;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVisVis1NSheet) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVisVis1NSheetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVisVis1NSheetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
