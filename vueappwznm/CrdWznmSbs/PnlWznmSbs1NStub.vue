...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbs1NStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbs1NStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbs1NStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbs1NStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbs1NStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbs1NStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbs1NStub) this.continf = dpcheng.ContInfWznmSbs1NStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbs1NStub) this.statapp = dpcheng.StatAppWznmSbs1NStub;
				if (dpcheng.StatShrWznmSbs1NStub) this.statshr = dpcheng.StatShrWznmSbs1NStub;
				if (dpcheng.StgIacWznmSbs1NStub) this.stgiac = dpcheng.StgIacWznmSbs1NStub;
				if (dpcheng.TagWznmSbs1NStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbs1NStub);
					this.tag = dpcheng.TagWznmSbs1NStub;
				}
				if (dpcheng.ListWznmQSbs1NStub) this.rst = dpcheng.ListWznmQSbs1NStub;
				if (dpcheng.StatAppQryWznmSbs1NStub) this.statappqry = dpcheng.StatAppQryWznmSbs1NStub;
				if (dpcheng.StatShrQryWznmSbs1NStub) this.statshrqry = dpcheng.StatShrQryWznmSbs1NStub;
				if (dpcheng.StgIacQryWznmSbs1NStub) this.stgiacqry = dpcheng.StgIacQryWznmSbs1NStub;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbs1NStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbs1NStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
