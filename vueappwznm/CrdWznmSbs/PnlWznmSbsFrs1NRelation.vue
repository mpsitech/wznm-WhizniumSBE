...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbsFrs1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbsFrs1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbsFrs1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbsFrs1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbsFrs1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbsFrs1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbsFrs1NRelation) this.continf = dpcheng.ContInfWznmSbsFrs1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbsFrs1NRelation) this.statapp = dpcheng.StatAppWznmSbsFrs1NRelation;
				if (dpcheng.StatShrWznmSbsFrs1NRelation) this.statshr = dpcheng.StatShrWznmSbsFrs1NRelation;
				if (dpcheng.StgIacWznmSbsFrs1NRelation) this.stgiac = dpcheng.StgIacWznmSbsFrs1NRelation;
				if (dpcheng.TagWznmSbsFrs1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbsFrs1NRelation);
					this.tag = dpcheng.TagWznmSbsFrs1NRelation;
				}
				if (dpcheng.ListWznmQSbsFrs1NRelation) this.rst = dpcheng.ListWznmQSbsFrs1NRelation;
				if (dpcheng.StatAppQryWznmSbsFrs1NRelation) this.statappqry = dpcheng.StatAppQryWznmSbsFrs1NRelation;
				if (dpcheng.StatShrQryWznmSbsFrs1NRelation) this.statshrqry = dpcheng.StatShrQryWznmSbsFrs1NRelation;
				if (dpcheng.StgIacQryWznmSbsFrs1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmSbsFrs1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSbsFrs1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbsFrs1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbsFrs1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
