...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbsBsbMNSubset.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbsBsbMNSubsetData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbsBsbMNSubset": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbsBsbMNSubset"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbsBsbMNSubsetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbsBsbMNSubsetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbsBsbMNSubset) this.continf = dpcheng.ContInfWznmSbsBsbMNSubset;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbsBsbMNSubset) this.statapp = dpcheng.StatAppWznmSbsBsbMNSubset;
				if (dpcheng.StatShrWznmSbsBsbMNSubset) this.statshr = dpcheng.StatShrWznmSbsBsbMNSubset;
				if (dpcheng.StgIacWznmSbsBsbMNSubset) this.stgiac = dpcheng.StgIacWznmSbsBsbMNSubset;
				if (dpcheng.TagWznmSbsBsbMNSubset) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbsBsbMNSubset);
					this.tag = dpcheng.TagWznmSbsBsbMNSubset;
				}
				if (dpcheng.ListWznmQSbsBsbMNSubset) this.rst = dpcheng.ListWznmQSbsBsbMNSubset;
				if (dpcheng.StatAppQryWznmSbsBsbMNSubset) this.statappqry = dpcheng.StatAppQryWznmSbsBsbMNSubset;
				if (dpcheng.StatShrQryWznmSbsBsbMNSubset) this.statshrqry = dpcheng.StatShrQryWznmSbsBsbMNSubset;
				if (dpcheng.StgIacQryWznmSbsBsbMNSubset) this.stgiacqry = dpcheng.StgIacQryWznmSbsBsbMNSubset;
				/*
				...
				*/
				...
				if (dpcheng.TagWznmSbsBsbMNSubset) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoMref", text: this.tag.TcoMref}, {value: "TcoRty", text: this.tag.TcoRty});
					/*
					*/
				...
				if (dpcheng.ListWznmQSbsBsbMNSubset) {
					var rows = [];
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoMref: rec["mref"], TcoRty: rec["rty"]})
						/*
						*/
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbsBsbMNSubsetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbsBsbMNSubsetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
