...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbsAsbMNSubset.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbsAsbMNSubsetData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbsAsbMNSubset": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbsAsbMNSubset"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbsAsbMNSubsetData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbsAsbMNSubsetData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbsAsbMNSubset) this.continf = dpcheng.ContInfWznmSbsAsbMNSubset;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbsAsbMNSubset) this.statapp = dpcheng.StatAppWznmSbsAsbMNSubset;
				if (dpcheng.StatShrWznmSbsAsbMNSubset) this.statshr = dpcheng.StatShrWznmSbsAsbMNSubset;
				if (dpcheng.StgIacWznmSbsAsbMNSubset) this.stgiac = dpcheng.StgIacWznmSbsAsbMNSubset;
				if (dpcheng.TagWznmSbsAsbMNSubset) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbsAsbMNSubset);
					this.tag = dpcheng.TagWznmSbsAsbMNSubset;
				}
				if (dpcheng.ListWznmQSbsAsbMNSubset) this.rst = dpcheng.ListWznmQSbsAsbMNSubset;
				if (dpcheng.StatAppQryWznmSbsAsbMNSubset) this.statappqry = dpcheng.StatAppQryWznmSbsAsbMNSubset;
				if (dpcheng.StatShrQryWznmSbsAsbMNSubset) this.statshrqry = dpcheng.StatShrQryWznmSbsAsbMNSubset;
				if (dpcheng.StgIacQryWznmSbsAsbMNSubset) this.stgiacqry = dpcheng.StgIacQryWznmSbsAsbMNSubset;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSbsAsbMNSubset) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbsAsbMNSubsetData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbsAsbMNSubsetData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
