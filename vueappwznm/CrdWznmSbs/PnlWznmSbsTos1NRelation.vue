...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbsTos1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbsTos1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbsTos1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbsTos1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbsTos1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbsTos1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbsTos1NRelation) this.continf = dpcheng.ContInfWznmSbsTos1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbsTos1NRelation) this.statapp = dpcheng.StatAppWznmSbsTos1NRelation;
				if (dpcheng.StatShrWznmSbsTos1NRelation) this.statshr = dpcheng.StatShrWznmSbsTos1NRelation;
				if (dpcheng.StgIacWznmSbsTos1NRelation) this.stgiac = dpcheng.StgIacWznmSbsTos1NRelation;
				if (dpcheng.TagWznmSbsTos1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbsTos1NRelation);
					this.tag = dpcheng.TagWznmSbsTos1NRelation;
				}
				if (dpcheng.ListWznmQSbsTos1NRelation) this.rst = dpcheng.ListWznmQSbsTos1NRelation;
				if (dpcheng.StatAppQryWznmSbsTos1NRelation) this.statappqry = dpcheng.StatAppQryWznmSbsTos1NRelation;
				if (dpcheng.StatShrQryWznmSbsTos1NRelation) this.statshrqry = dpcheng.StatShrQryWznmSbsTos1NRelation;
				if (dpcheng.StgIacQryWznmSbsTos1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmSbsTos1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSbsTos1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbsTos1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbsTos1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
