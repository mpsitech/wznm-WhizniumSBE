...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSbsPst1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSbsPst1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSbsPst1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSbsPst1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSbsPst1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSbsPst1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSbsPst1NQuerymod) this.continf = dpcheng.ContInfWznmSbsPst1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSbsPst1NQuerymod) this.statapp = dpcheng.StatAppWznmSbsPst1NQuerymod;
				if (dpcheng.StatShrWznmSbsPst1NQuerymod) this.statshr = dpcheng.StatShrWznmSbsPst1NQuerymod;
				if (dpcheng.StgIacWznmSbsPst1NQuerymod) this.stgiac = dpcheng.StgIacWznmSbsPst1NQuerymod;
				if (dpcheng.TagWznmSbsPst1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmSbsPst1NQuerymod);
					this.tag = dpcheng.TagWznmSbsPst1NQuerymod;
				}
				if (dpcheng.ListWznmQSbsPst1NQuerymod) this.rst = dpcheng.ListWznmQSbsPst1NQuerymod;
				if (dpcheng.StatAppQryWznmSbsPst1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmSbsPst1NQuerymod;
				if (dpcheng.StatShrQryWznmSbsPst1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmSbsPst1NQuerymod;
				if (dpcheng.StgIacQryWznmSbsPst1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmSbsPst1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSbsPst1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSbsPst1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSbsPst1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
