...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmStbSupMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmStbSupMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmStbSupMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmStbSupMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmStbSupMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmStbSupMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmStbSupMNStub) this.continf = dpcheng.ContInfWznmStbSupMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmStbSupMNStub) this.statapp = dpcheng.StatAppWznmStbSupMNStub;
				if (dpcheng.StatShrWznmStbSupMNStub) this.statshr = dpcheng.StatShrWznmStbSupMNStub;
				if (dpcheng.StgIacWznmStbSupMNStub) this.stgiac = dpcheng.StgIacWznmStbSupMNStub;
				if (dpcheng.TagWznmStbSupMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmStbSupMNStub);
					this.tag = dpcheng.TagWznmStbSupMNStub;
				}
				if (dpcheng.ListWznmQStbSupMNStub) this.rst = dpcheng.ListWznmQStbSupMNStub;
				if (dpcheng.StatAppQryWznmStbSupMNStub) this.statappqry = dpcheng.StatAppQryWznmStbSupMNStub;
				if (dpcheng.StatShrQryWznmStbSupMNStub) this.statshrqry = dpcheng.StatShrQryWznmStbSupMNStub;
				if (dpcheng.StgIacQryWznmStbSupMNStub) this.stgiacqry = dpcheng.StgIacQryWznmStbSupMNStub;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQStbSupMNStub) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmStbSupMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmStbSupMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
