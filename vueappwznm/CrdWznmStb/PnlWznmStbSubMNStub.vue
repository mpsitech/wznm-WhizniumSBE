...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmStbSubMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmStbSubMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmStbSubMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmStbSubMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmStbSubMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmStbSubMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmStbSubMNStub) this.continf = dpcheng.ContInfWznmStbSubMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmStbSubMNStub) this.statapp = dpcheng.StatAppWznmStbSubMNStub;
				if (dpcheng.StatShrWznmStbSubMNStub) this.statshr = dpcheng.StatShrWznmStbSubMNStub;
				if (dpcheng.StgIacWznmStbSubMNStub) this.stgiac = dpcheng.StgIacWznmStbSubMNStub;
				if (dpcheng.TagWznmStbSubMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmStbSubMNStub);
					this.tag = dpcheng.TagWznmStbSubMNStub;
				}
				if (dpcheng.ListWznmQStbSubMNStub) this.rst = dpcheng.ListWznmQStbSubMNStub;
				if (dpcheng.StatAppQryWznmStbSubMNStub) this.statappqry = dpcheng.StatAppQryWznmStbSubMNStub;
				if (dpcheng.StatShrQryWznmStbSubMNStub) this.statshrqry = dpcheng.StatShrQryWznmStbSubMNStub;
				if (dpcheng.StgIacQryWznmStbSubMNStub) this.stgiacqry = dpcheng.StgIacQryWznmStbSubMNStub;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQStbSubMNStub) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmStbSubMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmStbSubMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
