...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmStbMNSquawk.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmStbMNSquawkData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmStbMNSquawk": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmStbMNSquawk"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmStbMNSquawkData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmStbMNSquawkData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmStbMNSquawk) this.continf = dpcheng.ContInfWznmStbMNSquawk;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmStbMNSquawk) this.statapp = dpcheng.StatAppWznmStbMNSquawk;
				if (dpcheng.StatShrWznmStbMNSquawk) this.statshr = dpcheng.StatShrWznmStbMNSquawk;
				if (dpcheng.StgIacWznmStbMNSquawk) this.stgiac = dpcheng.StgIacWznmStbMNSquawk;
				if (dpcheng.TagWznmStbMNSquawk) {
					Wznm.unescapeBlock(dpcheng.TagWznmStbMNSquawk);
					this.tag = dpcheng.TagWznmStbMNSquawk;
				}
				if (dpcheng.ListWznmQStbMNSquawk) this.rst = dpcheng.ListWznmQStbMNSquawk;
				if (dpcheng.StatAppQryWznmStbMNSquawk) this.statappqry = dpcheng.StatAppQryWznmStbMNSquawk;
				if (dpcheng.StatShrQryWznmStbMNSquawk) this.statshrqry = dpcheng.StatShrQryWznmStbMNSquawk;
				if (dpcheng.StgIacQryWznmStbMNSquawk) this.stgiacqry = dpcheng.StgIacQryWznmStbMNSquawk;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQStbMNSquawk) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmStbMNSquawkData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmStbMNSquawkData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
