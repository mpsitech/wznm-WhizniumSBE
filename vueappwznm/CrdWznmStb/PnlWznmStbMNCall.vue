...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmStbMNCall.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmStbMNCallData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmStbMNCall": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmStbMNCall"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmStbMNCallData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmStbMNCallData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmStbMNCall) this.continf = dpcheng.ContInfWznmStbMNCall;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmStbMNCall) this.statapp = dpcheng.StatAppWznmStbMNCall;
				if (dpcheng.StatShrWznmStbMNCall) this.statshr = dpcheng.StatShrWznmStbMNCall;
				if (dpcheng.StgIacWznmStbMNCall) this.stgiac = dpcheng.StgIacWznmStbMNCall;
				if (dpcheng.TagWznmStbMNCall) {
					Wznm.unescapeBlock(dpcheng.TagWznmStbMNCall);
					this.tag = dpcheng.TagWznmStbMNCall;
				}
				if (dpcheng.ListWznmQStbMNCall) this.rst = dpcheng.ListWznmQStbMNCall;
				if (dpcheng.StatAppQryWznmStbMNCall) this.statappqry = dpcheng.StatAppQryWznmStbMNCall;
				if (dpcheng.StatShrQryWznmStbMNCall) this.statshrqry = dpcheng.StatShrQryWznmStbMNCall;
				if (dpcheng.StgIacQryWznmStbMNCall) this.stgiacqry = dpcheng.StgIacQryWznmStbMNCall;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmStbMNCallData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmStbMNCallData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
