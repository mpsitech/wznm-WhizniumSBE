...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmUsgMNUser.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmUsgMNUserData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmUsgMNUser": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmUsgMNUser"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmUsgMNUserData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmUsgMNUserData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmUsgMNUser) this.continf = dpcheng.ContInfWznmUsgMNUser;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmUsgMNUser) this.statapp = dpcheng.StatAppWznmUsgMNUser;
				if (dpcheng.StatShrWznmUsgMNUser) this.statshr = dpcheng.StatShrWznmUsgMNUser;
				if (dpcheng.StgIacWznmUsgMNUser) this.stgiac = dpcheng.StgIacWznmUsgMNUser;
				if (dpcheng.TagWznmUsgMNUser) {
					Wznm.unescapeBlock(dpcheng.TagWznmUsgMNUser);
					this.tag = dpcheng.TagWznmUsgMNUser;
				}
				if (dpcheng.ListWznmQUsgMNUser) this.rst = dpcheng.ListWznmQUsgMNUser;
				if (dpcheng.StatAppQryWznmUsgMNUser) this.statappqry = dpcheng.StatAppQryWznmUsgMNUser;
				if (dpcheng.StatShrQryWznmUsgMNUser) this.statshrqry = dpcheng.StatShrQryWznmUsgMNUser;
				if (dpcheng.StgIacQryWznmUsgMNUser) this.stgiacqry = dpcheng.StgIacQryWznmUsgMNUser;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmUsgMNUserData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmUsgMNUserData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
