...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmUsgAAccess.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmUsgAAccessData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmUsgAAccess": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmUsgAAccess"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmUsgAAccessData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmUsgAAccessData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmUsgAAccess) this.continf = dpcheng.ContInfWznmUsgAAccess;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmUsgAAccess) this.statapp = dpcheng.StatAppWznmUsgAAccess;
				if (dpcheng.StatShrWznmUsgAAccess) this.statshr = dpcheng.StatShrWznmUsgAAccess;
				if (dpcheng.StgIacWznmUsgAAccess) this.stgiac = dpcheng.StgIacWznmUsgAAccess;
				if (dpcheng.TagWznmUsgAAccess) {
					Wznm.unescapeBlock(dpcheng.TagWznmUsgAAccess);
					this.tag = dpcheng.TagWznmUsgAAccess;
				}
				if (dpcheng.ListWznmQUsgAAccess) this.rst = dpcheng.ListWznmQUsgAAccess;
				if (dpcheng.StatAppQryWznmUsgAAccess) this.statappqry = dpcheng.StatAppQryWznmUsgAAccess;
				if (dpcheng.StatShrQryWznmUsgAAccess) this.statshrqry = dpcheng.StatShrQryWznmUsgAAccess;
				if (dpcheng.StgIacQryWznmUsgAAccess) this.stgiacqry = dpcheng.StgIacQryWznmUsgAAccess;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQUsgAAccess) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmUsgAAccessData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmUsgAAccessData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
