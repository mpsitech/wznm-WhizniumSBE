...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmPrsMNProject.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmPrsMNProjectData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmPrsMNProject": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmPrsMNProject"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmPrsMNProjectData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmPrsMNProjectData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmPrsMNProject) this.continf = dpcheng.ContInfWznmPrsMNProject;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmPrsMNProject) this.statapp = dpcheng.StatAppWznmPrsMNProject;
				if (dpcheng.StatShrWznmPrsMNProject) this.statshr = dpcheng.StatShrWznmPrsMNProject;
				if (dpcheng.StgIacWznmPrsMNProject) this.stgiac = dpcheng.StgIacWznmPrsMNProject;
				if (dpcheng.TagWznmPrsMNProject) {
					Wznm.unescapeBlock(dpcheng.TagWznmPrsMNProject);
					this.tag = dpcheng.TagWznmPrsMNProject;
				}
				if (dpcheng.ListWznmQPrsMNProject) this.rst = dpcheng.ListWznmQPrsMNProject;
				if (dpcheng.StatAppQryWznmPrsMNProject) this.statappqry = dpcheng.StatAppQryWznmPrsMNProject;
				if (dpcheng.StatShrQryWznmPrsMNProject) this.statshrqry = dpcheng.StatShrQryWznmPrsMNProject;
				if (dpcheng.StgIacQryWznmPrsMNProject) this.stgiacqry = dpcheng.StgIacQryWznmPrsMNProject;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQPrsMNProject) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmPrsMNProjectData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmPrsMNProjectData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
