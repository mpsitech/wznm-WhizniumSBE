...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVecFct1NTablecol.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVecFct1NTablecolData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVecFct1NTablecol": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVecFct1NTablecol"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVecFct1NTablecolData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVecFct1NTablecolData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVecFct1NTablecol) this.continf = dpcheng.ContInfWznmVecFct1NTablecol;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVecFct1NTablecol) this.statapp = dpcheng.StatAppWznmVecFct1NTablecol;
				if (dpcheng.StatShrWznmVecFct1NTablecol) this.statshr = dpcheng.StatShrWznmVecFct1NTablecol;
				if (dpcheng.StgIacWznmVecFct1NTablecol) this.stgiac = dpcheng.StgIacWznmVecFct1NTablecol;
				if (dpcheng.TagWznmVecFct1NTablecol) {
					Wznm.unescapeBlock(dpcheng.TagWznmVecFct1NTablecol);
					this.tag = dpcheng.TagWznmVecFct1NTablecol;
				}
				if (dpcheng.ListWznmQVecFct1NTablecol) this.rst = dpcheng.ListWznmQVecFct1NTablecol;
				if (dpcheng.StatAppQryWznmVecFct1NTablecol) this.statappqry = dpcheng.StatAppQryWznmVecFct1NTablecol;
				if (dpcheng.StatShrQryWznmVecFct1NTablecol) this.statshrqry = dpcheng.StatShrQryWznmVecFct1NTablecol;
				if (dpcheng.StgIacQryWznmVecFct1NTablecol) this.stgiacqry = dpcheng.StgIacQryWznmVecFct1NTablecol;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVecFct1NTablecol) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVecFct1NTablecolData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVecFct1NTablecolData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
