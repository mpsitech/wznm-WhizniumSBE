...
<script>
	...
	*/
	...
	export default {
		name: 'PnlWznmVecVec1NVectoritem',
		...
		mounted() {
			//console.log("PnlWznmVecVec1NVectoritem.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleButClick: function(ctlsref) {
				const dpchapp = {
					"DpchAppWznmVecVec1NVectoritemDo": {
						"scrJref": this.scrJref,
						"srefIxVDo": ctlsref
					}
				};
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVecVec1NVectoritemData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVecVec1NVectoritem": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVecVec1NVectoritem"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVecVec1NVectoritemData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVecVec1NVectoritemData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVecVec1NVectoritem) this.continf = dpcheng.ContInfWznmVecVec1NVectoritem;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVecVec1NVectoritem) this.statapp = dpcheng.StatAppWznmVecVec1NVectoritem;
				if (dpcheng.StatShrWznmVecVec1NVectoritem) this.statshr = dpcheng.StatShrWznmVecVec1NVectoritem;
				if (dpcheng.StgIacWznmVecVec1NVectoritem) this.stgiac = dpcheng.StgIacWznmVecVec1NVectoritem;
				if (dpcheng.TagWznmVecVec1NVectoritem) {
					Wznm.unescapeBlock(dpcheng.TagWznmVecVec1NVectoritem);
					this.tag = dpcheng.TagWznmVecVec1NVectoritem;
				}
				if (dpcheng.ListWznmQVecVec1NVectoritem) this.rst = dpcheng.ListWznmQVecVec1NVectoritem;
				if (dpcheng.StatAppQryWznmVecVec1NVectoritem) this.statappqry = dpcheng.StatAppQryWznmVecVec1NVectoritem;
				if (dpcheng.StatShrQryWznmVecVec1NVectoritem) this.statshrqry = dpcheng.StatShrQryWznmVecVec1NVectoritem;
				if (dpcheng.StgIacQryWznmVecVec1NVectoritem) this.stgiacqry = dpcheng.StgIacQryWznmVecVec1NVectoritem;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVecVec1NVectoritem) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVecVec1NVectoritemData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVecVec1NVectoritemData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
