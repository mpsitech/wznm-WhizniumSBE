...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVecPst1NQuerymod.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVecPst1NQuerymodData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVecPst1NQuerymod": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVecPst1NQuerymod"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVecPst1NQuerymodData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVecPst1NQuerymodData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVecPst1NQuerymod) this.continf = dpcheng.ContInfWznmVecPst1NQuerymod;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVecPst1NQuerymod) this.statapp = dpcheng.StatAppWznmVecPst1NQuerymod;
				if (dpcheng.StatShrWznmVecPst1NQuerymod) this.statshr = dpcheng.StatShrWznmVecPst1NQuerymod;
				if (dpcheng.StgIacWznmVecPst1NQuerymod) this.stgiac = dpcheng.StgIacWznmVecPst1NQuerymod;
				if (dpcheng.TagWznmVecPst1NQuerymod) {
					Wznm.unescapeBlock(dpcheng.TagWznmVecPst1NQuerymod);
					this.tag = dpcheng.TagWznmVecPst1NQuerymod;
				}
				if (dpcheng.ListWznmQVecPst1NQuerymod) this.rst = dpcheng.ListWznmQVecPst1NQuerymod;
				if (dpcheng.StatAppQryWznmVecPst1NQuerymod) this.statappqry = dpcheng.StatAppQryWznmVecPst1NQuerymod;
				if (dpcheng.StatShrQryWznmVecPst1NQuerymod) this.statshrqry = dpcheng.StatShrQryWznmVecPst1NQuerymod;
				if (dpcheng.StgIacQryWznmVecPst1NQuerymod) this.stgiacqry = dpcheng.StgIacQryWznmVecPst1NQuerymod;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVecPst1NQuerymod) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVecPst1NQuerymodData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVecPst1NQuerymodData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
