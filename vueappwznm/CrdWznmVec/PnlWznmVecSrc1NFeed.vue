...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmVecSrc1NFeed.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmVecSrc1NFeedData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmVecSrc1NFeed": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmVecSrc1NFeed"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmVecSrc1NFeedData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmVecSrc1NFeedData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmVecSrc1NFeed) this.continf = dpcheng.ContInfWznmVecSrc1NFeed;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmVecSrc1NFeed) this.statapp = dpcheng.StatAppWznmVecSrc1NFeed;
				if (dpcheng.StatShrWznmVecSrc1NFeed) this.statshr = dpcheng.StatShrWznmVecSrc1NFeed;
				if (dpcheng.StgIacWznmVecSrc1NFeed) this.stgiac = dpcheng.StgIacWznmVecSrc1NFeed;
				if (dpcheng.TagWznmVecSrc1NFeed) {
					Wznm.unescapeBlock(dpcheng.TagWznmVecSrc1NFeed);
					this.tag = dpcheng.TagWznmVecSrc1NFeed;
				}
				if (dpcheng.ListWznmQVecSrc1NFeed) this.rst = dpcheng.ListWznmQVecSrc1NFeed;
				if (dpcheng.StatAppQryWznmVecSrc1NFeed) this.statappqry = dpcheng.StatAppQryWznmVecSrc1NFeed;
				if (dpcheng.StatShrQryWznmVecSrc1NFeed) this.statshrqry = dpcheng.StatShrQryWznmVecSrc1NFeed;
				if (dpcheng.StgIacQryWznmVecSrc1NFeed) this.stgiacqry = dpcheng.StgIacQryWznmVecSrc1NFeed;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQVecSrc1NFeed) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmVecSrc1NFeedData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmVecSrc1NFeedData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
