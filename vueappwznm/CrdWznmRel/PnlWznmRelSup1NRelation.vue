...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRelSup1NRelation.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRelSup1NRelationData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRelSup1NRelation": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRelSup1NRelation"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRelSup1NRelationData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRelSup1NRelationData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmRelSup1NRelation) this.continf = dpcheng.ContInfWznmRelSup1NRelation;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmRelSup1NRelation) this.statapp = dpcheng.StatAppWznmRelSup1NRelation;
				if (dpcheng.StatShrWznmRelSup1NRelation) this.statshr = dpcheng.StatShrWznmRelSup1NRelation;
				if (dpcheng.StgIacWznmRelSup1NRelation) this.stgiac = dpcheng.StgIacWznmRelSup1NRelation;
				if (dpcheng.TagWznmRelSup1NRelation) {
					Wznm.unescapeBlock(dpcheng.TagWznmRelSup1NRelation);
					this.tag = dpcheng.TagWznmRelSup1NRelation;
				}
				if (dpcheng.ListWznmQRelSup1NRelation) this.rst = dpcheng.ListWznmQRelSup1NRelation;
				if (dpcheng.StatAppQryWznmRelSup1NRelation) this.statappqry = dpcheng.StatAppQryWznmRelSup1NRelation;
				if (dpcheng.StatShrQryWznmRelSup1NRelation) this.statshrqry = dpcheng.StatShrQryWznmRelSup1NRelation;
				if (dpcheng.StgIacQryWznmRelSup1NRelation) this.stgiacqry = dpcheng.StgIacQryWznmRelSup1NRelation;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQRelSup1NRelation) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRelSup1NRelationData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRelSup1NRelationData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
