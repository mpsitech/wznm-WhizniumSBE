...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRelRef1NPanel.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRelRef1NPanelData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRelRef1NPanel": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRelRef1NPanel"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRelRef1NPanelData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRelRef1NPanelData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmRelRef1NPanel) this.continf = dpcheng.ContInfWznmRelRef1NPanel;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmRelRef1NPanel) this.statapp = dpcheng.StatAppWznmRelRef1NPanel;
				if (dpcheng.StatShrWznmRelRef1NPanel) this.statshr = dpcheng.StatShrWznmRelRef1NPanel;
				if (dpcheng.StgIacWznmRelRef1NPanel) this.stgiac = dpcheng.StgIacWznmRelRef1NPanel;
				if (dpcheng.TagWznmRelRef1NPanel) {
					Wznm.unescapeBlock(dpcheng.TagWznmRelRef1NPanel);
					this.tag = dpcheng.TagWznmRelRef1NPanel;
				}
				if (dpcheng.ListWznmQRelRef1NPanel) this.rst = dpcheng.ListWznmQRelRef1NPanel;
				if (dpcheng.StatAppQryWznmRelRef1NPanel) this.statappqry = dpcheng.StatAppQryWznmRelRef1NPanel;
				if (dpcheng.StatShrQryWznmRelRef1NPanel) this.statshrqry = dpcheng.StatShrQryWznmRelRef1NPanel;
				if (dpcheng.StgIacQryWznmRelRef1NPanel) this.stgiacqry = dpcheng.StgIacQryWznmRelRef1NPanel;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQRelRef1NPanel) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRelRef1NPanelData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRelRef1NPanelData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
