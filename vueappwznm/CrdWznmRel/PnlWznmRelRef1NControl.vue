...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRelRef1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRelRef1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRelRef1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRelRef1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRelRef1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRelRef1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmRelRef1NControl) this.continf = dpcheng.ContInfWznmRelRef1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmRelRef1NControl) this.statapp = dpcheng.StatAppWznmRelRef1NControl;
				if (dpcheng.StatShrWznmRelRef1NControl) this.statshr = dpcheng.StatShrWznmRelRef1NControl;
				if (dpcheng.StgIacWznmRelRef1NControl) this.stgiac = dpcheng.StgIacWznmRelRef1NControl;
				if (dpcheng.TagWznmRelRef1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmRelRef1NControl);
					this.tag = dpcheng.TagWznmRelRef1NControl;
				}
				if (dpcheng.ListWznmQRelRef1NControl) this.rst = dpcheng.ListWznmQRelRef1NControl;
				if (dpcheng.StatAppQryWznmRelRef1NControl) this.statappqry = dpcheng.StatAppQryWznmRelRef1NControl;
				if (dpcheng.StatShrQryWznmRelRef1NControl) this.statshrqry = dpcheng.StatShrQryWznmRelRef1NControl;
				if (dpcheng.StgIacQryWznmRelRef1NControl) this.stgiacqry = dpcheng.StgIacQryWznmRelRef1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQRelRef1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRelRef1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRelRef1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
