...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRelRef1NDialog.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRelRef1NDialogData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRelRef1NDialog": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRelRef1NDialog"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRelRef1NDialogData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRelRef1NDialogData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmRelRef1NDialog) this.continf = dpcheng.ContInfWznmRelRef1NDialog;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmRelRef1NDialog) this.statapp = dpcheng.StatAppWznmRelRef1NDialog;
				if (dpcheng.StatShrWznmRelRef1NDialog) this.statshr = dpcheng.StatShrWznmRelRef1NDialog;
				if (dpcheng.StgIacWznmRelRef1NDialog) this.stgiac = dpcheng.StgIacWznmRelRef1NDialog;
				if (dpcheng.TagWznmRelRef1NDialog) {
					Wznm.unescapeBlock(dpcheng.TagWznmRelRef1NDialog);
					this.tag = dpcheng.TagWznmRelRef1NDialog;
				}
				if (dpcheng.ListWznmQRelRef1NDialog) this.rst = dpcheng.ListWznmQRelRef1NDialog;
				if (dpcheng.StatAppQryWznmRelRef1NDialog) this.statappqry = dpcheng.StatAppQryWznmRelRef1NDialog;
				if (dpcheng.StatShrQryWznmRelRef1NDialog) this.statshrqry = dpcheng.StatShrQryWznmRelRef1NDialog;
				if (dpcheng.StgIacQryWznmRelRef1NDialog) this.stgiacqry = dpcheng.StgIacQryWznmRelRef1NDialog;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQRelRef1NDialog) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRelRef1NDialogData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRelRef1NDialogData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
