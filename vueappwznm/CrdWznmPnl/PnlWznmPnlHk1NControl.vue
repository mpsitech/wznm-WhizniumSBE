...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmPnlHk1NControl.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmPnlHk1NControlData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmPnlHk1NControl": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmPnlHk1NControl"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmPnlHk1NControlData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmPnlHk1NControlData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmPnlHk1NControl) this.continf = dpcheng.ContInfWznmPnlHk1NControl;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmPnlHk1NControl) this.statapp = dpcheng.StatAppWznmPnlHk1NControl;
				if (dpcheng.StatShrWznmPnlHk1NControl) this.statshr = dpcheng.StatShrWznmPnlHk1NControl;
				if (dpcheng.StgIacWznmPnlHk1NControl) this.stgiac = dpcheng.StgIacWznmPnlHk1NControl;
				if (dpcheng.TagWznmPnlHk1NControl) {
					Wznm.unescapeBlock(dpcheng.TagWznmPnlHk1NControl);
					this.tag = dpcheng.TagWznmPnlHk1NControl;
				}
				if (dpcheng.ListWznmQPnlHk1NControl) this.rst = dpcheng.ListWznmQPnlHk1NControl;
				if (dpcheng.StatAppQryWznmPnlHk1NControl) this.statappqry = dpcheng.StatAppQryWznmPnlHk1NControl;
				if (dpcheng.StatShrQryWznmPnlHk1NControl) this.statshrqry = dpcheng.StatShrQryWznmPnlHk1NControl;
				if (dpcheng.StgIacQryWznmPnlHk1NControl) this.stgiacqry = dpcheng.StgIacQryWznmPnlHk1NControl;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQPnlHk1NControl) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmPnlHk1NControlData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmPnlHk1NControlData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
