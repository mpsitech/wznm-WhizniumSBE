...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmRtjSup1NRtjob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmRtjSup1NRtjobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmRtjSup1NRtjob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmRtjSup1NRtjob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmRtjSup1NRtjobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmRtjSup1NRtjobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmRtjSup1NRtjob) this.continf = dpcheng.ContInfWznmRtjSup1NRtjob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmRtjSup1NRtjob) this.statapp = dpcheng.StatAppWznmRtjSup1NRtjob;
				if (dpcheng.StatShrWznmRtjSup1NRtjob) this.statshr = dpcheng.StatShrWznmRtjSup1NRtjob;
				if (dpcheng.StgIacWznmRtjSup1NRtjob) this.stgiac = dpcheng.StgIacWznmRtjSup1NRtjob;
				if (dpcheng.TagWznmRtjSup1NRtjob) {
					Wznm.unescapeBlock(dpcheng.TagWznmRtjSup1NRtjob);
					this.tag = dpcheng.TagWznmRtjSup1NRtjob;
				}
				if (dpcheng.ListWznmQRtjSup1NRtjob) this.rst = dpcheng.ListWznmQRtjSup1NRtjob;
				if (dpcheng.StatAppQryWznmRtjSup1NRtjob) this.statappqry = dpcheng.StatAppQryWznmRtjSup1NRtjob;
				if (dpcheng.StatShrQryWznmRtjSup1NRtjob) this.statshrqry = dpcheng.StatShrQryWznmRtjSup1NRtjob;
				if (dpcheng.StgIacQryWznmRtjSup1NRtjob) this.stgiacqry = dpcheng.StgIacQryWznmRtjSup1NRtjob;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQRtjSup1NRtjob) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmRtjSup1NRtjobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmRtjSup1NRtjobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
