...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpxMNJob.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpxMNJobData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpxMNJob": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpxMNJob"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpxMNJobData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpxMNJobData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpxMNJob) this.continf = dpcheng.ContInfWznmOpxMNJob;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpxMNJob) this.statapp = dpcheng.StatAppWznmOpxMNJob;
				if (dpcheng.StatShrWznmOpxMNJob) this.statshr = dpcheng.StatShrWznmOpxMNJob;
				if (dpcheng.StgIacWznmOpxMNJob) this.stgiac = dpcheng.StgIacWznmOpxMNJob;
				if (dpcheng.TagWznmOpxMNJob) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpxMNJob);
					this.tag = dpcheng.TagWznmOpxMNJob;
				}
				if (dpcheng.ListWznmQOpxMNJob) this.rst = dpcheng.ListWznmQOpxMNJob;
				if (dpcheng.StatAppQryWznmOpxMNJob) this.statappqry = dpcheng.StatAppQryWznmOpxMNJob;
				if (dpcheng.StatShrQryWznmOpxMNJob) this.statshrqry = dpcheng.StatShrQryWznmOpxMNJob;
				if (dpcheng.StgIacQryWznmOpxMNJob) this.stgiacqry = dpcheng.StgIacQryWznmOpxMNJob;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpxMNJobData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpxMNJobData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
