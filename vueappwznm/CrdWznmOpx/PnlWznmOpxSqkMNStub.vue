...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpxSqkMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpxSqkMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpxSqkMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpxSqkMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpxSqkMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpxSqkMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpxSqkMNStub) this.continf = dpcheng.ContInfWznmOpxSqkMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpxSqkMNStub) this.statapp = dpcheng.StatAppWznmOpxSqkMNStub;
				if (dpcheng.StatShrWznmOpxSqkMNStub) this.statshr = dpcheng.StatShrWznmOpxSqkMNStub;
				if (dpcheng.StgIacWznmOpxSqkMNStub) this.stgiac = dpcheng.StgIacWznmOpxSqkMNStub;
				if (dpcheng.TagWznmOpxSqkMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpxSqkMNStub);
					this.tag = dpcheng.TagWznmOpxSqkMNStub;
				}
				if (dpcheng.ListWznmQOpxSqkMNStub) this.rst = dpcheng.ListWznmQOpxSqkMNStub;
				if (dpcheng.StatAppQryWznmOpxSqkMNStub) this.statappqry = dpcheng.StatAppQryWznmOpxSqkMNStub;
				if (dpcheng.StatShrQryWznmOpxSqkMNStub) this.statshrqry = dpcheng.StatShrQryWznmOpxSqkMNStub;
				if (dpcheng.StgIacQryWznmOpxSqkMNStub) this.stgiacqry = dpcheng.StgIacQryWznmOpxSqkMNStub;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpxSqkMNStub) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpxSqkMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpxSqkMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
