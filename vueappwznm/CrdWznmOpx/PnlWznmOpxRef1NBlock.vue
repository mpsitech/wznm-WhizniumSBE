...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmOpxRef1NBlock.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmOpxRef1NBlockData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmOpxRef1NBlock": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmOpxRef1NBlock"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmOpxRef1NBlockData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmOpxRef1NBlockData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmOpxRef1NBlock) this.continf = dpcheng.ContInfWznmOpxRef1NBlock;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmOpxRef1NBlock) this.statapp = dpcheng.StatAppWznmOpxRef1NBlock;
				if (dpcheng.StatShrWznmOpxRef1NBlock) this.statshr = dpcheng.StatShrWznmOpxRef1NBlock;
				if (dpcheng.StgIacWznmOpxRef1NBlock) this.stgiac = dpcheng.StgIacWznmOpxRef1NBlock;
				if (dpcheng.TagWznmOpxRef1NBlock) {
					Wznm.unescapeBlock(dpcheng.TagWznmOpxRef1NBlock);
					this.tag = dpcheng.TagWznmOpxRef1NBlock;
				}
				if (dpcheng.ListWznmQOpxRef1NBlock) this.rst = dpcheng.ListWznmQOpxRef1NBlock;
				if (dpcheng.StatAppQryWznmOpxRef1NBlock) this.statappqry = dpcheng.StatAppQryWznmOpxRef1NBlock;
				if (dpcheng.StatShrQryWznmOpxRef1NBlock) this.statshrqry = dpcheng.StatShrQryWznmOpxRef1NBlock;
				if (dpcheng.StgIacQryWznmOpxRef1NBlock) this.stgiacqry = dpcheng.StgIacQryWznmOpxRef1NBlock;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQOpxRef1NBlock) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmOpxRef1NBlockData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmOpxRef1NBlockData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
