...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSht1NBox.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSht1NBoxData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSht1NBox": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSht1NBox"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSht1NBoxData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSht1NBoxData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSht1NBox) this.continf = dpcheng.ContInfWznmSht1NBox;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSht1NBox) this.statapp = dpcheng.StatAppWznmSht1NBox;
				if (dpcheng.StatShrWznmSht1NBox) this.statshr = dpcheng.StatShrWznmSht1NBox;
				if (dpcheng.StgIacWznmSht1NBox) this.stgiac = dpcheng.StgIacWznmSht1NBox;
				if (dpcheng.TagWznmSht1NBox) {
					Wznm.unescapeBlock(dpcheng.TagWznmSht1NBox);
					this.tag = dpcheng.TagWznmSht1NBox;
				}
				if (dpcheng.ListWznmQSht1NBox) this.rst = dpcheng.ListWznmQSht1NBox;
				if (dpcheng.StatAppQryWznmSht1NBox) this.statappqry = dpcheng.StatAppQryWznmSht1NBox;
				if (dpcheng.StatShrQryWznmSht1NBox) this.statshrqry = dpcheng.StatShrQryWznmSht1NBox;
				if (dpcheng.StgIacQryWznmSht1NBox) this.stgiacqry = dpcheng.StgIacQryWznmSht1NBox;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSht1NBoxData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSht1NBoxData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
