...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmSgeSqkMNStub.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmSgeSqkMNStubData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmSgeSqkMNStub": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmSgeSqkMNStub"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmSgeSqkMNStubData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmSgeSqkMNStubData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmSgeSqkMNStub) this.continf = dpcheng.ContInfWznmSgeSqkMNStub;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmSgeSqkMNStub) this.statapp = dpcheng.StatAppWznmSgeSqkMNStub;
				if (dpcheng.StatShrWznmSgeSqkMNStub) this.statshr = dpcheng.StatShrWznmSgeSqkMNStub;
				if (dpcheng.StgIacWznmSgeSqkMNStub) this.stgiac = dpcheng.StgIacWznmSgeSqkMNStub;
				if (dpcheng.TagWznmSgeSqkMNStub) {
					Wznm.unescapeBlock(dpcheng.TagWznmSgeSqkMNStub);
					this.tag = dpcheng.TagWznmSgeSqkMNStub;
				}
				if (dpcheng.ListWznmQSgeSqkMNStub) this.rst = dpcheng.ListWznmQSgeSqkMNStub;
				if (dpcheng.StatAppQryWznmSgeSqkMNStub) this.statappqry = dpcheng.StatAppQryWznmSgeSqkMNStub;
				if (dpcheng.StatShrQryWznmSgeSqkMNStub) this.statshrqry = dpcheng.StatShrQryWznmSgeSqkMNStub;
				if (dpcheng.StgIacQryWznmSgeSqkMNStub) this.stgiacqry = dpcheng.StgIacQryWznmSgeSqkMNStub;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQSgeSqkMNStub) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmSgeSqkMNStubData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmSgeSqkMNStubData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
