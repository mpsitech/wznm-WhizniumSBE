...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmChkRef1NCall.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmChkRef1NCallData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmChkRef1NCall": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmChkRef1NCall"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmChkRef1NCallData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmChkRef1NCallData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmChkRef1NCall) this.continf = dpcheng.ContInfWznmChkRef1NCall;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmChkRef1NCall) this.statapp = dpcheng.StatAppWznmChkRef1NCall;
				if (dpcheng.StatShrWznmChkRef1NCall) this.statshr = dpcheng.StatShrWznmChkRef1NCall;
				if (dpcheng.StgIacWznmChkRef1NCall) this.stgiac = dpcheng.StgIacWznmChkRef1NCall;
				if (dpcheng.TagWznmChkRef1NCall) {
					Wznm.unescapeBlock(dpcheng.TagWznmChkRef1NCall);
					this.tag = dpcheng.TagWznmChkRef1NCall;
				}
				if (dpcheng.ListWznmQChkRef1NCall) this.rst = dpcheng.ListWznmQChkRef1NCall;
				if (dpcheng.StatAppQryWznmChkRef1NCall) this.statappqry = dpcheng.StatAppQryWznmChkRef1NCall;
				if (dpcheng.StatShrQryWznmChkRef1NCall) this.statshrqry = dpcheng.StatShrQryWznmChkRef1NCall;
				if (dpcheng.StgIacQryWznmChkRef1NCall) this.stgiacqry = dpcheng.StgIacQryWznmChkRef1NCall;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQChkRef1NCall) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmChkRef1NCallData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmChkRef1NCallData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
