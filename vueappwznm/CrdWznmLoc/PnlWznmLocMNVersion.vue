...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWznmLocMNVersion.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWznmLocMNVersionData": {
						"scrJref": this.scrJref,
						"StgIacQryWznmLocMNVersion": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWznmLocMNVersion"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWznmLocMNVersionData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWznmLocMNVersionData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWznmLocMNVersion) this.continf = dpcheng.ContInfWznmLocMNVersion;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWznmLocMNVersion) this.statapp = dpcheng.StatAppWznmLocMNVersion;
				if (dpcheng.StatShrWznmLocMNVersion) this.statshr = dpcheng.StatShrWznmLocMNVersion;
				if (dpcheng.StgIacWznmLocMNVersion) this.stgiac = dpcheng.StgIacWznmLocMNVersion;
				if (dpcheng.TagWznmLocMNVersion) {
					Wznm.unescapeBlock(dpcheng.TagWznmLocMNVersion);
					this.tag = dpcheng.TagWznmLocMNVersion;
				}
				if (dpcheng.ListWznmQLocMNVersion) this.rst = dpcheng.ListWznmQLocMNVersion;
				if (dpcheng.StatAppQryWznmLocMNVersion) this.statappqry = dpcheng.StatAppQryWznmLocMNVersion;
				if (dpcheng.StatShrQryWznmLocMNVersion) this.statshrqry = dpcheng.StatShrQryWznmLocMNVersion;
				if (dpcheng.StgIacQryWznmLocMNVersion) this.stgiacqry = dpcheng.StgIacQryWznmLocMNVersion;
				/*
				...
				*/
				...
				if (dpcheng.ListWznmQLocMNVersion) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWznmVDpch, dpcheng) {
				if (srefIxWznmVDpch == "DpchEngWznmLocMNVersionData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWznmVDpch == "DpchEngWznmLocMNVersionData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
